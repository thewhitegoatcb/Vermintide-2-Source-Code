...
function BTPackMasterAttackAction:init(...)
	BTPackMasterAttackAction.super.init(self, ...)
end

BTPackMasterAttackAction.name = "BTPackMasterAttackAction"

function BTPackMasterAttackAction:enter(unit, blackboard, t)
...
function BTPackMasterAttackAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPackMasterAttackAction:run(unit, blackboard, t, dt)
...
function BTPackMasterAttackAction:attack(unit, t, dt, blackboard)
...
function BTPackMasterAttackAction:attack_success(unit, blackboard)
...
function BTPackMasterAttackAction:create_bot_threat(unit, blackboard, t)
	local first_person_extension = ScriptUnit.has_extension(blackboard.target_unit, "first_person_system")
