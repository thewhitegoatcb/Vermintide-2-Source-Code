...
function UICleanUI.create(peer_id, hud)
	return { off_window_clock = 0, was_enabled = false, dirty = true,
		areas = { },
		widget_area_map = { },
...
function UICleanUI:update(dt)
	...
	for i = 1, unit_frame_amount do
		...
		portrait_bounding_boxes [i] = { {
				centre_pos [1] - portrait_size [1] * 0.5, centre_pos [2] - portrait_size [2] },
	...
	local left_portrait_bounding_boxes = {
		portrait_bounding_boxes [2], portrait_bounding_boxes [3], portrait_bounding_boxes [4] }
		...
		if self.gamepadclusters then
			...
			self.gamepadclusters = {
				...
				bottom = {
					...
					widgets = { { alpha = -1, set_alpha_function = "set_health_alpha",
						...
						{ set_alpha_function = "set_frame_alpha", alpha = -1,
				...
				bottom_left = {
					bounding_box = pad_bounding_box(get_world_bounding_box(left_portrait_bounding_boxes), margin),
					widgets = { { alpha = -1, set_alpha_function = "set_default_alpha",
						...
						{ alpha = -1, set_alpha_function = "set_portrait_alpha",
				...
				bottom_right = {
					...
					widgets = { { set_alpha_function = "set_panel_alpha", alpha = -1,

							widget = hud:component("GamePadEquipmentUI") },


						{ alpha = -1, set_alpha_function = "set_ability_alpha",
			...
			self.clusters = {
				...
				bottom = {
					...
					widgets = { { set_alpha_function = "set_panel_alpha", alpha = -1,
						...
						{ alpha = -1, set_alpha_function = "set_equipment_alpha",
						...
						{ alpha = -1, set_alpha_function = "set_health_alpha",
				...
				bottom_right = {
					bounding_box = pad_bounding_box(get_world_bounding_box(bottom_right_bounding_boxes), margin),
					widgets = { { set_alpha_function = "set_ammo_alpha", alpha = -1,
