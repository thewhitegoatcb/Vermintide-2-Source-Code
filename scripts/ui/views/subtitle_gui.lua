local scenegraph_definition = {
	...
	subtitle_background_parent = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "center",
	...
	subtitle_background = { vertical_alignment = "bottom", parent = "subtitle_background_parent", horizontal_alignment = "left",
...
local subtitle_widget_definition = { scenegraph_id = "subtitle_background",
	element = UIElements.StaticText,
	content = { text_field = "" },


	style = {
		text = { vertical_alignment = "bottom", horizontal_alignment = "left", word_wrap = true, font_type = "hell_shark", draw_text_rect = true,
...
function SubtitleGui:init(parent, ingame_ui_context)
	self._parent = parent
...
function SubtitleGui:_add_subtitle(unit, speaker, text)
	local new_entry = {
		unit = unit,
		speaker = speaker,
		text = text }
...
function SubtitleGui:_remove_subtitle(unit)
...
function SubtitleGui:_has_subtitle_for_unit(unit)
	local subtitle_list = self.subtitle_list
	local num_subtitles = #subtitle_list
...
local customizer_data = { root_scenegraph_id = "subtitle_background", label = "Subtitles", registry_key = "subtitle", drag_scenegraph_id = "subtitle_background" }
...
function SubtitleGui:update(dt)
...
function SubtitleGui:start_subtitle(speaker_name, subtitle)
	self.subtitles_to_display [speaker_name] = subtitle
	self._force_text_remake = true
end

function SubtitleGui:stop_subtitle(speaker_name)
