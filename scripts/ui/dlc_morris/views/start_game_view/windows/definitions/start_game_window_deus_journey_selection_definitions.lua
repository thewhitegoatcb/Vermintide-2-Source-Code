...
local modifier_info_size = { large_window_size [1] - 50, 200 }

local modifier_info_panel_offset = { 0, -50, 0 }
local padding = { 20, 0 }
...
local journey_widget_settings = { width = 180, spacing_x = 50 }
...
local scenegraph_definition = {
	...
	info_window = { vertical_alignment = "center", parent = "window", horizontal_alignment = "right", size = window_size, position = { info_window_size [1] + 25, 0, 1 } },
	level_root_node = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { 0, 0 }, position = { 210, 0, 10 } },
	end_level_root_node = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { 0, 0 }, position = { 90, 0, 10 } },
	...
	modifier_timer = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { 512, 100 }, position = { 0, 0, 2 } },
	modifier_info = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = modifier_info_size, position = { 0, 0, 2 } },

	modifier_info_god = { vertical_alignment = "top", parent = "modifier_info", horizontal_alignment = "center", size = modifier_info_panel_size, position = modifier_info_panel_pos },
...
local function create_modifier_timer_widget(scenegraph_id)
	return {
		element = {
			passes = { { retained_mode = false, style_id = "title", pass_type = "text", text_id = "title" },




				{ retained_mode = false, style_id = "time_text", pass_type = "text", text_id = "time_text" } } },
		...
		content = { time_text = "3 days, 23h 03m", title = "deus_start_game_mod_timer_title" },



		style = {
			title = { vertical_alignment = "top", horizontal_alignment = "center", localize = true, font_size = 42, font_type = "hell_shark_header",
				text_color = Colors.get_color_table_with_alpha("font_default", 255),
			...
			time_text = { vertical_alignment = "bottom", horizontal_alignment = "center", localize = false, font_size = 32, font_type = "hell_shark_header",
				text_color = Colors.get_color_table_with_alpha("font_default", 255),
...
local function create_modifier_info_panel(scenegraph_id)
	...
	local icon_offset = { 0, 40, 0 }

	local title_offset = { 0, -spacing_y - icon_size [2] + icon_offset [2], 0 }
	local desc_offset = { 0, -spacing_y - title_font_size + title_offset [2], 0 }
	...
	return {
		element = {
			passes = { { pass_type = "texture", style_id = "icon", texture_id = "icon",
				...
				{ retained_mode = false, style_id = "title", pass_type = "text", text_id = "title" },




				{ retained_mode = false, style_id = "description", pass_type = "text", text_id = "description" } } },
		...
		style = {
			...
			title = { upper_case = true, localize = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "top", dynamic_font_size = true, font_type = "hell_shark_header",
				text_color = Colors.get_color_table_with_alpha("font_title", 255),
			...
			description = { horizontal_alignment = "center", font_size = 18, localize = false, word_wrap = true, vertical_alignment = "top", dynamic_font_size = false, font_type = "hell_shark",
				text_color = Colors.get_color_table_with_alpha("font_default", 255),
...
local function create_modifier_info_widget(scenegraph_id)
	...
	return {
		...
		content = { title = "deus_start_game_mod_info_title",
		...
		style = {
			...
			title = { vertical_alignment = "top", horizontal_alignment = "center", localize = true, font_size = 22, font_type = "hell_shark_header",
				text_color = Colors.get_color_table_with_alpha("font_default", 255),
...
local function create_level_widget(i, specific_scenegraph_id)
	...
	local passes = { { style_id = "icon", pass_type = "hotspot", content_id = "button_hotspot",
		...
		{ pass_type = "texture", style_id = "chaos_symbol", texture_id = "chaos_symbol",
	...
	local content = { frame = "map_frame_00", locked = true, lock = "map_frame_lock", draw_path = false, path_glow = "mission_select_screen_trail_fill", draw_path_fill = false, path = "mission_select_screen_trail", icon_glow = "map_frame_glow_02", icon_unlock_guidance_glow = "map_frame_glow_03", chaos_symbol = "map_frame_chaos_slot_01", lock_fade = "map_frame_fade", icon = "level_icon_01", draw_chaos_symbol = true,
		button_hotspot = { } }
