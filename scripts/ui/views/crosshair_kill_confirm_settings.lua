CrosshairKillConfirmSettingsGroups = table.enum(
"off",
"all",
"elites_above",
"bosses_specials",
...
local kill_confirm_enemy_types = table.enum(
"infantry",
"elite",
"special",
...
local kill_confirm_types = table.enum(
"kill",
"kill_dot",
"kill_weakpoint",
...
local kill_confirm_type_colors = {
	[kill_confirm_types.kill] = { 255, 243, 21, 21 },
	[kill_confirm_types.kill_dot] = { 255, 228, 139, 255 },
	[kill_confirm_types.kill_weakpoint] = { 255, 230, 168, 0 },
	[kill_confirm_types.assist] = { 255, 0, 162, 255 } }
...
local kill_confirm_weakspot_zones = { head = true, weakspot = true }
...
local kill_confirm_styles = { style_1 = "kill_confirm_01", style_2 = "kill_confirm_02", style_5 = "kill_confirm_05", style_3 = "kill_confirm_03", style_4 = "kill_confirm_04" }
