...
function StartGameWindowAdventureOverviewConsole:on_enter(params, offset)
...
function StartGameWindowAdventureOverviewConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowAdventureOverviewConsole:_create_ui_elements(params, offset)
...
function StartGameWindowAdventureOverviewConsole:on_exit(params)
...
function StartGameWindowAdventureOverviewConsole:set_focus(focused)
	self._is_focused = focused
end

function StartGameWindowAdventureOverviewConsole:update(dt, t)
...
function StartGameWindowAdventureOverviewConsole:post_update(dt, t)
	return end

function StartGameWindowAdventureOverviewConsole:_update_can_play()
...
function StartGameWindowAdventureOverviewConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowAdventureOverviewConsole:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowAdventureOverviewConsole:_handle_input(dt, t)
...
function StartGameWindowAdventureOverviewConsole:_play_sound(event)
	self._parent:play_sound(event)
end

function StartGameWindowAdventureOverviewConsole:_can_play()
	local parent = self._parent
...
function StartGameWindowAdventureOverviewConsole:_update_difficulty_option()
...
function StartGameWindowAdventureOverviewConsole:_option_selected(input_index, t)
...
function StartGameWindowAdventureOverviewConsole:_handle_new_selection(input_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowAdventureOverviewConsole:_update_animations(dt)
...
function StartGameWindowAdventureOverviewConsole:_draw(dt)
