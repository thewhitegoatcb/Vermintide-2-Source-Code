...
function StartGameWindowAreaSelectionConsole:on_enter(params, offset)
...
function StartGameWindowAreaSelectionConsole:create_ui_elements(params, offset)
...
function StartGameWindowAreaSelectionConsole:_setup_area_widgets()
...
function StartGameWindowAreaSelectionConsole:_select_area_by_name(area_name)
	...
	if active_area_widgets then
		for i = 1, #active_area_widgets do
			...
			if is_selected then idx = i or idx
			end
		end end
...
function StartGameWindowAreaSelectionConsole:_set_area_presentation_info(area_name)
	local title_text = ""
...
function StartGameWindowAreaSelectionConsole:on_exit(params)
...
function StartGameWindowAreaSelectionConsole:update(dt, t)
...
function StartGameWindowAreaSelectionConsole:post_update(dt, t)
	self:draw(dt)
end

function StartGameWindowAreaSelectionConsole:_update_animations(dt)
...
function StartGameWindowAreaSelectionConsole:_is_button_pressed(widget)
	local content = widget.content
...
function StartGameWindowAreaSelectionConsole:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowAreaSelectionConsole:_update_area_option()
...
function StartGameWindowAreaSelectionConsole:_handle_input(dt, t)
	local parent = self.parent
...
function StartGameWindowAreaSelectionConsole:_on_select_button_pressed()
...
function StartGameWindowAreaSelectionConsole:draw(dt)
...
function StartGameWindowAreaSelectionConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowAreaSelectionConsole:_assign_video_player(material_name, video_player)
	self:_destroy_video_widget()
...
function StartGameWindowAreaSelectionConsole:_destroy_video_widget()
...
function StartGameWindowAreaSelectionConsole:_animate_area_widget(widget, dt)
	local content = widget.content
...
function StartGameWindowAreaSelectionConsole:_show_storepage(url, dlc_name)
