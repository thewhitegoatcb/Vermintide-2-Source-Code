...
function BTSelector_ethereal_skeleton_with_shield:init(...)
	BTSelector_ethereal_skeleton_with_shield.super.init(self, ...)
	self._children = { }
end

function BTSelector_ethereal_skeleton_with_shield:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_ethereal_skeleton_with_shield:run(unit, blackboard, t, dt)
...
function BTSelector_ethereal_skeleton_with_shield:add_child(node)
