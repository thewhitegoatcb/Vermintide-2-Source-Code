...
function PlayerCharacterStateStanding:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "standing")
	local context = character_state_init_context
end

function PlayerCharacterStateStanding:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateStanding:on_exit(unit, input, dt, context, t, next_state)
	return end

function PlayerCharacterStateStanding:_inspection_available()
...
function PlayerCharacterStateStanding:update(unit, input, dt, context, t)
	local csm = self.csm
