...
function BTSelector_storm_vermin:init(...)
	BTSelector_storm_vermin.super.init(self, ...)
	self._children = { }
end

function BTSelector_storm_vermin:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_storm_vermin:run(unit, blackboard, t, dt)
...
function BTSelector_storm_vermin:add_child(node)
