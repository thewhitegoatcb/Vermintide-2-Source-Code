...
function TrueFlightUtility.sort_prioritize_specials(targets, optional_reference_pos)
...
function TrueFlightUtility.sort_prioritize_elites(targets, optional_reference_pos)
	order_upvalue = table.mirror_array(targets, FrameTable.alloc_table())
	reference_pos_upvalue = optional_reference_pos
...
function TrueFlightUtility.sort_prioritize_bosses(targets, optional_reference_pos)
	order_upvalue = table.mirror_array(targets, FrameTable.alloc_table())
	reference_pos_upvalue = optional_reference_pos
