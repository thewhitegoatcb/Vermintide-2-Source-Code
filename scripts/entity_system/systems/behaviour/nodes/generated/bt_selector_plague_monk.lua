...
function BTSelector_plague_monk:init(...)
	BTSelector_plague_monk.super.init(self, ...)
	self._children = { }
end

function BTSelector_plague_monk:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_plague_monk:run(unit, blackboard, t, dt)
...
function BTSelector_plague_monk:add_child(node)
