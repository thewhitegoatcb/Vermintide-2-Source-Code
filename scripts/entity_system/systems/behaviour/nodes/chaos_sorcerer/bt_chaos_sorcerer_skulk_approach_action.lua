...
function BTChaosSorcererSkulkApproachAction:init(...)
...
function BTChaosSorcererSkulkApproachAction:enter(unit, blackboard, t)
	...
	if action.sorcerer_type == "tentacle" then
		if not blackboard.portal_data then
			blackboard.portal_data = { chance_to_look_for_wall_spawn = 0.5, search_counter = 0, portal_spawn_type = "n/a",
	...
	elseif action.sorcerer_type == "vortex" and
	not blackboard.vortex_data then
...
function BTChaosSorcererSkulkApproachAction:initialize_vortex_data(blackboard, vortex_template_name)
	...
	blackboard.vortex_data = { spawn_timer = 3,
		physics_world = World.get_data(blackboard.world, "physics_world"),
...
function BTChaosSorcererSkulkApproachAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChaosSorcererSkulkApproachAction:run(unit, blackboard, t, dt)
...
function BTChaosSorcererSkulkApproachAction:at_goal(unit, blackboard)
	local skulk_data = blackboard.skulk_data
...
function BTChaosSorcererSkulkApproachAction:move_to(position, unit, blackboard)
	local ai_navigation = blackboard.navigation_extension
	ai_navigation:move_to(position)
	blackboard.move_pos = Vector3Box(position)
end

function BTChaosSorcererSkulkApproachAction:idle(unit, blackboard)
	self:anim_event(unit, blackboard, "idle")
	blackboard.move_state = "idle"
end

function BTChaosSorcererSkulkApproachAction:start_move_animation(unit, blackboard)
	local move_animation = blackboard.action.move_animation
	self:anim_event(unit, blackboard, move_animation)
	blackboard.move_state = "moving"
end

function BTChaosSorcererSkulkApproachAction:anim_event(unit, blackboard, anim)
	local skulk_data = blackboard.skulk_data
...
local TRIES = 15
function BTChaosSorcererSkulkApproachAction:get_skulk_target(unit, blackboard, teleporting)
	local action = blackboard.action
...
function BTChaosSorcererSkulkApproachAction:debug_show_skulk_circle(unit, blackboard)
	local action = blackboard.action
	local skulk_data = blackboard.skulk_data
...
function BTChaosSorcererSkulkApproachAction:update_dummie(unit, blackboard, t)
	return false
end
...
function BTChaosSorcererSkulkApproachAction:_update_vortex_search(unit, blackboard, t, vortex_data)
...
function BTChaosSorcererSkulkApproachAction._get_vortex_cast_position(unit, blackboard, vortex_data, physics_world)
	local action = blackboard.action
...
function BTChaosSorcererSkulkApproachAction:update_portal_search(unit, blackboard, t, portal_data)
...
function BTChaosSorcererSkulkApproachAction.get_portal_location_list(portal_data, center_position)
...
function BTChaosSorcererSkulkApproachAction.prepare_wall_search(portal_data, center_position)
...
function BTChaosSorcererSkulkApproachAction.evaluate_floor(portal_data, nav_world, center_pos, num_tries)
...
function BTChaosSorcererSkulkApproachAction.evaluate_wall(portal_data, nav_world, center_pos, num_tries)
...
function BTChaosSorcererSkulkApproachAction.try_next_portal_location(portal_data, nav_world, center_pos)
