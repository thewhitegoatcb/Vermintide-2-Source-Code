...
function BTRatlingGunnerShootAction:_create_nav_obstacles(unit, target_unit, nav_world, action)
...
function BTRatlingGunnerShootAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.anim_cb_attack_shoot_start_finished = nil
	blackboard.anim_cb_attack_shoot_random_shot = nil

	local drawer = Managers.state.debug:drawer({ mode = "retained", name = "BTRatlingGunnerShootAction" })
	drawer:reset()
...
function BTRatlingGunnerShootAction:run(unit, blackboard, t, dt)
	local data = blackboard.attack_pattern_data
...
function BTRatlingGunnerShootAction:_notify_attacking(self_unit, target_unit)
...
function BTRatlingGunnerShootAction:_notify_no_longer_attacking(self_unit, target_unit)
...
function BTRatlingGunnerShootAction:stop_shooting(unit, data)
...
function BTRatlingGunnerShootAction:_update_shooting(unit, blackboard, data, t, dt)
...
function BTRatlingGunnerShootAction:_start_shooting(blackboard, unit, data, t)
...
function BTRatlingGunnerShootAction:_update_target(unit, blackboard, action, data, t, dt)
...
function BTRatlingGunnerShootAction:_calculate_wanted_target_position(unit, target_unit, data)
...
function BTRatlingGunnerShootAction:_start_align_towards_target(unit, blackboard, data, target_unit, t)
	data.state = "align"
...
function BTRatlingGunnerShootAction:_end_align_towards_target(unit, data)
	data.state = "ready"
...
function BTRatlingGunnerShootAction:_update_align_towards_target(unit, blackboard, t, dt)
	local data = blackboard.attack_pattern_data
	local action = blackboard.action
	local target_unit = data.target_unit
...
function BTRatlingGunnerShootAction:_angle_to_speed(angle_left)
	if SLOW_DOWN_ANGLE < angle_left then
		do return MAX_SPEED end
...
function BTRatlingGunnerShootAction:_aim_at_target(unit, blackboard, t, dt)
	local data = blackboard.attack_pattern_data
	local action = blackboard.action
	local target_unit = data.target_unit
...
function BTRatlingGunnerShootAction:_remaining_angle(from, to)
...
function BTRatlingGunnerShootAction:_rotate_from_to(from, to, max_angle_speed, dt)
...
function BTRatlingGunnerShootAction:_fire_from_position_direction(blackboard, data)
...
function BTRatlingGunnerShootAction:_shoot(unit, blackboard)
	local action = blackboard.action
	local data = blackboard.attack_pattern_data
...
function BTRatlingGunnerShootAction:_create_bot_threat_box(unit, attack_data, duration)
	local self_pos = POSITION_LOOKUP [unit]
