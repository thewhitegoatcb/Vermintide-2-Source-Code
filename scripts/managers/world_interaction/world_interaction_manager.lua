...
function WorldInteractionManager:_add_water_ripple(pos, angle, material, random_size_diff, stretch_multiplier, ref_time, size, multiplier)
	...
	self._water_ripples [#self._water_ripples + 1] = { timer = 0,
		pos = Vector3Box(pos),
...
function WorldInteractionManager:_update_foliage(dt, t)
...
local TEXTURE_SIZE = { }
function WorldInteractionManager:_update_foliage_players(dt, t)
...
function WorldInteractionManager:_update_foliage_ai(local_player_unit, dt, t)
...
function WorldInteractionManager:destory() return end