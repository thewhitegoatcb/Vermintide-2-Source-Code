...
function BTVortexFlyAction:init(...)
	BTVortexFlyAction.super.init(self, ...)
end

BTVortexFlyAction.name = "BTVortexFlyAction"

function BTVortexFlyAction:enter(unit, blackboard, t)
...
function BTVortexFlyAction:leave(unit, blackboard, t, reason, destroy)
...
function BTVortexFlyAction:_move_to_destination(current_position, destination, locomotion_extension, dt, max_speed)
...
function BTVortexFlyAction:run(unit, blackboard, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
