...
function StartGameWindowWeavePanel:on_enter(params, offset)
...
function StartGameWindowWeavePanel:_create_ui_elements(params, offset)
...
function StartGameWindowWeavePanel:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowWeavePanel")
	self._ui_animator = nil
end

function StartGameWindowWeavePanel:update(dt, t)
...
function StartGameWindowWeavePanel:post_update(dt, t)
	self:_handle_input(dt, t)
end

function StartGameWindowWeavePanel:_update_animations(dt)
...
function StartGameWindowWeavePanel:_is_button_pressed(widget)
	local content = widget.content
...
function StartGameWindowWeavePanel:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function StartGameWindowWeavePanel:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowWeavePanel:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowWeavePanel:_is_button_selected(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.is_selected
end

function StartGameWindowWeavePanel:_handle_input(dt, t)
	local parent = self._parent
...
function StartGameWindowWeavePanel:_on_panel_button_selected(index)
	local parent = self._parent
...
function StartGameWindowWeavePanel:_set_selected_option(index)
...
function StartGameWindowWeavePanel:_update_selected_option()
	local parent = self._parent
...
function StartGameWindowWeavePanel:_draw(dt)
...
function StartGameWindowWeavePanel:_play_sound(event)
	self._parent:play_sound(event)
end

function StartGameWindowWeavePanel:_setup_input_buttons()
	local input_service = self._parent:window_input_service()
...
function StartGameWindowWeavePanel:_handle_gamepad_activity()
...
function StartGameWindowWeavePanel:_set_text_button_size(widget, width)
	local ui_scenegraph = self._ui_scenegraph
...
function StartGameWindowWeavePanel:_get_text_width(text_style, text)
...
function StartGameWindowWeavePanel:_set_text_button_horizontal_position(widget, x_position)
	local offset = widget.offset
	offset [1] = x_position
end

function StartGameWindowWeavePanel:_animate_title_entry(widget, dt)
	local content = widget.content
	local style = widget.style
	local hotspot = content.button_hotspot
...
function StartGameWindowWeavePanel:_start_panel_selection_animation(previous_selected_index, new_selected_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowWeavePanel:_update_panel_selection_animation(dt)
