...
function OrbPickupUnitExtension:init(extension_init_context, unit, extension_init_data)
	...
	self._buff_params = { attacker_unit = unit }
end

function OrbPickupUnitExtension:game_object_initialized(unit, go_id)
	return end

function OrbPickupUnitExtension:extensions_ready(world, unit)
	return end

function OrbPickupUnitExtension:destroy()
	return end

function OrbPickupUnitExtension:update(unit, input, dt, context, t)
	if self._done then
		return
	end
...
function OrbPickupUnitExtension:get_orb_flight_target_position()
