...
function BTStaggerAction:enter(unit, blackboard, t)
...
function BTStaggerAction:_select_animation(unit, blackboard, impact_vec, stagger_anims)
...
function BTStaggerAction:clean_blackboard(blackboard)
...
function BTStaggerAction:leave(unit, blackboard, t, reason, destroy)
...
function BTStaggerAction:run(unit, blackboard, t, dt)
...
function BTStaggerAction:anim_cb_push_cancel(unit, blackboard)
