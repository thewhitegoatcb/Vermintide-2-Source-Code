...
TwitchVoteTemplates.twitch_vote_activate_splitting_enemies = { text = "display_name_mutator_splitting_enemies", cost = 200, texture_id = "twitch_icon_splitting_enemies", description = "description_mutator_splitting_enemies",
...
TwitchVoteTemplates.twitch_vote_activate_leash = { text = "display_name_mutator_leash", cost = 200, texture_id = "twitch_icon_leash", description = "description_mutator_leash",
...
TwitchVoteTemplates.twitch_vote_activate_slayer_curse = { text = "display_name_mutator_slayer_curse", cost = 200, texture_id = "twitch_icon_slayer_curse", description = "description_mutator_slayer_curse",
...
TwitchVoteTemplates.twitch_vote_activate_bloodlust = { text = "display_name_mutator_bloodlust", cost = 200, texture_id = "twitch_icon_bloodlust", description = "description_mutator_bloodlust",
...
TwitchVoteTemplates.twitch_vote_activate_realism = { text = "display_name_mutator_realism", cost = 200, texture_id = "twitch_icon_realism", description = "description_mutator_realism",
...
TwitchVoteTemplates.twitch_vote_activate_darkness = { text = "display_name_mutator_darkness", cost = 200, texture_id = "twitch_icon_darkness", description = "description_mutator_darkness",
	...
	condition_func = function (current_vote)
		return not Managers.state.game_mode._mutator_handler:has_activated_mutator("darkness") and
		not Managers.state.game_mode._mutator_handler:has_activated_mutator("twitch_darkness") and
		not Managers.state.game_mode._mutator_handler:has_activated_mutator("night_mode") and
		Managers.level_transition_handler:get_current_environment_variation_id() ~= 0 and
		not twitch_settings.disable_mutators
	end,
	on_success = function (is_server)
		if is_server then
			local mutator_handler = Managers.state.game_mode._mutator_handler
...
TwitchVoteTemplates.twitch_vote_activate_ticking_bomb = { text = "display_name_mutator_ticking_bomb", cost = 100, texture_id = "twitch_icon_ticking_bomb", description = "description_mutator_ticking_bomb",
...
TwitchVoteTemplates.twitch_vote_activate_lightning_strike = { text = "display_name_lightning_strike", cost = 100, texture_id = "twitch_icon_heavens_lightning", description = "description_mutator_lightning_strike",
...
TwitchVoteTemplates.twitch_vote_activate_chasing_spirits = { text = "display_name_chasing_spirits", cost = 100, texture_id = "twitch_icon_death_spirits", description = "description_mutator_chasing_spirits",
...
TwitchVoteTemplates.twitch_vote_activate_flames = { text = "display_name_flames", cost = 100, texture_id = "twitch_icon_fire_burn", description = "description_mutator_flames",
