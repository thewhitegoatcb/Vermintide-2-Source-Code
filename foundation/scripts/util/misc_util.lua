IDENTITY = IDENTITY or function (x) return x end
NOP = NOP or function () return end
TABLE_NEW = TABLE_NEW or function () return { } end
CONST = CONST or setmetatable({ }, {
	__call = function (self, x) return x == nil and NOP or self [x] end,
...
function varargs.join(delimiter, ...)
	local output = ""
