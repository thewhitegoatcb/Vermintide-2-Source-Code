...
function PlayerCharacterStateLeaveLedgeHangingPullUp:init(character_state_init_context)
...
function PlayerCharacterStateLeaveLedgeHangingPullUp:on_enter_animation_event()
	local unit = self.unit
	CharacterStateHelper.play_animation_event(unit, "hanging_exit")
end

function PlayerCharacterStateLeaveLedgeHangingPullUp:on_enter(unit, input, dt, context, t, previous_state, params)
	local unit = self.unit
...
function PlayerCharacterStateLeaveLedgeHangingPullUp:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateLeaveLedgeHangingPullUp:update(unit, input, dt, context, t)
	local csm = self.csm
	local unit = self.unit
	local input_extension = self.input_extension
	local status_extension = self.status_extension
...
function PlayerCharacterStateLeaveLedgeHangingPullUp:calculate_end_position()
	local unit = self.unit
