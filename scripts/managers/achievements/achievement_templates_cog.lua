...
achievements.cog_penta_bomb = { name = "achv_cog_penta_bomb_name", required_dlc_extra = "cog", desc = "achv_cog_penta_bomb_desc", display_completion_ui = true, icon = "achievement_trophy_cog_penta_bomb", required_dlc = "cog_upgrade",
...
achievements.cog_air_bomb = { name = "achv_cog_air_bomb_name", required_dlc_extra = "cog", desc = "achv_cog_air_bomb_desc", display_completion_ui = true, icon = "achievement_trophy_cog_air_bomb", required_dlc = "cog_upgrade",
...
achievements.cog_kill_barrage = { name = "achv_cog_kill_barrage_name", required_dlc_extra = "cog", desc = "achv_cog_kill_barrage_desc", display_completion_ui = true, icon = "achievement_trophy_cog_kill_barrage", required_dlc = "cog_upgrade",
	...
	events = { "register_kill", "crank_gun_fire" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.cog_all_kill_barrage = { name = "achv_cog_all_kill_barrage_name", required_dlc_extra = "cog", desc = "achv_cog_all_kill_barrage_desc", display_completion_ui = true, icon = "achievement_trophy_cog_all_kill_barrage", required_dlc = "cog_upgrade",
...
achievements.cog_climb_kill = { required_dlc = "cog", name = "achv_cog_climb_kill_name", display_completion_ui = true, desc = "achv_cog_climb_kill_desc", required_career = "dr_engineer", icon = "achievement_trophy_cog_climb_kill", always_run = true,
...
achievements.cog_long_bomb = { name = "achv_cog_long_bomb_name", required_dlc_extra = "cog", desc = "achv_cog_long_bomb_desc", display_completion_ui = true, icon = "achievement_trophy_cog_long_bomb", required_dlc = "cog_upgrade",
	...
	events = { "on_grenade_thrown", "register_kill" },
	completed = function (statistics_db, stats_id, template_data)
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		if event_name == "on_grenade_thrown" then
			...
			if not throw_unit then return false end
...
achievements.cog_steam_alt = { name = "achv_cog_steam_alt_name", required_dlc_extra = "cog", desc = "achv_cog_steam_alt_desc", display_completion_ui = true, icon = "achievement_trophy_cog_steam_alt", required_dlc = "cog_upgrade",
	...
	events = { "steam_alt_fire", "register_damage" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.cog_bomb_grind = { name = "achv_cog_bomb_grind_name", required_dlc_extra = "cog", desc = "achv_cog_bomb_grind_desc", display_completion_ui = true, icon = "achievement_trophy_cog_bomb_grind", required_dlc = "cog_upgrade",
...
achievements.cog_chain_headshot = { display_completion_ui = true, name = "achv_cog_chain_headshot_name", required_dlc = "cog", icon = "achievement_trophy_cog_chain_headshot", desc = "achv_cog_chain_headshot_desc",





	events = { "on_hit", "ammo_used" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.cog_pistol_headshot_grind = { name = "achv_cog_pistol_headshot_grind_name", desc = "achv_cog_pistol_headshot_grind_desc", display_completion_ui = true, icon = "achievement_trophy_cog_pistol_headshot_grind", required_dlc = "cog",
...
achievements.cog_clutch_pump = { name = "achv_cog_clutch_pump_name", desc = "achv_cog_clutch_pump_desc", display_completion_ui = true, icon = "achievement_trophy_cog_clutch_pump", required_dlc = "cog",
...
achievements.cog_hammer_cliff_push = { name = "achv_cog_hammer_cliff_push_name", desc = "achv_cog_hammer_cliff_push_desc", display_completion_ui = true, icon = "achievement_trophy_cog_hammer_cliff_push", required_dlc = "cog",
...
achievements.cog_only_crank = { name = "achv_cog_only_crank_name", display_completion_ui = true, required_dlc = "cog", icon = "achievement_trophy_cog_only_crank", desc = "achv_cog_only_crank_desc",





	events = { "register_kill", "register_completed_level" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.cog_exploding_barrel_kills = { display_completion_ui = true, name = "achv_cog_exploding_barrel_kills_name", required_dlc = "cog", icon = "achievement_trophy_cog_exploding_barrel_kills", desc = "achv_cog_exploding_barrel_kills_desc",





	events = { "register_kill", "explosive_barrel_destroyed" },
	completed = function (statistics_db, stats_id, template_data)
		if statistics_db:get_persistent_stat(stats_id, "cog_exploding_barrel_kills") > 0 then print("completed") end
...
achievements.cog_long_crank_fire = { display_completion_ui = true, name = "achv_cog_long_crank_fire_name", required_dlc = "cog", icon = "achievement_trophy_cog_long_crank_fire", desc = "achv_cog_long_crank_fire_desc",





	events = { "crank_gun_fire_start", "crank_gun_fire" },
	completed = function (statistics_db, stats_id, template_data)
...
local kill_register_weapons = table.mirror_array_inplace({ "bardin_engineer_career_skill_weapon_heavy", "bardin_engineer_career_skill_weapon", "dr_steam_pistol", "dr_2h_cog_hammer" })

achievements.cog_kill_register = { display_completion_ui = false, required_dlc = "cog",
...
achievements.cog_missing_cog = { required_dlc = "cog", name = "achv_cog_missing_cog_name", allow_in_inn = true, display_completion_ui = true, icon = "achievement_trophy_cog_missing_cog", desc = "achv_cog_missing_cog_desc",
...
add_multi_stat_count_challenge(achievements, "cog_crank_kill", { "cog_kills_bardin_engineer_career_skill_weapon", "cog_kills_bardin_engineer_career_skill_weapon_heavy" }, 3000, "achievement_trophy_cog_crank_kill", "cog_upgrade")
...
add_weapon_kills_per_breeds_challenge(achievements, "cog_crank_kill_ratling", { "bardin_engineer_career_skill_weapon_heavy", "bardin_engineer_career_skill_weapon" }, { "skaven_ratling_gunner" }, 15, "achievement_trophy_cog_crank_kill_ratling", "cog", true, nil, nil)


add_weapon_kills_per_breeds_challenge(achievements, "cog_steam_elite_kill", { "dr_steam_pistol" }, elite_special_breeds, 150, "achievement_trophy_cog_steam_elite_kill", "cog_upgrade", true, nil, nil)
add_weapon_kills_per_breeds_challenge(achievements, "cog_hammer_kill_storm", { "dr_2h_cog_hammer" }, { "chaos_vortex_sorcerer" }, 1, nil, "cog_upgrade", false, nil, nil)
add_weapon_kills_per_breeds_challenge(achievements, "cog_hammer_kill_leech", { "dr_2h_cog_hammer" }, { "chaos_corruptor_sorcerer" }, 1, nil, "cog_upgrade", false, nil, nil)
add_weapon_kills_per_breeds_challenge(achievements, "cog_hammer_kill_hale", { "dr_2h_cog_hammer" }, { "chaos_exalted_sorcerer" }, 1, nil, "cog_upgrade", false, nil, nil)
...
local all_challenges = { "cog_climb_kill", "cog_chain_headshot", "cog_crank_kill_ratling", "cog_pistol_headshot_grind", "cog_clutch_pump", "cog_hammer_cliff_push", "cog_only_crank", "cog_exploding_barrel_kills", "cog_long_crank_fire", "cog_missing_cog", "cog_complete_100_missions_dr_engineer", "cog_penta_bomb", "cog_crank_kill", "cog_kill_barrage", "cog_all_kill_barrage", "cog_long_bomb", "cog_hammer_axe_kills", "cog_wizard_hammer", "cog_steam_elite_kill", "cog_steam_alt", "cog_bomb_grind" }
...
local wizard_hammerer = { "cog_hammer_kill_storm", "cog_hammer_kill_leech", "cog_hammer_kill_hale" }
