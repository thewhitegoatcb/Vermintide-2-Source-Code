...
function HeroWindowCosmeticsLoadoutConsole:on_enter(params, offset)
...
function HeroWindowCosmeticsLoadoutConsole:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowCosmeticsLoadoutConsole:create_ui_elements(params, offset)
...
function HeroWindowCosmeticsLoadoutConsole:on_exit(params)
...
function HeroWindowCosmeticsLoadoutConsole:_input_service()
...
function HeroWindowCosmeticsLoadoutConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCosmeticsLoadoutConsole:post_update(dt, t)

	return end

function HeroWindowCosmeticsLoadoutConsole:_update_input_description()
...
function HeroWindowCosmeticsLoadoutConsole:_update_animations(dt)
...
function HeroWindowCosmeticsLoadoutConsole:_is_button_pressed(widget)
...
function HeroWindowCosmeticsLoadoutConsole:_handle_gamepad_input(dt, t)
...
function HeroWindowCosmeticsLoadoutConsole:_handle_input(dt, t)
	local parent = self.parent
...
function HeroWindowCosmeticsLoadoutConsole:_update_selected_cosmetic_slot_index()
...
function HeroWindowCosmeticsLoadoutConsole:_update_loadout_sync()
	local parent = self.parent
...
function HeroWindowCosmeticsLoadoutConsole:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCosmeticsLoadoutConsole:draw(dt)
...
function HeroWindowCosmeticsLoadoutConsole:_play_sound(event)
	self.parent:play_sound(event)
end



function HeroWindowCosmeticsLoadoutConsole:_setup_slot_icons()
...
function HeroWindowCosmeticsLoadoutConsole:_populate_loadout()
...
function HeroWindowCosmeticsLoadoutConsole:_equip_item_presentation(item, slot)
...
function HeroWindowCosmeticsLoadoutConsole:_clear_item_slot(slot)
...
function HeroWindowCosmeticsLoadoutConsole:_is_equipment_slot_right_clicked()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_is_equipment_slot_pressed()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_is_equipment_slot_hovered()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_set_equipment_slot_selected(row_index)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_enable_selection_highlight()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_disable_selection_highlight()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_is_equipment_slot_hovered_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadoutConsole:_highlight_equipment_slot_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
	local style = widget.style
