...
function BTSelector_pet_skeleton_armored:init(...)
	BTSelector_pet_skeleton_armored.super.init(self, ...)
	self._children = { }
end

function BTSelector_pet_skeleton_armored:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_pet_skeleton_armored:run(unit, blackboard, t, dt)
...
function BTSelector_pet_skeleton_armored:add_child(node)
