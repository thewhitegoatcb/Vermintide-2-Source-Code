...
local RPCS = { "rpc_interaction_approved", "rpc_interaction_denied", "rpc_interaction_completed", "rpc_interaction_abort", "rpc_sync_interactable_used_state", "rpc_sync_interaction_state" }
...
local extensions = { "GenericHuskInteractorExtension", "GenericUnitInteractorExtension" }




function InteractionSystem:init(entity_system_creation_context, system_name)
...
function InteractionSystem:destroy()
	self.network_event_delegate:unregister(self)
end

function InteractionSystem:rpc_interaction_approved(channel_id, interaction_id, interactor_go_id, interactable_go_id, is_level_unit)
...
function InteractionSystem:rpc_interaction_denied(channel_id, interactor_go_id)
...
function InteractionSystem:rpc_interaction_completed(channel_id, interactor_go_id, interaction_result)
...
function InteractionSystem:rpc_interaction_abort(channel_id, interactor_go_id)
...
function InteractionSystem:rpc_sync_interaction_state(channel_id, unit_id, state_id, interaction_type_id, interactable_unit_id, start_time, duration, is_level_unit)
...
function InteractionSystem:rpc_sync_interactable_used_state(channel_id, interactable_unit_id, is_level_object, is_used)
