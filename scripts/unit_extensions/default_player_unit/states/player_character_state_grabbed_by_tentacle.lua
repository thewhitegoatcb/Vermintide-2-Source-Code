...
function PlayerCharacterStateGrabbedByTentacle:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "grabbed_by_tentacle")
end

function PlayerCharacterStateGrabbedByTentacle:on_enter(unit, input, dt, context, t, previous_state)
...
function PlayerCharacterStateGrabbedByTentacle:on_exit(unit, input, dt, context, t, next_state)
	local status_extension = self.status_extension
...
PlayerCharacterStateGrabbedByTentacle.states = {
	...
	portal_consume = {
		enter = function (parent, unit, t)
			...
			local params = { animation = "tentacle_portal_struggle_dead",
...
function PlayerCharacterStateGrabbedByTentacle:get_drag_velocity(player_pos, t, dt)
...
function PlayerCharacterStateGrabbedByTentacle:update(unit, input, dt, context, t)
	local csm = self.csm
