...
function ControllerSettingsView:init(ingame_ui_context)
	self.ui_renderer = ingame_ui_context.ui_renderer
	self.input_manager = ingame_ui_context.input_manager
	self.ingame_ui = ingame_ui_context.ingame_ui
end

local controller_settings_to_add = { { "Player",
		PlayerControllerKeymaps }, { "ingame_menu",
		IngameMenuKeymaps }, { "chat_input",
		ChatControllerSettings } }


local scenegraph_definition = {
	root = { is_root = true, position = { 0, 0, UILayer.default }, size = { 1920, 1080 } },
	widget_start = { vertical_alignment = "top", parent = "root" } }
...
UIElements.KeyBindElement = {
	passes = { { pass_type = "hover", content_id = "button_hotspot" },
		...
		{ style_id = "hover_text", pass_type = "text", text_id = "text_field",
...
local widget_definition = { scenegraph_id = "",
	element = UIElements.KeyBindElement,
	content = { text_field = "TEST",

		button_hotspot = { } },


	style = {
		text = { font_size = 14, font_type = "hell_shark", horizontal_alignment = "center",
			text_color = Colors.color_definitions.white },




		hover_text = { font_size = 14, font_type = "hell_shark", horizontal_alignment = "center",
...
function ControllerSettingsView:create_ui_elements()
	local ui_widgets = { }
	local n_widgets = 0
	...
	for _, settings_data in ipairs(controller_settings_to_add) do
		...
		scenegraph_definition [service_name] = { parent = "widget_start",

			offset = { 0, -n_widgets * 16, 1 },
			size = { 1920, 16 } }
		...
		for map_name, _ in pairs(settings_data [2]) do
			...
			scenegraph_definition [index_name] = { parent = "widget_start",
...
function ControllerSettingsView:on_enter()
	self:create_ui_elements()
end

function ControllerSettingsView:destroy()
	return end

function ControllerSettingsView:update(dt)
