...
function ProjectileLinearSphereSweepImpactUnitExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileLinearSphereSweepImpactUnitExtension:extensions_ready(world, unit)
	self.locomotion_extension = ScriptUnit.extension(unit, "projectile_locomotion_system")
end

function ProjectileLinearSphereSweepImpactUnitExtension:update(unit, input, dt, context, t)
...
function ProjectileLinearSphereSweepImpactUnitExtension:_valid_target(unit, hit_unit, hit_actor)
