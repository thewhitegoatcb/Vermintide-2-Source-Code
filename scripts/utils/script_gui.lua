...
function ScriptGUI.irect(gui, resx, resy, x1, y1, x2, y2, layer, color)
...
function ScriptGUI.itext(gui, resx, resy, text, font_mtrl, font_size, font, x1, y1, layer, color)
	Gui.text(gui, text, font_mtrl, font_size, font, Vector3(x1 * resx, ( 1 - y1 ) * resy, layer), color)
end

function ScriptGUI.itext_next_xy(gui, resx, resy, text, font_mtrl, font_size, font, x1, y1, layer, color)
	Gui.text(gui, text, font_mtrl, font_size, font, Vector3(x1 * resx, ( 1 - y1 ) * resy, layer), color)
...
function ScriptGUI.icrect(gui, resx, resy, x1, y1, x2, y2, layer, color)
...
function ScriptGUI.ictext(gui, resx, resy, text, font_mtrl, font_size, font, x1, y1, layer, color)
	Gui.text(gui, text, font_mtrl, font_size, font, Vector3(x1, resy - y1, layer), color)
end


function ScriptGUI.hud_line(gui, p1, p2, layer, line_width, color)
...
function ScriptGUI.hud_iline(gui, resx, resy, p1, p2, layer, line_width, color)
