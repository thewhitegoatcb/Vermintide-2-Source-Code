...
function ActionCareerDRRanger:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerDRRanger:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionCareerDRRanger:_create_smoke_screen()
...
function ActionCareerDRRanger:client_owner_post_update(dt, t, world, can_damage)
	if self.thrown then
		return
	end
...
function ActionCareerDRRanger:_stagger_explosion()
	local owner_unit = self.owner_unit
...
function ActionCareerDRRanger:_throw()
...
function ActionCareerDRRanger:finish(reason)
