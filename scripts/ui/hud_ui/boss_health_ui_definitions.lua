...
local scenegraph_definition = {
	...
	pivot = { vertical_alignment = "bottom", parent = "pivot_parent", horizontal_alignment = "left",
	...
	pivot_dragger = { vertical_alignment = "top", parent = "pivot", horizontal_alignment = "left",
...
local function create_health_bar_widget()
	...
	local passes = { { pass_type = "texture", style_id = "lower_marked_bg", texture_id = "lower_marked_bg",
		...
		{ pass_type = "texture", style_id = "lower_normal_bg", texture_id = "lower_normal_bg",
		...
		{ pass_type = "texture", style_id = "marked_portrait_frame", texture_id = "marked_portrait_frame",
		...
		{ pass_type = "texture", style_id = "skull_divider1", texture_id = "skull_divider1",
		...
		{ pass_type = "texture", style_id = "skull_divider2", texture_id = "skull_divider2",
		...
		{ pass_type = "texture", style_id = "skull_divider3", texture_id = "skull_divider3",
		...
		{ pass_type = "texture", style_id = "skull_divider4", texture_id = "skull_divider4",
	...
	local content = { skull_divider1 = "skull_divider", skull_divider4 = "skull_divider", lower_marked_bg = "boss_hp_bar_marked_bg", skull_divider3 = "skull_divider", lower_normal_bg = "boss_hp_bar_bottom", skull_divider2 = "skull_divider", marked_portrait_frame = "unit_frame_portrait_enemy_marked" }
	...
	content [bar_name] = { texture_id = "boss_hp_bar_fill",
	...
	content [healing_bar_name] = { texture_id = "boss_hp_bar_healing",
	...
	content [dead_space_bar_name] = { texture_id = "boss_hp_bar_dead_space",
	...
	style [dead_space_bar_divider_name] = { default_width_offset = 11,
		color = table.clone(default_color),

		offset = { 429, bar_y - 8, 7 },
		size = { 21, 29 } }
	...
	style [bar_edge_name] = { default_width_offset = 7,
		color = table.clone(default_color),
	...
	content [title_text] = ""
	style [title_text] = { vertical_alignment = "top", upper_case = false, horizontal_alignment = "left", font_size = 24, font_type = "hell_shark",
	...
	style [title_text_shadow] = { vertical_alignment = "top", upper_case = true, horizontal_alignment = "left", font_size = 24, font_type = "hell_shark",
	...
	style [attribute_text] = { vertical_alignment = "top", upper_case = false, horizontal_alignment = "left", font_size = 16, font_type = "hell_shark",
