...
function BTSelector_storm_vermin_commander:init(...)
	BTSelector_storm_vermin_commander.super.init(self, ...)
	self._children = { }
end

function BTSelector_storm_vermin_commander:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_storm_vermin_commander:run(unit, blackboard, t, dt)
...
function BTSelector_storm_vermin_commander:add_child(node)
