...
function PlayerCharacterStateLeaping:init(character_state_init_context)
...
function PlayerCharacterStateLeaping:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateLeaping:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateLeaping:update(unit, input, dt, context, t)
	local csm = self.csm
...
function PlayerCharacterStateLeaping:_update_distance_travelled()
...
function PlayerCharacterStateLeaping:leap(unit, dt, t)
	local locomotion_extension = self.locomotion_extension
...
function PlayerCharacterStateLeaping:teleleap(unit, dt, t)
	local locomotion_extension = self.locomotion_extension
...
function PlayerCharacterStateLeaping:_teleport_to_with_collision(start_pos, end_pos, rot, collision_filter)
	local locomotion_extension = self.locomotion_extension
...
function PlayerCharacterStateLeaping:_update_movement(unit, dt, t)
...
function PlayerCharacterStateLeaping:_reset_speed_and_gravity(unit)
	local locomotion_extension = self.locomotion_extension
...
function PlayerCharacterStateLeaping:_finish(unit, t, aborted, final_position)
	local locomotion_extension = self.locomotion_extension
	local first_person_extension = self.first_person_extension
	local leap_data = self._leap_data
...
function PlayerCharacterStateLeaping:_start_leap(unit, t)
	local locomotion_extension = self.locomotion_extension
	local first_person_extension = self.first_person_extension
	local leap_data = self._leap_data
