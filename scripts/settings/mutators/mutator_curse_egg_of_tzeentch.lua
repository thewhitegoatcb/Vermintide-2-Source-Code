...
local MONSTERS = { "chaos_troll", "chaos_spawn", "skaven_rat_ogre", "skaven_stormfiend", "beastmen_minotaur" }
...
local SOUND_EVENTS = { EGG_DESTROYED = "Play_curse_egg_of_tzeentch_alert_egg_destroyed", ALERT_MEDIUM = "Play_curse_egg_of_tzeentch_alert_medium", ALERT_LOW = "Play_curse_egg_of_tzeentch_alert_low", EGG_EXPLOSION = "Play_curse_egg_of_tzeentch_explosion", ALERT_HIGH = "Play_curse_egg_of_tzeentch_alert_high" }
...
local EGG_EXTENSION_INIT_DATA = {
	buff_system = { breed = "n/a",
		...
		initial_buff_names = { "objective_unit", "health_bar" } },

	health_system = { },


	death_system = { death_reaction_template = "destructible_buff_objective_unit" },


	hit_reaction_system = { hit_reaction_template = "level_object" },


	timed_spawner_system = { max_spawn_amount = 1 } }
...
return { display_name = "curse_egg_of_tzeentch_name", icon = "deus_curse_tzeentch_01", description = "curse_egg_of_tzeentch_desc", curse_package_name = "resource_packages/mutators/mutator_curse_egg_of_tzeentch",
	...
	server_update_function = function (context, data, dt, t)
		...
		if not data.timer and
		num_missions >= 2 and
		ALIVE [data.egg_unit] and mission_system:has_active_mission(EGG_MISSION_NAME) then
		...
		function timed_spawner_system.cb_unit_spawned_function(unit)
		...
		data.egg_unit = spawn_egg_on_path(
		conflict_director,
		data.unit_spawner,
		data.nav_world,
		data.mission_system,
		egg_extension_init_data,
