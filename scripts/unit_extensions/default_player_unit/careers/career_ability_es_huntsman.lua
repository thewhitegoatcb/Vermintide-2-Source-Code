...
function CareerAbilityESHuntsman:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityESHuntsman:extensions_ready(world, unit)
...
function CareerAbilityESHuntsman:destroy()
	return end

function CareerAbilityESHuntsman:update(unit, input, dt, context, t)
...
function CareerAbilityESHuntsman:stop(reason)
	if self._is_priming then
		self:_stop_priming()
	end
end

function CareerAbilityESHuntsman:_ability_available()
...
function CareerAbilityESHuntsman:force_trigger_ability()
	local skip_cooldown = true
	self:_run_ability(skip_cooldown)
end

function CareerAbilityESHuntsman:_run_ability(skip_cooldown)
	...
	local server_buff_names = { "markus_huntsman_activated_ability", "markus_huntsman_activated_ability_headshot_multiplier" }



	local local_buff_names = { }
	if talent_extension:has_talent("markus_huntsman_activated_ability_improved_stealth") then
		local_buff_names = { "markus_huntsman_activated_ability_increased_zoom", "markus_huntsman_activated_ability_increased_reload_speed", "markus_huntsman_activated_ability_decrease_move_speed", "markus_huntsman_activated_ability_decrease_crouch_move_speed", "markus_huntsman_activated_ability_decrease_walk_move_speed", "markus_huntsman_activated_ability_decrease_dodge_speed", "markus_huntsman_activated_ability_decrease_dodge_distance" }
	...
	elseif talent_extension:has_talent("markus_huntsman_activated_ability_duration") then
		local_buff_names = { "markus_huntsman_activated_ability_increased_zoom_duration", "markus_huntsman_activated_ability_increased_reload_speed_duration", "markus_huntsman_activated_ability_decrease_move_speed_duration", "markus_huntsman_activated_ability_decrease_crouch_move_speed_duration", "markus_huntsman_activated_ability_decrease_walk_move_speed_duration", "markus_huntsman_activated_ability_decrease_dodge_speed_duration", "markus_huntsman_activated_ability_decrease_dodge_distance_duration", "markus_huntsman_end_activated_on_hit_duration" }
		...
		server_buff_names = { "markus_huntsman_activated_ability_duration", "markus_huntsman_activated_ability_headshot_multiplier_duration" }
	else



		local_buff_names = { "markus_huntsman_activated_ability_increased_zoom", "markus_huntsman_activated_ability_increased_reload_speed", "markus_huntsman_activated_ability_decrease_move_speed", "markus_huntsman_activated_ability_decrease_crouch_move_speed", "markus_huntsman_activated_ability_decrease_walk_move_speed", "markus_huntsman_activated_ability_decrease_dodge_speed", "markus_huntsman_activated_ability_decrease_dodge_distance", "markus_huntsman_end_activated_on_hit" }
		...
		server_buff_names = { "markus_huntsman_activated_ability", "markus_huntsman_activated_ability_headshot_multiplier" }
	end
...
function CareerAbilityESHuntsman:_play_vo()
	local owner_unit = self.owner_unit
