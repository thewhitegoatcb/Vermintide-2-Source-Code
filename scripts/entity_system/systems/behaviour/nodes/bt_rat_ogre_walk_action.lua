...
function BTRatOgreWalkAction:init(...)
...
function BTRatOgreWalkAction:enter(unit, blackboard, t)
...
function BTRatOgreWalkAction:leave(unit, blackboard, t, reason, destroy)
...
function BTRatOgreWalkAction:run(unit, blackboard, t, dt)
...
local hit_units = { }
function BTRatOgreWalkAction:follow(unit, t, dt, blackboard, locomotion)
...
function BTRatOgreWalkAction:find_patrol_goal(unit, blackboard, distance_passed_player)
