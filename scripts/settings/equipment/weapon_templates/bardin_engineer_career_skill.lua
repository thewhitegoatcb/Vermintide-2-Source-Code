...
local weapon_template = {
	actions = {
		action_one = {
			default = { total_time_secondary = 1.75, anim_event_secondary = "reload", kind = "career_dummy", anim_event = "attack_charge", total_time = 1.4,





				allowed_chain_actions = { { sub_action = "spin", start_time = 0, action = "action_one", hold_allowed = true, input = "action_one" },
			...
			spin = { charge_sound_stop_event = "Stop_player_engineer_engine_loop", visual_spinup_min = 0, kind = "career_dr_four_spin", override_visual_spinup = true, charge_sound_name = "Play_player_engineer_engine_charge", windup_max = 0, initial_windup = 0, visual_spinup_max = 0.3, charge_sound_husk_name = "Play_player_engineer_engine_charge_husk", windup_speed = 0, anim_end_event = "attack_finished", hold_input = "action_one_hold", anim_event = "attack_charge", charge_sound_husk_stop_event = "Stop_player_engineer_engine_loop_husk",
				...
				allowed_chain_actions = { { sub_action = "fire", action = "action_one", hold_allowed = true, input = "action_one",
						start_time = spinup_time }, { sub_action = "default", start_time = 0, action = "action_wield", input = "action_wield" },
					{ sub_action = "default", start_time = 0, action = "weapon_reload", hold_allowed = true, input = "weapon_reload" } },
			...
			fire = { kind = "action_selector",

				on_chain_keep_audio_loops = { "engineer_weapon_spin" },
				conditional_actions = { { sub_action = "armor_pierce_fire",
			...
			base_fire = { alert_sound_range_hit = 1.5, charge_value = "bullet_hit", damage_profile = "engineer_ability_shot", kind = "career_dr_four", shot_count = 1, action_priority = 0, fire_time = 0, anim_end_event = "attack_finished", anim_event_secondary = "reload", total_time_secondary = 1.75, apply_recoil = true, headshot_multiplier = 2, aim_assist_ramp_multiplier = 0.1, additional_critical_strike_chance = 0, aim_assist_max_ramp_multiplier = 0.3, aim_assist_auto_hit_chance = 0.5, fire_sound_event = "Play_player_engineer_shooting_burst", aim_assist_ramp_decay_delay = 0.2, critical_hit_effect = "bullet_critical_impact", anim_event = "attack_shoot_charged", reload_when_out_of_ammo = true, continuous_buff_check = true, num_layers_spread = 1, hit_effect = "bullet_impact", ranged_attack = true, alert_sound_range_fire = 10, hold_input = "action_one_hold",
				...
				allowed_chain_actions = { { sub_action = "charged", start_time = 0, action = "action_two", hold_allowed = true, release_required = "action_one_hold", input = "action_two" },
					{ sub_action = "default", start_time = 0, action = "weapon_reload", hold_allowed = true, input = "weapon_reload" },
					{ sub_action = "default", action = "action_wield", input = "action_wield",
				...
				recoil_settings = { horizontal_climb = 0, restore_duration = 0.25, vertical_climb = 0.8, climb_duration = 0.1,
		...
		action_two = {
			default = { charge_sound_stop_event = "Stop_player_engineer_engine_loop", anim_end_event = "attack_finished", visual_spinup_min = 0.4, kind = "career_dr_four_spin", charge_sound_name = "Play_player_engineer_engine_charge", override_visual_spinup = true, windup_max = 0, initial_windup = 0, visual_spinup_time = 0.3, visual_spinup_max = 0.5, charge_sound_husk_name = "Play_player_engineer_engine_loop_husk", windup_speed = 0, hold_input = "action_two_hold", anim_event = "attack_charge_loop", charge_sound_husk_stop_event = "Stop_player_engineer_engine_loop_husk",
				...
				allowed_chain_actions = { { sub_action = "charged", action = "action_two", hold_allowed = true, input = "action_two",
						start_time = spinup_time }, { sub_action = "default", start_time = 0, action = "weapon_reload", hold_allowed = true, input = "weapon_reload" },
			...
			charged = { kind = "career_dr_four_spin", anim_end_event = "attack_finished", action_priority = 0, windup_max = 1, initial_windup = 0, hold_input = "action_two_hold", anim_event = "attack_charge_end", windup_speed = 0.2,
				...
				allowed_chain_actions = { { sub_action = "fire", action = "action_one", hold_allowed = true, input = "action_one",
						start_time = base_chain_time }, { sub_action = "default", start_time = 0, action = "weapon_reload", hold_allowed = true, input = "weapon_reload" },
					{ sub_action = "default", start_time = 0, action = "action_wield", input = "action_wield" } },
		...
		weapon_reload = {
			default = { charge_sound_stop_event = "Stop_player_engineer_steam_loop", stop_at_max = true, anim_end_event = "cooldown_end", kind = "career_dr_four_charge", hold_input = "weapon_reload_hold", do_not_validate_with_hold = false, charge_sound_husk_stop_event = "Stop_player_engineer_steam_loop_husk", charge_sound_husk_name = "Play_player_engineer_steam_loop_husk", minimum_hold_time = 0.5, charge_time = 3, uninterruptible = true, anim_event = "cooldown_start", charge_sound_name = "Play_player_engineer_steam_loop",
...
weapon_template.attack_meta_data = { max_range = 25, aim_at_node = "j_spine1", keep_distance = 6.5, fire_input = "fire_hold", ignore_enemies_for_obstruction = false, stop_fire_delay = 0.3,
	...
	aim_data = { min_radius_pseudo_random_c = 1, max_radius_pseudo_random_c = 0.3021, min_radius = math.pi / 72, max_radius = math.pi / 16 },
...
weapon_template.aim_assist_settings = { max_range = 22, no_aim_input_multiplier = 0, aim_at_node = "j_spine", always_auto_aim = true, base_multiplier = 0.15, effective_max_range = 10,
...
weapon_template.particle_fx = {
	heat_shimmer = { { orphaned_policy = "destroy", effect = "fx/wpnfx_engineer_heat_shimmer", third_person = false, link_target = "right_weapon", first_person = true, link_node = "fx_muzzle", destroy_policy = "stop_spawning" } } }
...
weapon_template.wwise_dep_right_hand = { "wwise/drakegun", "wwise/flamethrower" }
weapon_template.visual_heat_cooldown_speed = visual_heat_cooldown_speed

weapon_template.custom_data = { windup = 0,

	windup_loss_per_second = ( max_rps - initial_rounds_per_second ) / rps_loss_per_second }

function weapon_template.update(weapon_extension, dt, t)
...
return { bardin_engineer_career_skill_weapon = table.clone(weapon_template),
