...
function UpsellPopup:create_ui_elements()
...
function UpsellPopup:update(dt)
...
function UpsellPopup:_handle_input(dt)
...
function UpsellPopup:_start_transition_animation(animation_name)
...
function UpsellPopup:_update_animations(dt)
