...
function BTTargetPouncedAction:init(...)
...
function BTTargetPouncedAction:enter(unit, blackboard, t)
	...
	local target_position = POSITION_LOOKUP [target_unit] local target_rotation = Unit.local_rotation(target_unit, 0)
...
function BTTargetPouncedAction:leave(unit, blackboard, t, reason, destroy)
...
function BTTargetPouncedAction:run(unit, blackboard, t, dt)
...
function BTTargetPouncedAction.impact_pushback(pouncing_unit, impact_position, close_impact_radius, far_impact_radius, impact_speed_given, excluded_player_unit)
...
local temp_damage_triplett = { 0, 0, 0 }
function BTTargetPouncedAction.direct_damage(unit, blackboard)
