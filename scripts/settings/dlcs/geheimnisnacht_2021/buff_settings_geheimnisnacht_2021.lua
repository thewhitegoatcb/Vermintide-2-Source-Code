...
settings.buff_templates = {
	geheimnisnacht_2021_event_horde_buff = {
		buffs = { { multiplier = 0.25, name = "geheimnisnacht_2021_event_damage", stat_buff = "damage_dealt" },




			{ multiplier = 1.25, name = "geheimnisnacht_2021_event_health", stat_buff = "max_health" },




			{ remove_buff_func = "ai_update_max_health", name = "geheimnisnacht_2021_event_health_update", apply_buff_func = "ai_update_max_health" },




			{ remove_buff_func = "geheimnisnacht_2021_remove_eye_glow", name = "geheimnisnacht_2021_event_eye_glow", apply_buff_func = "geheimnisnacht_2021_apply_eye_glow" },




			{ multiplier = 1.1, name = "geheimnisnacht_2021_event_stagger", stat_buff = "stagger_resistance" },




			{ multiplier = 0.9, name = "geheimnisnacht_2021_event_hit_mass", stat_buff = "hit_mass_amount" } } },
