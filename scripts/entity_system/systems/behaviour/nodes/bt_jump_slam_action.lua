...
function BTJumpSlamAction:init(...)
	BTJumpSlamAction.super.init(self, ...)
end

BTJumpSlamAction.name = "BTJumpSlamAction"

function BTJumpSlamAction:enter(unit, blackboard, t)
...
function BTJumpSlamAction:leave(unit, blackboard, t, reason, destroy)
	local animation_system = Managers.state.entity:system("animation_system")
...
function BTJumpSlamAction:run(unit, blackboard, t, dt)
	local data = blackboard.jump_slam_data
...
function BTJumpSlamAction:_calculate_sphere_collision(action, bot_threat, self_pos, self_rot)
...
function BTJumpSlamAction:_create_bot_aoe_threat(jump_data, attack_rotation, action, bot_threat)
...
function BTJumpSlamAction.progress_to_landing(blackboard, unit, data)
...
function BTJumpSlamAction.progress_to_in_flight(blackboard, unit, velocity)
	LocomotionUtils.set_animation_driven_movement(unit, false, true)
