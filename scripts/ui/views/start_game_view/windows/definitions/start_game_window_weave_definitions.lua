...
local scenegraph_definition = {
	...
	weave_texture = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { 246, 252 }, position = { 0, -65, 1 } },
	weave_title_divider = { vertical_alignment = "bottom", parent = "weave_texture", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, -85, 1 } },
	weave_title = { vertical_alignment = "bottom", parent = "weave_title_divider", horizontal_alignment = "center", size = { window_text_width, 50 }, position = { 0, 20, 1 } } }


local weave_title_text_style = { font_size = 36, upper_case = true, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "bottom", font_type = "hell_shark_header",
