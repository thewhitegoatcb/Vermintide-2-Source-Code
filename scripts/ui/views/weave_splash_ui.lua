...
local weave_splash_images = { "weave_loading_screen" }
...
function WeaveSplashUI:init(world)
	self._world = world
...
function WeaveSplashUI:_setup_ui()
...
function WeaveSplashUI:_create_ui_elements()
...
function WeaveSplashUI:update(dt, t)
	self:_update_animations(dt, t)
	self:_draw(dt, t)
	self:_update_current_splash(dt, t)
end

function WeaveSplashUI:_update_animations(dt, t)
...
function WeaveSplashUI:_update_current_splash(dt, t)
...
function WeaveSplashUI:_draw(dt, t)
...
function WeaveSplashUI:destroy()
	UIRenderer.destroy(self._ui_renderer, self._world)
end

function WeaveSplashUI:clear_user_name() return end