...
function XboxEventManager:init()
...
function XboxEventManager:write(event, event_data, debug_string, debug_print_func, prioritize, skip_wait_time)
...
function XboxEventManager:update(dt)
...
function XboxEventManager:_handle_priority_event(priority_event)
...
function XboxEventManager:_handle_event()
...
function XboxEventManager:_handle_immediate_event()
...
function XboxEventManager:flush()
...
function XboxEventManager:destroy() return end