...
local scenegraph_definition = {
	...
	game_option_1 = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = game_option_size, position = { 0, -16, 2 } },
...
local function create_settings_option(scenegraph_id, size, title_text, button_text, icon_texture, background_texture)
	...
	local widget = {
		...
		style = {
			...
			icon_lock = { vertical_alignment = "center", horizontal_alignment = "center",


				texture_size = { 146, 146 },
				color = { 255, 255, 255, 255 },
				offset = { size [1] / 2 - 120, 0, 7 } },
			...
			option_text = { font_size = 28, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "left", vertical_alignment = "top", font_type = "hell_shark_header",
				...
				size = { size [1] - icon_texture_size [1] - 60, size [2] } },
...
local function create_additional_settings_option(scenegraph_id, size, title_text, background_texture)
	...
	local widget = {
		...
		content = { title_edge = "game_option_divider", title_bg = "playername_bg_02",
		...
		style = {
			...
			title_text_disabled = { font_size = 32, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "left", vertical_alignment = "top", font_type = "hell_shark_header",
				...
				text_color = { 255, 108, 108, 108 },
				default_text_color = { 255, 108, 108, 108 },
				offset = { frame_width + 5, -frame_width, 10 } },
