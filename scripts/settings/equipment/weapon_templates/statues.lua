...
local weapon_template = {
	...
	actions = {
		action_one = {
			default = { uppety = 0, anim_time_scale = 0.8, kind = "throw", is_statue_and_needs_rotation_cause_reasons = true, throw_time = 0.43749999999999994, ammo_usage = 1, weapon_action_hand = "left", block_pickup = true, speed = 2, uninterruptible = true, anim_event = "attack_throw", total_time = 0.7249999999999999,
				...
				angular_velocity = { -1.85, -0.25, 0 },
				throw_offset = { 0.39, 1.15, -0.57 },




				projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", collision_filter = "n/a", drop_on_player_destroyed = true, use_dynamic_collision = false } } },
	...
	dodge_count = 1,
	buffs = {
		statue_decrease_movement = { variable_value = 1 },
		change_dodge_distance = { external_optional_multiplier = 0.45 },
		change_dodge_speed = { external_optional_multiplier = 0.65 } } }
...
cannon_ball.actions.action_one.default.throw_offset = { 0.3, 0.5, 0 }
cannon_ball.actions.action_one.default.buff_data = { { start_time = 0, external_multiplier = 0.5, end_time = 0.28, buff_name = "planted_fast_decrease_movement" } }
...
cannon_ball.actions.action_one.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "cannon_ball", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_cannon_ball_01/pup_cannon_ball_01" }
...
cannon_ball.actions.action_dropped.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "cannon_ball", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_cannon_ball_01/pup_cannon_ball_01" }
...
trail_cog.actions.action_one.default.throw_offset = { 0.4, 0.9, 0 }
trail_cog.actions.action_one.default.angular_velocity = { 0, 0, 0 }

trail_cog.actions.action_inspect = ActionTemplates.action_inspect
trail_cog.wield_anim = "to_cog"
trail_cog.wield_anim_3p = "to_cog"
trail_cog.actions.action_one.default.buff_data = { { start_time = 0, external_multiplier = 0.5, end_time = 0.28, buff_name = "planted_fast_decrease_movement" } }
...
trail_cog.actions.action_one.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit_limited", pickup_name = "trail_cog", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/wpn_trail_cog_02/pup_trail_cog_02" }
...
trail_cog.actions.action_dropped.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit_limited", pickup_name = "trail_cog", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/wpn_trail_cog_02/pup_trail_cog_02" }
...
gargoyle_head.actions.action_one.default.throw_offset = { 0.3, 0.5, 0 }
gargoyle_head.actions.action_one.default.buff_data = { { start_time = 0, external_multiplier = 1, end_time = 0.28, buff_name = "planted_fast_decrease_movement" } }
...
gargoyle_head.actions.action_one.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "gargoyle_head", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_gargoyle_head/pup_gargoyle_head_01" }
...
gargoyle_head.actions.action_dropped.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "gargoyle_head", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_gargoyle_head/pup_gargoyle_head_01" }
...
shadow_gargoyle_head.actions.action_one.default.throw_offset = { 0.3, 0.5, 0 }
shadow_gargoyle_head.actions.action_one.default.buff_data = { { start_time = 0, external_multiplier = 1, end_time = 0.28, buff_name = "planted_fast_decrease_movement" } }
...
shadow_gargoyle_head.actions.action_one.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "shadow_gargoyle_head", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_shadow_gargoyle_head/pup_shadow_gargoyle_head_01" }
...
shadow_gargoyle_head.actions.action_dropped.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "shadow_gargoyle_head", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_shadow_gargoyle_head/pup_shadow_gargoyle_head_01" }
...
magic_crystal.actions.action_one.default.throw_offset = { -0.2, 0.5, 0 }
...
magic_crystal.actions.action_one.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "magic_crystal", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_magic_crystal/pup_magic_crystal" }
...
magic_crystal.actions.action_dropped.default.projectile_info = { projectile_unit_template_name = "pickup_projectile_unit", pickup_name = "magic_crystal", drop_on_player_destroyed = true, projectile_unit_name = "units/weapons/player/pup_magic_crystal/pup_magic_crystal" }
...
training_dummy.actions.action_one.default.angular_velocity = { 0, 0, 0 }
training_dummy.actions.action_one.default.throw_offset = { 0, 1, -0.2 }
