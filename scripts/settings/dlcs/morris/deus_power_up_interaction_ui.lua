...
function DeusPowerUpInteractionUI:init(parent, ingame_ui_context)
	DeusPowerUpInteractionUI.super.init(self, parent, ingame_ui_context)
end

function DeusPowerUpInteractionUI:chest_unlock_failed(chest_type)
	if chest_type == DeusPowerUpInteractionUI.TYPE then
		self:_start_animation("chest_unlock_failed")
	end
end

function DeusPowerUpInteractionUI:_populate_widget(interactable_unit)
