...
function BTTransportedAction:init(...)
	BTTransportedAction.super.init(self, ...)
end

BTTransportedAction.name = "BTTransportedAction"

function BTTransportedAction:enter(unit, blackboard, t, dt)
...
function BTTransportedAction:leave(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
	local locomotion_extension = blackboard.locomotion_extension
...
function BTTransportedAction:run(unit, blackboard, t, dt, bt_name)
