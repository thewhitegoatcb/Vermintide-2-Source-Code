...
function ProjectileHomingSkullLocomotionExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileHomingSkullLocomotionExtension:update(unit, input, dt, context, t)
	self.moved = false
...
function ProjectileHomingSkullLocomotionExtension:moved_this_frame()
	return not self.stopped and self.moved
end

function ProjectileHomingSkullLocomotionExtension:destroy()
	self.stopped = true
end
function ProjectileHomingSkullLocomotionExtension:stop()
	self.stopped = true
end