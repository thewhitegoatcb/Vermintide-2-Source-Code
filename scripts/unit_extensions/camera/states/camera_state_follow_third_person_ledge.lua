...
function CameraStateFollowThirdPersonLedge:init(camera_state_init_context)
...
function CameraStateFollowThirdPersonLedge:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollowThirdPersonLedge:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollowThirdPersonLedge:update(unit, input, dt, context, t)
	local csm = self.csm
