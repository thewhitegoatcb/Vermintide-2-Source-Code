...
function InteractionDefinitions.deus_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function InteractionDefinitions.deus_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
function InteractionDefinitions.deus_access.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.deus_weapon_chest.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
...
function InteractionDefinitions.deus_weapon_chest.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.deus_weapon_chest.client.can_interact(interactor_unit, interactable_unit, data, config)
...
InteractionDefinitions.deus_cursed_chest.config = { block_other_interactions = true, hud_verb = "player_interaction", hold = true, swap_to_3p = false, activate_block = true }
...
function InteractionDefinitions.deus_cursed_chest.server.start(world, interactor_unit, interactable_unit, data, config, t)
...
function InteractionDefinitions.deus_cursed_chest.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function InteractionDefinitions.deus_cursed_chest.client.start(world, interactor_unit, interactable_unit, data, config, t)
	local deus_cursed_chest_extension = ScriptUnit.has_extension(interactable_unit, "deus_cursed_chest_system")
	if deus_cursed_chest_extension then
		data.start_time = t
		local duration = deus_cursed_chest_extension:get_interaction_length()
...
function InteractionDefinitions.deus_cursed_chest.client.get_progress(data, config, t)
...
function InteractionDefinitions.deus_cursed_chest.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		local deus_cursed_chest_extension = ScriptUnit.has_extension(interactable_unit, "deus_cursed_chest_system")
		if deus_cursed_chest_extension then
...
function InteractionDefinitions.deus_cursed_chest.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	local deus_cursed_chest_extension = ScriptUnit.has_extension(interactable_unit, "deus_cursed_chest_system")
...
function InteractionDefinitions.deus_cursed_chest.client.can_interact(interactor_unit, interactable_unit, data, config)
	if Managers.mechanism:current_mechanism_name() ~= "deus" or Managers.mechanism:game_mechanism():get_state() ~= "ingame_deus" then
		return false
	end
	local deus_cursed_chest_extension = ScriptUnit.has_extension(interactable_unit, "deus_cursed_chest_system")
...
function InteractionDefinitions.deus_arena_interactable.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS then
...
function InteractionDefinitions.deus_arena_interactable.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		local deus_arena_interactable_extension = ScriptUnit.has_extension(interactable_unit, "deus_arena_interactable_system")
		if deus_arena_interactable_extension then
...
function InteractionDefinitions.deus_arena_interactable.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	local deus_arena_interactable_extension = ScriptUnit.has_extension(interactable_unit, "deus_arena_interactable_system")
...
function InteractionDefinitions.deus_arena_interactable.client.can_interact(interactor_unit, interactable_unit, data, config)
	if Managers.mechanism:current_mechanism_name() ~= "deus" or Managers.mechanism:game_mechanism():get_state() ~= "ingame_deus" then
		return false
	end
	local deus_arena_interactable_extension = ScriptUnit.has_extension(interactable_unit, "deus_arena_interactable_system")
...
InteractionDefinitions.deus_setup_rally_flag = {
	config = { block_other_interactions = true, hud_verb = "setup", hold = true, swap_to_3p = true, offset_flag = 0.5, duration = 3, activate_block = true },
		...
		stop = function (world, interactor_unit, interactable_unit, data, config, t, result)
			if result == InteractionResult.SUCCESS then
				...
				local extension_init_data = {
					buff_system = { breed = "n/a",

						initial_buff_names = { "deus_rally_flag_aoe_buff" } } }


				Managers.state.unit_spawner:spawn_network_unit(
...
function InteractionDefinitions.deus_debug_changelog.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
...
function InteractionDefinitions.deus_debug_changelog.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end

function InteractionDefinitions.deus_debug_changelog.client.can_interact(interactor_unit, interactable_unit, data, config)
