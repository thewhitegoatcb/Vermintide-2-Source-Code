return { description = "description_nurgle_storm", display_name = "display_name_nurgle_storm", icon = "mutator_icon_nurgle_storm",
		...
		elseif data.spawn_nurgle_storm_at < time and not has_unchecked_positions then
			...
			if player_unit then
				...
				if storm_spawn_position and backup_storm_spawn_position then
					...
					data.astar,
					nav_world,
					storm_spawn_position,
					directed_wander_position,
					30,
