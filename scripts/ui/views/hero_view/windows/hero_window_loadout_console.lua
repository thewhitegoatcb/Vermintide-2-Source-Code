...
function HeroWindowLoadoutConsole:on_enter(params, offset)
...
function HeroWindowLoadoutConsole:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowLoadoutConsole:create_ui_elements(params, offset)
...
function HeroWindowLoadoutConsole:on_exit(params)
...
function HeroWindowLoadoutConsole:_input_service()
...
function HeroWindowLoadoutConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowLoadoutConsole:post_update(dt, t)

	return end

function HeroWindowLoadoutConsole:_update_input_description()
...
function HeroWindowLoadoutConsole:_update_animations(dt)
...
function HeroWindowLoadoutConsole:_is_button_pressed(widget)
...
function HeroWindowLoadoutConsole:_handle_gamepad_input(dt, t)
	...
	elseif input_service:get("refresh", true) and
	self:_is_selected_item_customizable() then
		self:_play_sound("play_gui_equipment_selection_click")
...
function HeroWindowLoadoutConsole:_handle_input(dt, t)
	local parent = self.parent
...
function HeroWindowLoadoutConsole:_customize_item(item)
...
function HeroWindowLoadoutConsole:_update_selected_loadout_slot_index()
...
function HeroWindowLoadoutConsole:_update_loadout_sync()
	local parent = self.parent
...
function HeroWindowLoadoutConsole:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowLoadoutConsole:draw(dt)
...
function HeroWindowLoadoutConsole:_play_sound(event)
	self.parent:play_sound(event)
end



function HeroWindowLoadoutConsole:_setup_slot_icons()
...
function HeroWindowLoadoutConsole:_populate_loadout()
...
function HeroWindowLoadoutConsole:_equip_item_presentation(item, slot)
	local item_data = item.data
	local slot_type = item_data.slot_type
...
function HeroWindowLoadoutConsole:_clear_item_slot(slot)
...
function HeroWindowLoadoutConsole:_is_equipment_slot_right_clicked()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_is_customize_item_pressed()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_is_selected_item_customizable()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_get_selected_item()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_is_equipment_slot_pressed()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_is_equipment_slot_hovered()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_set_equipment_slot_selected(row_index)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_enable_selection_highlight()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_disable_selection_highlight()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_is_equipment_slot_hovered_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadoutConsole:_highlight_equipment_slot_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
	local style = widget.style
...
function HeroWindowLoadoutConsole:_show_weapon_disclaimer(should_show)
