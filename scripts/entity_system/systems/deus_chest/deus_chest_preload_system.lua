...
function DeusChestPreloadSystem:init(context, system_name, extensions)
...
function DeusChestPreloadSystem:_setup_weapon_preload_settings()
	local success = false
...
function DeusChestPreloadSystem:destroy()
...
function DeusChestPreloadSystem:update(context, t)
...
function DeusChestPreloadSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function DeusChestPreloadSystem:on_remove_extension(unit, extension_name, ...)
...
function DeusChestPreloadSystem:get_player_preload_packages(player)
...
function DeusChestPreloadSystem:set_player_preload_packages(player, preload_packages)
	local peer_id = player.peer_id
	local local_player_id = player:local_player_id()
