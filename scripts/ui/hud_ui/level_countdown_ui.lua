...
function LevelCountdownUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function LevelCountdownUI:create_ui_elements()
	DO_RELOAD = false
...
function LevelCountdownUI:update(dt)
	if DO_RELOAD then
		self:create_ui_elements()
		self.colors = {
			normal = Colors.get_table("font_default"),
...
function LevelCountdownUI:is_enter_game()
	return self._countdown_active
end

function LevelCountdownUI:draw(dt)
...
function LevelCountdownUI:update_enter_game_counter(start_time, max_start_time, dt)
...
function LevelCountdownUI:play_sound(event)
	WwiseWorld.trigger_event(self.wwise_world, event)
end

function LevelCountdownUI:_get_start_time()
...
function LevelCountdownUI:_get_active_waystone_extension()
