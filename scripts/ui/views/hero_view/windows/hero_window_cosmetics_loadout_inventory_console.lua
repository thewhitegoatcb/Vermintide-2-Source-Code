...
function HeroWindowCosmeticsLoadoutInventoryConsole:on_enter(params, offset)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowCosmeticsLoadoutInventoryConsole:create_ui_elements(params, offset)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_input_service()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:set_focus(focused)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:on_exit(params)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCosmeticsLoadoutInventoryConsole:post_update(dt, t)

	return end

function HeroWindowCosmeticsLoadoutInventoryConsole:_update_input_description()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_set_item_compare_enable_state(enabled)
	self._widgets_by_name.item_tooltip_compare.content.visible = enabled
	self._draw_item_compare = enabled
end

function HeroWindowCosmeticsLoadoutInventoryConsole:_update_equipped_item_tooltip()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_update_selected_item_tooltip()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_update_animations(dt)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_is_button_pressed(widget)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot or content.hotspot
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_handle_gamepad_input(dt, t)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_handle_input(dt, t)
	local widgets_by_name = self._widgets_by_name
	local parent = self.parent
	local item_grid = self._item_grid
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_update_page_info()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_update_selected_cosmetic_slot_index()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_update_loadout_sync()
	local item_grid = self._item_grid
	local parent = self.parent
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCosmeticsLoadoutInventoryConsole:draw(dt)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowCosmeticsLoadoutInventoryConsole:_change_category_by_index(index, force_update)
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_setup_input_buttons()
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_set_gamepad_input_buttons_visibility(visible)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowCosmeticsLoadoutInventoryConsole:_handle_gamepad_activity()
	local mouse_active = Managers.input:is_device_active("mouse")
