...
function BackendInterfaceHeroAttributes:init()
...
function BackendInterfaceHeroAttributes:_refresh_attributes()
...
function BackendInterfaceHeroAttributes:on_authenticated()
...
function BackendInterfaceHeroAttributes:get(hero_name, attribute_name)
...
function BackendInterfaceHeroAttributes:set(hero_name, attribute_name, value)
	local db_entity_name = DB_ENTITY_NAME_PREFIX .. hero_name
	local db_attribute_name = DB_ATTRIBUTE_NAME_PREFIX .. attribute_name
