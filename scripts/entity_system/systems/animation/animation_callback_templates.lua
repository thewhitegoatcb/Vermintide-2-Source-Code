...
function AnimationCallbackTemplates.client.anim_cb_enable_second_hit_ragdoll(unit, param)
	local death_ext = ScriptUnit.extension(unit, "death_system")
	death_ext:enable_second_hit_ragdoll()
end


function AnimationCallbackTemplates.client.anim_cb_push_finished(unit, param)
...
function AnimationCallbackTemplates.server.anim_cb_damage(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_special_damage(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local action = blackboard.action
...
function AnimationCallbackTemplates.server.anim_cb_reset_attack_animation_locked(unit, param)
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
	local blackboard = ai_extension:blackboard()
	blackboard.reset_attack_animation_locked = true
end

function AnimationCallbackTemplates.server.anim_cb_unlink_unit(unit, param)
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
	local blackboard = ai_extension:blackboard()
	blackboard.unlink_unit = true
end

function AnimationCallbackTemplates.server.anim_cb_mounted_knocked_off(unit, param)
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
	local blackboard = ai_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_mounting_finished(unit, param)
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
	local blackboard = ai_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_frenzy_damage(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local action = blackboard.action
	if not action or not action.damage then
...
function AnimationCallbackTemplates.server.anim_cb_attack_vce(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local action = blackboard.action
...
function AnimationCallbackTemplates.server.anim_cb_attack_vce_long(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local action = blackboard.action
...
function AnimationCallbackTemplates.server.anim_cb_shout_vo(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_combo_damage(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local action = blackboard.action
...
function AnimationCallbackTemplates.server.anim_cb_rotation_start(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_rotation_start = true
end


function AnimationCallbackTemplates.server.anim_cb_rotation_stop(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_rotation_stop = true
end


function AnimationCallbackTemplates.server.anim_cb_picked_up_standard(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_running_attack_start(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_running_attack_end(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_death_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_death_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_move(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_move_stop(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_transform_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_throw_weapon(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_throw_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_charge_start_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_charge_charging_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_charge_impact_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_disable_charge_collision(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_throw(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_spawn_projectile(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_spawn_projectile = true
end


function AnimationCallbackTemplates.server.anim_cb_jump_start_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.jump_start_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_jump_climb_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.jump_climb_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_start_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.start_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_attack_start(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_attack_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_escape_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_escape_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_attack_cooldown(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_attack_cooldown = true
end


function AnimationCallbackTemplates.server.anim_cb_blocked_cooldown(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_blocked_cooldown = true
end


function AnimationCallbackTemplates.server.anim_cb_summoning_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.summoning_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_shout_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_shout_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_order_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_order_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_scurry_under_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_scurry_under_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_dig_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_dig_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_attack_throw_score_finished(unit, param)
...
function AnimationCallbackTemplates.server.anim_cb_attack_jump_start_finished(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_attack_shoot_start_finished(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_reload_start_finished(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_attack_windup_start_finished(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_attack_shoot_random_shot(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_stormvermin_voice(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_patrol_sound(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_exit_shooting_hit_react(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_enter_shooting_hit_react(unit, param)
	local ai_base_extension = ScriptUnit.has_extension(unit, "ai_system")
	if ai_base_extension then
		local blackboard = ai_base_extension:blackboard()
...
function AnimationCallbackTemplates.server.anim_cb_place_standard(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_pick_up_standard(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_placed_standard(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_stormvermin_push(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_stormvermin_push_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.attack_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_attack_overlap_done(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_vomit(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_vomit_end(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.is_puking = nil
end


function AnimationCallbackTemplates.server.anim_cb_dodge_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_dodge_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_downed_end_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.downed_end_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_landing_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.landing_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_teleport_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_teleport_finished = true
end


function AnimationCallbackTemplates.server.anim_cb_teleport_start_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_teleport_end_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_move_jump_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_stagger_immune(unit, param)
	local blackboard = BLACKBOARDS [unit]
	blackboard.anim_cb_stagger_immune = true
end


function AnimationCallbackTemplates.server.anim_cb_push_cancel(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_disable_invincibility(unit, param)
...
function AnimationCallbackTemplates.server.anim_cb_combat_step_stop(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.client.anim_cb_hide_unit(unit, param)
...
function AnimationCallbackTemplates.client.anim_cb_hide_weapons(unit, param)
...
function AnimationCallbackTemplates.client.anim_cb_unhide_weapons(unit, param)
	local player_manager = Managers.player
	local player = player_manager:unit_owner(unit)
	if not player then
		return
...
function AnimationCallbackTemplates.client.anim_cb_climb_rotation_start(unit, param)
	local status_extension = ScriptUnit.extension(unit, "status_system")
	status_extension.start_climb_rotation = true
end


function AnimationCallbackTemplates.server.anim_cb_chew_attack(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
...
function AnimationCallbackTemplates.server.anim_cb_chew_attack_finished(unit, param)
	local blackboard = BLACKBOARDS [unit]
...
function AnimationCallbackTemplates.server.anim_cb_attack_grabbed_smash(unit, param)
	local blackboard = BLACKBOARDS [unit]
	local active_node = blackboard.active_node
	local victim_unit = blackboard.victim_grabbed
...
function AnimationCallbackTemplates.client.anim_cb_enable_skeleton_collison(unit, param)
