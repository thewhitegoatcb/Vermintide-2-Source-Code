...
function ExplosiveBarrelHealthExtension:init(extension_init_context, unit, extension_init_data)
...
function ExplosiveBarrelHealthExtension:update(dt, context, t)
...
function ExplosiveBarrelHealthExtension:apply_client_predicted_damage(predicted_damage)

	return end

function ExplosiveBarrelHealthExtension:add_damage(attacker_unit, damage_amount, hit_zone_name, damage_type, hit_position, damage_direction, damage_source_name, hit_ragdoll_actor, source_attacker_unit, hit_react_type, is_critical_strike, added_dot)
...
function ExplosiveBarrelHealthExtension:health_data()
	local last_damage_data = self.last_damage_data
	local data = {
