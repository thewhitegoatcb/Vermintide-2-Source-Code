...
function StartGameWindowCustomGameOverviewConsole:on_enter(params, offset)
...
function StartGameWindowCustomGameOverviewConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowCustomGameOverviewConsole:_create_ui_elements(params, offset)
...
function StartGameWindowCustomGameOverviewConsole:on_exit(params)
...
function StartGameWindowCustomGameOverviewConsole:set_focus(focused)
	self._is_focused = focused
end

function StartGameWindowCustomGameOverviewConsole:update(dt, t)
...
function StartGameWindowCustomGameOverviewConsole:post_update(dt, t)
	return end

function StartGameWindowCustomGameOverviewConsole:_update_can_play()
...
function StartGameWindowCustomGameOverviewConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowCustomGameOverviewConsole:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowCustomGameOverviewConsole:_handle_input(dt, t)
...
function StartGameWindowCustomGameOverviewConsole:_can_play()
	local parent = self._parent
...
function StartGameWindowCustomGameOverviewConsole:_update_mission_option()
	local parent = self._parent
	local selected_level_id = parent:get_selected_level_id()
...
function StartGameWindowCustomGameOverviewConsole:_update_difficulty_option()
...
function StartGameWindowCustomGameOverviewConsole:_option_selected(input_index, t)
	local parent = self._parent
	local custom_game_settings = parent:get_custom_game_settings(self._mechanism_name) or parent:get_custom_game_settings("adventure")
...
function StartGameWindowCustomGameOverviewConsole:_handle_new_selection(input_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowCustomGameOverviewConsole:_update_animations(dt)
...
function StartGameWindowCustomGameOverviewConsole:_draw(dt)
