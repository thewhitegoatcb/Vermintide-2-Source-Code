...
local vote_level_template = { cost = 0, use_frame_texture = true, texture_id = "level_image_any", text = "twitch_vote_next_deus_level",
...
for shop_name, settings in pairs(DeusShopSettings.shop_types) do
	...
	TwitchVoteTemplates [new_vote_template_name] = new_vote_template
	TwitchVoteDeusSelectLevelNames [shop_name] = new_vote_template_name end