return { description = "weaves_life_mutator_desc", display_name = "weaves_life_mutator_name", icon = "mutator_icon_life_thorns",
	...
	add_to_spawn_queue = function (data, pos, rot)
		...
		data.spawn_queue [#data.spawn_queue + 1] = { position = positionBox, rotation = rotationBox }
	end,
	...
	server_start_function = function (context, data)
		...
		data.extension_init_data = {
			area_damage_system = { area_damage_template = "mutator_life_poison", radius = 1, nav_tag_volume_layer = "fire_grenade", invisible_unit = false, player_screen_effect_name = "fx/screenspace_poison_globe_impact", create_nav_tag_volume = true, damage_source = "dot_debuff", aoe_dot_damage_interval = 0.25, damage_players = true,
			...
			props_system = { despawn_animation_time = 2, spawn_animation_time = 4 } }
