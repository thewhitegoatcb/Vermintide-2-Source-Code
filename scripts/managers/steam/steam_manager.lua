...
function SteamManager:on_inventory_result(handle, result)
...
function SteamManager:on_price_result(result, currency)
...
function SteamManager:on_start_purchase(result, order_id, transaction_id)
...
function SteamManager:request_purchase_item(steam_itemdefid, amount, callback)
