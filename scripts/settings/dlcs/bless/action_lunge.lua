...
function ActionLunge:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionLunge:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
	...
	status_extension.do_lunge = { allow_rotation = false, noclip = false, dodge = false,
		...
		damage = { offset_forward = 0.5, height = 1, depth_padding = 0.6, hit_zone_hit_name = "full", ignore_shield = true, collision_filter = "filter_explosion_overlap_no_player", power_level_multiplier = 1, interrupt_on_first_hit = true, damage_profile = "light_push", width = 2 } }
