...
function ActionGeiserTargeting:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionGeiserTargeting:client_owner_start_action(new_action, t)
...
function ActionGeiserTargeting:_start_charge_sound()
	local current_action = self.current_action
	local owner_unit = self.owner_unit
...
function ActionGeiserTargeting:_stop_charge_sound()
	local current_action = self.current_action
	local owner_unit = self.owner_unit
	local owner_player = self.owner_player
	local is_bot = owner_player and owner_player.bot_player
...
function ActionGeiserTargeting:client_owner_post_update(dt, t, world, can_damage)
...
function ActionGeiserTargeting:finish(reason, data)
	local world = self.world
	local network_transmit = self.network_transmit
...
function ActionGeiserTargeting:destroy()
