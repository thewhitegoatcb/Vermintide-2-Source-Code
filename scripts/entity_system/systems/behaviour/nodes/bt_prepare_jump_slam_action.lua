...
function BTPrepareJumpSlamAction:init(...)
	BTPrepareJumpSlamAction.super.init(self, ...)
end

BTPrepareJumpSlamAction.name = "BTPrepareJumpSlamAction"

function BTPrepareJumpSlamAction:enter(unit, blackboard, t)
	blackboard.jump_slam_data = { state = "start", num_jump_tries = 1,
...
function BTPrepareJumpSlamAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPrepareJumpSlamAction:run(unit, blackboard, t, dt)
...
function BTPrepareJumpSlamAction.start_jump_animation(blackboard, unit)
...
function BTPrepareJumpSlamAction.try_position(nav_world, pos, to_target_normalized)
...
function BTPrepareJumpSlamAction.prepare_jump_new(blackboard, unit, data, t)
...
function BTPrepareJumpSlamAction.test_trajectory_new(blackboard, p1, p2, segment_list, to_target_normalized, multiple_raycasts)
