...
function ActionBlock:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
	self.world = world
...
function ActionBlock:client_owner_start_action(new_action, t)
...
function ActionBlock:client_owner_post_update(dt, t, world, can_damage)
	local status_extension = self._status_extension
...
function ActionBlock:finish(reason, data)
...
function ActionBlock:streak_available(t, streak_action)
