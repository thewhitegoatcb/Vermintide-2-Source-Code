...
function BTChaosPlagueWaveSpawnerSummoningAction:init(...)
	BTChaosPlagueWaveSpawnerSummoningAction.super.init(self, ...)
end

function BTChaosPlagueWaveSpawnerSummoningAction:enter(unit, blackboard, t)
...
function BTChaosPlagueWaveSpawnerSummoningAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.action = nil
end

function BTChaosPlagueWaveSpawnerSummoningAction:run(unit, blackboard, t, dt)
