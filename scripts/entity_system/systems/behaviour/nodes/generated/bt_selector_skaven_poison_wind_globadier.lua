...
function BTSelector_skaven_poison_wind_globadier:init(...)
	BTSelector_skaven_poison_wind_globadier.super.init(self, ...)
	self._children = { }
end

function BTSelector_skaven_poison_wind_globadier:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_skaven_poison_wind_globadier:run(unit, blackboard, t, dt)
...
function BTSelector_skaven_poison_wind_globadier:add_child(node)
