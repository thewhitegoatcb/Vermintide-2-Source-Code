...
if script_data.debug_lightfx then
	LightFX = LightFX or { }
	function LightFX.set_color_in_cube(red, green, blue, intensity, blendtime)
		LightFX.color = { red, green, blue, intensity, blendtime }
...
function LightFXManager:set_lightfx_color_scheme(color_scheme)
...
function LightFXManager:set_lightfx_color(red, green, blue, intensity, blendtime)
...
function LightFXManager:_get_value_from_color_scheme(color_scheme)
...
function LightFXManager:update(dt)
	...
	if conditional_color_scheme then
		...
		conditional_color_scheme_timer =
		conditional_color_scheme_timer and conditional_color_scheme_timer - dt
...
function LightFXManager:udpate_debug(dt)
