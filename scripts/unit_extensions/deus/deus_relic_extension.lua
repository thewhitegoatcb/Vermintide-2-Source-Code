...
function DeusRelicExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
	self._is_server = Managers.player.is_server
	self._nav_world = Managers.state.entity:system("ai_system"):nav_world()
end

function DeusRelicExtension:game_object_initialized(unit, go_id)
	self._go_id = go_id
end

function DeusRelicExtension:destroy()
...
function DeusRelicExtension:update(unit, input, dt, context, t)
	self:_update_position_resetting(unit, t)

	self:_update_objective_marker(unit, t)
end

function DeusRelicExtension:_update_position_resetting(unit, t)
...
function DeusRelicExtension:_update_objective_marker(unit, t)
