...
local RPCS = { "rpc_add_weave_buffs" }
...
local extension_list = { "PlayerUnitWeaveLoadoutExtension", "PlayerHuskWeaveLoadoutExtension" }




function WeaveLoadoutSystem:init(entity_system_creation_context, system_name)
...
function WeaveLoadoutSystem:destroy()
...
function WeaveLoadoutSystem:rpc_add_weave_buffs(channel_id, go_id, num_buffs, buff_ids, buff_data_type_ids, buff_values)
