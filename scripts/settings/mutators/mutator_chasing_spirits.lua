...
return { description = "chasing_spirits_mutator_desc", chase_time = 5, delay_time = 2, chase_speed = 1, spirit_power_level = 200, icon = "mutator_icon_death_spirits", display_name = "chasing_spirits_mutator_name",
