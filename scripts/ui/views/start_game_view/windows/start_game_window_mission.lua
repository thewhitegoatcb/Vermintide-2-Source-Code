...
function StartGameWindowMission:on_enter(params, offset)
...
function StartGameWindowMission:create_ui_elements(params, offset)
...
function StartGameWindowMission:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowMission")
end

function StartGameWindowMission:update(dt, t)
...
function StartGameWindowMission:post_update(dt, t)
	return end

function StartGameWindowMission:draw(dt)
