local scenegraph = {
	...
	end_screen_banner_victory = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	victory_effect_1 = { vertical_alignment = "center", parent = "end_screen_banner_victory", horizontal_alignment = "center",
	...
	victory_effect_2 = { vertical_alignment = "center", parent = "end_screen_banner_victory", horizontal_alignment = "center",
	...
	victory_effect_shine_1 = { vertical_alignment = "center", parent = "end_screen_banner_victory", horizontal_alignment = "center",
	...
	victory_effect_shine_2 = { vertical_alignment = "center", parent = "end_screen_banner_victory", horizontal_alignment = "center",
	...
	title_text_victory = { vertical_alignment = "top", parent = "end_screen_banner_victory", horizontal_alignment = "center",
...
local title_text_victory_style = { word_wrap = true, upper_case = true, localize = false, use_shadow = true, font_size = 100, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local widgets = {
	...
	shine_1 = UIWidgets.create_simple_rotated_texture("sparkle_effect", 0, { 128, 128 }, "victory_effect_shine_1"),
	shine_2 = UIWidgets.create_simple_rotated_texture("sparkle_effect", math.degrees_to_radians(75), { 100, 100 }, "victory_effect_shine_2") }


local animations = { }
animations.victory = { { name = "entry", start_progress = 1, end_progress = 1.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "text", start_progress = 1.4, end_progress = 1.6,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "shine_1", start_progress = 1.5, end_progress = 2.2,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "shine_2", start_progress = 1.4, end_progress = 1.8,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "glow", start_progress = 1.4, end_progress = 2,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "fade_out", start_progress = 6, end_progress = 6.5,
