...
function BTPackMasterDragAction:init(...)
...
function BTPackMasterDragAction:enter(unit, blackboard, t)
...
function BTPackMasterDragAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPackMasterDragAction:find_hoist_pos(nav_world, unit, blackboard)
...
function BTPackMasterDragAction:can_hoist(unit, blackboard)
...
function BTPackMasterDragAction:safe_to_hoist(unit, blackboard)
	local rat_pos = POSITION_LOOKUP [unit]
	...
	for k, enemy_unit in ipairs(player_and_bot_units) do
		if blackboard.drag_target_unit ~= enemy_unit and
		not ScriptUnit.extension(enemy_unit, "status_system"):is_disabled() then
...
function BTPackMasterDragAction:run(unit, blackboard, t, dt)
	...
	if blackboard.test_destinations then
		...
		if not valid_destinations then --[[ Nothing --]]
		end
...
function BTPackMasterDragAction:find_destinations(unit, blackboard, t, dt)
	local position = POSITION_LOOKUP [unit]
...
function BTPackMasterDragAction:find_valid_covers(position, destinations, wanted_direction, player_aggro_pos)
...
function BTPackMasterDragAction:find_valid_interest_points(position, destinations, wanted_direction)
...
function BTPackMasterDragAction:find_nav_group_neighbour(blackboard, position, wanted_direction, avoid_pos)
...
function BTPackMasterDragAction:find_escape_destination(unit, blackboard)
...
function BTPackMasterDragAction:setup_destination_test(unit, blackboard)
...
function BTPackMasterDragAction:test_destinations(unit, blackboard)
