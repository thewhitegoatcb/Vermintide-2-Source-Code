...
function StartGameWindowAdventure:on_enter(params, offset)
...
function StartGameWindowAdventure:create_ui_elements(params, offset)
...
function StartGameWindowAdventure:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowAdventure")
	self.ui_animator = nil
end

function StartGameWindowAdventure:update(dt, t)
...
function StartGameWindowAdventure:post_update(dt, t)
	return end

function StartGameWindowAdventure:draw(dt)
