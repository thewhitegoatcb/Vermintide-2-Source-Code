...
function DisconnectIndicatorView:init(world)
	self._world = world
...
function DisconnectIndicatorView:destroy()
...
function DisconnectIndicatorView:update(dt)
	if DO_RELOAD then
		DO_RELOAD = false
		self._recalc_text_width = true
...
function DisconnectIndicatorView:_create_ui_elements()
...
function DisconnectIndicatorView:_is_visible()
