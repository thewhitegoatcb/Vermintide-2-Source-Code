...
function CareerAbilityWEShade:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityWEShade:extensions_ready(world, unit)
...
function CareerAbilityWEShade:destroy()
	return end

function CareerAbilityWEShade:update(unit, input, dt, context, t)
...
function CareerAbilityWEShade:stop(reason)
	if self._is_priming then
		self:_stop_priming()
	end
end

function CareerAbilityWEShade:_ability_available()
...
function CareerAbilityWEShade:_run_ability()
...
function CareerAbilityWEShade:_play_vo()
	local owner_unit = self._owner_unit
