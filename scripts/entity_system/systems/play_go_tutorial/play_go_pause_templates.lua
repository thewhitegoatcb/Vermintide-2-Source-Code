...
PauseEvents = {
	pause_events = { { animation_delay = 0.75, stop_delay = 0.1, input_requirement = "sequence", mission_name = "prologue_use_special_ability", name = "special_ability",
			...
			allowed_input = { "action_career", "action_career_release" },
			...
			check_prerequisites = function () return true end } },


	animation_hook_templates = { { stop_delay = 0.1, mission_name = "prologue_pushing", animation_delay = 0.75, breed = "skaven_storm_vermin", name = "push_storm_vermin",


			animations = { "attack_pounce", "attack_special" },




			input_mappings = { { "action_two_hold", "action_one" } },





			allowed_input = { "action_two_hold", "action_one" },
			...
			on_exit = DefaultAnimationFunctions.on_exit,
			check_prerequisites = function () return true end },
		{ stop_delay = 0.07, mission_name = "prologue_dodge", animation_delay = 0.4, breed = "chaos_raider_tutorial", name = "dodge_chaos_raider",


			animations = { "attack_cleave_02" },




			input_mappings = { { "move_left", "dodge_hold" },



				{ "move_right", "dodge_hold" },



				{ "move_controller_left", "dodge_hold" },



				{ "move_controller_right", "dodge_hold" } },





			allowed_input = { "move", "move_left", "move_right", "move_controller", "dodge", "dodge_hold", "jump" },
			...
			on_exit = DefaultAnimationFunctions.on_exit,
			check_prerequisites = function () return true end },
		{ stop_delay = 0.05, mission_name = "prologue_blocking", animation_delay = 0.4, breed = "chaos_marauder_tutorial", name = "block_chaos_marauder",


			animations = { "attack_pounce" },




			input_mappings = { { "action_two", "action_two_hold" } },





			allowed_input = { "action_two_hold", "action_two" },
...
for idx, pause_event in ipairs(PauseEvents.pause_events) do
	...
	PauseEvents.pause_events [pause_event.name] = pause_event end