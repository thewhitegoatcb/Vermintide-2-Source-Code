...
function PlayerCharacterStateCatapulted:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "catapulted")
end

function PlayerCharacterStateCatapulted:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateCatapulted:on_exit(unit, input, dt, context, t, next_state)
	self._direction = nil
...
function PlayerCharacterStateCatapulted:update(unit, input, dt, context, t)
	local csm = self.csm
