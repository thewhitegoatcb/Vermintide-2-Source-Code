...
function ActionRailGun:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionRailGun:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionRailGun:shoot(num_shots_this_frame, shots_fired, num_shots_total)
...
function ActionRailGun:finish(reason)
