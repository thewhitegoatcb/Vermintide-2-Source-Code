...
function BTPrepareForCrazyJumpAction:init(...)
...
function BTPrepareForCrazyJumpAction:enter(unit, blackboard, t)
	...
	blackboard.jump_data = { crouching = false, ready_crouch_time = false,
...
function BTPrepareForCrazyJumpAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPrepareForCrazyJumpAction:run(unit, blackboard, t, dt)
...
function BTPrepareForCrazyJumpAction.start_crawling(unit, blackboard, t, data)
...
function BTPrepareForCrazyJumpAction.ready_to_jump(unit, blackboard, data, set_data)
...
function BTPrepareForCrazyJumpAction.test_trajectory(blackboard, p1, p2, segment_list, multiple_raycasts)
...
function BTPrepareForCrazyJumpAction.test_simple_jump(to_target, jump_speed)
