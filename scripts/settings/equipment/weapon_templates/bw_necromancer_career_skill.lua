local weapon_template = {
	...
	actions = {
		...
		action_career_hold = {
			default = { faster_breed_to_spawn = "pet_skeleton", breed_to_spawn = "pet_skeleton", weapon_action_hand = "left", kind = "career_bw_necromancer_raise_dead_targeting", hold_input = "action_career_hold", controlled_unit_template = "necromancer_pet_ability", uninterruptible = true, anim_event = "necro_ability_start",
				...
				allowed_chain_actions = { { sub_action = "spawn_summon_area", start_time = 0, action = "action_career_hold", input = "action_one" },
					{ sub_action = "spawn_summon_area", start_time = 0, action = "action_career_hold", input = "action_career_release" },
					{ sub_action = "default", start_time = 0, action = "action_wield", input = "action_wield" },


					{ sub_action = "default", start_time = 0, action = "action_two", input = "action_two" } },
			...
			spawn_summon_area = { weapon_action_hand = "left", anim_event = "necro_ability_cast", uninterruptible = true, kind = "dummy", total_time = 0.51,
		...
		action_two = {
			default = { kind = "career_dummy", weapon_action_hand = "left", anim_end_event = "ability_finished", anim_event = "necro_ability_cancel", total_time = 0.2,
...
return { bw_necromancer_career_skill_weapon = table.clone(weapon_template) }