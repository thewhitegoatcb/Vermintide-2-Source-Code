...
function BTGreySeerMountedAction:init(...)
	BTGreySeerMountedAction.super.init(self, ...)
end

BTGreySeerMountedAction.name = "BTGreySeerMountedAction"

function BTGreySeerMountedAction:enter(unit, blackboard, t)
...
function BTGreySeerMountedAction:leave(unit, blackboard, t, reason, destroy)
...
function BTGreySeerMountedAction:run(unit, blackboard, t, dt)
