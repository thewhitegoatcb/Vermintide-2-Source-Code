...
local density_multiplier_steps_per_difficulty_tweak = { { -10, 1 },
	{ 0, 1.15 },
	{ 10, 1.3 } }



local min_override_chance_per_difficulty_tweak = { { -10, 0.1 },
	{ 0, 0.4 },
	{ 10, 0.8 } }



local max_override_chance_per_difficulty_tweak = { { -10, 0.3 },
	{ 0, 0.6 },
	{ 10, 1 } }
