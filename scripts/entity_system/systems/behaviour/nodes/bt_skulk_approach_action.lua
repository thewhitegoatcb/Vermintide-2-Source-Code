...
function BTSkulkApproachAction:init(...)
	BTSkulkApproachAction.super.init(self, ...)
end

function BTSkulkApproachAction:enter(unit, blackboard, t)
...
function BTSkulkApproachAction:leave(unit, blackboard, t, reason, destroy)
...
function BTSkulkApproachAction:run(unit, blackboard, t, dt)
...
function BTSkulkApproachAction:update_skulk_data(unit, blackboard, dt)
	local action = blackboard.action
...
function BTSkulkApproachAction:commit_to_target(unit, blackboard, dt)
	local action = blackboard.action
...
function BTSkulkApproachAction:at_goal(unit, blackboard)
	local skulk_data = blackboard.skulk_data
...
function BTSkulkApproachAction:move_to(position, unit, blackboard)
	local skulk_data = blackboard.skulk_data
	local ai_navigation = blackboard.navigation_extension
...
function BTSkulkApproachAction:idle(unit, blackboard)
	self:anim_event(unit, blackboard, "idle")
	blackboard.move_state = "idle"
end

function BTSkulkApproachAction:start_move_animation(unit, blackboard)
	self:anim_event(unit, blackboard, "move_fwd_run")
	blackboard.move_state = "moving"
end

function BTSkulkApproachAction:anim_event(unit, blackboard, anim)
	local skulk_data = blackboard.skulk_data
...
local TRIES = 15
function BTSkulkApproachAction:get_random_goal_on_circle(unit, blackboard)
	local skulk_data = blackboard.skulk_data
...
function BTSkulkApproachAction:debug_show_skulk_circle(unit, blackboard)
	local action = blackboard.action
