...
function VisualStateMachine:init(name, parent, ...)
	...
	if parent ~= nil then
		...
		self._state_machine_stack = { self }
	end
...
function VisualStateMachine:destroy()
...
function VisualStateMachine:add_transition(source_class_name, event_name, target_class)
...
function VisualStateMachine:remove_transition(source_class_name, event_name)
...
function VisualStateMachine:set_transitions(source_class_name, transitions)
...
function VisualStateMachine:set_initial_state(state_class, ...)
...
function VisualStateMachine:update(dt, t)
	...
	for ii, state_machine in ipairs(self._state_machine_stack) do
		...
		if update_func ~= nil then
			...
			local args = { update_func(state, dt, t) }
...
function VisualStateMachine:event(event_name, ...)
...
function VisualStateMachine:state_report()
	local s = ""
...
function VisualStateMachine:_transitions_from_state()
...
function VisualStateMachine._current_state_name(state_machine)
...
function VisualStateMachine:_handle_event(event_name, args)
...
function VisualStateMachine:_received_event(event_name, args)
...
function VisualStateMachine.find_in_table(t, value)
...
function VisualStateMachine:_leave_state()
...
function VisualStateMachine:_enter_state(state_class, args)
