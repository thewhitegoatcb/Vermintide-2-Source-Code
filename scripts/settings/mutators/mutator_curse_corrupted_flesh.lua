...
"curse_corrupted_flesh_name",
"curse_corrupted_flesh_desc",
"deus_curse_nurgle_01",
"mark_of_nurgle", {

	normal = { mark_chance = 0.3, max_marked_enemies = 2 },



	hard = { mark_chance = 0.3, max_marked_enemies = 3 },



	harder = { mark_chance = 0.3, max_marked_enemies = 3 },



	hardest = { mark_chance = 0.3, max_marked_enemies = 3 },



	cataclysm = { mark_chance = 0.3, max_marked_enemies = 3 } },
