...
table.append(CanWieldAllItemTemplates, { "bw_scholar", "bw_adept", "bw_unchained", "we_shade", "we_maidenguard", "we_waywatcher", "dr_ironbreaker", "dr_slayer", "dr_ranger", "wh_zealot", "wh_bountyhunter", "wh_captain", "es_huntsman", "es_knight", "es_mercenary", "empire_soldier_tutorial" })
...
function UpdateItemMasterList(item_names, career_name)
	...
	table.insert(ItemMasertListUpdateQueue, { item_names, career_name })
end
...
function ItemMasterListMeta.__index(table, key)
