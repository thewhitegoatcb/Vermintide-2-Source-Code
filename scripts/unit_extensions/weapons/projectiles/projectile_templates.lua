...
ProjectileTemplates.impact_templates = {
	...
	necromancer_trapped_soul = { owner_heal_amount = 2, owner_heal_type = "heal_from_proc",
...
function ProjectileTemplates.get_trajectory_template(trajectory_template_name, is_husk)
...
function ProjectileTemplates.get_impact_template(impact_template_name)
