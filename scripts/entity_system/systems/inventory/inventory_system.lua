...
local RPCS = { "rpc_show_inventory", "rpc_play_simple_particle_with_vector_variable", "rpc_add_equipment", "rpc_give_equipment", "rpc_add_equipment_limited_item", "rpc_wield_equipment", "rpc_destroy_slot", "rpc_add_equipment_buffs", "rpc_add_no_wield_required_equipment_buffs", "rpc_add_inventory_slot_item", "rpc_start_weapon_fx", "rpc_stop_weapon_fx", "rpc_update_additional_slot" }
...
local extensions = { "SimpleHuskInventoryExtension", "SimpleInventoryExtension" }




function InventorySystem:init(entity_system_creation_context, system_name)
...
function InventorySystem:update(context, t)
...
function InventorySystem:update_mission_inventory_item(units, slot_name, item_name, previous_num_items, add_func, remove_func)
...
function InventorySystem:destroy()
	self.network_event_delegate:unregister(self)
end

function InventorySystem:register_event_objective(objective_name, add_func, remove_func)
...
function InventorySystem:rpc_show_inventory(channel_id, unit_id, show_inventory)
...
function InventorySystem:rpc_play_simple_particle_with_vector_variable(channel_id, effect_id, position, variable_id, variable_value)
	if self.is_server then
...
function InventorySystem:rpc_destroy_slot(channel_id, go_id, slot_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_give_equipment(channel_id, interactor_game_object_id, game_object_id, slot_id, item_name_id, position)
...
function InventorySystem:rpc_add_equipment(channel_id, go_id, slot_id, item_name_id, weapon_skin_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_add_inventory_slot_item(channel_id, go_id, slot_id, item_name_id, weapon_skin_id)
	local unit = self.unit_storage:unit(go_id)
...
function InventorySystem:rpc_add_equipment_buffs(channel_id, go_id, slot_id, num_buffs, buff_ids, buff_value_type_ids, buff_values)
...
function InventorySystem:rpc_add_no_wield_required_equipment_buffs(sender, go_id, slot_id, num_buffs, buff_ids, buff_value_type_ids, buff_values)
...
function InventorySystem:rpc_add_equipment_limited_item(channel_id, go_id, slot_id, item_name_id, spawner_unit_id, limited_item_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_wield_equipment(channel_id, go_id, slot_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_start_weapon_fx(channel_id, go_id, item_name_id, fx_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_stop_weapon_fx(channel_id, go_id, item_name_id, fx_id)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
...
function InventorySystem:rpc_update_additional_slot(channel_id, go_id, slot_id, items)
	if self.is_server then
		local peer_id = CHANNEL_TO_PEER_ID [channel_id]
