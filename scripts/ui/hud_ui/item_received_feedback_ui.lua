...
local item_icons = { potion_speed_boost_01 = "killfeed_icon_04", grenade_fire_02 = "killfeed_icon_09", potion_healing_draught_01 = "killfeed_icon_06", grenade_frag_02 = "killfeed_icon_05", grenade_fire_01 = "killfeed_icon_09", grenade_frag_01 = "killfeed_icon_05", potion_cooldown_reduction_01 = "killfeed_icon_13", potion_damage_boost_01 = "killfeed_icon_10", healthkit_first_aid_kit_01 = "reinforcement_heal" }
...
function ItemReceivedFeedbackUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function ItemReceivedFeedbackUI:destroy()
...
function ItemReceivedFeedbackUI:create_ui_elements()
...
function ItemReceivedFeedbackUI:remove_event(index)
...
function ItemReceivedFeedbackUI:add_event(hash, color_from, event_type, ...)
...
function ItemReceivedFeedbackUI:_assign_portrait_texture(widget, pass_name, texture)
...
function ItemReceivedFeedbackUI:event_give_item_feedback(hash, giver_player, item_name)
...
function ItemReceivedFeedbackUI:_get_hero_portrait(profile_index, career_index)
...
local customizer_data = { root_scenegraph_id = "message_animated", label = "Item received", registry_key = "item_received", drag_scenegraph_id = "message_animated_dragger" }
...
function ItemReceivedFeedbackUI:update(dt, t)
