...
function PlayerUnitVisualEffectsExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerUnitVisualEffectsExtension:extensions_ready(world, unit)
...
function PlayerUnitVisualEffectsExtension:destroy()
	return end

function PlayerUnitVisualEffectsExtension:update(unit, input, dt, context, t)
	self:_update_overcharge_thresholds()
	self:_set_overcharge_flow_values()
	self:_set_weapons_energy_drainable()
end

function PlayerUnitVisualEffectsExtension:_update_overcharge_thresholds()
...
function PlayerUnitVisualEffectsExtension:_set_overcharge_flow_values()
	local overcharge_extension = self.overcharge_extension
...
function PlayerUnitVisualEffectsExtension:_set_character_overcharge(value)
...
function PlayerUnitVisualEffectsExtension:_set_weapons_energy_drainable()
...
function PlayerUnitVisualEffectsExtension:_set_character_overcharge_threshold()
	local unit = self.unit
	local third_person_mesh_unit = self.third_person_mesh_unit
	local first_person_unit = self.first_person_unit
	local first_person_mesh_unit = self.first_person_mesh_unit
...
function PlayerUnitVisualEffectsExtension:_set_weapons_overcharge(value)
	local inventory_extension = self.inventory_extension
	local wielded_slot_data = inventory_extension:get_wielded_slot_data()
...
function PlayerUnitVisualEffectsExtension:_set_weapons_overcharge_threshold()
	local inventory_extension = self.inventory_extension
	local wielded_slot_data = inventory_extension:get_wielded_slot_data()
