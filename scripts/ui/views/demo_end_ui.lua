...
function DemoEndUI:init(world)
	...
	"material", demo_video.video_name)
...
function DemoEndUI:_create_ui_elements()
...
function DemoEndUI:update(dt, t)
	self:_draw(dt, t)
end

function DemoEndUI:_draw(dt, t)
