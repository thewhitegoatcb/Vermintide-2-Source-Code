...
settings.breeds = { "scripts/settings/breeds/breed_chaos_exalted_sorcerer_drachenfels" }



settings.behaviour_trees_precompiled = { "scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_exalted_sorcerer_drachenfels" }



settings.anim_lookup = { "attack_float_01", "attack_float_02", "attack_float_01_fwd", "attack_float_02_fwd", "attack_float_03", "attack_float_06", "attack_float_03_fwd", "attack_float_06_fwd", "attack_close_01", "attack_close_02", "attack_close_03", "attack_float_special", "attack_float_combo_01", "float_teleport_start", "float_teleport_end", "teleport_defensive", "to_exhausted", "toggle_movement", "teleport_to_aoe", "teleport_to_flying", "float_teleport_death_end" }
...
settings.behaviour_trees = { "scripts/entity_system/systems/behaviour/trees/chaos/chaos_exalted_sorcerer_drachenfels_behavior" }



settings.behaviour_tree_nodes = { "scripts/entity_system/systems/behaviour/nodes/chaos_sorcerer/bt_chaos_sorcerer_charge_action", "scripts/entity_system/systems/behaviour/nodes/chaos_sorcerer/bt_swarm_action" }
...
settings.utility_considerations_file_names = { "scripts/settings/dlcs/penny/penny_utility_considerations" }



settings.unit_extension_templates = { "scripts/settings/dlcs/penny/penny_unit_extension_templates" }



settings.ai_breed_snippets_file_names = { "scripts/settings/dlcs/penny/penny_ai_breed_snippets" }



settings.enemy_package_loader_breed_categories = {
	level_specific = { "chaos_exalted_sorcerer_drachenfels" } }