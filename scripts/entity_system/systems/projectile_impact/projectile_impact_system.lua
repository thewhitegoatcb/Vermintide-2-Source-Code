...
local extensions = { "ProjectileBaseImpactUnitExtension", "ProjectileRaycastImpactUnitExtension", "PlayerProjectileImpactUnitExtension", "ProjectileFixedImpactUnitExtension", "ProjectileLinearSphereSweepImpactUnitExtension" }
...
function ProjectileImpactSystem:init(entity_system_creation_context, system_name)
...
function ProjectileImpactSystem:destroy()
