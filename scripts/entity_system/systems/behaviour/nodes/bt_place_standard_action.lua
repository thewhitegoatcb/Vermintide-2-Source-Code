...
function BTPlaceStandardAction:init(...)
...
function BTPlaceStandardAction:enter(unit, blackboard, t)
...
function BTPlaceStandardAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPlaceStandardAction:run(unit, blackboard, t, dt)
...
function BTPlaceStandardAction:anim_cb_place_standard(unit, blackboard)
	...
	if game then
		...
		if position_on_navmesh then
			...
			local extension_init_data = {
				...
				death_system = { death_reaction_template = "standard" },
...
function BTPlaceStandardAction:anim_cb_placed_standard(unit, blackboard)
