...
local scenegraph_definition = {
	...
	indicator_centre = { vertical_alignment = "center", parent = "root", horizontal_alignment = "center",
...
local ignored_damage_types = { temporary_health_degen = true, vomit_face = true, buff_shared_medpack = true, buff = true, damage_over_time = true, life_tap = true, health_degen = true, warpfire_ground = true, vomit_ground = true, warpfire_face = true, wounded_dot = true, overcharge = true, heal = true, knockdown_bleed = true, life_drain = true }
...
local damage_indicator_widget_definition = { scenegraph_id = "indicator_centre",
	element = UIElements.RotatedTexture,
	content = { texture_id = "damage_direction_indicator" },


	style = {
		rotating_texture = { angle = 90,
...
local colors_by_type = {
	enemy = { 255, 205, 50, 50 },
	friendly_fire = { 255, 50, 205, 50 } }


DamageIndicatorGui = class(DamageIndicatorGui)

function DamageIndicatorGui:init(parent, ingame_ui_context)
	self._parent = parent
...
function DamageIndicatorGui:create_ui_elements()
...
function DamageIndicatorGui:destroy()
	return end

function DamageIndicatorGui:update(dt)
