...
function BTSelector_chaos_exalted_sorcerer:init(...)
	BTSelector_chaos_exalted_sorcerer.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_exalted_sorcerer:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_exalted_sorcerer:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_exalted_sorcerer:add_child(node)
