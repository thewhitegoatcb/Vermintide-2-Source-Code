...
ActionTemplates.wield = {
	default = { wield_cooldown = 0.35, weapon_action_hand = "either", kind = "wield", keep_buffer = true, action_priority = 2, uninterruptible = true, total_time = 0,
...
ActionTemplates.wield_and_use = {
	default = { ammo_usage = 1, slot_to_wield = "slot_level_event", weapon_action_hand = "either", kind = "instant_wield", uninterruptible = true, total_time = 0,
...
ActionTemplates.reload = {
	...
	auto_reload_on_empty = { weapon_action_hand = "either", kind = "reload", total_time = 0,
		condition_func = function (action_user, input_extension)
			return false
		end,
		chain_condition_func = function (action_user, input_extension)
...
ActionTemplates.action_inspect = {
	default = { weapon_action_hand = "either", kind = "dummy", total_time = 1,
		...
		allowed_chain_actions = { { start_time = 0, end_time = 0, input = "action_inspect_hold" },
			{ sub_action = "action_inspect_hold", start_time = 0, action = "action_inspect", auto_chain = true } } },



	action_inspect_hold = { cooldown = 0.15, minimum_hold_time = 0.3, anim_end_event = "inspect_end", kind = "dummy", can_abort_reload = false, weapon_action_hand = "either", hold_input = "action_inspect_hold", anim_event = "inspect_start",
...
ActionTemplates.give_item_on_defend = { interaction_priority = 5, ammo_usage = 1, anim_end_event = "attack_finished", kind = "interaction", interaction_type = "give_item", weapon_action_hand = "left", uninterruptible = true, do_not_validate_with_hold = true, hold_input = "action_two_hold", anim_event = "parry_pose", total_time = 0,
...
ActionTemplates.instant_give_item = {
	...
	instant_give = { interaction_priority = 4, ammo_usage = 1, anim_end_event = "attack_finished", kind = "interaction", interaction_type = "give_item", weapon_action_hand = "left", uninterruptible = true, hold_input = "interact", anim_event = "parry_pose", total_time = 0,
...
ActionTemplates.career_skill_dummy = {
	default = { kind = "dummy", weapon_action_hand = "either", total_time = 0,
...
ActionTemplates.action_career_bw_1 = {
	default = { slot_to_wield = "slot_career_skill_weapon", input_override = "action_career", weapon_action_hand = "either", kind = "instant_wield", total_time = 0,
		condition_func = function (action_user, input_extension)
		...
		action_on_wield = { action = "action_career_hold", sub_action = "default" },
		allowed_chain_actions = { } } }
...
for _, action_names in pairs(CareerActionNames) do
	for i = 1, #action_names do
		...
		default_data.chain_condition_func = condition_func end end