...
function OverpoweredBlobHealthExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function OverpoweredBlobHealthExtension:update(dt, context, t)
...
function OverpoweredBlobHealthExtension:destroy()
