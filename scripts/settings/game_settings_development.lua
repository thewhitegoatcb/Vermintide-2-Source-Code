...
GameSettingsDevelopment.debug_unit_colors = { { 255, 0, 0 },
	{ 0, 255, 0 },
	{ 0, 255, 255 },
	{ 255, 255, 0 },
	{ 255, 0, 255 },
...
GameSettingsDevelopment.ignored_rpc_logs = { "rpc_network_clock_sync_request", "rpc_network_time_sync_response", "rpc_network_current_server_time_response", "rpc_network_current_server_time_request", "rpc_add_damage", "rpc_heal", "rpc_ai_drop_single_item", "rpc_ai_inventory_wield", "rpc_ai_show_single_item", "rpc_ai_weapon_shoot_start", "rpc_ai_weapon_shoot_end", "rpc_interest_point_chatter_update", "rpc_set_animation_rotation_scale", "rpc_set_animation_translation_scale", "rpc_set_script_driven", "rpc_set_affected_by_gravity", "rpc_set_animation_driven", "rpc_constrain_ai", "rpc_sync_anim_state_1", "rpc_sync_anim_state_2", "rpc_sync_anim_state_3", "rpc_sync_anim_state_4", "rpc_sync_anim_state_5", "rpc_sync_anim_state_6", "rpc_sync_anim_state_7", "rpc_sync_anim_state_8", "rpc_sync_anim_state_9", "rpc_sync_anim_state_10", "rpc_sync_anim_state_11", "rpc_sync_anim_state_12", "rpc_create_bot_nav_transition", "rpc_pacing_changed", "rpc_play_dialogue_event", "rpc_trigger_dialogue_event", "rpc_interrupt_dialogue_event", "rpc_anim_event", "rpc_anim_event_variable_float", "rpc_update_anim_variable_done", "rpc_attack_hit", "rpc_enemy_has_target", "rpc_enemy_is_alerted", "rpc_set_blocking", "rpc_set_charge_blocking", "rpc_status_change_bool", "rpc_skinned_surface_mtr_fx", "rpc_surface_mtr_fx", "rpc_surface_mtr_fx_lvl_unit", "rpc_play_melee_hit_effects", "rpc_weapon_blood", "rpc_link_unit", "rpc_play_first_person_sound", "rpc_server_audio_event", "rpc_server_audio_event_at_pos", "rpc_server_audio_unit_event", "rpc_server_audio_unit_param_string_event", "rpc_server_audio_unit_param_int_event", "rpc_server_audio_unit_param_float_event", "rpc_client_audio_set_global_parameter_with_lerp", "rpc_sync_door_state", "rpc_add_external_velocity", "rpc_tutorial_message", "rpc_player_blocked_attack", "rpc_set_wounded", "rpc_alert_enemy", "rpc_start_mission_with_unit", "rpc_update_mission", "rpc_end_mission", "rpc_objective_entered_socket_zone", "rpc_create_explosion", "rpc_area_damage", "rpc_player_projectile_impact_dynamic", "rpc_client_spawn_light_weight_projectile", "rpc_client_despawn_light_weight_projectile", "rpc_player_projectile_impact_level", "rpc_projectile_stopped", "rpc_generic_impact_projectile_impact", "rpc_show_inventory", "rpc_assign_peer_to_profile", "rpc_add_equipment", "rpc_create_attachment", "rpc_wield_equipment", "rpc_destroy_slot", "rpc_set_current_location", "rpc_sync_damage_taken", "rpc_flow_state_story_played", "rpc_flow_state_story_stopped", "rpc_flow_state_number_changed", "rpc_add_buff", "rpc_server_audio_unit_event", "rpc_remove_server_controlled_buff", "rpc_ping", "rpc_pong", "rpc_shared_state_set_int", "rpc_shared_state_set_string", "rpc_shared_state_set_bool", "rpc_shared_state_set_server_int", "rpc_shared_state_set_server_string", "rpc_shared_state_set_server_bool" }
