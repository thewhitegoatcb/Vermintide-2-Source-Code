...
table.merge_recursive(BTConditions.ability_check_categories, {
	ranged_weapon = { dr_engineer = true } })
...
function BTConditions.can_activate.dr_engineer(blackboard)
...
function BTConditions.reload_ability_weapon.dr_engineer(blackboard, args)
	local career_extension = blackboard.career_extension
