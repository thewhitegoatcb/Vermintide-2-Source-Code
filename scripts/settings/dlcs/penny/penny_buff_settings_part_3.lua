...
settings.buff_templates = {
	enemy_penny_curse_pulse = {
		buffs = { { update_func = "enemy_penny_curse_pulse", name = "penny_curse_pulse", radius = 3, tick_rate = 0.5 } } },
	...
	enemy_penny_curse = {
		buffs = { { duration = 5, name = "penny_curse", debuff = true, max_stacks = 50, icon = "troll_vomit_debuff", refresh_durations = true,
...
settings.buff_function_templates = {
	enemy_penny_curse_pulse = function (unit, buff, params, world)
		local t = params.t
		if Managers.state.network.is_server and HEALTH_ALIVE [unit] and (
		buff.next_tick == nil or buff.next_tick and buff.next_tick < t) then
