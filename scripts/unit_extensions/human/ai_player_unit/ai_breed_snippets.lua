...
local function setup_start_angry(unit, blackboard, conflict_director)
	...
	if behind_door then
		...
		blackboard.waiting = { next_player_unit_index = 1, awake_on_players_passing = true, view_cone_dot = 1, next_update_time = 0, travel_dist = travel_dist }
	else
...
function AiBreedSnippets.on_rat_ogre_spawn(unit, blackboard)
	local breed = blackboard.breed
...
function AiBreedSnippets.on_rat_ogre_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
...
function AiBreedSnippets.on_rat_ogre_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_spawn(unit, blackboard)
	blackboard.aggro_list = { }
	blackboard.fling_skaven_timer = 0
	blackboard.next_move_check = 0
...
function AiBreedSnippets.on_stormfiend_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_demo_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_demo_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_demo_shoot(unit, blackboard)
...
function AiBreedSnippets.on_loot_rat_update(unit, blackboard, t)

	local t = Managers.time:time("game")
	local cooldown_time = blackboard.dodge_cooldown_time
	if not cooldown_time or cooldown_time < t then
		local breed = blackboard.breed
		local dodge_vector, threat_vector = LocomotionUtils.in_crosshairs_dodge(unit, blackboard, t,
		breed.dodge_crosshair_radius, breed.dodge_crosshair_delay, breed.dodge_crosshair_min_distance, breed.dodge_crosshair_max_distance)
...
function AiBreedSnippets.on_loot_rat_alerted(unit, blackboard, alerting_unit, enemy_unit)
...
function AiBreedSnippets.on_loot_rat_stagger_action_done(unit)
...
function AiBreedSnippets.on_chaos_troll_spawn(unit, blackboard)
	blackboard.aggro_list = { }
	blackboard.fling_skaven_timer = 0
...
function AiBreedSnippets.on_chaos_troll_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_troll_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_dummy_troll_spawn(unit, blackboard)
	blackboard.aggro_list = { }
	blackboard.can_get_downed = true
	blackboard.crouch_sticky_timer = 0
	blackboard.displaced_units = { }
...
function AiBreedSnippets.on_chaos_dummy_troll_update(unit, blackboard)
	local t = Managers.time:time("game")
...
function AiBreedSnippets.on_chaos_dummy_troll_death(unit, blackboard)
	local audio_system = Managers.state.entity:system("audio_system")
	audio_system:play_audio_unit_event("Play_enemy_troll_vce_hurt", unit)
end

function AiBreedSnippets.on_chaos_dummy_sorcerer_spawn(unit, blackboard, t)
	local health_extension = ScriptUnit.extension(unit, "health_system")
...
function AiBreedSnippets.on_storm_vermin_champion_spawn(unit, blackboard)
	local breed = blackboard.breed
	blackboard.aggro_list = { }
	blackboard.next_move_check = 0
...
function AiBreedSnippets.on_storm_vermin_champion_husk_spawn(unit)
	local actor = Unit.actor(unit, "c_trophy_rack_ward")
	Actor.set_collision_enabled(actor, false)
	Actor.set_scene_query_enabled(actor, false)
end

function AiBreedSnippets.on_storm_vermin_hot_join_sync(sender, unit)
...
function AiBreedSnippets.on_storm_vermin_champion_update(unit, blackboard, t, dt)
	local side = Managers.state.side.side_by_unit [unit]
	local enemy_player_and_bot_units = side.ENEMY_PLAYER_AND_BOT_UNITS
...
function AiBreedSnippets.on_storm_vermin_champion_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_storm_vermin_champion_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_warrior_spawn(unit, blackboard)
	blackboard.displaced_units = { }
	blackboard.aggro_list = { }
end

function AiBreedSnippets.on_chaos_warrior_update(unit, blackboard, t)
	local breed = blackboard.breed
...
function AiBreedSnippets.on_chaos_tentacle_despawn(unit, blackboard)
	...
	if
	boss_master_unit and Unit.alive(boss_master_unit) then
...
function AiBreedSnippets.on_chaos_spawn_spawn(unit, blackboard)
	local breed = blackboard.breed
	blackboard.aggro_list = { }
	blackboard.fling_skaven_timer = 0
	blackboard.next_move_check = 0
...
function AiBreedSnippets.on_chaos_spawn_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_spawn_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_vortex_sorcerer_spawn(unit, blackboard)
	local breed = blackboard.breed
...
function AiBreedSnippets.on_chaos_vortex_sorcerer_death(unit, blackboard)
	remove_vortex_units(unit, blackboard)
end

function AiBreedSnippets.on_chaos_vortex_sorcerer_despawn(unit, blackboard)
	remove_vortex_units(unit, blackboard)
end
...
function AiBreedSnippets.on_chaos_plague_sorcerer_spawn(unit, blackboard)
	blackboard.spell_count = 0
end
...
function AiBreedSnippets.on_chaos_tentacle_sorcerer_spawn(unit, blackboard)
	blackboard.spell_count = 0
end
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_spawn(unit, blackboard)
	local t = Managers.time:time("game")
	local breed = blackboard.breed
	blackboard.max_vortex_units = breed.max_vortex_units
	...
	local spells = { } local spells_lookup = { }
	local physics_world = World.get_data(blackboard.world, "physics_world")

	blackboard.spell_count = 0


	local spell = { spawn_timer = 3, name = "vortex",
	...
	local spell = { name = "boss_vortex", spawn_timer = 3,
	...
	local spell = { name = "tentacle", search_counter = 0, chance_to_look_for_wall_spawn = 0.5, portal_spawn_type = "n/a",
	...
	local spell = { range = 40, magic_missile = true, magic_missile_speed = 20, true_flight_template_name = "sorcerer_magic_missile", projectile_unit_name = "units/weapons/projectile/magic_missile/magic_missile", name = "magic_missile", launch_angle = 0.7,
	...
	local spell = { range = 40, magic_missile = true, magic_missile_speed = 15, true_flight_template_name = "sorcerer_strike_missile", projectile_unit_name = "units/weapons/projectile/strike_missile/strike_missile", name = "sorcerer_strike_missile", explosion_template_name = "chaos_strike_missile_impact", launch_angle = 1.25,
	...
	local spell = { range = 40, name = "magic_missile_ground", magic_missile = true, magic_missile_speed = 20, true_flight_template_name = "sorcerer_magic_missile_ground", projectile_unit_name = "units/weapons/projectile/magic_missile/magic_missile",
	...
	local spell = { name = "missile_barrage", magic_missile = true, magic_missile_speed = 20, range = 40,
	...
	local spell = { range = 40, name = "seeking_bomb_missile", magic_missile = true, magic_missile_speed = 2.5, true_flight_template_name = "sorcerer_slow_bomb_missile", projectile_unit_name = "units/weapons/projectile/insect_swarm_missile/insect_swarm_missile_01", explosion_template_name = "chaos_slow_bomb_missile", life_time = 15,
	...
	if blackboard.in_boss_arena then
		...
		function blackboard.valid_teleport_pos_func(pos, blackboard)
...
function check_for_recent_attackers(unit, blackboard, t, ranged_range)
	...
	elseif blackboard.recent_melee_attacker and
	blackboard.recent_melee_attacker_timer < t then
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_update(unit, blackboard, t, dt)
...
function AiBreedSnippets.reward_boss_kill_loot(unit, blackboard)
	...
	wanted_drop_position =
	wanted_drop_position or position
...
function AiBreedSnippets.drop_loot(num_die, pos, has_physics, unit)
	local pickup_name = Managers.state.game_mode:get_boss_loot_pickup()
	if not pickup_name then
		return
	end
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_exalted_champion_spawn(unit, blackboard)
	local t = Managers.time:time("game")
...
function AiBreedSnippets.on_chaos_exalted_champion_norsca_spawn(unit, blackboard)
	local t = Managers.time:time("game")
...
function AiBreedSnippets.on_chaos_exalted_champion_update(unit, blackboard, t, dt)
	local self_pos = POSITION_LOOKUP [unit]
	local breed = blackboard.breed
...
function AiBreedSnippets.update_exalted_champion_cheer_state(unit, blackboard, t, dt, player_average_hp)
	local network_manager = Managers.state.network
	local network_transmit = network_manager.network_transmit
	local audio_system = Managers.state.entity:system("audio_system")
...
function AiBreedSnippets.on_chaos_exalted_champion_norsca_update(unit, blackboard, t, dt)
	local self_pos = POSITION_LOOKUP [unit]
	local breed = blackboard.breed
...
function AiBreedSnippets.on_chaos_exalted_champion_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_exalted_champion_norsca_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:freeze_intensity_decay(1)
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_chaos_exalted_champion_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_stormfiend_boss_spawn(unit, blackboard)
...
function AiBreedSnippets.on_stormfiend_boss_update(unit, blackboard)
	local breed = blackboard.breed
	local hp = ScriptUnit.extension(blackboard.unit, "health_system"):current_health_percent()
...
function AiBreedSnippets.on_stormfiend_boss_dismount(unit, blackboard)
...
function AiBreedSnippets.on_grey_seer_spawn(unit, blackboard)
	local breed = blackboard.breed
	local t = Managers.time:time("game")
	local physics_world = World.get_data(blackboard.world, "physics_world")
	blackboard.aggro_list = { }
	...
	local spell = { range = 40, name = "magic_missile", magic_missile = true, magic_missile_speed = 20, true_flight_template_name = "sorcerer_magic_missile", projectile_unit_name = "units/weapons/projectile/warp_lightning_bolt/warp_lightning_bolt", read_from_missile_data = true, explosion_template_name = "grey_seer_warp_lightning_impact",
...
function AiBreedSnippets.on_grey_seer_update(unit, blackboard, t)
	local breed = blackboard.breed
...
function AiBreedSnippets.on_grey_seer_death(unit, blackboard, t)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_grey_seer_despawn(unit, blackboard, t)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
...
function AiBreedSnippets.on_gutter_runner_spawn(unit, blackboard)
	local t = Managers.time:time("game")
...
function AiBreedSnippets.update_enemy_sighting_within_commander_sticky(blackboard)
		...
		elseif HEALTH_ALIVE [blackboard.commander_target] then
			...
			if blackboard.attack_token or blackboard.keep_target then
				...
				if distance_sq < detection_radius * detection_radius then
					within_commander_range = true end end end until true
