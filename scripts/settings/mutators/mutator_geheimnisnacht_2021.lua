local spawn_lists = {
	skaven = { "skaven_plague_monk", "skaven_clan_rat", "skaven_plague_monk", "skaven_clan_rat", "skaven_plague_monk", "skaven_clan_rat" },
	...
	chaos = { "chaos_marauder", "chaos_marauder", "chaos_marauder", "chaos_marauder", "chaos_marauder" } }
...
local event_settings = {
	...
	warcamp = {
		ritual_locations = { { -151.1, -20, 19.15, 0 } } },



	nurgle = {
		ritual_locations = { { 175.1, -114.5, 2.5, 0 } } },



	dlc_wizards_tower = {
		ritual_locations = { { 4.45, 36.4, 77.01, 0 } } },



	dlc_bastion = {
		ritual_locations = { { 109.6, 56.7, -52.8, 0 } } },



	dlc_dwarf_beacons = {
		ritual_locations = { { -128.2, -102.8, -15.3, 0 } } } }
...
local hard_mode_mutators = { "geheimnisnacht_2021_hard_mode" }
...
return { description = "description_mutator_geheimnisnacht_2021", icon = "mutator_icon_death_spirits", display_name = "display_name_mutator_geheimnisnacht_2021", curse_package_name = "resource_packages/dlcs/geheimnisnacht_2021_event",
	...
	spawn_ritual_ring = function (position, rotation)
		...
		local extension_init_data = {
			health_system = { damage_cap_per_hit = 1, health = 15 },



			death_system = { death_reaction_template = "geheimnisnacht_2021_altar" },
		...
		local spread = 2.5
		local idle_variations = { "idle_pray_01", "idle_pray_02", "idle_pray_03", "idle_pray_04", "idle_pray_05" }
		local optional_data_base = { far_off_despawn_immunity = true, ignore_breed_limits = true,
			...
			spawned_func = function (unit, breed, optional_data)
				...
				if breed == Breeds.chaos_marauder and
				ScriptUnit.has_extension(unit, "ai_inventory_system") then
		...
		local group_data = { template = "geheimnisnacht_2021_altar_cultists",
