...
local page_settings = {
	{ sound_event_enter = "play_gui_equipment_button", name = "salvage", class_name = "CraftPageSalvageConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "craft_random_item", class_name = "CraftPageCraftItemConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "reroll_weapon_properties", class_name = "CraftPageRollPropertiesConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "reroll_weapon_traits", class_name = "CraftPageRollTraitConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "upgrade_item_rarity_common", class_name = "CraftPageUpgradeItemConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "apply_weapon_skin", class_name = "CraftPageApplySkinConsole", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "convert_blue_dust", class_name = "CraftPageConvertDustConsole", sound_event_exit = "play_gui_equipment_close" } }
...
function HeroWindowCraftingConsole:on_enter(params, offset)
...
function HeroWindowCraftingConsole:_start_transition_animation(animation_name)
	local params = {
		wwise_world = self.wwise_world,
...
function HeroWindowCraftingConsole:create_ui_elements(params, offset)
...
function HeroWindowCraftingConsole:on_exit(params)
...
function HeroWindowCraftingConsole:set_input_description(input_desc_name)
...
function HeroWindowCraftingConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCraftingConsole:_update_input_desc()
...
function HeroWindowCraftingConsole:post_update(dt, t)
	if self._active_page and self._active_page.post_update then
		self._active_page:post_update(dt, t)
	end
end

function HeroWindowCraftingConsole:_update_animations(dt)
...
function HeroWindowCraftingConsole:_is_button_pressed(widget)
...
function HeroWindowCraftingConsole:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowCraftingConsole:_is_button_held(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowCraftingConsole:set_focus(focused)
	self._focused = focused
end

function HeroWindowCraftingConsole:_handle_input(dt, t)
...
function HeroWindowCraftingConsole:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCraftingConsole:draw(dt)
...
function HeroWindowCraftingConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowCraftingConsole:_change_recipe_page(current_page)
...
function HeroWindowCraftingConsole:window_input_service()
	return
end

function HeroWindowCraftingConsole:_set_page_index(page_index)
...
function HeroWindowCraftingConsole:_set_crafting_glow_progress(progress)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowCraftingConsole:on_craft_ended()
	local active_page = self._active_page
...
function HeroWindowCraftingConsole:craft(items, recipe_override)
...
function HeroWindowCraftingConsole:craft_complete(result)
...
function HeroWindowCraftingConsole:waiting_for_craft()
	return self._waiting_for_craft
end

function HeroWindowCraftingConsole:lock_input()
...
function HeroWindowCraftingConsole:unlock_input()
	local input_manager = self.input_manager
...
function HeroWindowCraftingConsole:_set_input_progress(progress)
...
function HeroWindowCraftingConsole:set_reward_tooltip_item(item)
	local widget = self._widgets_by_name.item_tooltip
	widget.content.item = item
	self._tooltip_item_id = item
end

function HeroWindowCraftingConsole:has_active_reward_tooltip()
	return self._tooltip_item_id
end

local item_tooltip_skip_inputs = { "confirm_press", "refresh_press", "special_1_press", "back_menu", "move_up", "move_down", "move_left", "move_right" }
...
function HeroWindowCraftingConsole:_handle_tooltip_skip_input(input_service)
