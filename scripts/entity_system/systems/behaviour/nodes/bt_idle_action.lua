...
function BTIdleAction:enter(unit, blackboard, t)
...
function BTIdleAction:leave(unit, blackboard, t, reason, destroy)
...
function BTIdleAction:_discovery_sound_when_close(unit, blackboard)
...
function BTIdleAction:run(unit, blackboard, t, dt)
