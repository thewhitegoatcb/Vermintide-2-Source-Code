local scenegraph_definition = {
	screen = { vertical_alignment = "center", scale = "fit", horizontal_alignment = "center",

		size = { 1920, 1080 },
		position = { 0, 0, UILayer.controller_description } },



	input_description_field = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "center",
	...
	background = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "center" },




	fullscreen_background = { vertical_alignment = "bottom", scale = "fit_width",
...
local function create_background_widget(num_elements)
	return { scenegraph_id = "background",
		element = {
		...
		content = { background_id = "tab_menu_bg_02" },
		...
		style = {
			background = { vertical_alignment = "bottom", horizontal_alignment = "center",
				...
				texture_size = { texture_settings.size [1] * num_elements, texture_settings.size [2] * 1.2 } } } }
...
local function create_fullscreen_background_widget()
	return UIWidgets.create_simple_uv_texture("menu_panel_bg", { { 0, 1 }, { 1, 0 } }, "fullscreen_background", nil, nil, { 200, 10, 10, 10 })
end
...
local function create_input_description_widgets(amount)
	...
	for i = 1, amount do
		...
		scenegraph_definition [scenegraph_root_id] = { vertical_alignment = "center", parent = "input_description_field", horizontal_alignment = "left",
		...
		local widget_definition = {
			...
			style = {
				...
				text_shadow = { font_size = 24, word_wrap = true, pixel_perfect = true, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
...
function MenuInputDescriptionUI:init(ingame_ui_context, ui_renderer, input_service, number_of_elements, layer, generic_actions, use_fullscreen_layout)
...
function MenuInputDescriptionUI:create_ui_elements(ui_renderer, number_of_elements, use_fullscreen_layout)
...
function MenuInputDescriptionUI:_verify_input()
...
function MenuInputDescriptionUI:draw(ui_renderer, dt)
	self:_verify_input()
...
function MenuInputDescriptionUI:destroy()

	return end

function MenuInputDescriptionUI:change_generic_actions(new_generic_actions)
	self.generic_actions = new_generic_actions
	self:set_input_description(self.current_console_selection_data)
end

function MenuInputDescriptionUI:setup_console_widget_selections()
	local steppers = self.steppers
	local console_widget_selections = { { name = "difficulty", gamepad_support = true,



			widget = steppers.difficulty.widget,
			actions = { { hotspot_id = "left_button_hotspot", input_action = "move_left", description_text = "input_description_previous" },




				{ hotspot_id = "right_button_hotspot", input_action = "move_right", description_text = "input_description_next" } } },
		...
		{ name = "privacy", gamepad_support = true,
		...
		{ name = "level", gamepad_support = true,
		...
		{ name = "play_button", gamepad_support = false,



			widget = self.play_button_console_widget,
			actions = { { hotspot_id = "button_hotspot", input_action = "confirm", description_text = "input_description_confirm" } } },
		...
		{ name = "quickmatch_button", gamepad_support = false,
...
function MenuInputDescriptionUI:set_input_description(console_selection_data)
	self:clear_input_descriptions()
...
function MenuInputDescriptionUI:clear_input_descriptions()
	self.number_of_descriptions_in_use = nil
end

function MenuInputDescriptionUI:get_gamepad_input_texture_data(input_action, ignore_keybinding)
...
function MenuInputDescriptionUI:_align_inputs(total_width, spacing, widgets_width_list)
	local ui_scenegraph = self.ui_scenegraph
