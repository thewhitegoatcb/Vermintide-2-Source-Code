...
function ActionStaff:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionStaff:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionStaff:client_owner_post_update(dt, t, world, can_damage)
...
function ActionStaff:finish(reason)
...
function ActionStaff:fire(reason)
