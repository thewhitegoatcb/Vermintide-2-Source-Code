...
local LOADOUT_SLOTS = LOADOUT_SLOTS or { slot_necklace = true, slot_trinket_1 = true, slot_ring = true, slot_melee = true, slot_ranged = true }
...
function LoadoutUtils.sync_loadout_slot(player, slot_name, item, sync_to_specific_peer_id)
...
local EMPTY_TABLE = { }
function LoadoutUtils.hot_join_sync(peer_id)
...
function LoadoutUtils.create_loadout_item_from_rpc_data(slot_id, item_id, rarity_id, power_level, properties_array, properties_values_array, traits_array)
...
function LoadoutUtils.properties_to_rpc_params(item)
...
function LoadoutUtils.properties_from_rpc_params(properties_array, properties_values_array, traits_array)
	local properties_lookup = NetworkLookup.properties
	local traits_lookup = NetworkLookup.traits
