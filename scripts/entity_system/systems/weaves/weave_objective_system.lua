...
local extensions = { "WeaveCapturePointExtension", "WeaveTargetExtension", "WeaveItemExtension", "WeaveLimitedItemSpawnerExtension", "WeaveDoomWheelExtension", "WeaveInteractionExtension", "WeaveKillEnemiesExtension", "WeaveSocketExtension" }
...
function WeaveObjectiveSystem:init(entity_system_creation_context, system_name)
	...
	self._essence_unit_names = { "units/fx/essence_unit", "units/fx/essence_unit" }
	self._essence_sound_events = { "Play_hud_wind_collect_essence", "Play_hud_wind_collect_essence_chunk" }
...
function WeaveObjectiveSystem:_activate_objectives(objectives)
...
function WeaveObjectiveSystem:update(context, t)
	local dt = context.dt
...
function WeaveObjectiveSystem:_update_activate_objectives()
...
function WeaveObjectiveSystem:_complete_objective(id, extension, objects_to_remove)
...
function WeaveObjectiveSystem:deactivate()
...
function WeaveObjectiveSystem:game_object_created(game_object_id)
...
function WeaveObjectiveSystem:add_score(score)
	self._weave_manager:increase_bar_score(score)
end

function WeaveObjectiveSystem:on_ai_killed(killed_unit, killer_unit, death_data, killing_blow)
...
function WeaveObjectiveSystem:spawn_essence_unit(position, size)
	local essence_unit_data = self._essence_unit_data
	local index = nil
...
function WeaveObjectiveSystem:_collect_dropped_essence(dt)
...
function WeaveObjectiveSystem:only_kill_objective()
	local num_update_list = #self._main_objectives
