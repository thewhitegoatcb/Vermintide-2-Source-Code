return { description = "description_mutator_slayer_curse", display_name = "display_name_mutator_slayer_curse", decay_tick = 1, icon = "mutator_icon_slayer_curse", decay_start = 5,
	...
	server_ai_killed_function = function (context, data, killed_unit, killer_unit)
		...
		if not player_units [killer_unit] then
			player_units [killer_unit] = { next_decay = 0,
				buffs = { } }
		end
