...
Colors.color_definitions = {
	...
	default = { 255, 75, 100, 100 },
	plentiful = { 255, 255, 255, 255 },
	common = { 255, 41, 138, 15 },
	rare = { 255, 33, 88, 169 },
	exotic = { 255, 220, 115, 10 },
	unique = { 255, 180, 31, 38 },
	magic = { 255, 0, 211, 178 },
	promo = { 255, 140, 31, 135 },


	card_plentiful = { 255, 255, 255, 255 },
	card_common = { 255, 0, 255, 0 },
	card_rare = { 255, 0, 0, 255 },
	card_exotic = { 255, 255, 25, 0 },
	card_unique = { 255, 255, 0, 0 },
	card_promo = { 255, 255, 0, 255 },


	iron_tokens = { 255, 255, 255, 255 },
	bronze_tokens = { 255, 115, 197, 42 },
	silver_tokens = { 255, 30, 116, 189 },
	gold_tokens = { 255, 236, 107, 20 },


	drag_same_slot = { 255, 255, 168, 0 },
	drag_same_slot_hover = { 255, 0, 255, 0 },
	drag_same_slot_disabled = { 255, 255, 0, 0 },


	credits_title = { 255, 255, 168, 0 },
	credits_header = { 255, 255, 215, 0 },
	credits_normal = { 255, 255, 255, 255 },


	loading_screen_stone = { 255, 23, 22, 20 },


	font_default = { 255, 181, 181, 181 },
	font_title = { 255, 193, 91, 36 },
	font_button_normal = { 255, 160, 146, 101 },

	button_normal = { 255, 230, 40, 73 },
	button_green = { 255, 0, 200, 10 },
	button_red = { 255, 255, 0, 0 },


	hit_marker_normal = { 255, 255, 255, 255 },
	hit_marker_critical = { 255, 255, 161, 53 },
	hit_marker_armored = { 255, 70, 130, 180 },
	hit_marker_friendly = { 255, 50, 205, 50 },


	twitch = { 255, 100, 65, 164 },
	very_dark_gray = { 255, 80, 80, 80 },


	wh_captain = { 255, 153, 184, 193 },
	wh_bountyhunter = { 255, 198, 154, 74 },
	wh_zealot = { 255, 202, 197, 174 },
	wh_priest = { 255, 230, 184, 71 },
	dr_ranger = { 255, 187, 235, 30 },
	dr_ironbreaker = { 255, 41, 219, 255 },
	dr_slayer = { 255, 228, 0, 0 },
	dr_engineer = { 255, 255, 191, 4 },
	we_waywatcher = { 255, 55, 123, 44 },
	we_maidenguard = { 255, 74, 145, 236 },
	we_shade = { 255, 151, 99, 192 },
	we_thornsister = { 255, 64, 194, 176 },
	es_mercenary = { 255, 204, 128, 128 },
	es_huntsman = { 255, 114, 130, 67 },
	es_knight = { 255, 36, 84, 173 },
	es_questingknight = { 255, 255, 191, 4 },
	bw_adept = { 255, 255, 93, 0 },
	bw_scholar = { 255, 173, 28, 8 },
	bw_unchained = { 255, 150, 50, 100 },
	bw_necromancer = { 255, 1, 100, 67 },
	empire_soldier_tutorial = { 255, 36, 84, 173 },

	vs_poison_wind_globadier = { 255, 153, 184, 193 },
	vs_gutter_runner = { 255, 198, 154, 74 },
	vs_packmaster = { 255, 202, 197, 174 },


	vs_ratling_gunner = { 255, 228, 0, 0 },
	vs_warpfire_thrower = { 255, 255, 192, 203 },
	vs_chaos_troll = { 255, 55, 123, 44 },
	vs_chaos_spawn = { 255, 74, 145, 236 },
	vs_stormfiend = { 255, 151, 99, 192 },
	vs_rat_ogre = { 255, 204, 128, 128 },



	console_menu_rect = { 255, 0, 0, 0 },



	healthkit_first_aid_kit_01 = { 255, 53, 204, 53 },
	wpn_side_objective_tome_01 = { 255, 216, 133, 0 },
	potion_healing_draught_01 = { 255, 53, 204, 53 },
	potion_damage_boost_01 = { 255, 216, 174, 69 },
	potion_speed_boost_01 = { 255, 65, 169, 228 },
	potion_cooldown_reduction_01 = { 255, 197, 91, 255 },
	wpn_grimoire_01 = { 255, 100, 65, 164 },
	grenade_frag_01 = { 255, 240, 32, 0 },
	grenade_frag_02 = { 255, 240, 32, 0 },
	grenade_smoke_01 = { 255, 240, 32, 0 },
	grenade_smoke_02 = { 255, 240, 32, 0 },
	grenade_fire_01 = { 255, 240, 32, 0 },
	grenade_fire_02 = { 255, 240, 32, 0 },
	...
	metal = { 255, 255, 255, 0 },
	death = { 255, 139, 0, 139 },
	heavens = { 255, 0, 191, 255 },
	light = { 255, 255, 255, 255 },
	beasts = { 255, 139, 69, 19 },
	fire = { 255, 220, 20, 60 },
	shadow = { 255, 128, 128, 128 },


	khorne = { 255, 254, 52, 31 },
	tzeentch = { 255, 61, 150, 251 },
	slaanesh = { 255, 236, 109, 251 },
	nurgle = { 255, 200, 230, 81 },
	belakor = { 255, 172, 134, 218 },

	deus_potion = { 255, 155, 17, 30 } }
...
if not Colors.distinct_colors_lookup then
	...
	local f = 92 + 63 * (i % 3)
	local g = f / 2
	Colors.distinct_colors_lookup = { { 0,
			f, 0 }, { 0, 0, f }, { f, 0, 0 }, {
			f, f, 0 }, { 0, f, f }, { f, 0, f }, {
			f, g, 0 }, { f, 0, g }, { 0, g, f }, {
			g, 0, f } }
...
function Colors.get_color_with_alpha(name, alpha)
	local color = Colors.color_definitions [name]
...
function Colors.get_table(name)
	local color = Colors.color_definitions [name]
	return { color [1], color [2], color [3], color [4] }
end

function Colors.get_color_table_with_alpha(name, alpha)
	local color = Colors.color_definitions [name]
...
function Colors.get_indexed(index)
...
function Colors.copy_to(dst, src)
	dst [1] = src [1]
	dst [2] = src [2]
	dst [3] = src [3]
	dst [4] = src [4]
...
function Colors.copy_no_alpha_to(dst, src)
	dst [2] = src [2]
	dst [3] = src [3]
	dst [4] = src [4]
end

function Colors.set(dst, a, r, g, b)
	dst [1] = a
	dst [2] = r
	dst [3] = g
	dst [4] = b
...
function Colors.lerp_color_tables(color1, color2, t, out)
	out = out or { }
	local s = 1 - t
...
function Colors.darker(col, k)
	k = DARKEN_FACTOR ^ (k or 1)
	col [4] = col [4] * k col [3] = col [3] * k col [2] = col [2] * k
end
...
function Colors.brighter(col, k)
	return Colors.darker(col, -k)
end

function Colors.luminance(col)
