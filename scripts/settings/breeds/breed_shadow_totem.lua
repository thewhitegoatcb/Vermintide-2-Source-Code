...
local breed_data = { immediate_threat = true, bot_melee_aim_node = "j_spine1", ignore_activate_unit = true, unit_template = "belakor_totem", flesh_material = "stone", poison_resistance = 100, animation_sync_rpc = "rpc_sync_anim_state_1", race = "chaos", exchange_order = 1, perception = "perception_no_seeing", debug_despawn_immunity = false, no_blood_splatter_on_damage = true, debug_spawn_category = "Misc", override_bot_target_node = "j_spine1", target_head_node = "c_blk_totem_01", far_off_despawn_immunity = true, behavior = "shadow_totem", base_unit = "units/props/blk/blk_totem_01", threat_value = 10, hit_effect_template = "HitEffectsShadowTotem",
	...
	hit_zones = {
		full = { prio = 1, actors = { "enemy_hit_box" } } },
