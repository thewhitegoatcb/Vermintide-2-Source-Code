...
function FriendsUIComponent:init(ingame_ui_context)
...
function FriendsUIComponent:_create_ui_elements()
...
function FriendsUIComponent:is_active()
	return self._active
end

function FriendsUIComponent:activate_friends_ui()
...
function FriendsUIComponent:deactivate_friends_ui()
	self._active = false
end

function FriendsUIComponent:_refresh_friends_list()
	local empty_list = { }
...
function FriendsUIComponent:join_lobby_data()
...
local EMPTY_TABLE = { }
function FriendsUIComponent:cb_refresh_friends_done(friend_list)
	friend_list =
	friend_list or EMPTY_TABLE
...
function FriendsUIComponent:_button_pressed(hotspot_content)
...
function FriendsUIComponent:update(dt, input_service)
	if DO_RELOAD then
		DO_RELOAD = false
		self:_create_ui_elements()
	end
...
function FriendsUIComponent:_update_invite_cooldown(dt)
...
function FriendsUIComponent:_update_animations(dt)
	self:_update_refresh_animations(dt)
end

function FriendsUIComponent:_update_refresh_animations(dt)
...
function FriendsUIComponent:_handle_input(input_service, dt)
	local widgets_by_name = self._widgets_by_name
...
function FriendsUIComponent:_update_active_tab(input_service, dt)
...
function FriendsUIComponent:_animate_refresh_button(widget)
	widget.content.animate = true
end

local _update_list_temp_pos_table = { 0, 0 }
function FriendsUIComponent:_update_list(active_tab)
	local list_style = active_tab.style.list_style
...
function FriendsUIComponent:_handle_list_input(active_tab)
	local item_contents = active_tab.content.list_content
...
function FriendsUIComponent:_draw(input_service, dt)
...
function FriendsUIComponent:_tab_pressed(widget)
...
function FriendsUIComponent:_activate_tab(widget)
...
function FriendsUIComponent:_deactivate_active_tab()
...
function FriendsUIComponent:_populate_tab(widget, list, allow_invite)
...
function FriendsUIComponent:_setup_tab_scrollbar(widget)
	local tabs_size = definitions.scenegraph_info.tabs_size
	local tabs_active_size = definitions.scenegraph_info.tabs_active_size
...
local _get_mask_size_temp = { 0, 0 }
local _get_mask_position_temp = { 0, 0, 0 }
function FriendsUIComponent:_get_mask_position_and_size(widget)
...
function FriendsUIComponent:_send_invite(content)
...
function FriendsUIComponent:_open_player_profile(content)
	local id = content.id
	if IS_PS4 then
...
function FriendsUIComponent:_join_player(content)
