...
local package_exclusion_list = { ["units/weapons/player/wpn_bw_deus_01/wpn_bw_deus_01_runed_3p"] = true, ["units/weapons/player/wpn_bw_deus_02/wpn_bw_deus_02_3p"] = true, ["units/weapons/player/wpn_bw_deus_02/wpn_bw_deus_02_runed_3p"] = true, ["units/weapons/player/wpn_bw_deus_01/wpn_bw_deus_01_magic_3p"] = true, ["units/weapons/player/wpn_bw_deus_01/wpn_bw_deus_01_3p"] = true, ["units/weapons/player/wpn_bw_deus_02/wpn_bw_deus_02_magic_3p"] = true }
...
function DeusChestPreloadExtension:init(extension_init_context, unit, extension_init_data)
...
function DeusChestPreloadExtension:extensions_ready(world, unit)
...
function DeusChestPreloadExtension:update(unit, input, dt, context, t)
...
function DeusChestPreloadExtension:get_weapon_preload_packages()
	return self._weapon_preload_packages
end

function DeusChestPreloadExtension:get_chest_type()
	return self._chest_type
end

function DeusChestPreloadExtension:_generate_stored_weapon_packages(career_name)
...
function DeusChestPreloadExtension:_generate_upgraded_weapon_packages()
	local deus_run_controller = self._deus_run_controller
...
function DeusChestPreloadExtension:_generate_upgraded_weapon(weapon, rarity, go_id, profile_index, career_index)
	local deus_run_controller = self._deus_run_controller
...
function DeusChestPreloadExtension:_get_server_chest_type(unit)
