...
return { description = "weaves_shadow_mutator_desc", display_name = "weaves_shadow_mutator_name", icon = "mutator_icon_shadow_illusion",
	...
	buffed_units = { },
	buff_params = { external_optional_multiplier = -0.9 },
