...
function BonusDiceUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function BonusDiceUI:create_ui_elements()
...
function BonusDiceUI:add_die(die_type)
...
function BonusDiceUI:destroy()
	self.dice_keeper = nil
end

function BonusDiceUI:update(dt)
...
function BonusDiceUI:update_dices()
