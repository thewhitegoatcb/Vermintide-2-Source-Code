...
function HuskTalentExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
...
function HuskTalentExtension:extensions_ready(world, unit)
...
function HuskTalentExtension:set_talent_ids(talent_ids)
...
function HuskTalentExtension:apply_buffs_from_talents()
...
function HuskTalentExtension:_clear_buffs_from_talents()
	local buff_extension = self.buff_extension
	local talent_buff_ids = self._talent_buff_ids
...
function HuskTalentExtension:has_talent(talent_name)
	local talent_ids = self._talent_ids
...
function HuskTalentExtension:get_talent_ids()
	return self._talent_ids
end

function HuskTalentExtension:get_talent_names(talent_names)
	local talent_ids = self._talent_ids
	local hero_name = self._hero_name
...
function HuskTalentExtension:destroy()
	return end

function HuskTalentExtension:initial_talent_synced()
