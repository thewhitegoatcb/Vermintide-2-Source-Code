...
function BTSelector_horde_rat_defend_destructible:init(...)
	BTSelector_horde_rat_defend_destructible.super.init(self, ...)
	self._children = { }
end

function BTSelector_horde_rat_defend_destructible:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_horde_rat_defend_destructible:run(unit, blackboard, t, dt)
	...
	local node_defend = children [7]
	local condition_result = blackboard.defend

	if condition_result then
		self:set_running_child(unit, blackboard, t, node_defend, "aborted")


		local result, evaluate = node_defend:run(unit, blackboard, t, dt)
	...
	elseif node_defend == child_running then
		self:set_running_child(unit, blackboard, t, nil, "failed")
	end
...
function BTSelector_horde_rat_defend_destructible:add_child(node)
