...
function BTFindRangedPositionAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.find_ranged_position_t = nil
	blackboard.action = nil
	blackboard.num_failed_find_position_attempts = nil
end

function BTFindRangedPositionAction:run(unit, blackboard, t, dt)
...
function BTFindRangedPositionAction:_find_ranged_position(unit, blackboard, t)
