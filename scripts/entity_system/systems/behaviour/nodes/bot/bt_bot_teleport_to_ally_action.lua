...
function BTBotTeleportToAllyAction:init(...)
	BTBotTeleportToAllyAction.super.init(self, ...)
end

BTBotTeleportToAllyAction.name = "BTBotTeleportToAllyAction"

function BTBotTeleportToAllyAction:leave(unit, blackboard, t, reason, destroy)
	return end

function BTBotTeleportToAllyAction:enter(unit, blackboard, t)
...
function BTBotTeleportToAllyAction:run(unit, blackboard, t, dt)
	...
	local best_position = nil local best_distance_sq = -math.huge
	local angle_sign = 1
