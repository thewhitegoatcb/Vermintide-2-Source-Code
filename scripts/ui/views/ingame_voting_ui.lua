...
function IngameVotingUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function IngameVotingUI:create_ui_elements()
...
function IngameVotingUI:destroy()
	self.voting_manager:allow_vote_input(false)
	self.voting_manager = nil
end

function IngameVotingUI:get_text_width(text, text_style)
...
function IngameVotingUI:setup_option_input(option_widget, option, gamepad_active)
	local total_width = 0
...
function IngameVotingUI:align_option_inputs()

	return end

function IngameVotingUI:start_vote(active_voting)
...
function IngameVotingUI:update_vote(votes)
...
function IngameVotingUI:start_finish(previous_voting_info, t)
	self:clear_input_progress()
...
function IngameVotingUI:stop_finish()
...
function IngameVotingUI:update_finish(dt, t)
...
function IngameVotingUI:update(dt, t)
...
function IngameVotingUI:on_gamepad_activated(active_voting)
	if not self.has_voted then --[[ Nothing --]]
	end
...
function IngameVotingUI:on_gamepad_deactivated(active_voting)
	if not self.has_voted then --[[ Nothing --]]
	end
...
function IngameVotingUI:draw(dt, hold_input_pressed)
...
function IngameVotingUI:update_pulse_animations(dt, hold_input_pressed)
...
function IngameVotingUI:update_can_vote(enabled)
...
function IngameVotingUI:animate_option_get_vote(option)
...
function IngameVotingUI:update_input_progress(active_voting)
	local hold_input_pressed = false
...
function IngameVotingUI:clear_input_progress()
...
function IngameVotingUI:play_sound(event)
