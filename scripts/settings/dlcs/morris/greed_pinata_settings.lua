...
GreedPinataSettings = { total_drops = 3,

	possible_drops = {
		first_aid_kit = { drop_weight = 6,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		healing_draught = { drop_weight = 6,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		frag_grenade_t2 = { drop_weight = 8,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		fire_grenade_t2 = { drop_weight = 8,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		friendly_murderer_potion = { drop_weight = 5,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		killer_in_the_shadows_potion = { drop_weight = 5,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		hold_my_beer_potion = { drop_weight = 5,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		pockets_full_of_bombs_potion = { drop_weight = 1,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		vampiric_draught_potion = { drop_weight = 5,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		all_ammo_small = { drop_weight = 25,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		deus_soft_currency = { drop_weight = 40,

			spawn_function = spawn_functions.spawn_pickup_at_unit },

		lamp_oil = { drop_weight = 8,
			pickup_data = { fuse_time = 3, explode_time = 3 },
		...
		explosive_barrel = { drop_weight = 8,
			pickup_data = { fuse_time = 3, explode_time = 3 },
...
for _, drop in pairs(GreedPinataSettings.possible_drops) do
	drop.drop_weight = drop.drop_weight / total_pinata_spawn_weighting end