...
local scenegraph_definition = {
	...
	screen = { vertical_alignment = "center", scale = "aspect_ratio", horizontal_alignment = "center",
	...
	news_ticker_text = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center",
	...
	news_ticker_mask = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center",
	...
	news_ticker_bg = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center",
...
local text_style = { vertical_alignment = "bottom", font_size = 18, localize = false, horizontal_alignment = "left", word_wrap = false, font_type = "hell_shark_masked",
...
local text_style_shadow = { vertical_alignment = "bottom", font_size = 18, localize = false, horizontal_alignment = "left", word_wrap = false, font_type = "hell_shark_masked",
...
local widget_definitions = {
	simple_rect = UIWidgets.create_simple_rect("news_ticker_bg", Colors.get_color_table_with_alpha("black", 192), -1, { 0, -5, -1 }),
...
function IngameNewsTickerUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function IngameNewsTickerUI:create_ui_elements()
...
function IngameNewsTickerUI:destroy()
	GarbageLeakDetector.register_object(self, "ingame_news_ticker_ui")
end

function IngameNewsTickerUI:refresh_message()
...
function IngameNewsTickerUI:update(dt, t)
	if DO_RELOAD then
		self:create_ui_elements()
		self.news_ticker_speed = 100
		self.news_ticker_manager = Managers.news_ticker
	...
	if
	not refreshing_ingame_message and not self:handle_message_refresh_delay(dt) then
		self:refresh_message()
	end

end

function IngameNewsTickerUI:handle_delay(dt)
...
function IngameNewsTickerUI:handle_message_refresh_delay(dt)
...
function IngameNewsTickerUI:draw(dt, t)
...
function IngameNewsTickerUI:setup_news_ticker(text)
