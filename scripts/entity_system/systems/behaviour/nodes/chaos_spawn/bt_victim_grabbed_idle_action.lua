...
function BTVictimGrabbedIdleAction:init(...)
	BTVictimGrabbedIdleAction.super.init(self, ...)
end

function BTVictimGrabbedIdleAction:enter(unit, blackboard, t)
...
function BTVictimGrabbedIdleAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.navigation_extension:set_enabled(true)
end


local Unit_alive = Unit.alive
function BTVictimGrabbedIdleAction:run(unit, blackboard, t, dt)
