...
local scenegraph_definition = {
	root = { is_root = true,
		size = { 1920, 1080 },
		position = { 0, 0, UILayer.interaction } },
	...
	pivot = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	interaction = { vertical_alignment = "center", parent = "pivot", horizontal_alignment = "left",
	...
	text_pivot = { vertical_alignment = "center", parent = "interaction",


		size = { 0, 0 },
		position = { 14, -22, 2 } },

	tooltip_icon = { vertical_alignment = "center", parent = "interaction", horizontal_alignment = "left",
	...
	title_text_pivot = { vertical_alignment = "center", parent = "tooltip_icon",
	...
	interaction_bar = { vertical_alignment = "center", parent = "interaction", horizontal_alignment = "left",
	...
	interaction_bar_fill = { vertical_alignment = "center", parent = "interaction_bar", horizontal_alignment = "left",
...
local widget_definitions = {
	tooltip = { scenegraph_id = "interaction",
		element = {
			passes = { { texture_id = "icon_textures", style_id = "icon_styles", pass_type = "multi_texture" },
				...
				{ pass_type = "texture", style_id = "background_interaction_bar", texture_id = "background_interaction_bar" },
				...
				{ style_id = "hotkey_text", pass_type = "text", text_id = "hotkey_text",
				...
				{ style_id = "hotkey_text_shadow", pass_type = "text", text_id = "hotkey_text",
		...
		content = { background_interaction_bar = "interaction_pop_up_bar_border", title_text = "title_text", has_hotkey = false, hotkey_text = " ", button_text = "", text = "tooltip_text", background = "interaction_pop_up", gamepad_active = false,
			icon_textures = { } },
		...
		style = {
			...
			background_interaction_bar = { scenegraph_id = "interaction_bar",
				offset = { 10, 12, 0 },
				size = { 212, 10 },
				color = { 255, 255, 255, 255 } },


			title_text = { vertical_alignment = "bottom", upper_case = true, horizontal_alignment = "left", font_size = 20, font_type = "hell_shark", scenegraph_id = "title_text_pivot",
			...
			title_text_shadow = { vertical_alignment = "bottom", upper_case = true, horizontal_alignment = "left", font_size = 20, font_type = "hell_shark", scenegraph_id = "title_text_pivot",
			...
			text = { font_size = 30, upper_case = true, pixel_perfect = true, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font = true, scenegraph_id = "text_pivot", font_type = "hell_shark",
			...
			text_shadow = { upper_case = true, horizontal_alignment = "left", font_size = 30, pixel_perfect = true, scenegraph_id = "text_pivot", vertical_alignment = "center", dynamic_font = true, skip_button_rendering = true, font_type = "hell_shark",
			...
			hotkey_text = { font_size = 20, upper_case = true, pixel_perfect = true, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font = true, scenegraph_id = "text_pivot", font_type = "hell_shark",
			...
			hotkey_text_shadow = { upper_case = true, horizontal_alignment = "left", font_size = 20, pixel_perfect = true, scenegraph_id = "text_pivot", vertical_alignment = "center", dynamic_font = true, skip_button_rendering = true, font_type = "hell_shark",
			...
			button_text = { font_size = 30, scenegraph_id = "tooltip_icon", horizontal_alignment = "left", pixel_perfect = true, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
			...
			button_text_shadow = { font_size = 30, scenegraph_id = "tooltip_icon", horizontal_alignment = "left", pixel_perfect = true, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
			...
			icon_styles = { scenegraph_id = "tooltip_icon", draw_count = 0,
...
widget_definitions.interaction_bar = { scenegraph_id = "interaction_bar",
	element = {
		passes = { { pass_type = "texture", style_id = "glow", texture_id = "glow" },



			{ style_id = "bar", pass_type = "texture_uv_dynamic_color_uvs_size_offset", content_id = "bar",
	...
	content = { glow = "interaction_pop_up_glow_2",

		bar = { texture_id = "interaction_pop_up_glow_1", bar_value = 1 } },




	style = {
		glow = { scenegraph_id = "interaction_bar_fill",
			size = { 57, 111 },
			color = { 255, 255, 255, 255 },
			offset = { 0, -35.5, 1 } },


		bar = { uv_start_pixels = 0, scenegraph_id = "interaction_bar_fill", uv_scale_pixels = 217, offset_scale = 1, scale_axis = 1,
			offset = { 0, 0, 0 },
...
function InteractionUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function InteractionUI:create_ui_elements()
...
function InteractionUI:destroy()
...
function InteractionUI:button_texture_data_by_input_action(input_action)
...
function InteractionUI:_animate_in_progress_bar()
	...
	self.interaction_animations.interaction_bar_glow_fade = UIAnimation.init(UIAnimation.function_by_time, widget_style.glow.color,
	1, 0, 255, 0.3, math.easeInCubic)
	self.interaction_animations.interaction_bar_fill_fade = UIAnimation.init(UIAnimation.function_by_time, widget_style.bar.color,
	1, 0, 255, fade_in_time, math.easeInCubic)
end

function InteractionUI:_animate_out_progress_bar()
	local fade_out_time = UISettings.interaction.bar.fade_out
	local widget_style = self.interaction_bar_widget.style

	self.interaction_animations.interaction_bar_glow_fade = UIAnimation.init(UIAnimation.function_by_time, widget_style.glow.color,
	1, widget_style.glow.color [1], 0, fade_out_time, math.easeInCubic)
	self.interaction_animations.interaction_bar_fill_fade = UIAnimation.init(UIAnimation.function_by_time, widget_style.bar.color,
	1, widget_style.bar.color [1], 0, fade_out_time, math.easeInCubic)
end

function InteractionUI:_handle_interaction_progress(progress)
...
local customizer_data = { root_scenegraph_id = "pivot", label = "Interact", registry_key = "interact", drag_scenegraph_id = "interaction" }
...
local BASE_OFFSET = { 0, 0, 0 }
function InteractionUI:update(dt, t, my_player)
	if DO_RELOAD then
		self:create_ui_elements()
	end
	...
	if action_text then
		...
		if not self.draw_interaction_tooltip then
			...
			self.interaction_animations.tooltip_icon_fade = UIAnimation.init(UIAnimation.function_by_time, icon_style.color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)

			self.interaction_animations.tooltip_button_text_fade = UIAnimation.init(UIAnimation.function_by_time, button_text_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
			self.interaction_animations.tooltip_button_text_shadow_fade = UIAnimation.init(UIAnimation.function_by_time, button_text_shadow_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)

			self.interaction_animations.tooltip_text_fade = UIAnimation.init(UIAnimation.function_by_time, text_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
			self.interaction_animations.tooltip_text_shadow_fade = UIAnimation.init(UIAnimation.function_by_time, text_shadow_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)

			self.interaction_animations.tooltip_title_text_fade = UIAnimation.init(UIAnimation.function_by_time, title_text_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
			self.interaction_animations.tooltip_title_text_shadow_fade = UIAnimation.init(UIAnimation.function_by_time, title_text_shadow_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)

			self.interaction_animations.tooltip_background_fade = UIAnimation.init(UIAnimation.function_by_time, background_style.color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)

			self.interaction_animations.hotkey_text_fade = UIAnimation.init(UIAnimation.function_by_time, hotkey_text_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
			self.interaction_animations.hotkey_text_shadow_fade = UIAnimation.init(UIAnimation.function_by_time, hotkey_text_shadow_style.text_color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
			self.interaction_animations.background_interaction_bar_fade = UIAnimation.init(UIAnimation.function_by_time, background_interaction_bar_style.color,
			1, 0, target_alpha, fade_in_time, math.easeInCubic)
		end
...
function InteractionUI:_update_interaction_widget_size(has_hotkey, gamepad_active)
...
function InteractionUI:_get_interaction_text(player_unit, is_channeling)
	local interactor_extension = ScriptUnit.extension(player_unit, "interactor_system")
	...
	interaction_type =
	interaction_type or current_interaction_type
...
function InteractionUI:_get_wielded_interaction_text(player_unit)
...
function InteractionUI:_get_wielded_item_data(player_unit)
...
function InteractionUI:_assign_button_info(interact_action, failed_reason, channeling, override_text_color)
	local ui_renderer = self.ui_renderer
	local ui_scenegraph = self.ui_scenegraph
	local widget_style = self.interaction_widget.style
	local widget_content = self.interaction_widget.content
	...
	if interact_action and not failed_reason and not channeling then
		...
		if button_texture_data and button_texture_data.texture then
			...
			local size = { button_texture_data.size [1] / button_texture_data.size [2] * button_texture_data.size [1], button_texture_data.size [1] }
...
function InteractionUI:external_interact_ui_description(player_unit)
