...
local info_window_size = { window_size [1], window_size [2] + 50 }
...
local scenegraph_definition = {
	...
	window = { vertical_alignment = "center", parent = "area_left", horizontal_alignment = "left", size = large_window_size, position = { 100, 0, 1 } },
	...
	info_window = { vertical_alignment = "top", parent = "window", horizontal_alignment = "right", size = info_window_size, position = { info_window_size [1] - 25, 0, 1 } },
	...
	level_root_node = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { 0, 0 }, position = { 210, -100, 10 } },
	end_level_root_node = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { 0, 0 }, position = { 90, -24, 10 } },
	act_text_root_node = { vertical_alignment = "center", parent = "level_root_node", horizontal_alignment = "center", size = { 100, 50 }, position = { -150, 0, 10 } },
	...
	locked_text = { vertical_alignment = "bottom", parent = "info_window", horizontal_alignment = "center", size = { window_text_width, 100 }, position = { 0, 40, 1 } },
	level_texture_frame = { vertical_alignment = "top", parent = "info_window", horizontal_alignment = "center", size = { 180, 180 }, position = { 0, -20, 2 } },
	...
	description_text = { vertical_alignment = "top", parent = "level_title_divider", horizontal_alignment = "center", size = { window_text_width, 200 }, position = { 0, -20, 1 } },
	progression_divider = { vertical_alignment = "bottom", parent = "description_text", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, -50, 1 } },
	loot_objective = { vertical_alignment = "top", parent = "progression_divider", horizontal_alignment = "center", size = { window_text_width, 90 }, position = { -25, -150, 1 } },
	hero_tabs = { vertical_alignment = "top", parent = "loot_objective", horizontal_alignment = "center", size = { 0, 90 }, position = { 25, -135, 1 } },

	select_button = { vertical_alignment = "bottom", parent = "info_window", horizontal_alignment = "center", size = { 460, 72 }, position = { 0, 18, 20 } } }


local description_text_style = { font_size = 24, use_shadow = true, localize = false, dynamic_font_size_word_wrap = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark",
...
local heros_completed_text_style = { use_shadow = true, vertical_alignment = "top", localize = false, horizontal_alignment = "center", font_size = 22, font_type = "hell_shark",
...
local locked_level_text_style = { font_size = 22, horizontal_alignment = "center", localize = false, word_wrap = true, use_shadow = true, vertical_alignment = "top", font_type = "hell_shark",
...
local function create_level_widget(i, specific_scenegraph_id)
	...
	local passes = { { style_id = "icon", pass_type = "hotspot", content_id = "button_hotspot",
		...
		{ pass_type = "texture", style_id = "icon_unlock_guidance_glow", texture_id = "icon_unlock_guidance_glow" },
	...
	local content = { lock = "map_frame_lock", locked = true, lock_fade = "map_frame_fade", draw_path = false, frame = "map_frame_00", draw_path_fill = false, icon_unlock_guidance_glow = "map_frame_glow_03", boss_level = true, glass = "act_presentation_fg_glass", boss_icon = "boss_icon", icon = "level_icon_01", icon_glow = "map_frame_glow_02",
		button_hotspot = { } }
	...
	local style = {
		...
		icon_unlock_guidance_glow = { vertical_alignment = "center", horizontal_alignment = "center",
...
local function create_act_widget(index, optional_texture_version)
	...
	local content = { text = "title_text", title_edge = "game_option_divider", background = "menu_frame_bg_01", title_bg = "playername_bg_02",
	...
	local text_offset = { 16, -3, 10 }
	local style = {
		text = { vertical_alignment = "center", upper_case = true, localize = false, horizontal_alignment = "left", font_size = 28, font_type = "hell_shark_header",
		...
		text_shadow = { vertical_alignment = "center", upper_case = true, localize = false, horizontal_alignment = "left", font_size = 28, font_type = "hell_shark_header",
			...
			offset = { text_offset [1] + 1, text_offset [2] - 1, text_offset [3] - 1 } },
		...
		edge_holder_left = {
			color = { 0, 255, 255, 255 },
			offset = { 3, size [2] - 10, 15 },
			size = { 9, 17 } },

		edge_holder_right = {
			color = { 0, 255, 255, 255 },
			offset = { size [1] - 12, size [2] - 10, 15 },
			size = { 9, 17 } },

		title_bg = {
			size = { size [1] / 2, 40 },
			color = { 255, 255, 255, 255 },
			offset = { 0, size [2] - 40, 2 } },

		title_edge = {
			size = { size [1] / 2, 5 },
			color = { 255, 255, 255, 255 },
			offset = { 0, size [2] - 40, 4 } },
...
local function create_end_act_widget(optional_texture_version)
	...
	local style = {
		text = { vertical_alignment = "top", upper_case = true, localize = false, horizontal_alignment = "left", font_size = 28, font_type = "hell_shark_header",
		...
		text_shadow = { vertical_alignment = "top", upper_case = true, localize = false, horizontal_alignment = "left", font_size = 28, font_type = "hell_shark_header",
	...
	return { scenegraph_id = "loot_objective",
		element = {
			passes = { { style_id = "text", pass_type = "text", text_id = "text" },
				...
				{ pass_type = "texture", style_id = "checkmark", texture_id = "checkmark",
		...
		content = { total_amount = 0, counter_text = "0/0", checkmark = "matchmaking_checkbox", amount = 0,
		...
		style = {
			text = { vertical_alignment = "bottom", font_type = "hell_shark_header", horizontal_alignment = "left", dynamic_font_size = false, font_size = 32,
				...
				offset = { texture_size [1] + 15, texture_size [2] - 50, 1 } },

			text_shadow = { vertical_alignment = "bottom", font_type = "hell_shark_header", horizontal_alignment = "left", dynamic_font_size = false, font_size = 32,
				...
				offset = { texture_size [1] + 15 + 1, texture_size [2] - 50 - 1, 0 } },
			...
			counter_text = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",
				...
				offset = { texture_size [1] + 15, -40, 10 } },
			...
			counter_text_shadow = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",
				...
				text_color = Colors.get_table("black"),
				offset = { texture_size [1] + 15 + 1, -41, 0 } },
			...
			checkmark = { vertical_alignment = "left", horizontal_alignment = "bottom",
				color = Colors.get_table("online_green"),
				offset = { 68, 20, 5 },
				texture_size = { 27.75, 23.25 } },
	...
	return { scenegraph_id = "loot_objective",
		element = {
			passes = { { style_id = "text", pass_type = "text", text_id = "text" },
				...
				{ style_id = "difficulty_text_completed", pass_type = "text", text_id = "difficulty_text",
				...
				{ style_id = "difficulty_text_disabled", pass_type = "text", text_id = "difficulty_text" },



				{ style_id = "difficulty_text_shadow", pass_type = "text", text_id = "difficulty_text" },
		...
		content = { completed_difficulty_index = 0, checkmark = "matchmaking_checkbox",
		...
		style = {
			...
			difficulty_text = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",




				text_color = Colors.get_table("font_default"),
				offset = { texture_size [1] + 15, -40, 1 } },

			difficulty_text_completed = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",




				text_color = Colors.get_table("online_green"),
				offset = { texture_size [1] + 15, -40, 2 } },

			difficulty_text_disabled = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",
			...
			difficulty_text_shadow = { vertical_alignment = "top", font_type = "hell_shark_header", font_size = 32, horizontal_alignment = "left",
...
function create_hero_widgets(scenegraph_id)
	local icon_size = { 75.60000000000001, 97.2 }
	local frame_size = { 90, 90 }
	local slot_icons = { }
	...
	for k = 1, amount do
		...
		style [icon_name] = { saturated = true, masked = true,
			size = icon_size,
			color = default_color,
	...
	widget.content = content
	widget.style = style
	widget.offset = { -total_length / 2, -5, 0 }
	widget.scenegraph_id = scenegraph_id
...
if use_career_completion then
	...
	widgets.hero_tabs = UIWidgets.create_icon_selector("hero_tabs", { hero_entry_width, hero_entry_height }, hero_icons, hero_entry_spacing, true, hero_entry_frame_size, true, true)
end
...
local mission_settings = { { texture = "loot_objective_icon_02", key = "tome", title_text = "dlc1_3_1_tomes", widget_name = "tome_counter", stat_name = "collected_tomes" },
	...
	{ texture = "loot_objective_icon_06", key = "painting_scrap", title_text = "keep_decoration_painting", widget_name = "painting_scrap_counter", total_amount_func = "_calculate_paint_scrap_amount", stat_name = "collected_painting_scraps" },
	...
	{ texture = "loot_objective_icon_01", key = "grimoire", title_text = "dlc1_3_1_grimoires", widget_name = "grimoire_counter", stat_name = "collected_grimoires" } }
