...
settings.buff_templates = {
	mutator_ticking_bomb = {
		buffs = { { duration = 8, name = "mutator_ticking_bomb", remove_buff_func = "remove_ticking_bomb", icon = "buff_icon_mutator_ticking_bomb", max_stacks = 1, update_func = "update_ticking_bomb", apply_buff_func = "apply_ticking_bomb" } } },
	...
	ticking_bomb_decrease_movement = {
		buffs = { { apply_buff_func = "apply_action_lerp_movement_buff", multiplier = 0.5, update_func = "update_action_lerp_movement_buff", name = "decrease_speed", remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_movement", lerp_time = 2, max_stacks = 1, duration = 3,
