local scenegraph_definition = {
	screen = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.end_screen_banner } },
	level = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center", size = { 180, 180 }, position = { 0, -200, 1 } },
	title_divider = { vertical_alignment = "bottom", parent = "level", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, -120, 1 } },
	level_title = { vertical_alignment = "center", parent = "title_divider", horizontal_alignment = "center", size = { 1200, 50 }, position = { 0, 32, 1 } },
	difficulty_title = { vertical_alignment = "center", parent = "title_divider", horizontal_alignment = "center", size = { 1200, 50 }, position = { 0, 32, 1 } },
	act_title = { vertical_alignment = "center", parent = "title_divider", horizontal_alignment = "center", size = { 1200, 50 }, position = { 0, -38, 1 } } }


local act_title_text_style = { font_size = 32, upper_case = true, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark_header",
...
local level_title_text_style = { font_size = 36, upper_case = true, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "bottom", font_type = "hell_shark_header",
...
local difficulty_title_text_style = { font_size = 36, upper_case = true, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "bottom", font_type = "hell_shark_header",
...
local deus_widgets = {
	level = UIWidgets.create_expedition_widget_func("level", nil, DeusJourneySettings.journey_cave, "journey_cave", { width = 800, spacing_x = 40 }, 1.2),
	act_title = UIWidgets.create_simple_text("ACT IV", "act_title", nil, nil, act_title_text_style),
	level_title = UIWidgets.create_simple_text("Catacombs", "level_title", nil, nil, level_title_text_style),
	title_divider = UIWidgets.create_simple_texture("divider_01_top", "title_divider") }
...
local animations = { }
animations.enter = { { name = "frame_change", start_progress = 0, end_progress = 0,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "entry", start_progress = 2, end_progress = 2.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "text", start_progress = 2.4, end_progress = 2.6,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "fade_out", start_progress = 5.7, end_progress = 6.2,
...
animations.enter_first_time = { { name = "entry", start_progress = 2, end_progress = 2.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "text", start_progress = 2.4, end_progress = 2.8,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "glow", start_progress = 2.5, end_progress = 4.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "frame_change", start_progress = 3.2, end_progress = 3.2,
...
deus_animations.enter = { { name = "entry", start_progress = 2, end_progress = 2.5,
...
deus_animations.enter_first_time = { { name = "entry", start_progress = 2, end_progress = 2.5,
