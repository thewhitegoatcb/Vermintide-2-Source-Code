...
local confirm_button_size = { window_size [1] - 60, 72 }
local game_option_size = { window_size [1] - 20, window_size [2] - (50 + confirm_button_size [2]) }
...
local scenegraph_definition = {
	...
	confirm_button = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = confirm_button_size, position = { 0, 18, 20 } } }
