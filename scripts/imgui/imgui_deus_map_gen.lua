...
local populate_editable_keys = { { type = "INT", key = "CURSES_HOT_SPOTS_MIN_COUNT" },



	{ type = "INT", key = "CURSES_HOT_SPOTS_MAX_COUNT" },



	{ type = "FLOAT", key = "CURSES_HOT_SPOT_MIN_RANGE" },



	{ type = "FLOAT", key = "CURSES_HOT_SPOT_MAX_RANGE" },



	{ type = "FLOAT", key = "CURSES_MIN_PROGRESS" },



	{ type = "FLOAT", key = "MINOR_MODIFIABLE_NODE_CHANCE" } }
...
function ImguiDeusMapGen:update()
	if RELOAD then
		self:_init_configs()
		RELOAD = false
	end
...
function ImguiDeusMapGen:is_persistent()
	return false
end

function ImguiDeusMapGen:_init_configs()
...
function ImguiDeusMapGen:_reset_configs_for_journey()
...
function ImguiDeusMapGen:draw(is_open)
...
function ImguiDeusMapGen:_trigger_graph_render()
