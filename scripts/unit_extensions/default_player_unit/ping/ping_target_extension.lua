...
function PingTargetExtension:init(extension_init_context, unit, extension_init_data)
...
function PingTargetExtension:extensions_ready(world, unit)
...
function PingTargetExtension:set_pinged(pinged, flash, pinger_unit, show_outline)
	local owner_unit = self._unit
	if show_outline == nil then show_outline = true
	end
	if pinged then
...
function PingTargetExtension:pinged()
	return self._pinged > 0
end

function PingTargetExtension:update(unit, input, dt, context, t)
	return end

function PingTargetExtension:destroy()
	return end

function PingTargetExtension:_add_witch_hunter_buff(pinger_unit)
