...
function BTSelector_horde_shield_rat:init(...)
	BTSelector_horde_shield_rat.super.init(self, ...)
	self._children = { }
end

function BTSelector_horde_shield_rat:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_horde_shield_rat:run(unit, blackboard, t, dt)
...
function BTSelector_horde_shield_rat:add_child(node)
