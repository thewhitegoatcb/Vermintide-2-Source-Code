...
local RPCS = { "rpc_objective_entered_socket_zone" }



local extensions = { "ObjectiveSocketUnitExtension" }



function ObjectiveSocketSystem:init(entity_system_creation_context, system_name)
	...
	function self.objective_entered_zone_server(extension, unit)
	...
	function self.objective_entered_zone_client(extension, socket_id)
...
function ObjectiveSocketSystem:destroy()
...
function ObjectiveSocketSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function ObjectiveSocketSystem:on_remove_extension(unit, extension_name)
	ObjectiveSocketSystem.super.on_remove_extension(self, unit, extension_name)

	self.socket_extensions [unit] = nil
end

function ObjectiveSocketSystem:hot_join_sync(peer_id)
...
function ObjectiveSocketSystem:rpc_objective_entered_socket_zone(channel_id, unit_id, socket_id, is_game_object, is_limited_objective_unit)
