...
InputStackSettings = { { group_name = "input",
	...
	{ group_name = "game_popups",
		...
		services = { "weave_tutorial", "rewards_popups", "common_popup" } },
	...
	{ group_name = "network_popups",
		...
		services = { "mission_voting", "popup_profile_picker" } },
	...
	{ group_name = "ui",
		...
		services = { "Text", "dark_pact_selection" } },
	...
	{ group_name = "options",
		...
		services = { "options_menu" } },


	{ group_name = "ingame_ui",


		services = { "ingame_menu", "hero_view" } },
	...
	{ group_name = "console_friends_view",
		...
		services = { "console_friends_view" } },


	{ group_name = "hud_player_list",


		services = { "player_list_input" } },


	{ group_name = "deus_shop",


		services = { "deus_shop_view" } },


	{ group_name = "deus_map_view",


		services = { "deus_map_input_service_name" } } }
...
for group_id = 1, #InputStackSettings do
	...
	for service_id = 1, #group_services do
		...
		InputServiceToGroupMap [service_name] = group_id end end