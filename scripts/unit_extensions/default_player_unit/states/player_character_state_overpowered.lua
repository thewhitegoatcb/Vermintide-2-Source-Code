...
function PlayerCharacterStateOverpowered:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "overpowered")
end


function PlayerCharacterStateOverpowered:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateOverpowered:on_exit(unit, input, dt, context, t, next_state)
	local player = Managers.player:owner(unit)
	local is_bot = player and not player:is_player_controlled()
...
function PlayerCharacterStateOverpowered:update(unit, input, dt, context, t)
	local csm = self.csm
