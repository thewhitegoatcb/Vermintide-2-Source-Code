...
local scenegraph_definition = {
	root = { is_root = true,
		position = { 0, 0, UILayer.end_screen + 2 },
		size = { SIZE_X, SIZE_Y } },
	...
	entry_1 = { vertical_alignment = "center", parent = "pivot", horizontal_alignment = "center",
	...
	entry_2 = { vertical_alignment = "center", parent = "pivot", horizontal_alignment = "center",
	...
	entry_3 = { vertical_alignment = "center", parent = "pivot", horizontal_alignment = "center",
	...
	input_description_text = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "center",
	...
	title_text = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center",
...
local function create_entry(index)
	local bg_width = 899 local bg_height = 259
	local task_bg_width = 860 local task_bg_height = 127

	return {
		element = {
			passes = { { pass_type = "texture", style_id = "texture_bg", texture_id = "texture_bg",
				...
				{ style_id = "title_text", pass_type = "text", text_id = "title_text",
					...
					retained_mode = RETAINED_MODE_ENABLED },
				{ style_id = "bar_text", pass_type = "text", text_id = "bar_text",



					retained_mode = RETAINED_MODE_ENABLED },
				{ style_id = "progress_bar", pass_type = "texture_uv", content_id = "progress_bar",



					retained_mode = RETAINED_MODE_ENABLED },
				{ pass_type = "centered_texture_amount", style_id = "texture_divider", texture_id = "texture_divider",
				...
				{ pass_type = "texture", style_id = "texture_completed", texture_id = "texture_completed",



					retained_mode = RETAINED_MODE_ENABLED },
				{ texture_id = "overlay_mask", style_id = "overlay", pass_type = "texture",



					retained_mode = RETAINED_MODE_ENABLED },
				{ texture_id = "overlay", style_id = "overlay", pass_type = "texture",



					retained_mode = RETAINED_MODE_ENABLED },
				{ style_id = "task_text_1", pass_type = "text", text_id = "task_text_1",
				...
				{ style_id = "task_value_1", pass_type = "text", text_id = "task_value_1",
				...
				{ pass_type = "texture", style_id = "texture_task_icon_1", texture_id = "texture_task_icon_1",
				...
				{ pass_type = "gradient_mask_texture", style_id = "texture_task_marker_1", texture_id = "texture_task_marker_1",
				...
				{ pass_type = "texture", style_id = "texture_task_glow_1", texture_id = "texture_task_glow",
				...
				{ style_id = "task_text_2", pass_type = "text", text_id = "task_text_2",
				...
				{ style_id = "task_value_2", pass_type = "text", text_id = "task_value_2",
				...
				{ pass_type = "texture", style_id = "texture_task_icon_2", texture_id = "texture_task_icon_2",
				...
				{ pass_type = "gradient_mask_texture", style_id = "texture_task_marker_2", texture_id = "texture_task_marker_2",
				...
				{ pass_type = "texture", style_id = "texture_task_glow_2", texture_id = "texture_task_glow",
				...
				{ style_id = "task_text_3", pass_type = "text", text_id = "task_text_3",
				...
				{ style_id = "task_value_3", pass_type = "text", text_id = "task_value_3",
				...
				{ pass_type = "texture", style_id = "texture_task_icon_3", texture_id = "texture_task_icon_3",
				...
				{ pass_type = "gradient_mask_texture", style_id = "texture_task_marker_3", texture_id = "texture_task_marker_3",
				...
				{ pass_type = "texture", style_id = "texture_task_glow_3", texture_id = "texture_task_glow",
		...
		content = { texture_bg = "contract_progress_bg", title_text = "n/a", texture_completed = "contract_progress_completed", task_value_2 = "n/a", task_amount = 1, task_text_3 = "n/a", overlay = "rect_masked", task_value_1 = "n/a", visible = false, overlay_mask = "contract_masked_overlay", task_text_2 = "n/a", texture_divider = "contract_progress_divider", task_text_1 = "n/a", bar_text = "Contract Progress: 80%", task_value_3 = "n/a", texture_task_glow = "quest_endscreen_glow",
			...
			progress_bar = { bar_value_position = 0, bar_value_size = 0, texture_id = "contract_progress_bar", internal_bar_value_position = 0, bar_value = 0, bar_value_offset = 0, internal_bar_value = 0,
		...
		style = { task_start_offset = 20,

			task_bg_size = { task_bg_width, task_bg_height },
			overlay = {
				size = { 880, 235 },
				color = { 0, 0, 0, 0 },
				offset = { 0, 23, 7 } },
			...
			title_text = { vertical_alignment = "top", horizontal_alignment = "center", font_type = "hell_shark", font_size = 32,
				offset = { 0, -15, 4 },
				text_color = { 150, 0, 0, 0 } },





			bar_text = { vertical_alignment = "center", font_size = 16, horizontal_alignment = "left", debug_draw_box = false, font_type = "hell_shark",

				size = { task_bg_width, 20 },
				offset = { 20, 35, 4 },
				text_color = { 150, 0, 0, 0 } },
			...
			progress_bar = { uv_start_pixels = 0, uv_scale_pixels = 859, scale_axis = 1,
				size = { 859, 17 },
				color = { 255, 255, 255, 255 },
			...
			texture_divider = { texture_amount = 2, texture_axis = 1,
				color = { 255, 255, 255, 255 },
				size = { task_bg_width, task_bg_height },
				offset = { 20, 73, 2 },
				texture_size = { 11, 132 } },



			task_text_1 = { vertical_alignment = "top", font_size = 18, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 75 },
			...
			task_value_1 = { vertical_alignment = "center", font_size = 32, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 37 },
			...
			texture_task_marker_1 = { gradient_threshold = 0,
			...
			task_text_2 = { vertical_alignment = "top", font_size = 18, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 75 },
			...
			task_value_2 = { vertical_alignment = "center", font_size = 32, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 37 },
			...
			texture_task_marker_2 = { gradient_threshold = 0,
			...
			task_text_3 = { vertical_alignment = "top", font_size = 18, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 75 },
			...
			task_value_3 = { vertical_alignment = "center", font_size = 32, horizontal_alignment = "center", debug_draw_box = false, font_type = "hell_shark",
				size = { task_bg_width, 37 },
			...
			texture_task_marker_3 = { gradient_threshold = 0,
...
animation_definitions.contract_entry = { { name = "reset", start_progress = 0, end_progress = 0,
...
animation_definitions.contract_move = { { name = "move", start_progress = 0, end_progress = 0.3,
...
animation_definitions.contract_task_progress = { { name = "fade_in_selection", start_progress = 0, end_progress = 0.15,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "font_size", start_progress = 0.1, end_progress = 0.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "set_new_value", start_progress = 0.2, end_progress = 0.4,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "set_completed", start_progress = 0.45, end_progress = 0.6,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "fade_out_selection", start_progress = 0.6, end_progress = 0.75,
...
animation_definitions.contract_summary = { { name = "bar_progress", start_progress = 0, end_progress = 0.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "completed_stamp", start_progress = 0.5, end_progress = 0.7,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "delay", start_progress = 0.7, end_progress = 0.8,
...
animation_definitions.no_progress = { { name = "overlay_fade_in", start_progress = 0, end_progress = 0.5,
...
animation_definitions.contracts_exit = { { name = "fade_in", start_progress = 0, end_progress = 0.6,
