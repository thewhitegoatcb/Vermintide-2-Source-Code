...
function PlayerProjectileImpactUnitExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerProjectileImpactUnitExtension:update(unit, input, dt, context, t)
...
local INDEX_ACTOR = 4
function PlayerProjectileImpactUnitExtension:update_raycast(unit, input, dt, context, t, override_collision_filter)
...
function PlayerProjectileImpactUnitExtension:update_sphere_sweep(unit, input, dt, context, t, radius, collision_filter)
	local locomotion_extension = self.locomotion_extension
	if not locomotion_extension:moved_this_frame() then
		return
	end
