...
function Spline:calc_tangent(t)
	...
	local res = Vector3.from_table(self._P1) * dh1 +
	Vector3.from_table(self._P2) * dh2 +
	Vector3.from_table(self._T1) * dh3 +
	Vector3.from_table(self._T2) * dh4
...
function Spline:p1() return self._P1 end
function Spline:p2() return self._P2 end
function Spline:t1() return self._T1 end
function Spline:t2() return self._T2 end