...
local function setup_ui_definitions(window_width, list_width, list_height)
	local list_size = { list_width, math.min(list_height, 400) }
	local window_size = { window_width, list_size [2] + 350 }
	local list_entry_size = { list_width - 50, 50 }
	local list_scrollbar_size = { 5, list_size [2] }
	...
	local scenegraph_definition = {
		...
		screen_overlay = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, 900 } },
		window = { vertical_alignment = "center", parent = "screen_overlay", horizontal_alignment = "center", size = window_size, position = { 0, 0, 1 } },
		window_button = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { 300, 70 }, position = { 0, -32, 10 } },
		window_title = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1] - 40, 50 }, position = { 0, -40, 1 } },

		currency_area = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { window_size [1] + 20, 64 }, position = { 0, 100, 3 } },
		currency_area_frame = { vertical_alignment = "center", parent = "currency_area", horizontal_alignment = "center", size = { window_size [1] + 20 + 12, 76 }, position = { 0, 0, 0 } },
		currency_text = { vertical_alignment = "center", parent = "currency_area", horizontal_alignment = "right", size = { 64, 200 }, position = { -40, -2, 1 } },
		currency_title = { vertical_alignment = "center", parent = "currency_area", horizontal_alignment = "left", size = { 64, 200 }, position = { 40, -2, 1 } },
		currency_icon = { vertical_alignment = "center", parent = "currency_text", horizontal_alignment = "left", size = { 64, 64 }, position = { -64, 0, 1 } },
		currency_area_detail_left = { vertical_alignment = "center", parent = "currency_area", horizontal_alignment = "left", size = { 84, 112 }, position = { -40, 0, 10 } },
		currency_area_detail_right = { vertical_alignment = "center", parent = "currency_area", horizontal_alignment = "right", size = { 84, 112 }, position = { 40, 0, 10 } },

		list_window = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = list_size, position = { 0, -115, 1 } },
		list = { vertical_alignment = "top", parent = "list_window", horizontal_alignment = "right", size = list_size, position = { 0, -list_size [2], 0 } },
		list_scrollbar = { vertical_alignment = "center", parent = "list_window", horizontal_alignment = "right", size = list_scrollbar_size, position = { -20, 0, 1 } },
		list_root = { vertical_alignment = "top", parent = "list", horizontal_alignment = "left", size = { 0, 0 }, position = { 0, 0, 1 } } }


	local title_text_style = { use_shadow = true, upper_case = false, localize = true, font_size = 52, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
	...
	local currency_text_style = { word_wrap = false, upper_case = true, localize = false, use_shadow = true, font_size = 32, horizontal_alignment = "right", vertical_alignment = "center", dynamic_font_size = false, font_type = "hell_shark_header",
	...
	local currency_title_style = { word_wrap = false, upper_case = false, localize = false, use_shadow = true, font_size = 32, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font_size = false, font_type = "hell_shark_header",
	...
	local function create_list_mask(scenegraph_id, list_scenegraph_id, size)
		...
		local style = {
			...
			list_hotspot = {
				size = { size [1], size [2] + fade_distance * 2 },
				color = { 255, 255, 255, 255 },
				offset = { 0, -fade_distance, 0 } },
			...
			mask_bottom = {
				...
				offset = { 0, -fade_distance, 0 },
				angle = math.pi,
				pivot = { size [1] / 2, fade_distance / 2 } } }
	...
	local window_background_color = { 220, 10, 10, 10 }
	local window_dop_shadow_color = { 220, 0, 0, 0 }

	local widget_definitions = {
		screen_overlay = UIWidgets.create_simple_rect("screen_overlay", { 50, 10, 10, 10 }),

		window_background = UIWidgets.create_simple_rect("window", window_background_color),
		window_drop_shadow = UIWidgets.create_frame("window", scenegraph_definition.window.size, frame_name, 0, window_dop_shadow_color, { -frame_height, -frame_height }),
		window_frame = UIWidgets.create_frame("window", scenegraph_definition.window.size, "menu_frame_12_gold", 1, { 255, 255, 255, 255 }),
		...
		currency_area = UIWidgets.create_tiled_texture("currency_area", "menu_frame_bg_07", { 512, 256 }, nil, nil, { 255, 255, 255, 255 }),
		...
		currency_area_detail_left = UIWidgets.create_simple_uv_texture("button_detail_08_gold", { { 0, 0 }, { 1, 1 } }, "currency_area_detail_left"),
		currency_area_detail_right = UIWidgets.create_simple_uv_texture("button_detail_08_gold", { { 1, 0 }, { 0, 1 } }, "currency_area_detail_right"),

		list = create_list_mask("list_window", "list", list_size, list_entry_size),
		list_scrollbar = UIWidgets.create_scrollbar("list_scrollbar", list_scrollbar_size, "window", { 255, 120, 120, 120 }, { 255, 30, 30, 30 }) }
...
function StoreWelcomePopup:init(ingame_ui, layout, total_amount)
	...
	self._entry_size = { list_width - 50, 50 }
...
function StoreWelcomePopup:_setup_renderers()
...
function StoreWelcomePopup:_destroy_renderers()
...
function StoreWelcomePopup:_start_transition_animation(key, animation_name, optional_widgets)
	local params = {
...
function StoreWelcomePopup:completed()
	return self._done
end

function StoreWelcomePopup:_create_gamepad_input_description(input_service)
	local generic_input_actions = { { input_action = "confirm", priority = 2, description_text = "welcome_currency_popup_button_claim" } }
...
function StoreWelcomePopup:_set_fullscreen_effect_enable_state(enabled, progress, world)
...
function StoreWelcomePopup:is_complete()
	return self._state == "exit"
end

function StoreWelcomePopup:destroy()
...
function StoreWelcomePopup:_create_ui_elements(params)
...
function StoreWelcomePopup:_draw(input_service, dt)
...
function StoreWelcomePopup:_handle_input(input_service, dt, t)
	local gamepad_active = Managers.input:is_device_active("gamepad")
...
function StoreWelcomePopup:update(input_service, dt, t)
...
function StoreWelcomePopup:_update_animations(dt)
...
function StoreWelcomePopup:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot or content.hotspot
	return hotspot.on_hover_enter
end

function StoreWelcomePopup:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot or content.hotspot
...
function StoreWelcomePopup:_play_sound(event)
	WwiseWorld.trigger_event(self._wwise_world, event)
end


function StoreWelcomePopup:_setup_list_widgets(layout)
	local widgets = { }
...
function StoreWelcomePopup:_populate_text_widget(widget, settings, height_spacing)
	local content = widget.content
...
function StoreWelcomePopup:_populate_currency_title_widget(widget, settings)
	local content = widget.content
	local style = widget.style
...
function StoreWelcomePopup:_populate_currency_entry_widget(widget, settings)
	local content = widget.content
	local style = widget.style
...
function StoreWelcomePopup:_align_dlc_widgets()
...
function StoreWelcomePopup:_initialize_scrollbar()
...
function StoreWelcomePopup:_update_scroll_position()
	local scrollbar_logic = self._scrollbar_logic
...
function StoreWelcomePopup:_update_visible_list_entries()
	local scrollbar_logic = self._scrollbar_logic
...
function StoreWelcomePopup:_set_total_amount(total_amount)
	local widgets_by_name = self._widgets_by_name
