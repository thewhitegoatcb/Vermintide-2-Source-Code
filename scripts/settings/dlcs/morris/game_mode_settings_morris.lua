...
GameModeSettings.deus.object_sets = { gm_sp = true }
...
GameModeSettings.deus.hud_ui_settings = { killfeed_offset = true }
...
GameModeSettings.inn_deus.hud_ui_settings = { killfeed_offset = true }


GameModeSettings.inn_deus.use_keep_decorations = true
GameModeSettings.inn_deus.social_wheel_by_side = { heroes = "general" }
...
GameModeSettings.map_deus.social_wheel_by_side = { heroes = "general" }