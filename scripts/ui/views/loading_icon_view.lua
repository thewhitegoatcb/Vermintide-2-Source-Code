...
local loading_icon_data = { frames_per_second = 30 }
...
function LoadingIconView:init(world)
	self._world = world
...
function LoadingIconView:_update_loading_icon(dt)
	local widget = self._loading_icon_widget
...
function LoadingIconView:_draw(dt)
...
function LoadingIconView:destroy()
