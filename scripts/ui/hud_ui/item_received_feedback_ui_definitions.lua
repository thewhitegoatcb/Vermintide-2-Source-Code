...
local scenegraph_definition = {
	...
	message_animated_parent = { vertical_alignment = "center", parent = "root", horizontal_alignment = "center",
	...
	message_animated = { parent = "message_animated_parent",

		size = { 0, 0 },
		position = { 0, 0, 0 } },

	message_animated_dragger = { parent = "message_animated",
