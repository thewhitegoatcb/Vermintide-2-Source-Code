...
function PlayerCharacterStateGrabbedByChaosSpawn:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "grabbed_by_chaos_spawn")
end

function PlayerCharacterStateGrabbedByChaosSpawn:on_enter(unit, input, dt, context, t, previous_state)
...
function PlayerCharacterStateGrabbedByChaosSpawn:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateGrabbedByChaosSpawn:update(unit, input, dt, context, t)
	local csm = self.csm
