...
function StartGameWindowTwitchOverviewConsole:on_enter(params, offset)
...
function StartGameWindowTwitchOverviewConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowTwitchOverviewConsole:_create_ui_elements(params, offset)
...
function StartGameWindowTwitchOverviewConsole:_set_input_description(connected)
	if self._is_server then
		if connected then
...
function StartGameWindowTwitchOverviewConsole:_set_disconnect_button_text()
...
function StartGameWindowTwitchOverviewConsole:on_exit(params)
...
function StartGameWindowTwitchOverviewConsole:set_focus(focused)
	self._is_focused = focused
end

function StartGameWindowTwitchOverviewConsole:update(dt, t)
...
function StartGameWindowTwitchOverviewConsole:post_update(dt, t)
	return end

function StartGameWindowTwitchOverviewConsole:_update_input_description()
...
function StartGameWindowTwitchOverviewConsole:_update_can_play()
	if self._is_server then
...
function StartGameWindowTwitchOverviewConsole:_set_active(active)
	if active then
...
function StartGameWindowTwitchOverviewConsole:cb_on_message_received(key, message_type, user_name, message, parameter)
	local chat_output_widget = self._widgets_by_name.chat_output_widget
	local chat_output_content = chat_output_widget.content
...
function StartGameWindowTwitchOverviewConsole:_handle_virtual_keyboard(dt, t)
...
function StartGameWindowTwitchOverviewConsole:_handle_input(dt, t)
...
function StartGameWindowTwitchOverviewConsole:_handle_twitch_login_input(dt, t, input_service)
...
function StartGameWindowTwitchOverviewConsole:_is_button_pressed(widget)
...
function StartGameWindowTwitchOverviewConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowTwitchOverviewConsole:cb_connection_success_callback(user_data)
	self:_set_disconnect_button_text()
	self:_setup_connected_status()
	self:_set_active(true)
end

function StartGameWindowTwitchOverviewConsole:_setup_connected_status()
	local user_name = Managers.twitch and Managers.twitch:user_name() or "N/A"
	self._widgets_by_name.frame_widget.content.connected = Localize("start_game_window_twitch_connected_to") .. user_name
end

function StartGameWindowTwitchOverviewConsole:_can_play()
...
function StartGameWindowTwitchOverviewConsole:_update_mission_option()
	local parent = self._parent
	local selected_level_id = parent:get_selected_level_id()
...
function StartGameWindowTwitchOverviewConsole:_set_selected_level(level_id)
...
function StartGameWindowTwitchOverviewConsole:_update_difficulty_option()
...
function StartGameWindowTwitchOverviewConsole:_option_selected(input_index, t)
	local parent = self._parent
	local twitch_settings = parent:get_twitch_settings(self._mechanism_name) or parent:get_twitch_settings("adventure")
...
function StartGameWindowTwitchOverviewConsole:_handle_new_selection(input_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowTwitchOverviewConsole:_update_animations(dt)
...
function StartGameWindowTwitchOverviewConsole:_update_button_animations(dt)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowTwitchOverviewConsole:_animate_button(widget, dt)
	local content = widget.content
...
function StartGameWindowTwitchOverviewConsole:_draw(dt)
...
function StartGameWindowTwitchOverviewConsole:_play_sound(event)
