...
function BTSelector_skaven_ratling_gunner:init(...)
	BTSelector_skaven_ratling_gunner.super.init(self, ...)
	self._children = { }
end

function BTSelector_skaven_ratling_gunner:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_skaven_ratling_gunner:run(unit, blackboard, t, dt)
...
function BTSelector_skaven_ratling_gunner:add_child(node)
