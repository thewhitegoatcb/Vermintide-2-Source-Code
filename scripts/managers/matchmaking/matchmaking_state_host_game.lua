...
function MatchmakingStateHostGame:init(params)
...
function MatchmakingStateHostGame:destroy()
	return end

function MatchmakingStateHostGame:on_enter(state_context)
...
function MatchmakingStateHostGame:set_debug_info()
...
function MatchmakingStateHostGame:on_exit()
	return end

function MatchmakingStateHostGame:update(dt, t)
	if self._wait_to_start_game then
		do return MatchmakingStateWaitForCountdown, self.state_context end
	elseif self._skip_waystone then
		do return MatchmakingStateStartGame, self.state_context end
	else
		return MatchmakingStateWaitForCountdown, self.state_context
	end
end

function MatchmakingStateHostGame:_start_hosting_game()
	...
	if self._wait_to_start_game then --[[ Nothing --]]
