...
local XB1_ACHIEVEMENT_ID = { penny_complete_veteran = 83, penny_castle_eruptions = 90, penny_complete_recruit = 82, penny_complete_legend = 85, penny_complete_champion = 84, penny_castle_no_kill = 91 }
...
local PS4_ACHIEVEMENT_ID = { penny_castle_eruptions = "083" }
...
local castle = { LevelSettings.dlc_castle }
...
add_meta_challenge(achievements, "penny_complete_castle", { "penny_castle_chalice", "penny_castle_skull", "penny_castle_flask", "penny_castle_eruptions", "penny_castle_no_kill" })