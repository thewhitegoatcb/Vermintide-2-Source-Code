...
local extensions = { "WardExtension" }




function WardSystem:init(entity_system_creation_context, system_name, ...)
...
function WardSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function WardSystem:update(context, t)
...
function WardSystem:on_remove_extension(unit, extension_name)
