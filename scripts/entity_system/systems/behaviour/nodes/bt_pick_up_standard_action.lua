...
function BTPickupStandardAction:init(...)
...
function BTPickupStandardAction:enter(unit, blackboard, t)
...
function BTPickupStandardAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPickupStandardAction:run(unit, blackboard, t, dt)
...
function BTPickupStandardAction:anim_cb_pick_up_standard(unit, blackboard)
