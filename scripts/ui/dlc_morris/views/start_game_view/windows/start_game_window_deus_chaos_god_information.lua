...
function StartGameWindowDeusChaosGodInformation:on_enter(params, offset)
...
function StartGameWindowDeusChaosGodInformation:on_exit(params)
	table.clear(self)
end

function StartGameWindowDeusChaosGodInformation:_create_ui_elements(definitions, params, offset)
...
function StartGameWindowDeusChaosGodInformation:_start_animation(animation_name, widget, params)
	params =
	params or { }
...
function StartGameWindowDeusChaosGodInformation:update(dt, t)
...
function StartGameWindowDeusChaosGodInformation:_update_journey()
...
function StartGameWindowDeusChaosGodInformation:post_update(dt, t)

	return end

function StartGameWindowDeusChaosGodInformation:_update_animations(dt, t)
...
function StartGameWindowDeusChaosGodInformation:_draw(dt, t)
...
function StartGameWindowDeusChaosGodInformation:_refresh_journey_data()
...
function StartGameWindowDeusChaosGodInformation:_update_time_left()
...
function StartGameWindowDeusChaosGodInformation:_update_theme(initial_delay)
	...
	self:_start_animation("set_theme", self._widgets_by_name.god_info_widget, { theme_settings = theme_settings })
end

function StartGameWindowDeusChaosGodInformation:_setup_belakor_information()
...
function StartGameWindowDeusChaosGodInformation:_refresh_belakor_curse_data()
	local backend_deus = Managers.backend:get_interface("deus")
...
function StartGameWindowDeusChaosGodInformation:_update_belakor_time_left()
	local current_time = Managers.time:time("main")
	local backend_deus = Managers.backend:get_interface("deus")
...
function StartGameWindowDeusChaosGodInformation:_update_belakor_status()
	local backend_deus = Managers.backend:get_interface("deus")
	local belakor_active_in_expedition = backend_deus:deus_journey_with_belakor(self._journey_name)
	local widget = self._widgets_by_name.belakor_info_widget

	if belakor_active_in_expedition then
		self:_start_animation("set_theme_belakor", widget, { theme_settings = DeusThemeSettings.belakor })
	end
