...
function LoadTimeManager:start_timer(time_spent_in_level, end_reason)
...
function LoadTimeManager:set_lobby(lobby)
...
function LoadTimeManager:has_lobby()
...
function LoadTimeManager:update(dt)
...
function LoadTimeManager:end_timer()
...
function LoadTimeManager:destroy()
