...
local scenegraph_definition = {
	root = { is_root = true, position = { 0, 0, UILayer.popup + 1 }, size = { 1920, 1080 } },
	screen = { scale = "fit",
		position = { 0, 0, UILayer.popup },
		size = { 1920, 1080 } },
	...
	title_box = { vertical_alignment = "top", parent = "popup_root", horizontal_alignment = "center",
	...
	popup_password_box = { vertical_alignment = "center", parent = "popup_root", horizontal_alignment = "center",
	...
	popup_password_input = { vertical_alignment = "center", parent = "popup_password_box", horizontal_alignment = "center",
	...
	popup_password_text = { vertical_alignment = "bottom", parent = "popup_password_box", horizontal_alignment = "center",
	...
	popup_text_box = { vertical_alignment = "top", parent = "popup_root", horizontal_alignment = "center",
	...
	popup_text = { vertical_alignment = "top", parent = "popup_text_box", horizontal_alignment = "center",
	...
	buttons_root = { vertical_alignment = "bottom", parent = "popup_root", horizontal_alignment = "center",
	...
	button_1_1 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	button_2_1 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	button_2_2 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	button_3_1 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	button_3_2 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	button_3_3 = { vertical_alignment = "center", parent = "buttons_root", horizontal_alignment = "center",
	...
	timer = { vertical_alignment = "top", parent = "popup_root", horizontal_alignment = "right" },




	center_timer = { vertical_alignment = "bottom", parent = "popup_text_box", horizontal_alignment = "center",
...
local function create_default_window(scenegraph_id, size)
	...
	local passes = { { style_id = "background", pass_type = "texture_uv", content_id = "background" },
		...
		{ style_id = "timer", pass_type = "text", text_id = "timer_field" },



		{ style_id = "timer_shadow", pass_type = "text", text_id = "timer_field" },



		{ style_id = "center_timer", pass_type = "text", text_id = "center_timer_field" },



		{ style_id = "center_timer_shadow", pass_type = "text", text_id = "center_timer_field" } }





	local content = { timer_field = "", title_text = "", text_start_offset = 0, text_field = "", background_fade = "options_window_fade_01", background_tint = "gradient_dice_game_reward", center_timer_field = "",
	...
	local style = {
		...
		inner_rect = { scenegraph_id = "popup_text_box",

			color = { 200, 10, 10, 10 },
			offset = { 0, 0, 3 } },

		inner_frame = { scenegraph_id = "popup_text_box",
		...
		title_text = { word_wrap = false, scenegraph_id = "title_box", font_size = 50, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, dynamic_font_size = true, font_type = "hell_shark_header",
		...
		title_text_shadow = { word_wrap = false, scenegraph_id = "title_box", font_size = 50, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, dynamic_font_size = true, font_type = "hell_shark_header",
		...
		text = { word_wrap = true, scenegraph_id = "popup_text", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		text_shadow = { word_wrap = true, scenegraph_id = "popup_text", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		timer = { font_size = 36, scenegraph_id = "timer", pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		timer_shadow = { font_size = 36, scenegraph_id = "timer", pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		center_timer = { font_size = 44, scenegraph_id = "center_timer", pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		center_timer_shadow = { font_size = 44, scenegraph_id = "center_timer", pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
...
local function create_password_window(scenegraph_id, size)
	...
	local passes = { { style_id = "background", pass_type = "texture_uv", content_id = "background" },
		...
		{ style_id = "input", pass_type = "text", text_id = "input" },



		{ style_id = "input_shadow", pass_type = "text", text_id = "input" },



		{ texture_id = "status_texture_glow", style_id = "status_texture_glow", pass_type = "texture",
		...
		{ texture_id = "status_texture_frame", style_id = "status_texture_frame", pass_type = "texture",
		...
		{ style_id = "placeholder_input", pass_type = "text", text_id = "placeholder_input",
		...
		{ style_id = "placeholder_input_shadow", pass_type = "text", text_id = "placeholder_input",
		...
		{ style_id = "status_message", pass_type = "text", text_id = "status_message",
		...
		{ style_id = "error_message", pass_type = "text", text_id = "status_message",
		...
		{ style_id = "status_message_shadow", pass_type = "text", text_id = "status_message",
		...
		{ style_id = "checkbox_background", pass_type = "hotspot", content_id = "checkbox_hotspot",
		...
		{ style_id = "checkbox_text", pass_type = "text", text_id = "checkbox_text" },



		{ style_id = "checkbox_text_shadow", pass_type = "text", text_id = "checkbox_text" } }





	local content = { checkbox_text = "popup_info_show_password", input = "", background_tint = "gradient_dice_game_reward", checkbox = "matchmaking_checkbox", text_field = "", input_mode = "insert", title_text = "", timer_field = "", text_start_offset = 0, text_index = 1, center_timer_field = "", status_texture_glow = "loading_title_divider", status_texture_frame = "loading_title_divider_background", background_fade = "options_window_fade_01", caret_index = 1, placeholder_input = "popup_info_type_password", active = true,
		checkbox_hotspot = { is_selected = false },
	...
	local style = {
		checkbox = { vertical_alignment = "top", scenegraph_id = "popup_password_box", horizontal_alignment = "right",
			texture_size = { 22, 16 },
			offset = { 0, 27, 6 },
			color = { 255, 255, 255, 255 } },
		...
		checkbox_frame = { scenegraph_id = "popup_password_box", horizontal_alignment = "right", vertical_alignment = "top",
			area_size = { 25, 25 },
		...
		checkbox_background = { scenegraph_id = "popup_password_box",
			size = { 25, 25 },
			offset = { 575, 55, 5 },
			color = { 200, 10, 10, 10 } },


		checkbox_text = { word_wrap = true, scenegraph_id = "popup_password_box", localize = true, pixel_perfect = true, horizontal_alignment = "right", font_size = 18, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		checkbox_text_shadow = { word_wrap = true, scenegraph_id = "popup_password_box", localize = true, pixel_perfect = true, horizontal_alignment = "right", font_size = 18, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		text = { word_wrap = true, scenegraph_id = "popup_password_text", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		text_shadow = { word_wrap = true, scenegraph_id = "popup_password_text", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		error_message = { word_wrap = true, scenegraph_id = "popup_password_box", font_size = 22, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "top", dynamic_font = true, font_type = "hell_shark",
		...
		status_message = { word_wrap = true, scenegraph_id = "popup_password_box", font_size = 22, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "top", dynamic_font = true, font_type = "hell_shark",
		...
		status_message_shadow = { word_wrap = true, scenegraph_id = "popup_password_box", font_size = 22, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "top", dynamic_font = true, font_type = "hell_shark",
		...
		status_texture_frame = { vertical_alignment = "bottom", horizontal_alignment = "center",
			texture_size = { 314, 33 },
		...
		status_texture_glow = { vertical_alignment = "bottom", horizontal_alignment = "center",
			texture_size = { 314, 33 },
		...
		inner_rect = { scenegraph_id = "popup_password_box",

			color = { 200, 10, 10, 10 },
			offset = { 0, 0, 3 } },

		inner_frame = { scenegraph_id = "popup_password_box",
		...
		title_text = { word_wrap = true, scenegraph_id = "title_box", font_size = 50, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, dynamic_font_size = true, font_type = "hell_shark_header",
		...
		title_text_shadow = { word_wrap = true, scenegraph_id = "title_box", font_size = 50, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, dynamic_font_size = true, font_type = "hell_shark_header",
		...
		placeholder_input = { word_wrap = false, scenegraph_id = "popup_password_input", localize = true, pixel_perfect = true, horizontal_alignment = "center", font_size = 28, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",




			text_color = { 200, 40, 40, 40 },
		...
		placeholder_input_shadow = { word_wrap = false, scenegraph_id = "popup_password_input", localize = true, pixel_perfect = true, horizontal_alignment = "center", font_size = 28, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		input = { word_wrap = false, scenegraph_id = "popup_password_input", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", horizontal_scroll = true, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		input_shadow = { word_wrap = false, scenegraph_id = "popup_password_input", font_size = 28, pixel_perfect = true, horizontal_alignment = "center", horizontal_scroll = true, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
...
local function create_gamepad_button(input_action, scenegraph_id)
	return {
		...
		style = {
			text = { vertical_alignment = "center", font_size = 24, font_type = "hell_shark", horizontal_alignment = "center",
...
function PopupHandler:init(context, from_manager)
...
function PopupHandler:set_input_manager(input_manager)
	self.input_manager = input_manager
	local block_reasons = { popup = true }
...
function PopupHandler:get_input_manager()
	return self.input_manager
end

function PopupHandler:remove_input_manager(application_shutdown)
	if self:has_popup() then
		self:release_input()
	end
...
function PopupHandler:create_ui_elements()
...
function PopupHandler:acquire_input(ignore_cursor_stack)
	local input_manager = self.input_manager

	self:release_input(true)

	input_manager:capture_input({ "keyboard", "gamepad", "mouse" }, 1, "popup", "PopupHandler")
...
function PopupHandler:release_input(ignore_cursor_stack)
	local input_manager = self.input_manager
	...
	input_manager:release_input({ "keyboard", "gamepad", "mouse" }, 1, "popup", "PopupHandler", block_reason)
...
function PopupHandler:update(dt, from_manager)
	...
	if current_popup then
		...
		local ui_renderer = self.ui_renderer local input_manager = self.input_manager or self.mock_input_manager
		...
		if result then
			...
			self.popup_results [current_popup.popup_id] = { result, result_params }
...
function PopupHandler:_handle_keyboard_input(current_popup)
	local n_args = current_popup.n_args
	...
	elseif input_service:get("move_left_hold_continuous") then
		index = math.clamp(index - 1, 1, n_args)
	elseif input_service:get("confirm_press") and
	current_popup.button_enabled_state [index] then
		local args = current_popup.args
		self:play_sound("Play_hud_select")
...
function PopupHandler:get_gamepad_input_texture_data(input_service, input_action, ignore_keybinding)
...
function PopupHandler:set_button_enabled(popup_id, button_index, enabled)
	local popup = nil
...
function PopupHandler:active_popup()
...
function PopupHandler:queue_popup(popup_type, text, topic, ...)
	local n_popups = self.n_popups local popups = self.popups
	n_popups = n_popups + 1
	self.n_popups = n_popups
	if not popups [n_popups] then local new_popup = { args = { } } end
...
function PopupHandler:_initialize_popup(popup)
...
function PopupHandler:_initialize_password_popup(popup)
...
function PopupHandler:set_popup_verifying_password(popup_id, is_verifying, status_message, error_message)
...
function PopupHandler:_animate_element_pulse(target, target_index, from, to, time)
	local new_animation = UIAnimation.init(UIAnimation.pulse_animation,
	target, target_index, from, to, time)
	return new_animation
end


function PopupHandler:activate_timer(popup_id, time, default_result, alignment, blink, optional_timer_format_func, optional_font_size)
	local n_popups = self.n_popups
...
function PopupHandler:has_popup()
	return self.n_popups > 0
end

function PopupHandler:has_popup_with_id(popup_id)
...
function PopupHandler:_reset_popup_initialized()
	for _, popup in pairs(self.popups) do
		popup.initialized = false
	end
end

function PopupHandler:cancel_popup(popup_id)
	local n_popups = self.n_popups
	local popups = self.popups
	for i = 1, n_popups do
...
function PopupHandler:cancel_all_popups()
	local n_popups = self.n_popups
	local popups = self.popups
	for i = 1, n_popups do
		popups [i] = nil
...
function PopupHandler:query_result(popup_id)
...
function PopupHandler:play_sound(event)
	WwiseWorld.trigger_event(self.wwise_world, event)
end

function PopupHandler:fit_text_width_to_popup(text)
...
function PopupHandler:get_number_of_rows(localized_text, text_style, text_area_width)
	local font, scaled_font_size = UIFontByResolution(text_style)
