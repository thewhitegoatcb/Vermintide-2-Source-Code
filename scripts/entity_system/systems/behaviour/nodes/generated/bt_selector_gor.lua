...
function BTSelector_gor:init(...)
	BTSelector_gor.super.init(self, ...)
	self._children = { }
end

function BTSelector_gor:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_gor:run(unit, blackboard, t, dt)
...
function BTSelector_gor:add_child(node)
