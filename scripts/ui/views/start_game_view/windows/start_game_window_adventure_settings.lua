...
function StartGameWindowAdventureSettings:on_enter(params, offset)
...
function StartGameWindowAdventureSettings:create_ui_elements(params, offset)
...
function StartGameWindowAdventureSettings:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowAdventureSettings")
	self.ui_animator = nil
end

function StartGameWindowAdventureSettings:update(dt, t)
...
function StartGameWindowAdventureSettings:post_update(dt, t)
	return end

function StartGameWindowAdventureSettings:_update_animations(dt)
...
function StartGameWindowAdventureSettings:_is_button_released(widget)
...
function StartGameWindowAdventureSettings:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowAdventureSettings:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowAdventureSettings:_handle_input(dt, t)
...
function StartGameWindowAdventureSettings:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowAdventureSettings:_update_difficulty_option()
	local parent = self.parent
...
function StartGameWindowAdventureSettings:_set_difficulty_option(difficulty_key)
...
function StartGameWindowAdventureSettings:draw(dt)
...
function StartGameWindowAdventureSettings:_update_game_options_hover_effect()
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowAdventureSettings:_on_option_button_hover_enter(widget, index, instant)
...
function StartGameWindowAdventureSettings:_on_option_button_hover_exit(widget, index, instant)
...
function StartGameWindowAdventureSettings:_create_style_animation_enter(widget, target_value, style_id, widget_index, instant)
...
function StartGameWindowAdventureSettings:_create_style_animation_exit(widget, target_value, style_id, widget_index, instant)
	local widget_style = widget.style
	local pass_style = widget_style [style_id]
	if not pass_style then
		return
...
function StartGameWindowAdventureSettings:_animate_pulse(target, target_index, from, to, speed)
	local new_animation = UIAnimation.init(UIAnimation.pulse_animation, target, target_index, from, to, speed)
	return new_animation
end

function StartGameWindowAdventureSettings:_animate_element_by_time(target, target_index, from, to, time)
