...
LimitedItemTrackSpawnerTemplates = {
	...
	explosive_barrel_spawner = {
		types = { "explosive_barrel", "explosive_barrel_objective" },
		...
		spawn_func = function (world, spawner_unit, spawn_data)
			...
			local extension_init_data = {
				...
				pickup_system = { spawn_type = "limited",
	...
	magic_barrel_spawner = {
		types = { "explosive_barrel", "explosive_barrel_objective", "magic_barrel" },
	...
	wizards_barrel_spawner = {
		types = { "explosive_barrel", "explosive_barrel_objective", "wizards_barrel" },
