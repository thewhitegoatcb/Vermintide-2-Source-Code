return { description = "description_mutator_same_specials", icon = "mutator_icon_specials_frequency", display_name = "display_name_mutator_same_specials",
	...
	update_conflict_settings = function (context, data)
		...
		method.after_safe_zone_delay = { 30, 70 }
	end }