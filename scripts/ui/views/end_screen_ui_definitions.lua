...
local widget_definitions = {
	background_rect = { scenegraph_id = "screen",
		element = {
...
local animations = { }
animations.fade_in_background = { { name = "fade_in", start_progress = 0, end_progress = 0.2,
...
animations.fade_out_background = { { name = "fade_out", start_progress = 0, end_progress = 0.3,
...
animations.auto_display_text = { { name = "fade_in", start_progress = 0, end_progress = 0.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "fade_out", start_progress = 4, end_progress = 4.5,
...
local screens = {
	victory = { file_name = "scripts/ui/views/end_screens/victory_end_screen_ui", class_name = "VictoryEndScreenUI" },



	defeat = { file_name = "scripts/ui/views/end_screens/defeat_end_screen_ui", class_name = "DefeatEndScreenUI" },



	none = { file_name = "scripts/ui/views/end_screens/none_end_screen_ui", class_name = "NoneEndScreenUI" } }
