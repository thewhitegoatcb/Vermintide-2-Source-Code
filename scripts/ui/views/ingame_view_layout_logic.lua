...
function IngameViewLayoutLogic:init(ingame_ui_context, params, menu_layouts, full_access_layout)
...
function IngameViewLayoutLogic:setup_button_layout(layout_data)
...
function IngameViewLayoutLogic:_update_menu_options()
...
function IngameViewLayoutLogic:_update_menu_options_enabled_states()
	local active_button_data = self.active_button_data
	if active_button_data then
...
function IngameViewLayoutLogic:execute_layout_option(index)
	local active_button_data = self.active_button_data
	...
	if data then
		...
		if url then
			...
			local transition_params = { menu_state_name = transition_state, menu_sub_state_name = transition_sub_state, force_open = force_open }
...
function IngameViewLayoutLogic:update()
	self:_update_menu_options()
	self:_update_menu_options_enabled_states()
end

function IngameViewLayoutLogic:layout_data()
	return self.active_button_data
end

function IngameViewLayoutLogic:destroy()
