...
function VictoryEndScreenUI:init(ingame_ui_context, input_service, screen_context)
...
function VictoryEndScreenUI:_destroy()
...
function VictoryEndScreenUI:_start()
...
function VictoryEndScreenUI:_update(dt)
