...
function HeroWindowWeaveForgeBackground:on_enter(params, offset)
...
function HeroWindowWeaveForgeBackground:_setup_definitions()
...
function HeroWindowWeaveForgeBackground:create_ui_elements(params, offset)
...
function HeroWindowWeaveForgeBackground:on_exit(params)
	print("[HeroViewWindow] Exit Substate HeroWindowWeaveForgeBackground")
	self._ui_animator = nil
end

function HeroWindowWeaveForgeBackground:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowWeaveForgeBackground:post_update(dt, t)
	return end

function HeroWindowWeaveForgeBackground:_update_animations(dt)
...
function HeroWindowWeaveForgeBackground:_draw(dt)
