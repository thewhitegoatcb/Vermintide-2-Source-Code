...
local XB1_ACHIEVEMENT_ID = { penny_portals_heads = 86, penny_portals_vintage = 87 }




local PS4_ACHIEVEMENT_ID = { penny_portals_vintage = "081" }
...
local portals = { LevelSettings.dlc_portals }
...
add_meta_challenge(achievements, "penny_complete_portals", { "penny_portals_portal", "penny_portals_heads", "penny_portals_cleanser", "penny_portals_vintage", "penny_portals_hideout" })