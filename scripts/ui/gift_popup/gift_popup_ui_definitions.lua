...
local scenegraph_definition = {
	root = { is_root = true, size = { 1920, 1080 }, position = { 0, 0, UILayer.item_display_popup } },
	screen = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.item_display_popup } },
	menu_root = { vertical_alignment = "center", parent = "root", horizontal_alignment = "center", size = { 1920, 1080 }, position = { 0, 0, 0 } },

	popup_bg_parent = { vertical_alignment = "center", parent = "menu_root", horizontal_alignment = "center", size = { 715, 958 }, position = { 0, 60, 2 } },
	popup_bg = { vertical_alignment = "center", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 715, 958 }, position = { 0, -10, 0 } },
	claim_button = { vertical_alignment = "bottom", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 454, 83 }, position = { 0, 45, 2 } },
	button_glow = { vertical_alignment = "center", parent = "claim_button", horizontal_alignment = "center", size = { 454, 83 }, position = { 0, 0, 8 } },
	thumb_widgets_pivot = { vertical_alignment = "center", parent = "claim_button", horizontal_alignment = "center", size = { 64, 64 }, position = { 0, 85, 2 } },


	title_text = { vertical_alignment = "top", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 560, 80 }, position = { 0, -120, 0 } },
	description_text = { vertical_alignment = "top", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 560, 80 }, position = { 0, -155, 0 } },
	reward_name_text = { vertical_alignment = "bottom", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 560, 50 }, position = { 0, 260, 1 } },
	reward_type_text = { vertical_alignment = "bottom", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 560, 50 }, position = { 0, 230, 3 } },

	divider = { vertical_alignment = "bottom", parent = "popup_bg_parent", horizontal_alignment = "center", size = { 379, 8 }, position = { 0, 200, 1 } },

	hero_icon = { vertical_alignment = "center", parent = "reward_type_text", horizontal_alignment = "center", size = { 46, 46 }, position = { 0, -30, -1 } },
	hero_icon_tooltip = { vertical_alignment = "center", parent = "reward_type_text", horizontal_alignment = "center", size = { 46, 46 }, position = { 0, -30, -1 } } }


local function create_reward_thumb_widget()
	local widget_definition = { scenegraph_id = "thumb_widgets_pivot" }
	widget_definition.element = {
		passes = { { pass_type = "hotspot", content_id = "button_hotspot" },
			...
			{ pass_type = "texture", style_id = "icon_frame", texture_id = "icon_frame",
			...
			{ pass_type = "texture", style_id = "selection", texture_id = "selection",
	...
	widget_definition.content = { first_time = true, selection = "popup_icon_selection", icon_frame = "frame_01", selected = false, icon = "icons_placeholder", draw_frame = true, icon_glow = "popup_icon_glow",
	...
	widget_definition.offset = { 0, 0, 0 }
...
local default_tooltip_style = { font_size = 24, max_width = 500, localize = false, horizontal_alignment = "left", vertical_alignment = "top", font_type = "hell_shark",
...
local widget_definitions = {
	...
	background = UIWidgets.create_simple_rect("screen", { 255, 0, 0, 0 }) }


local generic_input_actions = {
	default = { { input_action = "confirm", priority = 4, description_text = "input_description_select" } },
	...
	selection = { { input_action = "back", priority = 5, description_text = "input_description_close" } } }
...
animation_definitions.chest_unit_spawn = { { name = "rotation", start_progress = 0, end_progress = 0.7,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "scale", start_progress = 0, end_progress = 0.25,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "position", start_progress = 0.01, end_progress = 0.7,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "bg_fade_in", start_progress = 0.6, end_progress = 1,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "button_fade_in", start_progress = 1.4, end_progress = 1.71,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "animation_fall", start_progress = 0.65, end_progress = 0.71,
	...
	{ name = "chest_land", start_progress = 0.71, end_progress = 1,
	...
	{ name = "animation_fall_xxx", start_progress = 0.71, end_progress = 1.71,
...
animation_definitions.chest_unit_open = { { name = "animation_open", start_progress = 0, end_progress = 1,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "scale", start_progress = 1.1, end_progress = 1.25,
...
animation_definitions.thumbs_fade_in = { { name = "fade_in", start_progress = 0, end_progress = 1,
		...
		update = function (ui_scenegraph, scenegraph_definition, widgets, progress, params)
			...
			for index, widget in ipairs(thumb_widgets) do --[[ Nothing --]]
			end
