...
local GREY_WINGS_TELEPORT_STATES = { IDLE = 1, COOLDOWN = 5, FINDING_TELEPORT_POSITION = 2, TELEPORTING = 3, LANDING = 4 }
...
settings.buff_function_templates = {
	update_belakor_grey_wings_teleport_trigger = function (unit, buff, params)
		...
		if blackboard.move_state == "attacking" and combo_attack_data and (

		combo_attack_data.current_attack_name == "attack_wild_flailing" or
		combo_attack_data.current_attack_name == "attack_heavy") and
		not combo_attack_data.aborted then
			parent_buff_shared_table.teleport = true
		end
	end,
	...
	update_belakor_grey_wings = function (unit, buff, params)
		...
		if shared_table.teleport_state == GREY_WINGS_TELEPORT_STATES.TELEPORTING and
		ALIVE [unit] and shared_table.teleport_t < t then
...
local grey_wings_valid_damage_types = { light_blunt_linesman = true, light_slashing_tank = true, drakegun = true, blunt_linesman = true, light_stab_linesman = true, stab_tank = true, light_slashing_linesman = true, heavy_blunt_smiter = true, blunt = true, light_blunt_fencer = true, heavy_blunt_linesman = true, blunt_tank_uppercut = true, heavy_blunt_tank = true, heavy_slashing_smiter_uppercut = true, arrow = true, light_stab_smiter = true, light_stab_fencer = true, heavy_stab_fencer = true, bolt_sniper = true, piercing = true, blunt_tank = true, shot_repeating_handgun = true, light_slashing_fencer = true, projectile = true, slashing_fencer = true, heavy_slashing_fencer = true, shot_sniper = true, heavy_stab_smiter = true, shot_machinegun = true, heavy_slashing_tank = true, shot_shotgun = true, heavy_slashing_smiter = true, light_slashing_linesman_hs = true, heavy_stab_tank = true, light_slashing_smiter = true, slashing_smiter = true, drakegun_shot = true, arrow_sniper = true, stab_smiter = true, arrow_carbine = true, throwing_axe = true, heavy_blunt_fencer = true, stab_fencer = true, light_blunt_tank = true, arrow_machinegun = true, light_stab_tank = true, slashing_linesman = true, blunt_fencer = true, slashing_smiter_uppercut = true, slashing = true, bolt_carbine = true, light_blunt_smiter = true, heavy_stab_linesman = true, blunt_smiter = true, slashing_buffed = true, shot_carbine = true, bolt_machinegun = true, slashing_tank = true, cutting = true, heavy_slashing_linesman = true, burning_stab_fencer = true, stab_linesman = true }
...
settings.buff_templates = {
	orb_test_01 = {
		buffs = { { event = "on_kill", name = "orb_test_01", buff_func = "spawn_orb",
	...
	orb_test_buff_01 = { activation_effect = "fx/screenspace_potion_02",

		buffs = { { name = "orb_test_buff_01", multiplier = 0.5, stat_buff = "attack_speed", duration = 2, max_stacks = 10, icon = "potion_buff_02", refresh_durations = true } } },
	...
	belakor_shadow_lieutenant = {
		buffs = { { multiplier = 1.75, name = "belakor_shadow_lieutenant", stat_buff = "max_health", remove_buff_func = "remove_max_health_buff_for_ai", apply_buff_func = "apply_max_health_buff_for_ai",
				...
				perks = { "anti_oneshot" } },
			{ name = "belakor_shadow_lieutenant_material_objective_unit", buff_func = "remove_objective_unit", event = "on_death", remove_buff_func = "remove_objective_unit", apply_buff_func = "apply_objective_unit" },
			...
			{ event = "on_death", name = "belakor_shadow_lieutenant_drop_crystal", buff_func = "belakor_shadow_lieutenant_drop_crystal" } } },
	...
	belakor_crystal_spawn_on_death = {
		buffs = { { event = "on_death", name = "belakor_crystal_spawn_on_death", buff_func = "belakor_crystal_drop",
	...
	belakor_grey_wings = { create_parent_buff_shared_table = true,

		buffs = { { event = "on_damage_taken", name = "belakor_grey_wings", buff_func = "on_grey_wings_damage_taken",




				valid_damage_types = grey_wings_valid_damage_types },
			{ min_dist_from_players_gap_closer = 3, name = "belakor_grey_wings_teleport_logic", min_distance_to_trigger_gap_closer_teleport = 10, teleport_effect = "fx/blk_grey_wings_teleport_01", remove_buff_func = "remove_belakor_grey_wings", teleport_effect_trail = "fx/blk_grey_wings_teleport_direction_01", min_teleport_distance_gap_closer = 3, teleport_delay = 0.5, teleport_cooldown = 1, teleport_available_buff = "belakor_grey_wings_teleport_available", max_teleport_distance_gap_closer = 6, apply_buff_func = "apply_belakor_grey_wings", max_teleport_distance = 13, min_teleport_distance = 7, find_valid_pos_attempts = 5, update_func = "update_belakor_grey_wings", min_dist_from_players = 5 },
			...
			{ update_func = "update_belakor_grey_wings_teleport_trigger", name = "belakor_grey_wings_on_combo", max_distance_to_trigger_teleport_from_combo_attack = 5 },




			{ multiplier = 1, name = "belakor_grey_wings_health", stat_buff = "max_health", remove_buff_func = "remove_max_health_buff_for_ai", apply_buff_func = "apply_max_health_buff_for_ai" } } },
	...
	belakor_grey_wings_teleport_available = {
		buffs = { { name = "belakor_grey_wings_teleport_available",


				perks = { buff_perks.invulnerable_ranged } },
			{ remove_buff_func = "remove_attach_particle", name = "belakor_grey_wings_particle", apply_buff_func = "apply_attach_particle", particle_fx = "fx/blk_grey_wings_01" } } },
	...
	belakor_homing_skull_debuff = {
		buffs = { { name = "belakor_homing_skull_debuff", apply_buff_func = "apply_one_from_list",
				...
				buff_list = { "belakor_homing_skull_debuff_delayed_stun_effect" } } } },
	...
	belakor_homing_skull_debuff_delayed_stun = {
		buffs = { { buff_to_add = "belakor_homing_skull_debuff_delayed_stun_effect", name = "belakor_homing_skull_debuff_delayed_stun", is_cooldown = true, icon = "deus_curse_slaanesh_01", continuous_effect = "fx/screenspace_darkness_flash", remove_buff_func = "add_buff", priority_buff = true, debuff = true, max_stacks = 1, duration = 3 } } },
	...
	belakor_homing_skull_debuff_delayed_stun_effect = { deactivation_sound = "stop_curse_belakor_shadow_skulls_player_disabled", activation_sound = "play_curse_belakor_shadow_skulls_player_disabled_start",


		buffs = { { priority_buff = true, name = "belakor_homing_skull_debuff_delayed_stun_effect", debuff = true, icon = "deus_curse_belakor_02", apply_buff_func = "apply_homing_skull_achieve", continuous_effect = "fx/screenspace_darkness_flash", max_stacks = 1, duration = 2.5,
				...
				perks = { buff_perks.overpowered } },
			{ particle_fx = "fx/skull_trap", name = "belakor_homing_skull_debuff_particle", offset_rotation_y = 90, duration = 2.5, remove_buff_func = "remove_attach_particle", apply_buff_func = "apply_attach_particle" } } },
	...
	belakor_homing_skull_debuff_delayed_banish = {
		buffs = { { icon = "twitch_icon_vanishing_act", name = "belakor_homing_skull_debuff_delayed_banish", continuous_effect = "fx/screenspace_inside_plague_vortex", max_stacks = 1, duration = 5, priority_buff = true, debuff = true,
			...
			{ max_stacks = 1, name = "belakor_homing_skull_debuff_delayed_banish_stun", duration = 5,
	...
	belakor_cultists_buff = {
		buffs = { { multiplier = 0.25, name = "belakor_cultists_buff_damage", stat_buff = "damage_dealt" },




			{ multiplier = 1.25, name = "belakor_cultists_buff_health", stat_buff = "max_health" },




			{ remove_buff_func = "ai_update_max_health", name = "belakor_cultists_buff_health_update", apply_buff_func = "ai_update_max_health" },




			{ remove_buff_func = "belakor_cultists_remove_eye_glow", name = "belakor_cultists_buff_eye_glow", apply_buff_func = "belakor_cultists_apply_eye_glow" },




			{ multiplier = 1.1, name = "belakor_cultists_buff_stagger", stat_buff = "stagger_resistance" },




			{ multiplier = 0.9, name = "belakor_cultists_buff_hit_mass", stat_buff = "hit_mass_amount" } } } }