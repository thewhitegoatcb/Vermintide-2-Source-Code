...
function CameraStateFollow:init(camera_state_init_context)
...
function CameraStateFollow:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollow:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollow:update(unit, input, dt, context, t)
	local csm = self.csm
