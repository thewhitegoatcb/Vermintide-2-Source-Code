...
function LuaAStar.a_star_plain(nodes, node1, node2)
	local closed_set = { }
	local open_set = { node1 }
	local came_from = { }
...
function LuaAStar.a_star_cached(nodes, a1, a2)
	...
	cached_paths [a1] [a2] = { path, length }
	return path, length
end