...
function StartGameWindowHeroicDeedOverviewConsole:on_enter(params, offset)
...
function StartGameWindowHeroicDeedOverviewConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowHeroicDeedOverviewConsole:_create_ui_elements(params, offset)
...
function StartGameWindowHeroicDeedOverviewConsole:on_exit(params)
...
function StartGameWindowHeroicDeedOverviewConsole:set_focus(focused)
	self._is_focused = focused
end

function StartGameWindowHeroicDeedOverviewConsole:update(dt, t)
...
function StartGameWindowHeroicDeedOverviewConsole:post_update(dt, t)
	return end

function StartGameWindowHeroicDeedOverviewConsole:_present_heroic_deed(backend_id)
...
function StartGameWindowHeroicDeedOverviewConsole:_update_heroic_deed_selection()
...
function StartGameWindowHeroicDeedOverviewConsole:_update_can_play()
...
function StartGameWindowHeroicDeedOverviewConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowHeroicDeedOverviewConsole:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowHeroicDeedOverviewConsole:_handle_input(dt, t)
...
function StartGameWindowHeroicDeedOverviewConsole:_can_play()
	local item_interface = Managers.backend:get_interface("items")
...
function StartGameWindowHeroicDeedOverviewConsole:_option_selected(input_index, t)
...
function StartGameWindowHeroicDeedOverviewConsole:_handle_new_selection(input_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowHeroicDeedOverviewConsole:_update_animations(dt)
...
function StartGameWindowHeroicDeedOverviewConsole:_draw(dt)
