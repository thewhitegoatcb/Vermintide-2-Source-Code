...
local weapon_template = {
	actions = {
		action_one = {
			default = { kind = "career_bw_necromancer_command_attack", weapon_action_hand = "left", anim_event = "pet_control_target_command", total_time = 0.2,
			...
			cast_stand = { anim_event = "pet_control_target_command", weapon_action_hand = "left", kind = "career_bw_necromancer_command_stand", total_time = 1,
				...
				allowed_chain_actions = { { sub_action = "default", start_time = 0.2, action = "action_wield", input = "action_wield" },
					...
					{ sub_action = "default", start_time = 0.5, action = "action_two", release_required = "action_two_hold", input = "action_two" },
					{ sub_action = "default", start_time = 0.2, action = "weapon_reload", input = "weapon_reload" } },
		...
		action_two = {
			default = { kind = "action_selector", weapon_action_hand = "left",

				conditional_actions = { { sub_action = "command_stand", release_required = "action_two_hold",
				...
				default_action = { action = "action_two", sub_action = "dummy" } },


			command_stand = { weapon_action_hand = "left", anim_end_event = "pet_control_cancel", kind = "career_bw_necromancer_command_stand_targeting", hold_input = "action_two_hold", anim_event = "pet_control_target", minimum_hold_time = 0.3,
				...
				allowed_chain_actions = { { sub_action = "default", start_time = 0, action = "action_wield", input = "action_wield" },
					{ sub_action = "cast_stand", start_time = 0.2, action = "action_one", input = "action_one" },
			...
			dummy = { kind = "dummy", weapon_action_hand = "left", total_time = 0,
		...
		action_three = {
			default = { anim_event = "pet_control_target_command_return", weapon_action_hand = "left", anim_event_3p = "pet_control_target_command", kind = "dummy", total_time = 0.7,
				...
				allowed_chain_actions = { { sub_action = "default", start_time = 0.2, action = "action_wield", input = "action_wield" },
					...
					{ sub_action = "default", start_time = 0.2, action = "action_two", release_required = "action_two_hold", input = "action_two" },
					{ sub_action = "default", start_time = 0.2, action = "weapon_reload", input = "weapon_reload" } },
		...
		weapon_reload = {
			default = { anim_event = "pet_control_sacrifice", weapon_action_hand = "left", kind = "career_bw_necromancer_command_vent", total_time = 1,
				...
				allowed_chain_actions = { { sub_action = "default", start_time = 0.9, action = "action_wield", input = "action_wield" },
					...
					{ sub_action = "default", start_time = 0.9, action = "action_one", input = "action_one" },
	...
	wwise_dep_left_hand = { "wwise/two_handed_swords" } }

return { bw_necromancer_career_utility_weapon = table.clone(weapon_template) }