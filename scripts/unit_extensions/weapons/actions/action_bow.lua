...
function ActionBow:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionBow:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionBow:reload(current_action)
...
function ActionBow:client_owner_post_update(dt, t, world, can_damage)
...
function ActionBow:finish(reason, data)
	local current_action = self.current_action
	local owner_unit = self.owner_unit
...
function ActionBow:fire(current_action, add_spread)
	local owner_unit = self.owner_unit
