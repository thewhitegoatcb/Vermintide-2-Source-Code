...
local function profile_start(title)
	local t = { title = title, start_time = os.clock() }
	return t
end
...
function Boot:setup()
	...
	Boot.startup_packages = { "resource_packages/boot_assets", "resource_packages/fonts", "resource_packages/strings", "resource_packages/foundation_scripts", "resource_packages/game_scripts", "resource_packages/level_scripts", "resource_packages/levels/benchmark_levels", "resource_packages/levels/honduras_levels" }
...
local function xb1_format_locale(language_id)
	...
	local supported_languages = { ["zh-hk"] = "zh", ["fr-ch"] = "fr", ["ru-ru"] = "ru", ["nb-no"] = "nb", ["en-us"] = "en", ["en-gb"] = "en", ["en-il"] = "en", ["es-mx"] = "es", ["en-nz"] = "en", ["da-dk"] = "da", ["en-sa"] = "en", ["pt-pt"] = "pt", ["es-co"] = "es", ["en-hu"] = "en", ["en-sg"] = "en", ["fr-ca"] = "fr", ["en-ae"] = "en", ["nl-be"] = "nl", ["en-in"] = "en", ["zh-tw"] = "zh", ["en-cz"] = "en", ["de-ch"] = "de", ["de-de"] = "de", ["fr-be"] = "fr", ["en-gr"] = "en", ["ko-kr"] = "kr", ["tr-tr"] = "tr", ["sv-se"] = "sv", ["zh-sg"] = "zh", ["es-ar"] = "es", ["en-sk"] = "en", ["pl-pl"] = "pl", ["nl-nl"] = "nl", ["pt-br"] = "br-pt", ["it-it"] = "it", ["es-es"] = "es", ["en-au"] = "en", ["de-at"] = "de", ["en-ca"] = "en", ["zh-cn"] = "zh", ["fr-fr"] = "fr", ["en-hk"] = "en", ["ja-jp"] = "jp", ["es-cl"] = "es", ["fi-fi"] = "fi", ["en-ie"] = "en", ["en-za"] = "en" }
...
local function init_development_parameters()
	...
	Development.init_application_parameters({ Application.argv() }, true)
...
function Boot:booting_update(dt)
...
function Boot:booting_render()
	render_startup_world()
end

function Boot:_require_foundation_scripts()
	...
	base_require("managers",
	"world/world_manager",
	"player/player",
	"free_flight/free_flight_manager",
	"state/state_machine_manager",
	"time/time_manager",
...
function ReplayBoot:update(dt)
	dt = Managers.replay:update(dt)
	World.update(self._world, dt)
end

function ReplayBoot:render()
...
local EMPTY_TABLE = { }
function Boot:game_update(real_world_dt)
...
function Game:_set_ps4_content_restrictions()


	local restrictions = { { country = "at", age = 18 },
...
function Game:require_game_scripts()
	game_require("utils",
	"patches",
	"colors",
	"framerate",
	...
	game_require("ui",
	"views/show_cursor_stack",

	"ui_fonts")

	game_require("settings",
	"demo_settings",
	"motion_control_settings",
	"game_settings_development",

	"controller_settings",

	"default_user_settings")

	game_require("entity_system",

	"entity_system")

	game_require("game_state",
	"game_state_machine",
	"state_context",
	"state_splash_screen",
	"state_loading",
	...
	game_require("managers",
	"admin/admin_manager",
	"news_ticker/news_ticker_manager",
	"player/player_manager",
	"player/player_bot",
	"save/save_manager",
	"save/save_data",
	"perfhud/perfhud_manager",
	"music/music_manager",
	"network/party_manager",
	"network/lobby_manager",
	...
	"popup/popup_manager",
	"popup/simple_popup",
	"light_fx/light_fx_manager",
	"razer_chroma/razer_chroma_manager",
	"play_go/play_go_manager",
	"controller_features/controller_features_manager",
	"deed/deed_manager",
	"boon/boon_manager",
	"telemetry/telemetry_manager",
	"telemetry/telemetry_events",
	"telemetry/telemetry_reporters",
	"load_time/load_time_manager",
	"game_mode/game_mechanism_manager",
	"ui/ui_manager",
	...
	elseif IS_XB1 then
		game_require("managers",
		"events/xbox_event_manager",
		"rest_transport/rest_transport_manager",
		"twitch/twitch_manager",
	...
	elseif IS_PS4 then
		...
		"system_dialog/system_dialog_manager")
	elseif IS_LINUX then
		game_require("managers",
		"irc/irc_manager",
		"curl/curl_manager",
...
function Game:_handle_win32_graphics_quality()
...
function Game:_init_backend_xbox()
...
function Game:_init_backend_ps4()
...
function Game:_load_win32_user_settings()
...
function Game:_init_localization_manager()
...
function Game:select_starting_state()
	...
	elseif GameSettingsDevelopment.start_state == "game" then
		...
		do return StateSplashScreen, { } end
