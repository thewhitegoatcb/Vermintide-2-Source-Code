...
function BTSelector_chaos_skeleton:init(...)
	BTSelector_chaos_skeleton.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_skeleton:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_skeleton:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_skeleton:add_child(node)
