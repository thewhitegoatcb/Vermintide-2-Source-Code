return { description = "curse_abundance_of_life_desc", display_name = "curse_abundance_of_life_name", icon = "deus_curse_slaanesh_01",




	pickup_system_multipliers = { healing = 0, deus_potions = 3, potions = 3 },
