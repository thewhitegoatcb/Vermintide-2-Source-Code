...
function BTFireProjectileAction:init(...)
...
function BTFireProjectileAction:enter(unit, blackboard, t)
...
function BTFireProjectileAction:_check_for_volley_attack(blackboard, unit, t)
...
function BTFireProjectileAction:leave(unit, blackboard, t, reason)
...
function BTFireProjectileAction:run(unit, blackboard, t, dt)
...
function BTFireProjectileAction:_fire_from_position_direction(blackboard, unit, dt, projectile_speed, g)
...
local PI = math.pi
local TWO_PI = PI * 2
function BTFireProjectileAction:_fire_projectile(unit, blackboard, dt)
	local action = blackboard.action
