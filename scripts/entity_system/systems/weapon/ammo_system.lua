...
local extensions = { "ActiveReloadAmmoUserExtension", "GenericAmmoUserExtension" }




local RPCS = { "rpc_give_ammo_fraction_to_owner" }



function AmmoSystem:init(entity_system_creation_context, system_name)
...
function AmmoSystem:on_add_extension(world, unit, extension_name, extension_init_data)
	...
	if not extension_owners then
		self._unit_extensions_by_owener [extension.owner_unit] = { extension }
	else
...
function AmmoSystem:on_remove_extension(unit, extension_name)
...
function AmmoSystem:destroy()
	self._network_event_delegate:unregister(self)
end

function AmmoSystem:give_ammo_fraction_to_owner(owner_unit, fraction, to_reserve)
...
function AmmoSystem:rpc_give_ammo_fraction_to_owner(channel_id, unit_id, fraction, to_reserve)
