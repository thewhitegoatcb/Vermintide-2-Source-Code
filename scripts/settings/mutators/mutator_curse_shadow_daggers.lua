...
function Storm:init(unit_name, min_cooldown, max_cooldown, logging_prefix)
...
function Storm:spawn(spawn_position)
	...
	local extension_init_data = {
		shadow_dagger_spawner_system = { limitted_spawner = true } }
...
return { description = "curse_shadow_daggers_desc", curse_package_name = "resource_packages/mutators/mutator_curse_shadow_daggers", display_name = "curse_shadow_daggers_name", icon = "deus_curse_khorne_01",
