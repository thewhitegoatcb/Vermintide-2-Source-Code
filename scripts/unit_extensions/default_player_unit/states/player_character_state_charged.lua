...
function PlayerCharacterStateCharged:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "charged")
	local context = character_state_init_context
	self.inputs_to_buffer = { wield_4_alt = true, wield_2 = true, wield_5 = true, action_career_release = true, action_career = true, wield_3 = true, wield_1 = true, wield_4 = true, action_one = true, wield_switch = true }
...
function PlayerCharacterStateCharged:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateCharged:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateCharged:update(unit, input, dt, context, t)
	local csm = self.csm
...
function PlayerCharacterStateCharged:queue_input(input, input_extension, inventory_extension)
