...
local SHADER_FLAGS = { "NECROMANCER_CAREER_REMAP" }
...
local PARTICLE_LIGHTING_REMAP_VALUES = {
	NECROMANCER_CAREER_REMAP = { 39, 0, 182, 110 } }
...
function GlobalShaderFlags.set_global_shader_flag(shader_flag_name, enable)
...
function GlobalShaderFlags.set_override_shader_flag(shader_flag_name, enable)
	local global_shader_flags = update_global_shader_flags(shader_flag_name, enable)
...
function GlobalShaderFlags.remove_override_shader_flag(shader_flag_name)
