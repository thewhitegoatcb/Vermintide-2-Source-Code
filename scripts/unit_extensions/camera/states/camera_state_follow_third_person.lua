...
function CameraStateFollowThirdPerson:init(camera_state_init_context)
...
function CameraStateFollowThirdPerson:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollowThirdPerson:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollowThirdPerson:refresh_follow_unit(follow_unit, follow_node)
	self._follow_unit = follow_unit
	self._follow_node = follow_node
end

function CameraStateFollowThirdPerson:update(unit, input, dt, context, t)
	local csm = self.csm
