...
function BTObservePoisonWind:init(...)
	BTObservePoisonWind.super.init(self, ...)
end

function BTObservePoisonWind:enter(unit, blackboard, t)
...
function BTObservePoisonWind:leave(unit, blackboard, t, reason, destroy)
	blackboard.observe_poison_wind = nil
	blackboard.action = nil
	blackboard.navigation_extension:set_enabled(true)
end

function BTObservePoisonWind:run(unit, blackboard, t, dt)
