...
function BTSelector_pet_skeleton_dual_wield:init(...)
	BTSelector_pet_skeleton_dual_wield.super.init(self, ...)
	self._children = { }
end

function BTSelector_pet_skeleton_dual_wield:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_pet_skeleton_dual_wield:run(unit, blackboard, t, dt)
	...
	local condition_result = unit_alive(blackboard.target_unit) and
...
function BTSelector_pet_skeleton_dual_wield:add_child(node)
