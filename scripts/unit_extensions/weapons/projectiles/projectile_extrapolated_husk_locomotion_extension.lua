...
function ProjectileExtrapolatedHuskLocomotionExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileExtrapolatedHuskLocomotionExtension:update(unit, input, dt, context, t)
...
function ProjectileExtrapolatedHuskLocomotionExtension:destroy()
	return end

function ProjectileExtrapolatedHuskLocomotionExtension:stop()
	self._stopped = true
end