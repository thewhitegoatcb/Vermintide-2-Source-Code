...
function BTBotDropPickupAction:init(...)
	BTBotDropPickupAction.super.init(self, ...)
end

BTBotDropPickupAction.name = "BTBotDropPickupAction"

function BTBotDropPickupAction:enter(unit, blackboard, t)
...
function BTBotDropPickupAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.drop = nil
end

function BTBotDropPickupAction:run(unit, blackboard, t, dt)
