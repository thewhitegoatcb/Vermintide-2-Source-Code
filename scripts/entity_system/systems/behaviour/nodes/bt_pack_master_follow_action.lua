...
function BTPackMasterFollowAction:init(...)
...
function BTPackMasterFollowAction:enter(unit, blackboard, t)
...
function BTPackMasterFollowAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPackMasterFollowAction:run(unit, blackboard, t, dt)
