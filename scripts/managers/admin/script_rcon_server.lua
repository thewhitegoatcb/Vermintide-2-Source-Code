...
local Commands = {
	ban = { arg_help = "rcon_server_command_args_ban", min_args = 2, help = "rcon_server_command_help_ban", max_args = 3, method = "_command_ban" },
	banlist = { arg_help = "", min_args = 0, help = "rcon_server_command_help_banlist", max_args = 0, method = "_command_banlist" },
	help = { arg_help = "", min_args = 0, help = "rcon_server_command_help_help", max_args = 0, method = "_command_help" },
	id = { arg_help = "", min_args = 0, help = "rcon_server_command_help_id", max_args = 0, method = "_command_id" },
	kick = { arg_help = "rcon_server_command_args_kick", min_args = 1, help = "rcon_server_command_help_kick", max_args = 1, method = "_command_kick" },
	players = { arg_help = "", min_args = 0, help = "rcon_server_command_help_players", max_args = 0, method = "_command_players" },
	say = { arg_help = "rcon_server_command_args_say", min_args = 1, method = "_command_say", help = "rcon_server_command_help_say" },
	shutdown = { arg_help = "", min_args = 0, help = "rcon_server_command_help_shutdown", max_args = 0, method = "_command_shutdown" },
	status = { arg_help = "", min_args = 0, help = "rcon_server_command_help_status", max_args = 0, method = "_command_status" },
	unban = { arg_help = "rcon_server_command_args_unban", min_args = 1, help = "rcon_server_command_help_unban", max_args = 1, method = "_command_unban" } }
...
function ScriptRconServer:destroy()
...
function ScriptRconServer:_find_player(find_str)
	local disable_pattern_matching = true
	local start_index = 1
	local found_id = nil
	for _, player in pairs(Managers.player:players()) do
		local peer_id = player:network_id()
		if string.find(peer_id, find_str, start_index, disable_pattern_matching) ~= nil or
		string.find(player:name(), find_str, start_index, disable_pattern_matching) ~= nil then
...
function ScriptRconServer:_find_banned(find_str)
...
function ScriptRconServer:rcon_connect(id, ip_port)
...
function ScriptRconServer:_command_ban(peer_id, name, days_str)
...
function ScriptRconServer:_command_banlist()
	local result = ""
	local manager = Managers.ban_list
...
function ScriptRconServer:_command_help()
...
function ScriptRconServer:_command_id()
	return string.format("%s\n", Network.peer_id())
end

function ScriptRconServer:_command_kick(id_or_name)
...
function ScriptRconServer:_command_players()
	local player_list = ""
...
function ScriptRconServer:_command_say(...)
...
function ScriptRconServer:_command_shutdown()
	Application.quit()
	return string.format("%s\n", tr("rcon_server_command_response_shutting_down"))
end

function ScriptRconServer:_command_status()
...
function ScriptRconServer:_command_unban(id_or_name)
