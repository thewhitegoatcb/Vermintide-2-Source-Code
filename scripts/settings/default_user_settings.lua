...
local default_user_settings = { gamepad_left_handed = false, gamepad_auto_aim_enabled = true, play_intro_cinematic = true, gamepad_look_invert_y = false, tutorials_enabled = true, mouse_look_invert_y = false, master_bus_volume = 100, vsync = true, enable_gamepad_acceleration = true, root_scale_y = 1, always_ask_hero_when_joining = false, enabled_crosshairs = "all", max_fps = 0, sfx_bus_volume = 100, input_buffer = 0.5, borderless_fullscreen = false, dlss_enabled = false, hud_clamp_ui_scaling = false, voip_push_to_talk = true, overcharge_opacity = 100, use_subtitles = true, camera_shake = true, twitch_vote_time = 45, max_stacking_frames = -1, use_gamepad_hud_layout = "auto", adapter_index = 0, twitch_disable_positive_votes = "enable_positive_votes", max_quick_play_search_range = "far", double_tap_dodge = false, use_high_quality_fur = true, give_on_defend = true, use_alien_fx = false, gamepad_look_sensitivity_y = 0, gamepad_rumble_enabled = true, use_baked_enemy_meshes = false, sound_quality = "high", toggle_stationary_dodge = false, priority_input_buffer = 1, fullscreen = true, tobii_eyetracking = true, voice_bus_volume = 100, mouse_look_sensitivity = 0, twitch_spawn_amount = 1, social_wheel_gamepad_layout = "auto", tobii_extended_view_sensitivity = 50, sound_panning_rule = "speakers", tobii_clean_ui = true, tobii_extended_view_use_head_tracking = false, allow_occupied_hero_lobbies = true, write_network_debug_output_to_log = false, gamepad_zoom_sensitivity_y = 0, twitch_difficulty = 50, tobii_fire_at_gaze = true, max_upload_speed = 512, tobii_aim_at_gaze = true, deadlock_timeout = 15, use_custom_hud_scale = false, process_priority = "unchanged", fullscreen_minimize_on_alt_tab = true, weapon_scroll_type = "scroll_wrap", voip_is_enabled = true, screen_blood_enabled = true, profanity_check = false, twitch_disable_mutators = false, show_numerical_latency = false, toggle_crouch = false, social_wheel_delay = 0.12, double_tap_dodge_threshold = 0.25, hud_scale = 100, player_outlines = "on", ragdoll_enabled = true, tobii_extended_view = true, use_razer_chroma = false, friendly_fire_crosshair = true, language_id = "en", persistent_ammo_counter = false, friendly_fire_hit_marker = true, subtitles_font_size = 20, subtitles_background_opacity = 20, twitch_mutator_duration = 1, motion_sickness_misc_cam = "normal", gamepad_use_ps4_style_input_icons = false, fsr2_enabled = false, use_pc_menu_layout = false, gamepad_layout = "default", chat_enabled = true, root_scale_x = 1, small_network_packets = false, twitch_time_between_votes = 30, music_bus_volume = 100, toggle_alternate_attack = false, weapon_trails = "normal", mute_in_background = false, voip_bus_volume = 100, blood_enabled = true, gamepad_look_sensitivity = 0, motion_sickness_hit = "normal", motion_sickness_swing = "normal", dismemberment_enabled = true, head_bob = true, melee_camera_movement = true, numeric_ui = false, minion_outlines = "off", gamepad_zoom_sensitivity = 0, dynamic_range_sound = "high", chat_font_size = 20,
...
local default_render_settings = { lod_scatter_density = 1, local_probes_enabled = true, upscaling_mode = "none", fsr_quality = 4, sun_shadows = true, skin_material_enabled = false, eye_adaptation_speed = 1, fsr_enabled = false, lens_quality_enabled = false, sun_flare_enabled = false, lod_decoration_density = 1, dof_enabled = false, nv_framerate_cap = 0, taa_enabled = false, ssr_high_quality = false, light_shafts_enabled = false, dlss_g_enabled = false, fxaa_enabled = false, upscaling_quality = "none", lens_flares_enabled = false, ao_enabled = true, ao_high_quality = false, ssr_enabled = false, bloom_enabled = true, gamma = 2.2, lod_object_multiplier = 1, sharpen_enabled = false, nv_low_latency_boost = false, upscaling_enabled = false, motion_blur_enabled = true,
...
DefaultUserSettings = {
	...
	setup_resolution = function ()
		...
		if application_settings.auto_detect_video and not user_settings or safe_mode then
			...
			local resolution = { resolution [1], resolution [2], resolution [3] }
