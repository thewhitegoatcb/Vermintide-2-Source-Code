...
function BTSelector_berzerker:init(...)
	BTSelector_berzerker.super.init(self, ...)
	self._children = { }
end

function BTSelector_berzerker:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_berzerker:run(unit, blackboard, t, dt)
...
function BTSelector_berzerker:add_child(node)
