...
function StartGameWindowMutatorSummary:on_enter(params, offset)
...
function StartGameWindowMutatorSummary:create_ui_elements(params, offset)
...
function StartGameWindowMutatorSummary:on_exit(params)
...
function StartGameWindowMutatorSummary:update(dt, t)
...
function StartGameWindowMutatorSummary:post_update(dt, t)
	return end

function StartGameWindowMutatorSummary:_is_button_pressed(widget)
...
function StartGameWindowMutatorSummary:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowMutatorSummary:_handle_input(dt, t)
...
function StartGameWindowMutatorSummary:_update_selected_item_backend_id()
...
function StartGameWindowMutatorSummary:_present_item_by_backend_id(backend_id)
...
function StartGameWindowMutatorSummary:draw(dt)
...
function StartGameWindowMutatorSummary:_play_sound(event)
