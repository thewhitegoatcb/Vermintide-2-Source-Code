...
function template.create_widget_definition(scenegraph_id)
	...
	return {
		...
		content = { icon = "icon_property_stamina", text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", icon_pulse = "icon_property_stamina",
		...
		style = {
			...
			frame = { horizontal_alignment = "center", vertical_alignment = "center",
				area_size = { 50, 50 },
				default_size = { 50, 50 },
				frame_margins = { -frame_height, -frame_height },
...
function template.check_widget_visible(widget, vertical_pixel_overlap, horizontal_pixel_overlap)
	local style = widget.style
	local background_style = style.background
	local background_size = background_style.texture_size

	if
	horizontal_pixel_overlap and horizontal_pixel_overlap > background_size [1] * 0.5 then
		return false
	end

	if
	vertical_pixel_overlap and vertical_pixel_overlap > background_size [2] * 0.5 then
		return false
	end
