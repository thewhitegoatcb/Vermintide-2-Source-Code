...
local buff_order = { "skulls_2023_buff_power_level", "skulls_2023_buff_attack_speed", "skulls_2023_buff_crit_chance", "skulls_2023_buff_movement_speed", "skulls_2023_buff_cooldown_regen" }
...
settings.buff_templates = {
	skulls_2023_buff = {
		buffs = { { name = "skulls_2023_buff",


				max_stacks = MAX_STACKS },
			{ event = "on_kill", name = "skulls_2023_buff_kill_tracker", max_stacks = 1, buff_func = "on_kill_skulls_2023_buff" },





			{ name = "skulls_2023_buff_main", refresh_durations = true, duration_end_func = "cleanup_skulls_2023_buff", event = "on_knocked_down", remove_buff_func = "remove_skulls_2023_buff", apply_buff_func = "apply_skulls_2023_buff", buff_func = "dummy_function", remove_on_proc = true, max_stacks = 1, reapply_buff_func = "reapply_skulls_2023_buff",
	...
	skulls_2023_buff_power_level = {
		buffs = { { name = "skulls_2023_buff_power_level", multiplier = 0.15, stat_buff = "power_level", buff_func = "dummy_function", event = "on_knocked_down", refresh_durations = true, priority_buff = true, remove_on_proc = true, max_stacks = 1, icon = "potion_liquid_bravado",
	...
	skulls_2023_buff_attack_speed = {
		buffs = { { name = "skulls_2023_buff_attack_speed", multiplier = 0.12, stat_buff = "attack_speed", buff_func = "dummy_function", event = "on_knocked_down", refresh_durations = true, priority_buff = true, remove_on_proc = true, max_stacks = 1, icon = "grudge_mark_frenzy_debuff",
	...
	skulls_2023_buff_crit_chance = {
		buffs = { { name = "skulls_2023_buff_crit_chance", stat_buff = "critical_strike_chance", buff_func = "dummy_function", event = "on_knocked_down", refresh_durations = true, priority_buff = true, remove_on_proc = true, max_stacks = 1, icon = "bardin_slayer_crit_chance", bonus = 0.2,
	...
	skulls_2023_buff_movement_speed = {
		buffs = { { priority_buff = true, name = "skulls_2023_buff_movement_speed", icon = "mutator_skulls_movement_speed", buff_func = "dummy_function", event = "on_knocked_down", remove_buff_func = "remove_movement_buff", refresh_durations = true, multiplier = 1.2, apply_buff_func = "apply_movement_buff", remove_on_proc = true, max_stacks = 1,
	...
	skulls_2023_buff_cooldown_regen = {
		buffs = { { name = "skulls_2023_buff_cooldown_regen", multiplier = 0.25, stat_buff = "cooldown_regen", buff_func = "dummy_function", event = "on_knocked_down", refresh_durations = true, priority_buff = true, remove_on_proc = true, max_stacks = 1, icon = "mutator_skulls_cooldown_reduction",
	...
	skulls_2023_buff_refresh = {
		buffs = { { reset_on_max_stacks = true, name = "skulls_2023_buff_refresh", buff_func = "dummy_function", on_max_stacks_func = "skulls_2023_stack_refresh", icon = "buff_icon_mutator_icon_slayer_curse", event = "on_knocked_down", remove_on_proc = true,
	...
	skulls_2023_debuff = {
		buffs = { { priority_buff = true, name = "skulls_2023_debuff", icon = "grudge_mark_cursed_debuff", buff_func = "dummy_function", event = "on_knocked_down", remove_buff_func = "remove_skulls_2023_debuff", apply_buff_func = "apply_skulls_2023_debuff", refresh_durations = true, remove_on_proc = true, debuff = true,
			...
			{ name = "skulls_2023_debuff_dot", damage_percentage = 0.01, buff_func = "dummy_function", event = "on_knocked_down", refresh_durations = true, remove_on_proc = true, update_start_delay = 1, max_stacks = 1, update_func = "update_skulls_2023_debuff_dot", update_frequency = 1,
	...
	remove_skulls_2023_buff = function (unit, buff, params, world)
		...
		if end_t and end_t <= params.t then
			...
			for i = 1, num_buff_stacks do
				buff_system:add_buff_synced(unit, "skulls_2023_debuff", BuffSyncType.LocalAndServer, { external_optional_value = num_buff_stacks })
			end
		end
	end,
...
settings.stacking_buff_functions = {
	...
	skulls_2023_stack_refresh = function (owner_unit, sub_buff_template)
		if ALIVE [owner_unit] then
			local buff_system = Managers.state.entity:system("buff_system")
			buff_system:add_buff_synced(owner_unit, "skulls_2023_buff", BuffSyncType.LocalAndServer, { refresh_duration_only = true })
		end
	end }