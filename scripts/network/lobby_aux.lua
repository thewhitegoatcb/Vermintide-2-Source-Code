...
function LobbyAux.create_network_hash(config_file_name, project_hash, disable_print)
...
LobbyGameModes = { "adventure", "custom", "n/a", "tutorial", "event", "deed", "weave", "twitch" }
...
LobbyAux.map_lobby_distance_filter = IS_PS4 and { "close", "medium", "world" } or
...
function LobbyAux.get_next_lobby_distance_filter(current_filter, max_filter)
...
function LobbyAux.verify_lobby_data(lobby)
