...
settings.pickups = {
	potions = {
		beer_bottle = { only_once = true, item_description = "interaction_beer", spawn_weighting = 1e-06, debug_pickup_category = "consumables", pickup_sound_event = "pickup_potion", consumable_item = true, item_name = "wpn_beer_bottle", unit_name = "units/weapons/player/pup_ale/pup_ale", type = "inventory_item", slot_name = "slot_level_event", wield_on_pickup = true, local_pickup_sound = true, hud_description = "interaction_beer",
		...
		beer_bottle_unique = { only_once = true, item_description = "interaction_beer", spawn_weighting = 1e-06, debug_pickup_category = "consumables", pickup_sound_event = "pickup_potion", consumable_item = true, item_name = "wpn_beer_bottle", unit_name = "units/weapons/player/pup_ale/pup_ale", type = "inventory_item", slot_name = "slot_level_event", wield_on_pickup = true, local_pickup_sound = true, hud_description = "interaction_beer",
