...
local arrow_size = { 59, 31 }
local gotwf_item_size = { 260 * icon_scale, 250 * icon_scale }

local scenegraph_definition = {
	root = { is_root = true, size = { 1920, 1080 }, position = { 0, 0, UILayer.default } },
	black_background = { vertical_alignment = "bottom", horizontal_alignment = "center", scale = "fit_width", size = { 1920, 200 }, position = { 0, 0, UILayer.default } },
	black_background_fade = { vertical_alignment = "bottom", horizontal_alignment = "center", scale = "fit_width", size = { 1920, 200 }, position = { 0, 200, UILayer.default } },
	screen = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.default } },
	viewport = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center", size = { 800, 500 }, position = { 0, -115, 1 } },
	screen_top = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.item_display_popup } },
	screen_left = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "left", size = { 0, 0 }, position = { 0, 0, 1 } },
	screen_center = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center", size = { 1920, 1080 }, position = { 0, 0, 1 } },
	window = { vertical_alignment = "top", parent = "screen_center", horizontal_alignment = "left", size = window_size, position = { ( 1920 - window_size [1] ) * 0.5, ( 1080 - window_size [2] ) * 0.5 * -1, 1 } },
	write_mask = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1], window_size [2] + 100 }, position = { 0, 0, 1 } },
	write_mask_left = { vertical_alignment = "bottom", parent = "write_mask", horizontal_alignment = "left", size = { 50, 400 }, position = { -25, 0, 1 } },
	write_mask_right = { vertical_alignment = "bottom", parent = "write_mask", horizontal_alignment = "right", size = { 50, 400 }, position = { 25, 0, 1 } },
	scrollbar_area = { vertical_alignment = "bottom", parent = "write_mask", horizontal_alignment = "center", size = { window_size [1], gotwf_item_size [2] + 70 }, position = { 0, 100, 50 } },

	window_anchor = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", position = { 0, -350, 2 } },
	gotwf_logo_foreground = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { 460.8, 527.2 }, position = { -650, 10, 1 } },
	gotwf_logo_flag = { vertical_alignment = "top", parent = "gotwf_logo_foreground", horizontal_alignment = "center", size = { 407.20000000000005, 572.8000000000001 }, position = { 8, -40, 0 } },
	gotwf_logo_banner_left = { vertical_alignment = "center", parent = "gotwf_logo_foreground", horizontal_alignment = "left", size = { 133.6, 201.60000000000002 }, position = { -37, -65, -2 } },
	gotwf_logo_banner_right = { vertical_alignment = "center", parent = "gotwf_logo_foreground", horizontal_alignment = "right", size = { 133.6, 201.60000000000002 }, position = { 50, -65, -2 } },
	gotwf_description = { vertical_alignment = "bottom", parent = "gotwf_logo_foreground", horizontal_alignment = "center", position = { 0, -240, 0 } },
	gotwf_window = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "left", size = { 1600, 250 }, position = { 0, 39, 2 } },
	gotwf_item_anchor = { parent = "gotwf_window", size = gotwf_item_size, position = { 0, 15, 0 } },
	arrow_left = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "left", size = { 100, 100 }, position = { -70, 115, 0 } },
	arrow_right = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "right", size = { 100, 100 }, position = { 70, 115, 0 } },
	claim_button = { vertical_alignment = "bottom", parent = "gotwf_item_anchor", horizontal_alignment = "center", position = { 10, 25, 5 }, size = { gotwf_item_size [1], 60 } },

	lock_root = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center", size = { 1, 1 }, position = { 0, -1600, 10 } },

	lock_bg_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 167, 333 }, position = { 0, 0, 3 } },
	lock_bg_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "left", size = { 167, 333 }, position = { 167, 0, 3 } },

	lock_pillar_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 210, 231 }, position = { 1, 0, 1 } },
	lock_pillar_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 210, 231 }, position = { 210, 0, 1 } },

	lock_pillar_top = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "center", size = { 231, 212 }, position = { 1, 212, 1 } },
	lock_pillar_bottom = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "center", size = { 231, 212 }, position = { 0, 0, 1 } },

	lock_cogwheel_bg_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 170, 342 }, position = { 0, 0, 7 } },
	lock_cogwheel_bg_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 172, 342 }, position = { 172, 0, 7 } },

	lock_cogwheel_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 158, 316 }, position = { 0, 0, 6 } },
	lock_cogwheel_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 158, 316 }, position = { 158, 0, 6 } },

	lock_stick_top_left = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 125, 127 }, position = { 0, 127, 2 } },
	lock_stick_top_right = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 125, 127 }, position = { 125, 127, 2 } },
	lock_stick_bottom_left = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 125, 127 }, position = { 0, 0, 2 } },
	lock_stick_bottom_right = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 125, 127 }, position = { 125, 0, 2 } },

	lock_block_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 153, 149 }, position = { 0, 0, 5 } },
	lock_block_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "left", size = { 153, 149 }, position = { -153, 0, 5 } },

	lock_slot_holder_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "right", size = { 52, 303 }, position = { -1, 0, 4 } },
	lock_slot_holder_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "left", size = { 52, 303 }, position = { 0, 0, 4 } },

	lock_cover_top_left = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 142, 151 }, position = { 0, 151, 9 } },
	lock_cover_top_right = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 146, 152 }, position = { 146, 152, 9 } },
	lock_cover_bottom_left = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 141, 150 }, position = { 0, 0, 9 } },
	lock_cover_bottom_right = { vertical_alignment = "top", parent = "lock_root", horizontal_alignment = "right", size = { 146, 149 }, position = { 146, 0, 9 } },

	frame_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 116, 290 }, position = { 0, 0, 0 } },
	frame_bottom = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 116, 290 }, position = { 0, 0, 0 } },
	frame_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 116, 290 }, position = { 0, 0, 0 } },
	frame_top = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 116, 290 }, position = { 0, 0, 0 } },

	mask_left = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 120, 270 }, position = { 0, 5, 480 } },
	mask_right = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 120, 270 }, position = { 0, 5, 480 } },
	mask_top = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 260, 120 }, position = { 0, -5, 480 } },
	mask_bottom = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 260, 120 }, position = { 0, -5, 480 } },
	mask_center = { vertical_alignment = "center", parent = "lock_root", horizontal_alignment = "center", size = { 260, 260 }, position = { 0, 0, 480 } } }


local gotwf_description_text_style = { font_size = 32, upper_case = true, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local function create_simple_item(scenegraph_id, texture_name, size, offset, masked)
	...
	style [item_icon_name] = { vertical_alignment = "center", horizontal_alignment = "center",
		masked = masked,
		texture_size = size,
	...
	style [slot_background_frame_name] = { vertical_alignment = "center", horizontal_alignment = "center",
		masked = masked,
		texture_size = size,
	...
	style [rarity_texture_name] = { vertical_alignment = "center", horizontal_alignment = "center",
		masked = masked,
		texture_size = size,
...
local function create_item_definition_func(scenegraph_id, size, masked, index, current_reward, date, owned, hidden, expired, claimable, rewards)
	...
	local base_passes = { { style_id = "date_text", pass_type = "text", text_id = "date_text" },




		{ style_id = "date_text_shadow", pass_type = "text", text_id = "date_text" },
		...
		{ pass_type = "texture", style_id = "package_icon", texture_id = "package_icon",
	...
	local base_content = { loading_icon = "loot_loading", owned_icon_bg = "store_owned_ribbon", owned_icon = "store_owned_sigil", masked_rect = "rect_masked", rect = "store_thumbnail_bg_plentiful", package_icon = "store_package",
	...
	local base_style = {
		date_text = { font_size = 32, upper_case = true, localize = false, horizontal_alignment = "center", vertical_alignment = "bottom", dynamic_font_size = false,
			...
			offset = { 0, -20 - (( current_reward or claimable ) and not owned and current_reward_offset or 0), 10 } },

		date_text_shadow = { font_size = 32, upper_case = true, localize = false, horizontal_alignment = "center", vertical_alignment = "bottom", dynamic_font_size = false,
			...
			offset = { 2, -22 - (( current_reward or claimable ) and not owned and current_reward_offset or 0), 9 } },
		...
		loading_icon = { vertical_alignment = "top", horizontal_alignment = "left", masked = true, angle = 0,
			...
			color = { 255, 255, 255, 255 },
			offset = { size [1] * 0.5 - 50, -50, 8 },
			texture_size = { 100, 100 } },

		owned_icon = { vertical_alignment = "bottom", horizontal_alignment = "right",
			masked = masked,
			...
			color = { 255, 255, 255, 255 },
			offset = { 2, 20, 12 + 16 * (num_rewards - 1) },
			default_offset = { 5, 20, 12 + 16 * (num_rewards - 1) } },

		owned_icon_bg = { vertical_alignment = "bottom", horizontal_alignment = "right",
			masked = masked,
			...
			color = { 255, 255, 255, 255 },
			offset = { -10, -0, 11 + 16 * (num_rewards - 1) },
			default_offset = { 2, -45, 11 + 16 * (num_rewards - 1) } },

		package_icon = { vertical_alignment = "top", horizontal_alignment = "left",
			masked = masked,


			texture_size = size,
			color = { 255, icon_intensity, icon_intensity, icon_intensity },
			offset = { 0, 0, 7 } } }
	...
	for i = 1, num_rewards do
		local extra_offset = { ( i - 1 ) * extra_offset_value, ( i - 1 ) * -extra_offset_value, ( i - 1 ) * 15 }
		local size = { base_size [1] * size_multiplier, base_size [2] * size_multiplier }
		local item_passes = { { pass_type = "hotspot",

				content_id = "hotspot_" .. i,
				style_id = "hotspot_" .. i },
			{ pass_type = "texture", texture_id = "rect",
			...
			{ pass_type = "texture_frame", texture_id = "frame",


				style_id = "frame_" .. i },
			{ pass_type = "texture_frame", texture_id = "hover_frame",


				style_id = "hover_frame_" .. i },
			{ pass_type = "texture_frame", texture_id = "pulse_frame",
			...
			{ pass_type = "texture_frame", texture_id = "painting_frame",
		...
		local item_style = {
			["hotspot_" .. i] = {
				size = { gotwf_item_size [1] * size_multiplier, gotwf_item_size [2] },
				base_offset = { 0, 0, 0 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 0 + extra_offset [3] } },

			["background_rect_" .. i] = { vertical_alignment = "top", horizontal_alignment = "left",
				masked = masked,
			...
			["background_" .. i] = { vertical_alignment = "top", horizontal_alignment = "left",
				masked = masked,
				...
				color = { 255, 255, 255, 255 },
				base_offset = { 0, 0, 1 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 1 + extra_offset [3] } },

			["overlay_" .. i] = { vertical_alignment = "top", horizontal_alignment = "left",
				masked = masked,
				...
				color = { 0, 5, 5, 5 },
				base_offset = { 0, 0, 8 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 8 + extra_offset [3] } },

			["type_tag_icon_" .. i] = { vertical_alignment = "top", horizontal_alignment = "left",
				masked = masked,


				texture_size = { 56, 56 },
				color = { 255, icon_intensity, icon_intensity, icon_intensity },
				base_offset = { size [1] - 56, 0, 9 },
				offset = { size [1] - 56 + extra_offset [1], 0 + extra_offset [2], 9 + extra_offset [3] } },

			["icon_" .. i] = { vertical_alignment = "top", horizontal_alignment = "left",
				masked = masked,
				...
				color = { 255, icon_intensity, icon_intensity, icon_intensity },
				base_offset = { 0, 0, 7 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 7 + extra_offset [3] } },

			["frame_" .. i] = { horizontal_alignment = "left", vertical_alignment = "top",
				masked = masked,
				...
				color = { 255, icon_intensity, icon_intensity, icon_intensity },
				base_offset = { 0, 0, 10 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 10 + extra_offset [3] } },

			["hover_frame_" .. i] = { horizontal_alignment = "left", vertical_alignment = "top",
				masked = masked,
				...
				color = { 0, 255, 255, 255 },
				base_offset = { 0, 0, 6 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 6 + extra_offset [3] } },

			["pulse_frame_" .. i] = { horizontal_alignment = "left", vertical_alignment = "top",
				masked = masked,
				...
				color = { 0, 255, 255, 255 },
				base_offset = { 0, 0, 12 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 12 + extra_offset [3] } },

			["painting_" .. i] = { vertical_alignment = "center", horizontal_alignment = "center",
				masked = masked,
			...
			["painting_frame_" .. i] = { horizontal_alignment = "center", vertical_alignment = "center",
				masked = masked,
				...
				frame_margins = { -painting_frame_spacing, -painting_frame_spacing },
				color = { 255, 255, 255, 255 },
				base_offset = { 0, 0, 12 },
				offset = { 0 + extra_offset [1], 0 + extra_offset [2], 12 + extra_offset [3] } } }
	...
	widget.content = content
	widget.style = style
	widget.offset = { 10 + ( index - 1 ) * (size [1] + gotwf_item_spacing), ( current_reward or claimable ) and not owned and current_reward_offset or 0, 5 }
	widget.scenegraph_id = scenegraph_id
	...
	return {
		element = {
			passes = { { style_id = "hotspot", pass_type = "hotspot", content_id = "hotspot" },
				...
				{ texture_id = "arrow", style_id = "arrow", pass_type = "rotated_texture" },



				{ texture_id = "arrow_hover", style_id = "arrow_hover", pass_type = "rotated_texture",
	...
	return {
		element = {
			passes = { { style_id = "frame", pass_type = "hotspot", content_id = "button_hotspot" },
				...
				{ style_id = "hover_frame", texture_id = "hover_frame", pass_type = "texture_frame",
		...
		content = { draw_frame = true, hover_glow = "button_state_default", glass = "button_glass_02", background_fade = "button_bg_fade", gamepad_selection_progress = 0,
			side_detail = {
				uvs = { { 1, 0 }, { 0, 1 } },
...
local background_widgets = {
	black_background = UIWidgets.create_simple_rect("black_background", { 255, 0, 0, 0 }),
	black_background_fade = UIWidgets.create_simple_texture("vertical_gradient", "black_background_fade", nil, nil, { 255, 0, 0, 0 }) }


local bottom_widgets = {
	bg_black = UIWidgets.create_simple_rect("screen", { 255, 0, 0, 0 }) }


local viewport_widgets = {
	frame_bg = UIWidgets.create_simple_texture("store_thumbnail_bg_plentiful", "viewport", true, nil, nil, 1),

	left_mask = UIWidgets.create_simple_texture("mask_rect", "mask_left", nil, nil, { 0, 255, 255, 255 }),
	right_mask = UIWidgets.create_simple_texture("mask_rect", "mask_right", nil, nil, { 0, 255, 255, 255 }),
	top_mask = UIWidgets.create_simple_texture("mask_rect", "mask_top", nil, nil, { 0, 255, 255, 255 }),
	bottom_mask = UIWidgets.create_simple_texture("mask_rect", "mask_bottom", nil, nil, { 0, 255, 255, 255 }),
	center_mask = UIWidgets.create_simple_texture("mask_rect", "mask_center", nil, nil, { 0, 255, 255, 255 }) }


local widgets = {
	arrow_left = create_arrow("achievement_arrow", "achievement_arrow_hover", math.pi * 0.5, { arrow_size [1] * 0.5, arrow_size [2] * 0.5 }, "arrow_left", false, { 255, 255, 255, 255 }, 0, { 0, 0, 0 }),
	arrow_right = create_arrow("achievement_arrow", "achievement_arrow_hover", -math.pi * 0.5, { arrow_size [1] * 0.5, arrow_size [2] * 0.5 }, "arrow_right", false, { 255, 255, 255, 255 }, 0, { 41, 0, 0 }),
	...
	write_mask = UIWidgets.create_simple_texture("mask_rect", "write_mask", false, false, { 255, 255, 255, 255 }, 0),
	left_fade_mask = UIWidgets.create_simple_texture("horizontal_gradient_mask", "write_mask_left", false, false, { 255, 255, 255, 255 }, 0),
	right_fade_mask = UIWidgets.create_simple_uv_texture("horizontal_gradient_mask", { { 1, 0 }, { 0, 1 } }, "write_mask_right", false, false, { 255, 255, 255, 255 }, 0) }


local lock_widgets = {
	lock_bg_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_11", 0, { 167, 166.5 }, "lock_bg_left"),
	lock_bg_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_11", math.pi, { 0, 166.5 }, "lock_bg_right"),

	lock_pillar_left = UIWidgets.create_simple_texture("dice_game_lock_part_13", "lock_pillar_left"),
	lock_pillar_right = UIWidgets.create_simple_uv_texture("dice_game_lock_part_13", { { 1, 0 }, { 0, 1 } }, "lock_pillar_right"),
	lock_pillar_top = UIWidgets.create_simple_texture("dice_game_lock_part_12", "lock_pillar_top"),
	lock_pillar_bottom = UIWidgets.create_simple_uv_texture("dice_game_lock_part_12", { { 0, 1 }, { 1, 0 } }, "lock_pillar_bottom"),

	lock_cogwheel_bg_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_05", 0, { 170, 171 }, "lock_cogwheel_bg_left"),
	lock_cogwheel_bg_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_06", 0, { 0, 171 }, "lock_cogwheel_bg_right"),

	lock_cogwheel_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_07", 0, { 158, 158 }, "lock_cogwheel_left"),
	lock_cogwheel_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_08", 0, { 0, 158 }, "lock_cogwheel_right"),

	lock_stick_top_left = UIWidgets.create_simple_texture("dice_game_lock_part_14", "lock_stick_top_left"),
	lock_stick_top_right = UIWidgets.create_simple_uv_texture("dice_game_lock_part_14", { { 1, 0 }, { 0, 1 } }, "lock_stick_top_right"),
	lock_stick_bottom_left = UIWidgets.create_simple_texture("dice_game_lock_part_15", "lock_stick_bottom_left"),
	lock_stick_bottom_right = UIWidgets.create_simple_uv_texture("dice_game_lock_part_15", { { 1, 0 }, { 0, 1 } }, "lock_stick_bottom_right"),
	...
	lock_block_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_09", 0, { 153, 74.5 }, "lock_block_left"),
	lock_block_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_09", math.pi, { 153, 74.5 }, "lock_block_right"),

	lock_slot_holder_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_10", 0, { 52, 151 }, "lock_slot_holder_left"),
	lock_slot_holder_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_part_10_02", 0, { 0, 151.5 }, "lock_slot_holder_right"),

	frame_right = UIWidgets.create_simple_rotated_texture("dice_game_lock_left_side", math.pi, { 58, 145 }, "frame_right"),
	frame_bottom = UIWidgets.create_simple_rotated_texture("dice_game_lock_left_side", -math.pi * 0.5, { 58, 145 }, "frame_bottom"),
	frame_left = UIWidgets.create_simple_rotated_texture("dice_game_lock_left_side", 0, { 58, 145 }, "frame_left"),
	frame_top = UIWidgets.create_simple_rotated_texture("dice_game_lock_left_side", -math.pi * 1.5, { 58, 145 }, "frame_top") }


local lock_open_time_multiplier = 0.5

local animation_definitions = {
	on_enter = { { name = "fade_in", start_progress = 0, end_progress = 0.7,
	...
	item_rotation = { { name = "item_rotation", start_progress = 0, end_progress = 0.5,
			...
			update = function (ui_scenegraph, scenegraph_definition, widgets, progress, params)
				...
				for index = start_index, #reward_order do
					...
					local start_extra_offset = { index * extra_offset_value, index * -extra_offset_value, index * 15 }
					local extra_offset = { ( index - 1 ) * extra_offset_value, ( index - 1 ) * -extra_offset_value, ( index - 1 ) * 15 }
	...
	hide_item_list = { { name = "hide_item_list", start_progress = 0, end_progress = 0.3,
	...
	show_item_list = { { name = "show_item_list", start_progress = 0, end_progress = 0.3,
	...
	lock_close = { { name = "sticks_open", start_progress = 2.6, end_progress = 3.1,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "cover_open", start_progress = 1.8, end_progress = 2.4,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "top_and_bottom_pillar_lock", start_progress = 1.7, end_progress = 1.8,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "cogwheel_bg_spin", start_progress = 1.2, end_progress = 1.6,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "cogwheel_spin", start_progress = 0.1, end_progress = 1.1,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "left_and_right_pillar_lock", start_progress = 0, end_progress = 0.1,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "finalize", start_progress = 3, end_progress = 3.5,
	...
	reveal_instant = { { name = "reveal_instant", start_progress = 0, end_progress = 0,
	...
	hide_instant = { { name = "hide_instant", start_progress = 0, end_progress = 0,
...
local generic_input_actions = {
	default = { { input_action = "d_horizontal", priority = 1, description_text = "input_description_navigate", ignore_keybinding = true },
	...
	multiple_rewards = { { input_action = "d_horizontal", priority = 1, description_text = "input_description_navigate", ignore_keybinding = true },





		{ input_action = "special_1", priority = 2, description_text = "input_description_toggle" },
	...
	claim_available = { { input_action = "d_horizontal", priority = 1, description_text = "input_description_navigate", ignore_keybinding = true },





		{ input_action = "confirm", priority = 2, description_text = "welcome_currency_popup_button_claim" },
...
return {
	gotwf_item_size = { gotwf_item_size [1] + gotwf_item_spacing, gotwf_item_size [2] },
