...
function BTCirclePreyAction:init(...)
	BTCirclePreyAction.super.init(self, ...)
end

BTCirclePreyAction.name = "BTCirclePreyAction"

function BTCirclePreyAction:enter(unit, blackboard, t)
...
function BTCirclePreyAction:leave(unit, blackboard, t, reason, destroy)
...
function BTCirclePreyAction:run(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
...
function BTCirclePreyAction:get_new_goal(unit, blackboard)
...
function BTCirclePreyAction:move_to_goal(unit, blackboard, goal_position)
...
function BTCirclePreyAction:stop(unit, blackboard)
