...
local layout_editable_keys = { { type = "FLOAT", key = "SPRING_CONSTANT" },



	{ type = "FLOAT", key = "FORCE_MAX" },



	{ type = "FLOAT", key = "REPEL_CONSTANT" },



	{ type = "FLOAT", key = "DEFAULT_MASS" },



	{ type = "FLOAT", key = "START_MASS" },



	{ type = "FLOAT", key = "END_MASS" },



	{ type = "FLOAT", key = "NODE_SPEED" },



	{ type = "FLOAT", key = "DAMPING_FACTOR" },
...
local base_gen_editable_keys = { { type = "INT", key = "MAX_STRAIGHT_LINE" },



	{ type = "INT", key = "MAX_IDEAL_NODES" },



	{ type = "INT", key = "MIN_NODES" },



	{ type = "INT", key = "MAX_CONNECTIONS_PER_NODE" },



	{ type = "INT", key = "MAX_INCOMING_CONNECTIONS_PER_NODE" },



	{ type = "INT", key = "MAX_PATHS" } }
...
local RELOAD = true
function ImguiDeusMapBaseGen:init()
...
local GEN_STATE = { LAYOUT = 2, BASE_GEN = 1 }



function ImguiDeusMapBaseGen:update(t, dt)
	if RELOAD then
		self:_init_configs()
		RELOAD = false
	end
...
function ImguiDeusMapBaseGen:is_persistent()
	return false
end

function ImguiDeusMapBaseGen:_init_configs()
...
function ImguiDeusMapBaseGen:_reset_configs_for_journey()
...
function ImguiDeusMapBaseGen:draw(is_open)
	...
	if self._saved_graphs then
		...
		self._configs_changed = have_configs_changed(base_gen_editable_keys, self._base_config, self._original_base_config) or

		have_configs_changed(layout_editable_keys, self._layout_config, self._original_layout_config)
