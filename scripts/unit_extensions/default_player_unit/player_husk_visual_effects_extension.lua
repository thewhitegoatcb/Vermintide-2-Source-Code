...
function PlayerHuskVisualEffectsExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerHuskVisualEffectsExtension:extensions_ready(world, unit)
...
function PlayerHuskVisualEffectsExtension:destroy()
	return end

function PlayerHuskVisualEffectsExtension:update(unit, input, dt, context, t)
	self:_update_overcharge_thresholds()
	self:_set_overcharge_flow_values()
	self:_set_weapons_energy_drainable()
end

function PlayerHuskVisualEffectsExtension:_update_overcharge_thresholds()
...
function PlayerHuskVisualEffectsExtension:_set_overcharge_flow_values()
	local overcharge_extension = self.overcharge_extension
...
function PlayerHuskVisualEffectsExtension:_set_character_overcharge(value)
...
function PlayerHuskVisualEffectsExtension:_set_weapons_energy_drainable()
...
function PlayerHuskVisualEffectsExtension:_set_character_overcharge_threshold()
	local unit = self.unit
	local mesh_unit = self.third_person_mesh_unit
...
function PlayerHuskVisualEffectsExtension:_set_weapons_overcharge(value)
	local inventory_extension = self.inventory_extension
...
function PlayerHuskVisualEffectsExtension:_set_weapons_overcharge_threshold()
	local inventory_extension = self.inventory_extension
	local equipment = inventory_extension:equipment()
