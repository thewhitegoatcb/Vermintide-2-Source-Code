...
function GenericHuskInteractorExtension:init(extension_init_context, unit, extension_init_data)
...
function GenericHuskInteractorExtension:game_object_unit_destroyed()
...
function GenericHuskInteractorExtension:destroy()
	local interaction_context = self.interaction_context
	local interactable_unit = interaction_context.interactable_unit
...
function GenericHuskInteractorExtension:update(unit, input, dt, context, t)
...
function GenericHuskInteractorExtension:_stop_interaction(interactable_unit, t)
	local world = self.world
...
function GenericHuskInteractorExtension:stop_interaction(t)
	local interaction_context = self.interaction_context
	local interactable_unit = interaction_context.interactable_unit
...
function GenericHuskInteractorExtension:is_interacting()
	local interaction_context = self.interaction_context
	local interaction_type = interaction_context.interaction_type
	return self.state ~= "waiting_to_interact", interaction_type
end

function GenericHuskInteractorExtension:is_stopping()
	return self.state == "stopping_interaction"
end

function GenericHuskInteractorExtension:interactable_unit()
...
function GenericHuskInteractorExtension:hot_join_sync(peer_id)
...
function GenericHuskInteractorExtension:set_interaction_context(state, interaction_type, interactable_unit, start_time, duration)
...
function GenericHuskInteractorExtension:interaction_approved(interaction_type, interactable_unit)
...
function GenericHuskInteractorExtension:interaction_completed(interaction_result)
