...
function BTCastMissileAction:init(...)
	BTCastMissileAction.super.init(self, ...)
end

function BTCastMissileAction:enter(unit, blackboard, t)
...
function BTCastMissileAction:leave(unit, blackboard, t, reason, destroy)
...
function BTCastMissileAction:run(unit, blackboard, t, dt)
...
function BTCastMissileAction:launch_projectile(blackboard, action, initial_position, target_dir, angle, speed, owner_unit, target_unit)
	...
	local extension_init_data = {
		...
		projectile_impact_system = { server_side_raycast = true, collision_filter = "filter_enemy_ray_projectile",


			owner_unit = owner_unit },

		projectile_system = { impact_template_name = "explosion_impact",
			damage_source = damage_source,

			owner_unit = owner_unit },

		area_damage_system = { area_damage_template = "sorcerer_area_dot_damage", invisible_unit = false, area_ai_random_death_template = "area_poison_ai_random_death", damage_players = true,
...
function BTCastMissileAction:launch_magic_missile(blackboard, action, position, target_dir, angle, speed, owner_unit, target_unit, position_target, missile_data)
	...
	local extension_init_data = {
		projectile_locomotion_system = { trajectory_template_name = "throw_trajectory", gravity_settings = "arrows",
			angle = angle,
			speed = speed,
		...
		projectile_system = { impact_template_name = "direct_impact",

			owner_unit = owner_unit,
			damage_source = damage_source,
			explosion_template_name = missile_data.explosion_template_name or "chaos_magic_missile" },

		projectile_impact_system = { collision_filter = "filter_enemy_ray_projectile", server_side_raycast = true,
