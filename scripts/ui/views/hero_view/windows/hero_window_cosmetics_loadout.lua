...
function HeroWindowCosmeticsLoadout:on_enter(params, offset)
...
function HeroWindowCosmeticsLoadout:create_ui_elements(params, offset)
...
function HeroWindowCosmeticsLoadout:on_exit(params)
...
function HeroWindowCosmeticsLoadout:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCosmeticsLoadout:post_update(dt, t)

	return end

function HeroWindowCosmeticsLoadout:_update_animations(dt)
...
function HeroWindowCosmeticsLoadout:_is_button_pressed(widget)
...
function HeroWindowCosmeticsLoadout:_handle_input(dt, t)
...
function HeroWindowCosmeticsLoadout:_update_selected_cosmetic_slot_index()
...
function HeroWindowCosmeticsLoadout:_update_loadout_sync()
	local parent = self.parent
...
function HeroWindowCosmeticsLoadout:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCosmeticsLoadout:draw(dt)
...
function HeroWindowCosmeticsLoadout:_play_sound(event)
	self.parent:play_sound(event)
end



function HeroWindowCosmeticsLoadout:_setup_slot_icons()
...
function HeroWindowCosmeticsLoadout:_populate_loadout()
...
function HeroWindowCosmeticsLoadout:_equip_item_presentation(item, slot)
...
function HeroWindowCosmeticsLoadout:_is_equipment_slot_pressed()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadout:_is_equipment_slot_hovered()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadout:_set_equipment_slot_selected(column_index)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadout:_is_equipment_slot_hovered_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowCosmeticsLoadout:_highlight_equipment_slot_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
	local style = widget.style
