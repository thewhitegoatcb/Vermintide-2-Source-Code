...
function StateTitleScreenInitNetwork:_init_network()
...
function StateTitleScreenInitNetwork:_create_session()
	local auto_join_setting = Development.parameter("auto_join")
...
function StateTitleScreenInitNetwork:_creating_session_host(dt, t)
...
function StateTitleScreenInitNetwork:_join_session(dt, t)
	self._lobby_host:update(dt)
...
function StateTitleScreenInitNetwork:_update_host_lobby(dt, t)
...
function StateTitleScreenInitNetwork:_update_lobby_client(dt, t)
	Managers.level_transition_handler:update()
...
function StateTitleScreenInitNetwork:_update_lobby_join(dt, t)
...
function StateTitleScreenInitNetwork:_error(dt, t)
...
function StateTitleScreenInitNetwork:on_exit(application_shutdown)
...
function StateTitleScreenInitNetwork:_packages_loaded()
	local level_transition_handler = Managers.level_transition_handler
