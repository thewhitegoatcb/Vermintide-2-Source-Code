return { description = "weaves_heavens_mutator_desc", display_name = "weaves_heavens_mutator_name", icon = "mutator_icon_heavens_lightning",
	...
	server_start_function = function (context, data)
		...
		data.extension_init_data = {
			area_damage_system = { explosion_template_name = "lightning_strike" } }
