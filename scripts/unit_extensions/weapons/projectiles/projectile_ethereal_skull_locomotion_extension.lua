...
function ProjectileEtherealSkullLocomotionExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileEtherealSkullLocomotionExtension:update(unit, input, dt, context, t)
	self._moved = false
...
function ProjectileEtherealSkullLocomotionExtension:get_homing_movement(unit, base_position, t, dt)
...
function ProjectileEtherealSkullLocomotionExtension:get_patrol_movement(unit, base_position, t, dt)
...
function ProjectileEtherealSkullLocomotionExtension:get_spawn_traversal_movement(unit, base_position, t, dt)
...
function ProjectileEtherealSkullLocomotionExtension:set_movement(unit, current_base_position, new_base_position, game, id, t, dt)
	if not game and id then return end
	if not new_base_position then return
	end
...
function ProjectileEtherealSkullLocomotionExtension:set_knockback(attacker_unit, hit_dir, hit_pos, t)
...
function ProjectileEtherealSkullLocomotionExtension:set_rotation(unit, target_direction, game, id, dt)
	if not game and id then return
	end
...
function ProjectileEtherealSkullLocomotionExtension:get_vertical_offset(t)
	local spawn_time = self._spawn_time
	local lifetime = t - spawn_time
...
function ProjectileEtherealSkullLocomotionExtension:get_homing_target_direction(base_position)
...
function ProjectileEtherealSkullLocomotionExtension:set_target(target_unit, thrown)
...
function ProjectileEtherealSkullLocomotionExtension:get_target_node_position(unit)
...
function ProjectileEtherealSkullLocomotionExtension:has_target()
	return self._target_unit and Unit.alive(self._target_unit)
end

function ProjectileEtherealSkullLocomotionExtension:moved_this_frame()
	return not self._stopped and self._moved
end

function ProjectileEtherealSkullLocomotionExtension:destroy()
	self._stopped = true
...
function ProjectileEtherealSkullLocomotionExtension:stop()
	self._stopped = true
end