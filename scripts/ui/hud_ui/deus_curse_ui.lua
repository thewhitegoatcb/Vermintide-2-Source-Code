...
function DeusCurseUI:init(parent, ingame_ui_context)
...
function DeusCurseUI:create_ui_elements()
...
function DeusCurseUI:update(dt, t)
...
function DeusCurseUI:on_timer_ended()
...
function DeusCurseUI:show_special_message(theme, name, description, duration)
...
function DeusCurseUI:show_curse_info(theme, curse)
...
function DeusCurseUI:_update_description_widget(title_text, curse_name, curse_description, icon, color)
	...
	local text_height = UIUtils.get_text_height(self.ui_renderer, { text_background_width, 0 }, self._description_widget.style.area_text_style, curse_description)
...
function DeusCurseUI:on_round_started()
	self._timer = self:_get_display_time()
end

function DeusCurseUI:draw(dt)
...
function DeusCurseUI:_start_animation(key, animation_name)
	local params = {
...
function DeusCurseUI:update_animations(dt)
