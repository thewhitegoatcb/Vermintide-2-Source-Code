...
local breed_additional_spawn_chance = { skaven_plague_monk = 0.05, chaos_raider = 0.1, chaos_marauder = 0.05, beastmen_bestigor = 0.2, chaos_berzerker = 0.05, skaven_clan_rat_with_shield = 0.05, skaven_stormfiend = 0.5, chaos_marauder_with_shield = 0.05, beastmen_minotaur = 0.5, chaos_fanatic = 0.05, skaven_clan_rat = 0.05, beastmen_ungor = 0.05, chaos_warrior = 0.2, skaven_rat_ogre = 0.5, beastmen_ungor_archer = 0.05, chaos_troll = 0.5, chaos_spawn = 0.5, skaven_storm_vermin_commander = 0.1, skaven_storm_vermin = 0.05, beastmen_gor = 0.05, skaven_storm_vermin_with_shield = 0.1 }
...
return { description = "curse_skulls_of_fury_desc", curse_package_name = "resource_packages/mutators/mutator_curse_skulls_of_fury", display_name = "curse_skulls_of_fury_name", icon = "deus_curse_khorne_01",
	...
	server_start_function = function (context, data)
		...
		data.extension_init_data = {
			buff_system = { breed = "n/a",
				...
				initial_buff_names = { buff_name } },

			area_damage_system = { explosion_template_name = "curse_skulls_of_fury_explosion" } }
