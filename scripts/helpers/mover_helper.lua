...
function MoverHelper.create_collision_state(unit, actor_name)
	local actor = Unit.actor(unit, actor_name)
	return { disable_reasons = { }, actor = actor }
end
...
function MoverHelper.set_active_mover(unit, mover_state, new_active_mover)
...
function MoverHelper.set_disable_reason(unit, mover_state, reason, new_state)
...
function MoverHelper.set_collision_disable_reason(unit, state_data, reason, new_state)
