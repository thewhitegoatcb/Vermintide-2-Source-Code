...
function StartGameWindowMutatorList:on_enter(params, offset)
...
function StartGameWindowMutatorList:create_ui_elements(params, offset)
...
function StartGameWindowMutatorList:_has_deed_items()
...
function StartGameWindowMutatorList:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowMutatorList")
	self.ui_animator = nil
end

function StartGameWindowMutatorList:update(dt, t)
...
function StartGameWindowMutatorList:post_update(dt, t)
	return end

function StartGameWindowMutatorList:_update_animations(dt)
...
function StartGameWindowMutatorList:_is_button_pressed(widget)
...
function StartGameWindowMutatorList:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowMutatorList:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowMutatorList:_handle_input(dt, t)
...
function StartGameWindowMutatorList:_update_selected_item_backend_id()
...
function StartGameWindowMutatorList:_present_item_by_backend_id(backend_id)
...
function StartGameWindowMutatorList:draw(dt)
...
function StartGameWindowMutatorList:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowMutatorList:_update_game_options_hover_effect()
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowMutatorList:_on_option_button_hover_enter(widget, index, instant)
...
function StartGameWindowMutatorList:_on_option_button_hover_exit(widget, index, instant)
...
function StartGameWindowMutatorList:_create_style_animation_enter(widget, target_value, style_id, widget_index, instant)
...
function StartGameWindowMutatorList:_create_style_animation_exit(widget, target_value, style_id, widget_index, instant)
	local widget_style = widget.style
	local pass_style = widget_style [style_id]
	if not pass_style then
		return
...
function StartGameWindowMutatorList:_animate_pulse(target, target_index, from, to, speed)
	local new_animation = UIAnimation.init(UIAnimation.pulse_animation, target, target_index, from, to, speed)
	return new_animation
end

function StartGameWindowMutatorList:_animate_element_by_time(target, target_index, from, to, time)
