...
function DeusArenaIdolExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
	self._world = extension_init_context.world
end

function DeusArenaIdolExtension:destroy()
	return end

function DeusArenaIdolExtension:on_local_player_game_starts()
