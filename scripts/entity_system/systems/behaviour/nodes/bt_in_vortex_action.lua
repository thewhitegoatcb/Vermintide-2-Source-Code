...
function BTInVortexAction:init(...)
	BTInVortexAction.super.init(self, ...)
end

BTInVortexAction.name = "BTInVortexAction"

function BTInVortexAction:enter(unit, blackboard, t)
...
function BTInVortexAction:leave(unit, blackboard, t, reason, destroy)
	if not destroy then
...
function BTInVortexAction:run(unit, blackboard, t, dt)
