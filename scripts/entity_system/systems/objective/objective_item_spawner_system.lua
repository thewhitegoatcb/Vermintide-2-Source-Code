...
function ObjectiveItemSpawnerSystem:init(entity_system_creation_context, system_name, extensions)
...
function ObjectiveItemSpawnerSystem:item_gizmo_spawned(unit)
...
function ObjectiveItemSpawnerSystem:_get_unit_template(unit)
	fassert(false, "'_get_unit_template' needs to be overwritten in child")
end

function ObjectiveItemSpawnerSystem:spawn_items(spawn_ids)
...
function ObjectiveItemSpawnerSystem:_trigger_spawn(item_spawner_data, objective_id, objective_data)
...
function ObjectiveItemSpawnerSystem:_spawn_unit(item_spawner_template, extension_init_data, position, rotation)
...
function ObjectiveItemSpawnerSystem:destroy_objective(objective_id)
