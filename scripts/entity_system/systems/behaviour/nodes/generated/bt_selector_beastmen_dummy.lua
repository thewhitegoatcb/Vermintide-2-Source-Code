...
function BTSelector_beastmen_dummy:init(...)
	BTSelector_beastmen_dummy.super.init(self, ...)
	self._children = { }
end

function BTSelector_beastmen_dummy:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_beastmen_dummy:run(unit, blackboard, t, dt)
...
function BTSelector_beastmen_dummy:add_child(node)
