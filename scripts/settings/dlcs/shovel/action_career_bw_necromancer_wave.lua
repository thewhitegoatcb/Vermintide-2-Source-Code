...
function ActionCareerBWNecromancerWave:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerBWNecromancerWave:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerBWNecromancerWave:client_owner_post_update(dt, t, world, can_damage, current_time_in_action)
	return end

function ActionCareerBWNecromancerWave:finish(reason)
	self._inventory_extension:wield_previous_non_level_slot()
end

function ActionCareerBWNecromancerWave:_spawn_wave(position, direction)
...
function ActionCareerBWNecromancerWave:_play_vo()
