...
function BTTransformAction:init(...)
	BTTransformAction.super.init(self, ...)
end

BTTransformAction.name = "BTTransformAction"

function BTTransformAction:enter(unit, blackboard, t)
...
function BTTransformAction:leave(unit, blackboard, t, reason, destroy)
...
function BTTransformAction:run(unit, blackboard, t, dt)
...
function BTTransformAction:anim_cb_transform_finished(unit, blackboard)
	blackboard.transform_anim_finished = true
end

function BTTransformAction:transform(unit, blackboard)
	local action = blackboard.action
