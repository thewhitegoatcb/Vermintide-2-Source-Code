...
function HeroWindowCharacterPreview:on_enter(params, offset)
...
function HeroWindowCharacterPreview:create_ui_elements(params, offset)
...
function HeroWindowCharacterPreview:on_exit(params)
...
function HeroWindowCharacterPreview:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCharacterPreview:post_update(dt, t)
...
function HeroWindowCharacterPreview:respawn_hero()
...
function HeroWindowCharacterPreview:_update_animations(dt)
...
function HeroWindowCharacterPreview:_update_loadout_sync()
...
function HeroWindowCharacterPreview:_update_skin_sync()
	local parent = self.parent
...
function HeroWindowCharacterPreview:_update_wielded_slot()
	local parent = self.parent
...
function HeroWindowCharacterPreview:_populate_loadout()
	local world_previewer = self.world_previewer
...
function HeroWindowCharacterPreview:_is_button_pressed(widget)
...
function HeroWindowCharacterPreview:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function HeroWindowCharacterPreview:_handle_input(dt, t)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowCharacterPreview:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCharacterPreview:draw(dt)
...
function HeroWindowCharacterPreview:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowCharacterPreview:_update_loading_overlay_fadeout_animation(dt)
...
function HeroWindowCharacterPreview:_handle_statistics_pressed()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowCharacterPreview:_statistics_activate()
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.detailed
	return widget.content.active
end

function HeroWindowCharacterPreview:_activate_statistics()
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.detailed
...
function HeroWindowCharacterPreview:_sync_statistics()
...
function HeroWindowCharacterPreview:_deactivate_statistics()
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.detailed
...
function HeroWindowCharacterPreview:_update_statistics_widget(input_service, dt)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.detailed
...
function HeroWindowCharacterPreview:_populate_statistics(layout)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.detailed
...
function HeroWindowCharacterPreview:_setup_tab_scrollbar(widget)
	local detailed_button_size = scenegraph_definition.detailed_button.size
	local detailed_list_size = scenegraph_definition.detailed_list.size
...
function HeroWindowCharacterPreview:_show_weapon_disclaimer(should_show)
