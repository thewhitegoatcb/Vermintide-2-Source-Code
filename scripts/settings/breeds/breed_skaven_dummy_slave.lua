local breed_data = { not_bot_target = true, horde_behavior = "SET_TO_NIL", target_selection = "pick_no_targets", behavior = "dummy_clan_rat", horde_target_selection = "SET_TO_NIL", passive_in_patrol = false, race = "skaven", no_autoaim = true, perception = "perception_no_seeing", debug_spawn_category = "Misc" }
