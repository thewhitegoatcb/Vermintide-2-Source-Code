...
function ShadowFlareExtension:init(extension_init_context, unit, extension_init_data)
...
function ShadowFlareExtension:flare_active()
	return not self._flare_done
end

function ShadowFlareExtension:set_flare_done()
	self._flare_done = true
end

function ShadowFlareExtension:update(unit, dt)
...
function ShadowFlareExtension:delete_with_delay(unit, dt)
