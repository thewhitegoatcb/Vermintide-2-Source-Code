...
function UnitSynchronizationExtension:init(extension_init_context, unit, extension_init_data)
...
function UnitSynchronizationExtension:update(unit, input, dt, context, t)
...
function UnitSynchronizationExtension:_server_sync_position_rotation(dt, t)
...
function UnitSynchronizationExtension:_client_validate_position_rotation(dt, t)
	local game = Managers.state.network:game()
	if game then
