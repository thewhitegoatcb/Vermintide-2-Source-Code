...
function BTPackMasterEscortRatOgreAction:init(...)
	BTPackMasterEscortRatOgreAction.super.init(self, ...)
end

function BTPackMasterEscortRatOgreAction:enter(unit, blackboard, t)
...
function BTPackMasterEscortRatOgreAction:leave(unit, blackboard, t, reason, destroy)
	Managers.state.network:anim_event(unit, "move_fwd")
end

function BTPackMasterEscortRatOgreAction:run(unit, blackboard, t, dt)
