...
function ActionHealingDraught:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionHealingDraught:client_owner_start_action(new_action, t)
	ActionHealingDraught.super.client_owner_start_action(self, new_action, t)
	self.current_action = new_action
end

function ActionHealingDraught:client_owner_post_update(dt, t, world, can_damage)

	return end

function ActionHealingDraught:finish(reason)
