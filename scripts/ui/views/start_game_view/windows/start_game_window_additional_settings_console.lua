...
function StartGameWindowAdditionalSettingsConsole:on_enter(params, offset, parent_window_name)
...
function StartGameWindowAdditionalSettingsConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowAdditionalSettingsConsole:create_ui_elements(definitions, params, offset)
...
function StartGameWindowAdditionalSettingsConsole:_set_additional_options_enabled_state(enabled)
...
function StartGameWindowAdditionalSettingsConsole:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowAdditionalSettingsConsole")
	self.ui_animator = nil
end

function StartGameWindowAdditionalSettingsConsole:set_focus(focused)
...
function StartGameWindowAdditionalSettingsConsole:update(dt, t)
...
function StartGameWindowAdditionalSettingsConsole:post_update(dt, t)
	return end

function StartGameWindowAdditionalSettingsConsole:_update_animations(dt)
...
function StartGameWindowAdditionalSettingsConsole:_is_button_released(widget)
...
function StartGameWindowAdditionalSettingsConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowAdditionalSettingsConsole:_is_button_hover(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.is_hover
end

function StartGameWindowAdditionalSettingsConsole:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowAdditionalSettingsConsole:_is_other_option_button_selected(widget, current_option)
...
function StartGameWindowAdditionalSettingsConsole:_handle_input_index(index_increment)
	...
	repeat
		...
		if not widget_name then
			...
			if not widget.content.button_hotspot.disable_button then
				self._input_index = input_index end end until


	self._input_index == input_index
end

function StartGameWindowAdditionalSettingsConsole:_handle_gamepad_input(dt, t, input_service)
...
function StartGameWindowAdditionalSettingsConsole:_handle_mouse_input(dt, t, input_service)
...
function StartGameWindowAdditionalSettingsConsole:_handle_input(dt, t)
...
function StartGameWindowAdditionalSettingsConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowAdditionalSettingsConsole:_update_additional_options()
	local parent = self.parent
...
function StartGameWindowAdditionalSettingsConsole:draw(dt)
...
function StartGameWindowAdditionalSettingsConsole:_handle_gamepad_activity()
