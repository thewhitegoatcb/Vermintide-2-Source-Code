...
function BTSelector_skaven_warpfire_thrower:init(...)
	BTSelector_skaven_warpfire_thrower.super.init(self, ...)
	self._children = { }
end

function BTSelector_skaven_warpfire_thrower:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_skaven_warpfire_thrower:run(unit, blackboard, t, dt)
...
function BTSelector_skaven_warpfire_thrower:add_child(node)
