...
function ActionInteraction:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionInteraction:client_owner_start_action(new_action, t)
...
function ActionInteraction:client_owner_post_update(dt, t, world, can_damage)
	return end

function ActionInteraction:finish(reason)
