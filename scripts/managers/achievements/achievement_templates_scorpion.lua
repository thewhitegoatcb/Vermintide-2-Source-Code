...
local seasonal_list_of_weaves_from_to = {
	tier_1 = { from = 1, to = 40 },
	tier_2 = { from = 41, to = 80 },
	tier_3 = { from = 81, to = 120 },
	tier_4 = { to = 160, from = 121, disable_for_seasons = { 2, 3 } } }
...
for season_id = season_offset, season_num do
	...
	for tier, tbl in pairs(seasonal_list_of_weaves_from_to) do
		...
		if not disable_for_seasons or not table.contains(disable_for_seasons, season_id) then
			...
			local from = tbl.from
			local to = tbl.to
			AchievementTemplates.achievements [id] = { required_dlc = "scorpion",

				name = "achv_scorpion_" .. tier .. "_seasonal_name",
				desc = "achv_scorpion_" .. tier .. "_seasonal_desc",
				icon = "achievement_trophy_scorpion_" .. tier .. "_season_" .. season_id, disable_on_consoles = season_id ~= season_num,
	...
	AchievementTemplates.achievements [quickplay_achievement_id] = { ID_XB1 = 78, name = "achv_scorpion_complete_unranked_weaves_name", desc = "achv_scorpion_complete_unranked_weaves_desc", ID_PS4 = "077", icon = "achievement_trophy_scorpion_complete_unranked_weaves_season_2", required_dlc = "scorpion", disable_on_consoles = season_id ~= season_num,
...
AchievementTemplates.achievements.scorpion_bardin_reach_level_35 = { name = "achv_scorpion_bardin_reach_level_35_name", icon = "achievement_trophy_scorpion_bardin_reach_level_35", desc = "achv_scorpion_bardin_reach_level_35_desc",
...
AchievementTemplates.achievements.scorpion_kerillian_reach_level_35 = { name = "achv_scorpion_kerillian_reach_level_35_name", icon = "achievement_trophy_scorpion_kerillian_reach_level_35", desc = "achv_scorpion_kerillian_reach_level_35_desc",
...
AchievementTemplates.achievements.scorpion_markus_reach_level_35 = { name = "achv_scorpion_markus_reach_level_35_name", icon = "achievement_trophy_scorpion_markus_reach_level_35", desc = "achv_scorpion_markus_reach_level_35_desc",
...
AchievementTemplates.achievements.scorpion_sienna_reach_level_35 = { name = "achv_scorpion_sienna_reach_level_35_name", icon = "achievement_trophy_scorpion_sienna_reach_level_35", desc = "achv_scorpion_sienna_reach_level_35_desc",
...
AchievementTemplates.achievements.scorpion_victor_reach_level_35 = { name = "achv_scorpion_victor_reach_level_35_name", icon = "achievement_trophy_scorpion_victor_reach_level_35", desc = "achv_scorpion_victor_reach_level_35_desc",
...
AchievementTemplates.achievements.scorpion_complete_helmgart_act_one_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_helmgart_act_one_cataclysm_name", icon = "achievement_trophy_scorpion_complete_act_one_cataclysm", desc = "achv_scorpion_complete_helmgart_act_one_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_helmgart_act_two_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_helmgart_act_two_cataclysm_name", icon = "achievement_trophy_scorpion_complete_act_two_cataclysm", desc = "achv_scorpion_complete_helmgart_act_two_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_helmgart_act_three_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_helmgart_act_three_cataclysm_name", icon = "achievement_trophy_scorpion_complete_act_three_cataclysm", desc = "achv_scorpion_complete_helmgart_act_three_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_skittergate_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_skittergate_cataclysm_name", icon = "achievement_trophy_scorpion_complete_skittergate_cataclysm", desc = "achv_scorpion_complete_skittergate_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_all_helmgart_levels_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_all_helmgart_levels_cataclysm_name", icon = "achievement_trophy_scorpion_complete_all_helmgart_levels_cataclysm", desc = "achv_scorpion_complete_all_helmgart_levels_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_bogenhafen_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_bogenhafen_cataclysm_name", required_dlc_extra = "bogenhafen", icon = "achievement_trophy_scorpion_complete_bogenhafen_cataclysm", desc = "achv_scorpion_complete_bogenhafen_cataclysm_desc",
...
AchievementTemplates.achievements.scorpion_complete_back_to_ubersreik_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_back_to_ubersreik_cataclysm_name", required_dlc_extra = "holly", icon = "achievement_trophy_scorpion_complete_back_to_ubersreik_cataclysm", desc = "achv_scorpion_complete_back_to_ubersreik_cataclysm_desc",
	...
	completed = function (statistics_db, stats_id)
		...
		if check_level_difficulty(statistics_db, stats_id, LevelSettings.magnus.level_id, diff) then count = count + 1 end
		if check_level_difficulty(statistics_db, stats_id, LevelSettings.cemetery.level_id, diff) then count = count + 1 end
		if check_level_difficulty(statistics_db, stats_id, LevelSettings.forest_ambush.level_id, diff) then count = count + 1
		end
		return count >= 3
	end,
	progress = function (statistics_db, stats_id)
	...
	requirements = function (statistics_db, stats_id)
		...
		return { { name = "level_name_magnus",

				completed = complete_holly_magnus }, { name = "level_name_cemetery",

				completed = complete_holly_cemetery }, { name = "level_name_forest_ambush",
...
AchievementTemplates.achievements.scorpion_complete_plaza_cataclysm = { required_dlc = "scorpion", name = "achv_scorpion_complete_plaza_cataclysm_name", required_dlc_extra = "holly", icon = "achievement_trophy_scorpion_complete_plaza_cataclysm", desc = "achv_scorpion_complete_plaza_cataclysm_desc",
	...
	completed = function (statistics_db, stats_id)
		...
		if check_level_difficulty(statistics_db, stats_id, LevelSettings.plaza.level_id, diff) then count = count + 1
		end
		return count >= 1
	end }
...
local wind_order = { "life", "metal", "heavens", "light", "death", "beasts", "shadow", "fire" }
...
for i = 1, #wind_order do
	...
	AchievementTemplates.achievements [id] = { required_dlc = "scorpion",
		...
		progress = function (statistics_db, stats_id)
			...
			return { count, num_weaves_per_wind }
		end }
end
...
AchievementTemplates.achievements.scorpion_complete_unranked_weaves = { ID_XB1 = 78, name = "achv_scorpion_complete_unranked_weaves_name", required_dlc = "scorpion", icon = "icons_placeholder", ID_PS4 = "077", desc = "achv_scorpion_complete_unranked_weaves_desc",
...
AchievementTemplates.complete_weaves_list = { 5, 10, 15, 20, 25, 30, 35, 40, 80, 120 }
AchievementTemplates.xbox_achievement_ids = { nil, nil, nil, 79, nil, nil, nil, 80, 81 }
AchievementTemplates.ps4_achievement_ids = { nil, nil, nil, "078", nil, nil, nil, "079", "080" }
...
for i, weave_number in ipairs(AchievementTemplates.complete_weaves_list) do
	...
	AchievementTemplates.achievements [id] = { required_dlc = "scorpion",
		...
		progress = function (statistics_db, stats_id)
			...
			if not IS_WINDOWS then
				do return { count, weave_number } end
			else
...
AchievementTemplates._list_of_weaves_from_to = { weaves_9 = { from = 41, to = 60 }, weaves_10 = { from = 61, to = 80 }, weaves_11 = { from = 81, to = 120 } }
	...
	for career_index, career in pairs(SPProfiles [profile_index].careers) do
		...
		AchievementTemplates.achievements [id] = { required_dlc = "scorpion",
			...
			progress = function (statistics_db, stats_id)
				...
				return { completed, amount_of_weaves }
			end }
		...
		AchievementTemplates.achievements [id] = { required_dlc = "scorpion",
			...
			progress = function (statistics_db, stats_id)
				...
				return { amount_finished, total_winds }
			end }
	end
end
...
AchievementTemplates.achievements.scorpion_weaves_life_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_life_season_1_name", icon = "achievement_trophy_scorpion_weaves_life_season_1", desc = "achv_scorpion_weaves_life_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_heavens_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_heavens_season_1_name", display_completion_ui = true, icon = "achievement_trophy_scorpion_weaves_heavens_season_1", desc = "achv_scorpion_weaves_heavens_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_death_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_death_season_1_name", icon = "achievement_trophy_scorpion_weaves_death_season_1", desc = "achv_scorpion_weaves_death_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_beasts_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_beasts_season_1_name", icon = "achievement_trophy_scorpion_weaves_beasts_season_1", desc = "achv_scorpion_weaves_beasts_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_light_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_light_season_1_name", icon = "achievement_trophy_scorpion_weaves_light_season_1", desc = "achv_scorpion_weaves_light_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_fire_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_fire_season_1_name", display_completion_ui = true, icon = "achievement_trophy_scorpion_weaves_fire_season_1", desc = "achv_scorpion_weaves_fire_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_shadow_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_shadow_season_1_name", icon = "achievement_trophy_scorpion_weaves_shadow_season_1", desc = "achv_scorpion_weaves_shadow_season_1_desc",
...
AchievementTemplates.achievements.scorpion_weaves_metal_season_1 = { required_dlc = "scorpion", name = "achv_scorpion_weaves_metal_season_1_name", display_completion_ui = true, icon = "achievement_trophy_scorpion_weaves_metal_season_1",
...
AchievementTemplates.achievements.elven_ruins_align_leylines_timed_cata = { required_dlc = "scorpion", name = "achv_elven_ruins_align_leylines_timed_cata_name", display_completion_ui = true, icon = "achievement_trophy_elven_ruins_align_leylines_timed_cata",
...
AchievementTemplates.achievements.farmlands_rescue_prisoners_timed_cata = { required_dlc = "scorpion", name = "achv_farmlands_rescue_prisoners_timed_cata_name", display_completion_ui = true, icon = "achievement_trophy_farmlands_rescue_prisoners_timed_cata",
...
AchievementTemplates.achievements.military_kill_chaos_warriors_in_event_cata = { required_dlc = "scorpion", name = "achv_military_kill_chaos_warriors_in_event_cata_name", display_completion_ui = true, icon = "achievement_trophy_military_kill_chaos_warriors_in_event_cata",
...
AchievementTemplates.achievements.ground_zero_burblespew_tornado_enemies_cata = { required_dlc = "scorpion", name = "achv_ground_zero_burblespew_tornado_enemies_cata_name", display_completion_ui = true, icon = "achievement_trophy_ground_zero_burblespew_tornado_enemies_cata",
...
AchievementTemplates.achievements.fort_kill_enemies_cannonball_cata = { required_dlc = "scorpion", name = "achv_fort_kill_enemies_cannonball_cata_name", display_completion_ui = true, icon = "achievement_trophy_fort_kill_enemies_cannonball_cata",
...
AchievementTemplates.achievements.nurgle_player_showered_in_pus_cata = { required_dlc = "scorpion", name = "achv_nurgle_player_showered_in_pus_cata_name", display_completion_ui = true, icon = "achievement_trophy_nurgle_player_showered_in_pus",
...
AchievementTemplates.achievements.bell_destroy_bell_flee_timed_cata = { required_dlc = "scorpion", name = "achv_bell_destroy_bell_flee_timed_cata_name", display_completion_ui = true, icon = "achievement_trophy_bell_destroy_bell_flee_timed_cata",
...
AchievementTemplates.achievements.catacombs_stay_inside_ritual_pool_cata = { required_dlc = "scorpion", name = "achv_catacombs_stay_inside_ritual_pool_cata_name", display_completion_ui = true, icon = "achievement_trophy_catacombs_stay_inside_ritual_pool_cata",
...
AchievementTemplates.achievements.mines_kill_final_troll_timed_cata = { required_dlc = "scorpion", name = "achv_mines_kill_final_troll_timed_cata_name", display_completion_ui = true, icon = "achievement_trophy_mines_kill_final_troll_timed_cata",
...
AchievementTemplates.achievements.warcamp_bodvarr_charge_warriors_cata = { required_dlc = "scorpion", name = "achv_warcamp_bodvarr_charge_warriors_cata_name", display_completion_ui = true, icon = "achievement_trophy_warcamp_bodvarr_charge_warriors_cata",
...
AchievementTemplates.achievements.skaven_stronghold_skarrik_kill_skaven_cata = { required_dlc = "scorpion", name = "achv_skaven_stronghold_skarrik_kill_skaven_cata_name", display_completion_ui = true, icon = "achievement_trophy_skaven_stronghold_skarrik_kill_skaven_cata",
...
AchievementTemplates.achievements.ussingen_no_event_barrels_cata = { required_dlc = "scorpion", name = "achv_ussingen_no_event_barrels_cata_name", display_completion_ui = true, icon = "achievement_trophy_ussingen_no_event_barrels_cata", desc = "achv_ussingen_no_event_barrels_cata_desc",
...
AchievementTemplates.achievements.skittergate_deathrattler_rasknitt_timed_cata = { required_dlc = "scorpion", name = "achv_skittergate_deathrattler_rasknitt_timed_cata_name", display_completion_ui = true, icon = "achievement_trophy_skittergate_deathrattler_rasknitt_timed_cata",
...
local helmgart_cata_level_name_stats = { achv_mines_kill_final_troll_timed_cata_name = "mines_speed_event_cata", achv_ussingen_no_event_barrels_cata_name = "ussingen_used_no_barrels_cata", achv_military_kill_chaos_warriors_in_event_cata_name = "military_statue_kill_chaos_warriors_cata", achv_bell_destroy_bell_flee_timed_cata_name = "bell_speed_event_cata", achv_ground_zero_burblespew_tornado_enemies_cata_name = "halescourge_tornado_enemies_cata", achv_catacombs_stay_inside_ritual_pool_cata_name = "catacombs_added_souls_cata", achv_elven_ruins_align_leylines_timed_cata_name = "elven_ruins_speed_event_cata", achv_fort_kill_enemies_cannonball_cata_name = "forest_fort_kill_cannonball_cata", achv_farmlands_rescue_prisoners_timed_cata_name = "farmlands_speed_event_cata", achv_skaven_stronghold_skarrik_kill_skaven_cata_name = "storm_vermin_warlord_kills_enemies_cata", achv_skittergate_deathrattler_rasknitt_timed_cata_name = "skittergate_speed_event_cata", achv_nurgle_player_showered_in_pus_cata_name = "nurgle_bathed_all_cata", achv_warcamp_bodvarr_charge_warriors_cata_name = "exalted_champion_charge_chaos_warrior_cata" }
...
AchievementTemplates.achievements.complete_all_helmgart_level_achievements_cata = { name = "achv_complete_all_helmgart_level_achievements_cata_name", icon = "achievement_trophy_complete_all_helmgart_level_achievements_cata", desc = "achv_complete_all_helmgart_level_achievements_cata_desc",
...
AchievementTemplates.achievements.scorpion_cataclysm_unlock_kill_all_lords = { required_dlc = "scorpion", name = "achv_scorpion_cataclysm_unlock_kill_all_lords_name", icon = "achivement_trophy_scorpion_cataclysm_unlock_kill_all_lords", desc = "achv_scorpion_cataclysm_unlock_kill_all_lords_desc",
	...
	requirements = function (statistics_db, stats_id)
		...
		return { { name = "chaos_exalted_champion",
				...
				completed = sorcerer_completed }, { name = "skaven_storm_vermin_warlord",
...
local s2_lord_levels = { "warcamp", "skaven_stronghold", "ground_zero", "skittergate" }
