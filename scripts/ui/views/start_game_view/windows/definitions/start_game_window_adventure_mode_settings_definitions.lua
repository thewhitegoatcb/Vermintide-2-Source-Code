...
local scenegraph_definition = {
	...
	game_option_next_mission = { vertical_alignment = "bottom", parent = "game_option_difficulty", horizontal_alignment = "center", size = game_option_size, position = { 0, -(game_option_size [2] + 16), 4 } },
...
local widgets = {
	...
	game_option_next_mission = create_settings_option("game_option_next_mission", scenegraph_definition.game_option_next_mission.size, Localize("start_game_window_mission"), Localize("start_game_window_change_mission"), nil, "game_options_bg_01"),
