...
local scenegraph_definition = {
	...
	game_option_reward = { vertical_alignment = "bottom", parent = "game_option_difficulty", horizontal_alignment = "center", size = { game_option_size [1], 449 }, position = { 0, -465, 0 } },
	multiplayer_title_bg = { vertical_alignment = "bottom", parent = "game_option_difficulty", horizontal_alignment = "left", size = { window_size [1], 40 }, position = { 0, -60, 1 } },
	multiplayer_title = { vertical_alignment = "center", parent = "multiplayer_title_bg", horizontal_alignment = "left", size = { window_text_width, 40 }, position = { 0, 0, 1 } },
	private_option = { vertical_alignment = "bottom", parent = "multiplayer_title_bg", horizontal_alignment = "left", size = { 250, 40 }, position = { 20, -60, 1 } },
	...
	local widget = {
		...
		style = {
			...
			title_text = { font_size = 32, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "left", vertical_alignment = "top", font_type = "hell_shark_header",
				...
				text_color = Colors.get_color_table_with_alpha("font_title", 255),
				default_text_color = Colors.get_color_table_with_alpha("font_title", 255),
				offset = { frame_width + 5, -frame_width, 7 } },
			...
			title_text_shadow = { font_size = 32, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "left", vertical_alignment = "top", font_type = "hell_shark_header",
				...
				text_color = Colors.get_color_table_with_alpha("black", 255),
				default_text_color = Colors.get_color_table_with_alpha("black", 255),
				offset = { frame_width + 5 + 2, -(frame_width + 2), 6 } },
			...
			option_text_disabled = { font_size = 28, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "bottom", font_type = "hell_shark_header",
			...
			button_disabled_rect = {
				color = { 150, 5, 5, 5 },
				offset = { frame_width, frame_width, 8 },
				size = { size [1] - frame_width * 2, size [2] - frame_width * 2 } } },
