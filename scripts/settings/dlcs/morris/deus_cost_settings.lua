local base_swap_cost = { common = 60, plentiful = 0, exotic = 200, rare = 120, unique = 300 }
...
local base_upgrade_cost = { common = 100, plentiful = 0, exotic = 350, rare = 200, unique = 500 }
...
DeusCostSettings = DeusCostSettings or {
	shop = {
		consumables = { heal = 200, ammo = 100, potion = 250 },




		blessings = { blessing_of_isha = 200, blessing_of_shallya = 200, blessing_of_grimnir = 200, blessing_of_power = 100, blessing_of_abundance = 200, blessing_holy_hand_grenade = 200, blessing_rally_flag = 200, blessing_of_ranald = 200 },
		...
		power_ups = { exotic = 250, unique = 300, rare = 200, uncommon = 100 } },
