return { description = "description_mutator_elite_specials", icon = "mutator_icon_powerful_elites", display_name = "display_name_mutator_elite_specials",
	...
	server_initialize_function = function (context, data)
		...
		BreedActions.skaven_ratling_gunner.shoot_ratling_gun.attack_time = { 12, 20 }
		...
		BreedActions.skaven_ratling_gunner.shoot_ratling_gun.ignore_staggers = { true, true, true, true, true, true }


		Breeds.skaven_poison_wind_globadier.armor_category = 2
		BreedActions.skaven_poison_wind_globadier.advance_towards_players.time_until_first_throw = { 0, 1 }
		BreedActions.skaven_poison_wind_globadier.advance_towards_players.throw_at_distance = { 5, 40 }
		...
		BreedActions.skaven_poison_wind_globadier.throw_poison_globe.time_between_throws = { 8, 1 }


		Breeds.skaven_warpfire_thrower.run_speed = 6
		BreedActions.skaven_warpfire_thrower.shoot_warpfire_thrower.ignore_staggers = { true, true, true, true, true, true }
		...
		BreedActions.chaos_corruptor_sorcerer.grab_attack.ignore_staggers = { true, true, true, true, true, true }
