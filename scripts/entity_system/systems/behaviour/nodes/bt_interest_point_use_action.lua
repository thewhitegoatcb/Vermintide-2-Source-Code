...
function BTInterestPointUseAction:init(...)
...
function BTInterestPointUseAction:enter(unit, blackboard, t)
...
function BTInterestPointUseAction:leave(unit, blackboard, t, reason, destroy)
	local interest_point_system_api = blackboard.system_api.ai_interest_point_system
	...
	if blackboard.ip_next_request_id ~= nil and
...
function BTInterestPointUseAction:run(unit, blackboard, t, dt)
	...
	if blackboard.ip_end_time ~= nil and
	blackboard.ip_end_time <= t then
