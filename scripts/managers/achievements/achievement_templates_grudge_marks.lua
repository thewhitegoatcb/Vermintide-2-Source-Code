...
local relevant_bosses = table.mirror_array_inplace({ "skaven_rat_ogre", "skaven_stormfiend", "chaos_spawn", "beastmen_minotaur", "chaos_troll" })

local expeditions = { "journey_ruin", "journey_ice", "journey_cave", "journey_citadel" }
...
achievements.grudge_marks_on_kill_util = { display_completion_ui = false,
	...
	if career ~= "empire_soldier_tutorial" then
		...
		if career_breed and career_breed.is_hero then
			...
			for i = 1, #expeditions do
				...
				achievements [achievement_id] = { display_completion_ui = false,
			...
			achievements [achievement_id] = { display_completion_ui = true,
			...
			add_meta_challenge(achievements, achievement_id, achievement_group, icon, required_dlc, nil, nil) icon = "achievement_trophy_" .. achievement_id
			...
			add_meta_challenge(achievements, achievement_id, achievement_group, icon, required_dlc, nil, nil) icon = "achievement_trophy_" .. achievement_id
			table.insert(achievement_to_check, achievement_id) end end end