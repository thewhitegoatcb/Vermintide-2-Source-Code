...
dlc_settings.challenge_categories = { "deus_mutator" }



dlc_settings.ingame_challenge_rewards = {
	deus_power_up_quest_test_reward_01 = { reward_id = "deus_power_up_quest_test_reward_01", sound = "Play_hud_grail_knight_stamina", consume_value = 1, type = "deus_power_up", consume_type = "round", target = "owner", granted_power_up_name = "deus_power_up_quest_granted_test_01", granted_power_up_rarity = "exotic", icon = "icon_objective_cdr" } }
...
dlc_settings.ingame_challenge_rewards_description = { deus_power_up_quest_test_reward_01 = "deus_power_up_quest_test_reward_01" }
