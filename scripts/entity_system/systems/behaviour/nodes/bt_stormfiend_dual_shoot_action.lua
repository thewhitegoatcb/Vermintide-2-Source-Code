...
function BTStormfiendDualShootAction:init(...)
...
function BTStormfiendDualShootAction:enter(unit, blackboard, t)
...
function BTStormfiendDualShootAction:leave(unit, blackboard, t, reason, destroy)
...
function BTStormfiendDualShootAction:run(unit, blackboard, t, dt)
	...
	if t < blackboard.anim_locked then
		...
		if t < data.start_firing_t then --[[ Nothing --]]
...
function BTStormfiendDualShootAction:create_firewall(unit, data)
...
function BTStormfiendDualShootAction:shoot_hit_check(unit, blackboard)
	local action = blackboard.action
	local data = blackboard.shoot_data
...
function BTStormfiendDualShootAction:_stop_beam_sfx(unit, blackboard, shoot_data)
	local action = blackboard.action
...
function BTStormfiendDualShootAction:_fire_from_position_direction(unit, blackboard, data, dt, muzzle_node_name)
	local action = blackboard.action
...
function BTStormfiendDualShootAction:_update_ratling_gun(unit, blackboard, t, dt)
	local data = blackboard.shoot_data
...
function BTStormfiendDualShootAction:_shoot_ratling_gun(unit, blackboard, t, dt, muzzle_node_name)
	local action = blackboard.action
	local data = blackboard.shoot_data
...
function BTStormfiendDualShootAction:initiate_firing(blackboard, t)
	local action = blackboard.action
	local data = blackboard.shoot_data
