...
function BTSelector_ethereal_skeleton_with_hammer:init(...)
	BTSelector_ethereal_skeleton_with_hammer.super.init(self, ...)
	self._children = { }
end

function BTSelector_ethereal_skeleton_with_hammer:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_ethereal_skeleton_with_hammer:run(unit, blackboard, t, dt)
...
function BTSelector_ethereal_skeleton_with_hammer:add_child(node)
