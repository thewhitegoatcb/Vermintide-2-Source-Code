local blacklisted_units = { "chaos_corruptor_sorcerer", "chaos_vortex_sorcerer", "skaven_warpfire_thrower", "skaven_poison_wind_globadier", "skaven_ratling_gunner" }
...
return { display_name = "flames_mutator_name", buff_duration_enemy = 3, description = "flames_mutator_desc", buff_duration_player = 3, icon = "mutator_icon_fire_burn",
