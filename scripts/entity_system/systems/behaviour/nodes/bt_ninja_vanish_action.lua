...
function BTNinjaVanishAction:init(...)
...
function BTNinjaVanishAction:enter(unit, blackboard, t)
...
function BTNinjaVanishAction:leave(unit, blackboard, t, reason, destroy)
...
function BTNinjaVanishAction:run(unit, blackboard, t, dt)
...
function BTNinjaVanishAction.vanish(unit, blackboard)
...
function BTNinjaVanishAction.play_foff(unit, blackboard, network_manager, pos, pos2)
...
function BTNinjaVanishAction.find_escape_position(unit, blackboard)
