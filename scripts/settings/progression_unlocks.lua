...
for key, level_requirement in pairs(TalentUnlockLevels) do
	...
	progression_unlocks [key] = { value = "options_button_icon_talents_glow", description = "reward_talent_point", unlock_type = "icon",
...
progression_unlocks.es_mercenary = { description = "end_screen_career_unlocked", profile = "empire_soldier", value = "es_mercenary", title = "es_mercenary", level_requirement = 0, unlock_type = "career" }
...
progression_unlocks.es_huntsman = { description = "end_screen_career_unlocked", profile = "empire_soldier", value = "es_huntsman", title = "es_huntsman", level_requirement = 7, unlock_type = "career" }
...
progression_unlocks.es_knight = { description = "end_screen_career_unlocked", profile = "empire_soldier", value = "es_knight", title = "es_knight", level_requirement = 12, unlock_type = "career" }
...
progression_unlocks.dr_ranger = { description = "n/a", profile = "dwarf_ranger", value = "dr_ranger", title = "dr_ranger", level_requirement = 0, unlock_type = "career" }
...
progression_unlocks.dr_ironbreaker = { description = "end_screen_career_unlocked", profile = "dwarf_ranger", value = "dr_ironbreaker", title = "dr_ironbreaker", level_requirement = 7, unlock_type = "career" }
...
progression_unlocks.dr_slayer = { description = "end_screen_career_unlocked", profile = "dwarf_ranger", value = "dr_slayer", title = "dr_slayer", level_requirement = 12, unlock_type = "career" }
...
progression_unlocks.wh_captain = { description = "end_screen_career_unlocked", profile = "witch_hunter", value = "wh_captain", title = "wh_captain", level_requirement = 0, unlock_type = "career" }
...
progression_unlocks.wh_bountyhunter = { description = "end_screen_career_unlocked", profile = "witch_hunter", value = "wh_bountyhunter", title = "wh_bountyhunter", level_requirement = 7, unlock_type = "career" }
...
progression_unlocks.wh_zealot = { description = "end_screen_career_unlocked", profile = "witch_hunter", value = "wh_zealot", title = "wh_zealot", level_requirement = 12, unlock_type = "career" }
...
progression_unlocks.we_waywatcher = { description = "end_screen_career_unlocked", profile = "wood_elf", value = "we_waywatcher", title = "we_waywatcher", level_requirement = 0, unlock_type = "career" }
...
progression_unlocks.we_maidenguard = { description = "end_screen_career_unlocked", profile = "wood_elf", value = "we_maidenguard", title = "we_maidenguard", level_requirement = 7, unlock_type = "career" }
...
progression_unlocks.we_shade = { description = "end_screen_career_unlocked", profile = "wood_elf", value = "we_shade", title = "we_shade", level_requirement = 12, unlock_type = "career" }
...
progression_unlocks.bw_adept = { description = "end_screen_career_unlocked", profile = "bright_wizard", value = "bw_adept", title = "bw_adept", level_requirement = 0, unlock_type = "career" }
...
progression_unlocks.bw_scholar = { description = "end_screen_career_unlocked", profile = "bright_wizard", value = "bw_scholar", title = "bw_scholar", level_requirement = 7, unlock_type = "career" }
...
progression_unlocks.bw_unchained = { description = "end_screen_career_unlocked", profile = "bright_wizard", value = "bw_unchained", title = "bw_unchained", level_requirement = 12, unlock_type = "career" }
...
ProgressionUnlocks = {
	...
	get_level_unlocks = function (level, profile)
		local templates = { }
		for unlock_name, template in pairs(progression_unlocks) do
			if ( not template.profile or template.profile == profile ) and
			template.level_requirement == level then
...
local prestige_unlocks = {
	witch_hunter = { "frame_0001", "frame_0002", "frame_0003", "frame_0004", "frame_0005", "frame_0006" },
	...
	bright_wizard = { "frame_0001", "frame_0002", "frame_0003", "frame_0004", "frame_0005", "frame_0006" },
	...
	dwarf_ranger = { "frame_0001", "frame_0002", "frame_0003", "frame_0004", "frame_0005", "frame_0006" },
	...
	wood_elf = { "frame_0001", "frame_0002", "frame_0003", "frame_0004", "frame_0005", "frame_0006" },
	...
	empire_soldier = { "frame_0001", "frame_0002", "frame_0003", "frame_0004", "frame_0005", "frame_0006" } }
...
function ProgressionUnlocks.prestige_reward_by_level(prestige_level, profile_name)
...
function ProgressionUnlocks.can_upgrade_prestige(hero_name)
...
function ProgressionUnlocks.upgrade_prestige(hero_name)
	local hero_attributes = Managers.backend:get_interface("hero_attributes")
...
function ProgressionUnlocks.get_prestige_level(hero_name)
	local hero_attributes = Managers.backend:get_interface("hero_attributes")
	return hero_attributes:get(hero_name, "prestige") or 0
end

function ProgressionUnlocks.get_num_talent_points(hero_name)
	local experience = ExperienceSettings.get_experience(hero_name)
	local level = ExperienceSettings.get_level(experience)
...
function ProgressionUnlocks.debug_use_hero_template(hero_template)
