...
function VortexHuskExtension:init(extension_init_context, unit, extension_init_data)
...
function VortexHuskExtension:extensions_ready(world, unit)
	WwiseUtils.trigger_unit_event(world, "Play_enemy_sorcerer_vortex_loop", unit)
end

function VortexHuskExtension:destroy()
...
function VortexHuskExtension:update(unit, input, dt, context, t)
...
function VortexHuskExtension:debug_render_vortex(t, dt, pos, fx_radius, inner_radius, outer_radius, spin_speed, height)
