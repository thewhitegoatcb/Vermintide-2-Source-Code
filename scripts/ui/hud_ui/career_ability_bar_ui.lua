...
function CareerAbilityBarUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function CareerAbilityBarUI:_get_ability_amount(player_unit)
...
function CareerAbilityBarUI:_create_ui_elements()
...
function CareerAbilityBarUI:update(dt, t, player)
...
local colors = {
	normal = { 255, 223, 133, 228 },
	medium = { 255, 223, 133, 228 },
	high = { 255, 223, 133, 228 } }


function CareerAbilityBarUI:_set_ability_bar_fraction(ability_fraction, min_threshold_fraction, max_threshold_fraction, icon_pulse_fraction)
...
function CareerAbilityBarUI:_set_game_options_dirty()
	self._game_options_dirty = true
end


function CareerAbilityBarUI:_update_game_options()
...
function CareerAbilityBarUI:_update_gamepad_input_button()
