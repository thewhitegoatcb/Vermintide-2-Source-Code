...
if has_steam and not disable_voip then
	...
	function Voip:set_input_manager(input_manager)
	...
	function Voip:register_rpcs(network_event_delegate, network_transmit)
	...
	function Voip:room_member_removed(callback_object, room_id, peer_id)
	...
	function Voip:room_member_added(room_id, peer_id)
	...
	function Voip:rpc_notify_connected(channel_id)
	...
	function Voip:rpc_voip_room_request(channel_id, enter)
	...
	function Voip:rpc_voip_room_to_join(channel_id, room_id)
	...
	function Voip:_destroy_voice_chat_ui()
	...
	function Voip:update(dt)
		...
		local room_id = self.room_id
		if
		room_id and self.is_server then
	...
	function Voip:add_voip_member(member)
	...
	function Voip:remove_member(member)
	...
	function Voip:mute_member(member)
		if self.voip_client == nil then return
		end
	...
	function Voip:unmute_member(member)
		if self.voip_client == nil then return end
	...
	function Voip:peer_muted(peer_id)
		return self.muted_peers [peer_id]
	end

	function Voip:leave_voip_room()
	...
	function Voip:set_volume(voip_bus_volume)
	...
	function Voip:set_enabled(enabled)
	...
	function Voip:set_push_to_talk(push_to_talk)
	...
	function Voip:is_talking(peer_id)
	...
	function Voip:audio_level(peer_id)
		local level = SteamVoipClient.audio_level(self.voip_client, peer_id)
		return level
	end
else

	function Voip:init() return end
	function Voip:set_input_manager(input_manager) return end
	function Voip:destroy() return end
	function Voip:destroy_voip_system() return end
	function Voip:register_rpcs() return end
	function Voip:unregister_rpcs() return end
	function Voip:add_voip_member() return end
	function Voip:mute_member() return end
	function Voip:unmute_member() return end
	function Voip:update() return end
	function Voip:peer_muted() return end
	function Voip:set_volume() return end
	function Voip:set_enabled() return end
	function Voip:set_push_to_talk() return end
	function Voip:is_talking() return end
	function Voip:audio_level() return -96 end end