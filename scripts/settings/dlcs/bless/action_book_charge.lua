...
function ActionBookCharge:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionBookCharge:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionBookCharge:client_owner_post_update(dt, t, world)
...
function ActionBookCharge:_update_visual_charge(current_charge)
...
function ActionBookCharge:finish(reason)
