...
function BTBossFollowAction:init(...)
	BTBossFollowAction.super.init(self, ...)
end

BTBossFollowAction.name = "BTBossFollowAction"

function BTBossFollowAction:enter(unit, blackboard, t)
...
function BTBossFollowAction:leave(unit, blackboard, t, reason, destroy)
...
function BTBossFollowAction:run(unit, blackboard, t, dt)
...
function BTBossFollowAction:_go_idle(unit, blackboard, navigation_extension, locomotion_extension)
...
function BTBossFollowAction:_go_moving(unit, blackboard, action)
	blackboard.move_state = "moving"
	Managers.state.network:anim_event(unit, action.move_anim)
end

function BTBossFollowAction:follow(unit, t, dt, blackboard, locomotion_extension)
	local navigation_extension = blackboard.navigation_extension
...
function BTBossFollowAction:check_fling_skaven(unit, blackboard, t)
...
function BTBossFollowAction:_follow_target_rat_ogre(unit, blackboard, t, dt)
...
function BTBossFollowAction:_follow_target_stormfiend(unit, blackboard, t, dt)
...
function BTBossFollowAction:_follow_target_chaos_spawn(unit, blackboard, t, dt)
	return LocomotionUtils.follow_target_ogre(unit, blackboard, t, dt)
end
...
function BTBossFollowAction:_debug_big_boy_turning(blackboard)
