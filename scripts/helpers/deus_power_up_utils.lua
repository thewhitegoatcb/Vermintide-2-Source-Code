...
function DeusPowerUpUtils.get_talent_from_power_up(talent_index, talent_tier, profile_index, career_index)
...
function DeusPowerUpUtils.get_talent_power_up_from_tier_and_column(tier, column)
...
function DeusPowerUpUtils.get_power_up_description(power_up_instance, profile_index, career_index)
	local power_up = DeusPowerUps [power_up_instance.rarity] [power_up_instance.name]
...
function DeusPowerUpUtils.get_power_up_icon(power_up_instance, profile_index, career_index)
	local power_up = DeusPowerUps [power_up_instance.rarity] [power_up_instance.name]

	if power_up.talent then
		local talent_settings = DeusPowerUpUtils.get_talent_from_power_up(power_up.talent_index, power_up.talent_tier, profile_index, career_index)

		do return talent_settings.icon end
	else
		return power_up.icon
	end
end

function DeusPowerUpUtils.get_power_up_name_text(name, talent_index, talent_tier, profile_index, career_index)
...
function DeusPowerUpUtils.power_ups_to_string(power_ups)
	local string_array = { }
...
function DeusPowerUpUtils.string_to_power_ups(power_ups_string)
	local power_ups = { }
...
function DeusPowerUpUtils.generate_specific_power_up(power_up_name, rarity)
	return generate_specific_power_up(power_up_name, rarity)
end

function DeusPowerUpUtils.generate_random_power_ups(seed, count, existing_power_ups, difficulty, run_progress, availability_type, career_name, forced_rarity)
	local new_power_ups = { }
...
function DeusPowerUpUtils.activate_deus_power_up(power_up_instance, buff_system, talent_interface, deus_backend, deus_run_controller, local_player_unit, profile_index, career_index)
