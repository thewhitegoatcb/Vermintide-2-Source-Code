...
local conversion_table = { chaos_vortex_sorcerer = "chaos_warrior", chaos_corruptor_sorcerer = "chaos_warrior" }
...
local ai_tweak_spawn_table = {
	chaos_warrior = function (unit, blackboard)
		...
		if blackboard.spawn_category == "specials_pacing" or

		blackboard.spawn_category == "spawn_one" or

		blackboard.spawn_category == "raw_spawner" then
