...
function BTThrowWeaponAction:init(...)
	BTThrowWeaponAction.super.init(self, ...)
end

BTThrowWeaponAction.name = "BTThrowWeaponAction"

function BTThrowWeaponAction:enter(unit, blackboard, t)
...
function BTThrowWeaponAction:leave(unit, blackboard, t, reason, destroy)
	if not destroy then
...
function BTThrowWeaponAction:anim_cb_throw_weapon(unit, blackboard)
...
function BTThrowWeaponAction:anim_cb_throw_finished(unit, blackboard)
	blackboard.throw_finished = true
end


function BTThrowWeaponAction:catch_weapon(unit, blackboard)
	local network_manager = Managers.state.network
	local owner_go_id = network_manager:unit_game_object_id(unit)
...
function BTThrowWeaponAction:run(unit, blackboard, t, dt)
...
function BTThrowWeaponAction:update_thrown_weapon(unit, blackboard, dt, t)
...
function BTThrowWeaponAction:check_overlap(action, thrown_unit, unit, blackboard, target_unit)
...
function BTThrowWeaponAction:attack_close_units(action, unit, blackboard, target_unit, t)
...
function BTThrowWeaponAction:anim_cb_damage(unit, blackboard)
