...
function BTCritterRatFleeAction:init(...)
	BTCritterRatFleeAction.super.init(self, ...)
end

BTCritterRatFleeAction.name = "BTCritterRatFleeAction"

function BTCritterRatFleeAction:enter(unit, blackboard, t)
...
function BTCritterRatFleeAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.move_pos = nil
...
function BTCritterRatFleeAction:run(unit, blackboard, t)
...
function BTCritterRatFleeAction:select_move_pos(unit, blackboard)
	local move_pos = nil
...
function BTCritterRatFleeAction:_get_cover_point_flee_pos(unit, blackboard)
...
function BTCritterRatFleeAction:_get_far_along_path_pos(unit, blackboard)
...
function BTCritterRatFleeAction:_get_random_flee_pos_in_front_of_target(unit, blackboard)
...
function BTCritterRatFleeAction:_get_random_flee_pos(unit, blackboard)
	...
	move_pos =
	move_pos or POSITION_LOOKUP [unit]


	return move_pos
end

function BTCritterRatFleeAction:start_idle_animation(unit, blackboard)

	Managers.state.network:anim_event(unit, "idle")
	blackboard.move_state = "idle"
end

function BTCritterRatFleeAction:start_move_animation(unit, blackboard)

	Managers.state.network:anim_event(unit, "move_fwd")
	blackboard.move_state = "moving"
end

function BTCritterRatFleeAction:at_destination(unit, blackboard, t)
	if blackboard.move_state ~= "idle" then
