...
ActivatedAbilitySettings.bw_necromancer = { { description = "career_active_desc_bw_necromancer_2", name = "bw_necromancer", display_name = "career_active_name_bw_necromancer_2", cooldown = 110, icon = "sienna_necromancer_passive", action_name = "action_career_bw_necromancer", weapon_name = "bw_necromancer_career_skill_weapon",
...
PassiveAbilitySettings.bw_necromancer = { description = "career_passive_desc_bw_necromancer", display_name = "career_passive_name_bw_necromancer", icon = "sienna_necromancer_activated_ability",
	...
	buffs = { "sienna_necromancer_passive_balefire", "sienna_necromancer_perk_dot_duration", "sienna_necromancer_perk_3", "sienna_necromancer_career_skill_damage_proc_aura", "sienna_necromancer_ability_cooldown_on_hit", "sienna_necromancer_ability_cooldown_on_damage_taken" },
	...
	perks = { { description = "career_passive_desc_bw_necromancer_a", display_name = "career_passive_name_bw_necromancer_a",
			description_values = { } },
