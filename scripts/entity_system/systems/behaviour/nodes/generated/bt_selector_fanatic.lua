...
function BTSelector_fanatic:init(...)
	BTSelector_fanatic.super.init(self, ...)
	self._children = { }
end

function BTSelector_fanatic:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_fanatic:run(unit, blackboard, t, dt)
...
function BTSelector_fanatic:add_child(node)
