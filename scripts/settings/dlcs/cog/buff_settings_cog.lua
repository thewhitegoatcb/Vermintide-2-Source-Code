...
settings.buff_templates = {
	bardin_engineer_pump_max_overheat_check = {
		buffs = { { duration = 2, name = "bardin_engineer_pump_max_overheat_check", on_max_stacks_overflow_func = "add_remove_buffs", max_stacks = 1, refresh_durations = true,
				...
				max_stack_data = {
					...
					talent_buffs = {
						bardin_engineer_overclock = {
							buffs_to_add = { { name = "bardin_engineer_pump_overclock_buff" } },




							buffs_to_add_if_missing = { { name = "bardin_engineer_pump_max_exhaustion_buff" } } } } } } } },
	...
	bardin_engineer_pump_max_exhaustion_buff = {
		buffs = { { duration = 5, name = "bardin_engineer_pump_max_exhaustion_buff", priority_buff = true, remove_buff_func = "bardin_engineer_animation_slow_down_remove", apply_buff_func = "bardin_engineer_animation_slow_down_add", debuff = true, max_stacks = 1, icon = "bardin_engineer_pump_max_exhaustion_buff_icon",
	...
	bardin_engineer_pump_overclock_buff = {
		buffs = { { name = "bardin_engineer_pump_overclock_buff", stat_buff = "critical_strike_chance", apply_buff_func = "bardin_engineer_overclock_damage", on_max_stacks_overflow_func = "reapply_buff", refresh_durations = true, priority_buff = true, max_health_loss = 10, duration = 12, max_stacks = 3, icon = "bardin_engineer_4_2", health_to_lose_per_stack = 4,
