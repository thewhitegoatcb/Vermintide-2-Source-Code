...
function CharacterInspectUI:init(ingame_ui_context)
...
function CharacterInspectUI:create_ui_elements()
...
function CharacterInspectUI:destroy()
	GarbageLeakDetector.register_object(self, "character_inspect_ui")
end

function CharacterInspectUI:update(dt)
	if DO_RELOAD then
		self:create_ui_elements()
	end
...
function CharacterInspectUI:_update_animations(dt)
...
function CharacterInspectUI:draw(dt)
...
function CharacterInspectUI:set_position(x, y)
