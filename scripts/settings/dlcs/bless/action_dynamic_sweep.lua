...
function ActionDynamicSweep:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionDynamicSweep:_get_damage_profile_name(action_hand, action)
...
function ActionDynamicSweep:_calculate_attack_direction(action, weapon_rotation)
	local current_mode = self.weapon_extension:get_mode()
