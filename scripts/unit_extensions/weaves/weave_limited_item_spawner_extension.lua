...
function WeaveLimitedItemSpawnerExtension:init(extension_init_context, unit, extension_init_data)
...
function WeaveLimitedItemSpawnerExtension:score()
	return self._score
end

function WeaveLimitedItemSpawnerExtension:get_objective_settings()
	return WeaveObjectiveSettings [WeaveLimitedItemSpawnerExtension.NAME]
end

function WeaveLimitedItemSpawnerExtension:activate(game_object_id, objective_data)
...
function WeaveLimitedItemSpawnerExtension:destroy()
	return end

function WeaveLimitedItemSpawnerExtension:set_weave_settings(objective_data)
...
function WeaveLimitedItemSpawnerExtension:complete()
...
function WeaveLimitedItemSpawnerExtension:deactivate()
...
function WeaveLimitedItemSpawnerExtension:objective_name()
	return self._objective_name
end

function WeaveLimitedItemSpawnerExtension:game_object_id()
	return self._game_object_id
end

function WeaveLimitedItemSpawnerExtension:update(dt, t)
...
function WeaveLimitedItemSpawnerExtension:cb_game_session_disconnect()

	return end

function WeaveLimitedItemSpawnerExtension:is_done()
	return self._value >= 100
end

function WeaveLimitedItemSpawnerExtension:get_percentage_done()
	return self._value / 100
end

function WeaveLimitedItemSpawnerExtension:get_score()
	return self._score
end

function WeaveLimitedItemSpawnerExtension:_server_update(dt, t)
...
function WeaveLimitedItemSpawnerExtension:_client_update(dt, t)
	local game_session = Network.game_session()
	if game_session then
