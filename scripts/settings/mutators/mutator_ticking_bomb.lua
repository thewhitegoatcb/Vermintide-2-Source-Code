return { description = "description_mutator_ticking_bomb", display_name = "display_name_mutator_ticking_bomb", icon = "mutator_icon_ticking_bomb",
		...
		if data.apply_bomb_buff_at_t < t then
			...
			for i = 1, random_num_affected_players do
				...
				if is_alive then
					...
					local bomb_data = { player_unit = random_player_unit }
