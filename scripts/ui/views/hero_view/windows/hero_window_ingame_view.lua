...
function HeroWindowIngameView:on_enter(params, offset)
...
function HeroWindowIngameView:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowIngameView:_init_menu_views()
...
function HeroWindowIngameView:_reset_menu_views()
	for name, view in pairs(self._views) do
...
function HeroWindowIngameView:_activate_view(new_view)
...
function HeroWindowIngameView:exit_current_view()
...
function HeroWindowIngameView:create_ui_elements(params, offset)
...
function HeroWindowIngameView:on_exit(params)
...
function HeroWindowIngameView:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowIngameView:post_update(dt, t)
	return end

function HeroWindowIngameView:_update_animations(dt)
...
function HeroWindowIngameView:_is_button_pressed(widget)
...
function HeroWindowIngameView:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function HeroWindowIngameView:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter and not hotspot.is_selected
end

function HeroWindowIngameView:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit and not hotspot.is_selected
end

function HeroWindowIngameView:_is_button_selected(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.is_selected
end

function HeroWindowIngameView:_handle_input(dt, t)
...
function HeroWindowIngameView:_get_next_available_index(index)
	local layout_logic = self.layout_logic
	if layout_logic then
		local layout_data = layout_logic:layout_data()
		local num_entries = #layout_data
...
function HeroWindowIngameView:_get_previous_available_index(index)
	local layout_logic = self.layout_logic
	if layout_logic then
		local layout_data = layout_logic:layout_data()
		local num_entries = #layout_data
...
function HeroWindowIngameView:_on_button_pressed(index, data)
...
function HeroWindowIngameView:_on_button_selected(index, ignore_sound)
	local title_button_widgets = self._title_button_widgets
...
function HeroWindowIngameView:draw(dt)
...
function HeroWindowIngameView:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowIngameView:_update_presentation()
	local layout_logic = self.layout_logic
	local layout_data = layout_logic:layout_data()
	local num_entries = #layout_data
