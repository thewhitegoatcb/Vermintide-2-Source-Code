...
local XB1_ACHIEVEMENT_ID = { karak_azgaraz_complete_dlc_dwarf_beacons_legend = 121, dwarf_big_jump = 118, dwarf_pressure_pad = 114, dwarf_crows = 115 }
...
local PS4_ACHIEVEMENT_ID = { dwarf_crows = "091" }




local all_difficulties = { }
local portals = { LevelSettings.dlc_dwarf_beacons }
...
achievements.dwarf_pressure_pad = { name = "achv_dwarf_pressure_pad_name", display_completion_ui = true, icon = "achievement_dwarf_pressure_pad", desc = "achv_dwarf_pressure_pad_desc",





	events = { "dwarf_pressure_pad" },
...
achievements.dwarf_big_jump = { name = "achv_dwarf_big_jump_name", display_completion_ui = true, icon = "achievement_dwarf_big_jump", desc = "achv_dwarf_big_jump_desc",





	events = { "dwarf_big_jump" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.dwarf_crows = { name = "achv_dwarf_crows_name", display_completion_ui = true, icon = "achievement_dwarf_crows", desc = "achv_dwarf_crows_desc",
...
achievements.dwarf_speedrun = { name = "achv_dwarf_speedrun_name", display_completion_ui = true, icon = "achievement_dwarf_speedrun", desc = "achv_dwarf_speedrun_desc",




	events = { "dwarf_speedrun_start", "dwarf_speedrun_end" },
	completed = function (statistics_db, stats_id, template_data)
