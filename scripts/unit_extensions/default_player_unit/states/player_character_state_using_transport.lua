...
function PlayerCharacterStateUsingTransport:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "using_transport")
	local context = character_state_init_context
end


function PlayerCharacterStateUsingTransport:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateUsingTransport:on_exit(unit, input, dt, context, t, next_state)

	return end

function PlayerCharacterStateUsingTransport:update(unit, input, dt, context, t)
	local csm = self.csm
