...
local window_size = { inner_window_size [1] - filter_frame_size [1] - info_frame_size [1] + 12, inner_window_size [2] - 60 }



local element_settings = { height_spacing = 7, height = 45,
	width = window_size [1] - 50 }




local ListSettings = { font_size = 18 }
...
local title_text_position = { 20, 0, 2 }
local level_text_position = { window_size [1] * 0.3, 0, 2 }
local difficulty_text_position = { window_size [1] * 0.6, 0, 2 }
local num_players_text_position = { window_size [1] * 0.8, 0, 2 }
local status_text_position = { window_size [1] * 0.6, 0, 2 }
local country_text_position = { -5, 0, 2 }
local country_button_position = { -50, 0, 2 }

local level_lock_position = { level_text_position [1] - 25, 10, 3 }
local difficulty_lock_position = { difficulty_text_position [1] - 25, 10, 3 }
local status_lock_position = { status_text_position [1] - 25, 10, 3 }


local definitions = {
	scenegraph_definition = {
		root = { is_root = true, size = { 1920, 1080 }, position = { 0, 0, UILayer.default + 20 } },
		menu_root = { vertical_alignment = "center", parent = "root", horizontal_alignment = "center", size = { 1920, 1080 }, position = { 0, 0, 0 } },

		window = { vertical_alignment = "center", parent = "menu_root", horizontal_alignment = "center", size = inner_window_size, position = { 0, 0, 1 } },
		item_list = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "left", size = { window_size [1], window_size [2] }, position = { filter_frame_size [1] + 8, 12, 1 } },
		loading_overlay = { vertical_alignment = "bottom", parent = "item_list", horizontal_alignment = "left", size = { window_size [1] - 16, window_size [2] + 7 }, position = { -4, -8, 6 } },


		loading_icon = { vertical_alignment = "center", parent = "loading_overlay", horizontal_alignment = "center", position = { 0, 0, 1 }, size = { 50, 50 } },
		loading_text = { vertical_alignment = "center", parent = "loading_icon", horizontal_alignment = "center", position = { 0, -90, 1 }, size = { 800, 50 } },
		scrollbar_root = { vertical_alignment = "top", parent = "item_list", horizontal_alignment = "right", position = { -24, -7, 20 }, size = { 22, 520 } },


		label_root = { vertical_alignment = "top", parent = "item_list", horizontal_alignment = "left", position = { 0, 35, 0 }, size = { window_size [1], 40 } },
		host_text_button = { vertical_alignment = "top", parent = "label_root", horizontal_alignment = "left", position = title_text_position, size = { 100, 40 } },
		level_text_button = { parent = "label_root", horizontal_alignment = "left", position = level_text_position, size = { 100, 40 } },
		difficulty_text_button = { parent = "label_root", horizontal_alignment = "left", position = difficulty_text_position, size = { 130, 40 } },
		players_text_button = { parent = "label_root", horizontal_alignment = "left", position = num_players_text_position, size = { 120, 40 } } },


	widget_definitions = {
		inventory_list_widget = { scenegraph_id = "item_list",
			element = {
				passes = { { style_id = "list_style", pass_type = "list_pass", content_id = "list_content",
						...
						passes = { { style_id = "background", pass_type = "hotspot", content_id = "button_hotspot" },
							...
							{ pass_type = "texture", style_id = "background", texture_id = "background_normal_hover",
							...
							{ pass_type = "texture", style_id = "background", texture_id = "background_selected",
							...
							{ pass_type = "texture", style_id = "background", texture_id = "background_selected_hover",
							...
							{ pass_type = "texture", style_id = "locked_level", texture_id = "locked_level",
							...
							{ pass_type = "texture", style_id = "locked_difficulty", texture_id = "locked_difficulty",
							...
							{ style_id = "num_players_text", pass_type = "text", text_id = "num_players_text" } } },





					{ style_id = "hover", pass_type = "hover", content_id = "hotspot" } } },
		...
		test = UIWidgets.create_simple_rect("item_list", { 200, 0, 255, 0 }),
		window = UIWidgets.create_simple_rect("window", { 200, 255, 0, 0 }),
		...
		loading_overlay = UIWidgets.create_simple_rect("loading_overlay", { 100, 0, 0, 0 }),
...
local function setup_mouse_scroll_widget_definition(scroll_field_width, scroll_field_height)
	...
	local scroll_field_scenegraph_definition = { horizontal_alignment = "right",
		position = { 0, -2, 1 },
		size = { scroll_field_width + 24, scroll_field_height },
	...
	definitions.widget_definitions.scroll_field = {
		...
		content = { scroll_step = 0.05, internal_scroll_value = 0 },
...
function level_is_locked(lobby_data)
	...
	if mechanism_settings and mechanism_settings.extra_requirements_function and
	not mechanism_settings.extra_requirements_function() then
		return true
	end
...
local function create_lobby_list_entry_content(lobby_data)
	...
	local content = { locked_difficulty = "locked_icon_01", locked_status = "locked_icon_01", background_selected = "lb_list_item_clicked", background_normal_hover = "lb_list_item_hover", visible = true, background_selected_hover = "lb_list_item_clicked", background_normal = "lb_list_item_normal", locked_level = "locked_icon_01",
		button_hotspot = { },
...
local function create_empty_lobby_list_entry_content()
	local content = { difficulty_text = "", title_text = "", num_players_text = "", background_normal = "lb_list_item_bg", fake = true, country_text = "", background_normal_hover = "lb_list_item_bg", background_selected = "lb_list_item_bg", level_text = "", status_text = "", background_selected_hover = "lb_list_item_bg",
...
local function create_lobby_list_entry_style()
	local style = {
		...
		title_text = { vertical_alignment = "center", horizontal_alignment = "left", font_type = "arial",
			size = { element_settings.width, element_settings.height },
		...
		level_text = { word_wrap = false, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font_size = true, font_type = "arial",
			size = { element_settings.width, element_settings.height },
			text_color = Colors.color_definitions.white,
		...
		difficulty_text = { vertical_alignment = "center", horizontal_alignment = "left", font_type = "arial",
			size = { element_settings.width, element_settings.height },
			text_color = Colors.color_definitions.white,
		...
		num_players_text = { vertical_alignment = "center", horizontal_alignment = "left", font_type = "arial",
			size = { element_settings.width, element_settings.height },
			text_color = Colors.color_definitions.white,
			...
			offset = { num_players_text_position [1] + 5, num_players_text_position [2], num_players_text_position [3] } },

		status_text = { vertical_alignment = "center", horizontal_alignment = "left", font_type = "arial",
			size = { element_settings.width, element_settings.height },
			text_color = Colors.color_definitions.white,
		...
		country_text = { vertical_alignment = "center", horizontal_alignment = "right", font_type = "arial",
			size = { element_settings.width, element_settings.height },
			text_color = Colors.color_definitions.white,
...
function LobbyItemsList:init(ingame_ui_context, settings)
	...
	settings.list_size = { item_list_definitions.size [1], item_list_definitions.size [2] }
	...
	self.list_style = { vertical_alignment = "top", scenegraph_id = "item_list",
		size = settings.list_size,
		list_member_offset = { 0, -(element_settings.height + element_settings.height_spacing), 0 },
...
function LobbyItemsList:destroy()
	return end

function LobbyItemsList.lobby_status_text(lobby_data)
...
function LobbyItemsList:create_ui_elements(offset)
...
function LobbyItemsList:update(dt, loading)
	if loading then
...
function LobbyItemsList:handle_gamepad_input(dt, num_elements)
	local input_manager = self.input_manager
...
function LobbyItemsList:update_gamepad_list_scroll()
	local selected_list_index = self.selected_list_index
...
function LobbyItemsList:is_entry_outside(index)
	local item_list_widget = self.item_list_widget
...
function LobbyItemsList:_pick_sort_func(sort_func_asc, sort_func_desc)
...
function LobbyItemsList:rotate_loading_icon(dt)
...
function LobbyItemsList:loading_overlay_fade_in(alpha)
...
function LobbyItemsList:loading_overlay_fade_out()
...
function LobbyItemsList:animate_loading_text()
	local widget = self.loading_text
	local style = widget.style
	local color = style.text.text_color
	if color [1] ~= 255 then
		local animation = UIAnimation.init(UIAnimation.function_by_time, color, 1, color [1], 255, 0.3, math.easeOutCubic,
		UIAnimation.wait, 3.2,
		UIAnimation.function_by_time, color, 1, 255, 0, 0.3, math.easeOutCubic)
		table.clear(widget.animations)
		widget.animations [animation] = true
	end
end

function LobbyItemsList:draw(dt)
...
function LobbyItemsList:sort_lobbies(lobbies, sort_func)
	table.sort(lobbies, sort_func)
end

function LobbyItemsList:remove_invalid_lobbies(lobbies)
	local valid_lobbies = { }
...
function LobbyItemsList:populate_lobby_list(lobbies, ignore_scroll_reset)
...
function LobbyItemsList:update_scroll()
...
function LobbyItemsList:set_scroll_amount(value)
	local current_scroll_value = self.scroll_value
...
function LobbyItemsList:set_scrollbar_length(start_scroll_value, ignore_scroll_reset)
	local settings = self.settings
	...
	local bar_fraction = 0 local step_fraction = 0
...
function LobbyItemsList:scroll_inventory_list(value)
	local item_list_widget = self.item_list_widget
	if item_list_widget then
		local list_content = item_list_widget.content.list_content
		local list_style = item_list_widget.style.list_style
		...
		if max_visible_elements and max_visible_elements < total_elements then
			...
			if
			column_count and new_start_index % column_count == 0 then
...
function LobbyItemsList:on_lobby_selected(index, play_sound)
	local item_list_widget = self.item_list_widget
	local list_content = item_list_widget.content.list_content
	local number_of_items_in_list = self.number_of_items_in_list
...
function LobbyItemsList:selected_lobby()
	local selected_list_index = self.selected_list_index
	if not selected_list_index then
		return
	end
...
function LobbyItemsList:set_selected_lobby(selected_lobby_data)
	self.selected_list_index = nil
...
function LobbyItemsList:animate_element_by_time(target, destination_index, from, to, time)
	local new_animation = UIAnimation.init(UIAnimation.function_by_time, target, destination_index,
	from, to, time, math.easeInCubic)
	return new_animation
end

function LobbyItemsList:play_sound(event)
