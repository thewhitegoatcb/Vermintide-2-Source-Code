...
local RPCS = { "rpc_add_damage", "rpc_add_damage_network", "rpc_damage_taken_overcharge", "rpc_heal", "rpc_remove_assist_shield", "rpc_request_heal", "rpc_suicide", "rpc_sync_damage_taken", "rpc_take_falling_damage", "rpc_request_knock_down", "rpc_request_heal_wounds", "rpc_request_revive", "rpc_request_insta_kill", "rpc_request_convert_temp" }
...
local extensions = { "ChaosTrollHealthExtension", "ChaosTrollHuskHealthExtension", "ExplosiveBarrelHealthExtension", "GenericHealthExtension", "InvincibleHealthExtension", "LootRatHealthExtension", "PlayerUnitHealthExtension", "RatOgreHealthExtension", "LureHealthExtension", "OverpoweredBlobHealthExtension", "TrainingDummyHealthExtension", "TargetHealthExtension" }
...
function HealthSystem:init(entity_system_creation_context, system_name)
...
function HealthSystem:freeze(unit, extension_name)
...
function HealthSystem:unfreeze(unit)
...
function HealthSystem:hot_join_sync(sender)
...
function HealthSystem:update(context, t)
...
function HealthSystem:_assist_shield(target_unit, shield_amount)
...
function HealthSystem:suicide(unit)
...
local debug_units = { }
function HealthSystem:update_debug()
...
function HealthSystem:rpc_add_damage_network(channel_id, victim_unit_go_id, victim_unit_is_level_unit, attacker_unit_go_id, attacker_is_level_unit, source_attacker_unit_go_id, damage_amount, hit_zone_id, damage_type_id, hit_position, damage_direction, damage_source_id, hit_react_type_id, is_critical_strike, added_dot, first_hit, total_hits, backstab_multiplier)
...
function HealthSystem:rpc_damage_taken_overcharge(channel_id, unit_go_id, damage)
...
function HealthSystem:rpc_heal(channel_id, target_unit_go_id, target_unit_is_level_unit, healer_unit_go_id, healer_unit_is_level_unit, heal_amount, heal_type_id)
...
function HealthSystem:rpc_remove_assist_shield(channel_id, unit_go_id)
	local unit = self.unit_storage:unit(unit_go_id)
	local health_extension = self.unit_extensions [unit]
	health_extension:remove_assist_shield("blocked_damage")
end

function HealthSystem:rpc_request_heal(channel_id, unit_go_id, heal_amount, heal_type_id)
...
function HealthSystem:rpc_request_convert_temp(channel_id, unit_go_id, amount)
...
function HealthSystem:rpc_suicide(channel_id, go_id)
	local unit = self.unit_storage:unit(go_id)
	self:suicide(unit)
end

function HealthSystem:rpc_sync_damage_taken(channel_id, go_id, is_level_unit, set_max_health, amount, state_id)
...
function HealthSystem:rpc_take_falling_damage(channel_id, go_id, fall_height)
	local unit = self.unit_storage:unit(go_id)
...
function HealthSystem:rpc_request_knock_down(channel_id, unit_go_id)
...
function HealthSystem:rpc_request_heal_wounds(channel_id, unit_go_id)
...
function HealthSystem:rpc_request_revive(channel_id, revived_unit_go_id, reviver_unit_go_id)
...
function HealthSystem:rpc_request_insta_kill(sender, unit_id, damage_type_id)
