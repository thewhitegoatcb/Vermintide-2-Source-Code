...
local XB1_ACHIEVEMENT_ID = { dwarf_valaya_emote = 113, dwarf_barrel_carry = 112, karak_azgaraz_complete_dlc_dwarf_interior_legend = 119 }





local PS4_ACHIEVEMENT_ID = { dwarf_valaya_emote = "092" }




local all_difficulties = { }
local portals = { LevelSettings.dlc_dwarf_interior }
...
achievements.dwarf_valaya_emote = { name = "achv_dwarf_valaya_emote_name", display_completion_ui = true, icon = "achievement_dwarf_valaya_emote", desc = "achv_dwarf_valaya_emote_desc",
...
achievements.dwarf_rune = { name = "achv_dwarf_rune_name", display_completion_ui = true, icon = "achievement_dwarf_rune", desc = "achv_dwarf_rune_desc",
...
achievements.dwarf_barrel_carry = { name = "achv_dwarf_barrel_carry_name", display_completion_ui = true, icon = "achievement_dwarf_barrel_carry", desc = "achv_dwarf_barrel_carry_desc",
	...
	events = { "objective_entered_socket_zone", "dwarf_barrel_carry" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.dwarf_bells = { name = "achv_dwarf_bells_name", display_completion_ui = true, icon = "achievement_dwarf_bells", desc = "achv_dwarf_bells_desc",
...
achievements.dwarf_pressure = { name = "achv_dwarf_pressure_name", display_completion_ui = true, icon = "achievement_dwarf_pressure",
