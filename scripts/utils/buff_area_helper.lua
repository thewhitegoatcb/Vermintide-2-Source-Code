...
function BuffAreaHelper.setup_range_check(unit, buff, params, world)
	buff.range_check = { update_time = 0,
		units_in_range = { },
...
function BuffAreaHelper.update_range_check(unit, buff, params, world)
...
function BuffAreaHelper.destroy_range_check(unit, buff, params, world)
	local buff_template = buff.template
	local range_check_template = buff_template.range_check
	local range_check_state = buff.range_check
