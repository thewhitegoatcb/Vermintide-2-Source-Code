...
local scenegraph_definition = {
	root = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.chat } },
	icon_slot_1 = { vertical_alignment = "top", parent = "root", horizontal_alignment = "left", size = { 24, 25 }, position = { 140, -54, 1 } },
	icon_slot_2 = { vertical_alignment = "bottom", parent = "icon_slot_1", horizontal_alignment = "center", size = { 24, 25 }, position = { 0, -30, 0 } },
	icon_slot_3 = { vertical_alignment = "bottom", parent = "icon_slot_2", horizontal_alignment = "center", size = { 24, 25 }, position = { 0, -30, 0 } },
	icon_slot_4 = { vertical_alignment = "bottom", parent = "icon_slot_3", horizontal_alignment = "center", size = { 24, 25 }, position = { 0, -30, 0 } },
	name_slot_1 = { vertical_alignment = "center", parent = "icon_slot_1", horizontal_alignment = "left", size = { 400, 24 }, position = { 25, 0, 0 } },
	name_slot_2 = { vertical_alignment = "center", parent = "icon_slot_2", horizontal_alignment = "left", size = { 400, 24 }, position = { 25, 0, 0 } },
	name_slot_3 = { vertical_alignment = "center", parent = "icon_slot_3", horizontal_alignment = "left", size = { 400, 24 }, position = { 25, 0, 0 } },
	name_slot_4 = { vertical_alignment = "center", parent = "icon_slot_4", horizontal_alignment = "left", size = { 400, 24 }, position = { 25, 0, 0 } },
	bg_slot_1 = { vertical_alignment = "center", parent = "icon_slot_1", horizontal_alignment = "left", size = { 250, 25 }, position = { -5, 0, -1 } },
	bg_slot_2 = { vertical_alignment = "center", parent = "icon_slot_2", horizontal_alignment = "left", size = { 250, 25 }, position = { -5, 0, -1 } },
	bg_slot_3 = { vertical_alignment = "center", parent = "icon_slot_3", horizontal_alignment = "left", size = { 250, 25 }, position = { -5, 0, -1 } },
	bg_slot_4 = { vertical_alignment = "center", parent = "icon_slot_4", horizontal_alignment = "left", size = { 250, 25 }, position = { -5, 0, -1 } } }
...
local name_style = { vertical_alignment = "center", font_size = 18, localize = false, horizontal_alignment = "left", word_wrap = false, font_type = "hell_shark",
...
function VoiceChatUI:init(ingame_ui_context)
...
function VoiceChatUI:set_input_manager(input_manager)
	self.input_manager = input_manager
end

function VoiceChatUI:create_ui_elements()
...
function VoiceChatUI:_update_timer()
	self._timer = Application.time_since_launch()
end

function VoiceChatUI:_update_safe_rect()
	if IS_PS4 then
...
function VoiceChatUI:_gather_members(members_table)
...
function VoiceChatUI:_update_talking_state(members_table)
...
function VoiceChatUI:_update_widgets()
...
local MEMBERS_TABLE = { }
function VoiceChatUI:update(dt)
