...
local RPCS = { "rpc_set_projectile_state", "rpc_projectile_stick_unit", "rpc_projectile_stick_position", "rpc_hot_join_sync_projectile_sticky" }
...
local extensions = { "ProjectilePhysicsHuskLocomotionExtension", "ProjectilePhysicsUnitLocomotionExtension", "ProjectileScriptUnitLocomotionExtension", "ProjectileTrueFlightLocomotionExtension", "ProjectileHomingSkullLocomotionExtension", "ProjectileExtrapolatedHuskLocomotionExtension", "ProjectileStickyLocomotion", "ProjectileEtherealSkullLocomotionExtension" }
...
function ProjectileLocomotionSystem:init(entity_system_creation_context, name)
...
function ProjectileLocomotionSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function ProjectileLocomotionSystem:on_remove_extension(unit, extension_name, ...)
...
function ProjectileLocomotionSystem:update(dt, t)
...
function ProjectileLocomotionSystem:destroy()
	self.network_event_delegate:unregister(self)
end


function ProjectileLocomotionSystem:_server_sync_position_rotation(dt, t)
...
function ProjectileLocomotionSystem:_client_validate_position_rotation(dt, t)
	local game = Managers.state.network:game()
	if game then
		local POSITION_LOOKUP = POSITION_LOOKUP
...
function ProjectileLocomotionSystem:rpc_set_projectile_state(channel_id, projectile_unit_id, state_id)
...
function ProjectileLocomotionSystem:rpc_projectile_stick_unit(channel_id, projectile_unit_id, stick_unit_id)
	local projectile_unit = self.unit_storage:unit(projectile_unit_id)
	local extension = ScriptUnit.extension(projectile_unit, "projectile_locomotion_system")
...
function ProjectileLocomotionSystem:rpc_projectile_stick_position(channel_id, projectile_unit_id, stick_position)
	local projectile_unit = self.unit_storage:unit(projectile_unit_id)
	local extension = ScriptUnit.extension(projectile_unit, "projectile_locomotion_system")
...
function ProjectileLocomotionSystem:rpc_hot_join_sync_projectile_sticky(channel_id, projectile_unit_id, time_lived, time_stopped)
	local projectile_unit = self.unit_storage:unit(projectile_unit_id)
