...
function WwiseUtils.trigger_position_event(world, event, position)
...
function WwiseUtils.trigger_unit_event(world, event, unit, node_id)
...
function WwiseUtils.make_position_auto_source(world, position)
...
function WwiseUtils.make_unit_auto_source(world, unit, node_id)
	local wwise_world = Managers.world:wwise_world(world)
...
function WwiseUtils.make_unit_manual_source(wwise_world, unit, node_id)
	local source = nil
