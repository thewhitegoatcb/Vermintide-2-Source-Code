return { description = "description_mutator_chaos_warrior_trickle", icon = "mutator_icon_powerful_elites", display_name = "display_name_mutator_chaos_warrior_trickle",
