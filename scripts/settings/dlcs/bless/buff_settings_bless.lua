...
settings.buff_templates = {
	...
	victor_priest_activated_ability_invincibility = { activation_sound = "career_ability_priest_buff_shield",
		...
		buffs = { { apply_buff_func = "victor_priest_on_career_skill_applied", name = "victor_priest_activated_ability_invincibility", icon = "victor_priest_activated_ability", update_func = "victor_priest_on_career_skill_update", refresh_durations = true, remove_buff_func = "victor_priest_on_career_skill_removed", priority_buff = true, max_stacks = 1, duration = 5, reapply_buff_func = "victor_priest_on_career_skill_applied",
			...
			{ stagger_distance = 1, name = "victor_priest_6_1_pulse_attack", push_radius = 3.5, buff_func = "victor_priest_6_1_pulse_attack", event = "on_melee_hit", duration = 5,
	...
	victor_priest_activated_noclip = {
		buffs = { { stagger_distance = 1, name = "victor_priest_activated_noclip", push_cooldown = 1, push_radius = 1.5, refresh_durations = true, apply_buff_func = "victor_priest_activated_noclip_apply", remove_buff_func = "victor_priest_activated_noclip_remove", duration = 5, max_stacks = 1, update_func = "victor_priest_activated_noclip_update", update_frequency = 0.1,
	...
	victor_priest_passive_smite_upgraded = {
		buffs = { { name = "victor_priest_passive_smite", duration = 0.3, damage_profile = "light_push", remove_buff_func = "victor_priest_activated_ability_aftershock_update",
