...
local scenegraph_definition = {
	...
	window_frame = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { window_size [1] * 2 + window_spacing, window_size [2] }, position = { 0, 0, 1 } },
	title_text_glow = { vertical_alignment = "top", parent = "window_frame", horizontal_alignment = "center", size = { 544, 16 }, position = { 0, 15, -1 } },
	...
	reward_window = { vertical_alignment = "top", parent = "window_frame", horizontal_alignment = "right", size = { 450, 500 }, position = { -50, -100, 1 } },
	reward_title_text = { vertical_alignment = "top", parent = "reward_window", horizontal_alignment = "center", size = { 450, 50 }, position = { 0, 0, 1 } },
	reward_description_text = { vertical_alignment = "top", parent = "reward_window", horizontal_alignment = "center", size = { 400, 225 }, position = { 0, -50, 1 } },
	reward_portrait_root = { vertical_alignment = "center", parent = "reward_window", horizontal_alignment = "center", size = { 0, 0 }, position = { 0, 0, 5 } },
	reward_item_text_detail = { vertical_alignment = "top", parent = "reward_portrait_root", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, -120, 10 } },
	reward_item_text = { vertical_alignment = "center", parent = "reward_item_text_detail", horizontal_alignment = "center", size = { 400, 0 }, position = { 0, 30, 1 } },

	info_window = { vertical_alignment = "top", parent = "window_frame", horizontal_alignment = "left", size = { 450, 500 }, position = { 50, -100, 1 } },
	info_title_text = { vertical_alignment = "top", parent = "info_window", horizontal_alignment = "center", size = { 450, 50 }, position = { 0, 0, 1 } },
	info_description_text = { vertical_alignment = "top", parent = "info_window", horizontal_alignment = "center", size = { 400, 225 }, position = { 0, -50, 1 } },

	prestige_button = { vertical_alignment = "bottom", parent = "window_frame", horizontal_alignment = "center", size = { 370, 70 }, position = { 0, 30, 1 } },
	impact_title_text = { vertical_alignment = "bottom", parent = "info_window", horizontal_alignment = "center", size = { 400, 50 }, position = { 0, 200, 1 } },
	impact_description_text = { vertical_alignment = "bottom", parent = "info_window", horizontal_alignment = "center", size = { 400, 50 }, position = { 0, 150, 1 } },

	unable_description_text = { vertical_alignment = "bottom", parent = "window_frame", horizontal_alignment = "center", size = { 800, 50 }, position = { 0, 130, 1 } },


	warning_popup_background = { vertical_alignment = "center", parent = "menu_root", horizontal_alignment = "center", size = { 800, 700 }, position = { 0, 0, 25 } },
	warning_popup_title_text = { vertical_alignment = "top", parent = "warning_popup_background", horizontal_alignment = "center", size = { 800, 50 }, position = { 0, 0, 2 } },
	warning_popup_desc = { vertical_alignment = "top", parent = "warning_popup_background", horizontal_alignment = "center", size = { 750, 650 }, position = { 0, -100, 2 } },
	warning_popup_accept_button = { vertical_alignment = "bottom", parent = "warning_popup_background", horizontal_alignment = "center", size = { 280, 70 }, position = { -200, 50, 2 } },
	warning_popup_decline_button = { vertical_alignment = "bottom", parent = "warning_popup_background", horizontal_alignment = "center", size = { 280, 70 }, position = { 200, 50, 2 } },

	debug_level_up_button = { vertical_alignment = "top", parent = "window_frame", horizontal_alignment = "center", size = { window_size [1] * 2 + window_spacing, 35 }, position = { 0, -5, 2 } } }
...
local reward_title_text_style = { word_wrap = true, upper_case = true, localize = false, font_size = 28, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local description_text_style = { vertical_alignment = "top", font_size = 18, localize = false, horizontal_alignment = "center", word_wrap = true, font_type = "hell_shark",
...
local impact_text_style = { word_wrap = true, upper_case = true, localize = false, font_size = 24, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark",
...
local unable_description_text_style = { word_wrap = true, upper_case = true, localize = false, font_size = 24, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark",
...
local function talent_row(scenegraph_id, size, amount, optional_color_name)
	...
	for k = 1, amount do
		...
		style [title_text_name] = { word_wrap = true, font_size = 18, localize = false, horizontal_alignment = "left", vertical_alignment = "center", font_type = "hell_shark",
			...
			offset = { offset [1] + 100, offset [2], 2 } }
		...
		style [title_text_shadow_name] = { word_wrap = true, font_size = 18, localize = false, horizontal_alignment = "left", vertical_alignment = "center", font_type = "hell_shark",
			...
			text_color = Colors.get_color_table_with_alpha("black", 255),
			size = { button_size [1] - 100, button_size [2] },
			offset = { offset [1] + 100 + 2, offset [2] - 2, 1 } }
		...
		style [glass_top_name] = {
			...
			color = { 255, 255, 255, 255 },
			offset = { offset [1], offset [2] + button_size [2] - 3, 1 } }
		...
		style [icon_name] = {
			...
			offset = { offset [1] + 10, offset [2] + button_size [2] / 2 - icon_size [2] / 2, 2 } }
		...
		style [icon_frame_name] = {
			size = icon_size,
			color = Colors.get_color_table_with_alpha("white", 255),
			offset = { offset [1] + 10, offset [2] + button_size [2] / 2 - icon_size [2] / 2, 3 } }
...
local widgets = {
	...
	info_window = UIWidgets.create_simple_rect("info_window", { 100, 0, 0, 0 }),
	...
	reward_window = UIWidgets.create_simple_rect("reward_window", { 100, 0, 0, 0 }),
