...
BenchmarkSettings = { cycle_view_time = 30, main_path_teleport_time = 2, initial_cycle_time = 30, debug = false, bot_selection_timer = 3, cycle_views = true, overview_downtime = 60, attract_benchmark = false, overview_duration = 10, cycle_time = 90, is_story_based = true, destroy_close_enemies_radius = 20, auto_host_level = "military", bot_damage_multiplier = 5, game_seed = 846387, destroy_close_enemies_timer = 90,
	...
	parameters = { hide_fps = true, network_debug = false, disable_tutorial_at_start = true, disable_gutter_runner = true, hide_version_info = true, network_debug_connections = false, honduras_demo = false, spawn_empty_chest = true, disable_debug_draw = true, disable_pack_master = true, network_log_messages = false, disable_intro_trailer = true, force_steam = true, debug_interactions = false, screen_space_player_camera_reactions = false, infinite_ammo = true, player_invincible = true, wanted_profile = "empire_soldier_tutorial" },
	...
	attract_mode_settings = { display_name = "intel_loading_screen_attract_mode",

		loading_screen_wwise_events = { } },


	benchmark_mode_settings = { display_name = "intel_loading_screen_benchmark_mode",
...
function BenchmarkSettings.demo_mode_overrides()
	...
	if DEMO_MODE then
		...
		SpecialsSettings.chaos.breeds = { "skaven_pack_master", "skaven_gutter_runner", "skaven_warpfire_thrower" }
	end
