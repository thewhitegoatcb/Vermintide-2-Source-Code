...
function BTPackMasterSkulkAroundAction:init(...)
...
function BTPackMasterSkulkAroundAction:enter(unit, blackboard, t)
...
function BTPackMasterSkulkAroundAction:leave(unit, blackboard, t, reason, destroy)
...
function BTPackMasterSkulkAroundAction:run(unit, blackboard, t, dt)
...
function BTPackMasterSkulkAroundAction:get_new_goal(unit, blackboard)
...
function BTPackMasterSkulkAroundAction:debug(unit, blackboard)
