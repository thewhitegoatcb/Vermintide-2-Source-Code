...
function StateTitleScreenLoadSave:_handle_tutorial_auto_start()
...
function StateTitleScreenLoadSave:_setup_init_network_view()
...
function StateTitleScreenLoadSave:cb_fade_in_done(wanted_state)
	self.parent.state = wanted_state
end

function StateTitleScreenLoadSave:on_exit(application_shutdown) return end