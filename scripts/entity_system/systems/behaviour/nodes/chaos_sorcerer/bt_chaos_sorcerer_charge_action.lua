...
function BTChaosSorcererChargeAction:init(...)
...
function BTChaosSorcererChargeAction:enter(unit, blackboard, t)
...
function BTChaosSorcererChargeAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChaosSorcererChargeAction:run(unit, blackboard, t, dt)
...
function BTChaosSorcererChargeAction:_start_charging(unit, blackboard)
...
function BTChaosSorcererChargeAction:_start_lunge(unit, blackboard, lunge_data, distance_to_target, t)
	...
	local lunge_animation = lunge_data.animations and
	lunge_data.animations [distance_identifier]
...
function BTChaosSorcererChargeAction:_start_impact(unit, blackboard, hit_target, hit_wall, hit_target_blocked, target_avoided_attack)
...
function BTChaosSorcererChargeAction:_start_align_to_target(unit, blackboard)
	local action = blackboard.action
...
function BTChaosSorcererChargeAction:_cancel_charge(unit, blackboard)
...
function BTChaosSorcererChargeAction:_check_lunge(unit, blackboard, t)
	local action = blackboard.action
...
function BTChaosSorcererChargeAction:_check_overlap(unit, blackboard, action)
	local t = Managers.time:time("game")
...
function BTChaosSorcererChargeAction:_charged_at_player(unit, hit_unit, blackboard, action)
...
function BTChaosSorcererChargeAction:_push_player(unit, hit_unit, blackboard, action, blocked)
	local to_hit_unit = POSITION_LOOKUP [hit_unit] - POSITION_LOOKUP [unit]
...
function BTChaosSorcererChargeAction:_hit_player(unit, blackboard, hit_unit, action, attack_direction)
	local hit_attacking_target = hit_unit == blackboard.charge_target_unit
...
function BTChaosSorcererChargeAction:_hit_ai(unit, hit_unit, action, blackboard, t)
...
function BTChaosSorcererChargeAction:_run_starting(unit, blackboard)
...
function BTChaosSorcererChargeAction:_run_charging(unit, blackboard, t, dt)
	local action = blackboard.action
...
function BTChaosSorcererChargeAction:_run_lunge(unit, blackboard, lunge_data, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
...
function BTChaosSorcererChargeAction:_run_impact(unit, blackboard, t, dt)
...
function BTChaosSorcererChargeAction:_run_cancel(unit, blackboard, t, dt)
...
function BTChaosSorcererChargeAction:_pick_distance_identifier(distance_threshold_table, distance)
...
function BTChaosSorcererChargeAction:_slow_down(unit, blackboard, slow_down_speed, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
	local current_velocity = locomotion_extension:current_velocity()
...
function BTChaosSorcererChargeAction:_get_turn_slowdown_percentage(unit, blackboard, dt, direction)
	local action = blackboard.action
...
function BTChaosSorcererChargeAction:anim_cb_start_finished(unit, blackboard)
...
function BTChaosSorcererChargeAction:anim_cb_charge_charging_finished(unit, blackboard)
...
function BTChaosSorcererChargeAction:anim_cb_charge_impact_finished(unit, blackboard)
...
function BTChaosSorcererChargeAction:anim_cb_attack_finished(unit, blackboard)
...
function BTChaosSorcererChargeAction:anim_cb_disable_charge_collision(unit, blackboard)
