...
function UIWidgetUtils.animate_default_button(widget, dt)
...
function UIWidgetUtils.animate_default_icon_tabs(widget, dt)
	local content = widget.content
	local style = widget.style
...
function UIWidgetUtils.animate_default_checkbox_button(widget, dt)
	local content = widget.content
	local style = widget.style
...
function UIWidgetUtils.animate_default_checkbox_button_console(widget, dt)
	local content = widget.content
	local style = widget.style
...
function UIWidgetUtils.animate_default_text_tabs(widget, dt)
	local content = widget.content
	local style = widget.style
	local amount = content.amount
...
function UIWidgetUtils.animate_option_button(widget, dt)
	local content = widget.content
	local style = widget.style
	local hotspot = content.button_hotspot
...
function UIWidgetUtils.animate_start_game_console_setting_button(widget, dt)
	local content = widget.content
	local style = widget.style
...
function UIWidgetUtils.animate_arrow_button(widget, dt)
	local content = widget.content
	local style = widget.style
...
function UIWidgetUtils.animate_icon_button(widget, dt)
	local content = widget.content
	local style = widget.style
	local hotspot = content.hotspot or content.button_hotspot
	local has_focus = content.has_focus
	...
	Colors.lerp_color_tables(
	texture_hover_style.default_color,
	texture_hover_style.hover_color,
	combined_progress,

	texture_hover_style.color)


	local texture_icon_style = style.texture_icon
	Colors.lerp_color_tables(
	texture_icon_style.default_color,
	texture_icon_style.hover_color,
	combined_progress,

	texture_icon_style.color)
...
function UIWidgetUtils.animate_play_button(widget, dt)
	local content = widget.content
	local style = widget.style
	local hotspot = content.button_hotspot
...
function UIWidgetUtils.get_level_frame_by_difficulty_index(difficulty_index)
...
function UIWidgetUtils.animate_game_option_button(widget, dt)
