...
function BTSelector_shield_vermin:init(...)
	BTSelector_shield_vermin.super.init(self, ...)
	self._children = { }
end

function BTSelector_shield_vermin:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_shield_vermin:run(unit, blackboard, t, dt)
...
function BTSelector_shield_vermin:add_child(node)
