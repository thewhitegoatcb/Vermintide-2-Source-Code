...
function BTInGravityWellAction:init(...)
...
function BTInGravityWellAction:enter(unit, blackboard, t)
	...
	local _, actor_count = PhysicsWorld.immediate_overlap(physics_world,
	"position", overlap_pos,
	"rotation", overlap_rotation,
	"size", overlap_size,
	"shape", shape,
	"types", "both",
	"collision_filter", "filter_environment_overlap")
...
function BTInGravityWellAction:_set_wanted_velocity(dt, blackboard, self_pos)
	local locomotion_extension = blackboard.locomotion_extension
...
function BTInGravityWellAction:leave(unit, blackboard, t, reason, destroy)
...
function BTInGravityWellAction:run(unit, blackboard, t, dt)
