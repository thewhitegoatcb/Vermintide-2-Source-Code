...
function UnlockReminderPopup:create_ui_elements()
...
function UnlockReminderPopup:update(dt)
...
function UnlockReminderPopup:_handle_input(dt)
...
function UnlockReminderPopup:show()
	UnlockReminderPopup.super.show(self)
	self:_start_transition_animation("on_enter")
end

function UnlockReminderPopup:hide()
	self._exit_anim_id = self:_start_transition_animation("on_exit")
end

function UnlockReminderPopup:_start_transition_animation(animation_name)
...
function UnlockReminderPopup:_update_animations(dt)
...
function UnlockReminderPopup:should_show()
