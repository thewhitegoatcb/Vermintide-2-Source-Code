...
local RPCS = { "rpc_generic_interaction_request" }



local extensions = { "GenericUnitInteractableExtension" }



function InteractableSystem:init(entity_system_creation_context, system_name)
...
function InteractableSystem:destroy()
	self.network_event_delegate:unregister(self)
end

function InteractableSystem:update(context, t)
...
function InteractableSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function InteractableSystem:on_remove_extension(unit, extension_name)
	self.unit_extensions [unit] = nil
	InteractableSystem.super.on_remove_extension(self, unit, extension_name)
end

function InteractableSystem:_can_interact(interactor_unit, interactable_unit, interaction_type)
...
function InteractableSystem:_handle_standard_interact_request(interaction_type, sender, interactor_id, interactable_id, is_level_unit)
...
function InteractableSystem:rpc_generic_interaction_request(channel_id, interactor_go_id, interactable_go_id, is_level_unit, interaction_type_id)
