local scenegraph_definition = {
	...
	chest_title = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "center", size = { 1200, 50 }, position = { 0, -100, 1 } },
	chest_sub_title = { vertical_alignment = "top", parent = "chest_title", horizontal_alignment = "center", size = { 1200, 50 }, position = { 0, -40, 1 } },
	upgrade_root = { vertical_alignment = "center", parent = "chest_title", horizontal_alignment = "center", size = { 0, 0 }, position = { 0, -110, 5 } },
	upgrade_background = { vertical_alignment = "center", parent = "upgrade_root", horizontal_alignment = "center", size = { 500, 90 }, position = { 0, 0, 0 } },
	upgrade_divider = { vertical_alignment = "center", parent = "upgrade_root", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, -40, 2 } },
	upgrade_divider_glow = { vertical_alignment = "bottom", parent = "upgrade_divider", horizontal_alignment = "center", size = { 264, 80 }, position = { 0, 20, -1 } },

	right_side_root = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "right", size = { 0, 0 }, position = { -20, 0, 1 } },
	left_side_root = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "left", size = { 0, 0 }, position = { 20, 0, 1 } },

	score_bar_bg = { vertical_alignment = "bottom", parent = "score_entry_window", horizontal_alignment = "center", size = { 278, 30 }, position = { 0, -36, 1 } },
	score_bar = { vertical_alignment = "bottom", parent = "score_bar_bg", horizontal_alignment = "left", size = { 278, 30 }, position = { 0, 0, 2 } },
	score_bar_edge = { vertical_alignment = "center", parent = "score_bar", horizontal_alignment = "right", size = { 35, 30 }, position = { 35, 0, 3 } },

	background = { vertical_alignment = "bottom", parent = "score_bar_bg", horizontal_alignment = "center", size = { 820, 90 }, position = { 0, 38, -3 } },
	score_bar_fg = { vertical_alignment = "bottom", parent = "score_bar_bg", horizontal_alignment = "center", size = { 352, 134 }, position = { 0, -14, 8 } },
	score_bar_start = { vertical_alignment = "bottom", parent = "score_bar_bg", horizontal_alignment = "left", size = { 0, 0 }, position = { 0, 0, 3 } },
	score_entry_texture = { vertical_alignment = "top", parent = "score_bar_bg", horizontal_alignment = "center", size = { 0, 0 }, position = { 0, 80, 3 } },
	score_entry_bg_left = { vertical_alignment = "center", parent = "score_entry_texture", horizontal_alignment = "center", size = { 334, 60 }, position = { 0, 0, -1 } },
	score_entry_bg_right = { vertical_alignment = "center", parent = "score_entry_texture", horizontal_alignment = "center", size = { 334, 60 }, position = { 0, 0, -2 } },
	score_entry_text = { vertical_alignment = "center", parent = "score_entry_texture", horizontal_alignment = "left", size = { 800, 40 }, position = { 0, 0, 1 } },

	score_entry_window = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "left", size = { 360, 576 }, position = { 50, 50, 1 } },
	score_window_top_divider = { vertical_alignment = "top", parent = "score_entry_window", horizontal_alignment = "center", size = { 264, 32 }, position = { 0, 14, 1 } },

	score_entry_root = { vertical_alignment = "top", parent = "score_entry_window", horizontal_alignment = "left", size = { 300, 100 }, position = { 40, -10, 1 } } }


local upgrade_text_style = { word_wrap = false, upper_case = true, localize = false, use_shadow = true, font_size = 50, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local widgets = {
	...
	upgrade_background = UIWidgets.create_simple_texture("tab_menu_bg_02", "upgrade_background", nil, nil, { 0, 255, 255, 255 }),
	...
	score_bar = UIWidgets.create_simple_uv_texture("chest_upgrade_fill", { { 0, 0 }, { 1, 1 } }, "score_bar"),
	score_bar_fg = UIWidgets.create_simple_texture("chest_upgrade_fg", "score_bar_fg") }


local function create_bar_divider(icon_texture)
	return { scenegraph_id = "score_bar_start",
		element = {
			passes = { { pass_type = "rect", style_id = "divider" },
...
animation_definitions.score_entry_add = { { name = "icon_entry", start_progress = 0.3, end_progress = 0.6,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "icon_size", start_progress = 0.3, end_progress = 0.6,
...
animation_definitions.score_presentation_start = { { name = "highlight_start", start_progress = 0.5, end_progress = 0.8,
...
animation_definitions.score_presentation_end = { { name = "highlight_end", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "checkbox_enter", start_progress = 0.3, end_progress = 0.6,
...
animation_definitions.chest_title_initialize = { { name = "fade_in", start_progress = 0.5, end_progress = 0.9,
...
animation_definitions.chest_title_update = { { name = "upgrade_background_fade_in", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "upgrade_text_fade_in", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "upgrade_background_fade_out", start_progress = 0.8, end_progress = 1.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "upgrade_text_fade_out", start_progress = 0.9, end_progress = 1.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "title_fade_in", start_progress = 1.2, end_progress = 1.6,
