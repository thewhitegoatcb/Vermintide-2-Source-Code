...
function ActionCareerWEWaywatcherPiercing:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerWEWaywatcherPiercing:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerWEWaywatcherPiercing:_restore_ammo()
	local owner_unit = self.owner_unit
