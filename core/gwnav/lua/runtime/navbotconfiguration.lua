...
function NavBotConfiguration:get_configuration_value(default, ...)
	return NavHelpers.unit_script_data(self.unit, default, ...)
end

function NavBotConfiguration:init(bot_configuration_unit)
...
function NavBotConfiguration:configure_bot(bot)
	...
	bot:set_channel_config(self.channel_radius, self.turn_sampling_angle, self.channel_smoothing_angle, self.min_distance_between_gates, self.max_distance_between_gates)
...
function NavBotConfiguration:shutdown()
