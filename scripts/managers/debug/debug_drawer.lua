...
function DebugDrawer:line_object()
...
function DebugDrawer:sphere(center, radius, color, segments, parts)
	color = color or Color(255, 255, 255)
	LineObject.add_sphere(self._line_object, color, center, radius, segments or 20, parts or 2)
end

function DebugDrawer:capsule_overlap(position, size, rotation, color)
...
function DebugDrawer:oobb_overlap(position, size, rotation, color)
...
function DebugDrawer:cone(from, to, radius, color, segments, bars)
	color = color or Color(255, 255, 255)
	LineObject.add_cone(self._line_object, color, from, to, radius, segments, bars)
end

function DebugDrawer:circle(center, radius, normal, color, segments)
	color = color or Color(255, 255, 255)
	LineObject.add_circle(self._line_object, color, center, radius, normal, segments or 20)
end

function DebugDrawer:arrow_2d(from, to, color)
...
function DebugDrawer:cylinder(pos1, pos2, radius, color, segments)
	color = color or Color(255, 255, 255)
