...
function curse_change_of_tzeentch.server_start_function(context, data)
	base_splitting_enemies.server_start_function(context, data)
	data.seed = Managers.mechanism:get_level_seed("mutator")
end

function curse_change_of_tzeentch.server_ai_killed_function(context, data, killed_unit, killer_unit, death_data, killing_blow)
	local random = nil
...
function curse_change_of_tzeentch.on_split_enemy(killer_unit)
