...
function BTSetDefendPositionAction:init(...)
	BTSetDefendPositionAction.super.init(self, ...)
end

BTSetDefendPositionAction.name = "BTSetDefendPositionAction"

function BTSetDefendPositionAction:enter(unit, blackboard, t)
...
function BTSetDefendPositionAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.defend_get_in_position = nil
end

function BTSetDefendPositionAction:run(unit, blackboard, t)
...
function BTSetDefendPositionAction:find_move_pos(blackboard, action)
...
function BTSetDefendPositionAction:has_overlap_at_pos(position, blackboard, action)
