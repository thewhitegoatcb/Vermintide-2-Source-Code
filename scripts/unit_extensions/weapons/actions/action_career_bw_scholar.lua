...
function ActionCareerBWScholar:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerBWScholar:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerBWScholar:client_owner_post_update(dt, t, world, can_damage)
	ActionCareerBWScholar.super.client_owner_post_update(self, dt, t, world, can_damage)
end

function ActionCareerBWScholar:finish(reason)
...
function ActionCareerBWScholar:_play_vo()
	local owner_unit = self.owner_unit
