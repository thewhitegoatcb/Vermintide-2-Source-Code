...
function ImguiVersusCharacterPickingDebug:init()
	self._initialized = false
end

function ImguiVersusCharacterPickingDebug:_initialize()
...
function ImguiVersusCharacterPickingDebug:update()
...
function ImguiVersusCharacterPickingDebug:is_persistent()
	return true
end

function ImguiVersusCharacterPickingDebug:_same_line_dummy(x, y)
	Imgui.same_line()
	Imgui.dummy(x, y)
	Imgui.same_line()
end

function ImguiVersusCharacterPickingDebug:draw(is_open)
...
function ImguiVersusCharacterPickingDebug:_draw_settings()
	Imgui.text("Settings")
	Imgui.indent()
...
function ImguiVersusCharacterPickingDebug:_draw_time_settings()
...
function ImguiVersusCharacterPickingDebug:_draw_timer()
	Imgui.text("Timer")
	Imgui.indent()
...
function ImguiVersusCharacterPickingDebug:_draw_selection_settings()
...
function ImguiVersusCharacterPickingDebug:_draw_party_data()
...
function ImguiVersusCharacterPickingDebug:_draw_player_data()
	local pick_data_per_party = self._pick_data_per_party
...
function ImguiVersusCharacterPickingDebug:_draw_pick_data()
	local pick_data_per_party = self._pick_data_per_party
	Imgui.unindent()
	for party_id, data in ipairs(pick_data_per_party) do
		...
		if Imgui.tree_node("Available Characters") then
			...
			for profile_id, careers in ipairs(available_characters) do --[[ Nothing --]]
			end
