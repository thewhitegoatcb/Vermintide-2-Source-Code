...
DamageWaveTemplates = {
	...
	templates = {
		plague_wave_teleport = { trigger_dialogue_on_impact = true, stop_running_wave_sound = "Stop_magic_plague_wave_loop", buff_wave_impact_name = "plague_wave_face_base", create_bot_aoe_threat = true, launch_wave_sound = "Play_magic_plague_wave", fx_unit = "units/beings/enemies/chaos_sorcerer_fx/chr_chaos_sorcerer_fx", start_speed = 5, max_speed = 10, fx_name_arrived = "fx/chaos_sorcerer_plague_wave_hit_01", apply_buff_to_player = true, fx_separation_dist = 1.5, running_wave_sound = "Play_magic_plague_wave_loop", max_height = 2.5, fx_name_running = "fx/chaos_sorcerer_plauge_wave_01", ai_query_distance = 0.8, launch_animation = "wave_summon_release", acceleration = 10, overflow_dist = 5, player_query_distance = 0.8, particle_arrived_stop_mode = "stop", apply_impact_buff_to_ai = false, impact_wave_sound = "Play_magic_plague_wave_hit", damage_friendly_ai = true, apply_buff_to_ai = true, time_of_life = 10, use_nav_cost_map_volumes = false, fx_name_impact = "fx/plague_wave_03", nav_cost_map_cost_type = "plague_wave", apply_impact_buff_to_player = true, fx_name_init = "fx/chaos_sorcerer_plauge_wave_02",
			...
			immune_breeds = { chaos_troll = true, chaos_spawn = true, skaven_grey_seer = true, chaos_plague_sorcerer = true, chaos_exalted_sorcerer = true, skaven_rat_ogre = true, skaven_stormfiend = true },
			...
			ai_push_data = { stagger_distance = 3, push_along_wave_direction = true,
				stagger_impact = {
				...
				stagger_duration = { 2.5, 1, 0, 0, 4 } },



			player_push_data = { ahead_dist = 1.5, push_forward_offset = 1.5, push_width = 1.25, player_pushed_speed = 20, dodged_width = 0.5 } },
		...
		plague_wave = { trigger_dialogue_on_impact = true, stop_running_wave_sound = "Stop_magic_plague_wave_loop", buff_wave_impact_name = "plague_wave_face_base", create_bot_aoe_threat = true, launch_wave_sound = "Play_magic_plague_wave", fx_unit = "units/beings/enemies/chaos_sorcerer_fx/chr_chaos_sorcerer_fx", start_speed = 10, max_speed = 20, fx_name_arrived = "fx/chaos_sorcerer_plague_wave_hit_01", apply_buff_to_player = true, fx_separation_dist = 1.5, running_wave_sound = "Play_magic_plague_wave_loop", max_height = 2.5, fx_name_running = "fx/chaos_sorcerer_plauge_wave_01", ai_query_distance = 0.8, launch_animation = "wave_summon_release", acceleration = 15, overflow_dist = 5, player_query_distance = 0.8, particle_arrived_stop_mode = "stop", apply_impact_buff_to_ai = false, impact_wave_sound = "Play_magic_plague_wave_hit", damage_friendly_ai = true, apply_buff_to_ai = true, time_of_life = 10, use_nav_cost_map_volumes = false, fx_name_impact = "fx/plague_wave_03", nav_cost_map_cost_type = "plague_wave", apply_impact_buff_to_player = true, fx_name_init = "fx/chaos_sorcerer_plauge_wave_02",
		...
		pattern_plague_wave = { fx_separation_dist = 1.5, max_speed = 15, fx_unit = "units/beings/enemies/chaos_sorcerer_fx/chr_chaos_sorcerer_fx", launch_animation = "wave_summon_release", buff_wave_impact_name = "plague_wave_face_base", overflow_dist = 5, fx_name_running = "fx/chaos_sorcerer_plauge_wave_01", fx_name_arrived = "fx/chaos_sorcerer_plague_wave_hit_01", start_speed = 10, particle_arrived_stop_mode = "stop", player_query_distance = 0.8, apply_buff_to_player = false, launch_wave_sound = "Play_magic_plague_wave", running_wave_sound = "Play_magic_plague_wave_loop", apply_impact_buff_to_ai = false, max_height = 2.5, impact_wave_sound = "Play_magic_plague_wave_hit", damage_friendly_ai = true, apply_buff_to_ai = false, time_of_life = 3, acceleration = 8, stop_running_wave_sound = "Stop_magic_plague_wave_loop", use_nav_cost_map_volumes = false, ai_query_distance = 0.8, fx_name_impact = "fx/plague_wave_03", nav_cost_map_cost_type = "plague_wave", apply_impact_buff_to_player = true, fx_name_init = "fx/chaos_sorcerer_plauge_wave_02",
			...
			immune_breeds = { chaos_troll = true, chaos_spawn = true, chaos_exalted_sorcerer = true, chaos_plague_sorcerer = true, skaven_rat_ogre = true, skaven_stormfiend = true },
			...
			player_push_data = { ahead_dist = 1.5, push_forward_offset = 1.5, push_width = 1.25, player_pushed_speed = 17, dodged_width = 0.5 } },
		...
		vermintide = { fx_separation_dist = 1.5, max_speed = 25, fx_unit = "units/hub_elements/empty", acceleration = 25, buff_wave_impact_name = "vermintide_face_base", overflow_dist = 5, fx_name_running = "fx/chr_grey_seer_lightning_wave_01", fx_name_arrived = "fx/chr_grey_seer_lightning_hit_02", start_speed = 12, particle_arrived_stop_mode = "stop", player_query_distance = 1, apply_buff_to_player = true, create_bot_aoe_threat = true, running_wave_sound = "Play_emitter_grey_seer_electric_ground_wave", apply_impact_buff_to_ai = false, max_height = 2.5, stop_running_wave_sound = "Stop_emitter_grey_seer_electric_ground_wave", damage_friendly_ai = true, apply_buff_to_ai = true, time_of_life = 10, trigger_dialogue_on_impact = true, use_nav_cost_map_volumes = false, ai_query_distance = 1, fx_name_impact = "fx/chr_grey_seer_lightning_hit_01", nav_cost_map_cost_type = "plague_wave", apply_impact_buff_to_player = true, fx_name_init = "fx/chr_grey_seer_lightning_init_01",
...
DamageWaveTemplates.templates.sienna_adept_ability_trail = { fx_separation_dist = 0.45, max_speed = 100, ignore_obstacles = true, acceleration = 100, overflow_dist = 0, buff_template_name = "sienna_adept_ability_trail", start_speed = 15, fx_name_running = "fx/brw_adept_skill_02", player_query_distance = 1, apply_buff_to_player = true, blob_separation_dist = 1, fx_name_impact = "fx/brw_adept_skill_02", apply_impact_buff_to_ai = false, max_height = 2.5, fx_name_arrived = "fx/brw_adept_skill_02", fx_name_filled = "fx/brw_adept_skill_02", apply_buff_to_ai = true, time_of_life = 6, particle_arrived_stop_mode = "stop", launch_wave_sound = "Play_sienna_adept_blink_ability", ai_query_distance = 2, buff_template_type = "sienna_adept_ability_trail", apply_impact_buff_to_player = false, fx_name_init = "fx/brw_adept_skill_02",
...
DamageWaveTemplates.templates.thornsister_thorn_wall_push = { launch_wave_sound = "career_ability_kerilian_thorngrasp", max_speed = 10, ignore_obstacles = true, time_of_life = 6, acceleration = 100, overflow_dist = 0.2, fx_name_running = "fx/thorn_vines", particle_arrived_stop_mode = "stop", start_speed = 10, fx_unit = "units/hub_elements/empty", player_query_distance = 1.5, apply_buff_to_player = false, apply_impact_buff_to_ai = false, max_height = 2.5, damage_friendly_ai = true, apply_buff_to_ai = false, create_blobs = false, is_transient = true, transient_name_override = "units/beings/player/way_watcher_thornsister/abilities/ww_thornsister_thorn_wave_01", ai_query_distance = 1.5, apply_impact_buff_to_player = false,
	...
	ai_push_data = { push_along_wave_direction = true, drag_along_wave = true,
		stagger_impact = {
			stagger_types.heavy,
			stagger_types.heavy,
			stagger_types.heavy,
		...
		stagger_duration = { 0.5, 0.5, 0.5, 0, 0.5, 0.5 },
		...
		stagger_refresh_time = { 0.5, 0.5, 0.5,
		...
		stagger_distance_table = { 0.5, 0.5, 0.5, 0.5, 0.5, 1 },
		...
		wave_drag_multiplier_table = { 1, 0.1, 1, 0, 1, 0 } },
...
DamageWaveTemplates.templates.necromancer_curse_wave = { stop_running_wave_sound = "Stop_career_necro_ability_withering_wave_loop", max_speed = 4, ignore_obstacles = true, num_waves = 1, acceleration = 0, overflow_dist = 0.2, buff_wave_impact_name = "sienna_necromancer_career_skill_on_hit_damage", fx_name_running = "fx/necromancer_wave", start_speed = 4, particle_arrived_stop_mode = "stop", player_query_distance = 2.2, apply_buff_to_player = false, running_wave_sound = "Play_career_necro_ability_withering_wave_loop", apply_impact_buff_to_ai = true, max_height = 2.5, fx_unit = "units/hub_elements/empty", damage_friendly_ai = false, apply_buff_to_ai = false, time_of_life = 3.5, spawn_separation_dist = 0.4, target_separation_dist = 1.5, apply_impact_buff_to_player = false,
	...
	running_spawn_config = { { separation_type = "box", spawn_type = "unit", start_delay = 0, max_random_angle = 0, frequency = 1,


			names = { "units/decals/necromancer_ability_decal" },
		...
		{ separation_type = "box", spawn_type = "unit", start_delay = 0, max_random_angle = 0, frequency = 0.5,


			names = { "units/decals/necromancer_ability_decal_mark1", "units/decals/necromancer_ability_decal_mark2", "units/decals/necromancer_ability_decal_mark3", "units/decals/necromancer_ability_decal_mark4", "units/decals/necromancer_ability_decal_mark5", "units/decals/necromancer_ability_decal_mark6" },
		...
		{ separation_type = "box", spawn_type = "unit", start_delay = 0.25, max_random_angle = 0, frequency = 0.5,
	...
	ai_push_data = { push_along_wave_direction = true, drag_along_wave = false,
		stagger_impact = {
			stagger_types.heavy,
			stagger_types.heavy,
			stagger_types.heavy,
		...
		stagger_duration = { 0.7, 0.7, 0, 0, 0.7, 0.5 },
		...
		wave_drag_multiplier_table = { 1, 0.1, 0, 0, 1, 0 },
	...
	update_func = function (damage_wave_ext, unit, position, t, dt)
		...
		if not update_data then
			...
			update_data = { next_spawn_t = 0, failed_attempts = 0, next_direction_update_t = 0,
...
function wave_linger.add_buff_func(damage_wave_ext, target_unit, buff_template_name, attacker_unit, source_unit)
...
function wave_linger.leave_area_func(unit)
	if ALIVE [unit] then
		local buff_extension = ScriptUnit.extension(unit, "buff_system")
...
for wave_name, wave_template in pairs(DamageWaveTemplates.templates) do
	...
	if hit_half_extends then
		...
		wave_template.ai_query_distance = Vector3.length(extends) end end