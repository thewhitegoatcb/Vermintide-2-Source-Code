...
local weapon_template = {
	actions = {
		action_one = {
			default = { kind = "melee_start", weapon_action_hand = "left",
				total_time = math.huge,



				allowed_chain_actions = { { sub_action = "dummy_action", start_time = 0, action = "action_one", end_time = 0.4, input = "action_one_release" },
					{ sub_action = "action_throw", start_time = 0.5, action = "action_one", auto_chain = true } } },



			dummy_action = { kind = "dummy", weapon_action_hand = "left", total_time = 0,
			...
			action_throw = { kind = "throw_grimoire", ammo_usage = 1, anim_end_event = "attack_finished", anim_event = "attack_throw", weapon_action_hand = "left", total_time = 0.7,
	...
	attack_meta_data = {
		...
		hold_attack = { arc = 0, penetrating = false,
			...
			attack_chain = { start_sub_action_name = "default", start_action_name = "action_one",
				...
				transitions = {
					action_one = {
						default = { wanted_sub_action_name = "action_throw", wanted_action_name = "action_one", bot_wait_input = "hold_attack", bot_wanted_input = "hold_attack" } } } } } } }
...
wpn_side_objective_tome_01.pickup_data = { pickup_name = "tome" }
...
geheimnisnacht_2021_side_objective.actions = {
	action_one = {
		...
		action_throw = { kind = "throw_geheimnisnacht_2021", ammo_usage = 1, anim_end_event = "attack_finished", anim_event = "attack_throw", weapon_action_hand = "left", total_time = 1.6,
	...
	action_two = {
		default = { minimum_hold_time = 0.3, anim_end_event = "inspect_end", cooldown = 0.15, weapon_action_hand = "either", can_abort_reload = false, kind = "inspect_geheimnisnacht_2021", hold_input = "action_two_hold", anim_event = "inspect_start",
...
geheimnisnacht_2021_side_objective.wield_anim_career = { bw_necromancer = "to_ritual_skull_immune", wh_priest = "to_ritual_skull_immune", we_thornsister = "to_ritual_skull_immune", es_questingknight = "to_ritual_skull_immune", dr_slayer = "to_ritual_skull_immune" }
...
geheimnisnacht_2021_side_objective.wield_anim_career_3p = { bw_necromancer = "to_ritual_skull", wh_priest = "to_ritual_skull", we_thornsister = "to_ritual_skull", es_questingknight = "to_ritual_skull", dr_slayer = "to_ritual_skull" }
