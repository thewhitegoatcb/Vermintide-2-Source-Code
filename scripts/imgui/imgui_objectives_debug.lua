...
function ImguiObjectivesDebug:init()
	self._objectives = { }
	self._timer = 0
...
function ImguiObjectivesDebug:_initialize()
...
function ImguiObjectivesDebug:update()
...
function ImguiObjectivesDebug:_update_versus()
...
function ImguiObjectivesDebug:is_persistent()
	return true
end

function ImguiObjectivesDebug:_temp(data, current_objectives, depth)
	depth = depth or 1
...
function ImguiObjectivesDebug:_same_line_dummy(x, y)
	Imgui.same_line()
	Imgui.dummy(x, y)
	Imgui.same_line()
end

function ImguiObjectivesDebug:_draw_versus(is_open)
	Imgui.text("Timer")
	Imgui.indent()
...
function ImguiObjectivesDebug:draw(is_open)
