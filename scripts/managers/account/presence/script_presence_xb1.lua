...
PRESENCE_LUT = { playing = "update_playing", menu = "update_menu", none = "update_none" }
...
function ScriptPresence:set_presence(presence)
...
function ScriptPresence:update(dt)
...
function ScriptPresence:update_none(user_id)
...
function ScriptPresence:update_menu(user_id)
...
function ScriptPresence:update_playing(user_id)
...
function ScriptPresence:_extract_stat_data(current_level, current_difficulty, current_num_players)
	local data = { }
...
function ScriptPresence:_has_new_data(current_level, current_difficulty, current_num_players, is_private)
...
function ScriptPresence:_setup_stat_data(current_level, current_difficulty, current_num_players, is_private)
...
function ScriptPresence:destroy()
	local account_manager = Managers.account
...
function ScriptPresence:_set_presence(user_id, presence_string)
...
function ScriptPresence:cb_async_presence_set(info)
