...
function ActionAimEnergy:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionAimEnergy:client_owner_start_action(new_action, t)
	ActionAimEnergy.super.client_owner_start_action(self, new_action, t)
end

function ActionAimEnergy:client_owner_post_update(dt, t, world, can_damage)
	ActionAimEnergy.super.client_owner_post_update(self, dt, t, world, can_damage)

	self:_process_energy_draining(dt, t)
end

function ActionAimEnergy:_process_energy_draining(dt, t)
...
function ActionAimEnergy:_fire_shot(t)
