...
function BTSelector_ogre:init(...)
	BTSelector_ogre.super.init(self, ...)
	self._children = { }
end

function BTSelector_ogre:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_ogre:run(unit, blackboard, t, dt)
...
function BTSelector_ogre:add_child(node)
