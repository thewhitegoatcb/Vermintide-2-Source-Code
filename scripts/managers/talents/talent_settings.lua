...
TalentUnlockLevels = { talent_point_5 = 25, talent_point_1 = 5, talent_point_6 = 30, talent_point_4 = 20, talent_point_3 = 15, talent_point_2 = 10 }
		...
		for row, coulumns in ipairs(tree_layout) do
			for coulumn, talent_name in ipairs(coulumns) do
				if talent_name ~= "empty" then
					...
					talent_settings.talent_id = lookup.talent_id end end end end end