...
function BackendInterfaceRunes:init()
...
function BackendInterfaceRunes:_refresh_attributes()
...
function BackendInterfaceRunes:on_authenticated()
...
function BackendInterfaceRunes:get(backend_id)
...
function BackendInterfaceRunes:set(backend_id, rune)
	local db_entity_name = DB_ENTITY_NAME_PREFIX .. backend_id
