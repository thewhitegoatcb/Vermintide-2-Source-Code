...
function ActionCareerBWNecromancerRaiseDeadTargeting:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
	...
	self._buff_unit_params = { is_husk = true }

	function self._nav_callback()
		local t = Managers.time:time("game")
		self:_update_targeting(t)
	end
end

function ActionCareerBWNecromancerRaiseDeadTargeting:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerBWNecromancerRaiseDeadTargeting:client_owner_post_update(dt, t, world, can_damage, current_time_in_action)
	self._ai_navigation_system:add_safe_navigation_callback(self._nav_callback)
end

function ActionCareerBWNecromancerRaiseDeadTargeting:_start_targeting()
...
function ActionCareerBWNecromancerRaiseDeadTargeting:_update_targeting(t)
...
function ActionCareerBWNecromancerRaiseDeadTargeting:_get_projectile_position()
	local world = self._world
...
function ActionCareerBWNecromancerRaiseDeadTargeting:_get_first_person_position_direction()
...
function ActionCareerBWNecromancerRaiseDeadTargeting:finish(reason, data)
	local world = self._world
