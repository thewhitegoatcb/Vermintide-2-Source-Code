InteractionResult = { "ONGOING", "SUCCESS", "FAILURE", "USER_ENDED" }
...
function InteractionCustomChecks.dialogue_not_playing(interactor_unit, interactable_unit)
...
InteractionDefinitions.player_generic = {
	default_config = { hud_verb = "player_interaction", duration = 2, hold = true, swap_to_3p = true },
	...
	get_config = function ()
		if InteractionDefinitions.player_generic.current_data then
			do return InteractionDefinitions [InteractionDefinitions.player_generic.current_data].config end
		else
...
InteractionDefinitions.revive = {
	config = { block_other_interactions = true, hud_verb = "revive", hold = true, swap_to_3p = true, activate_block = true, duration = 2 },
...
InteractionDefinitions.pull_up = {
	config = { block_other_interactions = true, hud_verb = "pull up", hold = true, swap_to_3p = true, activate_block = true, duration = 2, does_not_require_line_of_sight = true },
...
InteractionDefinitions.release_from_hook = {
	config = { block_other_interactions = true, hud_verb = "player_interaction", hold = true, swap_to_3p = true, activate_block = true, duration = 2 },
...
InteractionDefinitions.assisted_respawn = {
	config = { block_other_interactions = true, hud_verb = "assist respawn", hold = true, swap_to_3p = true, activate_block = true, duration = 2 },
...
InteractionDefinitions.smartobject = {
	config = { show_weapons = true, hold = true, swap_to_3p = false },
	...
	client = {
		...
		stop = function (world, interactor_unit, interactable_unit, data, config, t, result)
			...
			Unit.get_data(interactable_unit, "interaction_data", "only_once") then
...
InteractionDefinitions.pickup_object = {
	config = { allow_movement = true, duration = 0, hold = true, swap_to_3p = false },
			...
			if result == InteractionResult.SUCCESS then
				...
				if local_bot_or_human then
					...
					elseif pickup_settings.type == "explosive_inventory_item" then
						...
						local extra_extension_init_data = {
							health_system = { in_hand = true,
								owner_unit = interactor_unit,
								ignored_damage_types = { temporary_health_degen = true, kinetic = true, damage_over_time = true, buff = true, vomit_face = true, health_degen = true, vomit_ground = true, wounded_dot = true, heal = true },
...
InteractionDefinitions.give_item = {
	config = { allow_movement = true, duration = 0, hold = false, block_other_interactions = true },
...
InteractionDefinitions.heal = {
	config = { block_other_interactions = true, hold = true, swap_to_3p = true, duration = 2, attack_template = "heal_bandage" },
...
function InteractionDefinitions.linker_transportation_unit.client.hud_description(interactable_unit, data, config, key_tail)
...
function InteractionDefinitions.linker_transportation_unit.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil
...
function InteractionDefinitions.linker_transportation_unit.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.door.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil
...
function InteractionDefinitions.door.client.hud_description(interactable_unit, data, config)
	local door_extension = ScriptUnit.extension(interactable_unit, "door_system")
...
function InteractionDefinitions.chest.client.start(world, interactor_unit, interactable_unit, data, config, t)
	data.start_time = t
	local duration = Unit.get_data(interactable_unit, "interaction_data", "interaction_length")
	data.duration = duration
...
function InteractionDefinitions.chest.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil
	...
	if success and pickup_settings.can_spawn_func(pickup_params) then
		...
		if rand < chance then
			local extension_init_data = {
				pickup_system = { has_physics = true, spawn_type = "rare",
...
function InteractionDefinitions.inventory_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
function InteractionDefinitions.inventory_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { menu_sub_state_name = "equipment", menu_state_name = "overview", use_fade = true })
	end
...
function InteractionDefinitions.inventory_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.prestige_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
function InteractionDefinitions.prestige_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { menu_sub_state_name = "prestige", menu_state_name = "overview", use_fade = true })
	end
...
function InteractionDefinitions.prestige_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.forge_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { menu_sub_state_name = "forge", menu_state_name = "overview", use_fade = true })
	end
...
function InteractionDefinitions.forge_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return not script_data ["eac-untrusted"]
end
function InteractionDefinitions.forge_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.talents_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { menu_sub_state_name = "talents", menu_state_name = "overview", use_fade = true })
	end
...
function InteractionDefinitions.talents_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
function InteractionDefinitions.talents_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.cosmetics_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil


	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { menu_sub_state_name = "cosmetics", menu_state_name = "overview", use_fade = true })
	end
...
function InteractionDefinitions.cosmetics_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
function InteractionDefinitions.cosmetics_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.loot_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { use_fade = true, menu_state_name = "loot" })
	end
...
function InteractionDefinitions.loot_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return not script_data ["eac-untrusted"]
end
function InteractionDefinitions.loot_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.characters_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("character_selection_force", { use_fade = true, menu_state_name = "character" })
	end
...
function InteractionDefinitions.characters_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
function InteractionDefinitions.characters_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.altar_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("altar_view_force", { use_fade = true })
	end
...
function InteractionDefinitions.altar_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return false
end
...
function InteractionDefinitions.quest_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("quest_view_force", { use_fade = true })
	end
...
function InteractionDefinitions.quest_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	local can_use = false
...
function InteractionDefinitions.quest_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.journal_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("lorebook_view_force", { use_fade = true })
	end
...
function InteractionDefinitions.journal_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end
...
function InteractionDefinitions.map_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("start_game_view_force", { use_fade = true, menu_state_name = "play" })
	end
...
function InteractionDefinitions.map_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
function InteractionDefinitions.map_access.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.unlock_key_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		Managers.ui:handle_transition("unlock_key_force", { use_fade = true })
	end
...
function InteractionDefinitions.unlock_key_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end

for k, v in pairs(InteractionDefinitions) do
	if v.client.camera_node == nil then
		function v.client.camera_node() return k end
	end
	if v.client.hud_description == nil then
		function v.client.hud_description() return "interact_" .. k end
	end
end
...
function InteractionDefinitions.pictureframe.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)

	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk and rawget(_G, "HeroViewStateKeepDecorations") then
		...
		Managers.ui:handle_transition("hero_view_force", { type = "painting", menu_state_name = "keep_decorations", use_fade = true,
...
function InteractionDefinitions.pictureframe.client.can_interact(interactor_unit, interactable_unit, data, config)
	local keep_decoration_extension = ScriptUnit.extension(interactable_unit, "keep_decoration_system")
...
function InteractionDefinitions.pictureframe.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.trophy.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	not data.is_husk and rawget(_G, "HeroViewStateKeepDecorations") then
		...
		Managers.ui:handle_transition("hero_view_force", { type = "trophy", menu_state_name = "keep_decorations", use_fade = true,
...
function InteractionDefinitions.trophy.client.can_interact(interactor_unit, interactable_unit, data, config)
	local keep_decoration_extension = ScriptUnit.extension(interactable_unit, "keep_decoration_system")
	local can_interact = keep_decoration_extension:can_interact()
...
function InteractionDefinitions.trophy.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	local view_only = not data.is_server or Unit.get_data(interactable_unit, "interaction_data", "view_only")
	local interaction_action_text = view_only and "interaction_action_view" or Unit.get_data(interactable_unit, "interaction_data", "hud_interaction_action")
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), interaction_action_text
end
...
function InteractionDefinitions.decoration.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)

	data.start_time = nil

	if result == InteractionResult.SUCCESS and
	not data.is_husk and rawget(_G, "HeroViewStateKeepDecorations") then
		Managers.ui:handle_transition("hero_view_force", { menu_state_name = "keep_decorations", use_fade = true,
...
function InteractionDefinitions.decoration.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.decoration.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), Unit.get_data(interactable_unit, "interaction_data", "hud_interaction_action")
end
...
function InteractionDefinitions.no_interaction_hud_only.client.hud_description(interactable_unit, data, config, key_tail)
...
function InteractionDefinitions.no_interaction_hud_only.client.can_interact(interactor_unit, interactable_unit, data, config)
	return false, ""
end
...
function InteractionDefinitions.achievement_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil

	if result == InteractionResult.SUCCESS and not data.is_husk then
		Managers.ui:handle_transition("hero_view_force", { use_fade = true, menu_state_name = "achievements" })
	end
...
function InteractionDefinitions.achievement_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return not script_data.settings.use_beta_mode
end

function InteractionDefinitions.achievement_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_open"
end
...
function InteractionDefinitions.luckstone_access.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	if result == InteractionResult.SUCCESS then
		...
		if current_difficulty == 0 then current_difficulty = 1
		end
		local vote_data = { private_game = true, mission_id = "plaza", strict_matchmaking = false, always_host = true, matchmaking_type = "event", mechanism = "adventure", quick_game = false,
...
function InteractionDefinitions.luckstone_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function InteractionDefinitions.luckstone_access.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.luckstone_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.difficulty_selection_access.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	if result == InteractionResult.SUCCESS then
		...
		current_difficulty =
		current_difficulty > difficulty_steps and 1 or current_difficulty + 1
...
function InteractionDefinitions.difficulty_selection_access.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.difficulty_selection_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	local current_difficulty = unit_get_data(interactable_unit, "current_difficulty")
...
function InteractionDefinitions.inn_door_transition.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		local variation_data = Managers.backend:get_level_variation_data()
		local vote_data = { switch_mechanism = true, mechanism = "adventure",
...
function InteractionDefinitions.inn_door_transition.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_enter"
end

function InteractionDefinitions.inn_door_transition.client.can_interact(interactor_unit, interactable_unit, data, config)
	local is_game_matchmaking = Managers.matchmaking:is_game_matchmaking()
...
function InteractionDefinitions.deus_door_transition.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	if result == InteractionResult.SUCCESS and
	not data.is_husk then
		local variation_data = Managers.backend:get_level_variation_data()
		local vote_data = { switch_mechanism = true, mechanism = "deus", level_key = "morris_hub" }
...
function InteractionDefinitions.deus_door_transition.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "interaction_action_enter"
end
function InteractionDefinitions.deus_door_transition.client.can_interact(interactor_unit, interactable_unit, data, config)
