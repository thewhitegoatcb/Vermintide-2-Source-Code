...
function PerceptionUtils.troll_crouch_check(unit, blackboard, t)
...
function PerceptionUtils.perception_continuous_chaos_troll(unit, blackboard, breed, t, dt)
...
function PerceptionUtils.perception_continuous_chaos_spawn(unit, blackboard, breed, t, dt)
...
function PerceptionUtils.perception_continuous_rat_ogre(unit, blackboard, breed, t, dt)
	AiUtils.update_aggro(unit, blackboard, breed, t, dt)

	return true
end

function PerceptionUtils.perception_continuous_keep_target(unit, blackboard, breed, t, dt)
...
function PerceptionUtils:perception_no_seeing(unit, blackboard, breed, pick_target_func, t)

	return end

function PerceptionUtils.perception_all_seeing(unit, blackboard, breed, pick_target_func, t)
	local target_unit = blackboard.target_unit
...
function PerceptionUtils.perception_all_seeing_boss(unit, blackboard, breed, pick_target_func, t)
...
function PerceptionUtils.perception_standard_bearer(unit, blackboard, breed, pick_target_func, t)
	if blackboard.spawn_category == "patrol" then
		local ai_group_extension = ScriptUnit.has_extension(unit, "ai_group_system")
		if
		ai_group_extension and ai_group_extension.in_patrol then
			return
		end
	end
...
function PerceptionUtils.perception_pack_master(unit, blackboard, breed, pick_target_func, t)
...
function PerceptionUtils.perception_rat_ogre(unit, blackboard, breed, pick_target_func, t, dt)
	...
	if ALIVE [target_unit] then
		...
		if status_extension then
			...
			local x = offset.x local y = offset.y local z = offset.z
...
function PerceptionUtils.perception_all_seeing_re_evaluate(unit, blackboard, breed, pick_target_func, t)
	local target_unit = blackboard.target_unit
	local target_alive = HEALTH_ALIVE [target_unit]
...
function PerceptionUtils.perception_regular(unit, blackboard, breed, pick_target_func, t)
	if blackboard.keep_target then
		return false
	end
...
function PerceptionUtils.keep_target_until_invalid(unit, blackboard, breed, pick_target_func, t)
	local target_unit = blackboard.target_unit
...
function PerceptionUtils.perception_regular_update_aggro(unit, blackboard, breed, pick_target_func, t, dt)
	AiUtils.update_aggro(unit, blackboard, breed, t, dt)
...
local ai_units = { }
function PerceptionUtils.alert_enemies_within_range(___world, player_unit, is_server, alert_position, alert_radius)
...
function PerceptionUtils.pack_master_has_line_of_sight_for_attack(physics_world, packmaster_unit, target_unit)
...
function PerceptionUtils.clear_target_unit(blackboard)
...
function PerceptionUtils.special_opportunity(unit, blackboard)
