...
function PlayerCharacterStatePouncedDown:init(character_state_init_context)
...
function PlayerCharacterStatePouncedDown:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStatePouncedDown:on_exit(unit, input, dt, context, t, next_state)
	local first_person_extension = self.first_person_extension
	self.liberated = nil
...
function PlayerCharacterStatePouncedDown:set_free(t, unit)
	self.liberated = true
...
function PlayerCharacterStatePouncedDown:update(unit, input, dt, context, t)
	local csm = self.csm
