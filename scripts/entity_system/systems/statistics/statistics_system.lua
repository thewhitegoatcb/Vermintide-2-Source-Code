...
local extensions = { "StatisticsExtension" }



local CLIENT_RPCS = { "rpc_register_kill", "rpc_set_unsigned_number_session_stat" }




function StatisticsSystem:init(context, name)
...
function StatisticsSystem:destroy()
	self.network_event_delegate:unregister(self)
end

local dummy_input = { }
function StatisticsSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function StatisticsSystem:on_remove_extension(unit, extension_name)
	self.unit_extension_data [unit] = nil
	ScriptUnit.remove_extension(unit, self.NAME)
end

function StatisticsSystem:update(context, t)
...
function StatisticsSystem:hot_join_sync(sender)
...
function StatisticsSystem:rpc_set_unsigned_number_session_stat(channel_id, stat_id, value)
...
function StatisticsSystem:rpc_register_kill(channel_id, victim_unit_go_id)
