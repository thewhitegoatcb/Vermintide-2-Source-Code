...
SPProfilesAbbreviation = { "wh", "bw", "dr", "we", "es" }
...
local base_character_states = { "PlayerCharacterStateDead", "PlayerCharacterStateInteracting", "PlayerCharacterStateInspecting", "PlayerCharacterStateEmote", "PlayerCharacterStateJumping", "PlayerCharacterStateClimbingLadder", "PlayerCharacterStateLeavingLadderTop", "PlayerCharacterStateEnterLadderTop", "PlayerCharacterStateFalling", "PlayerCharacterStateKnockedDown", "PlayerCharacterStatePouncedDown", "PlayerCharacterStateStanding", "PlayerCharacterStateWalking", "PlayerCharacterStateDodging", "PlayerCharacterStateLedgeHanging", "PlayerCharacterStateLeaveLedgeHangingPullUp", "PlayerCharacterStateLeaveLedgeHangingFalling", "PlayerCharacterStateCatapulted", "PlayerCharacterStateStunned", "PlayerCharacterStateCharged", "PlayerCharacterStateUsingTransport", "PlayerCharacterStateGrabbedByPackMaster", "PlayerCharacterStateGrabbedByTentacle", "PlayerCharacterStateWaitingForAssistedRespawn", "PlayerCharacterStateOverchargeExploding", "PlayerCharacterStateInVortex", "PlayerCharacterStateGrabbedByChaosSpawn", "PlayerCharacterStateLunging", "PlayerCharacterStateLeaping", "PlayerCharacterStateOverpowered", "PlayerCharacterStateInHangingCage", "PlayerCharacterStateGrabbedByCorruptor" }
...
local base_camera_states = { "CameraStateIdle", "CameraStateFollow", "CameraStateFollowThirdPerson", "CameraStateFollowAttract", "CameraStateFollowThirdPersonLedge", "CameraStateFollowThirdPersonOverShoulder", "CameraStateFollowThirdPersonSmartClimbing", "CameraStateFollowThirdPersonTunneling", "CameraStateFollowChaosSpawnGrabbed", "CameraStateObserver", "CameraStateInteraction" }
...
local hud_components = { "LootObjectiveUI", "WaitForRescueUI", "ItemReceivedFeedbackUI", "OverchargeBarUI", "BuffUI", "BuffPresentationUI", "EquipmentUI", "GamePadEquipmentUI", "AbilityUI", "GamePadAbilityUI", "InteractionUI", "DamageIndicatorGui", "CrosshairUI", "FatigueUI", "BonusDiceUI", "PlayerInventoryUI", "SocialWheelUI", "WeaveProgressUI", "WeaveTimerUI", "WorldMarkerUI", "ChallengeTrackerUI" }
...
SPProfiles = { { career_voice_parameter = "victor_career_voice_effect", display_name = "witch_hunter", ingame_short_display_name = "witch_hunter_short", hero_selection_image = "hero_icon_wh", character_name = "inventory_name_witch_hunter", character_vo = "witch_hunter", unit_name = "witch_hunter", supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_witch_hunter", affiliation = "heroes", ui_portrait = "unit_frame_portrait_victor_captain",
		...
		career_voice_parameter_values = { 0, 100, 50 },
		...
		first_person_heights = { charged = 1, crouch = 1, stand = 1.7, knocked_down = 1, grabbed_by_tentacle = 1.9 },
	...
	{ career_voice_parameter = "sienna_career_voice_effect", display_name = "bright_wizard", ingame_short_display_name = "bright_wizard_short", hero_selection_image = "hero_icon_bw", character_name = "inventory_name_bright_wizard", character_vo = "bright_wizard", unit_name = "bright_wizard", supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_bright_wizard", affiliation = "heroes", ui_portrait = "unit_frame_portrait_sienna_scholar",
		...
		first_person_heights = { charged = 0.9, crouch = 1, stand = 1.55, knocked_down = 0.95, grabbed_by_tentacle = 1.7 },
	...
	{ career_voice_parameter = "dwarf_career_voice_effect", display_name = "dwarf_ranger", ingame_short_display_name = "dwarf_ranger_short", hero_selection_image = "hero_icon_dr", character_name = "inventory_name_dwarf_ranger", character_vo = "dwarf_ranger", unit_name = "dwarf_ranger", supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_dwarf_ranger", affiliation = "heroes", ui_portrait = "unit_frame_portrait_bardin_ranger",
		...
		first_person_heights = { charged = 0.75, crouch = 1, stand = 1.3, knocked_down = 0.7, grabbed_by_tentacle = 1.7 },
	...
	{ career_voice_parameter = "kerillian_career_voice_effect", display_name = "wood_elf", ingame_short_display_name = "wood_elf_short", hero_selection_image = "hero_icon_ww", character_name = "inventory_name_wood_elf", character_vo = "wood_elf", unit_name = "way_watcher", supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_wood_elf", affiliation = "heroes", ui_portrait = "unit_frame_portrait_kerillian_waywatcher",
		...
		first_person_heights = { charged = 0.85, crouch = 1, stand = 1.5, knocked_down = 1, grabbed_by_tentacle = 1.7 },
	...
	{ career_voice_parameter = "markus_career_voice_effect", display_name = "empire_soldier", ingame_short_display_name = "empire_soldier_short", hero_selection_image = "hero_icon_es", character_name = "inventory_name_empire_soldier", character_vo = "empire_soldier", unit_name = "empire_soldier", supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_empire_soldier", affiliation = "heroes", ui_portrait = "unit_frame_portrait_kruber_huntsman",
		...
		first_person_heights = { charged = 1, crouch = 1, stand = 1.65, knocked_down = 1, grabbed_by_tentacle = 1.9 },
	...
	{ career_voice_parameter = "markus_career_voice_effect", display_name = "empire_soldier_tutorial", ingame_short_display_name = "empire_soldier_short", hero_selection_image = "hero_icon_es", character_name = "inventory_name_empire_soldier", character_vo = "empire_soldier", unit_name = "empire_soldier", unit_template_name = "player_unit_3rd_tutorial", tutorial_profile = true, supports_motion_sickness_modes = true, default_wielded_slot = "slot_melee", role = "hero", ingame_display_name = "inventory_name_empire_soldier", affiliation = "tutorial", ui_portrait = "unit_frame_portrait_kruber_knight",
		...
		default_state_machine = default_state_machine,
		first_person_attachment = FirstPersonAttachments.empire_soldier,
		first_person_heights = { grabbed_by_tentacle = 1.9, knocked_down = 1, crouch = 1, stand = 1.65 },
...
DefaultUnits = {
	standard = { backlit_camera = "units/generic/backlit_camera", camera = "core/units/camera" } }
...
for index, profile in ipairs(SPProfiles) do
	...
	for i, career_settings in ipairs(profile.careers) do
		...
		table.clear(camera_state_names) end end