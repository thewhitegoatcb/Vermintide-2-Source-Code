...
local possible_drops = { { drop_weight = 500, pickup_name = "frag_grenade_t1", spawn_function = "spawn_pickup_at_unit" },





	{ drop_weight = 500, pickup_name = "frag_grenade_t2", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "fire_grenade_t1", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "fire_grenade_t2", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 10, pickup_name = "holy_hand_grenade", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 2000, pickup_name = "all_ammo_small", spawn_function = "spawn_pickup_at_unit" },
	...
	{ drop_weight = 500, pickup_name = "liquid_bravado_potion", spawn_function = "spawn_pickup_at_unit" },
	...
	{ drop_weight = 500, pickup_name = "friendly_murderer_potion", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "killer_in_the_shadows_potion", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "pockets_full_of_bombs_potion", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "hold_my_beer_potion", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "moot_milk_potion", spawn_function = "spawn_pickup_at_unit" },




	{ drop_weight = 500, pickup_name = "vampiric_draught_potion", spawn_function = "spawn_pickup_at_unit" } }
...
function spawn_functions.spawn_pickup_at_unit(unit, drop_table)
...
function spawn_functions.spawn_ignited_barrel_at_unit(unit, drop_table)
	local position = POSITION_LOOKUP [unit] + Vector3.up() * 0.1
...
return {
	...
	server_ai_killed_function = function (context, data, killed_unit, killer_unit)
		...
		if random <= drop_chance then
			...
			table.array_remove_if(possible_drops_table, function (value) return value.pickup_name == data.last_dropped_pickup end)
