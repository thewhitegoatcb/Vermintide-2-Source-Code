...
function BTSelector_training_dummy:init(...)
	BTSelector_training_dummy.super.init(self, ...)
	self._children = { }
end

function BTSelector_training_dummy:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_training_dummy:run(unit, blackboard, t, dt)
...
function BTSelector_training_dummy:add_child(node)
