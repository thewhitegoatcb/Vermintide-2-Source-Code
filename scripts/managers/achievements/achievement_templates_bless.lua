...
local difficulties = { "normal", "hard", "harder", "hardest", "cataclysm" }
...
achievements.bless_heal_allies = { name = "achv_bless_heal_allies_name", desc = "achv_bless_heal_allies_desc", display_completion_ui = true, icon = "achievement_trophy_bless_heal_allies", required_dlc = "bless",





	events = { "register_heal" },
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, bless_heal_allies_amount }
	end,
...
achievements.bless_saved_by_perk = { name = "achv_bless_saved_by_perk_name", desc = "achv_bless_saved_by_perk_desc", display_completion_ui = true, icon = "achievement_trophy_bless_saved_by_perk", required_dlc = "bless",





	events = { "register_damage_taken", "player_dead", "player_knocked_down" },
	progress = function (statistics_db, stats_id, template_data)
		local completed = statistics_db:get_persistent_stat(stats_id, "bless_saved_by_perk")
		return { completed, bless_saved_by_perk_amount }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_book_run = { name = "achv_bless_book_run_name", desc = "achv_bless_book_run_desc", display_completion_ui = true, icon = "achievement_trophy_bless_book_run", required_dlc = "bless",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, bless_book_run_amount }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_fast_shield = { name = "achv_bless_fast_shield_name", desc = "achv_bless_fast_shield_desc", display_completion_ui = true, icon = "achievement_trophy_bless_fast_shield", required_dlc = "bless",





	events = { "register_shield_applied", "register_player_disabled" },
	progress = function (statistics_db, stats_id, template_data)
		local completed = statistics_db:get_persistent_stat(stats_id, "bless_fast_shield")
		return { completed, bless_fast_shield_amount }
	end,
	completed = function (statistics_db, stats_id, template_data)
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		if event_name == "register_shield_applied" then
			...
			local is_incapacitated = status_extension:is_pounced_down() or
			status_extension:is_grabbed_by_pack_master() or
...
achievements.bless_unbreakable_damage_block = { always_run = true, name = "achv_bless_unbreakable_damage_block_name", display_completion_ui = true, desc = "achv_bless_unbreakable_damage_block_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_unbreakable_damage_block", required_dlc = "bless",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		if buff_extension:num_buff_stacks("victor_priest_activated_ability_invincibility") <= 0 and
		buff_extension:num_buff_stacks("victor_priest_activated_ability_invincibility_improved") <= 0 then
			return
		end
...
achievements.bless_punch_back = { always_run = true, name = "achv_bless_punch_back_name", display_completion_ui = true, desc = "achv_bless_punch_back_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_punch_back", required_dlc = "bless",
	...
	events = { "register_damage_taken", "register_damage" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_cluch_revive = { display_completion_ui = true, name = "achv_bless_cluch_revive_name", desc = "achv_bless_cluch_revive_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_cluch_revive", required_dlc = "bless",
...
local bless_ranged_raki_breeds = { skaven_ratling_gunner = true, skaven_warpfire_thrower = true }
achievements.bless_ranged_raki = { display_completion_ui = true, name = "achv_bless_ranged_raki_name", desc = "achv_bless_ranged_raki_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_ranged_raki", required_dlc = "bless",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		local current_buff = buff_extension:get_buff_type("victor_priest_activated_ability_invincibility") or
		buff_extension:get_buff_type("victor_priest_activated_ability_invincibility_improved")
...
achievements.bless_chaos_warriors = { display_completion_ui = true, name = "achv_bless_chaos_warriors_name", desc = "achv_bless_chaos_warriors_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_chaos_warriors", required_dlc = "bless",
	...
	events = { "register_kill", "righteous_fury_start", "righteous_fury_end", "player_dead" },
	completed = function (statistics_db, stats_id, template_data)
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		if event_name == "righteous_fury_start" and event_data [2] then
			...
			template_data.kill_count = 0
		elseif event_name == "righteous_fury_end" and event_data [2] or
		event_name == "player_dead" and event_data [1] and event_data [1].local_player then
...
achievements.bless_very_righteous = { display_completion_ui = true, name = "achv_bless_very_righteous_name", desc = "achv_bless_very_righteous_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_very_righteous", required_dlc = "bless",
	...
	events = { "righteous_fury_start", "righteous_fury_end", "player_dead" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_smite_enemies = { display_completion_ui = true, name = "achv_bless_smite_enemies_name", desc = "achv_bless_smite_enemies_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_smite_enemies", required_dlc = "bless",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, bless_smite_enemies_amount }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_great_hammer_headshots = { display_completion_ui = true, name = "achv_bless_great_hammer_headshots_name", desc = "achv_bless_great_hammer_headshots_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_great_hammer_headshots", required_dlc = "bless",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, bless_great_hammer_headshots_count }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
local bless_kill_specials_hammer_book_map = { skaven_ratling_gunner = 8, skaven_poison_wind_globadier = 2, chaos_corruptor_sorcerer = 32, chaos_vortex_sorcerer = 64, skaven_pack_master = 4, skaven_warpfire_thrower = 16, beastmen_standard_bearer = 128, skaven_gutter_runner = 1 }
...
achievements.bless_kill_specials_hammer_book = { display_completion_ui = true, name = "achv_bless_kill_specials_hammer_book_name", desc = "achv_bless_kill_specials_hammer_book_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_kill_specials_hammer_book", required_dlc = "bless",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { killed_specials_n, bless_kill_specials_hammer_book_map_n }
	end,
	completed = function (statistics_db, stats_id, template_data)
	...
	requirements = function (statistics_db, stats_id)
		...
		for breed_name, mask in pairs(bless_kill_specials_hammer_book_map) do
			...
			out_n = out_n + 1
			out_table [out_n] = { name = breed_name, completed = completed }
		end
		return out_table
	end,
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
...
achievements.bless_mighty_blow = { display_completion_ui = true, name = "achv_bless_mighty_blow_name", desc = "achv_bless_mighty_blow_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_mighty_blow", required_dlc = "bless",
...
achievements.bless_block_attacks = { always_run = true, name = "achv_bless_block_attacks_name", display_completion_ui = true, desc = "achv_bless_block_attacks_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_block_attacks", required_dlc = "bless",
	...
	events = { "register_damage_resisted_immune" },
	progress = function (statistics_db, stats_id, template_data)
		local completed = statistics_db:get_persistent_stat(stats_id, "bless_block_attacks")
		return { completed, bless_block_attacks_count }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.bless_righteous_stagger = { always_run = true, name = "achv_bless_righteous_stagger_name", display_completion_ui = true, desc = "achv_bless_righteous_stagger_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_righteous_stagger", required_dlc = "bless",
...
achievements.bless_charged_hammer = { display_completion_ui = true, name = "achv_bless_charged_hammer_name", desc = "achv_bless_charged_hammer_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_charged_hammer", required_dlc = "bless",
...
achievements.bless_protected_killing = { display_completion_ui = true, name = "achv_bless_protected_killing_name", desc = "achv_bless_protected_killing_desc", required_career = "wh_priest", icon = "achievement_trophy_bless_protected_killing", required_dlc = "bless",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		if buff_extension then
			local buff = buff_extension:get_buff_type("victor_priest_activated_ability_invincibility") or
			buff_extension:get_buff_type("victor_priest_activated_ability_invincibility_improved")
			if buff then
...
local all_challenges = { "bless_complete_all_helmgart_levels_wh_priest", "bless_complete_25_missions_wh_priest", "bless_saved_by_perk", "bless_book_run", "bless_heal_allies", "bless_fast_shield", "bless_unbreakable_damage_block", "bless_punch_back", "bless_cluch_revive", "bless_ranged_raki", "bless_chaos_warriors", "bless_very_righteous", "bless_smite_enemies", "bless_great_hammer_headshots", "bless_kill_specials_hammer_book", "bless_mighty_blow", "bless_block_attacks", "bless_righteous_stagger", "bless_charged_hammer", "bless_protected_killing" }
