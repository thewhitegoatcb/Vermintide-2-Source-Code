...
local demo_video = { video_name = "video/demo_end_video_list", sound_start = "Play_ending_demo", scenegraph_id = "splash_video", loop = false, material_name = "demo_end_video_list", sound_stop = "Stop_ending_demo" }
