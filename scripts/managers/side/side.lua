...
function Side:init(definition, side_id)
	...
	self.broadphase_category = { definition.name }
...
function Side:get_enemy_sides()
	return self._enemy_sides
end

function Side:get_allied_sides()
	return self._allied_sides
end

function Side:add_unit(unit)
...
function Side:remove_unit(unit)
...
function Side:add_enemy_unit(unit)
...
function Side:remove_enemy_unit(unit)
...
function Side:add_allied_unit(unit)
...
function Side:remove_allied_unit(unit)
...
function Side:add_player_unit(player_unit)
...
function Side:remove_player_unit(player_unit)
	local player_units = self._player_units
...
function Side:add_enemy_player_unit(player_unit)
...
function Side:remove_enemy_player_unit(player_unit)
	local enemy_player_units = self._enemy_player_units
...
function Side:player_units()
	return self._player_units
end

function Side:enemy_player_units()
	return self._enemy_player_units
end

function Side:enemy_units()
