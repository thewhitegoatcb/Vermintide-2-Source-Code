...
function BTClimbAction:init(...)
	BTClimbAction.super.init(self, ...)
end

BTClimbAction.name = "BTClimbAction"

function BTClimbAction:enter(unit, blackboard, t)
...
function BTClimbAction:leave(unit, blackboard, t, reason, destroy)
...
function BTClimbAction:run(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
	local locomotion_extension = blackboard.locomotion_extension
...
function BTClimbAction:_catapult_players(unit, blackboard, data)
