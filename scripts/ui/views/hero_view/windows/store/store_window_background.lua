...
function StoreWindowBackground:on_enter(params, offset)
...
function StoreWindowBackground:_create_viewport_definition()
	return { scenegraph_id = "screen",
		element = UIElements.Viewport,
		style = {
			viewport = { layer = 960, viewport_name = "store_background_viewport", clear_screen_on_create = true, level_name = "levels/ui_keep_menu/world", enable_sub_gui = false, fov = 50, world_name = "store_background",
				...
				camera_position = { 0, 2.8, 0.9 },
				camera_lookat = { 0, -2.8, 0.9 } } },
...
function StoreWindowBackground:_create_ui_elements(params, offset)
...
function StoreWindowBackground:on_exit(params)
...
function StoreWindowBackground:update(dt, t)
	self:_update_animations(dt, t)
	self:_draw(dt)
end

function StoreWindowBackground:post_update(dt, t)
...
function StoreWindowBackground:_hide_object_sets()
...
function StoreWindowBackground:_update_animations(dt, t)
...
function StoreWindowBackground:_is_button_pressed(widget)
...
function StoreWindowBackground:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function StoreWindowBackground:_draw(dt)
...
function StoreWindowBackground:_play_sound(event)
