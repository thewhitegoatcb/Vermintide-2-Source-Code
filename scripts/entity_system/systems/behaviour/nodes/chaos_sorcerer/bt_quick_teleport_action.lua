...
function BTQuickTeleportAction:init(...)
...
function BTQuickTeleportAction:enter(unit, blackboard, t)
...
function BTQuickTeleportAction:leave(unit, blackboard, t, reason, destroy)
...
function BTQuickTeleportAction:run(unit, blackboard, t, dt)
...
function BTQuickTeleportAction:play_teleport_effect(unit, blackboard, start_position, end_position)
...
function BTQuickTeleportAction:anim_cb_teleport_start_finished(unit, blackboard)
...
function BTQuickTeleportAction:anim_cb_teleport_end_finished(unit, blackboard)
	blackboard.quick_teleport = false
end

function BTQuickTeleportAction:anim_cb_tp_end_enter(unit, blackboard)
	local action = blackboard.action
...
function BTQuickTeleportAction:push_close_players(unit, blackboard, position, target_unit)
	local action = blackboard.action
