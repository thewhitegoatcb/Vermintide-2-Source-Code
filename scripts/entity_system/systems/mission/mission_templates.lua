MissionTemplates = {
	collect = {
		init = function (mission_data, unit)
			...
			local data = { info_slate_type = "mission_objective", manual_update = true, current_amount = 0, update_sound = true,
	...
	defend = {
		init = function (mission_data, unit)
			...
			local data = { info_slate_type = "mission_objective", update_sound = true, manual_update = true, flow_update = true,
	...
	simple = {
		init = function (mission_data, unit)
			...
			local data = { info_slate_type = "mission_objective", update_sound = true, manual_update = true, done = false, flow_update = true,
	...
	timed = {
		init = function (mission_data, unit)
			...
			local data = { info_slate_type = "mission_objective",
	...
	goal = {
		init = function (mission_data, unit)
			local mission_text = Localize(mission_data.text)
			local data = { manual_update = true, info_slate_type = "mission_goal", is_goal = true,
	...
	survival = {
		init = function (mission_data, unit)
			...
			local states = { wave = 2, completed = 3, prepare = 1 }
			local wave_state = states.prepare
			local wave_completed_text = nil
			if mission_data.wave_completed_text then wave_completed_text = Localize(mission_data.wave_completed_text) else wave_completed_text = nil end
			local wave_prepare_text = nil
			if mission_data.wave_prepare_text then wave_prepare_text = Localize(mission_data.wave_prepare_text) else wave_prepare_text = nil end
			local mission_text = Localize(mission_data.wave_text)

			local start_time = Managers.state.network:network_time()

			local data = { info_slate_type = "mission_objective", manual_update = true, flow_update = true, wave_completed = 0, update_sound = true,
	...
	tutorial = {
		init = function (mission_data, unit)
			local start_time = Managers.state.network:network_time()
			local data = { manual_update = true, info_slate_type = "mission_goal", done = false, flow_update = true,
...
function MissionTemplates.collect_uncompletable.evaluate_mission(data, dt)
