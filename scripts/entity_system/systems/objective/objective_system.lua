...
local RPCS = { "rpc_sync_objectives" }



function ObjectiveSystem:init(entity_system_creation_context, system_name, extensions)
...
function ObjectiveSystem:destroy()
	self.network_event_delegate:unregister(self)
end

function ObjectiveSystem:deactivate()
...
function ObjectiveSystem:activate_objectives(objective_sets)
...
function ObjectiveSystem:_server_activate_objectives(objective_sets)
...
function ObjectiveSystem:_client_activate_objectives(objective_sets)
	self._objective_lists = objective_sets
	local num_main_objectives = 0
...
function ObjectiveSystem:_reset_current_statistics()
	self._current_num_completed_sub_objectives = 0
	self._current_num_completed_main_objectives = 0
	self._current_num_sub_objectives = 0
	self._current_num_optional_sub_objectives = 0
...
function ObjectiveSystem:_activate_objectives(objectives, parent_objective, items_spawned)
	...
	for objective_name, objective_data in pairs(objectives) do
		if objective_data.sub_objectives then
			self._sub_objectives [objective_name] = { data = objective_data, extensions = { } }
...
function ObjectiveSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function ObjectiveSystem:update(context, t)
...
function ObjectiveSystem:game_object_destroyed(game_object_id)
...
function ObjectiveSystem:_update_server(dt, t)
	local main_objectives = self._main_objectives
	local sub_objectives = self._sub_objectives
	local objects_to_remove = { }
...
function ObjectiveSystem:_update_client(dt, t)
	local main_objectives = self._main_objectives
...
function ObjectiveSystem:_update_activate_objectives()
...
function ObjectiveSystem:_complete_objective(id, extension, objects_to_remove, is_sub_objective)
	extension:complete()
...
function ObjectiveSystem:_complete_parent_objective(data)
	self._num_completed_main_objectives = self._num_completed_main_objectives + 1
	self._current_num_completed_main_objectives = self._current_num_completed_main_objectives + 1
...
function ObjectiveSystem:is_active()
	return self._activated and not self._all_objectives_completed
end

function ObjectiveSystem:all_objectives_completed()
	return self._all_objectives_completed
end

function ObjectiveSystem:hot_join_sync(sender)
	self.network_transmit:send_rpc(
	"rpc_sync_objectives",
	sender,
	self._total_num_main_objectives,
	self._num_completed_main_objectives,
	self._num_completed_sub_objectives,
	self._current_num_completed_sub_objectives,

	self._current_num_sub_objectives)
end

function ObjectiveSystem:current_main_objectives()
	return self._main_objectives
end

function ObjectiveSystem:current_sub_objectives()
	return self._sub_objectives
end

function ObjectiveSystem:current_objective_index()
	return self._current_objective_index
end

function ObjectiveSystem:num_main_objectives()
	return self._total_num_main_objectives
end

function ObjectiveSystem:num_completed_main_objectives()
	return self._num_completed_main_objectives
end

function ObjectiveSystem:num_current_sub_objectives()
	return self._current_num_sub_objectives
end

function ObjectiveSystem:num_current_completed_sub_objectives()
	return self._current_num_completed_sub_objectives
end

function ObjectiveSystem:num_total_completed_objectives()
	return self._num_completed_main_objectives + self._num_completed_sub_objectives
end

function ObjectiveSystem:num_current_optional_sub_objectives()
	return self._current_num_optional_sub_objectives
end

function ObjectiveSystem:rpc_sync_objectives(sender, total_num_main_objectives, num_completed_main_objectives, num_completed_sub_objectives, current_num_completed_sub_objectives, current_num_sub_objectives)
...
function ObjectiveSystem:complete_objective(objective_name)
