...
UIElements = {
	...
	ButtonMenuSteps = {
		passes = { { pass_type = "hotspot", content_id = "button_hotspot",
			...
			{ texture_id = "texture_id", style_id = "texture", pass_type = "texture",
			...
			{ texture_id = "texture_hover_id", style_id = "texture", pass_type = "texture",
			...
			{ texture_id = "texture_click_id", style_id = "texture", pass_type = "texture",
			...
			{ texture_id = "texture_selected_id", style_id = "texture", pass_type = "texture",
			...
			{ texture_id = "texture_disabled_id", style_id = "texture", pass_type = "texture",
	...
	ButtonMenuStepsWithTimer = {
		passes = { { pass_type = "hotspot", content_id = "button_hotspot",
			...
			{ style_id = "timer_text_field", pass_type = "text", text_id = "timer_text_field",
			...
			{ style_id = "timer_text_field_hover", pass_type = "text", text_id = "timer_text_field",
			...
			{ style_id = "timer_text_field_selected", pass_type = "text", text_id = "timer_text_field",
			...
			{ style_id = "timer_text_field_disabled", pass_type = "text", text_id = "timer_text_field",
	...
	ToggleIconButton = {
		passes = { { pass_type = "hotspot", content_id = "button_hotspot" },
			...
			{ pass_type = "texture", style_id = "normal_texture", texture_id = "normal_texture",
			...
			{ pass_type = "texture", style_id = "click_texture", texture_id = "click_texture",
			...
			{ pass_type = "texture", style_id = "toggle_texture", texture_id = "toggle_texture",
			...
			{ pass_type = "texture", style_id = "toggle_hover_texture", texture_id = "toggle_hover_texture",
			...
			{ pass_type = "texture", style_id = "icon_hover_texture", texture_id = "icon_hover_texture",
			...
			{ pass_type = "texture", style_id = "icon_click_texture", texture_id = "icon_texture",
			...
			{ style_id = "tooltip_text", pass_type = "tooltip_text", text_id = "toggled_tooltip_text",
	...
	SimpleRotatedTexture = {
		passes = { { pass_type = "rotated_texture", texture_id = "texture_id" } } },
	...
	Button = {
		passes = { { pass_type = "hover", content_id = "button_hotspot" },


			{ pass_type = "click", content_id = "button_hotspot" },
	...
	StandardWindow = {
		passes = { { style_id = "background", pass_type = "rounded_background", content_id = "background" },



			{ style_id = "background_border", pass_type = "border", content_id = "background_border" },



			{ scenegraph_id = "top_drag_bar", pass_type = "hover", content_id = "top_drag_bar" },



			{ scenegraph_id = "right_drag_bar", pass_type = "hover", content_id = "right_drag_bar" },



			{ scenegraph_id = "left_drag_bar", pass_type = "hover", content_id = "left_drag_bar" },
	...
	ScrollBar = {
		passes = { { pass_type = "rounded_background", style_id = "background" },
			...
			{ style_id = "bg_up", pass_type = "hover", content_id = "scrollbar_up_hotspot" },




			{ style_id = "bg_up", pass_type = "click", content_id = "scrollbar_up_hotspot" },



			{ pass_type = "rounded_background", style_id = "bg_up" },


			{ style_id = "bg_down", pass_type = "hover", content_id = "scrollbar_down_hotspot" },




			{ style_id = "bg_down", pass_type = "click", content_id = "scrollbar_down_hotspot" },



			{ pass_type = "rounded_background", style_id = "bg_down" },


			{ pass_type = "on_click", click_check_content_id = "scrollbar_down_hotspot",
			...
			{ pass_type = "on_click", click_check_content_id = "scrollbar_up_hotspot",
			...
			{ pass_type = "rounded_background", style_id = "scrollbar" },


			{ pass_type = "hover", style_id = "background" },


			{ style_id = "background", pass_type = "held",
	...
	StaticText = {
		passes = { { style_id = "text", pass_type = "text", text_id = "text_field" } } },
	...
	StaticTextWrappedAroundFields = {
		passes = { { style_id = "text", pass_type = "wrapped_text_around_fields", text_id = "text_field" } } },
	...
	LorebookMultipleTexts = {
		passes = { { style_id = "text", pass_type = "lorebook_multiple_texts", text_id = "text_field" } } },
	...
	TextButton = {
		passes = { { pass_type = "hover", content_id = "button_text" },


			{ pass_type = "click", content_id = "button_text" },
	...
	RotatedTexture = {
		passes = { { pass_type = "rotated_texture", style_id = "rotating_texture" } } },
	...
	GamepadButton = function (button_type)
		return {
			passes = { { pass_type = "hotspot", content_id = "button_hotspot" },
				...
				{ pass_type = "game_pad_connected", content_id = "gamepad_button" },
				...
				{ localize = false, style_id = "button_type_text", pass_type = "text", text_id = "button_type_text_field",
