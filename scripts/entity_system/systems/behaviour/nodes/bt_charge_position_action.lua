...
function BTChargePositionAction:init(...)
...
function BTChargePositionAction:enter(unit, blackboard, t)
...
function BTChargePositionAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChargePositionAction:run(unit, blackboard, t, dt)
	...
	if blackboard.ray_can_go_update_time < t then
...
function BTChargePositionAction:_start_starting(unit, blackboard, t)
	blackboard.charge_state = "starting"
end

function BTChargePositionAction:_start_charging(unit, blackboard)
...
function BTChargePositionAction:_start_approaching(unit, blackboard)
	local action = blackboard.action
...
function BTChargePositionAction:_start_impact(unit, blackboard, hit_target, hit_wall, hit_target_blocked, target_avoided_attack)
	local action = blackboard.action
...
function BTChargePositionAction:_pause_charge(unit, blackboard)
	blackboard.navigation_extension:set_enabled(false)
...
function BTChargePositionAction:_cancel_charge(unit, blackboard)
...
function BTChargePositionAction:_check_unit_and_wall_collision(unit, blackboard, dt, ignore_wall_collision)
	local action = blackboard.action
...
function BTChargePositionAction:_check_overlap(unit, blackboard, action)
...
function BTChargePositionAction:_charged_at_player(unit, hit_unit, blackboard, action)

	return end

function BTChargePositionAction:_push_player(unit, hit_unit, blackboard, action, blocked)
...
function BTChargePositionAction:_hit_player(unit, blackboard, hit_unit, action, attack_direction)
...
function BTChargePositionAction:_hit_ai(unit, hit_unit, action, blackboard, t)
...
function BTChargePositionAction:_check_wall_collision(unit, blackboard, dt)
...
function BTChargePositionAction:_is_at_edge(unit, blackboard, from, direction)
...
function BTChargePositionAction:_check_smartobjects(unit, blackboard)
...
function BTChargePositionAction:_run_starting(unit, blackboard, t)
...
function BTChargePositionAction:_run_approaching(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
	...
	if action.max_charge_t < time_since_enter then
		self:_cancel_charge(unit, blackboard)
		return
	end
	...
	if action.max_charge_distance < blackboard.total_distance_ran then
		self:_cancel_charge(unit, blackboard)
		return
	end
...
function BTChargePositionAction:_run_charging(unit, blackboard, t, dt)
...
function BTChargePositionAction:_run_impact(unit, blackboard, t, dt)
...
function BTChargePositionAction:_run_cancel(unit, blackboard, t, dt)
...
function BTChargePositionAction:_slow_down(unit, blackboard, slow_down_speed, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
	local current_velocity = locomotion_extension:current_velocity()
...
function BTChargePositionAction:_update_animation_movement_speed(unit, blackboard, dt)
	local locomotion_extension = blackboard.locomotion_extension
	local current_velocity = locomotion_extension:current_velocity()
...
function BTChargePositionAction:_get_turn_slowdown_percentage(unit, blackboard, dt, direction)
	local action = blackboard.action
	local rotation = Unit.local_rotation(unit, 0)
...
function BTChargePositionAction:anim_cb_charge_start_finished(unit, blackboard)
	self:_start_charging(unit, blackboard)
...
function BTChargePositionAction:anim_cb_charge_charging_finished(unit, blackboard)
...
function BTChargePositionAction:anim_cb_disable_charge_collision(unit, blackboard)
...
function BTChargePositionAction:anim_cb_attack_finished(unit, blackboard)
