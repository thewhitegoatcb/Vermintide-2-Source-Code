...
function CorruptorBeamExtension:init(extension_init_context, unit, extension_init_data)
...
function CorruptorBeamExtension:destroy()
	self:remove_vfx_and_sfx()
end

function CorruptorBeamExtension:on_remove_extension(unit, extension_name)
	self:remove_vfx_and_sfx(unit)
end

function CorruptorBeamExtension:remove_vfx_and_sfx(unit)
...
function CorruptorBeamExtension:set_state(state, target_unit)
...
function CorruptorBeamExtension:_get_positions(dt, self_pos, real_target_position)
...
function CorruptorBeamExtension:update(unit, input, dt, context, t)
