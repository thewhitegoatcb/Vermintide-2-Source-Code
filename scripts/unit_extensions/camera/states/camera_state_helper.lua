...
function CameraStateHelper.set_local_pose(camera_unit, unit, node)
...
function CameraStateHelper.set_camera_rotation(camera_unit, camera_extension)
...
function CameraStateHelper.set_follow_camera_position(camera_unit, follow_unit, follow_node, position_offset, snap_camera, dt)
