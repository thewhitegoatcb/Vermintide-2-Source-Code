...
return { description = "mutator_deus_more_hordes_desc", display_name = "mutator_deus_more_hordes_name", hide_from_player_ui = true, icon = "mutator_icon_deus_more_hordes",
