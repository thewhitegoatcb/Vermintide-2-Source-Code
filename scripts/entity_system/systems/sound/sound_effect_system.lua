...
local RPCS = { "rpc_aggro_unit_changed" }



local extensions = { "PlayerSoundEffectExtension" }



function SoundEffectSystem:init(entity_system_creation_context, system_name)
...
function SoundEffectSystem:destroy()
	self.network_event_delegate:unregister(self)
end

function SoundEffectSystem:aggro_unit_changed(target_unit, enemy_unit, has_aggro)
...
function SoundEffectSystem:rpc_aggro_unit_changed(channel_id, target_unit_id, enemy_unit_id, has_aggro)
...
function SoundEffectSystem:hot_join_sync()
	return end