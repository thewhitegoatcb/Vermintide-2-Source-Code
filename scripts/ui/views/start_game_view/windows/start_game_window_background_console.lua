...
function StartGameWindowBackgroundConsole:on_enter(params, offset)
...
function StartGameWindowBackgroundConsole:_get_with_mechanism(lookup)
	local mechanism_name = self.parent:get_mechanism_name()
	return lookup [mechanism_name] or lookup.adventure
end

local MOOD_PER_MECHANISM = { versus = "menu_versus", adventure = "default", deus = "menu_chaos_wastes_01" }





function StartGameWindowBackgroundConsole:_create_viewport_definition()
	return { scenegraph_id = "root_fit",
		element = UIElements.Viewport,
		style = {
			viewport = { layer = 990, viewport_name = "character_preview_viewport", shading_environment = "environment/ui_end_screen", clear_screen_on_create = true, level_name = "levels/ui_keep_menu/world", enable_sub_gui = false, fov = 50, world_name = "character_preview",
...
function StartGameWindowBackgroundConsole:create_ui_elements(params, offset)
...
function StartGameWindowBackgroundConsole:_setup_object_sets()
...
function StartGameWindowBackgroundConsole:on_exit(params)
...
function StartGameWindowBackgroundConsole:update(dt, t)
...
function StartGameWindowBackgroundConsole:_update_object_sets(layout_name)
...
function StartGameWindowBackgroundConsole:post_update(dt, t)
...
function StartGameWindowBackgroundConsole:_update_animations(dt)
...
function StartGameWindowBackgroundConsole:draw(dt)
...
function StartGameWindowBackgroundConsole:_update_loading_overlay_fadeout_animation(dt)
