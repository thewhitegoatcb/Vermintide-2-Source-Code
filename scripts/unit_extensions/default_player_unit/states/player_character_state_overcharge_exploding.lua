...
function PlayerCharacterStateOverchargeExploding:init(character_state_init_context)
...
function PlayerCharacterStateOverchargeExploding:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateOverchargeExploding:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateOverchargeExploding:explode()
...
function PlayerCharacterStateOverchargeExploding:update(unit, input, dt, context, t)
	local csm = self.csm
	...
	if self.damage_timer < t then
		...
		Managers.state.controller_features:add_effect("rumble", { rumble_effect = "overcharge_rumble_crit" })
