...
base_locus_definition.config = { block_other_interactions = true, hud_verb = "player_interaction", hold = true, swap_to_3p = false, activate_block = true, animation = "interaction_start" }
...
function base_locus_definition.server.start(world, interactor_unit, interactable_unit, data, config, t)
...
function base_locus_definition.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function base_locus_definition.client.start(world, interactor_unit, interactable_unit, data, config, t)
	local deus_belakor_locus_extension = ScriptUnit.has_extension(interactable_unit, "deus_belakor_locus_system")
	if deus_belakor_locus_extension then
		data.start_time = t
		local duration = deus_belakor_locus_extension:get_interaction_length()
...
function base_locus_definition.client.get_progress(data, config, t)
...
function base_locus_definition.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function base_locus_definition.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	local deus_belakor_locus_extension = ScriptUnit.has_extension(interactable_unit, "deus_belakor_locus_system")
...
function base_locus_definition.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.deus_belakor_locus_with_crystal.server.update(world, interactor_unit, interactable_unit, data, config, dt, t)
	local deus_belakor_locus_extension = ScriptUnit.has_extension(interactable_unit, "deus_belakor_locus_system")
