...
local extensions = { "GenericAggroableExtension" }



function AggroSystem:init(context, name)
	AggroSystem.super.init(self, context, name, extensions)

	self.aggroable_units = { [0] = { } }
...
function AggroSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function AggroSystem:on_remove_extension(unit, extension_name)
