...
function PlayerCharacterStateEmote:init(character_state_init_context)
	PlayerCharacterState.init(self, character_state_init_context, "emote")
	local context = character_state_init_context
end

function PlayerCharacterStateEmote:on_enter(unit, input, dt, context, t, previous_state, params)
	self.locomotion_extension:set_wanted_velocity(Vector3.zero())

	local camera_settings = { override_node_name = "camera_attach", camera_node = "emotes", force_state_change = true, allow_camera_movement = true,
...
function PlayerCharacterStateEmote:on_exit(unit, input, dt, context, t, next_state)
...
function PlayerCharacterStateEmote:update(unit, input, dt, context, t)
	local csm = self.csm
...
function PlayerCharacterStateEmote:_update_emote()
