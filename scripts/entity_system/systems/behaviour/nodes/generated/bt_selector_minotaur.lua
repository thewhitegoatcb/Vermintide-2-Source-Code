...
function BTSelector_minotaur:init(...)
	BTSelector_minotaur.super.init(self, ...)
	self._children = { }
end

function BTSelector_minotaur:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_minotaur:run(unit, blackboard, t, dt)
...
function BTSelector_minotaur:add_child(node)
