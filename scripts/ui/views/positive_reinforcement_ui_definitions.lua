...
local scenegraph_definition = {
	...
	pivot = { vertical_alignment = "top", parent = "root", horizontal_alignment = "right",
	...
	pivot_dragger = { vertical_alignment = "bottom", parent = "message_animated", horizontal_alignment = "left",
	...
	message_animated = { vertical_alignment = "top", parent = "pivot", horizontal_alignment = "right",
	...
	message_animated_base = { vertical_alignment = "top", parent = "pivot", horizontal_alignment = "right",
	...
	message_animated_offset = { vertical_alignment = "top", parent = "pivot", horizontal_alignment = "right",
...
local widget_definitions = {
	message_animated = { scenegraph_id = "message_animated",
		element = {
			passes = { { pass_type = "texture", style_id = "icon_1", texture_id = "icon_1",
				...
				{ pass_type = "texture", style_id = "icon_2", texture_id = "icon_2",
				...
				{ pass_type = "texture", style_id = "icon_3", texture_id = "icon_3",
		...
		style = {
			text = { vertical_alignment = "bottom", dynamic_font = true, horizontal_alignment = "right", font_type = "hell_shark",
				font_size = FONT_SIZE,
...
local function create_message_widgets(number_of_slots)
	...
	for i = 1, number_of_slots do
		local message = { scenegraph_id = "message_animated",
			element = {
				passes = { { pass_type = "texture", style_id = "icon_1", texture_id = "icon_1",
			...
			content = { text = "", icon_texture = "hud_tutorial_icon_info",
				message_tables = { } },
...
local function create_reinforcement_widget(scenegraph_id, frame_settings_name, scale, retained_mode)
	...
	style [center_icon_name] = {
		...
		offset = { widget_length / 2 - 20 - 8, -20, 2 },
		size = { 40, 40 } }
	...
	style [background_name] = {
		color = table.clone(default_color),
		offset = { widget_length / 2 - 116, -34, 0 },
		size = { 232, 68 } }
	...
	style [arrow_name] = {
		color = table.clone(default_color),
		offset = { widget_length / 2 - 8, -13, 1 },
		size = { 35, 26 } }

	texte_style_ids [#texte_style_ids + 1] = arrow_name

	for i = 1, 2 do
		local portrait_offset = { ( i - 1 ) * widget_length, 0, 3 }
		...
		if i ~= 1 or not { { 0, 0 }, { 1, 1 } } then local uvs = { { 1, 0 }, { 0, 1 } } end
	...
	passes [#passes + 1] = { style_id = "count_text", pass_type = "text", text_id = "count_text",
	...
	passes [#passes + 1] = { style_id = "count_text_shadow", pass_type = "text", text_id = "count_text",
	...
	style.count_text = { vertical_alignment = "center", font_type = "hell_shark", use_shadow = true, font_size = 26, horizontal_alignment = "right",
	...
	style.count_text_shadow = { vertical_alignment = "center", font_type = "hell_shark", use_shadow = true, font_size = 26, horizontal_alignment = "right",
