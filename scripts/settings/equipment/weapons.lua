...
DamageTypes = { STAGGER = 4, DAMAGE = 5, SPEED = 3, CLEAVE = 2, ARMOR_PIERCING = 1 }
...
DAMAGE_TYPES_AOE = { warpfire_face = true, vomit_face = true, vomit_ground = true, poison = true, plague_face = true, warpfire_ground = true }
...
Dots = {
	poison_dot = function (dot_template_name, damage_profile, target_index, power_level, target_unit, attacker_unit, hit_zone_name, damage_source, boost_curve_multiplier, is_critical_strike, source_attacker_unit)
		...
		dot_template_name =
		dot_template_name or target_settings.dot_template_name or damage_profile.dot_template_name
...
DotTypeLookup = DotTypeLookup or { burning_dot_unchained_push = "burning_dot", burning_dot = "burning_dot", burning_dot_3tick = "burning_dot", arrow_poison_dot = "poison_dot", weapon_bleed_dot_whc = "poison_dot", burning_dot_1tick = "burning_dot", weapon_bleed_dot_maidenguard = "poison_dot", beam_burning_dot = "burning_dot", weapon_bleed_dot_dagger = "poison_dot", burning_dot_fire_grenade = "burning_dot", corpse_explosion_default = "poison_dot", burning_flamethrower_dot = "burning_dot", aoe_poison_dot = "poison_dot", sienna_necromancer_4_3_dot = "burning_dot", death_staff_dot = "burning_dot", chaos_zombie_explosion = "poison_dot" }
...
local MeleeBuffTypes = MeleeBuffTypes or { MELEE_1H = true, MELEE_2H = true }
local RangedBuffTypes = RangedBuffTypes or { RANGED_ABILITY = true, RANGED = true }
				...
				if pickup_settings then
					...
					if link_hit_zones then
						for i = 1, #link_hit_zones do
							...
							link_hit_zones [hit_zone_name] = true end end end end end end end