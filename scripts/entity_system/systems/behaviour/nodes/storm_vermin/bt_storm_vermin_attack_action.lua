...
function BTStormVerminAttackAction:init(...)
...
function BTStormVerminAttackAction:enter(unit, blackboard, t)
...
function BTStormVerminAttackAction:_init_attack(unit, blackboard, t)
...
function BTStormVerminAttackAction:leave(unit, blackboard, t, reason, destroy)
...
function BTStormVerminAttackAction:run(unit, blackboard, t, dt)
	...
	if target_is_valid and blackboard.bot_threat_at_t and blackboard.bot_threat_at_t < t then
		self:_create_bot_threat(unit, blackboard)
...
function BTStormVerminAttackAction:_create_bot_threat(unit, blackboard)
	local action = blackboard.action
	local bot_threat_duration = action.bot_threat_duration
...
function BTStormVerminAttackAction:anim_cb_attack_vce(unit, blackboard)
	local network_manager = Managers.state.network
...
function BTStormVerminAttackAction:anim_cb_attack_vce_long(unit, blackboard)
	local network_manager = Managers.state.network
...
function BTStormVerminAttackAction:update_reset_attack(unit, t, dt, blackboard)
	local action = blackboard.action
...
function BTStormVerminAttackAction:attack(unit, t, dt, blackboard)
...
local debug_drawer_info = { mode = "retained", name = "BTStormVerminAttackAction" }

function BTStormVerminAttackAction:anim_cb_damage(unit, blackboard)
	local action = blackboard.action
...
function BTStormVerminAttackAction:anim_cb_attack_finished(unit, blackboard)
	blackboard.attack_finished = true
end

function BTStormVerminAttackAction:_calculate_cylinder_collision(action, self_pos, self_rot)
...
function BTStormVerminAttackAction:_calculate_oobb_collision(action, self_pos, self_rot)
	local range = action.range
	local height = action.height
	local width = action.width
...
function BTStormVerminAttackAction.tag_catapult_enemy(unit, blackboard, action, target_unit, blocked)
...
function BTStormVerminAttackAction.catapult_enemies(unit, blackboard)
...
function BTStormVerminAttackAction.catapult_enemy(unit, blackboard, action, target_unit, blocked)
