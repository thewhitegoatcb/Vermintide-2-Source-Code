...
function StoreWorldMarkerExtension:init(extension_init_context, unit, extension_init_data)
...
function StoreWorldMarkerExtension:_destroy()
	Managers.state.event:unregister("set_all_shop_item_seen", self)
end

function StoreWorldMarkerExtension:event_set_all_shop_item_seen()
	self._unseen_shop_items = false
end

function StoreWorldMarkerExtension:_extensions_ready()
...
function StoreWorldMarkerExtension:_add_marker(cb)
...
function StoreWorldMarkerExtension:update(unit, dummy_input, dt, context, t)
