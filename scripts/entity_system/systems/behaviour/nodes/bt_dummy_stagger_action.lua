...
function BTDummyStaggerAction:init(...)
...
function BTDummyStaggerAction:enter(unit, blackboard, t)
...
function BTDummyStaggerAction:_select_animation(unit, blackboard, impact_vec, stagger_anims)
...
function BTDummyStaggerAction:clean_blackboard(blackboard)
...
function BTDummyStaggerAction:leave(unit, blackboard, t, reason, destroy)
...
function BTDummyStaggerAction:run(unit, blackboard, t, dt)
...
function BTDummyStaggerAction:anim_cb_push_cancel(unit, blackboard)
