...
EnemyPackageLoaderSettings.categories = { { id = "bosses", dynamic_loading = false,


		limit = math.huge,

		breeds = { "chaos_spawn", "chaos_troll", "skaven_rat_ogre", "skaven_stormfiend" } },





	{ id = "specials", dynamic_loading = false,


		limit = math.huge,

		breeds = { "chaos_plague_sorcerer", "chaos_corruptor_sorcerer", "skaven_gutter_runner", "skaven_pack_master", "skaven_poison_wind_globadier", "skaven_ratling_gunner", "skaven_warpfire_thrower", "chaos_vortex_sorcerer" } },
	...
	{ id = "level_specific", dynamic_loading = true,


		limit = math.huge,

		breeds = { "chaos_dummy_sorcerer", "chaos_exalted_champion_warcamp", "chaos_exalted_sorcerer", "skaven_storm_vermin_warlord", "skaven_storm_vermin_champion", "chaos_plague_wave_spawner", "skaven_stormfiend_boss", "skaven_grey_seer", "training_dummy", "pet_skeleton", "pet_skeleton_with_shield", "pet_skeleton_dual_wield", "pet_skeleton_armored", "critter_nurgling" } },
	...
	{ id = "debug", dynamic_loading = true, forbidden_in_build = "release",


		limit = math.huge,


		breeds = { "chaos_zombie", "chaos_skeleton", "chaos_tentacle", "chaos_tentacle_sorcerer", "skaven_stormfiend_demo" } },
	...
	{ id = "always_loaded", dynamic_loading = false,




		breeds = { "chaos_vortex", "critter_rat", "critter_pig" } } }
...
if IS_CONSOLE or script_data.enemy_package_loader_policy == "console" then
	...
	category_changes = {
		bosses = { limit = 1, dynamic_loading = true },



		specials = { dynamic_loading = true, limit = 3,


			replacement_breed_override_funcs = { patrol = "_find_patrol_replacement" } },



		level_specific = { dynamic_loading = true,
			limit = math.huge },


		debug = { forbidden_in_build = "release", dynamic_loading = true,
			limit = math.huge } }
end
...
EnemyPackageLoaderSettings.opt_lookup_breed_names = { skaven_storm_vermin_with_shield = "skaven_storm_vermin_with_shield_opt", chaos_raider = "chaos_raider_opt", chaos_berzerker = "chaos_berzerker_opt", skaven_clan_rat_with_shield = "skaven_clan_rat_with_shield_opt", chaos_marauder_with_shield = "chaos_marauder_with_shield_opt", chaos_fanatic = "chaos_fanatic_opt", skaven_slave = "skaven_slave_opt", skaven_storm_vermin = "skaven_storm_vermin_opt", skaven_clan_rat = "skaven_clan_rat_opt", chaos_marauder = "chaos_marauder_opt" }
...
EnemyPackageLoaderSettings.alias_to_breed = { chaos_raider_tutorial = "chaos_raider", chaos_dummy_troll = "chaos_troll", skaven_dummy_slave = "skaven_slave", chaos_exalted_champion_norsca = "chaos_exalted_champion_warcamp", chaos_marauder_tutorial = "chaos_marauder", skaven_storm_vermin_commander = "skaven_storm_vermin", chaos_spawn_exalted_champion_norsca = "chaos_spawn", skaven_clan_rat_tutorial = "skaven_clan_rat", skaven_dummy_clan_rat = "skaven_clan_rat" }
