...
function HeroWindowGotwfBackground:on_enter(params, offset)
...
function HeroWindowGotwfBackground:_start_animation(animation_name)
	local params = {
		parent = self._parent,
...
function HeroWindowGotwfBackground:_create_viewport_definition()
	return { scenegraph_id = "screen",
		element = UIElements.Viewport,
		style = {
			viewport = { layer = 2, viewport_name = "character_preview_viewport", clear_screen_on_create = true, level_name = "levels/gifts_of_the_wolf_father/gifts_of_wolf_father", enable_sub_gui = false, fov = 50, world_name = "character_preview",
...
function HeroWindowGotwfBackground:_create_ui_elements(params, offset)
...
function HeroWindowGotwfBackground:_package_loaded()
	self._viewport_widget_definition = self:_create_viewport_definition()
	self._fadeout_loading_overlay = true
end

function HeroWindowGotwfBackground:on_exit(params)
	...
	if self._package_reference_name and
	Managers.package:has_loaded(self._package_name, self._package_reference_name) then
...
function HeroWindowGotwfBackground:update(dt, t)
...
function HeroWindowGotwfBackground:_update_pan(dt, t)
	...
	self._world_previewer:set_default_position({ z = 53, y = 266, x = -62 + offset })
...
function HeroWindowGotwfBackground:post_update(dt, t)
	...
	if not self._initialized and self._viewport_widget then
		...
		world_previewer:set_default_position({ z = 53, x = -62, y = 266 })
...
function HeroWindowGotwfBackground:_update_animations(dt)
...
function HeroWindowGotwfBackground:_draw(dt)
...
function HeroWindowGotwfBackground:_update_loading_overlay_fadeout_animation(dt)
