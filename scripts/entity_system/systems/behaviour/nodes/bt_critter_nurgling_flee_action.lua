...
function BTCritterNurglingFleeAction:leave(unit, blackboard, t, reason, destroy)
...
function BTCritterNurglingFleeAction:run(unit, blackboard, t)
...
function BTCritterNurglingFleeAction:start_idle_animation(unit, blackboard)
	Managers.state.network:anim_event(unit, "idle")
	blackboard.move_state = "idle"
end

function BTCritterNurglingFleeAction:has_escaped_players(unit, blackboard, action)
...
function BTCritterNurglingFleeAction:get_random_move_pos(unit, blackboard, action)
	...
	move_pos =
	move_pos or start_pos


	return move_pos
end

function BTCritterNurglingFleeAction:start_move_animation(unit, blackboard)
