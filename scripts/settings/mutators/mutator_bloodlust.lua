return { description = "description_mutator_bloodlust", display_name = "display_name_mutator_bloodlust", debuff_start_time = 4.25, icon = "mutator_icon_bloodlust",





	amount_of_stacks_per_breed = { chaos_vortex_sorcerer = 2, skaven_plague_monk = 3, chaos_berzerker = 3, skaven_ratling_gunner = 2, skaven_poison_wind_globadier = 2, skaven_warpfire_thrower = 2, chaos_raider = 3, skaven_gutter_runner = 2, skaven_loot_rat = 2, skaven_pack_master = 2, skaven_stormfiend = 10, chaos_warrior = 5, skaven_rat_ogre = 10, chaos_troll = 10, chaos_spawn = 10, chaos_corruptor_sorcerer = 2, skaven_storm_vermin_commander = 3, skaven_storm_vermin = 3, skaven_storm_vermin_with_shield = 3 },
