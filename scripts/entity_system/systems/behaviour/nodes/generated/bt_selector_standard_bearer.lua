...
function BTSelector_standard_bearer:init(...)
	BTSelector_standard_bearer.super.init(self, ...)
	self._children = { }
end

function BTSelector_standard_bearer:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_standard_bearer:run(unit, blackboard, t, dt)
...
function BTSelector_standard_bearer:add_child(node)
