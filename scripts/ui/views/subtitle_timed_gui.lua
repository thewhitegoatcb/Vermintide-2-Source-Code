local scenegraph_definition = {
	...
	subtitle_row = { vertical_alignment = "bottom", parent = "menu_root", horizontal_alignment = "center",
...
local subtitle_row_widget = { start_offset_y = 0, scenegraph_id = "subtitle_row",
	element = {
		passes = { { style_id = "text", pass_type = "text", text_id = "text" },



			{ style_id = "shadow_text", pass_type = "text", text_id = "text" } } },
	...
	style = {
		text = { vertical_alignment = "center", font_type = "hell_shark", word_wrap = false, font_size = 36, horizontal_alignment = "center",
		...
		shadow_text = { vertical_alignment = "center", font_type = "hell_shark", word_wrap = false, font_size = 36, horizontal_alignment = "center",
...
function SubtitleTimedGui:is_complete()
	return self._complete
end

function SubtitleTimedGui:init(subtitle_timing_name, num_rows)
...
function SubtitleTimedGui:_create_ui_elements(ui_renderer)
...
function SubtitleTimedGui:update(ui_renderer, dt)
...
function SubtitleTimedGui:draw(ui_renderer, dt)
