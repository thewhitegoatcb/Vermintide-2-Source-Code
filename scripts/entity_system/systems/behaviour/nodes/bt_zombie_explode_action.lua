...
function BTZombieExplodeAction:init(...)
	BTZombieExplodeAction.super.init(self, ...)
end

BTZombieExplodeAction.name = "BTZombieExplodeAction"

function BTZombieExplodeAction:enter(unit, blackboard, t)
...
function BTZombieExplodeAction:leave(unit, blackboard, t, reason, destroy)
	local navigation_extension = blackboard.navigation_extension
	navigation_extension:set_enabled(true)
end

function BTZombieExplodeAction:run(unit, blackboard, t, dt)
...
function BTZombieExplodeAction:explode(unit, blackboard, t)
