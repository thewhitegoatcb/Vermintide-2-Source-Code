...
function WeaveSocketExtension:init(extension_init_context, unit, extension_init_data)
...
function WeaveSocketExtension:get_objective_settings()
	return WeaveObjectiveSettings [WeaveSocketExtension.NAME]
end

function WeaveSocketExtension:score()
	return self._score
end

function WeaveSocketExtension:activate(game_object_id, objective_data)
...
function WeaveSocketExtension:complete()
...
function WeaveSocketExtension:deactivate()
	if self._is_server then
...
function WeaveSocketExtension:objective_name()
	return self._objective_name
end

function WeaveSocketExtension:update(dt, t)
...
function WeaveSocketExtension:cb_game_session_disconnect()

	return end

function WeaveSocketExtension:is_done()
	return self._is_done
end

function WeaveSocketExtension:_server_update(dt, t)
...
function WeaveSocketExtension:_client_update(dt, t)
	return end

function WeaveSocketExtension:get_percentage_done()
	return math.clamp(self._num_closed_sockets / self._num_sockets, 0, 1)
end

function WeaveSocketExtension:get_score()
	return self._score
end