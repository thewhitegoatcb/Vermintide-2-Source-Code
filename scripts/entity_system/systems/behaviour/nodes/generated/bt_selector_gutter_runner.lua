...
function BTSelector_gutter_runner:init(...)
	BTSelector_gutter_runner.super.init(self, ...)
	self._children = { }
end

function BTSelector_gutter_runner:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_gutter_runner:run(unit, blackboard, t, dt)
...
function BTSelector_gutter_runner:add_child(node)
