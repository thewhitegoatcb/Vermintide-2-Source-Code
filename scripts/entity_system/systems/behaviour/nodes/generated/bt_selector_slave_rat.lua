...
function BTSelector_slave_rat:init(...)
	BTSelector_slave_rat.super.init(self, ...)
	self._children = { }
end

function BTSelector_slave_rat:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_slave_rat:run(unit, blackboard, t, dt)
...
function BTSelector_slave_rat:add_child(node)
