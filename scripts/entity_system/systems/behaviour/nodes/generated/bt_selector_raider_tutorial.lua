...
function BTSelector_raider_tutorial:init(...)
	BTSelector_raider_tutorial.super.init(self, ...)
	self._children = { }
end

function BTSelector_raider_tutorial:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_raider_tutorial:run(unit, blackboard, t, dt)
...
function BTSelector_raider_tutorial:add_child(node)
