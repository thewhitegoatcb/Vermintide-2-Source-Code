...
function StateLoadingRestartNetwork:on_enter(params)
...
function StateLoadingRestartNetwork:_init_params(params)
	...
	self._previous_session_error_headers_lookup = { host_left_game = "popup_notice_topic", kicked_by_server = "popup_notice_topic", afk_kick = "popup_notice_topic" }
...
function StateLoadingRestartNetwork:_init_network()
	...
	local lobby_data = self._starting_tutorial and
	Managers.invite:get_invited_lobby_data()
...
function StateLoadingRestartNetwork:update(dt, t)
...
function StateLoadingRestartNetwork:on_exit(application_shutdown) return end

function StateLoadingRestartNetwork:cb_server_created()
	self._server_created = true
end

function StateLoadingRestartNetwork:cb_lobby_joined()
	self._lobby_joined = true
end