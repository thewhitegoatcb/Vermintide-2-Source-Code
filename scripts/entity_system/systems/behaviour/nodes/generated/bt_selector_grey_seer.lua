...
function BTSelector_grey_seer:init(...)
	BTSelector_grey_seer.super.init(self, ...)
	self._children = { }
end

function BTSelector_grey_seer:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_grey_seer:run(unit, blackboard, t, dt)
...
function BTSelector_grey_seer:add_child(node)
