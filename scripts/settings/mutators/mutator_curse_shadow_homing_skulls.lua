...
local function find_positions(physics_world, random_player, shooter_count)
	...
	local cluster_center_positions = ConflictUtils.find_visible_positions_in_sphere_around_player(
	physics_world,
	shooter_count,
	random_player,
	BelakorBalancing.homing_skulls_radius,
	BelakorBalancing.homing_skulls_min_pitch,
	BelakorBalancing.homing_skulls_max_pitch,
	BelakorBalancing.homing_skulls_pitch_delta,
	0,
	2 * math.pi,
	BelakorBalancing.homing_skulls_yaw_delta,
	forbidden_position_list,
	BelakorBalancing.homing_skulls_radius,
	BelakorBalancing.homing_skulls_distance_between_skulls,
	BelakorBalancing.homing_skulls_min_distance_above_ground)


	return cluster_center_positions
end
local STATES = { WAITING_TO_SPAWN = "WAITING_TO_SPAWN", DISABLED = "DISABLED", SPAWNING = "SPAWNING" }




return { description = "curse_shadow_homing_skulls_desc", curse_package_name = "resource_packages/mutators/mutator_curse_shadow_homing_skulls", display_name = "curse_shadow_homing_skulls_name", icon = "deus_curse_belakor_01",
