...
function BTSelector_chaos_exalted_champion_warcamp:init(...)
	BTSelector_chaos_exalted_champion_warcamp.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_exalted_champion_warcamp:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_exalted_champion_warcamp:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_exalted_champion_warcamp:add_child(node)
