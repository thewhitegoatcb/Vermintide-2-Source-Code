...
function WeaveTargetExtension:init(extension_init_context, unit, extension_init_data)
	...
	self._attacks_allowed = extension_init_data.attacks_allowed or { melee = true, ranged = true }
...
function WeaveTargetExtension:get_objective_settings()
	return WeaveObjectiveSettings [WeaveTargetExtension.NAME]
end

function WeaveTargetExtension:score()
	return self._score
end

function WeaveTargetExtension:activate(game_object_id, objective_data)
...
function WeaveTargetExtension:complete()
...
function WeaveTargetExtension:deactivate()
	if self._is_server then
...
function WeaveTargetExtension:objective_name()
	return self._objective_name
end

function WeaveTargetExtension:cb_game_session_disconnect()

	return end

function WeaveTargetExtension:update(dt, t)
...
function WeaveTargetExtension:_server_update(dt, t)
...
function WeaveTargetExtension:_client_update(dt, t)
	return end

function WeaveTargetExtension:is_done()
	return self._health_system:is_dead()
end

function WeaveTargetExtension:attacks_allowed()
	return self._attacks_allowed
end

function WeaveTargetExtension:get_percentage_done()
	return math.clamp(1 - self._health / self._max_health, 0, 1)
end

function WeaveTargetExtension:get_score()
	return self._score
end