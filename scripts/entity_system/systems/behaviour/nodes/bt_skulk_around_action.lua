...
function BTSkulkAroundAction:init(...)
...
function BTSkulkAroundAction:enter(unit, blackboard, t)
...
function BTSkulkAroundAction:leave(unit, blackboard, t, reason, destroy)
...
function BTSkulkAroundAction:run(unit, blackboard, t, dt)
	local skulk_data = blackboard.skulk_data
...
function BTSkulkAroundAction:get_new_skulk_goal(unit, blackboard)
