...
function ScrollbarUI:init(ui_scenegraph, scroll_area_scenegraph_id, scroll_area_anchor_scenegraph_id, excess_area, enable_auto_scroll, optional_scroll_area_hotspot_widget, horizontal_scrollbar)
...
function ScrollbarUI:_create_ui_elements()
...
function ScrollbarUI:update(dt, t, ui_renderer, input_service, render_settings)
...
function ScrollbarUI:force_update_progress()
...
function ScrollbarUI:_auto_scroll(dt, t)
...
function ScrollbarUI:disable_input(disable)
	self._input_disabled = disable
end

function ScrollbarUI:_update_input(dt, t, input_service, ui_renderer)
...
function ScrollbarUI:_calculate_input_offset(input_service, ui_scenegraph)
	local widget = self._widgets_by_name.scrollbar
...
function ScrollbarUI:_update_scroller_position(input_service, ui_scenegraph)
	local widget = self._widgets_by_name.scrollbar
	local style = widget.style
...
function ScrollbarUI:_update_scroller_progress()
	local widget = self._widgets_by_name.scrollbar
...
function ScrollbarUI:_update_scrollbar_hover_animations()
	local widget = self._widgets_by_name.scrollbar
	local widget_content = widget.content
...
function ScrollbarUI:_update_animations(dt, t)
...
function ScrollbarUI:_draw(dt, t, ui_renderer, input_service, render_settings)
	local ui_scenegraph = self._ui_scenegraph
...
function ScrollbarUI:destroy(ui_scenegraph)
