...
function NavHelpers.unit_script_data(unit, default, ...)
...
function NavHelpers.get_layer_and_smartobject(unit, script_object_name)
	...
	local nav_tag_color = Color(
	NavHelpers.unit_script_data(unit, 0, script_object_name, "color", "r"),
	NavHelpers.unit_script_data(unit, 255, script_object_name, "color", "g"),
	NavHelpers.unit_script_data(unit, 0, script_object_name, "color", "b"))
