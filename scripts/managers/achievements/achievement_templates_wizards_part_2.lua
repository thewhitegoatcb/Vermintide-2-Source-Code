...
local XB1_ACHIEVEMENT_ID = { tower_hardest = 111, tower_wall_illusions = 108, tower_note_puzzle = 110, tower_skulls = 107, tower_created_all_potions = 109 }
...
local PS4_ACHIEVEMENT_ID = { tower_skulls = "088", tower_wall_illusions = "089" }
...
local bastion = { LevelSettings.dlc_wizards_tower }
...
local player_facing_diff_names = { hardest = "legend", hard = "veteran", harder = "champion", cataclysm = "cataclysm", normal = "recruit" }
...
achievements.tower_skulls = { name = "achv_tower_skulls_name", display_completion_ui = true, icon = "achievement_wizards_tower_skulls", desc = "achv_tower_skulls_desc",





	events = { "on_tower_skull_found" },
...
achievements.tower_wall_illusions = { name = "achv_tower_wall_illusions_name", display_completion_ui = true, icon = "achievement_wizards_tower_wall_illusions", desc = "achv_tower_wall_illusions_desc",





	events = { "tower_wall_illusion_found" },
	completed = function (statistics_db, stats_id, template_data)
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		if template_data [index] then return
		end
...
achievements.tower_invisible_bridge = { name = "achv_tower_invisible_bridge_name", display_completion_ui = true, icon = "achievement_wizards_tower_invisible_bridge", desc = "achv_tower_invisible_bridge_desc",





	events = { "update_tower_invisible_bridge_challenge" },
	completed = function (statistics_db, stats_id, template_data)
		return statistics_db:get_persistent_stat(stats_id, "tower_invisible_bridge") >= 1
	end,
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		if template_data.done then return
		end
...
achievements.tower_enable_guardian_of_lustria = { name = "achv_tower_guardian_of_lustria_name", display_completion_ui = true, icon = "achievement_wizards_tower_guardian_of_lustria", desc = "achv_tower_guardian_of_lustria_desc",





	events = { "tower_enable_guardian_of_lustria" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.tower_note_puzzle = { name = "achv_tower_note_puzzle_name", display_completion_ui = true, icon = "achievement_wizards_tower_note_puzzle", desc = "achv_tower_note_puzzle_desc",





	events = { "tower_note_puzzle" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.tower_created_all_potions = { name = "achv_tower_created_all_potions_name", display_completion_ui = true, icon = "achievement_wizards_tower_created_all_potions", desc = "achv_tower_created_all_potions_desc",





	events = { "tower_potion_created" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.tower_time_challenge = { name = "achv_tower_time_challenge_name", display_completion_ui = true, icon = "achievement_wizards_tower_time_challenge",
	...
	events = { "gameplay_start", "register_completed_level" },
	completed = function (statistics_db, stats_id, template_data)
