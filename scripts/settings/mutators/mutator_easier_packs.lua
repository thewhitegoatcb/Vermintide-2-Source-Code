local conversion_table = { marauders_and_warriors = "marauders", shield_rats = "shield_rats_no_elites", beastmen_elites = "beastmen", standard = "standard_no_elites", beastmen = "beastmen_light", marauders_elites = "marauders_and_warriors" }
