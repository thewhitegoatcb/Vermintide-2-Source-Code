...
function BTTauntAction:init(...)
	BTTauntAction.super.init(self, ...)
end

BTTauntAction.name = "BTTauntAction"

function BTTauntAction:enter(unit, blackboard, t)
	print("TAUNT")
...
function BTTauntAction:leave(unit, blackboard, t, reason, destroy)
	return end

function BTTauntAction:run(unit, blackboard, t, dt)
