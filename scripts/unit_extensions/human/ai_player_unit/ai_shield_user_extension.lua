...
function AIShieldUserExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
...
function AIShieldUserExtension:destroy()
	return end

function AIShieldUserExtension:extensions_ready(world, unit)
...
function AIShieldUserExtension:set_is_blocking(is_blocking)
...
function AIShieldUserExtension:set_is_dodging(is_dodging)
	local shield_broken = self.shield_broken
	if shield_broken then
		return
	end
...
function AIShieldUserExtension:break_shield()
...
function AIShieldUserExtension:can_block_attack(attacker_unit, trueflight_blocking, hit_direction)
