...
function BTSelector_chaos_zombie:init(...)
	BTSelector_chaos_zombie.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_zombie:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_zombie:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_zombie:add_child(node)
