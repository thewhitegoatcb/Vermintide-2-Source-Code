...
function DeusSoftCurrencyIndicatorUI:init(parent, ingame_ui_context)
	self._ui_renderer = ingame_ui_context.ui_renderer
	self._ingame_ui_context = ingame_ui_context
	self:_create_ui_elements()
end

function DeusSoftCurrencyIndicatorUI:_create_ui_elements()
...
function DeusSoftCurrencyIndicatorUI:play_animation(animation_name, from_coin_count, to_coin_count)
	local params = {
...
function DeusSoftCurrencyIndicatorUI:_update_animations(dt)
...
function DeusSoftCurrencyIndicatorUI:set_visible(status)
	return end

function DeusSoftCurrencyIndicatorUI:_get_coins()
	...
	if not mechanism or not mechanism.get_deus_run_controller then return 0 end
...
function DeusSoftCurrencyIndicatorUI:update(dt, t)
...
function DeusSoftCurrencyIndicatorUI:_draw(dt, t)
