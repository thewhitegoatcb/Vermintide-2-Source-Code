...
local function default_condition_func(vote_data)
	...
	if not validation_data then
		...
		local unused_indices = { true, true, true, true, true }
...
TwitchVoteTemplates.twitch_give_first_aid_kit = { cost = -100, use_frame_texture = true, texture_id = "twitch_icon_medical_supplies", multiple_choice = true, text = "twitch_give_first_aid_kit_one",
...
TwitchVoteTemplates.twitch_give_healing_draught = { cost = -100, use_frame_texture = true, texture_id = "twitch_icon_healing_draught", multiple_choice = true, text = "twitch_give_healing_draught_one",
...
TwitchVoteTemplates.twitch_give_damage_boost_potion = { cost = -50, use_frame_texture = true, texture_id = "twitch_icon_potion_of_strength", multiple_choice = true, text = "twitch_give_damage_boost_potion_one",
...
TwitchVoteTemplates.twitch_give_speed_boost_potion = { cost = -50, use_frame_texture = true, texture_id = "twitch_icon_potion_of_speed", multiple_choice = true, text = "twitch_give_speed_boost_potion_one",
...
TwitchVoteTemplates.twitch_give_cooldown_reduction_potion = { cost = -50, use_frame_texture = true, texture_id = "twitch_icon_potion_of_concentration", multiple_choice = true, text = "twitch_give_cooldown_reduction_potion_one",
...
TwitchVoteTemplates.twitch_give_frag_grenade_t1 = { cost = -100, use_frame_texture = true, texture_id = "twitch_icon_bomb", multiple_choice = true, text = "twitch_give_frag_grenade_t1_one",
...
TwitchVoteTemplates.twitch_give_fire_grenade_t1 = { cost = -100, use_frame_texture = true, texture_id = "twitch_icon_incediary_bomb", multiple_choice = true, text = "twitch_give_fire_grenade_t1_one",
