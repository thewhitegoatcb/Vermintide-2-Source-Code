...
function ActionDamageTarget:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionDamageTarget:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionDamageTarget:_apply_damage_step(hit_unit, power_level, step_data, t)
...
function ActionDamageTarget:client_owner_post_update(dt, t, world, can_damage)
	local target_unit = self._target_unit
...
function ActionDamageTarget:_start_forced_action(t)
...
function ActionDamageTarget:finish(reason)
...
function ActionDamageTarget:destroy()
	return end