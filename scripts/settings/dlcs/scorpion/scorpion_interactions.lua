...
local function _fulfill_requirements_for_weave()
	...
	for _, level_key in pairs(HelmgartLevels) do
		...
		if level_settings.mechanism == "adventure" and
...
function InteractionDefinitions.weave_level_select_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	not data.is_husk then
		...
		if fulfill_requirements_for_weave_levels then
			Managers.ui:handle_transition("start_game_view_force", { menu_sub_state_name = "weave_quickplay", menu_state_name = "play", use_fade = true })
...
function InteractionDefinitions.weave_level_select_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end

function InteractionDefinitions.weave_level_select_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
...
function InteractionDefinitions.weave_magic_forge_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	not data.is_husk then
		...
		if fulfill_requirements_for_weave_forge then
			Managers.ui:handle_transition("hero_view_force", { use_fade = true, menu_state_name = "weave_forge" })
...
function InteractionDefinitions.weave_magic_forge_access.client.can_interact(interactor_unit, interactable_unit, data, config)
	return true
end

function InteractionDefinitions.weave_magic_forge_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), Unit.get_data(interactable_unit, "interaction_data", "hud_interaction_action")
end
...
function InteractionDefinitions.weave_leaderboard_access.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	...
	not data.is_husk then
		...
		if fulfill_requirements_for_leaderboard then
			Managers.ui:handle_transition("start_game_view_force", { use_fade = true, menu_state_name = "leaderboard" })
...
function InteractionDefinitions.weave_leaderboard_access.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.weave_leaderboard_access.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
	if fail_reason == "status_offline" then
		do return Unit.get_data(interactable_unit, "interaction_data", "hud_description"), "status_offline" end
	else
