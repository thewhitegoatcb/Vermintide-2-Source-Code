...
GameActsOrder = { "prologue", "act_1", "act_2", "act_3", "act_4" }
...
MapPresentationActs = { "act_1", "act_2", "act_3", "act_4" }
...
GameActsDisplayNames = { act_1 = "act_1_display_name", prologue = "prologue_display_name", act_4 = "act_4_display_name", act_3 = "act_3_display_name", act_2 = "act_2_display_name" }
...
local function validate_level_data(level_key, level_data)
	if type(level_data) == "table" then
		...
		if only_release then
			...
			do return not level_settings.hub_level and unlockable and available and not debug_level end
		else
			local unlockable = level_data.unlockable
...
function LevelUnlockUtils.unlocked_level_difficulty_index(statistics_db, player_stats_id, level_key)
...
function LevelUnlockUtils.completed_level_difficulty_index(statistics_db, player_stats_id, level_key)
...
function LevelUnlockUtils.unlocked_journeys(statistics_db, player_stats_id)
	local journeys = { }
...
function LevelUnlockUtils.completed_journey_difficulty_index(statistics_db, player_stats_id, journey_name)
	...
	if journey_difficulty_name then
		...
		do return difficulty_index end
	else
		return 0
	end
end

function LevelUnlockUtils.completed_hero_journey_difficulty_index(statistics_db, player_stats_id, hero, journey_name)
	local journey_difficulty_name = JourneyDifficultyDBNames [journey_name]
	if journey_difficulty_name then
...
function LevelUnlockUtils.completed_journey_dominant_god_difficulty_index(statistics_db, player_stats_id, dominant_god)
...
function LevelUnlockUtils.highest_completed_difficulty_index_by_act(statistics_db, player_stats_id, act_name)
...
function LevelUnlockUtils.completed_adventure_difficulty(statistics_db, player_stats_id)
	return 1
end

function LevelUnlockUtils.completed_main_game_difficulty(statistics_db, player_stats_id)
...
function LevelUnlockUtils.completed_dlc_difficulty(statistics_db, player_stats_id, dlc_name)
...
function LevelUnlockUtils.get_required_completed_levels(statistics_db, player_stats_id, level_key)
...
function LevelUnlockUtils.current_weave(statistics_db, player_stats_id, ignore_dlc_check)
...
function LevelUnlockUtils.weave_unlocked(statistics_db, player_stats_id, weave_name, ignore_dlc_check, num_players)
	if script_data.unlock_all_levels then
		return true
	end
...
function LevelUnlockUtils.level_unlocked(statistics_db, player_stats_id, level_key, ignore_dlc_check)
	if script_data.unlock_all_levels then
		return true
	end
...
function LevelUnlockUtils.all_levels_completed(statistics_db, player_stats_id)
...
function LevelUnlockUtils.get_act_key_by_level(level_key)
...
function LevelUnlockUtils.act_unlocked(statistics_db, player_stats_id, act_key)
...
function LevelUnlockUtils.act_completed(statistics_db, player_stats_id, act_key)
	assert(GameActs [act_key] ~= nil, "Act %s does not exist.", act_key)
...
function LevelUnlockUtils.num_acts_completed(statistics_db, player_stats_id)
	local num = 0
...
function LevelUnlockUtils.all_dlc_levels_completed(statistics_db, player_stats_id, dlc_name)
...
function LevelUnlockUtils.get_next_adventure_level(statistics_db, player_stats_id)
...
function LevelUnlockUtils.debug_set_completed_game_difficulty(difficulty)
...
function LevelUnlockUtils.debug_set_completed_journey_difficulty(journey_name, difficulty_id)
	local statistics_db = Managers.player:statistics_db()
	local player = Managers.player:local_player()
	local stats_id = player:stats_id()
...
function LevelUnlockUtils.debug_set_completed_hero_journey_difficulty(hero, journey_name, difficulty_id)
	local statistics_db = Managers.player:statistics_db()
	local player = Managers.player:local_player()
	local stats_id = player:stats_id()
...
function LevelUnlockUtils.debug_unlock_act(act_index)
	local player_manager = Managers.player
	local statistics_db = player_manager:statistics_db()
...
function LevelUnlockUtils.debug_completed_act_levels(act_key, complete)
	local player_manager = Managers.player
	local statistics_db = player_manager:statistics_db()
	local player = player_manager:local_player()
	local stats_id = player:stats_id()
...
function LevelUnlockUtils.debug_complete_level(level_key)
	local player_manager = Managers.player
	local statistics_db = player_manager:statistics_db()
	local player = player_manager:local_player()
	local stats_id = player:stats_id()
