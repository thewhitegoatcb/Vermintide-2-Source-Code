...
function BTDodgeBackAction:init(...)
...
function BTDodgeBackAction:enter(unit, blackboard, t)
...
function BTDodgeBackAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.start_finished = nil
...
function BTDodgeBackAction:run(unit, blackboard, t, dt)
...
function BTDodgeBackAction:anim_cb_combat_step_stop(unit, blackboard)
	local navigation_extension = blackboard.navigation_extension
