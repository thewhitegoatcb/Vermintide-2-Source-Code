...
function CameraStateFollowThirdPersonTunneling:init(camera_state_init_context)
	CameraState.init(self, camera_state_init_context, "follow_third_person_tunneling")
end

function CameraStateFollowThirdPersonTunneling:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollowThirdPersonTunneling:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollowThirdPersonTunneling:update_tunnel_camera_position(position)
...
function CameraStateFollowThirdPersonTunneling:update(unit, input, dt, context, t)
	local csm = self.csm
	local camera_extension = self.camera_extension
	local follow_unit = self._follow_unit
