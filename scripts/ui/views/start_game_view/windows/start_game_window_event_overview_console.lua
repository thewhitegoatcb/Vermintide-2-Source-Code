...
function StartGameWindowEventOverviewConsole:on_enter(params, offset)
...
function StartGameWindowEventOverviewConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowEventOverviewConsole:_create_ui_elements(params, offset)
...
function StartGameWindowEventOverviewConsole:_setup_content_from_backend()
...
function StartGameWindowEventOverviewConsole:on_exit(params)
...
function StartGameWindowEventOverviewConsole:set_focus(focused)
	self._is_focused = focused
end

function StartGameWindowEventOverviewConsole:update(dt, t)
...
function StartGameWindowEventOverviewConsole:post_update(dt, t)
	return end

function StartGameWindowEventOverviewConsole:_update_can_play()
...
function StartGameWindowEventOverviewConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowEventOverviewConsole:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowEventOverviewConsole:_handle_input(dt, t)
...
function StartGameWindowEventOverviewConsole:_play_sound(event)
	self._parent:play_sound(event)
end

function StartGameWindowEventOverviewConsole:_can_play()
	local parent = self._parent
...
function StartGameWindowEventOverviewConsole:_update_difficulty_option()
...
function StartGameWindowEventOverviewConsole:_option_selected(input_index, t)
...
function StartGameWindowEventOverviewConsole:_handle_new_selection(input_index)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowEventOverviewConsole:_update_animations(dt)
...
function StartGameWindowEventOverviewConsole:_draw(dt)
