NewsFeedTemplates = { { description = "news_feed_vt1_skins_description", name = "vt1_skins", duration = 5, cooldown = -1, infinite = false, title = "news_feed_vt1_skins_title",
	...
	{ hidden = true, name = "vt2_collectors_edition", cooldown = -1, infinite = false, duration = 0,
	...
	{ hidden = true, name = "celebrate_frame", cooldown = -1, infinite = false, duration = 0,
	...
	{ description = "news_feed_unclaimed_challenge_description", name = "unclaimed_challenge", duration = 5, cooldown = -1, infinite = false, title = "news_feed_unclaimed_challenge_title",
	...
	{ description = "news_feed_unclaimed_quest_description", name = "unclaimed_quest", duration = 5, cooldown = -1, infinite = false, title = "news_feed_unclaimed_quest_title",
	...
	{ description = "news_feed_equipment_description", name = "equipment", duration = 5, cooldown = -1, infinite = false, title = "news_feed_equipment_title",
	...
	{ description = "news_feed_store_description", name = "new_shop_items", duration = 5, cooldown = -1, infinite = false, title = "news_feed_store_title", icon = "hud_store_icon",
	...
	{ description = "news_feed_talent_description", name = "talent", duration = 5, cooldown = -1, infinite = false, title = "news_feed_talent_title",
	...
	{ description = "news_feed_career_description", name = "career", duration = 5, cooldown = -1, infinite = false, title = "news_feed_career_title",
	...
	{ description = "news_feed_cosmetics_description", name = "cosmetics", duration = 5, cooldown = -1, infinite = false, title = "news_feed_cosmetics_title",
	...
	{ description = "news_feed_loot_chest_description", name = "loot_chest", duration = 5, cooldown = -1, infinite = false, title = "news_feed_loot_chest_title",
	...
	{ hidden = true, name = "sign_in_rewards", cooldown = -1, infinite = false, duration = 0,
					...
					for reward_id, items in pairs(PlayerData.new_sign_in_rewards) do
						...
						for _, backend_id in ipairs(items) do
							if item_interface:get_item_from_id(backend_id) ~= nil then
								table.insert(rewards_presentation_data, { type = "item", backend_id = backend_id })
							end
						end
