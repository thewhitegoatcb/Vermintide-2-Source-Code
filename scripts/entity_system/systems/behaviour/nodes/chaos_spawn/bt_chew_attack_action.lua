...
function BTChewAttackAction:init(...)
	BTChewAttackAction.super.init(self, ...)
end

function BTChewAttackAction:enter(unit, blackboard, t)
...
function BTChewAttackAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChewAttackAction:run(unit, blackboard, t, dt)
...
function BTChewAttackAction:anim_cb_chew_attack(unit, blackboard)
