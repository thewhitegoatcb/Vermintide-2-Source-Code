...
local scenegraph_definition = {
	...
	event_texture = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { 480, 564 }, position = { 0, -60, 1 } },
	event_title = { vertical_alignment = "top", parent = "event_texture", horizontal_alignment = "center", size = { 300, 80 }, position = { 0, -40, 1 } },
	description_text = { vertical_alignment = "bottom", parent = "event_texture", horizontal_alignment = "center", size = { 300, 120 }, position = { 0, 10, 1 } } }


local event_title_text_style = { word_wrap = true, upper_case = true, localize = false, use_shadow = true, font_size = 52, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
...
local description_text_style = { word_wrap = true, font_size = 22, localize = false, use_shadow = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark",
