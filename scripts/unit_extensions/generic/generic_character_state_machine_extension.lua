...
function GenericCharacterStateMachineExtension:init(extension_init_context, unit, extension_init_data)
...
function GenericCharacterStateMachineExtension:extensions_ready()
...
function GenericCharacterStateMachineExtension:destroy()
	self.state_machine:exit_current_state()
end

function GenericCharacterStateMachineExtension:reset()
	self.state_machine:reset()
end

function GenericCharacterStateMachineExtension:update(unit, input, dt, context, t)
	self.state_machine:update(unit, input, dt, context, t)
end

function GenericCharacterStateMachineExtension:current_state()
