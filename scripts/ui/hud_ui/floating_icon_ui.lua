...
function FloatingIconUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function FloatingIconUI:create_ui_elements()
...
function FloatingIconUI:destroy()
...
function FloatingIconUI:show_progression_bar(unit, extension)
...
function FloatingIconUI:hide_progression_bar(unit)
...
function FloatingIconUI:update(dt)
	if DO_RELOAD then
		self:create_ui_elements()
	end
...
function FloatingIconUI:_draw_progressbar(dt)
...
function FloatingIconUI:_get_camera()
...
function FloatingIconUI:_get_player_rotation_and_position()
...
function FloatingIconUI:_set_widget_position(widget, x, y)
	local offset = widget.offset
	offset [1] = x
	offset [2] = y
end

function FloatingIconUI:_set_bar_progress(widget, progress, dt)
...
function FloatingIconUI:_draw(unit, progress, dt)
	local ui_renderer = self.ui_renderer
...
function FloatingIconUI:convert_world_to_screen_position(camera, world_position)
	if camera then
...
function FloatingIconUI:get_floating_icon_position(screen_pos_x, screen_pos_y, forward_dot, right_dot, tooltip_settings)
...
function FloatingIconUI:get_icon_size(position, player_position, current_size, original_size, tooltip_settings)
...
function FloatingIconUI:icon_scale_by_distance(current_distance, max_distance)
...
function FloatingIconUI:get_player_first_person_extension()
