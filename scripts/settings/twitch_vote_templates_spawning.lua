...
local function spawn_custom_horde(breed_name, difficulty_amounts)
	...
	num_enemies_range =
	num_enemies_range or difficulty_amounts.hardest
...
local function spawn_hidden(breed_name, difficulty_amounts)
	...
	num_enemies =
	num_enemies or difficulty_amounts.hardest
...
TwitchVoteTemplates.twitch_spawn_rat_ogre = { text = "twitch_vote_spawn_rat_ogre", breed_name = "skaven_rat_ogre", texture_id = "twitch_icon_all_the_rage", cost = 180,
	...
	on_success = function (is_server)
		if is_server then
			...
			for i = 1, spawn_amount do
				Managers.state.conflict:spawn_one(breed, nil, nil, { max_health_modifier = 0.85 })
			end
		end
	end }


TwitchVoteTemplates.twitch_spawn_stormfiend = { text = "twitch_vote_spawn_stormfiend", breed_name = "skaven_stormfiend", texture_id = "twitch_icon_fire_and_fury", cost = 180,
...
TwitchVoteTemplates.twitch_spawn_chaos_troll = { text = "twitch_vote_spawn_chaos_troll", breed_name = "chaos_troll", texture_id = "twitch_icon_bad_indigestion", cost = 180,
...
TwitchVoteTemplates.twitch_spawn_chaos_spawn = { text = "twitch_vote_spawn_chaos_spawn", breed_name = "chaos_spawn", texture_id = "twitch_icon_writhing_horror", cost = 180,
...
TwitchVoteTemplates.twitch_spawn_minotaur = { text = "twitch_vote_spawn_minotaur", breed_name = "beastmen_minotaur", texture_id = "twitch_icon_the_bloodkine_wakes", cost = 180,
...
TwitchVoteTemplates.twitch_spawn_corruptor_sorcerer = { text = "twitch_vote_spawn_corruptor_sorcerer", breed_name = "chaos_corruptor_sorcerer", texture_id = "twitch_icon_soul_drinkers", cost = 150,
	...
	on_success = function (is_server)
		if is_server then
			...
			local amount_per_difficulty = { harder = 3, hard = 2, hardest = 3, normal = 2 }
...
TwitchVoteTemplates.twitch_spawn_vortex_sorcerer = { text = "twitch_vote_spawn_vortex_sorcerer", breed_name = "chaos_vortex_sorcerer", texture_id = "twitch_icon_all_aboard_the_wild_ride", cost = 100,
	...
	on_success = function (is_server)
		if is_server then
			...
			local amount_per_difficulty = { harder = 4, hard = 3, hardest = 4, normal = 3 }
...
TwitchVoteTemplates.twitch_spawn_gutter_runner = { text = "twitch_vote_spawn_gutter_runner", breed_name = "skaven_gutter_runner", texture_id = "twitch_icon_sneaking_stabbing", cost = 150,
	...
	on_success = function (is_server)
		if is_server then
			...
			local amount_per_difficulty = { harder = 3, hard = 2, hardest = 4, normal = 2 }
...
TwitchVoteTemplates.twitch_spawn_pack_master = { text = "twitch_vote_spawn_pack_master", breed_name = "skaven_pack_master", texture_id = "twitch_icon_cruel_hooks", cost = 150,
	...
	on_success = function (is_server)
		if is_server then
			...
			local amount_per_difficulty = { harder = 3, hard = 3, hardest = 4, normal = 3 }
...
TwitchVoteTemplates.twitch_spawn_poison_wind_globadier = { text = "twitch_vote_spawn_poison_wind_globadier", breed_name = "skaven_poison_wind_globadier", texture_id = "twitch_icon_hold_your_breath", cost = 100,
...
TwitchVoteTemplates.twitch_spawn_ratling_gunner = { text = "twitch_vote_spawn_ratling_gunner", breed_name = "skaven_ratling_gunner", texture_id = "twitch_icon_gunline", cost = 100,
...
TwitchVoteTemplates.twitch_spawn_warpfire_thrower = { text = "twitch_vote_spawn_warpfire_thrower", breed_name = "skaven_warpfire_thrower", texture_id = "twitch_icon_kill_it_with_fire", cost = 100,
	...
	on_success = function (is_server)
		if is_server then
			...
			local amount_per_difficulty = { harder = 4, hard = 4, hardest = 5, normal = 4 }
...
TwitchVoteTemplates.twitch_spawn_horde_vector_blob = { text = "twitch_vote_spawn_horde", cost = 100, texture_id = "twitch_icon_release_the_slaves",
	...
	on_success = function (is_server)
		if is_server then
			...
			local possible_breeds = { "skaven_slave", "chaos_fanatic" }
...
TwitchVoteTemplates.twitch_spawn_explosive_loot_rats = { text = "display_name_explosive_loot_rats", cost = 100, texture_id = "twitch_icon_explosive_loot_rats",
...
TwitchVoteTemplates.twitch_spawn_plague_monks = { text = "twitch_vote_spawn_plague_monks", cost = 100, texture_id = "twitch_icon_plague_monk",
...
TwitchVoteTemplates.twitch_spawn_berzerkers = { text = "twitch_vote_spawn_berzerkers", cost = 100, texture_id = "twitch_icon_berzerker",
...
TwitchVoteTemplates.twitch_spawn_death_squad_storm_vermin = { text = "twitch_vote_spawn_death_squad_storm_vermin", cost = 250, texture_id = "twitch_icon_blackfurs_on_parade", boss_equivalent = true,
...
TwitchVoteTemplates.twitch_spawn_death_squad_chaos_warrior = { text = "twitch_vote_spawn_death_squad_chaos_warrior", cost = 250, texture_id = "twitch_icon_eavymetal", boss_equivalent = true,
...
TwitchVoteTemplates.twitch_spawn_loot_rat_fiesta = { text = "twitch_vote_spawn_loot_rat_fiesta", cost = 0, texture_id = "twitch_icon_treasure_hunt",
