...
template.position_offset = { 0.25, 0.25, 0.9 }
template.screen_clamp = true
template.screen_clamp_method = "tutorial"
template.distance_from_center = { width = 400, height = 200 }




template.scale_settings = { end_scale_distance = 100, start_scale_distance = 10, min_scale = 0.5 }
	...
	return {
		...
		element = {
			passes = { { pass_type = "texture", style_id = "icon", texture_id = "icon" },
				...
				{ pass_type = "texture", style_id = "star", texture_id = "star",
		...
		content = { arrow = "indicator", icon = "hud_store_icon", star = "list_item_tag_new", show_star = true },
		...
		style = {
			icon = { vertical_alignment = "center", horizontal_alignment = "center",
				...
				texture_size = { 0, 0 },
				offset = { 0, 0, 0 },
				default_size = { size_scale * 64, size_scale * 64 },
				color = { 255, 255, 255, 255 } },

			star = { vertical_alignment = "center", horizontal_alignment = "center",
...
function template.update_function(ui_renderer, widget, marker, settings, dt, t)
	...
	local angle, ox, oy, oz = get_arrow_angle_and_offset(
	content.forward_dot_flat,
	content.right_dot_flat,
	arrow_style.texture_size,
	icon_style.texture_size,
	widget.offset [2] - 540)
