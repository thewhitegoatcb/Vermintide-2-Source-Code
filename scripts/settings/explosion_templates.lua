...
ExplosionTemplates = {
	...
	machinegun_poison_arrow = {
		explosion = { use_attacker_power_level = true, radius = 1, no_prop_damage = true, sound_event_name = "arrow_hit_poison_cloud", damage_profile = "poison_aoe", effect_name = "fx/wpnfx_poison_arrow_impact_machinegun" } },
	...
	carbine_poison_arrow = {
		explosion = { use_attacker_power_level = true, radius = 2, no_prop_damage = true, sound_event_name = "arrow_hit_poison_cloud", damage_profile = "poison_aoe", effect_name = "fx/wpnfx_poison_arrow_impact_carbine" } },
	...
	fireball = {
		explosion = { use_attacker_power_level = true, radius_min = 0.5, radius_max = 1, attacker_power_level_offset = 0.25, max_damage_radius_min = 0.1, damage_profile_glance = "fireball_explosion_glance", max_damage_radius_max = 0.75, sound_event_name = "drakepistol_hit", damage_profile = "fireball_explosion", effect_name = "fx/wpnfx_drake_pistols_projectile_impact" } },
	...
	fireball_charged = {
		explosion = { use_attacker_power_level = true, radius_min = 1.25, sound_event_name = "fireball_big_hit", radius_max = 3, attacker_power_level_offset = 0.25, max_damage_radius_min = 0.5, alert_enemies_radius = 10, damage_profile_glance = "fireball_charged_explosion_glance", max_damage_radius_max = 2, alert_enemies = true, damage_profile = "fireball_charged_explosion", effect_name = "fx/wpnfx_fireball_charged_impact_remap" } },
	...
	flaming_flail_impact_heavy = {
		explosion = { use_attacker_power_level = true, radius_min = 1.5, sound_event_name = "fireball_big_hit", radius_max = 3, exponential_falloff = true, attacker_power_level_offset = 0.1, max_damage_radius_min = 0.2, alert_enemies_radius = 10, no_friendly_fire = true, damage_profile_glance = "flaming_flail_explosion_glance", max_damage_radius_max = 0.25, alert_enemies = false, damage_profile = "flaming_flail_explosion", effect_name = "fx/wpnfx_flaming_flail_hit_01_remap" } },
	...
	sienna_unchained_burning_enemies_explosion = {
		explosion = { use_attacker_power_level = true, max_damage_radius_min = 0.5, effect_name = "fx/wpnfx_fireball_charged_impact", radius_max = 1.5, sound_event_name = "fireball_big_hit", attacker_power_level_offset = 0.01, radius_min = 0.5, alert_enemies_radius = 10, max_damage_radius_max = 2, alert_enemies = true, damage_profile = "slayer_leap_landing", no_friendly_fire = true } },
	...
	grenade = { is_grenade = true,
		...
		explosion = { dont_rotate_fx = true, radius = 5, max_damage_radius = 2, alert_enemies_radius = 20, sound_event_name = "player_combat_weapon_grenade_explosion", attack_template = "grenade", damage_profile_glance = "frag_grenade_glance", alert_enemies = true, damage_profile = "frag_grenade", effect_name = "fx/wpnfx_frag_grenade_impact",



			difficulty_power_level = {
				easy = { power_level_glance = 100, power_level = 200 },
				normal = { power_level_glance = 200, power_level = 400 },
				hard = { power_level_glance = 300, power_level = 600 },
				harder = { power_level_glance = 400, power_level = 800 },
				hardest = { power_level_glance = 500, power_level = 1000 },
				cataclysm = { power_level_glance = 550, power_level = 1100 },
				cataclysm_2 = { power_level_glance = 575, power_level = 1150 },
				cataclysm_3 = { power_level_glance = 600, power_level = 1200 } },
	...
	lamp_oil = {
		explosion = { radius = 3, dot_template_name = "burning_dot_3tick", max_damage_radius = 1.5, alert_enemies_radius = 15, sound_event_name = "fireball_big_hit", always_hurt_players = true, attack_template = "fire_grenade_explosion", alert_enemies = true, damage_profile = "explosive_barrel", effect_name = "fx/wpnfx_fire_grenade_impact",
			...
			difficulty_power_level = {
				...
				cataclysm = { power_level_glance = 275, power_level = 550 },
				cataclysm_2 = { power_level_glance = 300, power_level = 600 },
				cataclysm_3 = { power_level_glance = 325, power_level = 650 } } },
		...
		aoe = { dot_template_name = "burning_dot_1tick", radius = 6, nav_tag_volume_layer = "fire_grenade", create_nav_tag_volume = true, attack_template = "fire_grenade_dot", sound_event_name = "player_combat_weapon_fire_grenade_explosion", damage_interval = 1, duration = 5, area_damage_template = "explosion_template_aoe",
	...
	huge_boss_explosion = {
		explosion = { radius = 25, only_line_of_sight = true, max_damage_radius = 2.5, collision_filter = "filter_explosion_overlap", sound_event_name = "Play_enemy_combat_warpfire_backpack_explode", damage_profile = "huge_boss_explosion", ignore_attacker_unit = true, effect_name = "fx/warpfire_explosion_huge_01",


			difficulty_power_level = {
				easy = { power_level_glance = 1000, power_level = 1000 },
				normal = { power_level_glance = 1000, power_level = 1000 },
				hard = { power_level_glance = 1000, power_level = 1000 },
				harder = { power_level_glance = 1000, power_level = 1000 },
				hardest = { power_level_glance = 1000, power_level = 1000 },
				cataclysm = { power_level_glance = 1000, power_level = 1000 },
				cataclysm_2 = { power_level_glance = 1000, power_level = 1000 },
				cataclysm_3 = { power_level_glance = 1000, power_level = 1000 } } } },
...
ExplosionTemplates.fire_grenade = { is_grenade = true,

	explosion = { dont_rotate_fx = true, radius = 2, max_damage_radius = 1, alert_enemies_radius = 15, sound_event_name = "fireball_big_hit", dot_template_name = "burning_dot_1tick", alert_enemies = true, damage_profile = "explosive_barrel", effect_name = "fx/wpnfx_fire_grenade_impact",



		difficulty_power_level = {
			easy = { power_level_glance = 50, power_level = 59 },
			normal = { power_level_glance = 50, power_level = 50 },
			hard = { power_level_glance = 75, power_level = 50 },
			harder = { power_level_glance = 100, power_level = 100 },
			hardest = { power_level_glance = 150, power_level = 200 },
			cataclysm = { power_level_glance = 150, power_level = 300 },
			cataclysm_2 = { power_level_glance = 200, power_level = 400 },
			cataclysm_3 = { power_level_glance = 250, power_level = 500 } } },
	...
	aoe = { dot_template_name = "burning_dot_fire_grenade", radius = 6, nav_tag_volume_layer = "fire_grenade", create_nav_tag_volume = true, attack_template = "fire_grenade_dot", sound_event_name = "player_combat_weapon_fire_grenade_explosion", damage_interval = 1, duration = 5, area_damage_template = "explosion_template_aoe",
...
ExplosionTemplates.frag_fire_grenade = { is_grenade = true,
...
ExplosionTemplates.conflag = {
	aoe = { dot_template_name = "burning_dot_1tick", radius = 4, nav_tag_volume_layer = "fire_grenade", dot_balefire_variant = true, create_nav_tag_volume = true, attack_template = "wizard_staff_geiser", damage_interval = 1, duration = 2, area_damage_template = "explosion_template_aoe",
		...
		nav_mesh_effect = { particle_radius = 2, particle_name = "fx/wpnfx_fire_grenade_impact_remains_remap", particle_spacing = 0.9 } } }
...
ExplosionTemplates.cannon_ball_throw = {
	explosion = { always_hurt_players = false, radius = 10, no_prop_damage = true, max_damage_radius = 5, effect_name = "fx/wpnfx_frag_grenade_impact", attack_template = "drakegun", sound_event_name = "player_combat_weapon_grenade_explosion", damage_profile = "cannonball_impact", power_level = 300, ignore_attacker_unit = true, level_unit_damage = true,
		...
		on_death_func = function (hit_unit)
			local stat_names = { "forest_fort_kill_cannonball", "forest_fort_kill_cannonball_cata" }
...
ExplosionTemplates.victor_captain_activated_ability_stagger_ping_debuff_improved = {
	explosion = { no_prop_damage = true, radius = 10, use_attacker_power_level = true, max_damage_radius = 2, always_hurt_players = false, alert_enemies_radius = 15, attack_template = "drakegun", alert_enemies = true, damage_profile = "ability_push", ignore_attacker_unit = true, no_friendly_fire = true,
		...
		enemy_debuff = { "defence_debuff_enemies", "victor_witchhunter_improved_damage_taken_ping" } } }
...
ExplosionTemplates.chaos_zombie_explosion = {
	explosion = { always_hurt_players = true, radius = 3.2, alert_enemies_radius = 20, alert_enemies = true, dot_template_name = "chaos_zombie_explosion", max_damage_radius_min = 0.5, attack_template = "chaos_zombie_explosion", max_damage_radius_max = 2, sound_event_name = "Play_enemy_chaos_warrior_transform_explode", damage_interval = 0, power_level = 500, effect_name = "fx/chr_nurgle_explosion_01",
		...
		immune_breeds = { chaos_zombie = true, chaos_exalted_sorcerer = true } } }
...
ExplosionTemplates.chaos_magic_missile = {
	explosion = { always_hurt_players = true, radius = 3.2, alert_enemies = false, max_damage_radius_min = 0.5, attack_template = "chaos_magic_missile", max_damage_radius_max = 1, sound_event_name = "fireball_big_hit", damage_interval = 0, power_level = 500, effect_name = "fx/wpnfx_fireball_charged_impact",
		...
		immune_breeds = { chaos_zombie = true, skaven_grey_seer = true, skaven_stormfiend = true } } }
...
ExplosionTemplates.chaos_strike_missile_impact = {
	explosion = { radius = 2, alert_enemies = false, always_hurt_players = true, max_damage_radius_min = 0.5, attack_template = "chaos_magic_missile", max_damage_radius_max = 1, sound_event_name = "fireball_big_hit", damage_interval = 0, effect_name = "fx/chr_chaos_sorcerer_boss_strike_missile_impact",
		...
		difficulty_power_level = {
			easy = { power_level_glance = 5, power_level = 10 },
			normal = { power_level_glance = 10, power_level = 20 },
			hard = { power_level_glance = 20, power_level = 30 },
			harder = { power_level_glance = 30, power_level = 40 },
			hardest = { power_level_glance = 40, power_level = 50 },
			cataclysm = { power_level_glance = 40, power_level = 50 } },
		...
		immune_breeds = { chaos_zombie = true, chaos_exalted_sorcerer = true, skaven_grey_seer = true, skaven_stormfiend = true } } }
...
ExplosionTemplates.chaos_slow_bomb_missile_missed = {
	explosion = { always_hurt_players = true, radius = 3.2, alert_enemies = false, max_damage_radius_min = 0.5, attack_template = "chaos_magic_missile", max_damage_radius_max = 1, sound_event_name = "Play_enemy_boss_sorcerer_slow_bomb_hit", damage_interval = 0, power_level = 500, effect_name = "fx/chr_chaos_sorcerer_boss_projectile_flies_impact",
		...
		immune_breeds = { chaos_zombie = true, chaos_spawn = true, skaven_grey_seer = true } } }
...
ExplosionTemplates.grey_seer_warp_lightning_impact = {
	explosion = { always_hurt_players = true, radius = 3.2, alert_enemies = false, max_damage_radius_min = 0.5, attack_template = "chaos_magic_missile", max_damage_radius_max = 1, sound_event_name = "fireball_big_hit", damage_interval = 0, power_level = 500, effect_name = "fx/warp_lightning_bolt_impact",
		...
		immune_breeds = { skaven_stormfiend_boss = true, chaos_zombie = true, skaven_grey_seer = true } } }
...
ExplosionTemplates.death_spirit_bomb = {
	explosion = { trigger_on_server_only = true, radius = 1, wind_mutator = true, power_level = 0, effect_name = "fx/magic_wind_death_spirit_explosion_01" } }
...
ExplosionTemplates.bastion_light_spirit = {
	explosion = { trigger_on_server_only = true, radius = 1, wind_mutator = true, power_level = 0, effect_name = "fx/bastion_light_spirit_impact" } }
...
ExplosionTemplates.metal_mutator_blade_dance = {
	explosion = { wind_mutator = true, radius = 4, no_friendly_fire = true, hit_sound_event = "Play_wind_metal_gameplay_mutator_wind_hit", damage_profile = "blade_storm", ignore_buffs = true } }
...
ExplosionTemplates.suicide_blast = {
	explosion = { radius = 4, dot_template_name = "burning_3W_dot", max_damage_radius = 4, alert_enemies_radius = 15, sound_event_name = "fireball_big_hit", always_hurt_players = true, attack_template = "fire_grenade_explosion", alert_enemies = true, damage_profile = "explosive_barrel", effect_name = "fx/wpnfx_fire_grenade_impact",
		...
		difficulty_power_level = {
			...
			harder = { power_level_glance = 200, power_level = 400 },
			hardest = { power_level_glance = 250, power_level = 500 },
			survival_hard = { power_level_glance = 150, power_level = 300 },
			survival_harder = { power_level_glance = 200, power_level = 400 },
			survival_hardest = { power_level_glance = 250, power_level = 500 } } },
	...
	aoe = { dot_template_name = "burning_dot_1tick", radius = 4, nav_tag_volume_layer = "bot_poison_wind", create_nav_tag_volume = true, attack_template = "fire_grenade_dot", sound_event_name = "player_combat_weapon_fire_grenade_explosion", damage_interval = 1, duration = 3, area_damage_template = "explosion_template_aoe",
...
ExplosionTemplates.gutter_runner_foff = {
	explosion = { duration = 1, radius = 3, attack_template = "drakegun", max_damage_radius = 2, damage_profile = "ability_push", power_level = 200, effect_name = "fx/chr_gutter_foff" } }
...
ExplosionTemplates.shadow_flare = {
	spawn_unit = { glow_time = 15, unit_name = "shadow_flare_light", unit_path = "units/weapons/player/wpn_shadow_gargoyle_head/wpn_shadow_gargoyle_head" } }
