...
function ActionCareerDREngineerSpin:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerDREngineerSpin:client_owner_start_action(new_action, t)
...
function ActionCareerDREngineerSpin:finish(reason)
...
function ActionCareerDREngineerSpin:start_audio_loop()
...
function ActionCareerDREngineerSpin:_update_animation_speed(windup)
