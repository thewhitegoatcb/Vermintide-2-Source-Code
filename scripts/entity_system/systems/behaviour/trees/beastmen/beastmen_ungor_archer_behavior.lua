...
local UNGOR_ARCHER_RANGED_COMBAT = { "BTUtilityNode",
	{ "BTFindRangedPositionAction", name = "find_ranged_position",
		action_data = ACTIONS.find_ranged_position }, { "BTMoveToRangedPositionAction", name = "move_to_ranged_position",
		action_data = ACTIONS.move_to_ranged_position }, { "BTFireProjectileAction", name = "fire_projectile", weight = 2,
		action_data = ACTIONS.fire_projectile }, condition = "confirmed_player_sighting", name = "in_combat" }


local UNGOR_ARCHER_MELEE_COMBAT = { "BTUtilityNode",
	{ "BTClanRatFollowAction", name = "follow",
		...
		action_data = ACTIONS.combat_shout }, condition = "ungor_archer_enter_melee_combat", name = "in_combat" }



local UNGOR_ARCHER_SMART_OBJECT = { "BTSelector",
...
BreedBehaviors.ungor_archer = { "BTSelector",
	...
	{ "BTStaggerAction", name = "stagger", condition = "stagger",
		...
		action_data = ACTIONS.blocked }, { "BTSwitchWeaponsAction", name = "switch_weapons", condition = "switch_to_melee_weapon",
		action_data = ACTIONS.switch_weapons },
	UNGOR_ARCHER_SMART_OBJECT,
	UNGOR_ARCHER_MELEE_COMBAT,
	UNGOR_ARCHER_RANGED_COMBAT, { "BTMoveToGoalAction", name = "move_to_goal", condition = "has_goal_destination",
	...
	{ "BTFallbackIdleAction", name = "fallback_idle" }, name = "ungor_archer" }