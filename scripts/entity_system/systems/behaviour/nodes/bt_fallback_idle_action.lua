...
function BTFallbackIdleAction:init(...)
	BTFallbackIdleAction.super.init(self, ...)
end

BTFallbackIdleAction.name = "BTFallbackIdleAction"

function BTFallbackIdleAction:enter(unit, blackboard, t)
...
function BTFallbackIdleAction:leave(unit, blackboard, t, reason, destroy)
	return end

local Unit_alive = Unit.alive
function BTFallbackIdleAction:run(unit, blackboard, t, dt)
