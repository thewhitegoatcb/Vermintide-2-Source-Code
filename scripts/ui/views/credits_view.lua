...
local font_sizes = { legal = 15, normal = 30 }
...
function CreditsView:init(ingame_ui_context)
...
function CreditsView:_create_ui_elements()
...
function CreditsView:input_service()
...
function CreditsView:exit(return_to_game)
