...
local experience_levels = { 0, 200, 400, 600, 650, 700, 750, 800, 850, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000, 3100, 3200, 3300, 3400 }
...
function ExperienceSettings.get_player_level(player)
...
function ExperienceSettings.get_account_level()
...
function ExperienceSettings.get_experience(hero_name)
	local hero_attributes = Managers.backend:get_interface("hero_attributes")
	return hero_attributes:get(hero_name, "experience") or 0
end

function ExperienceSettings.get_experience_pool(hero_name)
	local hero_attributes = Managers.backend:get_interface("hero_attributes")
	return hero_attributes:get(hero_name, "experience_pool") or 0
end

function ExperienceSettings.get_level(experience)
...
function ExperienceSettings.get_extra_level(experience_pool)
...
function ExperienceSettings.get_total_experience_required_for_level(level)
	local experience = 0
...
function ExperienceSettings.get_experience_required_for_level(level)
...
ExperienceSettings.level_length_experience_multiplier = { short = 1, long = 1 }