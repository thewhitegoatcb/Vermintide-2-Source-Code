...
function DebugGlobadier.update(unit, blackboard, t)
...
local row_height = 17
function DebugGlobadier.debug_hud_print(caption, value, index, valid)
	local gui = Debug.gui
...
function DebugGlobadier.debug_hud_background(max_index)
	local gui = Debug.gui
	local width = 300
