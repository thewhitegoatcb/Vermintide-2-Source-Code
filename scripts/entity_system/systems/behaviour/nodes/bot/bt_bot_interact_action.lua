...
function BTBotInteractAction:init(...)
...
function BTBotInteractAction:enter(unit, blackboard, t)
	...
	blackboard.interact = { tried = false,
...
function BTBotInteractAction:leave(unit, blackboard, t, reason, destroy)
...
function BTBotInteractAction:run(unit, blackboard, t, dt)
