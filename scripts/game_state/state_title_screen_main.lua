...
function StateTitleScreenMain:on_enter(params)
	...
	if IS_PS4 and
	self.parent.invite_handled then
...
function StateTitleScreenMain:_queue_popup(...)
	self._error_popups [#self._error_popups + 1] = Managers.popup:queue_popup(...)
end

function StateTitleScreenMain:_setup_account_manager()
	Managers.account = Managers.account or AccountManager:new()
end

function StateTitleScreenMain:update(dt, t)
...
function StateTitleScreenMain:_update_network(dt, t)
...
function StateTitleScreenMain:_update_attract_mode(dt, t)
...
function StateTitleScreenMain:_enter_attract_mode()
...
function StateTitleScreenMain:_exit_attract_mode()
	Managers.music:stop_all_sounds()
...
function StateTitleScreenMain:_handle_continue_input(dt, t)
...
function StateTitleScreenMain:_user_exists(user_id)
...
function StateTitleScreenMain:_update_input(dt, t)
...
function StateTitleScreenMain:_next_state()
	if self._state then
		return self._state
	end
end

function StateTitleScreenMain:on_exit()
