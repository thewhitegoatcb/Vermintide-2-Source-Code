local blade_dance_enemies = { skaven_ratling_gunner = true, skaven_stormfiend = true, skaven_storm_vermin_with_shield = true, chaos_warrior = true, beastmen_bestigor = true, skaven_warpfire_thrower = true, beastmen_standard_bearer = true, skaven_storm_vermin_commander = true, skaven_storm_vermin = true, skaven_storm_vermin_champion = true }
...
return { display_name = "weaves_metal_mutator_name", description = "weaves_metal_mutator_desc", icon = "icon_wind_chamon", primary_armor_category = 6,





	modify_primary_armor_category_breeds = { "skaven_storm_vermin", "skaven_storm_vermin_champion", "skaven_storm_vermin_commander", "skaven_storm_vermin_with_shield", "skaven_stormfiend", "skaven_ratling_gunner", "skaven_warpfire_thrower", "chaos_warrior", "beastmen_bestigor", "beastmen_standard_bearer" },
