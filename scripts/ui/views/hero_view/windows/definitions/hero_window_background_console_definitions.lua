...
local scenegraph_definition = {
	...
	loading_overlay = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, UILayer.default + 100 } },
	loading_detail = { vertical_alignment = "center", parent = "loading_overlay", horizontal_alignment = "center", size = { 314, 33 }, position = { 0, 0, 1 } },

	detailed_button = { vertical_alignment = "top", parent = "screen", horizontal_alignment = "right", size = { 50, 50 }, position = { 0, -100, 1 } },
	detailed_list = { vertical_alignment = "top", parent = "detailed_button", horizontal_alignment = "right", size = { window_size [1] - 100, window_size [2] }, position = { 0, -40, 1 } } }
...
local function create_detailed_stat_widget(scenegraph_id, size, list_scenegraph_id, list_size)
	...
	local element = {
		passes = { { style_id = "hotspot", pass_type = "hotspot", content_id = "button_hotspot" },
			...
			{ style_id = "list_background", pass_type = "hotspot", content_id = "list_hotspot" },
			...
			{ style_id = "list_style", pass_type = "list_pass", content_id = "list_content",
				...
				passes = { { style_id = "title", pass_type = "text", text_id = "title" },
	...
	for i = 1, num_entries do
		list_content [i] = { title_divider = "game_option_divider", name = "", value = "", title = "",
			button_hotspot = { } }
	end
...
local loading_overlay_widgets = {
	loading_overlay = UIWidgets.create_simple_rect("loading_overlay", { 255, 12, 12, 12 }),
...
local camera_position_by_character = {
	witch_hunter = { z = 0.6, x = 0.6, y = -1.3 },




	bright_wizard = { z = 0.4, x = 0.6, y = -1.3 },




	dwarf_ranger = { z = 0, x = 0.6, y = -1.2 },




	wood_elf = { z = 0.35, x = 0.6, y = -1.3 },




	empire_soldier = { z = 0.5, x = 0.6, y = -1.3 },




	empire_soldier_tutorial = { z = 0.5, x = 0.6, y = -1.3 },
...
local background_rect = UIWidgets.create_simple_texture("gradient_dice_game_reward", "screen", nil, nil, { 80, 255, 255, 255 })
