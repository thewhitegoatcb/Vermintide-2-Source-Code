QuestSettings = {
	...
	rules = {
		daily = { num_criterias = 3, max_quests = 3 },



		weekly = { num_criterias = 3, max_quests = 7 },



		event = { num_criterias = 12, max_quests = 10 } },
	...
	scrap_count_level = { 3, 30 },



	scrap_count_generic = { 150, 260, 370, 540 },
	...
	weekly_complete_quickplay_missions = { 10, 10, 10 },




	weekly_complete_weekly_event_missions = { 1, 1, 1 },




	weekly_collect_tomes = { 15, 15, 15 },




	weekly_collect_grimoires = { 8, 8, 8 },




	weekly_collect_dice = { 15, 15, 15 },




	weekly_collect_painting_scrap = { 10, 10, 10 },




	weekly_kill_bosses = { 6, 6, 6 },




	weekly_kill_elites = { 55, 55, 55 },




	weekly_complete_levels_hero_wood_elf = { 6, 6, 6 },




	weekly_complete_levels_hero_witch_hunter = { 6, 6, 6 },




	weekly_complete_levels_hero_dwarf_ranger = { 6, 6, 6 },




	weekly_complete_levels_hero_empire_soldier = { 6, 6, 6 },




	weekly_complete_levels_hero_bright_wizard = { 6, 6, 6 },




	weekly_kill_critters = { 15, 15, 15 },




	weekly_score_headshots = { 150, 150, 150 },




	weekly_daily_quests = { 3, 3, 3 },
	...
	allowed_difficulties = {
		elven_ruins_speed_event = { hardest = true },
		elven_ruins_speed_event_cata = { cataclysm = true },
		farmlands_speed_event = { hardest = true },
		farmlands_speed_event_cata = { cataclysm = true },
		bell_speed_event = { hardest = true },
		bell_speed_event_cata = { cataclysm = true },
		mines_speed_event = { hardest = true },
		mines_speed_event_cata = { cataclysm = true },
		skittergate_speed_event = { hardest = true },
		skittergate_speed_event_cata = { cataclysm = true },
		exalted_champion_charge_chaos_warrior = { hardest = true },
		exalted_champion_charge_chaos_warrior_cata = { cataclysm = true },
		halescourge_tornado_enemies = { hardest = true },
		halescourge_tornado_enemies_cata = { cataclysm = true },
		storm_vermin_warlord_kills_enemies = { hardest = true },
		storm_vermin_warlord_kills_enemies_cata = { cataclysm = true },
		forest_fort_kill_cannonball = { hardest = true },
		forest_fort_kill_cannonball_cata = { cataclysm = true },
		nurgle_bathed_all = { hardest = true },
		nurgle_bathed_all_cata = { cataclysm = true },
		volume_corpse_pit_damage = { hardest = true },
		volume_corpse_pit_damage_cata = { cataclysm = true },
		ussingen_used_no_barrels = { hardest = true },
		ussingen_used_no_barrels_cata = { cataclysm = true },
		military_statue_kill_chaos_warriors = { hardest = true },
		military_statue_kill_chaos_warriors_cata = { cataclysm = true } } }


local level_challenge_name_lookup = { catacombs_added_souls = "achv_catacombs_stay_inside_ritual_pool_name", elven_ruins_speed_event_cata = "achv_elven_ruins_align_leylines_timed_cata_name", elven_ruins_speed_event = "achv_elven_ruins_align_leylines_timed_name", forest_fort_kill_cannonball_cata = "achv_fort_kill_enemies_cannonball_cata_name", mines_speed_event_cata = "achv_mines_kill_final_troll_timed_cata_name", halescourge_tornado_enemies_cata = "achv_ground_zero_burblespew_tornado_enemies_cata_name", nurgle_bathed_all = "achv_nurgle_player_showered_in_pus_name", skittergate_speed_event = "achv_skittergate_deathrattler_rasknitt_timed_name", exalted_champion_charge_chaos_warrior_cata = "achv_warcamp_bodvarr_charge_warriors_cata_name", halescourge_tornado_enemies = "achv_ground_zero_burblespew_tornado_enemies_name", forest_fort_kill_cannonball = "achv_fort_kill_enemies_cannonball_name", storm_vermin_warlord_kills_enemies_cata = "achv_skaven_stronghold_skarrik_kill_skaven_cata_name", storm_vermin_warlord_kills_enemies = "achv_skaven_stronghold_skarrik_kill_skaven_name", ussingen_used_no_barrels_cata = "achv_ussingen_no_event_barrels_cata_name", skittergate_speed_event_cata = "achv_skittergate_deathrattler_rasknitt_timed_cata_name", mines_speed_event = "achv_mines_kill_final_troll_timed_name", military_statue_kill_chaos_warriors_cata = "achv_military_kill_chaos_warriors_in_event_cata_name", exalted_champion_charge_chaos_warrior = "achv_warcamp_bodvarr_charge_warriors_name", bell_speed_event = "achv_bell_destroy_bell_flee_timed_name", military_statue_kill_chaos_warriors = "achv_military_kill_chaos_warriors_in_event_name", farmlands_speed_event = "achv_farmlands_rescue_prisoners_timed_name", ussingen_used_no_barrels = "achv_ussingen_no_event_barrels_name", farmlands_speed_event_cata = "achv_farmlands_rescue_prisoners_timed_cata_name", nurgle_bathed_all_cata = "achv_nurgle_player_showered_in_pus_cata_name", catacombs_added_souls_cata = "achv_catacombs_stay_inside_ritual_pool_cata_name", bell_speed_event_cata = "achv_bell_destroy_bell_flee_timed_cata_name" }
...
function QuestSettings.send_completed_message(challenge_stat_id)
...
function QuestSettings.check_globadier_kill_before_throwing(blackboard, killer_unit)
...
function QuestSettings.check_globadier_kill_during_suicide(blackboard, unit, killer_unit)
	if unit ~= killer_unit and blackboard.action and
	blackboard.action.name and blackboard.action.name == "suicide_run" then
...
function QuestSettings.check_num_enemies_killed_by_poison(unit, extension_unit)
...
function QuestSettings.check_warpfire_kill_before_shooting(blackboard, killer_unit)
...
function QuestSettings.check_warpfire_kill_on_power_cell(death_hit_zone, killer_unit)
...
function QuestSettings.check_num_enemies_killed_by_warpfire(unit, attacker_unit)
...
function QuestSettings.check_pack_master_dodge(target_unit)
	local stat_name = "pack_master_dodged_attack"
	increment_stat(target_unit, stat_name)
end

function QuestSettings.check_pack_master_kill_abducting_ally(blackboard, killer_unit)
...
function QuestSettings.check_pack_master_rescue_hoisted_ally(unit)
	local stat_name = "pack_master_rescue_hoisted_ally"
	increment_stat(unit, stat_name)
end

function QuestSettings.check_gutter_killed_while_pouncing(blackboard, killer_unit, damage_source)
...
function QuestSettings.check_gutter_runner_push_on_pounce(blackboard, pushing_unit)
...
function QuestSettings.check_gutter_runner_push_on_target_pounced(blackboard, pushing_unit)
...
function QuestSettings.check_corruptor_killed_at_teleport_time(blackboard, teleport_at_t, t, killer_unit)
...
function QuestSettings.check_corruptor_dodge(target_unit)
	local stat_name = "corruptor_dodged_attack"
	increment_stat(target_unit, stat_name)
end

function QuestSettings.check_corruptor_killed_while_grabbing(blackboard, killer_unit)
...
function QuestSettings.check_vortex_sorcerer_killed_while_summoning(blackboard, killer_unit)
	local unit = blackboard.unit
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
...
function QuestSettings.check_vortex_sorcerer_killed_while_ally_in_vortex(blackboard, killer_unit)
...
function QuestSettings.check_vortex_sorcerer_killed_by_melee(killer_unit, damage_source)
	local master_list_item = rawget(ItemMasterList, damage_source)
...
function QuestSettings.check_ratling_gunner_killed_by_melee(killer_unit, damage_source)
	local master_list_item = rawget(ItemMasterList, damage_source)
...
function QuestSettings.check_ratling_gunner_killed_while_shooting(blackboard, killer_unit)
	local unit = blackboard.unit
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
...
function QuestSettings.check_ratling_gunner_blocked_shot(unit, attacking_unit)
...
function QuestSettings.check_chaos_spawn_killed_while_grabbing(blackboard, killer_unit)
	local unit = blackboard.unit
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
...
function QuestSettings.check_chaos_spawn_killed_without_having_grabbed(blackboard, killer_unit)
...
function QuestSettings.check_chaos_troll_killed_without_regen(blackboard, killer_unit)
...
function QuestSettings.check_chaos_troll_killed_without_bile_damage(blackboard, killer_unit)
...
function QuestSettings.check_rat_ogre_killed_mid_leap(blackboard, killer_unit)
	local unit = blackboard.unit
	local ai_extension = ScriptUnit.extension(unit, "ai_system")
...
function QuestSettings.check_rat_ogre_killed_without_dealing_damage(blackboard, killer_unit)
...
function QuestSettings.check_stormfiend_killed_without_burn_damage(blackboard, killer_unit)
...
function QuestSettings.check_stormfiend_killed_on_controller(death_hit_zone, killer_unit)
...
function QuestSettings.check_killed_lord_as_last_player_standing(killer_unit)
...
function QuestSettings.handle_bastard_block(target_unit, attacker_unit, blocked)
...
function QuestSettings.handle_bastard_block_on_death(attacker_breed, attacker_unit, killing_blow, statistics_db)
...
function QuestSettings.handle_charge_stagger(unit, blackboard, attacker_unit)
