...
function ActPresentationUI:init(ingame_ui_context)
...
function ActPresentationUI:create_ui_elements()
...
function ActPresentationUI:start(level_key, previous_completed_difficulty_index)
...
function ActPresentationUI:_set_presentation_info(act_key, level_key)
...
function ActPresentationUI:_setup_level(act_key, played_level_key, previous_difficulty_index_completed)
	local widgets_by_name = self._widgets_by_name
...
function ActPresentationUI:destroy()
	self._ui_animator = nil
end

function ActPresentationUI:_update_animations(dt)
...
function ActPresentationUI:draw(dt)
...
function ActPresentationUI:start_presentation_animation(animation_name, optional_params)
