...
local MANAGER_GROUP_ORDER = { "global", "venture", "state" }
Managers = Managers or { state = { }, venture = { } }
ManagersCreationOrder = ManagersCreationOrder or { global = { }, state = { }, venture = { } }
...
function Managers.venture:destroy()
	destroy_manager_group("venture")
end

function Managers:on_round_start(...)
	call_on_managers("on_round_start", false, ...)
end

function Managers:on_round_end(...)
	call_on_managers("on_round_end", true, ...)
end

function Managers:on_venture_start(...)
	call_on_managers("on_venture_start", false, ...)
end

function Managers:on_venture_end(...)
