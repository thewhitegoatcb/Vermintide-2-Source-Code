...
function TerrorEventUtils.set_seed(seed)
	terror_seed = seed
end
...
function TerrorEventUtils.get_grudge_marked_name(breed_name, magic_number)
...
function TerrorEventUtils.apply_breed_enhancements(unit, breed, optional_data)
...
function TerrorEventUtils.generate_enhanced_breed(num_enhancements, breed_name, enhancement_set)
...
function TerrorEventUtils.generate_enhanced_breed_from_set(enhancement_set)
...
function TerrorEventUtils.add_enhancements_to_spawn_data(optional_data, num_enhancements, breed_name, enhancement_set)
...
function TerrorEventUtils.add_enhancements_for_difficulty(optional_data, difficulty, breed_name, event, difficulty_tweak, enhancement_set)
	optional_data =
	optional_data or { }
