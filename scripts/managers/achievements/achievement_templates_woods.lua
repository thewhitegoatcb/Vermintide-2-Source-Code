...
achievements.woods_javelin_melee = { name = "achv_woods_javelin_melee_name", required_dlc_extra = "woods", desc = "achv_woods_javelin_melee_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_catch_a_dying_breath", required_dlc = "woods",
...
achievements.woods_javelin_combo = { name = "achv_woods_javelin_combo_name", required_dlc_extra = "woods", desc = "achv_woods_javelin_combo_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_dance_of_the_willow", required_dlc = "woods",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		elseif attack_type and attack_type == "projectile" and template_data.timed_kill and victim_breed and
		victim_breed.special then
...
achievements.woods_wall_kill_grind = { name = "achv_woods_wall_kill_grind_name", required_dlc_extra = "woods", desc = "achv_woods_wall_kill_grind_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_the_awakening_of_the_woods", required_dlc = "woods",
...
achievements.woods_lifted_kill = { required_dlc = "woods", name = "achv_woods_lifted_kill_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_lifted_kill_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_ancients_vengeful_embrace", always_run = true,
...
achievements.woods_triple_lift = { required_dlc = "woods", name = "achv_woods_triple_lift_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_triple_lift_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_away_with_the_faeries", always_run = true,
...
achievements.woods_heal_grind = { name = "achv_woods_heal_grind_name", required_dlc_extra = "woods", desc = "achv_woods_heal_grind_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_handmaiden_of_isha", required_dlc = "woods",
...
achievements.woods_bleed_grind = { name = "achv_woods_bleed_grind_name", required_dlc_extra = "woods", desc = "achv_woods_bleed_grind_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_well_earned_agony", required_dlc = "woods",
...
achievements.woods_chaos_pinata = { required_dlc = "woods", name = "achv_woods_chaos_pinata_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_chaos_pinata_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_together_we", always_run = true,
	...
	events = { "vortex_caught_unit", "register_damage", "register_kill" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.woods_ability_combo = { name = "achv_woods_ability_combo_name", required_dlc_extra = "woods", desc = "achv_woods_ability_combo_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_rippling_radiance", required_dlc = "woods",
...
achievements.woods_wall_tank = { name = "achv_woods_wall_tank_name", required_dlc_extra = "woods", desc = "achv_woods_wall_tank_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_roots_of_ages", required_dlc = "woods",
	...
	events = { "register_thorn_wall_damage" },
	progress = function (statistics_db, stats_id, template_data)
...
achievements.woods_wall_block_ratling = { name = "achv_woods_wall_block_ratling_name", required_dlc_extra = "woods", desc = "achv_woods_wall_block_ratling_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_sheltering_thicket", required_dlc = "woods",
...
achievements.woods_bleed_boss = { name = "achv_woods_bleed_boss_name", required_dlc_extra = "woods", desc = "achv_woods_bleed_boss_desc", display_completion_ui = true, icon = "achievement_trophy_thornsister_an_offering_of_pain", required_dlc = "woods",
	...
	events = { "register_damage", "register_kill" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.woods_wall_kill_gutter = { required_dlc = "woods", name = "achv_woods_wall_kill_gutter_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_wall_kill_gutter_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_shall_not_pass", always_run = true,
...
achievements.woods_wall_dual_save = { required_dlc = "woods", name = "achv_woods_wall_dual_save_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_wall_dual_save_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_thorny_rescue", always_run = true,
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		elseif target_breed.name == "chaos_corruptor_sorcerer" and
		bb.grabbed_unit then
			hit_disabling_special = true
		end
...
achievements.woods_free_ability_grind = { required_dlc = "woods", name = "achv_woods_free_ability_grind_name", required_dlc_extra = "woods", display_completion_ui = true, desc = "achv_woods_free_ability_grind_desc", required_career = "we_thornsister", icon = "achievement_trophy_thornsister_weaves_bounty", always_run = true,
...
local all_challenges = { "woods_complete_all_helmgart_levels_recruit_we_thornsister", "woods_complete_all_helmgart_levels_veteran_we_thornsister", "woods_complete_all_helmgart_levels_champion_we_thornsister", "woods_complete_all_helmgart_levels_legend_we_thornsister", "woods_complete_25_missions_we_thornsister", "woods_javelin_melee", "woods_lifted_kill", "woods_javelin_combo", "woods_triple_lift", "woods_heal_grind", "woods_wall_kill_grind", "woods_bleed_grind", "woods_chaos_pinata", "woods_bleed_boss", "woods_wall_kill_gutter", "woods_wall_dual_save", "woods_ability_combo", "woods_wall_tank", "woods_wall_block_ratling", "woods_free_ability_grind" }
