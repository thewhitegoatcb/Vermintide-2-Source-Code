...
function ActionCareerBWNecromancerTargetting:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerBWNecromancerTargetting:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerBWNecromancerTargetting:client_owner_post_update(dt, t, world, can_damage, current_time_in_action)
	self._ai_navigation_system:add_safe_navigation_callback(self._nav_callback)
end


function ActionCareerBWNecromancerTargetting:_get_first_person_position_direction()
...
function ActionCareerBWNecromancerTargetting:_update_targetting(t)
...
function ActionCareerBWNecromancerTargetting:finish(reason)
	if self._decal_unit then
		local unit_spawner = Managers.state.unit_spawner
