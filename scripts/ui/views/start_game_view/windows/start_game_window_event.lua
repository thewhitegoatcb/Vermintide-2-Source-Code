...
function StartGameWindowEvent:on_enter(params, offset)
...
function StartGameWindowEvent:_create_ui_elements(params, offset)
...
function StartGameWindowEvent:_setup_content_from_backend()
...
function StartGameWindowEvent:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowEvent")
end

function StartGameWindowEvent:update(dt, t)
...
function StartGameWindowEvent:post_update(dt, t)
	return end

function StartGameWindowEvent:_draw(dt)
	local ui_renderer = self._ui_renderer
