...
function AiBreedSnippets.on_chaos_exalted_sorcerer_drachenfels_spawn(unit, blackboard)
	...
	local spell = { range = 40, name = "magic_missile_ground", magic_missile = true, magic_missile_speed = 10, target_ground = true, projectile_unit_name = "units/weapons/projectile/strike_missile_drachenfels/strike_missile_drachenfels", true_flight_template_name = "sorcerer_magic_missile_ground", explosion_template_name = "chaos_drachenfels_strike_missile_impact",
	...
	local spell = { range = 40, name = "seeking_bomb_missile", magic_missile = true, magic_missile_speed = 2.5, true_flight_template_name = "sorcerer_slow_bomb_missile", projectile_unit_name = "units/weapons/projectile/insect_swarm_missile_drachenfels/insect_swarm_missile_drachenfels_01", explosion_template_name = "chaos_slow_bomb_missile_new", life_time = 15,
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_drachenfels_update(unit, blackboard, t, dt)
	...
	if blackboard.third_phase_in_progress and blackboard.current_health ~= 1 then
		...
		elseif blackboard.ring_damage_effect_time and blackboard.ring_damage_effect_time <= t then
			...
			local power_level = { harder = 100, hard = 75, normal = 50, hardest = 150, cataclysm = 400, cataclysm_3 = 400, cataclysm_2 = 400, easy = 50 }
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_drachenfels_death(unit, blackboard)
	local conflict_director = Managers.state.conflict
...
function AiBreedSnippets.on_chaos_exalted_sorcerer_drachenfels_despawn(unit, blackboard)
	local conflict_director = Managers.state.conflict
	conflict_director:remove_unit_from_bosses(unit)
