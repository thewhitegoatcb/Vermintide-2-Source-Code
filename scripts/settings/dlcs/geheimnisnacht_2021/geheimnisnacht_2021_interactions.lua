...
InteractionDefinitions.geheimnisnacht_2021_altar.config = { only_once = true, hud_verb = "player_interaction", hold = true, swap_to_3p = false, activate_block = true, block_other_interactions = true }
...
function InteractionDefinitions.geheimnisnacht_2021_altar.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function InteractionDefinitions.geheimnisnacht_2021_altar.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function InteractionDefinitions.geheimnisnacht_2021_altar.server.can_interact(interactor_unit, interactable_unit)
	local altar_extension = ScriptUnit.extension(interactable_unit, "props_system")
...
function InteractionDefinitions.geheimnisnacht_2021_altar.client.can_interact(interactor_unit, interactable_unit, data, config)
	local altar_extension = ScriptUnit.extension(interactable_unit, "props_system")
	if not altar_extension:can_interact() then
		return
	end
...
function InteractionDefinitions.geheimnisnacht_2021_altar.client.start(world, interactor_unit, interactable_unit, data, config, t)
...
function InteractionDefinitions.geheimnisnacht_2021_altar.server.start(world, interactor_unit, interactable_unit, data, config, t)
