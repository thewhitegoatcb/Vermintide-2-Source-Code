...
function MatchmakingStateRequestProfiles:init(params)
	self._matchmaking_manager = params.matchmaking_manager
end

function MatchmakingStateRequestProfiles:destroy()
	return end

function MatchmakingStateRequestProfiles:on_enter(state_context)
...
function MatchmakingStateRequestProfiles:on_exit()
	return end

function MatchmakingStateRequestProfiles:update(dt, t)
...
function MatchmakingStateRequestProfiles:_request_profiles_data()
...
function MatchmakingStateRequestProfiles:rpc_matchmaking_request_profiles_data_reply(channel_id, profile_array, player_id_array)
...
function MatchmakingStateRequestProfiles:_update_profiles_data(profile_array, player_id_array)
