...
function ProjectileLinkerExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileLinkerExtension:extensions_ready()
	return end


function ProjectileLinkerExtension:link_projectile(projectile_unit, offset_position, rotation, actor_node)
...
function ProjectileLinkerExtension:unlink_projectile(projectile_unit)
...
function ProjectileLinkerExtension:destroy()
