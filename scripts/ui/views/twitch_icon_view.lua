...
function TwitchIconView:init(world)
	self._world = world
...
function TwitchIconView:_create_ui_elements()
...
function TwitchIconView:update(dt)
...
function TwitchIconView:_draw(dt)
...
function TwitchIconView:destroy()
