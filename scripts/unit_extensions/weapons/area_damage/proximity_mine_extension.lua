...
function ProximityMineExtension:init(extension_init_context, unit, extension_init_data)
...
function ProximityMineExtension:destroy()
	return end

function ProximityMineExtension:enable(enable)
	self._arm_timer = self.arm_time
end

function ProximityMineExtension:update(unit, input, dt, context, t)
...
function ProximityMineExtension:hot_join_sync(peer_id)
	return end