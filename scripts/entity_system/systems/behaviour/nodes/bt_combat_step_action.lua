...
function BTCombatStepAction:init(...)
...
function BTCombatStepAction:enter(unit, blackboard, t)
...
function BTCombatStepAction:leave(unit, blackboard, t, reason, destroy)
	blackboard.start_finished = nil
...
function BTCombatStepAction:run(unit, blackboard, t, dt)


	if blackboard.start_finished or
	t - blackboard.start_started_since > 10 then
...
function BTCombatStepAction:anim_cb_combat_step_stop(unit, blackboard)
	local navigation_extension = blackboard.navigation_extension
...
function BTCombatStepAction:_get_animation(rotation, direction)
