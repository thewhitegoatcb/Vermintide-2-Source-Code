local deus_rally_flag_template = { max_fatigue_points = 4, left_hand_unit = "units/weapons/player/wpn_deus_folded_rally_flag_01/wpn_deus_folded_rally_flag_01", state_machine = "units/beings/player/first_person_base/state_machines/common", gui_texture = "hud_consumable_icon_potion", wield_anim = "to_first_aid", load_state_machine = false, can_give_other = true,
	actions = {
		action_one = {
			default = { damage_window_end = 0.35, damage_window_start = 0.1, ammo_usage = 1, kind = "self_interaction", interaction_type = "deus_setup_rally_flag", weapon_action_hand = "left", uninterruptible = true, hold_input = "action_one_hold", interaction_priority = 4,
	...
	ammo_data = { ammo_hand = "left", destroy_when_out_of_ammo = true, max_ammo = 1, ammo_per_clip = 1, reload_time = 0, ignore_ammo_pickup = true },
	...
	pickup_data = { pickup_name = "deus_rally_flag" } }
