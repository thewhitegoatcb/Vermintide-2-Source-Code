...
function BTLootRatDodgeAction:init(...)
...
function BTLootRatDodgeAction:enter(unit, blackboard, t)
...
function BTLootRatDodgeAction:run(unit, blackboard, t, dt)
...
function BTLootRatDodgeAction:leave(unit, blackboard, t, reason, destroy)
...
function BTLootRatDodgeAction:dodge(unit, blackboard, dodge_vector, threat_vector)
	local unit_position = position_lookup [unit]
...
function BTLootRatDodgeAction:try_dodge_position(unit, blackboard, unit_position, dodge_position)
