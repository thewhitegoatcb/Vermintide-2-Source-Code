...
function curse_blood_storm.server_start_function(context, data)
...
function curse_blood_storm.server_update_function(context, data, dt, t)
...
function curse_blood_storm.server_player_hit_function(context, data, hit_unit, attacker_unit, hit_data)
