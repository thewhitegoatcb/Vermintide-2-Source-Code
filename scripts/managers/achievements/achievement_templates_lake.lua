...
add_event_challenge(achievements, "lake_speed_quest", nil, { achievement_settings.speed_quest_complete_time }, "lake_upgrade", nil, nil)
add_event_challenge(achievements, "lake_timing_quest", nil, { achievement_settings.timing_quest_complete_margain }, "lake_upgrade", nil, nil)


local harder_difficulties = { "harder", "hardest", "cataclysm" }
...
achievements.lake_kill_register = { display_completion_ui = false, required_dlc = "lake_upgrade",
...
add_weapon_kills_per_breeds_challenge(achievements, "lake_boss_killblow", { "markus_questingknight_career_skill_weapon" }, boss_breeds, 5, nil, "lake_upgrade", true, nil, nil)
...
local all_challenges = { "lake_complete_all_helmgart_levels_recruit_es_questingknight", "lake_complete_all_helmgart_levels_veteran_es_questingknight", "lake_complete_all_helmgart_levels_champion_es_questingknight", "lake_complete_all_helmgart_levels_legend_es_questingknight", "lake_complete_100_missions_es_questingknight", "lake_mission_streak_act1_legend_es_questingknight", "lake_mission_streak_act2_legend_es_questingknight", "lake_mission_streak_act3_legend_es_questingknight", "lake_boss_killblow", "lake_charge_stagger", "lake_bastard_block", "lake_untouchable", "lake_speed_quest", "lake_timing_quest" }
