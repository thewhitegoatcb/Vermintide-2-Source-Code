...
local function has_item(item_name, active_context)
	...
	if slot_data then
		...
		if item_name == "grimoire" then
			do return item_template.is_grimoire end
		else
			local pickup_data = item_template.pickup_data
			do return pickup_data.pickup_name == item_name end
		end
	else
		return false
	end
...
local unarmed_emotes = { { text = "social_wheel_pose_unarmed_01", name = "social_wheel_general_pose_unarmed_01", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_01", hide_weapons = true },

		ping_type = PingTypes.LOCAL_ONLY },
	{ text = "social_wheel_pose_unarmed_02", name = "social_wheel_general_pose_unarmed_02", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_02", hide_weapons = true },

		ping_type = PingTypes.LOCAL_ONLY },
	{ text = "social_wheel_pose_unarmed_03", name = "social_wheel_general_pose_unarmed_03", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_03", hide_weapons = true },

		ping_type = PingTypes.LOCAL_ONLY },
	{ text = "social_wheel_pose_unarmed_04", name = "social_wheel_general_pose_unarmed_04", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_04", hide_weapons = true },

		ping_type = PingTypes.LOCAL_ONLY },
	{ text = "social_wheel_pose_unarmed_05", name = "social_wheel_general_pose_unarmed_05", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_05", hide_weapons = true },

		ping_type = PingTypes.LOCAL_ONLY },
	{ text = "social_wheel_pose_unarmed_06", name = "social_wheel_general_pose_unarmed_06", icon = "radial_chat_pose_wheel_icon_unarmed",



		execute_func = play_emote,

		data = { anim_event = "anim_pose_unarmed_06", hide_weapons = true },
...
SocialWheelSettings = {
	general = {
		...
		{
			{ text = "social_wheel_general_no", event_text = "social_wheel_general_no", name = "social_wheel_general_no", icon = "radial_chat_icon_no", vo_event_name = "vw_negation",
			...
			{ text = "social_wheel_general_come_here", event_text = "social_wheel_general_come_here", name = "social_wheel_general_come_here", icon = "radial_chat_icon_come_here", vo_event_name = "vw_gather",
			...
			{ text = "social_wheel_general_patrol", event_text = "social_wheel_general_patrol", name = "social_wheel_general_patrol", icon = "radial_chat_icon_patrol", vo_event_name = "vw_patrol",
			...
			{ text = "social_wheel_general_help", event_text = "social_wheel_general_help", name = "social_wheel_general_help", icon = "radial_chat_icon_help", vo_event_name = "vw_help",
			...
			{ text = "social_wheel_general_boss", event_text = "social_wheel_general_boss", name = "social_wheel_general_boss", icon = "radial_chat_icon_boss", vo_event_name = "vw_boss",
			...
			{ text = "social_wheel_general_thank_you", event_text = "social_wheel_general_thank_you", name = "social_wheel_general_thank_you", icon = "radial_chat_icon_thank_you", vo_event_name = "vw_thank_you",
			...
			{ text = "social_wheel_general_yes", event_text = "social_wheel_general_yes", name = "social_wheel_general_yes", icon = "radial_chat_icon_yes", vo_event_name = "vw_affirmative",
		...
		unarmed_emotes, wedge_adjustment = 0.85, has_pages = true, individual_bg = true, angle = 1.7 * math.pi, size = { 500, 250 } },
	...
	general_gamepad = {
		...
		{
			{ text = "social_wheel_general_no", event_text = "social_wheel_general_no", name = "social_wheel_general_no_gp", icon = "radial_chat_icon_no",
			...
			{ text = "social_wheel_general_come_here", event_text = "social_wheel_general_come_here", name = "social_wheel_general_come_here_gp", icon = "radial_chat_icon_come_here",
			...
			{ text = "social_wheel_general_patrol", event_text = "social_wheel_general_patrol", name = "social_wheel_general_patrol_gp", icon = "radial_chat_icon_patrol",
			...
			{ text = "social_wheel_general_help", event_text = "social_wheel_general_help", name = "social_wheel_general_help_gp", icon = "radial_chat_icon_help",
			...
			{ text = "social_wheel_general_boss", event_text = "social_wheel_general_boss", name = "social_wheel_general_boss_gp", icon = "radial_chat_icon_boss",
			...
			{ text = "social_wheel_general_thank_you", event_text = "social_wheel_general_thank_you", name = "social_wheel_general_thank_you_gp", icon = "radial_chat_icon_thank_you",
			...
			{ text = "social_wheel_general_yes", event_text = "social_wheel_general_yes", name = "social_wheel_general_yes_gp", icon = "radial_chat_icon_yes",
		...
		unarmed_emotes_gamepad, wedge_adjustment = 0.85, has_pages = true, individual_bg = false, angle = 2 * math.pi, size = { 250, 250 } },

	item = {



		{ text = "witch_hunter_short", name = "social_wheel_item_pick_up_witch_hunter", icon = "radial_chat_icon_saltzpyre", data = "witch_hunter",
		...
		{ text = "bright_wizard_short", name = "social_wheel_item_pick_up_bright_wizard", icon = "radial_chat_icon_sienna", data = "bright_wizard",
			...
			ping_type = PingTypes.PLAYER_PICK_UP },
		{ text = "dwarf_ranger_short", name = "social_wheel_item_pick_up_dwarf_ranger", icon = "radial_chat_icon_bardin", data = "dwarf_ranger",
			...
			ping_type = PingTypes.PLAYER_PICK_UP },
		{ text = "wood_elf_short", name = "social_wheel_item_pick_up_wood_elf", icon = "radial_chat_icon_kerillian", data = "wood_elf",
			...
			ping_type = PingTypes.PLAYER_PICK_UP },
		{ text = "empire_soldier_short", name = "social_wheel_item_pick_up_empire_soldier", icon = "radial_chat_icon_kruber", data = "empire_soldier",
			...
			ping_type = PingTypes.PLAYER_PICK_UP }, wedge_adjustment = 0.9, ping = true, size = { 250, 250 }, angle = math.pi * 2 },
	...
	friendly_hero_player = {
		...
		{ text = "social_wheel_player_drop_grimoire", name = "social_wheel_player_drop_grimoire", icon = "radial_chat_icon_drop_grimoire", data = "grimoire",
			...
			ping_type = PingTypes.CHAT_ONLY }, wedge_adjustment = 1, ping = false, size = { 250, 250 }, angle = math.pi },
	...
	cancel = {
		...
		{ text = "social_wheel_general_cancel", event_text = "social_wheel_general_cancel", name = "cancel_social_wheel_general_cancel", icon = "radial_chat_icon_no", vo_event_name = "vw_cancel",
			...
			ping_type = PingTypes.CANCEL }, wedge_adjustment = 0.85, individual_bg = true, angle = 1.7 * math.pi, size = { 500, 250 } },
	...
	response = {
		...
		{ text = "social_wheel_general_no", event_text = "social_wheel_general_no", name = "response_social_wheel_general_no", icon = "radial_chat_icon_no", vo_event_name = "vw_cancel",
		...
		{ text = "social_wheel_general_yes", event_text = "social_wheel_general_yes", name = "response_social_wheel_general_yes", icon = "radial_chat_icon_yes", vo_event_name = "vw_affirmative",
			...
			ping_type = PingTypes.ACKNOWLEDGE }, wedge_adjustment = 0.85, individual_bg = true, angle = 1.7 * math.pi, size = { 500, 250 } } }
...
for _, category_settings in pairs(SocialWheelSettings) do
	if category_settings.has_pages then
		...
		for _, setting in ipairs(category_settings) do
			local name = setting.name
			fassert(SocialWheelSettingsLookup [name] == nil, "You have a duplicate entry in SocialWheelSettings (%s), each entry must have a unique name!", name)
			SocialWheelSettingsLookup [name] = setting end end end