...
function PlayerCharacterStateKnockedDown:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateKnockedDown:on_exit(unit, input, dt, context, t, next_state)
	local first_person_extension = self.first_person_extension
...
function PlayerCharacterStateKnockedDown:update(unit, input, dt, context, t)
	local csm = self.csm
	local unit = self.unit
