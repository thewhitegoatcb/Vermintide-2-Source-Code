...
function SummonedVortexHuskExtension:init(extension_init_context, unit, extension_init_data)
...
function SummonedVortexHuskExtension:extensions_ready(world, unit)
...
function SummonedVortexHuskExtension:destroy()
...
function SummonedVortexHuskExtension:update(unit, input, dt, context, t)
...
function SummonedVortexHuskExtension:debug_render_vortex(t, dt, pos, fx_radius, inner_radius, outer_radius, spin_speed, height)
