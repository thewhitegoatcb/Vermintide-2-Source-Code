...
local bxor1 = make_bitop({ [0] = { [0] = 0, 1 }, { [0] = 1, 0 }, n = 4 })
...
local function bxor(a, b, c, ...)
	...
	if b then
		...
		do return z end
	elseif a then do return a % MOD end else
		return 0 end
end
...
local function digestblock(msg, i, H)
	...
	local a = H [1] local b = H [2] local c = H [3] local d = H [4] local e = H [5] local f = H [6] local g = H [7] local h = H [8]
	for i = 1, 64 do
