...
function BTAlliedAvoidCombatAction:init(...)
	BTAlliedAvoidCombatAction.super.init(self, ...)
end

BTAlliedAvoidCombatAction.name = "BTAlliedAvoidCombatAction"

function BTAlliedAvoidCombatAction:enter(unit, blackboard, t)
...
function BTAlliedAvoidCombatAction:leave(unit, blackboard, t, reason, destroy)
...
function BTAlliedAvoidCombatAction:run(unit, blackboard, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
...
function BTAlliedAvoidCombatAction:_go_idle(unit, blackboard, locomotion_extension)
...
function BTAlliedAvoidCombatAction:_go_moving(unit, blackboard, action)
	blackboard.move_state = "moving"
	Managers.state.network:anim_event(unit, action.move_anim)
end

function BTAlliedAvoidCombatAction:flee(unit, t, dt, blackboard, locomotion_extension)
	local action = blackboard.action
	local navigation_extension = blackboard.navigation_extension
...
function BTAlliedAvoidCombatAction:_move_to_flee_location(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
