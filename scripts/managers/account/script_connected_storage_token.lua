...
function ScriptConnectedStorageQueryToken:info()
	local info = { }
	if self._status == self._adapter.COMPLETED then
...
function ScriptConnectedStorageDeleteToken:info()
	local info = { }
