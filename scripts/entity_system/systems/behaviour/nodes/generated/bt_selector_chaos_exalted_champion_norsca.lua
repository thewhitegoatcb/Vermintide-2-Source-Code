...
function BTSelector_chaos_exalted_champion_norsca:init(...)
	BTSelector_chaos_exalted_champion_norsca.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_exalted_champion_norsca:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_exalted_champion_norsca:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_exalted_champion_norsca:add_child(node)
