...
function GameModeSurvival:init(settings, world, ...)
	GameModeSurvival.super.init(self, settings, world, ...)
	self.about_to_lose = false
	self.lost_condition_timer = nil
end

function GameModeSurvival:evaluate_end_conditions(round_started, dt, t)
...
function GameModeSurvival:ended(reason)
