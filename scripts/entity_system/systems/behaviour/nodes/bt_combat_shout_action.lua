...
function BTCombatShoutAction:init(...)
	BTCombatShoutAction.super.init(self, ...)
end

BTCombatShoutAction.name = "BTCombatShoutAction"

function BTCombatShoutAction:enter(unit, blackboard, t)
...
function BTCombatShoutAction:leave(unit, blackboard, t, reason, destroy)
	local navigation_extension = blackboard.navigation_extension
...
function BTCombatShoutAction:run(unit, blackboard, t, dt)
	local locomotion_extension = blackboard.locomotion_extension
...
function BTCombatShoutAction:anim_cb_shout_vo(unit, blackboard)
	local network_manager = Managers.state.network
