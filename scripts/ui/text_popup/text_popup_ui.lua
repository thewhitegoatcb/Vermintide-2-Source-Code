...
function TextPopupUI:init(ui_context)
...
function TextPopupUI:_setup_input()
...
function TextPopupUI:_create_ui_elements()
...
function TextPopupUI:show(header_localization_key, text_localization_key, on_close_callback)
	...
	self._input_manager:capture_input({ "keyboard", "gamepad", "mouse" }, 1, "Text", "TextPopupUI")
...
function TextPopupUI:hide()
	...
	ShowCursorStack.pop()
	self._input_manager:release_input({ "keyboard", "gamepad", "mouse" }, 1, "Text", "TextPopupUI")
...
function TextPopupUI:update(dt)
...
function TextPopupUI:post_update(dt)
	return end

function TextPopupUI:post_render()
	return end

function TextPopupUI:_update_scroll_height(optional_scroll_value)
...
function TextPopupUI:_setup_scrollbar(height, optional_value)
...
function TextPopupUI:_update_mouse_scroll_input()
...
function TextPopupUI:_update_gamepad_scroll_input()
...
function TextPopupUI:_set_scrollbar_value(value)
	if value then
		local widgets_by_name = self._widgets_by_name
		local widget = widgets_by_name.scrollbar
...
function TextPopupUI:_button_clicked(button_name)
...
function TextPopupUI:_animate_button(widget, dt)
