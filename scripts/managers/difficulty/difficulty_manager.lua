...
function DifficultyManager:init(world, is_server, network_event_delegate, lobby_host)
	self.world = world
...
function DifficultyManager:set_difficulty(difficulty, tweak)
...
function DifficultyManager:get_level_difficulties(level_key)
...
function DifficultyManager:get_difficulty_rank()
	return self.difficulty_rank, self.difficulty_tweak
end

function DifficultyManager:get_difficulty_settings()
	return self.difficulty_setting
end

function DifficultyManager:get_difficulty_value_from_table(lookup_table)
...
function DifficultyManager:get_difficulty_index()
	return table.index_of(DefaultDifficulties, self.difficulty)
end

function DifficultyManager:hot_join_sync(peer_id)
...
function DifficultyManager:rpc_set_difficulty(channel_id, difficulty_id, difficulty_tweak, hot_join)
...
function DifficultyManager.players_below_required_power_level(difficulty_key, players)
...
function DifficultyManager.players_below_difficulty_rank(difficulty_key, players)
