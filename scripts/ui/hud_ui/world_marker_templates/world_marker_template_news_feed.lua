	...
	return {
		element = {
			passes = { { pass_type = "texture", style_id = "icon", texture_id = "icon" },
				...
				{ pass_type = "texture", style_id = "icon_pulse", texture_id = "icon_pulse" },



				{ pass_type = "texture", style_id = "background_pulse_1", texture_id = "background_pulse_1" },



				{ pass_type = "texture", style_id = "background_pulse_2", texture_id = "background_pulse_2" },
		...
		content = { icon_pulse = "icon_new_star", background_pulse_2 = "crosshair_03_large", text = "", background_pulse_1 = "crosshair_03_large", icon = "icon_new_star", arrow = "page_button_arrow_glow" },
		...
		style = {
			...
			icon_pulse = { vertical_alignment = "center", horizontal_alignment = "center",
				texture_size = { 35, 35 },
				default_size = { 35, 35 },
			...
			background_pulse_1 = { vertical_alignment = "center", horizontal_alignment = "center",
				texture_size = { 111, 111 },
				default_size = { 111, 111 },


				color = { 255, 255, 255, 255 },
				offset = { 0, 0, 1 } },

			background_pulse_2 = { vertical_alignment = "center", horizontal_alignment = "center",
			...
			text = { word_wrap = true, font_size = 20, localize = false, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark",
				size = { 100, 50 },
