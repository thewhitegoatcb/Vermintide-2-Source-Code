...
local scenegraph_definition = {
	screen = { vertical_alignment = "center", horizontal_alignment = "center", scale = "fit",
	...
	loading_background = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	skip_input = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "left",

		position = { 20, 15, 500 } },



	skip_input_text_1 = { vertical_alignment = "bottom", parent = "skip_input", horizontal_alignment = "left",
	...
	skip_input_text_2 = { vertical_alignment = "bottom", parent = "skip_input", horizontal_alignment = "left",
	...
	skip_input_text_3 = { vertical_alignment = "bottom", parent = "skip_input", horizontal_alignment = "left",
	...
	skip_input_icon = { vertical_alignment = "bottom", parent = "skip_input", horizontal_alignment = "left",
	...
	skip_input_icon_bar = { vertical_alignment = "center", parent = "skip_input_icon", horizontal_alignment = "center",
	...
	background = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	gamma_header_text = { vertical_alignment = "top", parent = "gamma_image", horizontal_alignment = "center",
	...
	gamma_image = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	gamma_correction_image = { vertical_alignment = "bottom", parent = "gamma_image", horizontal_alignment = "center",
	...
	gamma_stepper = { vertical_alignment = "center", parent = "gamma_correction_image", horizontal_alignment = "center",
	...
	gamma_info_text = { vertical_alignment = "bottom", parent = "gamma_correction_image", horizontal_alignment = "center",
	...
	apply_button = { vertical_alignment = "bottom", parent = "background", horizontal_alignment = "center",
	...
	sound_presentation_image = { vertical_alignment = "center", parent = "gamma_image", horizontal_alignment = "center",
	...
	sound_range_presentation_image = { vertical_alignment = "center", parent = "sound_presentation_image", horizontal_alignment = "center",
	...
	sound_panning_option_1 = { vertical_alignment = "center", parent = "gamma_stepper", horizontal_alignment = "center",
	...
	sound_panning_option_1_glow = { vertical_alignment = "center", parent = "sound_panning_option_1", horizontal_alignment = "center",
	...
	sound_panning_option_2 = { vertical_alignment = "center", parent = "gamma_stepper", horizontal_alignment = "center",
	...
	sound_panning_option_2_glow = { vertical_alignment = "center", parent = "sound_panning_option_2", horizontal_alignment = "center",
	...
	sound_range_option_1 = { vertical_alignment = "center", parent = "sound_panning_option_1", horizontal_alignment = "center",
	...
	sound_range_option_1_glow = { vertical_alignment = "center", parent = "sound_range_option_1", horizontal_alignment = "center",
	...
	sound_range_option_2 = { vertical_alignment = "center", parent = "sound_panning_option_2", horizontal_alignment = "center",
	...
	sound_range_option_2_glow = { vertical_alignment = "center", parent = "sound_range_option_2", horizontal_alignment = "center",
	...
	console_input_text_1 = { vertical_alignment = "bottom", parent = "background", horizontal_alignment = "right",
	...
	console_input_icon_root_1 = { vertical_alignment = "center", parent = "console_input_text_1", horizontal_alignment = "left",
	...
	console_input_icon_1 = { vertical_alignment = "center", parent = "console_input_icon_root_1", horizontal_alignment = "center",
	...
	console_input_text_2 = { vertical_alignment = "center", parent = "console_input_text_1", horizontal_alignment = "left",
	...
	console_input_icon_root_2 = { vertical_alignment = "center", parent = "console_input_text_2", horizontal_alignment = "left",
	...
	console_input_icon_2 = { vertical_alignment = "center", parent = "console_input_icon_root_2", horizontal_alignment = "center",
...
skip_widget = { scenegraph_id = "skip_input",
	element = {
		passes = { { style_id = "input_text_1", pass_type = "text", text_id = "input_text_1" },



			{ style_id = "input_text_2", pass_type = "text", text_id = "input_text_2",
			...
			{ style_id = "input_text_3", pass_type = "text", text_id = "input_text_3" },



			{ pass_type = "texture", style_id = "input_icon", texture_id = "input_icon",
			...
			{ pass_type = "gradient_mask_texture", style_id = "input_icon_bar", texture_id = "input_icon_bar",
			...
			{ style_id = "hold_bar", pass_type = "rect",


				content_check_function = function (content)
					return content.using_keyboard
				end },
			{ style_id = "hold_bar_bg", pass_type = "rect",
	...
	content = { input_icon_bar = "controller_hold_bar", input_text_2 = "", input_text_1 = "", using_keyboard = true,
	...
	style = {
		hold_bar = { scenegraph_id = "skip_input_icon",
			color = Colors.get_color_table_with_alpha("font_title", 255),
			offset = { -5, -16, 1 },
			size = { 0, 8 } },


		hold_bar_bg = { scenegraph_id = "skip_input_icon",
			color = { 255, 255, 255, 255 },
			offset = { -5, -16, 0 },
			size = { 0, 8 } },


		input_icon = { scenegraph_id = "skip_input_icon",

			color = { 255, 255, 255, 255 } },

		input_icon_bar = { scenegraph_id = "skip_input_icon_bar", gradient_threshold = 0,


			color = { 255, 255, 255, 255 } },

		input_text_1 = { scenegraph_id = "skip_input_text_1", font_size = 36, word_wrap = false, pixel_perfect = true, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		input_text_2 = { font_size = 36, upper_case = true, horizontal_alignment = "left", word_wrap = false, pixel_perfect = true, scenegraph_id = "skip_input_text_2", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
		...
		input_text_3 = { scenegraph_id = "skip_input_text_3", font_size = 36, word_wrap = false, pixel_perfect = true, horizontal_alignment = "left", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
...
local dead_space_filler_widget = { scenegraph_id = "dead_space_filler",
	element = {
		passes = { { pass_type = "rect" } } },
...
local function create_gamma_widget()
	return { scenegraph_id = "gamma_image",
		element = {
			passes = { { style_id = "value_text", pass_type = "text", text_id = "value_text" },



				{ style_id = "gamma_header_text", pass_type = "text", text_id = "gamma_header_text" },



				{ style_id = "gamma_info_text", pass_type = "text", text_id = "gamma_info_text" },



				{ pass_type = "texture", style_id = "gamepad_navigation_icon", texture_id = "gamepad_navigation_icon",
				...
				{ pass_type = "texture", style_id = "gamepad_accept_icon", texture_id = "gamepad_accept_icon",
				...
				{ style_id = "gamepad_navigation_text", pass_type = "text", text_id = "gamepad_navigation_text",
				...
				{ style_id = "gamepad_accept_text", pass_type = "text", text_id = "gamepad_accept_text",
		...
		content = { gamma_header_text = "startup_settings_gamma_header", gamma_info_text = "startup_settings_gamma_desc", value_text = 0, gamepad_navigation_icon = "xbone_button_icon_a", gamepad_accept_icon = "xbone_button_icon_a",
		...
		style = {
			gamepad_accept_icon = { scenegraph_id = "console_input_icon_2" },


			gamepad_navigation_icon = { scenegraph_id = "console_input_icon_1" },


			gamepad_navigation_text = { vertical_alignment = "center", scenegraph_id = "console_input_text_1", localize = false, font_size = 22, horizontal_alignment = "left", font_type = "hell_shark",
				text_color = Colors.get_color_table_with_alpha("white", 255) },
			...
			gamepad_accept_text = { vertical_alignment = "center", scenegraph_id = "console_input_text_2", localize = false, font_size = 22, horizontal_alignment = "left", font_type = "hell_shark",
				text_color = Colors.get_color_table_with_alpha("white", 255) },
			...
			value_text = { vertical_alignment = "bottom", localize = false, horizontal_alignment = "left", font_size = 32, dynamic_font = true, font_type = "hell_shark_header",
				offset = { 120.5, -70, 0 },
			...
			gamma_header_text = { vertical_alignment = "center", upper_case = true, localize = true, horizontal_alignment = "center", font_size = 42, font_type = "hell_shark_header", scenegraph_id = "gamma_header_text",
				text_color = Colors.get_color_table_with_alpha("font_title", 255) },
			...
			gamma_info_text = { vertical_alignment = "center", scenegraph_id = "gamma_info_text", localize = true, horizontal_alignment = "center", font_size = 24, word_wrap = true, font_type = "hell_shark",
				text_color = Colors.get_color_table_with_alpha("white", 255) } } }
...
local header_text_style = { vertical_alignment = "center", upper_case = true, localize = true, horizontal_alignment = "center", font_size = 42, font_type = "hell_shark_header", scenegraph_id = "gamma_header_text",
	text_color = Colors.get_color_table_with_alpha("font_title", 255) }
...
local description_text_style = { vertical_alignment = "center", scenegraph_id = "gamma_info_text", localize = true, horizontal_alignment = "center", font_size = 24, word_wrap = true, font_type = "hell_shark",
	text_color = Colors.get_color_table_with_alpha("white", 255) }
...
local prologue_video = { video_name = "video/vermintide_2_prologue_intro", sound_start = "vermintide_2_prologue_intro", scenegraph_id = "splash_video", material_name = "vermintide_2_prologue_intro", sound_stop = "Stop_vermintide_2_prologue_intro",
...
local dlc_intro_video = { video_name = "video/vermintide_2_shovel_intro", sound_start = "Play_vermintide_2_shovel_intro", scenegraph_id = "splash_video", material_name = "vermintide_2_shovel_intro", sound_stop = "Stop_vermintide_2_shovel_intro",
...
local gamma_value_settings = { start_value = 2.2, min = 1.5, num_decimals = 1, max = 5 }
...
local panning_value_settings = { min = 1, num_decimals = 0, start_value = 1, max = 2,




	options = { { value = "speakers",
			text = Localize("menu_settings_speakers") }, { value = "headphones",
			text = Localize("menu_settings_headphones") } },

	option_index_by_key = { headphones = 2, speakers = 1 } }




local dynamic_range_value_settings = { min = 1, num_decimals = 0, start_value = 3, max = 3,




	options = { { value = "low",
			text = Localize("menu_settings_low") }, { value = "medium",
			text = Localize("menu_settings_medium") }, { value = "high",
			text = Localize("menu_settings_high") } },

	option_index_by_key = { high = 3, medium = 2, low = 1 } }
...
local generic_input_actions = {
	default = { { input_action = "analog_input", priority = 1, description_text = "scoreboard_navigation" },
...
function TitleLoadingUI:init(world, params, force_done)
...
function TitleLoadingUI:_setup_gui()
	self._ui_renderer = UIRenderer.create(self._world,
...
function TitleLoadingUI:_create_elements()
...
function TitleLoadingUI:setup_gamma_menu()
	local gamma_stepper = self._gamma_widgets_by_name.gamma_stepper
	local gamma_adjuster = self._gamma_widgets_by_name.gamma_adjuster
	local min = gamma_value_settings.min local max = gamma_value_settings.max local start_value = gamma_value_settings.start_value
...
function TitleLoadingUI:setup_sound_panning_menu()
	local stepper = self._panning_widgets_by_name.stepper
	local min = panning_value_settings.min local max = panning_value_settings.max local start_value = panning_value_settings.start_value
...
function TitleLoadingUI:setup_sound_dynamic_range_menu()
	local stepper = self._dynamic_range_widgets_by_name.stepper
	local min = dynamic_range_value_settings.min local max = dynamic_range_value_settings.max local start_value = dynamic_range_value_settings.start_value
...
function TitleLoadingUI:update(dt, t)
	if DO_RELOAD then
		self:_create_elements()
	end
...
function TitleLoadingUI:_change_sound_panning_display_by_value(value)
	local min = panning_value_settings.min
	local max = panning_value_settings.max
...
function TitleLoadingUI:_change_sound_dynamic_range_display_by_value(value)
	local min = dynamic_range_value_settings.min
	local max = dynamic_range_value_settings.max
...
function TitleLoadingUI:_update_continue_button(gamepad_active, dt)
...
function TitleLoadingUI:_animate_button(widget, dt)
...
function TitleLoadingUI:_handle_stepper_input(widget, stepper_settings, gamepad_active, dt)
	local input_service = Managers.input:get_service("title_loading_ui")
...
function TitleLoadingUI:_on_stepper_arrow_hover(widget, style_id)
...
function TitleLoadingUI:_on_stepper_arrow_dehover(widget, style_id)
	local widget_animations = widget.animations
...
function TitleLoadingUI:_on_stepper_arrow_pressed(widget, style_id)
	local widget_animations = widget.animations
...
function TitleLoadingUI:_animate_element_by_catmullrom(target, target_index, target_value, p0, p1, p2, p3, time)
	local new_animation = UIAnimation.init(UIAnimation.catmullrom, target, target_index, target_value,
	p0, p1, p2, p3, time)
	return new_animation
end

function TitleLoadingUI:_animate_element_by_time(target, target_index, from, to, time)
	local new_animation = UIAnimation.init(UIAnimation.function_by_time, target, target_index,
	from, to, time, math.ease_out_quad)
	return new_animation
end

function TitleLoadingUI:_get_input_texture_data(input_action)
	local input_service = Managers.input:get_service("title_loading_ui")
	...
	if ( Managers.input:is_device_active("keyboard") or Managers.input:is_device_active("mouse") ) and IS_WINDOWS then
		...
		do return nil, is_button_unassigned and "" or Keyboard.button_locale_name(key_index) end
...
function TitleLoadingUI:_get_input_gamepad_texture_data(input_action)
	local input_service = Managers.input:get_service("title_loading_ui")
	return UISettings.get_gamepad_input_texture_data(input_service, input_action, true)
end

function TitleLoadingUI:_update_input_text(dt)
...
function TitleLoadingUI:_update_any_held()
	local held = false
...
function TitleLoadingUI:_update_input(dt)
...
function TitleLoadingUI:_handle_skip_fade(alpha)
...
function TitleLoadingUI:_render(dt)
...
function TitleLoadingUI:_render_video(dt)
...
function TitleLoadingUI:destroy()
	self:_stop_subtitles()

	UIRenderer.destroy(self._ui_renderer, self._world)

	if self._sound_started and
	first_time_video.sound_stop then
		Managers.music:trigger_event(first_time_video.sound_stop)
	end
...
function TitleLoadingUI:_start_subtitles_by_template(subtitle_template_settings)
	...
	local context = { ui_renderer = self._ui_renderer }
...
function TitleLoadingUI:_stop_subtitles()
	if self.cutscene_overlay_ui then
		self.cutscene_overlay_ui:destroy()
	end
end

function TitleLoadingUI:_has_active_subtitles()
