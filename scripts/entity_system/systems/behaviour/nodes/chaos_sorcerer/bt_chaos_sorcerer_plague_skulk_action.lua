...
function BTChaosSorcererPlagueSkulkAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChaosSorcererPlagueSkulkAction:run(unit, blackboard, t, dt)
	...
	if blackboard.vanish_countdown and blackboard.vanish_countdown < t and
	self:vanish(unit, blackboard, t) then
		return "done"
	end
...
function BTChaosSorcererPlagueSkulkAction:at_goal(unit, blackboard)
	local action = blackboard.action
...
function BTChaosSorcererPlagueSkulkAction:move_to(position, unit, blackboard)
	local action = blackboard.action
	local ai_navigation = blackboard.navigation_extension
	local breed = blackboard.breed
...
function BTChaosSorcererPlagueSkulkAction:vanish(unit, blackboard, t)
	local action = blackboard.action
...
function BTChaosSorcererPlagueSkulkAction:idle(unit, blackboard)
	self:anim_event(unit, blackboard, "idle")
	blackboard.move_state = "idle"
end

function BTChaosSorcererPlagueSkulkAction:start_move_animation(unit, blackboard)
	local move_animation = blackboard.action.move_animation
	self:anim_event(unit, blackboard, move_animation)
	blackboard.move_state = "moving"
end

function BTChaosSorcererPlagueSkulkAction:anim_event(unit, blackboard, anim)
	local skulk_data = blackboard.skulk_data
...
function BTChaosSorcererPlagueSkulkAction:get_plague_wave_cast_position(unit, blackboard, plague_wave_data)
	local action = blackboard.action
...
local TRIES = 15
function BTChaosSorcererPlagueSkulkAction:get_skulk_target(unit, blackboard, teleporting)
	local action = blackboard.action
	local nav_world = blackboard.nav_world
	local skulk_data = blackboard.skulk_data
