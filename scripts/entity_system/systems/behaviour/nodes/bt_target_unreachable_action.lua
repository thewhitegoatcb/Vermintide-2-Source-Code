...
function BTTargetUnreachableAction:init(...)
	BTTargetUnreachableAction.super.init(self, ...)
end

BTTargetUnreachableAction.name = "BTTargetUnreachableAction"

function BTTargetUnreachableAction:enter(unit, blackboard, t)
	local action = self._tree_node.action_data
	blackboard.action = action
	blackboard.unreachable_timer = blackboard.chasing_timer or 0
end

function BTTargetUnreachableAction:leave(unit, blackboard, t, reason, destroy)
	local default_move_speed = AiUtils.get_default_breed_move_speed(unit, blackboard)
	local navigation_extension = blackboard.navigation_extension
	navigation_extension:set_max_speed(default_move_speed)
end

function BTTargetUnreachableAction:run(unit, blackboard, t, dt)
...
function BTTargetUnreachableAction:move_closer(unit, blackboard, locomotion_extension, navigation_extension)
...
function BTTargetUnreachableAction:_debug_distance_text(unit, navigation_extension)
