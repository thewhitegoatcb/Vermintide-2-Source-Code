...
function ThornSisterWallExtension:init(extension_init_context, unit, extension_init_data)
	...
	if
	source_talent_extension and source_talent_extension:has_talent("kerillian_thorn_sister_debuff_wall") then
...
function ThornSisterWallExtension:update(unit, input, dt, context, t)
...
function ThornSisterWallExtension:trigger_area_damage()
...
function ThornSisterWallExtension:despawn()
	...
	if self._is_server and self._despawn_sound_event and (
	not self.group_spawn_index or self.group_spawn_index == 1) then
...
function ThornSisterWallExtension:die()
...
function ThornSisterWallExtension:owner()
