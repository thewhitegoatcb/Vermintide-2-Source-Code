...
function BTSelector_pack_master:init(...)
	BTSelector_pack_master.super.init(self, ...)
	self._children = { }
end

function BTSelector_pack_master:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_pack_master:run(unit, blackboard, t, dt)
...
function BTSelector_pack_master:add_child(node)
