...
function BTSelector_shield_marauder:init(...)
	BTSelector_shield_marauder.super.init(self, ...)
	self._children = { }
end

function BTSelector_shield_marauder:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_shield_marauder:run(unit, blackboard, t, dt)
...
function BTSelector_shield_marauder:add_child(node)
