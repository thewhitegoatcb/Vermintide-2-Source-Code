...
function DeusJourneyPresentationUI:create_ui_elements()
...
function DeusJourneyPresentationUI:start(journey_name, previous_completed_difficulty_index)
...
function DeusJourneyPresentationUI:_set_presentation_info(journey_data, journey_name)
