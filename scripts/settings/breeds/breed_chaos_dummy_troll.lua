local breed_data = { behavior = "dummy_troll", no_autoaim = true, target_selection = "pick_no_targets", boss = "SET_TO_NIL", passive_in_patrol = false, race = "chaos", not_bot_target = true, perception = "perception_no_seeing", combat_music_state = "no_boss", debug_spawn_category = "Misc",
