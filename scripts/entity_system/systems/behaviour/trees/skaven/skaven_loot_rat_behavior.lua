...
BreedBehaviors.loot_rat = { "BTSelector",
	...
	{ "BTStaggerAction", name = "stagger", condition = "loot_rat_stagger",
	...
	{ "BTLootRatDodgeAction", name = "dodge", condition = "loot_rat_dodge",

		action_data = ACTIONS.dodge }, { "BTLootRatFleeAction", name = "flee", condition = "loot_rat_flee",
		action_data = ACTIONS.flee }, { "BTLootRatAlertedAction", condition = "can_see_player", name = "alerted" },
