...
function ShockwaveSpellExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
...
function ShockwaveSpellExtension:update(unit, input, dt, context, t)
...
function ShockwaveSpellExtension:damage_enemies(position, t)
	if num_hits > 0 then
...
function ShockwaveSpellExtension:damage_player(position, radius)
...
function ShockwaveSpellExtension:setup_shockwave(damage_data)
...
function ShockwaveSpellExtension:reset_shockwave()
	self._spell_triggerd = false
	table.clear(HIT_ENEMIES)
end

function ShockwaveSpellExtension:destroy()
