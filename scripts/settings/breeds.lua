...
local DEFAULT_NAVTAG_LAYERS = { end_zone = 0, ledges = 1.5, barrel_explosion = 10, jumps = 1.5, bot_ratling_gun_fire = 3, temporary_wall = 0, planks = 1.5, big_boy_destructible = 0, destructible_wall = 5, ledges_with_fence = 1.5, doors = 1.5, teleporters = 5, bot_poison_wind = 1.5, fire_grenade = 10 }
...
local DEFAULT_NAV_COST_MAP_LAYERS = { plague_wave = 20, mutator_heavens_zone = 1, lamp_oil_fire = 10, warpfire_thrower_warpfire = 20, vortex_near = 1, stormfiend_warpfire = 30, vortex_danger_zone = 1, troll_bile = 20 }
...
DEFAULT_NAV_TAG_VOLUME_LAYER_COST_BOTS = { NO_BOTS_NO_SPAWN = 0, NO_BOTS = 0 }
...
local PerceptionTypes = { perception_pack_master = true, perception_no_seeing = true, perception_all_seeing_boss = true, perception_regular = true, perception_regular_update_aggro = true, perception_all_seeing_re_evaluate = true, perception_standard_bearer = true, perception_all_seeing = true, perception_rat_ogre = true }
...
local TargetSelectionTypes = { pick_closest_target_with_filter = true, pick_ninja_approach_target = true, pick_chaos_warrior_target_with_weights = true, pick_flee_target = true, pick_closest_target_near_detection_source_position = true, pick_bestigor_target_with_weights = true, pick_rat_ogre_target_idle = true, pick_player_controller_allied = true, pick_solitary_target = true, pick_mutator_sorcerer_target = true, pick_closest_target = true, pick_corruptor_target = true, pick_rat_ogre_target_with_weights = true, pick_closest_vortex_target = true, pick_closest_target_with_spillover = true, horde_pick_closest_target_with_spillover = true, pick_pack_master_target = true, pick_no_targets = true, pick_boss_sorcerer_target = true }
...
for name, breed in pairs(Breeds) do
	...
	elseif breed.race == "dummy" then --[[ Nothing --]]
	...
	if anim_variables then
		...
		breed.networked_animation_variables = compiled end end