...
local SOUND_EVENTS = { player_resurrected = "Play_blessing_of_isha_activate" }




local VALID_DISABLE_EVENTS = { pack_master_grab = true, assassin_pounced = true, corruptor_grab = true }
