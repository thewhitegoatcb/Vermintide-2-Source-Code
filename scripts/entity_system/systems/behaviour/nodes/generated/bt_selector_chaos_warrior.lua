...
function BTSelector_chaos_warrior:init(...)
	BTSelector_chaos_warrior.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_warrior:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_warrior:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_warrior:add_child(node)
