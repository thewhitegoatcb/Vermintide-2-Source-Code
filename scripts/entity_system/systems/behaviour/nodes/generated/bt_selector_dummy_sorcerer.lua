...
function BTSelector_dummy_sorcerer:init(...)
	BTSelector_dummy_sorcerer.super.init(self, ...)
	self._children = { }
end

function BTSelector_dummy_sorcerer:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_dummy_sorcerer:run(unit, blackboard, t, dt)
...
function BTSelector_dummy_sorcerer:add_child(node)
