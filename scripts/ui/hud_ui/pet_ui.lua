...
function PetUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function PetUI:destroy(parent, ingame_ui_context)
...
function PetUI:_destroy_all_widgets()
...
function PetUI:_create_ui_elements()
...
function PetUI:set_visible(visible)
	self._is_visible = visible

	self:_set_elements_visible(visible)
end

function PetUI:_set_elements_visible(visible)
...
function PetUI:_set_widget_dirty(widget)
	widget.element.dirty = true
	self._dirty = true
end

function PetUI:_set_all_dirty()
	UIUtils.mark_dirty(self._pet_widget_list)
	self:_set_widget_dirty(self._container_widget)
end

function PetUI:_create_pet_widget(pet_unit)
	...
	SKULL_TEXTURES [index] = SKULL_TEXTURES [skull_index] SKULL_TEXTURES [skull_index] = SKULL_TEXTURES [index]
	SKULL_GLOW_TEXTURES [index] = SKULL_GLOW_TEXTURES [skull_index] SKULL_GLOW_TEXTURES [skull_index] = SKULL_GLOW_TEXTURES [index]
...
function PetUI:_pet_ui_available(player)
...
local TO_REMOVE = { }
function PetUI:_update_animations(dt)
...
function PetUI:_update_pet_container(dt, t, player)
	...
	if not container_widget.content.initialized then
		...
		container_widget.content.help_text =
		string.format("{#color(255,168,0)}[%s]{#reset()} to attack", Utf8.upper(action_input_name("Player", "action_one"))) ..
		string.format("\n{#color(255,168,0)}[%s]{#reset()} to hold a position", Utf8.upper(action_input_name("Player", "action_two_hold"))) ..
...
function PetUI:add_pet_nameplate(unit, widget)
...
function PetUI:update(dt, t, player)
...
function PetUI:_handle_gamepad_activity()
...
function PetUI:_handle_resolution_modified()
...
function PetUI:resolution_modified()
	self:_set_all_dirty()
end

function PetUI:_draw(dt, t)
...
function PetUI:_update_pet_widget(widget, commander_extension, in_command_mode, hovered_unit)
	local content = widget.content
