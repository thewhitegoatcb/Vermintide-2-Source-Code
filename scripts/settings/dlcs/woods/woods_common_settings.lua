...
settings.career_setting_files = { "scripts/settings/dlcs/woods/career_settings_woods" }



settings.career_ability_settings = { "scripts/settings/dlcs/woods/career_ability_settings_woods" }



settings.action_template_files = { "scripts/settings/dlcs/woods/action_templates_woods" }



settings.talent_settings = { "scripts/settings/dlcs/woods/talent_settings_woods" }



settings.profile_files = { "scripts/settings/dlcs/woods/woods_profiles" }



settings.death_reactions = { "scripts/settings/dlcs/woods/woods_death_reactions" }
...
settings.statistics_definitions = { "scripts/managers/backend/statistics_definitions_woods" }



settings.unit_extension_templates = { "scripts/settings/dlcs/woods/woods_unit_extension_templates" }



settings.statistics_lookup = { "woods_javelin_melee_kills", "woods_lift_kills", "woods_javelin_combo", "woods_triple_lift", "woods_heal_grind", "woods_amount_healed", "woods_wall_kill_grind", "woods_wall_kill", "woods_bleed_grind", "woods_bleed_tics", "woods_chaos_pinata", "woods_bleed_boss", "woods_wall_kill_gutter", "woods_ability_combo", "woods_wall_tank", "woods_wall_hits_soaked", "woods_wall_block_ratling", "woods_ratling_shots_soaked", "woods_wall_dual_save", "woods_free_ability_grind", "woods_free_abilities_used" }
...
settings.anim_lookup = { "thorn_ability_start", "thorn_ability_cancel", "thorn_ability_flip", "thorn_ability_cast", "thorn_ability_flip_back", "attack_chain_01", "attack_chain_02", "attack_chain_03", "attack_throw_last", "overcharge_end", "sot_landing", "to_javelin", "to_javelin_noammo" }
...
settings.effects = { "fx/magic_thorn_sister_finger_trail", "fx/magic_thorn_sister_finger_trail_3p", "fx/magic_thorn_sister_finger_trail_long", "fx/magic_thorn_sister_finger_trail_medium", "fx/lifestaff_idle", "fx/lifestaff_trail", "fx/lifestaff_trail_3p", "fx/lifestaff_impact", "fx/thornsister_buff", "fx/thornsister_overcharge", "fx/thornsister_spirits", "fx/thorn_wall_aura", "fx/thorn_leaves", "fx/thorn_indicator", "fx/javelin_trail", "fx/thornsister_buff_screenspace", "fx/thornsister_overcharge_explosion", "fx/thornsister_vine_trail", "fx/thornsister_overcharge_explosion_3p" }
...
settings.material_effect_mappings_file_names = { "scripts/settings/material_effect_mappings_woods" }
...
settings.unlock_settings = {
	woods = { id = "1629000", class = "UnlockDlc", requires_restart = true },
	woods_upgrade = { id = "1629010", class = "UnlockDlc", requires_restart = true } }


settings.unlock_settings_xb1 = {
	woods = { id = "47365039-5234-3046-C035-4B5831583300", backend_reward_id = "woods", class = "UnlockDlc", requires_restart = true },
	woods_upgrade = { id = "47365039-5234-3046-C035-4B5831583300", backend_reward_id = "woods_upgrade", class = "UnlockDlc" } }



settings.unlock_settings_ps4 = {
	CUSA13595_00 = {
		woods = { product_label = "V2USSISTERTHORNK", backend_reward_id = "woods", class = "UnlockDlc", requires_restart = true, id = "6925f575a58740ef84ac8031ccaabfe8" },
		woods_upgrade = { id = "6925f575a58740ef84ac8031ccaabfe8", product_label = "V2USSISTERTHORNK", class = "UnlockDlc", backend_reward_id = "woods_upgrade" } },

	CUSA13645_00 = {
		woods = { product_label = "V2EUSISTERTHORNK", backend_reward_id = "woods", class = "UnlockDlc", requires_restart = true, id = "c8ae619a4d82456486e5bae83c206057" },
		woods_upgrade = { id = "c8ae619a4d82456486e5bae83c206057", product_label = "V2EUSISTERTHORNK", class = "UnlockDlc", backend_reward_id = "woods_upgrade" } } }
...
settings.store_layout = {
	structure = {
		cosmetics = {
			kerillian = {
				thornsister = { weapon_skins = "item_details" } } } },
	...
	pages = {
		thornsister = { sound_event_enter = "Play_hud_store_category_button", layout = "category", display_name = "we_thornsister", item_filter = "can_wield_we_thornsister", sort_order = 3, category_button_texture = "store_category_icon_kerillian_thornsister" } } }
...
settings.prop_extension = { "ThornSisterWallExtension" }



settings.area_damage_extension = { "SummonedVortexExtension", "SummonedVortexHuskExtension" }




settings.entity_extensions = { "scripts/settings/dlcs/woods/thornsister_wall_extension", "scripts/settings/dlcs/woods/summoned_vortex_extension", "scripts/settings/dlcs/woods/summoned_vortex_husk_extension" }





settings.health_extension_files = { "scripts/settings/dlcs/woods/thorn_wall_health_extension" }



settings.health_extensions = { "ThornWallHealthExtension" }



settings.network_damage_types = { "burst_thorn" }



settings.dot_type_lookup = { thorn_sister_passive_poison_improved = "poison_dot", weapon_bleed_dot_javelin = "poison_dot", thorn_sister_wall_bleed = "poison_dot", thorn_sister_passive_poison = "poison_dot" }
...
settings.progression_unlocks = {
	we_thornsister = { description = "end_screen_career_unlocked", profile = "wood_elf", value = "we_thornsister", title = "we_thornsister", level_requirement = 0, unlock_type = "career" } }
...
settings.network_go_types = { "thornsister_thorn_wall_unit", "vortex_unit" }




settings.game_object_templates = {
	thornsister_thorn_wall_unit = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	vortex_unit = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_yaw = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false } }
...
settings.game_object_initializers = {
	...
	vortex_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
		...
		local data_table = { height_percentage = 1, inner_radius_percentage = 1, fx_radius_percentage = 1,
...
settings.game_object_extractors = {
	thornsister_thorn_wall_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
		...
		local extension_init_data = {
			...
			death_system = { death_reaction_template = "thorn_wall", is_husk = true },
	...
	vortex_unit = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
		...
		local extension_init_data = {
			...
			area_damage_system = { vortex_template_name = vortex_template_name, inner_decal_unit = inner_decal_unit, outer_decal_unit = outer_decal_unit, owner_unit = owner_unit } }
