...
function CameraStateFollowThirdPersonSmartClimbing:init(camera_state_init_context)
	CameraState.init(self, camera_state_init_context, "follow_third_person_smart_climbing")

	self._follow_unit = nil
	self._follow_node = 0
end

function CameraStateFollowThirdPersonSmartClimbing:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollowThirdPersonSmartClimbing:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollowThirdPersonSmartClimbing:refresh_follow_unit(follow_unit, follow_node)
	self._follow_unit = follow_unit
	self._follow_node = follow_node
end

function CameraStateFollowThirdPersonSmartClimbing:update(unit, input, dt, context, t)
	local csm = self.csm
