...
settings.buff_templates = {
	markus_questing_knight_passive_cooldown_reduction = {
		buffs = { { name = "markus_questing_knight_passive_cooldown_reduction", multiplier = 0.1, stat_buff = "cooldown_regen", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_cdr", priority_buff = true } } },
	...
	markus_questing_knight_passive_cooldown_reduction_improved = {
		buffs = { { name = "markus_questing_knight_passive_cooldown_reduction_improved", multiplier = 0.15, stat_buff = "cooldown_regen", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_cdr" } } },
	...
	markus_questing_knight_passive_attack_speed = {
		buffs = { { name = "markus_questing_knight_passive_attack_speed", multiplier = 0.05, stat_buff = "attack_speed", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_attackspeed" } } },
	...
	markus_questing_knight_passive_attack_speed_improved = {
		buffs = { { name = "markus_questing_knight_passive_attack_speed_improved", multiplier = 0.075, stat_buff = "attack_speed", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_attackspeed", priority_buff = true } } },
	...
	markus_questing_knight_passive_power_level = {
		buffs = { { name = "markus_questing_knight_passive_power_level", multiplier = 0.1, stat_buff = "power_level", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_powerlevel", priority_buff = true } } },
	...
	markus_questing_knight_passive_power_level_improved = {
		buffs = { { name = "markus_questing_knight_passive_power_level_improved", multiplier = 0.15, stat_buff = "power_level", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_powerlevel" } } },
	...
	markus_questing_knight_passive_damage_taken = {
		buffs = { { name = "markus_questing_knight_passive_damage_taken", multiplier = -0.1, stat_buff = "damage_taken", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_damage_taken", priority_buff = true } } },
	...
	markus_questing_knight_passive_damage_taken_improved = {
		buffs = { { name = "markus_questing_knight_passive_damage_taken_improved", multiplier = -0.15, stat_buff = "damage_taken", refresh_durations = true, max_stacks = 1, icon = "markus_questing_knight_buff_damage_taken" } } },
	...
	markus_questing_knight_passive_health_regen = {
		buffs = { { heal = 1, heal_type = "career_passive", name = "markus_questing_knight_passive_health_regen", icon = "markus_questing_knight_buff_health_regen", time_between_heal = 5, priority_buff = true, apply_buff_func = "health_regen_start", max_stacks = 1, update_func = "health_regen_update" } } },
	...
	markus_questing_knight_passive_health_regen_improved = {
		buffs = { { icon = "markus_questing_knight_buff_health_regen", name = "markus_questing_knight_passive_health_regen_improved", heal = 1, max_stacks = 1, time_between_heal = 2.5, update_func = "health_regen_update", apply_buff_func = "health_regen_start", heal_type = "career_passive" } } } }
...
settings.proc_functions = {
	markus_questing_knight_spread_temp_health = function (owner_unit, buff, params)
		...
		if ALIVE [owner_unit] and Managers.player.is_server and healed_self and temp_health_gain then
			...
			local closest_ally = nil local closest_distance = 500
...
settings.buff_function_templates = {
	...
	update_markus_questing_knight_passive_aura = function (owner_unit, buff, params)
		...
		local buff_extension = ScriptUnit.extension(owner_unit, "buff_system")
		local buff_list = {
			{ buff_to_add = "markus_questing_knight_boss_aura_party", apply_to_party = true, apply_to_self = false, apply = buff_extension:has_buff_perk("boss_aura") },
			{ buff_to_add = "markus_questing_knight_specials_aura_party", apply_to_party = true, apply_to_self = false, apply = buff_extension:has_buff_perk("specials_aura") },
			{ buff_to_add = "markus_questing_knight_elites_aura_party", apply_to_party = true, apply_to_self = false, apply = buff_extension:has_buff_perk("elites_aura") },
			{ buff_to_add = "markus_questing_knight_super_aura_party", apply_to_party = true, apply_to_self = true, apply = super_buff_talent and buff_extension:has_buff_perk("boss_aura") and buff_extension:has_buff_perk("specials_aura") and buff_extension:has_buff_perk("elites_aura") },
			{ buff_to_add = "markus_questing_knight_passive_tank_buff", apply_to_party = false, apply_to_self = true, apply = tank_buff_talent and (buff_extension:has_buff_perk("boss_aura") or buff_extension:has_buff_perk("specials_aura") or buff_extension:has_buff_perk("elites_aura")) } }
		...
		for i = 1, num_units do
			...
			if Unit.alive(unit) then
				for b = 1, num_buffs do
					...
					if
					distance_squared < range_squared and apply and not buff_extension:has_buff_type(buff_to_add) then
		...
		if Unit.alive(owner_unit) then
			...
			if not avatar_talent then return
			end
			local buff_extension = ScriptUnit.extension(owner_unit, "buff_system")
