...
BreedBehaviors.berzerker = { "BTSelector",
	...
	{ "BTHesitateAction", name = "hesitate", condition = "is_alerted",
		...
		{ "BTClanRatFollowAction", name = "follow",
			...
			action_data = ACTIONS.running_attack }, { "BTComboAttackAction", name = "frenzy_attack", condition = "ask_target_before_attacking",
	...
	{ "BTFallbackIdleAction", name = "fallback_idle" }, name = "berzerker" }