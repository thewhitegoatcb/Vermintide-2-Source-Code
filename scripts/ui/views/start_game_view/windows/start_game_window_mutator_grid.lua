...
function StartGameWindowMutatorGrid:on_enter(params, offset)
...
function StartGameWindowMutatorGrid:create_ui_elements(params, offset)
...
function StartGameWindowMutatorGrid:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowMutatorGrid")
	self._item_grid:destroy()
	self._item_grid = nil
end

function StartGameWindowMutatorGrid:update(dt, t)
...
function StartGameWindowMutatorGrid:post_update(dt, t)
	return end

function StartGameWindowMutatorGrid:_is_button_pressed(widget)
...
function StartGameWindowMutatorGrid:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowMutatorGrid:_handle_input(dt, t)
...
function StartGameWindowMutatorGrid:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowMutatorGrid:_update_selected_item_backend_id()
...
function StartGameWindowMutatorGrid:draw(dt)
...
function StartGameWindowMutatorGrid:_update_page_info()
