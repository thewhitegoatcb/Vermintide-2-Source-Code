...
function BTSelector_chaos_exalted_sorcerer_drachenfels:init(...)
	BTSelector_chaos_exalted_sorcerer_drachenfels.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_exalted_sorcerer_drachenfels:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_exalted_sorcerer_drachenfels:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_exalted_sorcerer_drachenfels:add_child(node)
