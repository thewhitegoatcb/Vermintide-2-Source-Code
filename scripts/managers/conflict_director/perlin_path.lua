...
function PerlinPath.make_easy_path(nav_world, main_path, path_length)
...
function PerlinPath.fill_spawns(nav_world, main_path, path_length, density_path, p1, p2)
...
function PerlinPath.populate_spawns(nav_world, main_path, path_length, density_path, p1, p2)

	return end

function PerlinPath.draw_debug_spawns(nav_world, gui, triangles, lookup, area_list)
...
function PerlinPath.make_path(oktave_table, points)
...
function PerlinPath.normalize_path(points, wanted_area_fill_rate)
	local area = 0
