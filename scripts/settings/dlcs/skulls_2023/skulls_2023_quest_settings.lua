...
settings.quest_templates = {
	event_skulls_2023_collect_skulls = { name = "quest_event_skulls_2023_pickups", icon = "quest_book_event_skull", summary_icon = "achievement_symbol_book_event_skull",

		desc = function () return string.format(Localize("quest_event_skulls_2023_pickups_desc"), SKULLS_2023_PICKUP_COUNT) end,
		...
		completed = function (statistics_db, stats_id, quest_key, quest_templates)
			...
			return SKULLS_2023_PICKUP_COUNT <= statistics_db:get_persistent_stat(stats_id, "quest_statistics", stat_name)
		end,
		...
		progress = function (statistics_db, stats_id, quest_key, quest_templates)
			...
			return { count, SKULLS_2023_PICKUP_COUNT }
		end,

		events = { "register_skulls_2023_pickup" },
