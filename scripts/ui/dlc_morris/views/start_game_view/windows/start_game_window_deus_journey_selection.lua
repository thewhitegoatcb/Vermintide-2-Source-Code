...
function StartGameWindowDeusJourneySelection:on_enter(params, offset)
...
function StartGameWindowDeusJourneySelection:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowDeusJourneySelection:create_ui_elements(params, offset)
...
function StartGameWindowDeusJourneySelection:_get_unlocked_journeys()
...
function StartGameWindowDeusJourneySelection:_setup_journey_widgets()
...
function StartGameWindowDeusJourneySelection:_get_first_journey_name()
...
function StartGameWindowDeusJourneySelection:_is_journey_presented(journey_name)
	local active_node_widgets = self._active_node_widgets
	if active_node_widgets then
...
function StartGameWindowDeusJourneySelection:_select_journey(selected_journey_name)
...
function StartGameWindowDeusJourneySelection:_set_presentation_info(journey_name)
...
function StartGameWindowDeusJourneySelection:_setup_grid_navigation()
...
function StartGameWindowDeusJourneySelection:_find_journey_location_in_grid(journey_name_to_find)
...
function StartGameWindowDeusJourneySelection:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowDeusJourneySelection")
	self.ui_animator = nil
	self.parent:set_input_description(nil)
end

function StartGameWindowDeusJourneySelection:update(dt, t)
...
function StartGameWindowDeusJourneySelection:post_update(dt, t)
	return end

function StartGameWindowDeusJourneySelection:_update_modifiers(current_time)
...
function StartGameWindowDeusJourneySelection:_refresh_journey_cycle()
...
function StartGameWindowDeusJourneySelection:_update_modifier_timer(current_time)
	local journey_cycle = self._journey_cycle
...
function StartGameWindowDeusJourneySelection:_update_modifier_god_info(journey_name)
	local journey_cycle = self._journey_cycle
...
function StartGameWindowDeusJourneySelection:_update_journey_god_icons()
	local journey_cycle = self._journey_cycle
...
function StartGameWindowDeusJourneySelection:_on_new_journey_cycle()
...
function StartGameWindowDeusJourneySelection:_update_animations(dt)
...
function StartGameWindowDeusJourneySelection:_is_button_pressed(widget)
	local content = widget.content
...
function StartGameWindowDeusJourneySelection:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function StartGameWindowDeusJourneySelection:_update_selected_journey()
...
function StartGameWindowDeusJourneySelection:_update_selection_from_grid()
...
function StartGameWindowDeusJourneySelection:_update_grid_column(new_column)
...
function StartGameWindowDeusJourneySelection:_update_grid_navigation(column_change)
...
function StartGameWindowDeusJourneySelection:_find_column(column_change)
...
function StartGameWindowDeusJourneySelection:_handle_input(dt, t)
	...
	elseif active_node_widgets then
		for i = 1, #active_node_widgets do
			...
			self._selected_journey_name ~= journey_name then
				self:_play_sound("play_gui_lobby_button_02_mission_act_click")
				self:_select_journey(journey_name)
			end
...
function StartGameWindowDeusJourneySelection:draw(dt)
...
function StartGameWindowDeusJourneySelection:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowDeusJourneySelection:_animate_node_widget(widget, dt)
	local content = widget.content
	local hotspot = content.button_hotspot
