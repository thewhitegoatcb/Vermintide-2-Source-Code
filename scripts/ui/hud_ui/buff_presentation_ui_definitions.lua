...
local scenegraph_definition = {
	...
	presentation_widget_parent = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	presentation_widget = { vertical_alignment = "bottom", parent = "presentation_widget_parent", horizontal_alignment = "left",
	...
	presentation_widget_dragger = { vertical_alignment = "center", parent = "presentation_widget", horizontal_alignment = "center",
...
local text_style = { word_wrap = false, font_size = 52, localize = true, use_shadow = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark_header",
...
local widget_definitions = {
	presentation_widget = { scenegraph_id = "presentation_widget",
		element = {
		...
		content = { texture_frame = "item_frame", texture_icon = "kerillian_waywatcher_movement_speed_on_taking_damage" },
...
animation_definitions.presentation = { { name = "fade_in", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widget, params)
			return end },
	{ name = "fade_out", start_progress = 0.5, end_progress = 0.8,
