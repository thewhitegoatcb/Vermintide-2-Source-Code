...
local min_difficulty_info_size = { 500, 200 }
...
local scenegraph_definition = {
	...
	adventure_background = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1] + 70, 260 }, position = { 0, -75, 1 } },
	...
	game_option_1 = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] }, position = { -15, -105 + game_option_size [2] * 2, 1 } },
	...
	difficulty_stepper = { vertical_alignment = "bottom", parent = "game_option_1", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] }, position = { 17.5, 0, 0 } },
	difficulty_info = { vertical_alignment = "center", parent = "difficulty_stepper", horizontal_alignment = "center", size = min_difficulty_info_size, position = { 500, -10, 0 } },
...
local selector_input_definitions = { { widget_name = "difficulty_stepper",
