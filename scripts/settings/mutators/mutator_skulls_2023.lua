...
local EXTRA_MUTATORS = { "hordes_galore" }



return { description = "description_mutator_skulls_2023", display_name = "display_name_mutator_skulls_2023", icon = "mutator_icon_skulls_2023",
	...
	server_start_function = function (context, data)
		...
		data.mission_giver_unit = Managers.state.unit_spawner:spawn_network_unit("units/hub_elements/empty", "dialogue_node", { dialogue_system = { dialogue_profile = "inn_keeper" } })
