...
function HeroWindowInventory:on_enter(params, offset)
...
function HeroWindowInventory:create_ui_elements(params, offset)
...
function HeroWindowInventory:on_exit(params)
...
function HeroWindowInventory:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowInventory:post_update(dt, t)

	return end

function HeroWindowInventory:_update_animations(dt)
...
function HeroWindowInventory:_is_button_pressed(widget)
...
function HeroWindowInventory:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowInventory:_handle_input(dt, t)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowInventory:_update_page_info()
...
function HeroWindowInventory:_update_crafting_material_panel()
...
function HeroWindowInventory:_update_inventory_items()
	local item_grid = self._item_grid
	local parent = self.parent
...
function HeroWindowInventory:_update_disabled_backend_ids()
	local item_grid = self._item_grid
	local parent = self.parent
...
function HeroWindowInventory:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowInventory:draw(dt)
...
function HeroWindowInventory:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowInventory:_change_category_by_name(name)
...
function HeroWindowInventory:_change_category_by_index(index, force_update)
...
function HeroWindowInventory:change_item_filter(item_filter, change_page)
