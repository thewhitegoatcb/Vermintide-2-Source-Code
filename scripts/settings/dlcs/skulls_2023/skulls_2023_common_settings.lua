...
settings.live_events_packages = {
	skulls_2023 = {
		resource_packages = { "resource_packages/dlcs/skulls_2023_event" },


		dialogues = {
			adventure = { "dialogues/generated/npc_dlc_event_skulls" } } } }
...
settings.dialogue_lookup = { "dialogues/generated/lookup_npc_dlc_event_skulls" }
...
settings.husk_lookup = { "units/mutator/skulls_2023/pup_skull_of_fury" }
...
settings.item_master_list_file_names = { "scripts/settings/dlcs/skulls_2023/item_master_list_skulls_2023" }



settings.weapon_skins_file_names = { "scripts/settings/dlcs/skulls_2023/weapon_skins_skulls_2023" }



settings.pickups = {
	level_events = {
		skulls_2023 = { only_once = true, individual_pickup = false, hide_on_pickup = true, item_description = "skulls_2023_pickup_name", spawn_weighting = 1, debug_pickup_category = "special", pickup_sound_event = "Play_skulls_event_skull_pickup", type = "custom", unit_name = "units/mutator/skulls_2023/pup_skull_of_fury", local_pickup_sound = true, hud_description = "skulls_2023_pickup_name", disallow_bot_pickup = true,
