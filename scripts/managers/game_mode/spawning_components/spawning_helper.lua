...
function SpawningHelper.netpack_consumables(consumables)
	local return_table = { }
...
function SpawningHelper.netpack_additional_items(additional_items)
	local return_table = { }
...
function SpawningHelper.unnetpack_additional_items(encoded_additional_items)
	local decoded_table = { }
...
function SpawningHelper.fill_consumable_table(consumables, inventory_extension)
	for i = 1, #CONSUMABLE_SLOTS do
		local slot_name = CONSUMABLE_SLOTS [i]
...
function SpawningHelper.default_spawn_items(consumables, difficulty_settings, game_mode_settings)
...
function SpawningHelper.fill_ammo_percentage(ammo, inventory_extension, player_unit)
