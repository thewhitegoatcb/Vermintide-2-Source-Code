...
function StartGameWindowWeave:on_enter(params, offset)
...
function StartGameWindowWeave:create_ui_elements(params, offset)
...
function StartGameWindowWeave:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowWeave")
	self.ui_animator = nil
end

function StartGameWindowWeave:update(dt, t)
...
function StartGameWindowWeave:post_update(dt, t)
	return end

function StartGameWindowWeave:draw(dt)
