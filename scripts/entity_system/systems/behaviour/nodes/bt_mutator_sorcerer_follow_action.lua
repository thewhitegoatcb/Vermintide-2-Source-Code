...
function BTMutatorSorcererFollowAction:leave(unit, blackboard, t, reason, destroy)
	local audio_system = Managers.state.entity:system("audio_system")
...
function BTMutatorSorcererFollowAction:run(unit, blackboard, t, dt)
...
function BTMutatorSorcererFollowAction:check_infront(unit, target_unit, action)
...
function BTMutatorSorcererFollowAction:handle_movement_speed_bonus(unit, blackboard, action, current_position)
...
function BTMutatorSorcererFollowAction:play_movement_sound(unit, sound_event)
	local audio_system = Managers.state.entity:system("audio_system")
