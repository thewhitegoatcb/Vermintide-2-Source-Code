...
function HelpScreenUI:init(ingame_ui_context)
...
function HelpScreenUI:_create_ui_elements()
...
function HelpScreenUI:update(dt)
...
function HelpScreenUI:show_help(help_screen_name, input_service_name, on_init)
	if on_init then --[[ Nothing --]]
	end
...
function HelpScreenUI:hide_help()
	self:_close_help()
end

function HelpScreenUI:_set_page(index)
...
function HelpScreenUI:_draw(dt)
...
function HelpScreenUI:_update_input(dt)
...
function HelpScreenUI:_close_help()
