...
function BTJumpSlamImpactAction:init(...)
	BTJumpSlamImpactAction.super.init(self, ...)
end

BTJumpSlamImpactAction.name = "BTJumpSlamImpactAction"

function BTJumpSlamImpactAction:enter(unit, blackboard, t)
...
function BTJumpSlamImpactAction:leave(unit, blackboard, t, reason, destroy)
...
function BTJumpSlamImpactAction:run(unit, blackboard, t, dt)
...
function BTJumpSlamImpactAction:jump_slam_impact(unit, blackboard, t)
...
function BTJumpSlamImpactAction.catapult_players(unit_list, impact_position, radius, speed)
...
function BTJumpSlamImpactAction.catapult_player(target_unit, impact_position, radius, push_speed)
...
local ai_units = { }
function BTJumpSlamImpactAction.impact_damage(attacking_unit, t, radius, stagger_length, impact, damage, damage_type, hit_react_type, max_damage_radius, impact_position)
	...
	for i = 1, num_ai_units do
		...
		if
		ai_unit ~= attacking_unit and HEALTH_ALIVE [ai_unit] then
