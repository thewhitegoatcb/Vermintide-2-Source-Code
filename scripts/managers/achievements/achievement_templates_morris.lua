...
add_journey_complete_challenge(
achievements,
"morris_complete_journey_citadel",
"journey_citadel",
DifficultySettings.normal.rank,
...
if IS_CONSOLE then
	add_journey_complete_challenge(
	achievements,
	"morris_complete_journey_citadel_champion",
	"journey_citadel",
	DifficultySettings.harder.rank,
	"achievement_morris_citadel",
	"morris",
	93,
	...
	add_journey_complete_challenge(
	achievements,
	"morris_complete_journey_citadel_legend",
	"journey_citadel",
	DifficultySettings.hardest.rank,
	"achievement_morris_citadel",
	"morris",
	94,
	...
	add_opened_shrine_challenge(achievements, "morris_opened_shrines_swap_weapon", { DEUS_CHEST_TYPES.swap_melee, DEUS_CHEST_TYPES.swap_ranged }, 30, nil, nil, 99, nil)


	add_opened_shrine_challenge(achievements, "morris_opened_shrines_upgrade", { DEUS_CHEST_TYPES.upgrade }, 20, nil, nil, 100, nil)
	add_opened_shrine_challenge(achievements, "morris_opened_shrines_power_up", { DEUS_CHEST_TYPES.power_up }, 30, nil, nil, 101, nil)
end

add_journey_dominant_god_complete_challenge(
achievements,
"morris_complete_journey_dominant_god_nurgle",
DEUS_GOD_TYPES.NURGLE,
DifficultySettings.normal.rank,
...
add_journey_dominant_god_complete_challenge(
achievements, "morris_complete_journey_dominant_god_tzeentch",
DEUS_GOD_TYPES.TZEENTCH,
DifficultySettings.normal.rank,
...
add_journey_dominant_god_complete_challenge(
achievements, "morris_complete_journey_dominant_god_belakor",
DEUS_GOD_TYPES.BELAKOR,
DifficultySettings.normal.rank,
"achievement_morris_tzeentch",
"belakor",
99,
...
local difficulties = { "harder", "hardest", "cataclysm" }





local icon_by_hero = { we = "achievement_morris_kerillian_", bw = "achievement_morris_sienna_", wh = "achievement_morris_victor_", dr = "achievement_morris_bardin_", es = "achievement_morris_markus_" }
...
for _, hero in ipairs(SPProfilesAbbreviation) do
	for _, journey_name in ipairs(AvailableJourneyOrder) do
		for difficulty_index, difficulty in ipairs(difficulties) do
			...
			add_hero_journey_complete_challenge(
			achievements,
			id,
			hero,
			journey_name,
