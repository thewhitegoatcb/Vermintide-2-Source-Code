...
local RPCS = { "rpc_necromancer_passive_spawn_pet" }
...
function PassiveAbilityNecromancer:init(extension_init_context, unit, extension_init_data, ability_init_data)
...
function PassiveAbilityNecromancer:extensions_ready(world, unit)
...
function PassiveAbilityNecromancer:destroy()
...
function PassiveAbilityNecromancer:_on_talents_changed(unit, talent_extension)
...
function PassiveAbilityNecromancer:_register_events()
...
function PassiveAbilityNecromancer:_unregister_events()
	local event_manager = Managers.state.event
...
function PassiveAbilityNecromancer:update(dt, t)
	if self._is_server then
...
function PassiveAbilityNecromancer:_update_pets_server()
...
function PassiveAbilityNecromancer:spawn_pets(num_pets, template_name)
...
function PassiveAbilityNecromancer:spawn_pet(breed_name, relative_pos, template_name)
...
local ignored_life_essence_breeds = { pet_skeleton_with_shield = true, pet_skeleton_dual_wield = true, pet_skeleton = true, pet_skeleton_armored = true }
...
function PassiveAbilityNecromancer:event_on_killed(killing_blow, breed_killed, breed_attacker, attacker_unit, killed_unit)
...
function PassiveAbilityNecromancer:_kill_all_pets_server()
...
function PassiveAbilityNecromancer:rpc_necromancer_passive_spawn_pet(channel_id, breed_id, relative_pos, template_id)
...
function PassiveAbilityNecromancer:_update_spawning()
