...
local function owner_is_local_player(owner_unit)
	if DEDICATED_SERVER then return false
	end
...
settings.buff_templates = {
	grudge_mark_health = {
		buffs = { { multiplier = 0.5, name = "grudge_mark_health", stat_buff = "max_health" },




			{ remove_buff_func = "ai_update_max_health", name = "grudge_mark_health_update", apply_buff_func = "ai_update_max_health" } } },
	...
	grudge_mark_elite_health = {
		buffs = { { multiplier = 2, name = "grudge_mark_health", stat_buff = "max_health" },
	...
	grudge_mark_damage = {
		buffs = { { multiplier = 0.2, name = "grudge_mark_damage", stat_buff = "damage_dealt" } } },
	...
	grudge_mark_stagger_distance_resistance = {
		buffs = { { multiplier = -0.7, name = "grudge_mark_stagger_distance_resistance", stat_buff = "stagger_distance" } } },
	...
	grudge_mark_warping = {
		buffs = { { proc_cooldown = 10, name = "grudge_mark_warping", buff_func = "random_teleport_ai", event = "on_damage_taken", proc_chance = 0.1, max_teleport_distance = 8, min_teleport_distance = 3, find_valid_pos_attempts = 5, min_dist_from_players = 3 } } },
	...
	grudge_mark_unstaggerable = {
		buffs = { { apply_buff_func = "make_stagger_immune", name = "grudge_mark_unstaggerable" } } },
	...
	grudge_mark_raging = {
		buffs = { { buff_to_add = "grudge_mark_raging_buff", name = "grudge_mark_raging", update_frequency = 25, update_func = "add_buff", update_start_delay = 5 } } },
	...
	grudge_mark_raging_buff = { activation_sound_3p = true, activation_sound = "enemy_grudge_raging",


		buffs = { { multiplier = 1, name = "grudge_mark_raging_buff", stat_buff = "damage_dealt", duration = 10,





				particles = { { orphaned_policy = "stop", first_person = false, third_person = true, effect = "fx/cw_khorne_boss", continuous = true, destroy_policy = "stop" } } } } },
	...
	grudge_mark_vampiric = {
		buffs = { { name = "grudge_mark_vampiric", multiplier = 2, buff_func = "ai_heal_on_damage_dealt", event = "on_damage_dealt", bonus = 0 } } },
	...
	grudge_mark_ranged_immune = {
		buffs = { { name = "grudge_mark_ranged_immune",
	...
	grudge_mark_periodic_shield = {
		buffs = { { buff_to_add = "grudge_mark_periodic_shield_buff", name = "grudge_mark_periodic_shield", update_frequency = 20, update_func = "add_buff", update_start_delay = 0 } } },
	...
	grudge_mark_periodic_shield_buff = { deactivation_sound = "enemy_grudge_shield_end", activation_sound_3p = true, activation_sound = "enemy_grudge_shield_start",



		buffs = { { duration = 5, name = "grudge_mark_periodic_shield_buff",


				perks = { buff_perks.invulnerable },

				particles = { { orphaned_policy = "stop", first_person = false, third_person = true, effect = "fx/cw_shield", continuous = true, destroy_policy = "stop" } } } } },
	...
	grudge_mark_intangible = {
		buffs = { { num_mirrors = 3, name = "grudge_mark_intangible", update_func = "ai_spawn_mirror_images", update_dialogue_delay = 1, update_frequency_time = 45, update_start_delay = 5 } } },
	...
	grudge_mark_intangible_mirror = {
		buffs = { { multiplier = -1, name = "grudge_mark_intangible_mirror_damage", stat_buff = "damage_dealt", remove_buff_func = "remove_intangible_mirror_damage" },
			...
			{ multiplier = -10, name = "grudge_mark_intangible_mirror_health_stat", stat_buff = "max_health" },




			{ remove_buff_func = "ai_update_max_health", name = "grudge_mark_intangible_mirror_health_update", apply_buff_func = "ai_update_max_health" } } },
	...
	grudge_mark_crippling_blow = {
		buffs = { { event = "on_damage_dealt", name = "grudge_mark_crippling_blow", buff_to_add = "grudge_mark_crippling_blow_debuff", buff_func = "ai_add_buff_on_damage_dealt" } } },
	...
	grudge_mark_crippling_blow_debuff = {
		...
		buffs = { { name = "grudge_mark_crippling_blow_debuff_flow_event", flow_event = "sfx_vce_struggle", max_stacks = 1, duration = 5, apply_buff_func = "first_person_flow_event" },
			...
			{ update_func = "update_action_lerp_movement_buff", multiplier = 0.3, name = "grudge_mark_crippling_blow_slow_run", icon = "grudge_mark_crippling_debuff", priority_buff = true, remove_buff_func = "remove_action_lerp_movement_buff", apply_buff_func = "apply_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_movement", lerp_time = 0.1, debuff = true, max_stacks = 1, duration = 5,
				...
				sfx = { activation_sound = "enemy_grudge_crippling_hit" } },


			{ update_func = "update_charging_action_lerp_movement_buff", multiplier = 0.3, name = "grudge_mark_crippling_blow_slow_crouch", remove_buff_func = "remove_action_lerp_movement_buff", apply_buff_func = "apply_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_crouch_movement", lerp_time = 0.1, max_stacks = 1, duration = 5,
			...
			{ update_func = "update_charging_action_lerp_movement_buff", multiplier = 0.3, name = "grudge_mark_crippling_blow_slow_walk", remove_buff_func = "remove_action_lerp_movement_buff", apply_buff_func = "apply_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_walk_movement", lerp_time = 0.1, max_stacks = 1, duration = 5,
			...
			{ multiplier = 0.3, name = "grudge_mark_crippling_blow_jump_debuff", duration = 5, max_stacks = 1, remove_buff_func = "remove_movement_buff", apply_buff_func = "apply_movement_buff",
			...
			{ multiplier = 0.5, name = "grudge_mark_crippling_blow_dodge_speed_debuff", duration = 5, max_stacks = 1, remove_buff_func = "remove_movement_buff", apply_buff_func = "apply_movement_buff",
			...
			{ multiplier = 0.5, name = "grudge_mark_crippling_blow_dodge_distance_debuff", duration = 5, max_stacks = 1, remove_buff_func = "remove_movement_buff", apply_buff_func = "apply_movement_buff",
	...
	grudge_mark_crushing_blow = {
		buffs = { { buff_to_add = "grudge_mark_crushing_blow_debuff", name = "grudge_mark_crushing_blow", buff_func = "ai_crushing_blow", event = "on_damage_dealt",




				perks = { buff_perks.ai_unblockable } },

			{ remove_buff_func = "ai_remove_hit_sfx", name = "grudge_mark_crushing_blow_sfx", apply_buff_func = "ai_add_hit_sfx", hit_sfx_name = "enemy_grudge_crushing_hit" } } },
	...
	grudge_mark_crushing_blow_debuff = {
		buffs = { { duration = 8, name = "grudge_mark_crushing_blow_debuff", stat_buff = "max_fatigue", debuff = true, max_stacks = 20, refresh_durations = true, icon = "troll_vomit_debuff", bonus = -1 } } },
	...
	grudge_mark_regeneratig = {
		buffs = { { frequency = 1, name = "grudge_mark_regeneratig", part_healed_of_max_heath = 0.02, buff_func = "ai_delay_regen", event = "on_damage_taken", update_func = "ai_health_regen_update", on_hit_delay = 3 } } },
	...
	grudge_mark_periodic_curse_aura = {
		buffs = { { buff_to_add = "grudge_mark_curse", name = "grudge_mark_periodic_curse_aura", update_frequency = 0.5, time_between_curses = 2, update_start_delay = 0, max_distance = 4, update_func = "apply_curse_to_nearby_players", sound_on_enter = "enemy_grudge_cursed_enter",
				...
				particles = { { orphaned_policy = "stop", first_person = false, third_person = true, effect = "fx/gm_cursed_aoe", continuous = true, destroy_policy = "stop",
	...
	grudge_mark_curse = { deactivation_sound = "enemy_grudge_cursed_exit", activation_sound = "enemy_grudge_cursed_damage",


		buffs = { { icon = "grudge_mark_cursed_debuff", name = "grudge_mark_curse", stat_buff = "health_curse", debuff = true, max_stacks = 20, duration = 5, refresh_durations = true, bonus = -0.05 } } },
	...
	grudge_mark_commander = {
		buffs = { { update_frequency = 40, name = "grudge_mark_commander", update_func = "trigger_terror_event", update_start_delay = 8,





				faction_terror_events = { default = "grudge_mark_commander_terror_event_skaven", skaven = "grudge_mark_commander_terror_event_skaven", beastmen = "grudge_mark_commander_terror_event_beastmen", chaos = "grudge_mark_commander_terror_event_chaos" } } } },
	...
	grudge_mark_frenzy = {
		buffs = { { buff_to_add = "grudge_mark_frenzy_handler", name = "grudge_mark_frenzy", stacking_buff = "grudge_mark_frenzy_stack", buff_func = "add_frenzy_handler", event = "on_damage_taken", remove_buff_func = "remove_frenzy_handlers" } } },
	...
	grudge_mark_frenzy_handler = {
		buffs = { { buff_to_add = "grudge_mark_frenzy_stack", name = "grudge_mark_frenzy_handler", blocker_buff = "grudge_mark_frenzy_buff", buff_func = "add_frenzy_stack", event = "on_melee_hit", apply_buff_func = "add_extra_frenzy_stack" } } },
	...
	grudge_mark_frenzy_stack = {
		buffs = { { reset_on_max_stacks = true, name = "grudge_mark_frenzy_stack", icon = "grudge_mark_frenzy_debuff", max_stacks = 10, refresh_durations = true, debuff = true, on_max_stacks_func = "add_remove_buffs", duration = 3,
				...
				max_stack_data = {
					buffs_to_add = { "grudge_mark_frenzy_buff" } } } } },
	...
	grudge_mark_frenzy_buff = { deactivation_sound = "enemy_grudge_frenzy_end",

		buffs = { { buff_to_add = "grudge_mark_frenzy_buff", name = "grudge_mark_frenzy_buff", icon = "grudge_mark_frenzy_debuff", buff_func = "add_buff", event = "on_melee_hit", refresh_durations = true, apply_buff_func = "apply_frenzy_func", remove_buff_func = "remove_frenzy_func", max_stacks = 1, duration = 5 },
			...
			{ name = "grudge_mark_frenzy_buff_attack_speed", multiplier = 0.25, stat_buff = "attack_speed", duration = 5, max_stacks = 1, refresh_durations = true },
			...
			{ refresh_durations = true, name = "grudge_mark_frenzy_buff_move_speed", multiplier = 1.25, max_stacks = 1, remove_buff_func = "remove_movement_buff", apply_buff_func = "apply_movement_buff", duration = 5,
			...
			{ refresh_durations = true, multiplier = 0.2, stat_buff = "power_level_melee", buff_func = "deus_reckless_swings_buff_on_hit", event = "on_melee_hit", damage_to_deal = 10, name = "grudge_mark_frenzy_buff_reckless_swings", is_non_lethal = true, max_stacks = 1, duration = 5 } } },
	...
	grudge_mark_shockwave_attacks = {
		buffs = { { event = "minion_attack_used", name = "grudge_mark_shockwave_attacks", buff_func = "grudge_mark_shockwave" } } },
	...
	grudge_mark_ignore_death_aura = {
		buffs = { { buff_to_add = "grudge_mark_ignore_death_buff", name = "grudge_mark_ignore_death_aura", remove_buff_func = "grudge_mark_ignore_death_aura_cleanup", radius = 4, update_func = "grudge_mark_ignore_death_aura_update", update_frequency = 1 } } },
	...
	grudge_mark_ignore_death_buff = {
		buffs = { { name = "grudge_mark_ignore_death_buff",
...
settings.buff_function_templates = {
	make_stagger_immune = function (unit, buff, params)
		if ALIVE [unit] then
			...
			if blackboard then
				local stagger_immunity = { health_threshold = 0 }
	...
	ai_spawn_mirror_images = function (unit, buff, params)
		...
		local function nav_callback()
			if ALIVE [unit] then
				...
				local enhancements = { { "grudge_mark_intangible_mirror", no_attribute = true, name = "mirror_base" } }
...
settings.proc_functions = {
	...
	ai_add_buff_on_damage_dealt = function (owner_unit, buff, params, world, param_order)
		...
		if ALIVE [target_unit] and damage_amount > 0 then
			...
			if is_server() then
				buff_extension:add_buff(buff_name, { attacker_unit = target_unit })
