...
function DevBackendWatermarkView:init(world)
	self._world = world
...
function DevBackendWatermarkView:_create_ui_elements()
...
function DevBackendWatermarkView:update(dt)
	if DO_RELOAD then
		DO_RELOAD = false
		self:_create_ui_elements()
	end
...
function DevBackendWatermarkView:_draw(dt)
...
function DevBackendWatermarkView:destroy()
