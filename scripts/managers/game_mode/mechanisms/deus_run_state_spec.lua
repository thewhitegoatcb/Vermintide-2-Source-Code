...
local spec = {
	server = {
		run_node_key = { default_value = "start", type = "string",


			composite_keys = { } },

		run_ended = { default_value = false, type = "boolean",


			composite_keys = { } },

		completed_level_count = { default_value = 0, type = "number",


			composite_keys = { } },

		traversed_nodes = { type = "table",
		...
		blessings_with_buyer = { type = "table",
		...
		peer_initialized = { default_value = false, type = "boolean",


			composite_keys = { peer_id = true } },



		profile_initialized = { default_value = false, type = "boolean",


			composite_keys = { peer_id = true, career_index = true, profile_index = true, local_player_id = true } },
		...
		cursed_levels_completed = { default_value = 0, type = "number",
		...
		cursed_chests_purified = { default_value = 0, type = "number",
		...
		coin_chests_collected = { default_value = 0, type = "number",
		...
		spawned_once = { default_value = false, type = "boolean",
		...
		soft_currency = { default_value = 0, type = "number",


			composite_keys = { peer_id = true, local_player_id = true } },




		health_percentage = { type = "number", default_value = 1,
		...
		health_state = { default_value = "alive", type = "string",
		...
		melee_ammo = { type = "number", default_value = 1,
		...
		ranged_ammo = { type = "number", default_value = 1,
		...
		healthkit = { default_value = "", type = "string",
		...
		potion = { default_value = "", type = "string",
		...
		grenade = { default_value = "", type = "string",
		...
		slot_melee = { type = "string", default_value = "",
		...
		slot_ranged = { type = "string", default_value = "",
		...
		twitch_vote = { default_value = "", type = "string",


			composite_keys = { } },

		persisted_score = { type = "table",
		...
		ground_coins_picked_up = { default_value = 0, type = "number",


			composite_keys = { } },

		monster_coins_picked_up = { default_value = 0, type = "number",


			composite_keys = { } },

		melee_swap_chests_used = { type = "table",
		...
		ranged_swap_chests_used = { type = "table",
		...
		upgrade_chests_used = { type = "table",
		...
		power_up_chests_used = { default_value = 0, type = "number",


			composite_keys = { } },

		coins_earned = { default_value = 0, type = "number",


			composite_keys = { } },

		coins_spent = { default_value = 0, type = "number",


			composite_keys = { } },

		host_migration_count = { default_value = 0, type = "number",


			composite_keys = { } },

		arena_belakor_node = { default_value = "", type = "string",


			composite_keys = { } },

		seen_arena_belakor_node = { default_value = false, type = "boolean",
		...
		granted_non_party_end_of_level_power_ups = { type = "table",
	...
	peer = {
		telemetry_id = { default_value = "", type = "string",


			composite_keys = { } },

		player_level = { default_value = 1, type = "number",


			composite_keys = { } },

		player_name = { default_value = "Player", type = "string",


			composite_keys = { } },

		player_frame = { default_value = "default", type = "string",
