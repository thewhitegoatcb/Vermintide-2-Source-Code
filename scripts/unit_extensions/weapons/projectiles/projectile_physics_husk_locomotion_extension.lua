...
function ProjectilePhysicsHuskLocomotionExtension:init(extension_init_context, unit, extension_init_data)
	self.unit = unit
...
function ProjectilePhysicsHuskLocomotionExtension:destroy()
	return end

function ProjectilePhysicsHuskLocomotionExtension:update(unit, input, dt, context, t)
...
function ProjectilePhysicsHuskLocomotionExtension:is_at_rest()
	return Actor.is_sleeping(self.physics_actor)
end

function ProjectilePhysicsHuskLocomotionExtension:teleport(position, rotation)
...
function ProjectilePhysicsHuskLocomotionExtension:bounce()
	return end

function ProjectilePhysicsHuskLocomotionExtension:stop()
	self.stopped = true
	Actor.put_to_sleep(self.physics_actor)
end

function ProjectilePhysicsHuskLocomotionExtension:drop()
	self.dropped = true
	Actor.set_velocity(self.physics_actor, Vector3(0, 0, 0))
end

function ProjectilePhysicsHuskLocomotionExtension:has_stopped()
	return self.stopped
end