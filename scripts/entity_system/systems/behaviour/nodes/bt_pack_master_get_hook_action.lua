...
function BTPackMasterGetHookAction:leave(unit, blackboard, t, reason, destroy)
	if reason == "done" then
...
function BTPackMasterGetHookAction:run(unit, blackboard, t, dt)
...
function BTPackMasterGetHookAction:find_hidden_cover(position, player_center_pos, blackboard)
