...
local scenegraph_definition = {
	...
	screen = { vertical_alignment = "center", parent = "root", horizontal_alignment = "center",
	...
	background_fit = { vertical_alignment = "center", scale = "fit", horizontal_alignment = "center",
		size = { 1920, 1080 },
	...
	disclaimer = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	input_background = { vertical_alignment = "center", parent = "background_fit", horizontal_alignment = "center",



		position = { 0, 0, 100 } },

	foreground = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	esrb = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",

		size = { 1200, 576 } },



	warhammer = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",

		size = { 774, 417 } },



	bld_splash_partners = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	autodesk_splash = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_umbra = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_wwise = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_simplygon = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_dobly = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_dts = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	partner_splash_pixeldiet = { vertical_alignment = "bottom", parent = "partner_splash_dts", horizontal_alignment = "left",
	...
	partner_splash_nordic_games = { vertical_alignment = "bottom", parent = "partner_splash_dts", horizontal_alignment = "center",
	...
	partner_splash_black = { vertical_alignment = "center", parent = "bld_splash_partners", horizontal_alignment = "center",
	...
	texts = { parent = "background" },


	beta_disclaimer = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	return {
		element = {
			passes = { { style_id = "foreground", scenegraph_id = "foreground", pass_type = "rect",
				...
				{ style_id = "input_style", pass_type = "texture", texture_id = "material_name", content_id = "input_texture_content",
		...
		style = {
			...
			input_style = { vertical_alignment = "center", horizontal_alignment = "center",


				texture_size = input.input_texture_size,
				offset = input.input_texture_offset or { 0, 0, 0 },
...
local function create_disclaimer_widget(input)
	return { scenegraph_id = "disclaimer",
		element = {
			passes = { { style_id = "foreground", scenegraph_id = "foreground", pass_type = "rect" },
				...
				{ pass_type = "rect", style_id = "divider" },



				{ texture_id = "texture_id", style_id = "texture_style", pass_type = "texture" },




				{ style_id = "header", pass_type = "text", text_id = "header_text" },
				...
				{ style_id = "continue", pass_type = "text", text_id = "continue", scenegraph_id = "screen",
		...
		content = { continue = "press_any_key_to_continue", timer = 0, ready = false,
			text = input.text,
		...
		style = {
			...
			texture_style = { vertical_alignment = "top", horizontal_alignment = "left",
			...
			header = { word_wrap = false, localize = true, font_size = 32, horizontal_alignment = "left", vertical_alignment = "top", dynamic_font_size = true, font_type = "hell_shark_header",
			...
			text = { font_type = "hell_shark_header", font_size = 28, localize = true, word_wrap = true, horizontal_alignment = "left", vertical_alignment = "top",
			...
			continue = { vertical_alignment = "bottom", word_wrap = false, localize = true, font_type = "hell_shark", font_size = 32, horizontal_alignment = "right",
...
local splash_content = { { video_name = "video/fatshark_splash", sound_start = "Play_fatshark_logo", scenegraph_id = "splash_video", type = "video", material_name = "fatshark_splash", sound_stop = "Stop_fatshark_logo" },
	...
	{ scenegraph_id = "warhammer", type = "texture", axis = 2, time = 3, text_vertical_alignment = "bottom", spacing = 5, text_horizontal_alignment = "center", pixel_perfect = false, dynamic_font = false, direction = 1, texts_scenegraph_id = "texts", font_type = "hell_shark", localize = true, font_size = 13, material_name = "warhammer",




		texts = { "gw_legal_1", "gw_legal_2", "gw_legal_3", "gw_legal_4" },
	...
	{ texts_scenegraph_id = "texts", scenegraph_id = "bld_splash_partners", time = 3, type = "texture", font_size = 13, pixel_perfect = false, partner_splash = true, text_horizontal_alignment = "center", dynamic_font = false, spacing = 5, text_vertical_alignment = "bottom", font_type = "hell_shark", localize = true,
		...
		texture_materials = { "autodesk_splash", "umbra", "wwise", "simplygon", "dolby", "dts" },
		...
		texture_scenegraph_ids = { "autodesk_splash", "partner_splash_umbra", "partner_splash_wwise", "partner_splash_simplygon", "partner_splash_dobly", "partner_splash_dts" } },
	...
	{ text = "splash_seizure_disclaimer", forced = true, texture_id = "vermintide_2_logo", type = "disclaimer", time = 3, header_text = "splash_seizure_disclaimer_header",



		texture_size = { 300, 168 } } }
...
if Development.parameter("use_beta_mode") or script_data.settings.use_beta_mode then
	if IS_XB1 then
		...
		splash_content [#splash_content + 1] = { input_scenegraph_id = "input_background", product_id = "ADAA6515-8206-49E5-B34C-405244800B46", type = "beta_end", scenegraph_id = "background_fit", texts_scenegraph_id = "texts", input_material_name = "storepage_button", forced = true, music_name = "Play_menu_screen_music", material_name = "beta_end_overlay",



			input_texture_size = is_xbox_one_x and { 1776, 346 } or { 888, 173 },
			input_texture_offset = is_xbox_one_x and { 550, -260 } or { 275, -130 },
	...
	elseif IS_PS4 then
		...
		splash_content [#splash_content + 1] = { scenegraph_id = "background", type = "texture", axis = 2, time = 10, text_vertical_alignment = "center", forced = true, text_horizontal_alignment = "center", spacing = 5, dynamic_font = false, direction = 1, pixel_perfect = false, texts_scenegraph_id = "texts", font_type = "hell_shark", localize = false,




			texts = { "PRE-RELEASE SOFTWARE", "***", "This game is in a pre-release stage of development. This means ", "that some parts of the game, including online features", "(like chat and multiplayer), might not function as expected (or might", "not function at all). The game might even crash. Because this is", "a pre-release game, Fatshark does not commit", "to providing customer support for the game." },
	...
	elseif IS_WINDOWS then
		...
		if is_beta then
			splash_content [#splash_content + 1] = { scenegraph_id = "background", type = "texture", axis = 2, time = 10, text_vertical_alignment = "center", forced = true, text_horizontal_alignment = "center", spacing = 5, dynamic_font = false, direction = 1, pixel_perfect = false, texts_scenegraph_id = "texts", font_type = "hell_shark", localize = false, font_size = 36,
...
function SplashView:init(input_manager, world)
	if IS_PS4 then
	...
	self.ui_renderer = UIRenderer.create(world,
...
function SplashView:_next_splash(override_skip)
...
function SplashView:_update_video(gui, dt)
...
function SplashView:_update_texture(gui, dt)
...
function SplashView:_update_disclaimer(gui, dt)
	local w, h = Gui.resolution()
	local timer = self._current_splash_data.timer
	local texts = self._current_splash_data.texts
	local total_time = self._current_splash_data.time
...
function SplashView:_update_beta_end(gui, dt)
	local w, h = Gui.resolution()
	local timer = self._current_splash_data.timer
	local texts = self._current_splash_data.texts
	local total_time = self._current_splash_data.time
	...
	for i = 1, 8 do
		...
		if
		pad_controller and pad_controller.pressed(pad_controller.button_index("y")) then
...
if IS_CONSOLE then
	function SplashView:_wait_for_allow_console_skip()
...
function SplashView:set_index(index)
	self._current_index = index
	self:_next_splash()
end

function SplashView:_create_ui_elements()
...
function SplashView:update(dt)

	if IS_WINDOWS and
	self._fram_skip_hack < 1 then
...
if IS_CONSOLE then
	function SplashView:allow_console_skip()
		self._allow_console_skip = true
	end

	function SplashView:_get_console_input()
		...
		for i = 1, 8 do
			...
			local pad_controller = rawget(_G, pad_name)
			if
			pad_controller and pad_controller.any_pressed() then
				return true
			end
		end


		if IS_XB1 and GameSettingsDevelopment.allow_keyboard_mouse and (
		Keyboard.any_pressed() or Mouse.any_pressed()) then
			return true
		end
...
function SplashView:render()
	return end

function SplashView:video_complete()
...
function SplashView:is_completed()
