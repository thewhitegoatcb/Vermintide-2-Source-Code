return { screenspace_effect_name = "fx/screenspace_statue_veins/screenspace_statue_veins", display_name = "display_name_mutator_escort", pickup_name = "mutator_statue_01", end_effect_required_duration = 4.5, icon = "mutator_icon_escort", description = "description_mutator_escort", screenspace_end_effect_name = "fx/screenspace_statue_veins/screenspace_statue_veins_fade_out", buildup_sound_global_parameter = "mutator_escort_buildup", time_until_explosion = 10,
	...
	server_start_function = function (context, data)
		data.server = { escort_unit_spawned = false }
	...
	client_start_function = function (context, data)
		...
		data.client = { escort_unit_spawned = false,
