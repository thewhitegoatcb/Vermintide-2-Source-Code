...
settings.entity_extensions = { "scripts/unit_extensions/wizards/ward_extension", "scripts/unit_extensions/wizards/shockwave_spell_extension" }




settings.entity_system_params = {
	ward_extension = { system_class_name = "WardSystem", system_name = "ward_system",


		extension_list = { "WardExtension" } },

	shockwave_spell_extension = { system_class_name = "ExtensionSystemBase", system_name = "shockwave_spell_extension",


		extension_list = { "ShockwaveSpellExtension" } } }



settings.systems = { "scripts/entity_system/systems/ward/ward_system" }



settings.unit_extension_templates = { "scripts/settings/dlcs/wizards/wizards_extension_templates_part_2" }



settings.statistics_definitions = { "scripts/managers/backend/statistics_definitions_wizards_part_2" }



settings.statistics_lookup = { "tower_skulls", "tower_wall_illusions", "tower_invisible_bridge", "tower_enable_guardian_of_lustria", "tower_note_puzzle", "tower_created_all_potions", "tower_time_challenge" }
...
settings.network_go_types = { "pickup_projectile_wizards_barrel" }
...
settings.projectile_units = {
	vfx_scripted_projectile_unit = { dummy_linker_unit_name = "units/weapons/projectile/end_fight_tower/magic_missile_tower", transient_package_loader_ignore = true, projectile_unit_name = "units/weapons/projectile/end_fight_tower/magic_missile_tower" },




	sofia_vfx_scripted_projectile_unit = { dummy_linker_unit_name = "units/weapons/projectile/end_fight_tower/sofia_magic_missile_tower", transient_package_loader_ignore = true, projectile_unit_name = "units/weapons/projectile/end_fight_tower/sofia_magic_missile_tower" },




	olesya_vfx_scripted_projectile_unit = { dummy_linker_unit_name = "units/weapons/projectile/end_fight_tower/olesya_magic_missile_tower", transient_package_loader_ignore = true, projectile_unit_name = "units/weapons/projectile/end_fight_tower/olesya_magic_missile_tower" } }
...
settings.projectiles = {
	vfx_scripted_projectile_unit = { projectile_units_template = "vfx_scripted_projectile_unit", radius = 0.2, linear_dampening = 0, angle = 0, only_one_impact = true, gravity_settings = "gaze_fireball", projectile_unit_template_name = "vfx_scripted_projectile_unit", impact_template_name = "vfx_impact", impact_collision_filter = "filter_physics_projectile" } }
...
settings.effects = { "fx/ethereal_skulls_teleport_01" }




settings.unlock_settings = {
	wizards_part_2 = { class = "AlwaysUnlocked" } }
...
settings.game_object_initializers = {
	vfx_scripted_projectile_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
		...
		local data_table = { sphere_radius = 0.5, only_one_impact = true,
...
settings.game_object_extractors = {
	vfx_scripted_projectile_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
		...
		local extension_init_data = {
			...
			projectile_impact_system = { only_one_impact = true, sphere_radius = 0.5,
...
settings.ai_group_templates = {
	...
	ethereal_skulls = {
		...
		try_spawn_group = function (state, interactor_unit)
			...
			if state ~= "picked_up" or last_state ~= "spawned" then return end
		...
		add_group_members = function (state, interactor_unit, group_id, group_size, num_to_spawn)
			...
			local group_data = { template = "ethereal_skulls",
				id = group_id,
				size = group_size }
