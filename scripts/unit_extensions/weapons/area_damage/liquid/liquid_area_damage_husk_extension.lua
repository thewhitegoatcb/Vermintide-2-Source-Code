...
function LiquidAreaDamageHuskExtension:init(extension_init_context, unit, extension_init_data)
...
function LiquidAreaDamageHuskExtension:_get_rotation_from_navmesh(position)
...
function LiquidAreaDamageHuskExtension:add_damage_blob(blob_id, position, is_filled)
	local fx_id = nil
	...
	self._blobs [blob_id] = { fx_id = fx_id, position = Vector3Box(position), full = is_filled }
...
function LiquidAreaDamageHuskExtension:set_damage_blob_filled(blob_id)
...
function LiquidAreaDamageHuskExtension:remove_damage_blob(blob_id)
	return end

function LiquidAreaDamageHuskExtension:update(unit, input, dt, context, t)
...
function LiquidAreaDamageHuskExtension:destroy()
	local world = self._world
...
function LiquidAreaDamageHuskExtension:get_source_attacker_unit()
