...
local scenegraph_definition = {
	...
	loadout_background = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { window_size [1], 120 }, position = { 0, 0, 1 } },
	loadout_divider = { vertical_alignment = "top", parent = "loadout_background", horizontal_alignment = "center", size = { window_size [1], 0 }, position = { 0, 0, 10 } },
	loadout_grid = { vertical_alignment = "center", parent = "loadout_background", horizontal_alignment = "center", size = { window_size [1], 80 }, position = { 0, 0, 1 } } }
...
local category_settings = { { wield = true, name = "melee", display_name = "Melee Weapons", item_filter = "slot_type == melee and item_rarity ~= magic", hero_specific_filter = true,
	...
	{ wield = true, name = "ranged", display_name = "Ranged Weapons", item_filter = "slot_type == ranged and item_rarity ~= magic", hero_specific_filter = true,
	...
	{ display_name = "Jewellery", name = "jewellery", item_filter = "slot_type == trinket or slot_type == ring or slot_type == necklace", hero_specific_filter = true,
		...
		item_types = { "ring", "necklace", "trinket" },
