...
function BTTargetRageAction:init(...)
...
function BTTargetRageAction:enter(unit, blackboard, t)
...
function BTTargetRageAction:leave(unit, blackboard, t, reason, destroy)
...
function BTTargetRageAction:run(unit, blackboard, t, dt)
...
function BTTargetRageAction:anim_cb_move(unit, blackboard, action)
