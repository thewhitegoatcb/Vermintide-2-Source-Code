...
function BTSelector_storm_vermin_champion:init(...)
	BTSelector_storm_vermin_champion.super.init(self, ...)
	self._children = { }
end

function BTSelector_storm_vermin_champion:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_storm_vermin_champion:run(unit, blackboard, t, dt)
...
function BTSelector_storm_vermin_champion:add_child(node)
