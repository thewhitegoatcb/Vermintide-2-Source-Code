DamageBlobTemplates = {
	...
	templates = {
		warpfire = { fx_separation_dist = 0.8, time_of_life = 5, fx_max_height = 5, sfx_name_start = "Play_enemy_warpfire_thrower_fire_hit_ground", sfx_name_stop_remains = "Stop_enemy_stormfiend_fire_ground_loop", nav_cost_map_cost_type = "warpfire_thrower_warpfire", blob_life_time = 4, buff_template_name = "warpfire_thrower_ground_base", blob_radius = 1, fx_name_rim = "fx/wpnfx_warp_fire_remains_rim", apply_buff_to_player = true, blob_separation_dist = 2, init_function = "warpfire_thrower_fire_init", fx_name_filled = "fx/chr_warp_fire_flamethrower_remains_01", apply_buff_to_ai = true, create_blobs = true, fx_size_variable = "warp_fire_flamethrower_remains_size", update_function = "warpfire_thrower_fire_update", use_nav_cost_map_volumes = true, buff_template_type = "stormfiend_warpfire_ground", sfx_name_stop = "Stop_enemy_warpfire_thrower_fire_hit_ground", fx_max_radius = 5, sfx_name_start_remains = "Play_enemy_stormfiend_fire_ground_loop",
			...
			immune_breeds = { chaos_troll = true, chaos_spawn = true, skaven_warpfire_thrower = true, skaven_rat_ogre = true, chaos_plague_wave_spawner = true, skaven_stormfiend = true } },
		...
		warpfire_vs = { fx_separation_dist = 0.8, time_of_life = 5, fx_max_height = 5, sfx_name_start = "Play_enemy_warpfire_thrower_fire_hit_ground", sfx_name_stop_remains = "Stop_enemy_stormfiend_fire_ground_loop", nav_cost_map_cost_type = "warpfire_thrower_warpfire", blob_life_time = 4, buff_template_name = "warpfire_thrower_ground_base", blob_radius = 1, fx_name_rim = "fx/wpnfx_warp_fire_remains_rim", apply_buff_to_player = true, blob_separation_dist = 2, init_function = "warpfire_thrower_fire_init_vs", fx_name_filled = "fx/chr_warp_fire_flamethrower_remains_01", apply_buff_to_ai = true, create_blobs = false, fx_size_variable = "warp_fire_flamethrower_remains_size", update_function = "warpfire_thrower_fire_update_vs", use_nav_cost_map_volumes = true, buff_template_type = "stormfiend_warpfire_ground", sfx_name_stop = "Stop_enemy_warpfire_thrower_fire_hit_ground", fx_max_radius = 5, sfx_name_start_remains = "Play_enemy_stormfiend_fire_ground_loop",
	...
	warpfire_thrower_fire_init_vs = function (self, t)
		local warpfire_thrower_unit = self._source_unit
		if Unit.alive(warpfire_thrower_unit) then
