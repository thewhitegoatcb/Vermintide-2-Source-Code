...
PlayerUnitDamageSettings.stun.damage_types_with_stun_property = { slashing = false, blunt = false, cutting = false, piercing = false }
PlayerUnitDamageSettings.stun.damage_types_without_stun_property = { slashing = false, blunt = false, cutting = false, piercing = false }
