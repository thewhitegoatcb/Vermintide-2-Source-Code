...
local function generate_non_refreshable_potion_template(potion_name)
	...
	weapon_template.actions = {
		action_one = {
			default = { damage_window_start = 0.05, anim_end_event = "attack_finished", ammo_usage = 1, kind = "buff", damage_window_end = 0.2, weapon_action_hand = "left", block_pickup = true, uninterruptible = true, anim_event = "attack_heal", total_time = 1.3,
		...
		action_instant_drink_potion = {
			...
			instant_drink = { damage_window_end = 0.2, ammo_usage = 1, anim_end_event = "attack_finished", kind = "buff", damage_window_start = 0.05, weapon_action_hand = "left", interaction_priority = 2, block_pickup = true, uninterruptible = true, anim_event = "attack_heal", auto_validate_on_gamepad = true, total_time = 1.3,
				...
				condition_func = function (attacker_unit) return true end } },
	...
	weapon_template.ammo_data = { ammo_hand = "left", destroy_when_out_of_ammo = true, max_ammo = 1, ammo_per_clip = 1, reload_time = 0, ignore_ammo_pickup = true }
