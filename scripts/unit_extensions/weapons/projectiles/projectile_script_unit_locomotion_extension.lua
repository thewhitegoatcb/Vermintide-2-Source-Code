...
function ProjectileScriptUnitLocomotionExtension:init(extension_init_context, unit, extension_init_data)
	self.unit = unit
...
function ProjectileScriptUnitLocomotionExtension:destroy()
	return end

function ProjectileScriptUnitLocomotionExtension:bounce(hit_position, hit_direction, hit_normal)
...
function ProjectileScriptUnitLocomotionExtension:update(unit, input, _, context, t)
...
function ProjectileScriptUnitLocomotionExtension:_get_new_position_multiple_targetpoints(time_lived, dt)
...
function ProjectileScriptUnitLocomotionExtension:_get_new_position(time_lived, dt)
	local speed = self.speed
...
function ProjectileScriptUnitLocomotionExtension:_get_new_rotation(direction, time_lived)
...
function ProjectileScriptUnitLocomotionExtension:rotate_projectile_away_from_target(new_position, position)
...
function ProjectileScriptUnitLocomotionExtension:_unit_set_position_rotation(unit, position, rotation)
	Unit.set_local_rotation(unit, 0, rotation)
	Unit.set_local_position(unit, 0, position)
end

function ProjectileScriptUnitLocomotionExtension:moved_this_frame()
	return self.moved
end

function ProjectileScriptUnitLocomotionExtension:current_velocity()
	return self.velocity:unbox()
end

function ProjectileScriptUnitLocomotionExtension:current_position()
	return self._position:unbox()
end

function ProjectileScriptUnitLocomotionExtension:current_rotation()
	return self._rotation:unbox()
end

function ProjectileScriptUnitLocomotionExtension:last_position()
	return self._last_position:unbox()
end

function ProjectileScriptUnitLocomotionExtension:stop()
	self.stopped = true
end

function ProjectileScriptUnitLocomotionExtension:has_stopped()
	return self.stopped
end