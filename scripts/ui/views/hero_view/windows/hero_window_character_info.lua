...
function HeroWindowCharacterInfo:on_enter(params, offset)
...
function HeroWindowCharacterInfo:create_ui_elements(params, offset)
...
function HeroWindowCharacterInfo:on_exit(params)
	print("[HeroViewWindow] Exit Substate HeroWindowCharacterInfo")
	self.ui_animator = nil
end

function HeroWindowCharacterInfo:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCharacterInfo:post_update(dt, t)

	return end

function HeroWindowCharacterInfo:_update_animations(dt)
...
function HeroWindowCharacterInfo:set_focus(focused)
	self._focused = focused

end

function HeroWindowCharacterInfo:_update_loadout_sync()
...
function HeroWindowCharacterInfo:_has_hero_level_changed()
...
function HeroWindowCharacterInfo:_update_experience_presentation()
...
function HeroWindowCharacterInfo:_update_hero_portrait_frame()
...
function HeroWindowCharacterInfo:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCharacterInfo:draw(dt)
...
function HeroWindowCharacterInfo:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowCharacterInfo:_create_portrait_frame_widget(frame_settings_name, portrait_texture, level_text)
...
function HeroWindowCharacterInfo:_get_portrait_frame()
	local profile_index = self.profile_index
	local career_index = self.career_index
