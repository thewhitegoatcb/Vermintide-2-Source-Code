...
function BTNinjaSkulkAction:init(...)
...
function BTNinjaSkulkAction:enter(unit, blackboard, t)
...
function BTNinjaSkulkAction:leave(unit, blackboard, t, reason, destroy)
...
local close_range = 8
function BTNinjaSkulkAction:run(unit, blackboard, t, dt)
	local locomotion = blackboard.locomotion_extension
...
local segment_list = { }
local relative_positions = { 0.4, 0.5, -4, 0.5, 0, 1.5 }
function BTNinjaSkulkAction:check_free_los(unit, blackboard, data)
...
function BTNinjaSkulkAction:try_dodge_pos(unit, blackboard, pos, dodge_pos)
...
function BTNinjaSkulkAction:dodge(unit, blackboard, dodge_vec, aim_vec)
...
function BTNinjaSkulkAction:in_crosshairs(unit, blackboard, t, data)
...
function BTNinjaSkulkAction:get_fallback_goal(unit, blackboard)
...
function BTNinjaSkulkAction:set_goal_at_target(unit, blackboard)
...
function BTNinjaSkulkAction:get_new_goal(unit, blackboard)
...
function BTNinjaSkulkAction:anim_cb_dodge_finished(unit, params)
	blackboard.anim_cb_dodge_finished = nil
end


function BTNinjaSkulkAction:debug(unit, blackboard)
	if blackboard.skulk_pos then
		local pos = blackboard.skulk_pos:unbox()
