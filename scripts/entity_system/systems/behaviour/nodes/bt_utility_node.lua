...
function BTUtilityNode:ready(lua_node)
...
function BTUtilityNode:enter(unit, blackboard, t)
	return end

function BTUtilityNode:leave(unit, blackboard, t, reason, destroy)
...
function BTUtilityNode:run(unit, blackboard, t, dt)
...
function BTUtilityNode:add_child(node)
