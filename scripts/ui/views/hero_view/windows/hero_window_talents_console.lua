...
function HeroWindowTalentsConsole:on_enter(params, offset)
...
function HeroWindowTalentsConsole:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowTalentsConsole:on_exit(params)
...
function HeroWindowTalentsConsole:_inject_additional_scenegraph_definitions(scenegraph_definition)
...
function HeroWindowTalentsConsole:create_ui_elements(params, offset)
...
function HeroWindowTalentsConsole:_initialize_talents()
	local career_name = self._career_name
...
function HeroWindowTalentsConsole:_input_service()
...
function HeroWindowTalentsConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowTalentsConsole:post_update(dt, t)

	return end

function HeroWindowTalentsConsole:_update_talent_sync(initialize)
	self:_populate_talents_by_hero(initialize)
	self:_populate_career_info(initialize)
end

function HeroWindowTalentsConsole:_update_animations(dt)
...
function HeroWindowTalentsConsole:_is_button_pressed(widget)
...
function HeroWindowTalentsConsole:_is_button_released(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowTalentsConsole:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function HeroWindowTalentsConsole:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter and not hotspot.is_selected
end

function HeroWindowTalentsConsole:_handle_gamepad_input(dt, t)
...
function HeroWindowTalentsConsole:_handle_input(dt, t)
	local parent = self.parent
...
function HeroWindowTalentsConsole:_set_talent_selected(row, column)
...
function HeroWindowTalentsConsole:draw(dt, t)
...
function HeroWindowTalentsConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowTalentsConsole:_populate_talents_by_hero(initialize)
	self:_clear_talents()
...
function HeroWindowTalentsConsole:_clear_talents()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_set_talent_focused(row, column)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_can_press_talent(row, column)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_is_talent_pressed()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_is_talent_hovered()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_is_disabled_talent_hovered()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalentsConsole:_populate_career_info(initialize)
	local ui_renderer = self.ui_renderer
	local ui_scenegraph = self._ui_scenegraph
...
function HeroWindowTalentsConsole:_setup_additional_career_info(career_settings)
	if career_settings.additional_ui_info_file then
...
function HeroWindowTalentsConsole:_animate_pulse(target, target_index, from, to, speed)
...
function HeroWindowTalentsConsole:_set_talent_tooltip(talent, selected, locked)
	local widgets_by_name = self._widgets_by_name
	...
	elseif not selected then --[[ Nothing --]]
	end
