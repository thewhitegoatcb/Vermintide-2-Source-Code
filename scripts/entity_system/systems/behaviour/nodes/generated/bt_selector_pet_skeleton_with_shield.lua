...
function BTSelector_pet_skeleton_with_shield:init(...)
	BTSelector_pet_skeleton_with_shield.super.init(self, ...)
	self._children = { }
end

function BTSelector_pet_skeleton_with_shield:leave(unit, blackboard, t, reason)
...
function BTSelector_pet_skeleton_with_shield:add_child(node)
