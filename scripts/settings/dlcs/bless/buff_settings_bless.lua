...
settings.buff_templates = {
	...
	victor_priest_activated_ability_invincibility = { activation_sound = "career_ability_priest_buff_shield",

		buffs = { { apply_buff_func = "victor_priest_on_career_skill_applied", name = "victor_priest_activated_ability_invincibility", icon = "victor_priest_activated_ability", update_func = "victor_priest_on_career_skill_update", refresh_durations = true, remove_buff_func = "victor_priest_on_career_skill_removed", priority_buff = true, max_stacks = 1, duration = 5, reapply_buff_func = "victor_priest_on_career_skill_applied",
	...
	victor_priest_activated_ability_nuke = { deactivation_sound = "career_ability_priest_buildup_stop", activation_sound = "career_ability_priest_buildup",


		buffs = { { duration = 5, name = "victor_priest_activated_ability_nuke", apply_buff_func = "victor_priest_activated_ability_nuke_start", reapply_buff_func = "victor_priest_activated_ability_nuke_start", max_stacks = 1, refresh_durations = true, priority_buff = true, remove_buff_func = "victor_priest_activated_ability_nuke" } } },
	...
	victor_priest_activated_ability_invincibility_improved = { activation_sound = "career_ability_priest_buff_shield",

		buffs = { { apply_buff_func = "victor_priest_on_career_skill_applied", name = "victor_priest_activated_ability_invincibility", icon = "victor_priest_activated_ability", update_func = "victor_priest_on_career_skill_update", refresh_durations = true, remove_buff_func = "victor_priest_on_career_skill_removed", priority_buff = true, max_stacks = 1, duration = 8, reapply_buff_func = "victor_priest_on_career_skill_applied",
	...
	victor_priest_activated_ability_nuke_improved = { deactivation_sound = "career_ability_priest_buildup_stop", activation_sound = "career_ability_priest_buildup",


		buffs = { { duration = 8, name = "victor_priest_activated_ability_nuke", apply_buff_func = "victor_priest_activated_ability_nuke_start", reapply_buff_func = "victor_priest_activated_ability_nuke_start", max_stacks = 1, refresh_durations = true, priority_buff = true, remove_buff_func = "victor_priest_activated_ability_nuke" } } },
	...
	victor_priest_activated_noclip_improved = {
		buffs = { { stagger_distance = 1, name = "victor_priest_activated_noclip_improved", refresh_durations = true, push_cooldown = 1, remove_buff_func = "victor_priest_activated_noclip_remove", apply_buff_func = "victor_priest_activated_noclip_apply", push_radius = 1.5, duration = 8, icon = "victor_priest_6_1", max_stacks = 1, update_func = "victor_priest_activated_noclip_update", update_frequency = 0.1,
	...
	victor_priest_nuke_dot = {
		buffs = { { duration = 5, name = "victor_priest_nuke_dot", apply_buff_func = "start_dot_damage", update_start_delay = 0.7, time_between_dot_damages = 0.7, damage_type = "burninating", damage_profile = "burning_dot", update_func = "apply_dot_damage",
	...
	victor_priest_book_buff_attack_speed = {
		buffs = { { multiplier = 0.1, name = "victor_priest_book_buff_attack_speed", stat_buff = "attack_speed", max_stacks = 1, icon = "victor_witchhunter_activated_ability_guaranteed_crit_self_buff" },
			...
			{ max_stacks = 1, name = "victor_priest_book_buff_crit", stat_buff = "critical_strike_chance", bonus = 0.05 } } },
	...
	victor_priest_book_buff_heal_on_damage = {
		buffs = { { max_stacks = 1, name = "victor_priest_book_buff_heal_on_damage", buff_func = "victor_priest_book_buff_heal_on_kill_proc", event = "on_kill", icon = "bardin_ranger_increased_melee_damage_on_no_ammo" } } },
	...
	victor_priest_book_buff_stamina = {
		buffs = { { max_stacks = 1, name = "victor_priest_book_buff_block_cost", stat_buff = "block_cost", multiplier = -0.3 },





			{ max_stacks = 1, name = "victor_priest_book_buff_stamina", stat_buff = "max_fatigue", bonus = 6 },





			{ max_stacks = 1, name = "victor_priest_book_buff_push_angle", stat_buff = "block_angle", multiplier = 0.5 } } },
	...
	victor_priest_passive_aftershock = { deactivation_sound = "career_priest_fury_stop", activation_sound = "career_priest_fury_start",


		buffs = { { buff_to_add = "victor_priest_passive_smite", name = "victor_priest_passive_aftershock", max_stacks = 1, buff_func = "add_buff_to_hit_enemy", event = "on_damage_dealt", icon = "victor_priest_passive", buff_to_add_upgraded = "victor_priest_passive_smite_upgraded" } } },
	...
	victor_priest_passive_smite = {
		buffs = { { damage_multiplier = 0.2, name = "victor_priest_passive_smite", duration = 0.3, damage_profile = "light_push", remove_buff_func = "victor_priest_activated_ability_aftershock_update" } } },
	...
	victor_priest_passive_smite_upgraded = {
		buffs = { { damage_multiplier = 0.4, name = "victor_priest_passive_smite", duration = 0.8, damage_profile = "medium_push", remove_buff_func = "victor_priest_activated_ability_aftershock_update" } } } }
...
settings.proc_functions = {
		...
		if ALIVE [owner_unit] then
			...
			if current_temporary_health then
				...
				if damage_taken <= 0 then
					local data = { temp_hp = true, t = t, damage_taken = inital_damage_taken }
					table.insert(buff.damage_table, data)
				elseif damage_taken == inital_damage_taken then
					local data = { temp_hp = false, t = t, damage_taken = inital_damage_taken }
					table.insert(buff.damage_table, data)
				else
					local data = { temp_hp = true, t = t, damage_taken = current_temporary_health }
					table.insert(buff.damage_table, data)
					data = { temp_hp = false, t = t, damage_taken = damage_taken }
					table.insert(buff.damage_table, data)
				end
			end
	...
	add_buff_on_num_targets_hit = function (owner_unit, buff, params)
		...
		if ALIVE [owner_unit] then
			...
			local buff_extension = ScriptUnit.extension(owner_unit, "buff_system")
			if
			block_buff and buff_extension:has_buff_type(block_buff) then
				return
			end
				...
				if damage_store_buff then
					...
					if buff.heal_amount > 0 then
						params = {
							...
							external_optional_value = { temp_hp = temp_hp_tot, perm_hp = perm_hp_tot } }
