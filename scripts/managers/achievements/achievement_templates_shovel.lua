...
achievements.shovel_sac_vent = { display_completion_ui = true, name = "achv_sac_vent_name", required_career = "bw_necromancer", icon = "assistive_sacrifice", required_dlc = "shovel",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, SAC_VENT_TARGET }
	end,
...
achievements.shovel_sac_low = { display_completion_ui = true, name = "achv_sac_low_name", required_career = "bw_necromancer", icon = "easy_come_easy_go", required_dlc = "shovel",
...
achievements.shovel_fast_generate = { display_completion_ui = true, name = "achv_fast_generate_name", required_career = "bw_necromancer", icon = "unlimited_power", required_dlc = "shovel",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		local instance = { time = t, overcharge = percentage_gained }
...
achievements.shovel_command_elite = { display_completion_ui = true, name = "achv_command_elite_name", required_career = "bw_necromancer", icon = "dead_reckoning", required_dlc = "shovel",
...
achievements.shovel_skeleton_attack_big = { always_run = true, name = "achv_skeleton_attack_big_name", display_completion_ui = true, required_career = "bw_necromancer", icon = "sally_forth", required_dlc = "shovel",
...
achievements.shovel_skeleton_defend = { always_run = true, name = "achv_skeleton_defend_name", display_completion_ui = true, required_career = "bw_necromancer", icon = "wall_of_bone", required_dlc = "shovel",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		local t = Managers.time:time("game")
		local instance = { time = t, damage = damage_amount }
		table.insert(instances, instance)
...
achievements.shovel_many_skeletons = { display_completion_ui = true, name = "achv_many_skeletons_name", required_career = "bw_necromancer", icon = "deaths_company", required_dlc = "shovel",
	...
	events = { "on_controlled_unit_added" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_melee_balefire = { display_completion_ui = true, name = "achv_melee_balefire_name", required_career = "bw_necromancer", icon = "flames_forever", required_dlc = "shovel",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, MELEE_BALEFIRE_TARGET }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_fast_staff_attack = { always_run = true, name = "achv_fast_staff_attack_name", display_completion_ui = true, required_career = "bw_necromancer", icon = "mistress_of_the_stave", required_dlc = "shovel",
...
achievements.shovel_staff_balefire = { always_run = true, name = "achv_staff_balefire_name", display_completion_ui = true, required_career = "bw_necromancer", icon = "still_fiery_darlings", required_dlc = "shovel",
...
achievements.shovel_big_suck = { display_completion_ui = true, name = "achv_big_suck_name", required_career = "bw_necromancer", icon = "drained", required_dlc = "shovel",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, BIG_SUCK_TARGET }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_big_cleave = { display_completion_ui = true, name = "achv_big_cleave_name", required_career = "bw_necromancer", icon = "reaping_time", required_dlc = "shovel",
...
achievements.shovel_headshot_scythe = { display_completion_ui = true, name = "achv_headshot_scythe_name", required_career = "bw_necromancer", icon = "ripe_harvest", required_dlc = "shovel",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, HEADSHOT_SCYTHE_TARGET }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_staff_gandalf = { display_completion_ui = true, name = "achv_staff_gandalf_name", desc = "achv_staff_gandalf_desc", required_career = "bw_necromancer", icon = "whoosh_clang", required_dlc = "shovel",
	...
	events = { "register_kill", "on_hit", "necromancer_staff_gandalf_delayed_check" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_skeleton_balefire = { always_run = true, name = "achv_skeleton_balefire_name", display_completion_ui = true, required_career = "bw_necromancer", icon = "unrestful_bonefire", required_dlc = "shovel",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, SKELETON_BALEFIRE_TARGET }
	end,
	completed = function (statistics_db, stats_id, template_data)
...
achievements.shovel_keep_skeletons_alive = { display_completion_ui = true, name = "achv_keep_skeletons_alive_name", required_career = "bw_necromancer", icon = "the_soul_of_the_party", required_dlc = "shovel",
	...
	events = { "on_controlled_unit_added", "on_controlled_unit_removed", "on_round_started", "register_completed_level" },
	completed = function (statistics_db, stats_id, template_data)
...
local all_challenges = { "shovel_complete_all_helmgart_levels_bw_necromancer", "shovel_complete_25_missions_bw_necromancer", "shovel_sac_vent", "shovel_fast_generate", "shovel_command_elite", "shovel_skeleton_attack_big", "shovel_skeleton_defend", "shovel_many_skeletons", "shovel_melee_balefire", "shovel_fast_staff_attack", "shovel_staff_balefire", "shovel_big_suck", "shovel_big_cleave", "shovel_headshot_scythe", "shovel_skeleton_balefire", "shovel_keep_skeletons_alive" }
