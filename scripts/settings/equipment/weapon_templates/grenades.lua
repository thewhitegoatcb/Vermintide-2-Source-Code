...
weapon_template_frag.ammo_data = { ammo_hand = "right", destroy_when_out_of_ammo = true, max_ammo = 1, ammo_per_clip = 1, reload_time = 0, ignore_ammo_pickup = true }
...
weapon_template_frag.pickup_data = { pickup_name = "impact_grenade" }
...
weapon_template_fire_dot.actions = {
	action_one = {
		...
		throw = { uninterruptible = true, anim_end_event = "attack_finished", hide_weapon_after_fire = true, kind = "charged_projectile", alert_sound_range_hit = 10, fire_time = 0.3, is_impact_type = false, block_pickup = true, throw_time = 0.13, ammo_usage = 1, forced_charge_level = 1, speed = 2000, throw_offset_length_in_target_direction = 0.1, anim_event = "attack_throw", total_time = 0.5,
...
weapon_template_fire_dot.ammo_data = { ammo_hand = "right", destroy_when_out_of_ammo = true, max_ammo = 1, ammo_per_clip = 1, reload_time = 0 }
...
weapon_template_fire_dot.pickup_data = { pickup_name = "dot_grenade" }
