...
StateSplashScreen.packages_to_load = { "resource_packages/title_screen", "resource_packages/menu", "resource_packages/platform_specific/platform_specific", "resource_packages/menu_assets", "resource_packages/loading_screens/loading_screen_default" }
...
function StateSplashScreen:on_enter()
	...
	if LEVEL_EDITOR_TEST then
		...
		local skip_splash_screen_parameters = { "auto_host_level", "auto_join", "skip_splash", "attract_mode", "benchmark_mode" }
...
local esrb_regions = { CA = true, US = true, MX = true }




function StateSplashScreen:_is_in_esrb_region()
...
function StateSplashScreen:setup_esrb_logo()
...
function StateSplashScreen:update_esrb_logo(dt, t)
	local total_time = 5
...
function StateSplashScreen:cb_splashes_loaded()
...
function StateSplashScreen:setup_world()
...
if IS_WINDOWS or IS_XB1 then
	function StateSplashScreen:setup_input()
...
function StateSplashScreen:setup_splash_screen_view()
...
function StateSplashScreen:next_state()
	if not self:packages_loaded() or not self.wanted_state then
		return
	end

	if IS_WINDOWS and
	not self.debug_setup then
...
function StateSplashScreen:unload_packages()
...
function StateSplashScreen:load_packages()
...
function StateSplashScreen:packages_loaded()
...
function StateSplashScreen:cb_fade_in_done()
	self.wanted_state = StateTitleScreen
end

function StateSplashScreen:on_exit(application_shutdown)
