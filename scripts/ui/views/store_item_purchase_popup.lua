local window_size = { 800, 750 }
local inner_window_size = { window_size [1] - 158, window_size [2] - 158 }

local animation_definitions = { }
animation_definitions.approved = { { name = "product_in", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "text_in", start_progress = 0, end_progress = 0.3,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "stamp", start_progress = 0.1, end_progress = 0.6,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "frame_glow", start_progress = 0.4, end_progress = 1.9,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "fade_out", start_progress = 1.8, end_progress = 2.2,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			return end },
	{ name = "blur_progress_out", start_progress = 1.9, end_progress = 2.3,
...
animation_definitions.on_enter = { { name = "fade_in", start_progress = 0, end_progress = 0.3,
...
local scenegraph_definition = {
	...
	purchase_overlay = { scale = "fit", size = { 1920, 1080 }, position = { 0, 0, 900 } },
	purchase_background = { vertical_alignment = "center", parent = "purchase_overlay", horizontal_alignment = "center", size = window_size, position = { 0, 0, 1 } },
	purchase_background_fade = { vertical_alignment = "center", parent = "purchase_background", horizontal_alignment = "center", size = inner_window_size, position = { 0, 0, 1 } },
	background_edge_top = { vertical_alignment = "top", parent = "purchase_background", horizontal_alignment = "center", size = { window_size [1], 79 }, position = { 0, 0, 2 } },
	background_edge_bottom = { vertical_alignment = "bottom", parent = "purchase_background", horizontal_alignment = "center", size = { window_size [1], 79 }, position = { 0, 0, 2 } },
	background_edge_left = { vertical_alignment = "center", parent = "purchase_background", horizontal_alignment = "left", size = { 79, window_size [2] }, position = { 0, 0, 2 } },
	background_edge_right = { vertical_alignment = "center", parent = "purchase_background", horizontal_alignment = "right", size = { 79, window_size [2] }, position = { 0, 0, 2 } },

	corner_bottom_left = { vertical_alignment = "bottom", parent = "purchase_background", horizontal_alignment = "left", size = { 385, 381 }, position = { -25, -25, 3 } },
	corner_bottom_right = { vertical_alignment = "bottom", parent = "purchase_background", horizontal_alignment = "right", size = { 385, 381 }, position = { 29, -23, 3 } },

	corner_top_left = { vertical_alignment = "top", parent = "purchase_background", horizontal_alignment = "left", size = { 385, 381 }, position = { -27, 23, 3 } },
	corner_top_right = { vertical_alignment = "top", parent = "purchase_background", horizontal_alignment = "right", size = { 385, 381 }, position = { 27, 25, 3 } },

	purchase_confirmation_approved = { vertical_alignment = "center", parent = "purchase_overlay", horizontal_alignment = "center", size = { 0, 0 }, position = { 0, 100, 1 } },
	purchase_confirmation_declined = { vertical_alignment = "center", parent = "purchase_overlay", horizontal_alignment = "center", size = { 256, 512 }, position = { 0, 0, 1 } },
	purchase_confirmation_loading = { vertical_alignment = "center", parent = "purchase_overlay", horizontal_alignment = "center", size = { 314, 33 }, position = { 0, 0, 1 } },

	item_name_text = { vertical_alignment = "top", parent = "purchase_background_fade", horizontal_alignment = "center", size = { inner_window_size [1] - 30, 60 }, position = { 0, -80, 2 } },
	item_name_text_edge_top = { vertical_alignment = "top", parent = "item_name_text", horizontal_alignment = "center", size = { inner_window_size [1] - 30, 4 }, position = { 0, 4, 1 } },
	item_name_text_edge_bottom = { vertical_alignment = "bottom", parent = "item_name_text", horizontal_alignment = "center", size = { inner_window_size [1] - 30, 4 }, position = { 0, -4, 1 } },
	item_type_text = { vertical_alignment = "top", parent = "item_name_text", horizontal_alignment = "center", size = { inner_window_size [1] - 30, 50 }, position = { 0, -65, 2 } },

	purchase_button = { vertical_alignment = "bottom", parent = "purchase_background_fade", horizontal_alignment = "center", size = { 350, 68 }, position = { 0, 55, 10 } },
	currency_background = { vertical_alignment = "bottom", parent = "purchase_button", horizontal_alignment = "center", size = { 250, 100 }, position = { 0, 90, 0 } },
	purchase_item_root = { vertical_alignment = "top", parent = "item_name_text_edge_bottom", horizontal_alignment = "center", size = { 0, 0 }, position = { 0, -290, 2 } },

	currency_current = { vertical_alignment = "top", parent = "currency_background", horizontal_alignment = "right", size = { 180, 20 }, position = { -10, -20, 2 } },
	currency_cost = { vertical_alignment = "top", parent = "currency_background", horizontal_alignment = "right", size = { 180, 20 }, position = { -10, -50, 2 } },
	currency_cost_edge = { vertical_alignment = "bottom", parent = "currency_background", horizontal_alignment = "right", size = { 210, 2 }, position = { -10, 40, 2 } },
	currency_balance = { vertical_alignment = "bottom", parent = "currency_background", horizontal_alignment = "right", size = { 180, 20 }, position = { -10, 10, 2 } },
	currency_icon = { vertical_alignment = "center", parent = "currency_cost_edge", horizontal_alignment = "left", size = { 64, 64 }, position = { -32, 0, 1 } },

	close_button = { vertical_alignment = "bottom", parent = "purchase_background", horizontal_alignment = "center", size = { 260, 42 }, position = { 0, -80, 1 } } }


local item_type_text_style = { use_shadow = true, upper_case = false, localize = true, font_size = 28, horizontal_alignment = "center", vertical_alignment = "bottom", dynamic_font_size = true, font_type = "hell_shark_header",
...
local item_name_text_style = { word_wrap = true, upper_case = false, localize = false, use_shadow = true, font_size = 42, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = false, font_type = "hell_shark_header",
...
local static_widget_definitions = {
	purchase_overlay = UIWidgets.create_simple_rect("purchase_overlay", { 50, 10, 10, 10 }) }
...
local widget_definitions_by_state = {
	popup = {
		...
		background_edge_top = UIWidgets.create_tiled_texture("background_edge_top", "store_frame_side_01", { 128, 79 }),
		background_edge_bottom = UIWidgets.create_tiled_texture("background_edge_bottom", "store_frame_side_03", { 128, 79 }),
		background_edge_left = UIWidgets.create_tiled_texture("background_edge_left", "store_frame_side_04", { 79, 128 }),
		background_edge_right = UIWidgets.create_tiled_texture("background_edge_right", "store_frame_side_02", { 79, 128 }),

		purchase_background = UIWidgets.create_tiled_texture("purchase_background", "menu_frame_bg_03", { 256, 256 }),
		purchase_background_fade = UIWidgets.create_simple_texture("options_window_fade_01", "purchase_background_fade"),

		corner_bottom_left = UIWidgets.create_simple_rotated_texture("store_frame_corner", 0, { 192.5, 190.5 }, "corner_bottom_left"),
		corner_bottom_right = UIWidgets.create_simple_rotated_texture("store_frame_corner", -math.pi / 2, { 192.5, 190.5 }, "corner_bottom_right"),
		corner_top_left = UIWidgets.create_simple_rotated_texture("store_frame_corner", math.pi / 2, { 192.5, 190.5 }, "corner_top_left"),
		corner_top_right = UIWidgets.create_simple_rotated_texture("store_frame_corner", math.pi, { 192.5, 190.5 }, "corner_top_right"),
	...
	poll_result = {
		loading_icon = { scenegraph_id = "purchase_confirmation_loading",
			element = {
				passes = { { style_id = "background", pass_type = "texture", texture_id = "background",
					...
					{ style_id = "glow", pass_type = "texture", texture_id = "glow",
			...
			content = { background = "loading_title_divider_background", fade_out = false, glow = "loading_title_divider" },
	...
	approved = {
		approved = { scenegraph_id = "purchase_confirmation_approved",
			element = {
				passes = { { style_id = "text", pass_type = "text", text_id = "text" },
					...
					{ texture_id = "frame_write_mask", style_id = "frame_write_mask", pass_type = "texture" },



					{ pass_type = "rect", style_id = "title_divider" } } },





			content = { frame = "menu_frame_16_white", frame_write_mask = "diagonal_center_fade_write_mask", description_text = "inventory_item_added", text = "menu_store_purchase_confirmation_approved" },
			...
			style = {
				frame = { horizontal_alignment = "center", vertical_alignment = "center", masked = true,
				...
				frame_write_mask = { vertical_alignment = "center", horizontal_alignment = "center",


					texture_size = { 520, 440 },
					color = { 255, 255, 255, 255 },
					offset = { 0, 0, 2 } },

				title_divider = { vertical_alignment = "center", horizontal_alignment = "center",
				...
				text = { vertical_alignment = "center", upper_case = true, localize = true, horizontal_alignment = "center", font_size = 52, font_type = "hell_shark_header",
				...
				text_shadow = { vertical_alignment = "center", upper_case = true, localize = true, horizontal_alignment = "center", font_size = 52, font_type = "hell_shark_header",
				...
				description_text = { font_size = 20, upper_case = true, localize = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark",
				...
				description_text_shadow = { font_size = 20, upper_case = true, localize = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark",
...
function StoreItemPurchasePopup:init(ingame_ui, product, state)
...
function StoreItemPurchasePopup:_setup_renderers()
...
function StoreItemPurchasePopup:_destroy_renderers()
...
function StoreItemPurchasePopup:_create_gamepad_input_description(input_service)
	local generic_input_actions = { { input_action = "confirm", priority = 2, description_text = "menu_store_purchase_button_unlock" },
...
function StoreItemPurchasePopup:_change_state(state)
	if self._state then
...
function StoreItemPurchasePopup:_set_fullscreen_effect_enable_state(enabled, progress, world)
...
function StoreItemPurchasePopup:is_complete()
	return self._state == "exit"
end

function StoreItemPurchasePopup:is_aborted()
	return self._state == "aborted"
end

function StoreItemPurchasePopup:destroy()
...
function StoreItemPurchasePopup:_create_ui_elements(params)
...
function StoreItemPurchasePopup:_draw(input_service, dt)
...
function StoreItemPurchasePopup:update(input_service, dt, t)
...
function StoreItemPurchasePopup:_update_animations(dt)
...
function StoreItemPurchasePopup:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot or content.hotspot
	return hotspot.on_hover_enter
end

function StoreItemPurchasePopup:_is_button_pressed(widget)
	local content = widget.content
	local hotspot = content.button_hotspot or content.hotspot
...
function StoreItemPurchasePopup:_play_sound(event)
	WwiseWorld.trigger_event(self._wwise_world, event)
end

function StoreItemPurchasePopup:_destroy_product_widget(widget, product)
	local content = widget.content
...
function StoreItemPurchasePopup:_create_material_instance(gui, new_material_name, template_material_name, reference_name)
...
function StoreItemPurchasePopup:_set_material_diffuse(gui, material_name, texture_path)
...
function StoreItemPurchasePopup:_load_texture_package(package_name, reference_name, callback)
...
function StoreItemPurchasePopup:_is_unique_reference_to_material(reference_name)
	local cloned_materials_by_reference = self._cloned_materials_by_reference
...
function StoreItemPurchasePopup:_unload_texture_by_reference(reference_name)
	local loaded_package_names = self._loaded_package_names
	local cloned_materials_by_reference = self._cloned_materials_by_reference
...
function StoreItemPurchasePopup:_unload_all_textures()
	local loaded_package_names = self._loaded_package_names
...
function StoreItemPurchasePopup:_calculate_discount_textures(widget, discount)
	local content = widget.content
	local style = widget.style
	...
	for i = 1, length do
		...
		local size = { texture_settings.size [1], texture_settings.size [2] }
...
function StoreItemPurchasePopup:_start_transition_animation(key, animation_name, optional_widgets)
	local params = {
...
function StoreItemPurchasePopup:_popup_on_enter()
...
function StoreItemPurchasePopup:_create_popup_widget(product, scenegraph_id, display_as_owned)
	local product = self._product
	local product_id = product.product_id
	local item = product.item

	local masked = false
	local item_size = { 260, 220 }
...
function StoreItemPurchasePopup:_popup_update(input_service, dt, t)
...
function StoreItemPurchasePopup:_backend_result_callback(success, items)
...
local item_backgrounds_by_rarirty = { common = "store_thumbnail_bg_common", promo = "store_thumbnail_bg_promo", plentiful = "store_thumbnail_bg_plentiful", rare = "store_thumbnail_bg_rare", exotic = "store_thumbnail_bg_exotic", magic = "store_thumbnail_bg_magic", unique = "store_thumbnail_bg_unique" }
...
function StoreItemPurchasePopup:_populate_item_widget(widget, item, product_id, display_as_owned)
	...
	if item_type == "hat" or item_type == "skin" or item_type == "weapon_skin" then
		...
		if rarity and rarity ~= "default" then type_tag_icon = type_tag_icon .. "_" .. rarity
		end else
	...
	if package_available then
		...
		return end content.icon = inventory_icon Application.warning("Icon package not accessable for product_id: (%s) and texture_name: (%s)", product_id, texture_name) end

function StoreItemPurchasePopup:_set_product_price_text(widget, price_text, real_currency)
	local content = widget.content
	local style = widget.style
...
function StoreItemPurchasePopup:_approved_on_enter()
	self._ui_animator = UIAnimator:new(self._ui_scenegraph, animation_definitions)
	local product = self._product
...
function StoreItemPurchasePopup:_approved_update(input_service, dt, t)
