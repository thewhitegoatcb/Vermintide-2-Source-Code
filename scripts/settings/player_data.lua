...
DefaultPlayerData = { controls_version = 18, new_item_data_version = 6, mission_selection_version = 3, new_keep_decoration_version = 1, seen_shop_items_version = 1, viewed_dialogues_version = 1, level_preferences_version = 1, bot_spawn_priority_version = 2, new_sign_in_rewards_data_version = 2, favorite_item_data_version = 1,
