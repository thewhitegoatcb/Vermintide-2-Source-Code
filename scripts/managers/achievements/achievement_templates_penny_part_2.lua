...
local XB1_ACHIEVEMENT_ID = { penny_bastion_sprinter = 89, penny_bastion_torch = 88 }




local PS4_ACHIEVEMENT_ID = { penny_bastion_sprinter = "082" }
...
add_event_challenge(achievements, "penny_bastion_sprinter", nil, { bastion_sprinter }, nil, XB1_ACHIEVEMENT_ID.penny_bastion_sprinter, PS4_ACHIEVEMENT_ID.penny_bastion_sprinter)
...
local bastion = { LevelSettings.dlc_bastion }
...
add_meta_challenge(achievements, "penny_complete_bastion", { "penny_bastion_journal", "penny_bastion_overstay", "penny_bastion_sprinter", "penny_bastion_yorick", "penny_bastion_torch" })