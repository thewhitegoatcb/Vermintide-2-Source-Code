...
settings.buff_templates = {
	weapon_bleed_dot_javelin = {
		buffs = { { duration = 4, name = "weapon bleed dot javelin", max_stacks = 1, refresh_durations = true, apply_buff_func = "start_dot_damage", update_start_delay = 0.5, time_between_dot_damages = 0.5, hit_zone = "neck", damage_profile = "bleed_maidenguard", update_func = "apply_dot_damage",
	...
	thorn_sister_big_bleed = {
		buffs = { { duration = 5, name = "thorn sister big bleed", max_stacks = 3, refresh_durations = true, apply_buff_func = "start_dot_damage", update_start_delay = 0.75, time_between_dot_damages = 0.75, hit_zone = "neck", damage_profile = "bleed", update_func = "apply_dot_damage",
	...
	thorn_sister_passive_poison = {
		buffs = { { duration = 10, name = "thorn sister passive poison", stat_buff = "damage_taken", multiplier = 0.12, max_stacks = 1, remove_buff_func = "kerillian_thorn_sister_remove_buff_from_attacker", apply_buff_func = "start_dot_damage_kerillian", update_start_delay = 0.8, refresh_durations = true, time_between_dot_damages = 0.8, hit_zone = "neck", damage_profile = "thorn_sister_poison", update_func = "apply_dot_damage",
	...
	thorn_sister_passive_poison_improved = {
		buffs = { { duration = 10, name = "thorn sister passive poison improved", stat_buff = "damage_taken", multiplier = 0.12, max_stacks = 2, remove_buff_func = "kerillian_thorn_sister_remove_buff_from_attacker", apply_buff_func = "start_dot_damage_kerillian", update_start_delay = 0.8, refresh_durations = true, time_between_dot_damages = 0.8, hit_zone = "neck", damage_profile = "thorn_sister_poison", update_func = "apply_dot_damage",
	...
	thorn_sister_wall_bleed = {
		buffs = { { duration = 10, name = "thorn_sister_wall_bleed", max_stacks = 1, refresh_durations = true, apply_buff_func = "start_dot_damage", update_start_delay = 0.25, time_between_dot_damages = 0.25, hit_zone = "neck", damage_profile = "bleed", update_func = "apply_dot_damage",
	...
	thorn_sister_wall_slow = {
		buffs = { { remove_buff_func = "remove_movement_buff", name = "decrease_speed_thorn_sister_wall", refresh_durations = true, apply_buff_func = "apply_movement_buff", lerp_time = 0.1, max_stacks = 1,
			...
			{ apply_buff_func = "apply_action_lerp_movement_buff", name = "decrease_crouch_speed_thorn_sister_wall", refresh_durations = true, remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_crouch_movement", lerp_time = 0.1, max_stacks = 1, update_func = "update_charging_action_lerp_movement_buff",
				...
				duration = wall_slow_duration },
			{ apply_buff_func = "apply_action_lerp_movement_buff", name = "decrease_walk_speed_thorn_sister_wall", refresh_durations = true, remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_walk_movement", lerp_time = 0.1, max_stacks = 1, update_func = "update_charging_action_lerp_movement_buff",
				...
				duration = wall_slow_duration },
			{ name = "decrease_jump_speed_thorn_sister_wall", refresh_durations = true, max_stacks = 1, remove_buff_func = "remove_movement_buff", apply_buff_func = "apply_movement_buff",
	...
	kerillian_thorn_passive_team_buff = {
		buffs = { { name = "kerillian_thorn_passive_team_buff", multiplier = 0.15, stat_buff = "power_level", max_stacks = 1, icon = "kerillian_thornsister_avatar" },
			...
			{ max_stacks = 1, name = "kerillian_thorn_passive_team_buff_2", stat_buff = "critical_strike_chance", bonus = 0.05 } } },
	...
	kerillian_thorn_sister_drain_poison_phasing_buff = {
		buffs = { { refresh_durations = true, name = "kerillian_thorn_sister_poison_phasing", duration = 5, remove_buff_func = "kerillian_thorn_sister_noclip_off", max_stacks = 1, icon = "kerillian_thornsister_big_push", apply_buff_func = "kerillian_thorn_sister_noclip_on" },
			...
			{ refresh_durations = true, name = "kerillian_thorn_sister_poison_movespeed", remove_buff_func = "remove_movement_buff", max_stacks = 1, duration = 5, apply_buff_func = "apply_movement_buff", multiplier = 1.2,
...
settings.proc_functions = {
	...
	thorn_sister_transfer_temp_health_at_full = function (owner_unit, buff, params, world)
		...
		if not ALIVE [thornsister_unit] or thornsister_unit == owner_unit then return
		end
	...
	kerillian_thorn_sister_wall_buff_enemies = function (owner_unit, buff, params, world, param_order)
		...
		if ALIVE [owner_unit] and ALIVE [wall_unit] and target_number == 1 then
			...
			for _, enemy_unit in pairs(nearby_enemy_units) do
				...
				side_manager:is_enemy(owner_unit, enemy_unit) then
