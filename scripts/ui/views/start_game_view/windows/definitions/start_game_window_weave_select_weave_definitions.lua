...
local play_button_size = { window_size [1] - 20, 72 }
local game_option_size = { window_size [1] - 20, window_size [2] - 32 }
...
local scenegraph_definition = {
	...
	game_option_1 = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = game_option_size, position = { 0, -16, 4 } },
	...
	local widget = {
		element = {
			passes = { { style_id = "background", pass_type = "texture_uv", content_id = "background",
				...
				{ style_id = "warning_text", pass_type = "text", text_id = "warning_text",
				...
				{ style_id = "warning_text_shadow", pass_type = "text", text_id = "warning_text",
		...
		content = { glass = "game_options_fg_04", glow = "game_options_glow_01", divider = "divider_01_top",
			button_hotspot = { },
		...
		style = {
			...
			option_text = { font_size = 42, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
				...
				offset = { frame_width * 2, 60, 10 },
				size = { size [1] - frame_width * 4, size [2] } },

			option_text_shadow = { font_size = 42, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
				...
				offset = { frame_width * 2 + 2, 58, 9 },
				size = { size [1] - frame_width * 4, size [2] } },

			warning_text = { font_size = 42, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
			...
			warning_text_shadow = { font_size = 42, upper_case = true, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark_header",
			...
			description_text = { word_wrap = true, font_size = 18, localize = false, use_shadow = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark",
				...
				offset = { frame_width * 2 + 2 + 55, -400, 9 },
				size = { size [1] - frame_width * 4 - 100, size [2] } },
