...
function TransitionVideo:init(world, video_data_table)
	self._world = world
	...
	self._ui_renderer = UIRenderer.create(world,
	"material", self._video_data_table.video_name)

	self:_create_ui_elements()
end

function TransitionVideo:_create_ui_elements()
...
function TransitionVideo:activate(activate)
	if DO_RELOAD then
		self:_create_ui_elements()
		DO_RELOAD = false
	end
...
function TransitionVideo:_destroy_video()
...
function TransitionVideo:update(dt, t)
	if self._active then
		self:_draw(dt, t)
	end
end

function TransitionVideo:_draw(dt, t)
	local ui_renderer = self._ui_renderer
...
function TransitionVideo:completed()
	return self._demo_video.content.video_content.video_completed
end

function TransitionVideo:is_active()
	return self._active
end

function TransitionVideo:destroy()
