...
function BTGreySeerGroundCombatAction:leave(unit, blackboard, t, reason, destroy)
...
function BTGreySeerGroundCombatAction:run(unit, blackboard, t, dt)
...
function BTGreySeerGroundCombatAction:update_spells(unit, blackboard, t)
	local current_phase = blackboard.current_phase
...
function BTGreySeerGroundCombatAction:update_final_phase(unit, blackboard, t)
...
function BTGreySeerGroundCombatAction:update_regular_spells(unit, blackboard, t)
...
function BTGreySeerGroundCombatAction:update_warp_lightning_spell(unit, blackboard, t, position, target_unit_direction)
...
function BTGreySeerGroundCombatAction:update_vermintide_spell(unit, blackboard, t, position, target_unit_direction)
...
function BTGreySeerGroundCombatAction:update_teleport_spell(unit, blackboard, t, position)
...
function BTGreySeerGroundCombatAction:spawn_allies(unit, blackboard, t)
