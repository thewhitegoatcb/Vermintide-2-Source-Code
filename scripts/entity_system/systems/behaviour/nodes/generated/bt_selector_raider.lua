...
function BTSelector_raider:init(...)
	BTSelector_raider.super.init(self, ...)
	self._children = { }
end

function BTSelector_raider:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_raider:run(unit, blackboard, t, dt)
...
function BTSelector_raider:add_child(node)
