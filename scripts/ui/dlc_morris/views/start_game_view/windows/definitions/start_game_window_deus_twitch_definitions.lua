...
local login_text_area_size = { window_text_width - 20 - 160, 50 }

local journey_widget_settings = { width = 72, spacing_x = 40 }
...
local animation_definitions = {
	...
	right_arrow_flick = { { name = "right_arrow_flick", start_progress = 0, end_progress = 0.6,
	...
	left_arrow_flick = { { name = "left_arrow_flick", start_progress = 0, end_progress = 0.6,
	...
	gamemode_text_swap = { { name = "gamemode_swap_text_fade_out", start_progress = 0, end_progress = 0.2,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "gamemode_swap_text_fade_in", start_progress = 0.2, end_progress = 0.4,
...
animation_definitions.difficulty_info_enter = { { name = "difficulty_info_enter", start_progress = 0, end_progress = 0.6,
...
local scenegraph_definition = {
	...
	window = { vertical_alignment = "center", parent = "menu_root", horizontal_alignment = "left", size = { window_size [1], window_size [2] + 100 }, position = { 220, -50, 1 } },
	level_root_node = { vertical_alignment = "center", parent = "window", horizontal_alignment = "left", size = { 0, 0 }, position = { 285, 40, 10 } },
	brush_stroke = { vertical_alignment = "center", parent = "level_root_node", horizontal_alignment = "left", size = { 700, 100 }, position = { -390, -10, 0 } },
	window_game_mode_root = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1], window_frame_height }, position = { 0, -window_frame_height, 1 } },

	login_text_area = { vertical_alignment = "bottom", parent = "twitch_background", horizontal_alignment = "center", size = { window_text_width, 50 }, position = { 0, 80, 1 } },
	login_text_frame = { vertical_alignment = "center", parent = "login_text_area", horizontal_alignment = "left", size = login_text_area_size, position = { 10, 0, 1 } },
	login_text_box = { vertical_alignment = "center", parent = "login_text_frame", horizontal_alignment = "center", size = { 300, 42 }, position = { 0, 0, 1 } },

	twitch_background = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1] + 70, 280 }, position = { 0, -75, 1 } },
	twitch_texture = { vertical_alignment = "top", parent = "twitch_background", horizontal_alignment = "center", size = { 130, 29 }, position = { 0, 45, 2 } },

	client_disclaimer_background = { vertical_alignment = "top", parent = "window", horizontal_alignment = "center", size = { window_size [1] + 70, 150 }, position = { 0, -380, 1 } },
	client_disclaimer_description = { vertical_alignment = "center", parent = "client_disclaimer_background", horizontal_alignment = "center", size = { window_text_width, 100 }, position = { 0, 0, 1 } },

	game_option_3 = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] }, position = { -15, -15, 1 } },
	game_option_2 = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] }, position = { -15, -15 + game_option_size [2], 1 } },
	game_option_1 = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] }, position = { -15, -15 + game_option_size [2] * 2, 1 } },

	play_button = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], 72 }, position = { 0, 60, 1 } },

	difficulty_stepper = { vertical_alignment = "bottom", parent = "window", horizontal_alignment = "center", size = { game_option_size [1], game_option_size [2] + 22 }, position = { 0, 165, 1 } },
	difficulty_info = { vertical_alignment = "bottom", parent = "difficulty_stepper", horizontal_alignment = "center", size = { 500, 200 }, position = { 500, 0, 1 } },
	upsell_button = { vertical_alignment = "center", parent = "difficulty_info", horizontal_alignment = "center", size = { 28, 28 }, position = { 218, 0, 2 } },

	connecting = { vertical_alignment = "center", parent = "login_text_area", horizontal_alignment = "center", size = login_text_area_size, position = { 0, 0, 1 } },

	connect_button = { vertical_alignment = "center", parent = "login_text_area", horizontal_alignment = "right", size = { 160, 45 }, position = { -10, -2, 10 } },
	connect_button_frame = { vertical_alignment = "center", parent = "connect_button", horizontal_alignment = "center", size = { 160, 50 }, position = { 0, 2, 11 } },

	disconnect_button = { vertical_alignment = "center", parent = "login_text_area", horizontal_alignment = "center", size = { window_size [1] - 20, 45 }, position = { 0, -2, 10 } },
	disconnect_button_frame = { vertical_alignment = "center", parent = "disconnect_button", horizontal_alignment = "center", size = { window_size [1] - 20, 50 }, position = { 0, 2, 11 } },

	chat_feed_area_mask = { vertical_alignment = "center", parent = "menu_root", horizontal_alignment = "right", size = { 600, window_size [2] - 220 }, position = { 0, -145, 0 } },
	chat_feed_area = { vertical_alignment = "bottom", parent = "chat_feed_area_mask", horizontal_alignment = "right", size = { 600, window_size [2] - 220 }, position = { 10, -120, 1 } },
	chat_text_box = { vertical_alignment = "bottom", parent = "chat_feed_area", horizontal_alignment = "right", size = { 600, window_size [2] - 220 } } }


if IS_XB1 then
	scenegraph_definition.connect_button = { vertical_alignment = "center", parent = "login_text_area", horizontal_alignment = "center", size = { 160, 45 }, position = { 0, -2, 1 } }
	scenegraph_definition.connect_button_frame = { vertical_alignment = "center", parent = "connect_button", horizontal_alignment = "center", size = { 160, 50 }, position = { 0, 2, 10 } }
end
...
function create_button(scenegraph_id, size, text, font_size, content_check_function)
	...
	style [text_name] = { word_wrap = true, upper_case = true, localize = false, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark",
		...
		offset = { 10 + offset [1], offset [2] + 3, 4 },
		size = { size [1] - 20, size [2] } }
	...
	style [text_shadow_name] = { word_wrap = true, upper_case = true, localize = false, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark",
		...
		offset = { 10 + offset [1] + 2, offset [2] + 2, 3 },
		size = { size [1] - 20, size [2] } }
...
local chat_output_widget = { scenegraph_id = "chat_feed_area",
	element = {
		passes = { { style_id = "chat_text_box", pass_type = "text_area_chat", text_id = "text_field",
	...
	content = { mask_id = "mask_rect", text_start_offset = 0,
		message_tables = { } },



	style = {
		chat_text_box = { word_wrap = true, font_size = 18, spacing = 0, pixel_perfect = false, vertical_alignment = "top", dynamic_font = true, font_type = "chat_output_font_masked",
...
local function create_window(scenegraph_id, size)
	local widget = { element = { } }
	local passes = { { scenegraph_id = "login_text_box", pass_type = "hotspot", content_id = "text_input_hotspot" },



		{ scenegraph_id = "window", pass_type = "hotspot", content_id = "frame_hotspot" },



		{ scenegraph_id = "menu_root", pass_type = "hotspot", content_id = "screen_hotspot" },



		{ style_id = "login_rect_bg", pass_type = "rect",


			content_check_function = function (content, style)
				return not Managers.twitch:is_connected() and not Managers.twitch:is_connecting()
			end },
		{ style_id = "login_hint", pass_type = "text", text_id = "login_hint",
		...
		{ style_id = "twitch_name", pass_type = "text", text_id = "twitch_name",
		...
		{ style_id = "connecting", pass_type = "text", text_id = "connecting_id",
	...
	local content = { text_start_offset = 0, text_field_active = false, connecting_id = "Connecting", error_id = "", twitch_name = "", caret_index = 1, text_index = 1,

		login_hint = Localize("start_game_window_twitch_login_hint"),

		text_input_hotspot = { },
		screen_hotspot = { allow_multi_hover = true },
		frame_hotspot = { allow_multi_hover = true } }
	...
	local style = {
		login_rect_bg = { scenegraph_id = "login_text_frame",

			color = { 255, 0, 0, 0 },
			offset = { 0, 0, -1 },
			size = login_text_area_size },

		login_hint = { word_wrap = true, scenegraph_id = "login_text_box", font_size = 24, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font_size = true, font_type = "hell_shark",
		...
		connecting = { word_wrap = false, scenegraph_id = "connecting", font_size = 24, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",



			text_color = { 90, 255, 255, 255 },
		...
		twitch_name = { word_wrap = false, scenegraph_id = "login_text_box", horizontal_scroll = true, pixel_perfect = true, horizontal_alignment = "left", font_size = 28, vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark_arial",
...
local client_disclaimer_description_style = { font_size = 28, upper_case = false, localize = false, use_shadow = true, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "top", font_type = "hell_shark_header",
...
local widgets = {
	...
	login_text_frame = UIWidgets.create_frame("login_text_frame", { window_text_width, 50 }, "menu_frame_09", 1),
...
local selector_input_definition = { {
		...
		end },
	{
		...
		update = function (self, input_service, dt, t)
			...
			if input_service:get("confirm_press", true) and
			self._dlc_locked then
...
return {
	...
	twitch_keyboard_anchor_point = { 230, 350 } }