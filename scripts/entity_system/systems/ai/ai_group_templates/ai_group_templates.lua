...
AIGroupTemplates.encampment = {
	...
	wake_up_encampment = function (group, prime_target_unit)
		...
		Managers.state.entity:system("ai_group_system"):run_func_on_all_members(group, AIGroupTemplates.encampment.wake_up_unit, prime_target_unit) group.idle = false
	end,
