local ACTIONS = BreedActions.ethereal_skeleton_with_shield

BreedBehaviors.ethereal_skeleton_with_shield = { "BTSelector",
	...
	{ "BTFallbackIdleAction", name = "fallback_idle" }, name = "shield_marauder" }