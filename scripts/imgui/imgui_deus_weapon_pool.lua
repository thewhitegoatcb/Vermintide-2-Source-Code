...
function ImguiDeusWeaponPool:init()
	return end

function ImguiDeusWeaponPool:update()
	return end

function ImguiDeusWeaponPool:is_persistent()
	return true
end

function ImguiDeusWeaponPool:draw(is_open)
