...
function StartGameWindowMutator:on_enter(params, offset)
...
function StartGameWindowMutator:create_ui_elements(params, offset)
...
function StartGameWindowMutator:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowMutator")
end

function StartGameWindowMutator:update(dt, t)
...
function StartGameWindowMutator:post_update(dt, t)
	return end

function StartGameWindowMutator:draw(dt)
