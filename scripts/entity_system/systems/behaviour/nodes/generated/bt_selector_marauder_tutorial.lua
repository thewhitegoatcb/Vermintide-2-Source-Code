...
function BTSelector_marauder_tutorial:init(...)
	BTSelector_marauder_tutorial.super.init(self, ...)
	self._children = { }
end

function BTSelector_marauder_tutorial:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_marauder_tutorial:run(unit, blackboard, t, dt)
...
function BTSelector_marauder_tutorial:add_child(node)
