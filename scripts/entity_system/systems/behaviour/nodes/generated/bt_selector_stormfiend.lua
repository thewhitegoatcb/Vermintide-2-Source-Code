...
function BTSelector_stormfiend:init(...)
	BTSelector_stormfiend.super.init(self, ...)
	self._children = { }
end

function BTSelector_stormfiend:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_stormfiend:run(unit, blackboard, t, dt)
...
function BTSelector_stormfiend:add_child(node)
