...
function InteractionDefinitions.cog_missing_cog_pickup.client.can_interact(interactor_unit, interactable_unit, data, config)
...
function InteractionDefinitions.cog_missing_cog_pickup.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
	data.start_time = nil
...
function InteractionDefinitions.cog_missing_cog_pickup.client.hud_description(interactable_unit, data, config, fail_reason, interactor_unit)
