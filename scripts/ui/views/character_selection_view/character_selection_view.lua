...
function CharacterSelectionView:init(ingame_ui_context)
...
function CharacterSelectionView:initial_profile_view()
	return self.ingame_ui.initial_profile_view
end

function CharacterSelectionView:_setup_state_machine(state_machine_params, optional_start_state, optional_start_sub_state, optional_params)
...
function CharacterSelectionView:wanted_state()
	return self._wanted_state
end

function CharacterSelectionView:clear_wanted_state()
	self._wanted_state = nil
end

function CharacterSelectionView:input_service(ignore_input_blocked)
...
function CharacterSelectionView:set_input_blocked(blocked)
	self._input_blocked = blocked
end

function CharacterSelectionView:input_blocked()
	return self._input_blocked
end

function CharacterSelectionView:play_sound(event)
	WwiseWorld.trigger_event(self.wwise_world, event)
end

function CharacterSelectionView:create_ui_elements()
...
function CharacterSelectionView:get_background_world()
...
function CharacterSelectionView:show_hero_world()
...
function CharacterSelectionView:hide_hero_world()
...
function CharacterSelectionView:show_hero_panel()
	self._draw_menu_panel = true
	self:set_input_blocked(false)
end

function CharacterSelectionView:hide_hero_panel()
	self._draw_menu_panel = false
	self:set_input_blocked(true)
end

function CharacterSelectionView:draw(dt, input_service)
...
function CharacterSelectionView:post_update(dt, t)
	self._machine:post_update(dt, t)
	self.world_previewer:post_update(dt, t)
end

function CharacterSelectionView:update(dt, t)
...
function CharacterSelectionView:on_enter(params)
...
function CharacterSelectionView:set_current_hero(profile_index)
...
function CharacterSelectionView:_get_sorted_players()
...
function CharacterSelectionView:set_prestige_level(prestige)
	if prestige > 0 then
...
function CharacterSelectionView:_handle_mouse_input(dt, t, input_service)
	return end

function CharacterSelectionView:_is_selection_widget_pressed(widget)
...
function CharacterSelectionView:hotkey_allowed(input, mapping_data)
...
function CharacterSelectionView:_get_screen_settings_by_state_name(state_name)
...
function CharacterSelectionView:requested_screen_change_by_name(screen_name, sub_screen_name)
...
function CharacterSelectionView:_change_screen_by_name(screen_name, sub_screen_name, optional_params)
...
function CharacterSelectionView:_change_screen_by_index(index)
...
function CharacterSelectionView:post_update_on_enter()
...
function CharacterSelectionView:post_update_on_exit()
...
function CharacterSelectionView:on_exit(params)
...
function CharacterSelectionView:exit(return_to_game)
...
function CharacterSelectionView:transitioning()
...
function CharacterSelectionView:suspend()
	self.input_manager:device_unblock_all_services("keyboard", 1)
	self.input_manager:device_unblock_all_services("mouse", 1)
	self.input_manager:device_unblock_all_services("gamepad", 1)
	self.suspended = true
...
function CharacterSelectionView:unsuspend()
...
function CharacterSelectionView:_handle_exit(dt, input_service)
...
function CharacterSelectionView:close_menu(return_to_main_screen)
	local return_to_game = not return_to_main_screen
	self:exit(return_to_game)
end

function CharacterSelectionView:destroy()
	if self.viewport_widget then
		UIWidget.destroy(self.ui_top_renderer, self.viewport_widget)
		self.viewport_widget = nil
	end
...
function CharacterSelectionView:_is_button_pressed(widget)
