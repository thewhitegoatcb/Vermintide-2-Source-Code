...
local function spawn_orb(nav_world, orb_name, owner_peer_id, orb_starting_position, cake_slice_dir, cake_slice_angle_radians)
	...
	local extension_init_data = {
		pickup_system = { has_physics = false, spawn_limit = 1, flight_enabled = true,
...
function OrbSystem:init(entity_system_creation_context, ...)
...
function OrbSystem:rpc_spawn_orb(channel_id, orb_name, owner_peer_id, orb_starting_position, cake_slice_dir, cake_slice_angle_radians)
...
function OrbSystem:spawn_orb(orb_name, owner_peer_id, orb_starting_position, cake_slice_dir, cake_slice_angle_radians)
