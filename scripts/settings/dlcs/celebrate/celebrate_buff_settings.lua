...
settings.buff_templates = {
	celebrate_group = {
		buffs = { { max_stacks = 1, name = "celebrate_group", apply_buff_func = "hot_joined" } } },
	...
	beer_bottle_pickup_cooldown = {
		buffs = { { max_stacks = 1, name = "beer_bottle_pickup_cooldown", duration = 2.5 } } },
	...
	hinder_career_ability = {
		buffs = { { duration = 2.1, name = "hinder_career_ability",



				perks = { buff_perks.disable_career_ability } } } },




	intoxication_base = {
		buffs = { { max_stacks = 1, name = "intoxication_base", update_func = "update_intoxication_level", remove_buff_func = "remove_intoxication_base" } } },
	...
	intoxication_stagger = {
		buffs = { { duration = 2.5, name = "intoxication_stagger", max_stacks = 1, refresh_durations = true,





				perks = { buff_perks.intoxication_stagger } } } },




	increase_intoxication_level = { activation_effect = "fx/screenspace_drink_01",

		buffs = { { effect_buff = "intoxication_effect", name = "increase_intoxication_level", apply_buff_func = "increase_intoxication_level", base_buff = "intoxication_base" },





			{ buff_to_add = "intoxication_stagger", name = "add_intoxication_stagger", apply_buff_func = "add_buff" },




			{ buff_to_add = "beer_bottle_pickup_cooldown", name = "add_intoxication_pickup_cooldown", apply_buff_func = "add_buff" } } },
	...
	intoxication_effect_vfx = {
		buffs = { { refresh_durations = true, name = "intoxication_effect_vfx", continuous_effect = "fx/screenspace_drunken_lens_01", max_stacks = 1, duration = 30 } } },
	...
	intoxication_effect_max_stacks_vfx = {
		buffs = { { refresh_durations = true, name = "intoxication_effect_max_stacks_vfx", continuous_effect = "fx/screenspace_drunken_lens_05", max_stacks = 1, duration = 30 } } },
	...
	intoxication_effect = {
		buffs = { { remove_buff_func = "end_intoxication_effect", name = "intoxication_effect", duration = 30, continuous_effect = "fx/screenspace_drunken_lens_01", max_stacks = 3, icon = "buff_icon_mutator_icon_drunk", priority_buff = true, refresh_durations = true },
			...
			{ refresh_durations = true, name = "intoxication_effect_bloody_mess", max_stacks = 1, duration = 30,
			...
			{ refresh_durations = true, name = "intoxication_effect_drunk_stagger", max_stacks = 1, duration = 30,


				perks = { buff_perks.drunk_stagger } },



			{ name = "intoxication_power_level", multiplier = 0.1, stat_buff = "power_level", refresh_durations = true, max_stacks = 3, duration = 30 },
			...
			{ name = "intoxication_critical_hit_chance", multiplier = 0.15, stat_buff = "critical_strike_chance", refresh_durations = true, max_stacks = 3, duration = 30 },
			...
			{ name = "intoxication_cooldown_regen_increase", multiplier = 1.5, stat_buff = "cooldown_regen", refresh_durations = true, max_stacks = 3, duration = 30 },
			...
			{ max_stacks = 3, name = "drunk_attack_speed_slowdown", stat_buff = "attack_speed", multiplier = 0.02 } } },
	...
	falling_down_effect = { deactivation_effect = "fx/screenspace_hungover_01", activation_effect = "fx/screenspace_hungover_01",


		buffs = { { name = "falling_down_attack_speed_slowdown", stat_buff = "attack_speed", continuous_effect = "fx/screenspace_drink_looping", max_stacks = 1, remove_buff_func = "remove_falling_down_effect", multiplier = -0.5, duration = 5,





				perks = { buff_perks.falling_down } },



			{ apply_buff_func = "apply_action_lerp_movement_buff", multiplier = 0.5, name = "falling_down_decrease_speed", duration = 5, remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_movement", lerp_time = 1, max_stacks = 1, update_func = "update_action_lerp_movement_buff",
			...
			{ apply_buff_func = "apply_action_lerp_movement_buff", multiplier = 0.5, name = "falling_down_decrease_crouch_speed", duration = 5, remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_crouch_movement", lerp_time = 1, max_stacks = 1, update_func = "update_charging_action_lerp_movement_buff",
			...
			{ apply_buff_func = "apply_action_lerp_movement_buff", multiplier = 0.5, name = "falling_down_decrease_walk_speed", duration = 5, remove_buff_func = "remove_action_lerp_movement_buff", remove_buff_name = "planted_return_to_normal_walk_movement", lerp_time = 1, max_stacks = 1, update_func = "update_charging_action_lerp_movement_buff",
	...
	hungover_effect = { activation_effect = "fx/screenspace_hungover_01",

		buffs = { { continuous_effect = "fx/screenspace_hungover_lens_01", name = "hungover_effect", debuff = true, max_stacks = 3, icon = "debuff_icon_mutator_icon_drunk", priority_buff = true },
			...
			{ max_stacks = 3, name = "hungover_effect_stagger",


				perks = { buff_perks.hungover_stagger } },

			{ max_stacks = 3, name = "hungover_attack_speed_slowdown", stat_buff = "attack_speed", multiplier = -0.05 },





			{ max_stacks = 3, name = "hungover_regen_increase", stat_buff = "fatigue_regen", multiplier = -0.2 },





			{ max_stacks = 1, name = "hungover_effect_perk",


				perks = { buff_perks.hungover } } } } }
...
settings.group_buff_templates = {
	celebrate_group = { buff_per_instance = "celebrate_group", side_name = "heroes" } }





settings.add_sub_buffs_to_core_buffs = { { buff_name = "damage_boost_potion",


		sub_buff_to_add = { apply_buff_func = "check_celebrate_buff", name = "check celebrate" } },
