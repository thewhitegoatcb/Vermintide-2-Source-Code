...
function ProjectileRaycastImpactUnitExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileRaycastImpactUnitExtension:extensions_ready(world, unit)
	self.locomotion_extension = ScriptUnit.extension(unit, "projectile_locomotion_system")
end

function ProjectileRaycastImpactUnitExtension:update(unit, input, dt, context, t)
...
function ProjectileRaycastImpactUnitExtension:_do_raycast(unit, from, to, physics_world, collision_filter, t, dt)
...
function ProjectileRaycastImpactUnitExtension:_valid_target(unit, hit_unit, hit_actor)
