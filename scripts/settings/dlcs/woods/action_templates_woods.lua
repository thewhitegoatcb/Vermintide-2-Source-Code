ActionTemplates.action_career_we_thornsister = {
	default = { slot_to_wield = "slot_career_skill_weapon", weapon_action_hand = "either", kind = "instant_wield", input_override = "action_career", total_time = 0,
		condition_func = function (action_user, input_extension)
			...
			return career_extension:can_use_activated_ability() and activated_ability_data.action_name == "action_career_we_thornsister"
		end,
