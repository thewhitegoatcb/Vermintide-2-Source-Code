...
function BackendInterfaceCraftingPlayfab:init(backend_mirror)
...
function BackendInterfaceCraftingPlayfab:ready()
	return true
end

function BackendInterfaceCraftingPlayfab:update(dt)
	return end

function BackendInterfaceCraftingPlayfab:_new_id()
	self._last_id = self._last_id + 1

	return self._last_id
end

function BackendInterfaceCraftingPlayfab:craft(career_name, item_backend_ids, recipe_override)
...
function BackendInterfaceCraftingPlayfab:craft_request_cb(id, result)
...
function BackendInterfaceCraftingPlayfab:is_craft_complete(id)
...
function BackendInterfaceCraftingPlayfab:get_craft_result(id)
	return self._craft_requests [id]
end

function BackendInterfaceCraftingPlayfab:get_unlocked_weapon_skins()
	local mirror = self._backend_mirror
	return mirror:get_unlocked_weapon_skins()
end


function BackendInterfaceCraftingPlayfab:get_unlocked_cosmetics()
	local mirror = self._backend_mirror
