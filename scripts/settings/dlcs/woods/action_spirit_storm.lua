...
function ActionSpiritStorm:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionSpiritStorm:client_owner_start_action(new_action, t, chain_action_data, power_level)
...
function ActionSpiritStorm:client_owner_post_update(dt, t, world, can_damage)
...
function ActionSpiritStorm:finish(reason)
...
function ActionSpiritStorm:fire(reason)
	local current_action = self.current_action
	local owner_unit = self.owner_unit
