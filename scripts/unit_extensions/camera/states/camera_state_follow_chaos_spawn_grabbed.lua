...
function CameraStateFollowChaosSpawnGrabbed:init(camera_state_init_context)
...
function CameraStateFollowChaosSpawnGrabbed:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateFollowChaosSpawnGrabbed:on_exit(unit, input, dt, context, t, next_state)
	self._follow_unit = nil
end

function CameraStateFollowChaosSpawnGrabbed:update(unit, input, dt, context, t)
	local csm = self.csm
