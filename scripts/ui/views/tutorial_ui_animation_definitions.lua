...
local info_slate_enter = { } info_slate_enter [1] = { name = "entry", start_progress = 0, end_progress = 1,
	...
	on_complete = function (ui_scenegraph, scenegraph_definition, widget, params)
		return end }
info_slate_enter [2] = { name = "fade_in_text_and_icon", start_progress = 1, end_progress = 2,
...
local info_slate_exit = { { name = "exit", start_progress = 0, end_progress = 1,
...
local info_slate_flash = { } info_slate_flash [1] = { name = "flash", start_progress = 0, end_progress = 1,
...
local info_slate_move_slot = { { name = "move_up", start_progress = 0, end_progress = 2,
...
local mission_goal_wait = { { name = "wait", start_progress = 0, end_progress = 1,
...
local mission_goal_move_up = { { name = "move_up", start_progress = 0, end_progress = 2,
