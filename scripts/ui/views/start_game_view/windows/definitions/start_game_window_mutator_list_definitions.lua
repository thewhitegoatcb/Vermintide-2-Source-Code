...
local game_option_size = { window_size [1] - 20, window_size [2] - (50 + play_button_size [2]) }
...
local function create_overlay_button(scenegraph_id, size)
	...
	local widget = {
		...
		content = { glass = "game_options_fg_04", glow = "game_options_glow_01",
			button_hotspot = { },
		...
		style = {
			...
			option_text = { font_size = 42, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
				...
				offset = { frame_width * 2, 0, 10 },
				size = { size [1] - frame_width * 4, size [2] } },

			option_text_shadow = { font_size = 42, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
				...
				offset = { frame_width * 2 + 2, -2, 9 },
				size = { size [1] - frame_width * 4, size [2] } },

			warning_text = { font_size = 42, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
			...
			warning_text_shadow = { font_size = 42, upper_case = false, localize = false, word_wrap = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
