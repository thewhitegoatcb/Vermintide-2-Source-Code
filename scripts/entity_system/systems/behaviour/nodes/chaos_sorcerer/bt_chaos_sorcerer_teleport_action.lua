...
function BTChaosSorcererTeleportAction:init(...)
	BTChaosSorcererTeleportAction.super.init(self, ...)
end

function BTChaosSorcererTeleportAction:enter(unit, blackboard, t)
...
function BTChaosSorcererTeleportAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChaosSorcererTeleportAction:run(unit, blackboard, t, dt)
...
function BTChaosSorcererTeleportAction:play_teleport_effect(unit, start_position, end_position)
...
function BTChaosSorcererTeleportAction:anim_cb_teleport_start_finished(unit, blackboard)
