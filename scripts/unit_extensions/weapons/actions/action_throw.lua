...
function ActionThrow:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
	ActionThrow.super.init(self, world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionThrow:client_owner_start_action(new_action, t)
...
function ActionThrow:client_owner_post_update(dt, t, world, can_damage)
	if self.thrown then
		return
	end
...
function ActionThrow:_throw()
	...
	physics_world,
	first_person_unit_pos,
	direction,
	length,
	"closest",
	"types", "both",
	"collision_filter", "filter_physics_projectile_large")
	...
	ActionUtils.spawn_pickup_projectile(self.world,
	self.weapon_unit,
...
function ActionThrow:finish(reason)
