...
function BTThrowPoisonGlobeAction:init(...)
	BTThrowPoisonGlobeAction.super.init(self, ...)
end

BTThrowPoisonGlobeAction.name = "BTThrowPoisonGlobeAction"

function BTThrowPoisonGlobeAction:enter(unit, blackboard, t)
...
function BTThrowPoisonGlobeAction:leave(unit, blackboard, t, reason, destroy)
...
function BTThrowPoisonGlobeAction:run(unit, blackboard, t, dt)
	...
	if blackboard.start_anim_locked_time and
	blackboard.start_anim_locked_time < t then
...
function BTThrowPoisonGlobeAction:attack_throw(unit, t, dt, blackboard, locomotion, action)
...
function BTThrowPoisonGlobeAction:spawn_dummy_projectile(unit, blackboard, world, action)
...
function BTThrowPoisonGlobeAction:launch_projectile(blackboard, action, initial_position, target_vector, angle, speed, owner_unit)
