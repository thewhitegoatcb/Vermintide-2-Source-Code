...
local EXPLOSIVE_LOOT_RAT_BEHAVIOR = { "BTUtilityNode",
	{ "BTClanRatFollowAction", name = "follow",
		action_data = ACTIONS.follow }, { "BTZombieExplodeAction", name = "explosion_attack",
		action_data = ACTIONS.explosion_attack }, name = "in_combat", condition = "can_see_player", action_data = ACTIONS.utility_action }



BreedBehaviors.explosive_loot_rat = { "BTSelector",
	...
	EXPLOSIVE_LOOT_RAT_BEHAVIOR, { "BTIdleAction", name = "idle", condition = "no_target",
		action_data = ACTIONS.idle }, { "BTFallbackIdleAction", name = "fallback_idle" }, name = "horde" }