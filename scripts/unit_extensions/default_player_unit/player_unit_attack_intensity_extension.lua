...
function PlayerUnitAttackIntensityExtension:_setup_intensity()
...
function PlayerUnitAttackIntensityExtension:update(unit, input, dt, context, t)
...
function PlayerUnitAttackIntensityExtension:add_attack_intensity(attack_intensity_type, added_attack_intensity, clamp_override)
...
function PlayerUnitAttackIntensityExtension:want_an_attack(attack_intensity_type)
	fassert(AttackIntensitySettings.attack_type_intesities [attack_intensity_type], "No attack intesity settings defined for attack type \"%s\"", attack_intensity_type)
