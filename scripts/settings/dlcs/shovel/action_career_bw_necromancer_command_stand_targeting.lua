...
function ActionCareerBwNecromancerCommandStandTargeting:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerBwNecromancerCommandStandTargeting:client_owner_start_action(new_action, t, chain_action_data, power_level, action_init_data)
...
function ActionCareerBwNecromancerCommandStandTargeting:client_owner_post_update(dt, t, world, can_damage, current_time_in_action)
	self._ai_navigation_system:add_safe_navigation_callback(self._nav_callback)
end

function ActionCareerBwNecromancerCommandStandTargeting:_update_targeting(t)
...
function ActionCareerBwNecromancerCommandStandTargeting:_update_spawn_positions()
...
function ActionCareerBwNecromancerCommandStandTargeting:_get_projectile_position()
	local world = self._world
...
function ActionCareerBwNecromancerCommandStandTargeting:_get_first_person_position_direction()
...
function ActionCareerBwNecromancerCommandStandTargeting:finish(reason)
	local world = self._world
	local decal_ids = self._spawn_decal_ids
