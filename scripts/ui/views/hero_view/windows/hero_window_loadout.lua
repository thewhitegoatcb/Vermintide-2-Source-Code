...
function HeroWindowLoadout:on_enter(params, offset)
...
function HeroWindowLoadout:create_ui_elements(params, offset)
...
function HeroWindowLoadout:on_exit(params)
...
function HeroWindowLoadout:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowLoadout:post_update(dt, t)

	return end

function HeroWindowLoadout:_update_animations(dt)
...
function HeroWindowLoadout:_is_button_pressed(widget)
...
function HeroWindowLoadout:_handle_input(dt, t)
...
function HeroWindowLoadout:_update_selected_loadout_slot_index()
...
function HeroWindowLoadout:_update_loadout_sync()
	local parent = self.parent
...
function HeroWindowLoadout:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowLoadout:draw(dt)
...
function HeroWindowLoadout:_play_sound(event)
	self.parent:play_sound(event)
end



function HeroWindowLoadout:_setup_slot_icons()
...
function HeroWindowLoadout:_populate_loadout()
...
function HeroWindowLoadout:_equip_item_presentation(item, slot)
...
function HeroWindowLoadout:_clear_item_slot(slot)
...
function HeroWindowLoadout:_is_equipment_slot_right_clicked()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadout:_is_equipment_slot_pressed()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadout:_is_equipment_slot_hovered()
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadout:_set_equipment_slot_selected(column_index)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadout:_is_equipment_slot_hovered_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
...
function HeroWindowLoadout:_highlight_equipment_slot_by_type(item_type)
	local widget = self._widgets_by_name.loadout_grid
	local content = widget.content
	local style = widget.style
