...
function ThrownUnitHuskExtension:init(extension_init_context, unit, extension_init_data)
...
function ThrownUnitHuskExtension:extensions_ready(world, unit)
	Unit.flow_event(unit, "axe_thrown")
end

function ThrownUnitHuskExtension:destroy()

	return end

function ThrownUnitHuskExtension:update(unit, input, dt, context, t)
