...
function NavTagVolumeUtils.nav_tags_from_position(nav_world, position, above, below, layer_name_optional)
...
function NavTagVolumeUtils.inside_nav_tag_layer(nav_world, position, above, below, layer_name)
...
function NavTagVolumeUtils.inside_level_volume_layer(level, nav_tag_volume_handler, position, layer_name)
