...
local page_settings = {
	{ sound_event_enter = "play_gui_equipment_button", name = "salvage", class_name = "CraftPageSalvage", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "craft_random_item", class_name = "CraftPageCraftItem", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "reroll_weapon_properties", class_name = "CraftPageRollProperties", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "reroll_weapon_traits", class_name = "CraftPageRollTrait", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "upgrade_item_rarity_common", class_name = "CraftPageUpgradeItem", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "apply_weapon_skin", class_name = "CraftPageApplySkin", sound_event_exit = "play_gui_equipment_close" },





	{ sound_event_enter = "play_gui_equipment_button", name = "convert_blue_dust", class_name = "CraftPageConvertDust", sound_event_exit = "play_gui_equipment_close" } }
...
function HeroWindowCrafting:on_enter(params, offset)
...
function HeroWindowCrafting:create_ui_elements(params, offset)
...
function HeroWindowCrafting:on_exit(params)
...
function HeroWindowCrafting:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowCrafting:post_update(dt, t)
	if self._active_page and self._active_page.post_update then
		self._active_page:post_update(dt, t)
	end
end

function HeroWindowCrafting:_update_animations(dt)
...
function HeroWindowCrafting:_is_button_pressed(widget)
...
function HeroWindowCrafting:_is_button_hovered(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowCrafting:_is_button_held(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowCrafting:_handle_input(dt, t)
...
function HeroWindowCrafting:_exit(selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

function HeroWindowCrafting:draw(dt)
...
function HeroWindowCrafting:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowCrafting:_change_recipe_page(current_page)
	local total_pages = #page_settings
...
function HeroWindowCrafting:window_input_service()
	return
end

function HeroWindowCrafting:_set_page_index(page_index)
...
function HeroWindowCrafting:_update_craft_start_time(dt, t)
...
function HeroWindowCrafting:_update_craft_glow_in_time(dt, t)
...
function HeroWindowCrafting:_update_craft_glow_wait_time(dt, t)
...
function HeroWindowCrafting:_update_craft_glow_out_time(dt, t)
	...
	if progress == 1 then
		...
		if self._craft_glow_out_duration == 0 and
		self._active_page then
...
function HeroWindowCrafting:_set_crafting_fg_progress(progress)
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowCrafting:_update_craft_end_time(dt, t)
...
function HeroWindowCrafting:get_active_recipe()
	return self._active_recipe
end

function HeroWindowCrafting:craft(items, recipe_override)
...
function HeroWindowCrafting:craft_complete(result)
...
function HeroWindowCrafting:waiting_for_craft()
	return self._waiting_for_craft
end

function HeroWindowCrafting:is_crafting_anim_playing()
	return self._craft_start_duration ~= nil or
	self._craft_glow_in_duration ~= nil or
	self._craft_glow_wait_duration ~= nil or
	self._craft_glow_out_duration ~= nil or
	self._craft_end_duration ~= nil or
	self:waiting_for_craft()
end

function HeroWindowCrafting:cancel_crafting_animation()
...
function HeroWindowCrafting:lock_input()
...
function HeroWindowCrafting:unlock_input()
	local input_manager = self.input_manager
