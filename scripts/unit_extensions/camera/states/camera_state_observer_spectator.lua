...
local spectator_views = { "third_person", "first_person" }




local rotation_states = { "free", "follow", "locked" }





function CameraStateObserverSpectator:on_enter(unit, input, dt, context, t, previous_state, params)
...
function CameraStateObserverSpectator:update(unit, input, dt, context, t)
	local csm = self.csm
