...
local RPCS = { "rpc_sync_talents" }



local extension_list = { "TalentExtension", "HuskTalentExtension" }




function TalentSystem:init(entity_system_creation_context, system_name)
...
function TalentSystem:destroy()
	self.network_event_delegate:unregister(self)
	self.network_event_delegate = nil
end

function TalentSystem:on_add_extension(world, unit, extension_name, extension_init_data)
...
function TalentSystem:rpc_sync_talents(channel_id, unit_game_object_id, talent_ids)
...
function TalentSystem:hot_join_sync(peer_id)
