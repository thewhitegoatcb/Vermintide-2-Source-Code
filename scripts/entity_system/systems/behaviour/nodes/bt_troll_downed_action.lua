...
function BTTrollDownedAction:init(...)
	BTTrollDownedAction.super.init(self, ...)
end

function BTTrollDownedAction:enter(unit, blackboard, t)
...
function BTTrollDownedAction:leave(unit, blackboard, t, reason, destroy)
...
function BTTrollDownedAction:run(unit, blackboard, t, dt)
...
function BTTrollDownedAction:trigger_dialogue_event(unit, dialogue_event)
