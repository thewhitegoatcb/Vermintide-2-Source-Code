...
function BTCorruptorGrabAction:init(...)
	BTCorruptorGrabAction.super.init(self, ...)
end

BTCorruptorGrabAction.name = "BTCorruptorGrabAction"

function BTCorruptorGrabAction:enter(unit, blackboard, t)
...
function BTCorruptorGrabAction:leave(unit, blackboard, t, reason, destroy)
...
function BTCorruptorGrabAction:run(unit, blackboard, t, dt)
	local action = blackboard.action
...
function BTCorruptorGrabAction:attack(unit, t, dt, blackboard)
	local action = blackboard.action
...
function BTCorruptorGrabAction:drain_life(unit, blackboard)
...
function BTCorruptorGrabAction:anim_cb_damage(unit, blackboard)
...
function BTCorruptorGrabAction:overlap_players(unit, t, dt, blackboard)
...
function BTCorruptorGrabAction:grab_player(t, unit, blackboard)
	local target_unit = blackboard.corruptor_target
...
function BTCorruptorGrabAction:set_beam_state(unit, blackboard, state)
	local network_manager = Managers.state.network
