...
function CareerAbilityESMercenary:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityESMercenary:extensions_ready(world, unit)
...
function CareerAbilityESMercenary:destroy()
	return end

function CareerAbilityESMercenary:update(unit, input, dt, context, t)
...
function CareerAbilityESMercenary:stop(reason)
	if
...
function CareerAbilityESMercenary:_update_priming(dt)
...
function CareerAbilityESMercenary:_stop_priming()
	local effect_id = self._priming_fx_id
	if effect_id then
		local world = self._world
...
function CareerAbilityESMercenary:_run_ability(new_initial_speed)
	self:_stop_priming()
...
function CareerAbilityESMercenary:_play_vo()
	local owner_unit = self._owner_unit
...
function CareerAbilityESMercenary:_play_vfx()
	local owner_unit = self._owner_unit
