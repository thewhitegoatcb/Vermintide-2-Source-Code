...
function BTSelector_pet_skeleton:init(...)
	BTSelector_pet_skeleton.super.init(self, ...)
	self._children = { }
end

function BTSelector_pet_skeleton:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_pet_skeleton:run(unit, blackboard, t, dt)
	...
	local condition_result = ALIVE [blackboard.target_unit] and blackboard.confirmed_enemy_sighting_within_commander or blackboard.attack_locked_in_t and not blackboard.attack_aborted
...
function BTSelector_pet_skeleton:add_child(node)
