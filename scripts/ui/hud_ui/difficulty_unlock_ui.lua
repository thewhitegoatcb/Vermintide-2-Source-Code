...
function DifficultyUnlockUI:init(parent, ingame_ui_context)
	self._parent = parent
...
function DifficultyUnlockUI:create_ui_elements()
...
function DifficultyUnlockUI:difficulty_set()
...
function DifficultyUnlockUI:align_icon_widgets()
...
function DifficultyUnlockUI:destroy()
	self.ui_animator = nil
	self:set_visible(false)
end

function DifficultyUnlockUI:set_visible(visible)
...
function DifficultyUnlockUI:_check_for_presentation_start(mission_data)
...
function DifficultyUnlockUI:_update_start_timer(dt)
...
function DifficultyUnlockUI:update(dt, mission_data)
	if DO_RELOAD then
		DO_RELOAD = false
		self:create_ui_elements()
	end
...
function DifficultyUnlockUI:draw(dt)
	local ui_renderer = self.ui_renderer
	local ui_scenegraph = self.ui_scenegraph
...
function DifficultyUnlockUI:set_difficulty_amount(amount)
	self.icon_draw_count = amount
	self:align_icon_widgets()
end

function DifficultyUnlockUI:display_unlock(level_key, difficulty)
...
function DifficultyUnlockUI:on_presentation_complete()
	self.draw_widgets = false
end

function DifficultyUnlockUI:start_presentation_animation()
...
function DifficultyUnlockUI:start_explode_animation()
	local params = { wwise_world = self.wwise_world }
	local widgets = { }
