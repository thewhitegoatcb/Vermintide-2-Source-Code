...
function BTSelector_stormfiend_boss:init(...)
	BTSelector_stormfiend_boss.super.init(self, ...)
	self._children = { }
end

function BTSelector_stormfiend_boss:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_stormfiend_boss:run(unit, blackboard, t, dt)
...
function BTSelector_stormfiend_boss:add_child(node)
