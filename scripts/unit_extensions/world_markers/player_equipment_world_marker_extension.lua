...
function PlayerEquipmentWorldMarkerExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerEquipmentWorldMarkerExtension:_extensions_ready()
...
function PlayerEquipmentWorldMarkerExtension:_add_marker(cb)
	local unit = self._unit
...
function PlayerEquipmentWorldMarkerExtension:update(unit, dummy_input, dt, context, t)
