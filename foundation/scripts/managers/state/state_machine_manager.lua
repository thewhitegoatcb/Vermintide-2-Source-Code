...
function StateMachineManager:init()
...
function StateMachineManager:update(dt)
...
function StateMachineManager:destroy()
	if StateMachineManager.DEBUG and
	self._gui ~= nil then
...
function StateMachineManager:_register_state_machine(state_machine)
	self._state_machines [#self._state_machines + 1] = state_machine
end



function StateMachineManager:_unregister_state_machine(state_machine)
...
function StateMachineManager:_root_state_machines()
	local result = { }
...
function StateMachineManager:_state_machines_column_width(state_machines)
	local width = 0
...
function StateMachineManager:_draw_panel()
