...
function SearchUtils.extract_queries(query, definitions, results)
...
local find = string.find local lower = Utf8.lower
function SearchUtils.simple_search(needle, haystack)
