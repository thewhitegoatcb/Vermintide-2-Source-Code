...
local weapon_template = {
	...
	actions = {
		action_one = {
			default = { damage_window_start = 0.05, ammo_usage = 1, anim_end_event = "attack_finished", kind = "buff", buff_template = "damage_boost_potion", damage_window_end = 0.2, weapon_action_hand = "left", block_pickup = true, uninterruptible = true, anim_event = "attack_heal", total_time = 1.3,
...
damage_boost_potion.pickup_data = { pickup_name = "damage_boost_potion" }
...
speed_boost_potion.pickup_data = { pickup_name = "speed_boost_potion" }
...
invulnerability_potion.pickup_data = { pickup_name = "invulnerability_potion" }
...
cooldown_reduction_potion.pickup_data = { pickup_name = "cooldown_reduction_potion" }
