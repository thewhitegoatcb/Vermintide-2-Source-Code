...
local widgets = {
	...
	craft_button = UIWidgets.create_default_button("craft_button", scenegraph_definition.craft_button.size, nil, nil, Localize("hero_view_crafting_upgrade"), 24, nil, "button_detail_02", nil, disable_with_gamepad),
