...
function HeroWindowHeroPowerConsole:on_enter(params, offset)
...
function HeroWindowHeroPowerConsole:_start_transition_animation(animation_name)
	local params = {
...
function HeroWindowHeroPowerConsole:create_ui_elements(params, offset)
...
function HeroWindowHeroPowerConsole:on_exit(params)
	print("[HeroViewWindow] Exit Substate HeroWindowHeroPowerConsole")
	self.ui_animator = nil
end

function HeroWindowHeroPowerConsole:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowHeroPowerConsole:post_update(dt, t)

	return end

function HeroWindowHeroPowerConsole:_update_animations(dt)
...
function HeroWindowHeroPowerConsole:_is_button_pressed(widget)
...
function HeroWindowHeroPowerConsole:set_focus(focused)
	self._focused = focused
end

function HeroWindowHeroPowerConsole:_update_loadout_sync()
...
function HeroWindowHeroPowerConsole:_has_hero_level_changed()
...
function HeroWindowHeroPowerConsole:_calculate_power_level()
...
function HeroWindowHeroPowerConsole:_update_hero_power_effect(dt)
...
function HeroWindowHeroPowerConsole:_exit()
	self.exit = true
end

function HeroWindowHeroPowerConsole:draw(dt)
...
function HeroWindowHeroPowerConsole:_play_sound(event)
