...
local function _spawn_skeleton_ability_fx(source_unit, target_position, buff, world)
	...
	local spline_points = { start_pos, mid_point, target_position }
...
local function _on_death_damage_nearby(owner_unit, buff, params, world)
	...
	if closest_enemy then
		...
		if enemy_buff_ext then
			...
			local damage_lookup = {
				normal = { 12, 24, 32, 40, 120 },
				hard = { 18, 36, 48, 60, 180 },
				harder = { 26.25, 52.5, 70, 87.5, 262.5 },
				hardest = { 39.75, 79.5, 106, 132.5, 397.5 },
				cataclysm = { 50.25, 100.5, 134, 167.5, 500 } }
...
local function _spawn_skeleton_ability(necromancer_unit, spawn_data, spawn_index)
	if not ALIVE [necromancer_unit] then return end
...
settings.buff_templates = {
	...
	sienna_necromancer_passive_cursed_blood = {
		buffs = { { event = "on_critical_hit", name = "sienna_necromancer_passive_cursed_blood", buff_func = "necromancer_apply_cursed_blood" } } },
	...
	sienna_necromancer_career_skill_damage_proc_aura = {
		buffs = { { ai_buff_name = "sienna_necromancer_career_skill_damage_proc_aura_buff_ai", range = 15, name = "sienna_necromancer_career_skill_damage_proc_aura", remove_buff_func = "remove_side_buff_aura", owner_as_source = true, player_buff_name = "sienna_necromancer_career_skill_damage_proc_aura_buff", server_only = true, update_func = "side_buff_aura", update_frequency = 1 } } },
	...
	sienna_necromancer_career_skill_damage_proc_aura_buff = {
		buffs = { { max_stacks = 1, name = "sienna_necromancer_career_skill_damage_proc_aura_buff", damage = 10, buff_func = "sienna_necromancer_career_skill_damage_proc", event = "on_hit" } } },
	...
	sienna_necromancer_career_skill_damage_proc_aura_buff_ai = {
		buffs = { { max_stacks = 1, name = "sienna_necromancer_career_skill_damage_proc_aura_buff_ai", damage = 10, buff_func = "sienna_necromancer_career_skill_damage_proc", event = "on_damage_dealt" } } },
	...
	sienna_necromancer_career_skill_on_hit_damage = {
		buffs = { { remove_buff_func = "remove_attach_particle", name = "sienna_necromancer_career_skill_on_hit_damage", offset_rotation_y = 90, particle_fx = "fx/skull_trap", max_stacks = 1, duration = 10, apply_buff_func = "sienna_necromancer_on_hit_apply" } } },
	...
	necromancer_cursed_blood = {
		buffs = { { explosion_template = "sienna_necromancer_passive_explosion", name = "necromancer_cursed_blood", max_stacks = 1, buff_func = "necromancer_cursed_blood_on_death", event = "on_death", debuff_spread_radius = 5 } } },
	...
	necromancer_skeleton_timer = {
		buffs = { { icon = "sienna_necromancer_6_1", name = "necromancer_cursed_blood", duration = 20 } } },
	...
	necromancer_harvest_curse = {
		buffs = { { max_stacks = 1, name = "necromancer_harvest_curse" } } },
	...
	necromancer_on_death_delayed_health_damage = {
		buffs = { { debuff_spread_radius = 5, name = "necromancer_on_death_delayed_health_damage", remove_on_proc = true, buff_func = "delayed_health_damage", event = "on_death", apply_buff_func = "setup_delayed_damage", update_start_delay = 0.1, max_stacks = 1, update_func = "delayed_health_damage" } } },
	...
	necromancer_cursed_blood_dot = {
		buffs = { { debuff_spread_radius = 5, name = "necromancer_cursed_blood", damage_profile = "bleed", buff_func = "necromancer_cursed_blood_on_death", event = "on_death", apply_buff_func = "start_dot_damage", update_start_delay = 1.5, explosion_template = "sienna_necromancer_passive_explosion", time_between_dot_damages = 1.5, max_stacks = 1, update_func = "apply_dot_damage",
	...
	necromancer_cursed_blood_delayed_damage = {
		buffs = { { name = "necromancer_cursed_blood_delayed_damage", max_stacks = 1, update_func = "remove_and_apply_cursed_blood", apply_buff_func = "setup_delayed_damage", update_start_delay = 0.3 } } },
	...
	sienna_necromancer_pet_on_spawn_buff = {
		buffs = { { remove_buff_func = "sienna_necromancer_expire_spawned_pet", name = "lifetime" },




			{ event = "on_damage_dealt", name = "hud_sound_trigger", buff_func = "on_pet_damage_dealt",




				sounds_to_play = { "career_necro_skeleton_damage" } } } },
	...
	sienna_necromancer_pet_on_spawn_buff_charge = {
		buffs = { { event = "on_death", name = "pet_tracker", buff_func = "add_pet_charge" } } },
	...
	sienna_necromancer_pet_attack_sfx = {
		buffs = { { event = "on_damage_dealt", name = "hud_sound_trigger", buff_func = "on_pet_damage_dealt",
	...
	sienna_necromancer_perk_1 = {
		buffs = { { update_func = "sienna_necromancer_perk_1_func", name = "sienna_necromancer_perk_1", radius = 5, devour_health_percent = 0.15 } } },
	...
	necromancer_invulnerability_aura = {
		buffs = { { max_stacks = 1, name = "necromancer_invulnerability_aura", icon = "sienna_necromancer_passive",
	...
	sienna_necromancer_perk_3 = {
		buffs = { { event = "on_kill", name = "sienna_necromancer_perk_3", buff_to_add = "sienna_necromancer_lifetaker_crit", buff_func = "add_buff" } } },
	...
	sienna_necromancer_lifetaker_crit = {
		buffs = { { refresh_durations = true, name = "sienna_necromancer_lifetaker_crit", stat_buff = "critical_strike_chance", icon = "sienna_necromancer_passive",
	...
	sienna_pets_alive_cooldown = {
		buffs = { { multiplier = 5, name = "sienna_pets_alive_cooldown", stat_buff = "cooldown_regen" } } },
	...
	sienna_pet_spawn_charge = {
		buffs = { { duration = 20, name = "sienna_pet_spawn_charge", refresh_other_stacks_on_remove = true, duration_end_func = "spawn_pet", max_stacks = 4, icon = "unit_frame_portrait_pet_skeleton", is_cooldown = true } } },
	...
	necromancer_pet_ping_explosion = {
		buffs = { { remove_buff_func = "pet_ping_explosion", name = "sienna_pet_ping_explosion",



				particles = { { orphaned_policy = "destroy", effect = "fx/warp_lightning_bolt", third_person = true, first_person = false, link_node = "j_spine", continuous = true, destroy_policy = "destroy" } } } } },
	...
	sienna_necromancer_empowered_overcharge = {
		buffs = { { stat_buff = "overcharge_damage_immunity", name = "sienna_necromancer_empowered_overcharge", buff_func = "sienna_necromancer_empowered_overcharge_kill", max_stacks = 1, icon = "sienna_necromancer_6_3", event = "on_kill", percent_overcharge = 0.1,
	...
	death_staff_dot = {
		buffs = { { duration = 6, name = "death_staff_dot", apply_buff_func = "start_dot_damage", update_start_delay = 1, time_between_dot_damages = 1, damage_type = "burninating", damage_profile = "death_staff_dot", update_func = "apply_dot_damage",
	...
	dual_wield_skeleton_attack_speed = {
		buffs = { { value = 1, name = "dual_wield_skeleton_attack_speed", apply_buff_func = "apply_ai_attack_speed", remove_buff_func = "remove_ai_attack_speed" } } },
	...
	update_anim_movespeed = {
		buffs = { { update_func = "update_anim_movespeed", name = "update_anim_movespeed" } } },
	...
	raise_dead_ability = {
		buffs = { { update_frequency = 0.2, name = "raise_dead_ability", remove_buff_on_duration_end = true, update_func = "raise_dead_update", apply_buff_func = "on_raise_dead_start", update_start_delay = 0.2,
			...
			{ name = "raise_dead_ability_curse_aura", buff_area_buff = "sienna_necromancer_career_skill_on_hit_damage", enter_area_func = "enter_buff_area", buff_area = true, area_unit_name = "units/hub_elements/empty", exit_area_func = "exit_buff_area", buff_enemies = true,
				...
				area_radius = ability_radius },
			{ num_small_decals = 0, name = "raise_dead_ability_visuals", delay = 0.02, remove_buff_func = "raise_dead_remove", apply_buff_func = "raise_dead_apply", skull_spawn_frequency = 0.15, update_func = "raise_dead_visual_update",
				...
				unit_names = { "units/decals/necromancer_ability_decal_mark1", "units/decals/necromancer_ability_decal_mark2", "units/decals/necromancer_ability_decal_mark3", "units/decals/necromancer_ability_decal_mark4", "units/decals/necromancer_ability_decal_mark5", "units/decals/necromancer_ability_decal_mark6" },
	...
	raise_dead_ability_stagger = {
		buffs = { { max_stacks = 1, name = "raise_dead_ability_stagger", update_func = "necromancer_ability_stagger_update", update_frequency = 0.75,
			...
			{ max_stacks = 1, name = "raise_dead_ability_stagger_visuals", update_func = "necromancer_ability_stagger_hands" } } },
	...
	command_elite_challenge_tracker = {
		buffs = { { max_stacks = 1, name = "command_elite_challenge_tracker" } } },
	...
	skeleton_command_attack_boost = {
		buffs = { { multiplier = 1, name = "skeleton_command_attack_boost", stat_buff = "damage_dealt", duration = 8, max_stacks = 1, refresh_durations = true } } },
	...
	skeleton_command_defend_boost = {
		buffs = { { multiplier = -0.12, name = "skeleton_command_defend_boost", stat_buff = "damage_taken" } } } }
...
settings.proc_functions = {
	...
	necromancer_ability_register_stagger = function (entering_unit, owner_unit, template, buff_area_unit, source_unit)
		if not ALIVE [entering_unit] then return
		end
	...
	necromancer_ability_unregister_stagger = function (leaving_unit, owner_unit, template, buff_area_unit, source_unit)
		if not ALIVE [leaving_unit] then return
		end
...
settings.buff_function_templates = {
	sienna_necromancer_perk_1_func = function (unit, buff, params)
		...
		if ALIVE [player_unit] and Managers.player.is_server then
			...
			for i = 1, num_nearby_enemy_units do
				...
				if ALIVE [enemy_unit] and
				side_manager:is_enemy(player_unit, enemy_unit) then
					local health_extension = ScriptUnit.has_extension(enemy_unit, "health_system")
					if
					health_extension and health_extension:current_health_percent() < devour_health_percent then
	...
	necromancer_update_knockdown_damage_immunity = function (necromancer_unit, buff, params)
		...
		for i = 1, #player_units do repeat
				...
				if not ALIVE [other_unit] then
					...
					if side_disabled or not status_ext:is_knocked_down() then
						...
						elseif not tracked_buff_id then
							...
							tracked_players [other_unit] = buff_id end end end until true
		end
	...
	necromancer_cursed_area_buff = function (owner_unit, buff, params)
		...
		if is_local(owner_unit) and not is_bot(owner_unit) then --[[ Nothing --]]
		end
	...
	necromancer_cursed_area_buff_remove = function (owner_unit, buff, params)
		...
		if is_local(unit) and not is_bot(unit) then --[[ Nothing --]]
		end
	...
	raise_dead_remove = function (owner_unit, buff, params, world)
		if is_local(buff.source_attacker_unit) and
