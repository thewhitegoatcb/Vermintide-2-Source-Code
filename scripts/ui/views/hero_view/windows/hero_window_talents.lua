...
function HeroWindowTalents:on_enter(params, offset)
...
function HeroWindowTalents:on_exit(params)
...
function HeroWindowTalents:create_ui_elements(params, offset)
...
function HeroWindowTalents:_initialize_talents()
	local career_name = self._career_name
...
function HeroWindowTalents:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
function HeroWindowTalents:post_update(dt, t)

	return end

function HeroWindowTalents:_update_talent_sync(initialize)
	self:_populate_talents_by_hero(initialize)
	self:_populate_career_info(initialize)
end

function HeroWindowTalents:_update_animations(dt)
...
function HeroWindowTalents:_is_button_pressed(widget)
...
function HeroWindowTalents:_is_button_released(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
function HeroWindowTalents:_is_stepper_button_pressed(widget)
	local content = widget.content
...
function HeroWindowTalents:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter and not hotspot.is_selected
end

function HeroWindowTalents:_handle_input(dt, t)
...
function HeroWindowTalents:draw(dt)
...
function HeroWindowTalents:_play_sound(event)
	self.parent:play_sound(event)
end

function HeroWindowTalents:_populate_talents_by_hero(initialize)
	self:_clear_talents()
...
function HeroWindowTalents:_clear_talents()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalents:_is_talent_pressed()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalents:_is_talent_hovered()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalents:_is_disabled_talent_hovered()
	local widgets_by_name = self._widgets_by_name
...
function HeroWindowTalents:_populate_career_info(initialize)
	local hero_name = self.hero_name
	local career_index = self.career_index
	local profile_index = FindProfileIndex(hero_name)
	local profile = SPProfiles [profile_index]
...
function HeroWindowTalents:_animate_pulse(target, target_index, from, to, speed)
