...
function BTSelector_storm_vermin_warlord:init(...)
	BTSelector_storm_vermin_warlord.super.init(self, ...)
	self._children = { }
end

function BTSelector_storm_vermin_warlord:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_storm_vermin_warlord:run(unit, blackboard, t, dt)
	...
	if condition_result then
		self:set_running_child(unit, blackboard, t, node_jump_to_position, "aborted")


		local result, evaluate = node_jump_to_position:run(unit, blackboard, t, dt)
	...
	if condition_result then
		...
		local result, evaluate = node_in_defensive:run(unit, blackboard, t, dt)
...
function BTSelector_storm_vermin_warlord:add_child(node)
