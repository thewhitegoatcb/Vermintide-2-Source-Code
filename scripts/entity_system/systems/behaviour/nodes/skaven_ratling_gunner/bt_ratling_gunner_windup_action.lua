...
function BTRatlingGunnerWindUpAction:init(...)
	BTRatlingGunnerWindUpAction.super.init(self, ...)
end

function BTRatlingGunnerWindUpAction:enter(unit, blackboard, t)
...
function BTRatlingGunnerWindUpAction:_update_target(unit, blackboard, data, t)
...
function BTRatlingGunnerWindUpAction:leave(unit, blackboard, t, reason, destroy)
...
function BTRatlingGunnerWindUpAction:run(unit, blackboard, t, dt)
