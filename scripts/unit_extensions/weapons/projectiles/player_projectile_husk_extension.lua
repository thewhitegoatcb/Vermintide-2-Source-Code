...
function PlayerProjectileHuskExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerProjectileHuskExtension:destroy()
	if self._projectile_unit and self._active and not self.is_server then
		self:stop()
	end
end

function PlayerProjectileHuskExtension:extensions_ready(world, unit)
	self.locomotion_extension = ScriptUnit.extension(unit, "projectile_locomotion_system")
end

function PlayerProjectileHuskExtension:initialize_projectile(projectile_info, impact_data)
...
function PlayerProjectileHuskExtension:_handle_critical_strike(unit, is_critical_strike)
	if self._is_critical_strike then
		Unit.flow_event(unit, "vfx_critical_strike")
	end
end

function PlayerProjectileHuskExtension:update(unit, input, _, context, t)
...
function PlayerProjectileHuskExtension:stop(hit_unit, hit_zone_name)
...
function PlayerProjectileHuskExtension:_stop_by_life_time()
	Unit.flow_event(self._projectile_unit, "lua_projectile_end")
	self._active = false
	self.locomotion_extension:stop()
	self._stop_impacts = true
...
function PlayerProjectileHuskExtension:handle_timed_events(t)
...
function PlayerProjectileHuskExtension:impact_level(hit_unit, hit_position, hit_direction, hit_normal, hit_actor, level_index)
...
function PlayerProjectileHuskExtension:_on_impact()
	local timed_data = self._timed_data
...
function PlayerProjectileHuskExtension:_activate_life_time(game_time)
	local timed_data = self._timed_data
...
function PlayerProjectileHuskExtension:impact_dynamic(hit_unit, hit_position, hit_direction, hit_normal, hit_actor)
	local impact_data = self._impact_data
	local breed = Unit.get_data(hit_unit, "breed")
	local has_ranged_boost = false local ranged_boost_curve_multiplier = 0
...
function PlayerProjectileHuskExtension:hit_afro(breed, hit_actor)
...
function PlayerProjectileHuskExtension:hit_enemy(impact_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, breed, hit_units, ranged_boost_curve_multiplier)
...
function PlayerProjectileHuskExtension:hit_enemy_damage(damage_profile, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, breed, ranged_boost_curve_multiplier, hit_units)
...
function PlayerProjectileHuskExtension:hit_player(impact_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, hit_units, ranged_boost_curve_multiplier)
	if hit_actor == nil then
		return
	end
...
function PlayerProjectileHuskExtension:hit_player_damage(damage_profile, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, ranged_boost_curve_multiplier, hit_units)
	local owner_unit = self._owner_unit
	hit_units [hit_unit] = true
...
function PlayerProjectileHuskExtension:hit_level_unit(impact_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, hit_units, level_index, ranged_boost_curve_multiplier)
...
function PlayerProjectileHuskExtension:hit_damagable_prop(damage_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, hit_units, level_index, ranged_boost_curve_multiplier)
	hit_units [hit_unit] = true
end

function PlayerProjectileHuskExtension:hit_non_level_unit(impact_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, hit_units, ranged_boost_curve_multiplier)
	local damage_profile_name = impact_data.damage_profile_prop or impact_data.damage_profile or "default"
	local damage_profile = DamageProfileTemplates [damage_profile_name]
...
function PlayerProjectileHuskExtension:hit_non_level_damagable_unit(damage_profile, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, hit_units, ranged_boost_curve_multiplier)
	hit_units [hit_unit] = true
...
function PlayerProjectileHuskExtension:_get_projectile_units_names(projectile_info)
...
function PlayerProjectileHuskExtension:_handle_linking(impact_data, hit_unit, hit_position, hit_direction, hit_normal, hit_actor, damage_amount, hit_enemy)
...
function PlayerProjectileHuskExtension:_link_projectile(hit_unit, hit_actor, linker_unit_name, hit_position, hit_direction, depth, flow_event_on_init, flow_event_on_walls)
...
function PlayerProjectileHuskExtension:do_aoe(aoe_data, position)
	local world = self._world
	local unit = self._projectile_unit
	local owner_unit = self._owner_unit
...
function PlayerProjectileHuskExtension:trigger_external_event(event_name, network_sync)
