...
local LOADOUT_INTERFACE_OVERRIDES = { slot_hat = "items", slot_skin = "items", slot_frame = "items", slot_melee = "weaves", slot_ranged = "weaves" }
...
function BackendInterfaceWeavesPlayFab:init(backend_mirror)
...
function BackendInterfaceWeavesPlayFab:_validate_backend_progression_settings(progression_settings)
...
function BackendInterfaceWeavesPlayFab:_parse_loadouts()
	local loadouts = { }
...
function BackendInterfaceWeavesPlayFab:_validate_loadout(career_name, loadout)
...
function BackendInterfaceWeavesPlayFab:_parse_career_progress()
...
function BackendInterfaceWeavesPlayFab:_new_id()
	self._last_id = self._last_id and self._last_id + 1 or 1

	return self._last_id
end

function BackendInterfaceWeavesPlayFab:_create_leaderboard_entry(data, previous_tier, previous_score)
	if not data then
		local entry = { score = "-", name = "-", weave = "-", ranking = "-", local_player = false }
...
function BackendInterfaceWeavesPlayFab:_get_magic_inventory_item(item_backend_id)
	local inventory_items = self._backend_mirror:get_all_inventory_items()
	local item = inventory_items [item_backend_id]
...
function BackendInterfaceWeavesPlayFab:_update_item_custom_data(item_backend_id, item_loadout)
...
function BackendInterfaceWeavesPlayFab:_get_loadout_mastery_cost(loadout)
	local total_cost = 0
	local progression_settings = self._progression_settings
...
function BackendInterfaceWeavesPlayFab:ready()
	return true
end



function BackendInterfaceWeavesPlayFab:submit_scores(tier, score, num_players)
	...
	local submit_weave_score_request = { FunctionName = "submitWeaveScore",
...
function BackendInterfaceWeavesPlayFab:submit_weave_score_request_cb()
	return end

function BackendInterfaceWeavesPlayFab:request_player_rank(stat_name, leaderboard_type, external_error_cb)
	local player_rank_request = { MaxResultsCount = 1,
...
function BackendInterfaceWeavesPlayFab:player_rank_request_cb(result)
...
function BackendInterfaceWeavesPlayFab:request_leaderboard_around_player(stat_name, leaderboard_type, max_result_count, external_error_cb)
...
function BackendInterfaceWeavesPlayFab:request_leaderboard_around_player_cb(result)
...
function BackendInterfaceWeavesPlayFab:get_player_entry()
	return self._player_entry
end

function BackendInterfaceWeavesPlayFab:request_leaderboard(stat_name, start_position, leaderboard_type, external_error_cb)
	local leaderboard_request = { MaxResultsCount = 100,
		StatisticName = stat_name,
		ProfileConstraints = { ShowLinkedAccounts = true },
...
function BackendInterfaceWeavesPlayFab:leaderboard_request_cb(result)
	local leaderboard = result.Leaderboard
...
function BackendInterfaceWeavesPlayFab:is_requesting_leaderboard()
	return self._requesting_leaderboard > 0
end

function BackendInterfaceWeavesPlayFab:get_leaderboard_entries()
	return self._leaderboard_entries
end

function BackendInterfaceWeavesPlayFab:has_leaderboard_request_failed()
	return self._leaderboard_player_rank_error or self._leaderboard_request_error
end

function BackendInterfaceWeavesPlayFab:player_rank_request_failed_cb(external_error_cb, result, reenable_queue_function)
	self._requesting_leaderboard = self._requesting_leaderboard - 1
...
function BackendInterfaceWeavesPlayFab:request_leaderboard_failed_cb(external_error_cb, result, reenable_queue_function)
	self._requesting_leaderboard = self._requesting_leaderboard - 1
...
function BackendInterfaceWeavesPlayFab:get_mastery(career_name, optional_item_backend_id)
...
function BackendInterfaceWeavesPlayFab:get_essence()
	return self._backend_mirror:get_essence()
end

function BackendInterfaceWeavesPlayFab:get_total_essence()
	return self._backend_mirror:get_total_essence()
end

function BackendInterfaceWeavesPlayFab:get_maximum_essence()
...
function BackendInterfaceWeavesPlayFab:get_average_power_level(career_name)
	local loadout = self._loadouts [career_name]
...
function BackendInterfaceWeavesPlayFab:get_total_magic_level(career_name)
...
function BackendInterfaceWeavesPlayFab:max_magic_level()
	local magic_levels = self._progression_settings.magic_levels
	local num_levels = #magic_levels
	return num_levels
end

function BackendInterfaceWeavesPlayFab:get_career_power_level(career_name)
	local magic_level = self:get_career_magic_level(career_name)
...
function BackendInterfaceWeavesPlayFab:get_career_magic_level(career_name)
...
function BackendInterfaceWeavesPlayFab:career_upgrade_cost(career_name)
...
function BackendInterfaceWeavesPlayFab:upgrade_career_magic_level(career_name, external_cb)
	...
	local request = { FunctionName = "upgradeCareerMagicLevel",
...
function BackendInterfaceWeavesPlayFab:upgrade_career_magic_level_cb(external_cb, result)
...
function BackendInterfaceWeavesPlayFab:get_item_magic_level(item_backend_id)
	local item = self:_get_magic_inventory_item(item_backend_id)
...
function BackendInterfaceWeavesPlayFab:get_item_power_level(item_backend_id)
...
function BackendInterfaceWeavesPlayFab:magic_item_upgrade_cost(item_backend_id)
...
function BackendInterfaceWeavesPlayFab:upgrade_item_magic_level(item_backend_id, external_cb)
	...
	local request = { FunctionName = "upgradeItemMagicLevel",
...
function BackendInterfaceWeavesPlayFab:upgrade_item_magic_level_cb(external_cb, result)
	local function_result = result.FunctionResult
...
function BackendInterfaceWeavesPlayFab:magic_item_cost(item_id)
...
function BackendInterfaceWeavesPlayFab:buy_magic_item(item_id, external_cb)
	...
	local request = { FunctionName = "buyMagicItem",
...
function BackendInterfaceWeavesPlayFab:buy_magic_item_cb(external_cb, result)
	local function_result = result.FunctionResult
...
function BackendInterfaceWeavesPlayFab:get_forge_level()
	return self._forge_level
end

function BackendInterfaceWeavesPlayFab:forge_max_level()
	local forge_levels = self._progression_settings.forge_levels
	local num_levels = #forge_levels
	return num_levels
end

function BackendInterfaceWeavesPlayFab:forge_magic_level_cap()
...
function BackendInterfaceWeavesPlayFab:forge_upgrade_cost()
...
function BackendInterfaceWeavesPlayFab:upgrade_forge(external_cb)
	...
	local request = { FunctionName = "upgradeWeaveForge",
...
function BackendInterfaceWeavesPlayFab:upgrade_forge_cb(external_cb, result)
	local function_result = result.FunctionResult
...
function BackendInterfaceWeavesPlayFab:get_property_mastery_costs(property_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.properties [property_name]
...
function BackendInterfaceWeavesPlayFab:get_property_required_forge_level(property_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.properties [property_name]
...
function BackendInterfaceWeavesPlayFab:set_loadout_property(career_name, property_name, slot_index, optional_item_backend_id)
	...
	if optional_item_backend_id then
		...
		if not item_loadout then
			...
			item_loadout = { properties = { }, traits = { } }
...
function BackendInterfaceWeavesPlayFab:remove_loadout_property(career_name, property_name, slot_index, optional_item_backend_id)
	local loadout = self._loadouts [career_name]
	if optional_item_backend_id then
		loadout = loadout.item_loadouts [optional_item_backend_id]
	end
...
function BackendInterfaceWeavesPlayFab:get_loadout_properties(career_name, optional_item_backend_id)
	local loadout = self._loadouts [career_name]
...
function BackendInterfaceWeavesPlayFab:get_trait_mastery_cost(trait_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.traits [trait_name]
...
function BackendInterfaceWeavesPlayFab:get_trait_required_forge_level(trait_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.traits [trait_name]
	local required_forge_level = progression_data.required_forge_level
...
function BackendInterfaceWeavesPlayFab:set_loadout_trait(career_name, trait_name, slot_index, optional_item_backend_id)
...
function BackendInterfaceWeavesPlayFab:remove_loadout_trait(career_name, trait_name, optional_item_backend_id)
	local loadout = self._loadouts [career_name]
	if optional_item_backend_id then
		loadout = loadout.item_loadouts [optional_item_backend_id]
	end
...
function BackendInterfaceWeavesPlayFab:get_loadout_traits(career_name, optional_item_backend_id)
	local loadout = self._loadouts [career_name]
	local traits = nil
	if optional_item_backend_id then
		local item_loadout = loadout.item_loadouts [optional_item_backend_id]
...
function BackendInterfaceWeavesPlayFab:apply_career_item_loadouts(career_name)
	if career_name then
		local loadout = self._loadouts [career_name]
...
function BackendInterfaceWeavesPlayFab:get_talent_mastery_cost(talent_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.talents [talent_name]
	local mastery_cost = progression_data.mastery_cost
...
function BackendInterfaceWeavesPlayFab:get_talent_required_forge_level(talent_name)
	local progression_settings = self._progression_settings
	local progression_data = progression_settings.talents [talent_name]
	local required_forge_level = progression_data.required_forge_level
...
function BackendInterfaceWeavesPlayFab:set_loadout_talent(career_name, talent_name, slot_index)
...
function BackendInterfaceWeavesPlayFab:remove_loadout_talent(career_name, talent_name)
	local loadout = self._loadouts [career_name]
	local loadout_talents = loadout.talents
...
function BackendInterfaceWeavesPlayFab:get_loadout_talents(career_name)
	local loadout = self._loadouts [career_name]
	local loadout_talents = loadout.talents
...
function BackendInterfaceWeavesPlayFab:get_talent_ids(career_name)
...
function BackendInterfaceWeavesPlayFab:get_talent_tree(career_name)
...
function BackendInterfaceWeavesPlayFab:get_talents(career_name)
	local loadout = self._loadouts [career_name]
	local loadout_talents = loadout.talents
...
function BackendInterfaceWeavesPlayFab:get_total_power_level(profile_name, career_name)
	return self:get_average_power_level(career_name)
end



function BackendInterfaceWeavesPlayFab:has_loadout_item_id(career_name, item_id)
	local loadout = self._loadouts [career_name]
...
function BackendInterfaceWeavesPlayFab:get_loadout_item_id(career_name, slot_name)
...
function BackendInterfaceWeavesPlayFab:set_loadout_item(item_backend_id, career_name, slot_name)
...
function BackendInterfaceWeavesPlayFab:get_dirty_user_data()
...
function BackendInterfaceWeavesPlayFab:clear_dirty_user_data()
