...
local scenegraph_definition = {
	...
	loading_overlay = { vertical_alignment = "center", parent = "root_fit", horizontal_alignment = "center", size = { 314, 33 }, position = { 0, 0, 1 } } }


local loading_overlay_widgets = {
	loading_overlay = UIWidgets.create_simple_rect("root_fit", { 255, 12, 12, 12 }),
...
local camera_position_by_character = {
	witch_hunter = { z = 0.4, x = 1, y = -0.4 },




	bright_wizard = { z = 0.2, x = 1, y = -0.7 },




	dwarf_ranger = { z = 0, x = 1, y = -0.6 },




	wood_elf = { z = 0.16, x = 1, y = -0.5 },




	empire_soldier = { z = 0.2, x = 1, y = -0.6 },




	empire_soldier_tutorial = { z = 0.2, x = 1, y = -0.6 } }
