...
settings.buff_templates = {
	slayer_curse_debuff = {
		buffs = { { name = "slayer_curse_debuff", icon = "buff_icon_mutator_icon_slayer_curse", debuff = true,
	...
	mutator_bloodlust = {
		buffs = { { icon = "bardin_slayer_crit_chance", name = "mutator_bloodlust", stat_buff = "attack_speed", multiplier = 0.05, max_stacks = 10, duration = 4, refresh_durations = true },
			...
			{ remove_buff_func = "remove_movement_buff", name = "mutator_bloodlust_movement", multiplier = 1.05, max_stacks = 10, duration = 4, apply_buff_func = "apply_movement_buff", refresh_durations = true,
			...
			{ duration = 4, name = "mutator_bloodlust_trigger", refresh_durations = true, max_stacks = 10, remove_buff_func = "remove_bloodlust", apply_buff_func = "apply_bloodlust" } } },
	...
	mutator_bloodlust_debuff = {
		buffs = { { update_func = "update_bloodlust_debuff", name = "mutator_bloodlust_debuff", damage_percentage = 0.05, icon = "troll_vomit_debuff", remove_buff_func = "remove_bloodlust_debuff", apply_buff_func = "apply_bloodlust_debuff", damage_frequency = 1 } } } }
