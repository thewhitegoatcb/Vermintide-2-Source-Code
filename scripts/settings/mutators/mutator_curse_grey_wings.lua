...
return { description = "curse_grey_wings_desc", curse_package_name = "resource_packages/mutators/mutator_curse_grey_wings", display_name = "curse_grey_wings_name", icon = "deus_curse_belakor_01",
