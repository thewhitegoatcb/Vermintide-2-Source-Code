...
BreedBehaviors.skaven_warpfire_thrower = { "BTSelector",
	...
	{ "BTSequence",
		{ "BTPackMasterSkulkAroundAction", name = "skulk", condition = "path_found",
			action_data = ACTIONS.skulk }, { "BTPackMasterFollowAction", name = "follow", condition = "path_found",
			action_data = ACTIONS.follow }, { "BTWarpfireThrowerShootAction", name = "shoot_warpfire_thrower",
			action_data = ACTIONS.shoot_warpfire_thrower }, condition = "can_see_player", name = "enemy_spotted" },
	{ "BTTriggerMoveToAction", condition = "can_trigger_move_to", name = "trigger_move_to" },
	{ "BTIdleAction", name = "idle" }, name = "skaven_warpfire_thrower" }