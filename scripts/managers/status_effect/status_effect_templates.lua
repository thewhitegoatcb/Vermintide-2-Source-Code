...
local base_effect = { default_timed_duration = 7,
...
StatusEffectTemplates.burning.unit_material_variable = { variable_name = "dissolve_emissive",

	value = { 7, 1, 0.02 } }

StatusEffectTemplates.burning.death_unit_material_variable = { variable_name = "dissolve_emissive",

	value = { 7, 1, 0.02 } }

StatusEffectTemplates.burning.particle_material_variable = { variable_name = "remap_index", value = 0, cloud_name = "fire" }
...
StatusEffectTemplates.burning.particle_by_category = { small = "fx/chr_impact_fire_small_remap", medium = "fx/chr_impact_fire_medium_remap", large = "fx/chr_impact_fire_large_remap" }
...
function StatusEffectTemplates.burning_death_critical.on_applied(unit, reason, status_template, world)
...
function StatusEffectTemplates.burning_death_critical.on_decrement(unit, reason, status_template, world, apply_data)
...
StatusEffectTemplates.burning_warpfire.particle_by_category = { small = "fx/chr_impact_fire_small_remap" }


StatusEffectTemplates.burning_warpfire.unit_material_variable.value = { 2, 5, 0.02 }
...
StatusEffectTemplates.burning_warpfire_death_critical.unit_material_variable.value = { 2, 5, 0.02 }
...
StatusEffectTemplates.burning_elven_magic.unit_material_variable.value = { 0.45, 0.4, 1.25 }
...
StatusEffectTemplates.burning_elven_magic_death_critical.unit_material_variable.value = { 0.45, 0.4, 1.25 }
...
StatusEffectTemplates.burning_balefire.unit_material_variable.value = { 0.02, 5, 3 }
...
StatusEffectTemplates.burning_balefire_death_critical.unit_material_variable.value = { 0.02, 5, 3 }
...
StatusEffectTemplates.poisoned.particle_by_category = { small = "fx/chr_impact_poison_small", medium = "fx/chr_impact_poison_medium" }
