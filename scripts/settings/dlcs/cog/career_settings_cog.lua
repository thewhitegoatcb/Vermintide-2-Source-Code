...
PlayerBreeds.hero_dr_engineer = { is_hero = true, name = "hero_dr_engineer", cannot_be_aggroed = true, vortexable = true, awards_positive_reinforcement_message = true, is_player = true, disable_local_hit_reactions = true, poison_resistance = 0, armor_category = 4, threat_value = 8,
...
CareerSettings.dr_engineer = { profile_name = "dwarf_ranger", display_name = "dr_engineer", sound_character = "dwarf_engineer", package_name = "resource_packages/careers/dr_engineer", name = "dr_engineer", preview_idle_animation = "career_idle_04", preview_animation = "career_select_04", icon = "icons_placeholder", base_skin = "skin_dr_engineer", picking_image = "medium_unit_frame_portrait_bardin_engineer", preview_wield_slot = "ranged", playfab_name = "dr_4", category_image = "icons_placeholder", should_reload_career_weapon = true, portrait_image_picking = "picking_portrait_bardin_engineer", talent_tree_index = 4, description = "bardin_4_desc", portrait_image = "unit_frame_portrait_bardin_engineer", portrait_thumbnail = "portrait_bardin_engineer_thumbnail", sort_order = 1, required_dlc = "cog",
	...
	video = { material_name = "dr_engineer", resource = "video/career_videos/bardin/dr_engineer" },
	...
	preview_items = { { item_name = "bardin_engineer_career_skill_weapon_preview" },
	...
	animation_variables = { is_engineer = 1 },
...
OverchargeData.dr_engineer = { overcharge_threshold = 10, overcharge_warning_critical_sound_event = "drakegun_overcharge_warning_critical", time_until_overcharge_decreases = 0.25, overcharge_warning_low_sound_event = "drakegun_overcharge_warning_low", overcharge_value_decrease_rate = 1.3, overcharge_warning_high_sound_event = "drakegun_overcharge_warning_high", explosion_template = "overcharge_explosion_dwarf", overcharge_warning_med_sound_event = "drakegun_overcharge_warning_med", hit_overcharge_threshold_sound = "ui_special_attack_ready" }
...
PlayerUnitStatusSettings.overcharge_values = table.merge(PlayerUnitStatusSettings.overcharge_values or { }, { cog_hammer_charge_light = 3, cog_hammer_heavy_1_burn = 10, cog_hammer_heavy_1_explosion = 40 })
