...
function CareerAbilityDRSlayer:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityDRSlayer:extensions_ready(world, unit)
...
function CareerAbilityDRSlayer:destroy()
	return end

function CareerAbilityDRSlayer:update(unit, input, dt, context, t)
...
function CareerAbilityDRSlayer:stop(reason)
	if
...
function CareerAbilityDRSlayer:_ability_available()
...
function CareerAbilityDRSlayer:_start_priming()
...
function CareerAbilityDRSlayer:_update_priming()
...
function CareerAbilityDRSlayer:_stop_priming()
...
function CareerAbilityDRSlayer:_do_common_stuff()
	...
	local buffs = { "bardin_slayer_activated_ability" }
...
function CareerAbilityDRSlayer:_do_stomp(t)
	self:_stop_priming()
...
function CareerAbilityDRSlayer:_do_leap()
	...
	status_extension.do_leap = { camera_effect_sequence_start = "jump", anim_start_event_3p = "jump_fwd", camera_effect_sequence_land = "landed_leap", anim_start_event_1p = "slayer_jump_ability", move_function = "leap",
...
function CareerAbilityDRSlayer:_play_vo()
	local owner_unit = self._owner_unit
