...
ImguiCatTesterTools.curated_pickup_list = ImguiCatTesterTools.curated_pickup_list or { "all_ammo_small", "cooldown_reduction_potion", "damage_boost_potion", "deus_relic_01", "deus_soft_currency", "deus_weapon_chest", "explosive_barrel", "fire_grenade_t1", "first_aid_kit", "frag_grenade_t1", "grimoire", "healing_draught", "lamp_oil", "speed_boost_potion", "tome", "torch" }
...
ImguiCatTesterTools.curated_breed_list = ImguiCatTesterTools.curated_breed_list or { "beastmen_bestigor", "beastmen_gor", "beastmen_minotaur", "beastmen_standard_bearer", "beastmen_ungor_archer", "beastmen_ungor", "chaos_berzerker", "chaos_corruptor_sorcerer", "chaos_fanatic", "chaos_marauder_with_shield", "chaos_marauder", "chaos_raider", "chaos_spawn", "chaos_troll", "chaos_vortex_sorcerer", "chaos_warrior", "critter_pig", "skaven_clan_rat_with_shield", "skaven_clan_rat", "skaven_gutter_runner", "skaven_pack_master", "skaven_plague_monk", "skaven_poison_wind_globadier", "skaven_rat_ogre", "skaven_ratling_gunner", "skaven_slave", "skaven_storm_vermin_with_shield", "skaven_storm_vermin", "skaven_stormfiend", "skaven_warpfire_thrower" }
...
local localization_placeholders = { beastmen_ungor = "Ungor", _UNKNOWN = "Unknown", beastmen_bestigor = "Bestigor", critter_pig = "xdd", skaven_clan_rat_with_shield = "Clan Rat w/ Shield", beastmen_ungor_archer = "Ungor Archer", chaos_fanatic = "Fanatic", beastmen_gor = "Gor", skaven_storm_vermin_with_shield = "Stormvermin w/ Shield" }
...
function ImguiCatTesterTools:init()
...
function ImguiCatTesterTools:update()
	return end

function ImguiCatTesterTools:draw()
...
function ImguiCatTesterTools:_spawn_pickup(pickup_name)
...
function ImguiCatTesterTools:_spawn_breed(breed_name)
	local conflict_director = Managers.state.conflict
	conflict_director:aim_spawning(Breeds [breed_name], true)
end

function ImguiCatTesterTools:is_persistent()
	return false
end