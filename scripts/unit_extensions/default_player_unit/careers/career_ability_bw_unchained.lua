...
function CareerAbilityBWUnchained:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityBWUnchained:extensions_ready(world, unit)
...
function CareerAbilityBWUnchained:destroy()
	return end

function CareerAbilityBWUnchained:update(unit, input, dt, context, t)
...
function CareerAbilityBWUnchained:stop(reason)
	if
...
function CareerAbilityBWUnchained:_update_priming(dt)
...
function CareerAbilityBWUnchained:_stop_priming()
	local world = self._world
	local effect_id = self._priming_fx_id
...
function CareerAbilityBWUnchained:_run_ability(new_initial_speed)
	self:_stop_priming()
	...
	if talent_extension:has_talent("sienna_unchained_activated_ability_fire_aura") then
		local buffs = { "sienna_unchained_activated_ability_pulse" }
...
function CareerAbilityBWUnchained:_play_vo()
	local owner_unit = self._owner_unit
