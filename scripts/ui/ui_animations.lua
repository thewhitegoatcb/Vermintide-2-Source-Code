...
UIAnimation = UIAnimation or {
	catmullrom = { num_args = 8, num_data = 1,
	...
	size_offset_scale = { num_args = 9, num_data = 1,
	...
	pulse_animation = { num_args = 5, num_data = 1,
	...
	pulse_animation2 = { num_args = 4, num_data = 1,
	...
	pulse_animation3 = { num_args = 6, num_data = 1,
	...
	text_flash = { num_args = 6, num_data = 1,
	...
	update_function_by_time = { num_args = 6, num_data = 1,
	...
	linear_scale2 = { num_args = 6, num_data = 1,
	...
	linear_scale_color = { num_args = 8, num_data = 1,
	...
	function_by_time = { num_args = 6, num_data = 1,
	...
	function_by_time_with_offset = { num_args = 7, num_data = 1,
	...
	linear_scale = { num_args = 5, num_data = 1,
	...
	set_visible = { num_args = 1, num_data = 0,
	...
	set_invisible = { num_args = 1, num_data = 0,
	...
	picture_sequence = { num_args = 4, num_data = 2,
	...
	timestep_setter_tables = { num_args = 4, num_data = 1,
...
function UIAnimation.init(...)
	...
	local ui_animation = { current_index = 1,
...
function UIAnimation.update(ui_animation, dt)
	...
	if animation_type then
		local num_args = animation_type.num_args local num_data = animation_type.num_data



		local continue = extract_continue_amount(num_data, data_array, current_index + num_args + 1,
		animation_type.update(dt, unpack_index [num_args + num_data](data_array, current_index + 1)))
