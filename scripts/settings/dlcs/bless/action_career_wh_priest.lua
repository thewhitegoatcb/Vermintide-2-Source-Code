...
local spell_buffs = { "victor_priest_activated_ability_invincibility", "victor_priest_activated_ability_nuke", "victor_priest_activated_noclip" }
...
function ActionCareerWHPriestUtility.cast_spell(target_unit, warrior_priest_unit)
...
function ActionCareerWHPriestUtility._add_buffs_to_target(target_unit, warrior_priest_unit)
