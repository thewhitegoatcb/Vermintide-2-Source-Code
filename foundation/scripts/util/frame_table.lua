...
if rawget(_G, "FrameTable") then return end
FrameTable = { }
...
function FrameTable.swap_and_clear()
	...
	frame_table_back_buffer = frame_table_buffer frame_table_buffer = frame_table_back_buffer
...
function FrameTable.init(use_ordinary_tables)
