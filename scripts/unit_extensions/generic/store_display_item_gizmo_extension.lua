...
function StoreDisplayItemGizmoExtension:init(extension_init_context, unit, extension_init_data)
...
function StoreDisplayItemGizmoExtension:cb_display_item_loaded()
...
function StoreDisplayItemGizmoExtension:spawn_prop(item_master_list_id)
...
function StoreDisplayItemGizmoExtension:destroy()
