...
function BTLeaveHooks.reset_fling_skaven(unit, blackboard, t)
	blackboard.fling_skaven = false
end

function BTLeaveHooks.check_if_victim_was_grabbed(unit, blackboard, t)
...
function BTLeaveHooks.kill_unit(unit, blackboard, t)
...
function BTLeaveHooks.unclamp_health(unit, blackboard, t)
	local health_extension = ScriptUnit.has_extension(unit, "health_system")
	health_extension:set_min_health_percentage(nil)
end

function BTLeaveHooks.ring_summoning_ends(unit, blackboard, t)
...
function BTLeaveHooks.charge_ends(unit, blackboard, t)
	blackboard.charge_cooldown = blackboard.charge_total_cooldown
end

function BTLeaveHooks.teleport_ends(unit, blackboard, t)
	blackboard.teleport_cooldown = blackboard.teleport_total_cooldown
end


function BTLeaveHooks.summoning_ends(unit, blackboard, t)
	blackboard.is_summoning = false
end

function BTLeaveHooks.sorcerer_next_phase(unit, blackboard, t)
...
function BTLeaveHooks.sorcerer_setup_done(unit, blackboard, t)
	blackboard.mode = "offensive"
	blackboard.setup_done = true
	blackboard.phase_timer = t + 20
end

function BTLeaveHooks.sorcerer_evade(unit, blackboard, t)
	blackboard.escape_teleport = false
end


function BTLeaveHooks.reset_stormfiend_charge(unit, blackboard, t)
	blackboard.weakspot_hits = nil
	blackboard.weakspot_rage = nil
end

function BTLeaveHooks.stormfiend_boss_mount_leave(unit, blackboard, t)
	return end

function BTLeaveHooks.stormfiend_boss_rage_leave(unit, blackboard, t)
...
function BTLeaveHooks.stormfiend_boss_jump_down_leave(unit, blackboard, t)
...
function BTLeaveHooks.on_grey_seer_intro_leave(unit, blackboard, t)
...
function BTLeaveHooks.on_grey_seer_death_sequence_leave(unit, blackboard, t)
...
function BTLeaveHooks.leave_attack_grabbed_smash(unit, blackboard, t)
...
function BTLeaveHooks.on_lord_intro_leave(unit, blackboard, t)
...
function BTLeaveHooks.on_lord_warlord_intro_leave(unit, blackboard, t)
	if HEALTH_ALIVE [unit] and not blackboard.exit_last_action then
		local health_extension = ScriptUnit.extension(unit, "health_system")
		health_extension.is_invincible = false
...
function BTLeaveHooks.reset_keep_target(unit, blackboard, t)
	blackboard.keep_target = nil
end

function BTLeaveHooks.reset_chain_stagger(unit, blackboard, t)
	blackboard.num_chain_stagger = nil
end

function BTLeaveHooks.remove_invincibility(unit, blackboard, t)
	local health_extension = ScriptUnit.extension(unit, "health_system")
	health_extension.is_invincible = false
end
...
function BTLeaveHooks.mutator_sorcerer_activate_teleport(unit, blackboard, t)
	if blackboard.stagger then
		blackboard.quick_teleport = true
	end
end

function BTLeaveHooks.mutator_sorcerer_force_teleport(unit, blackboard, t)
	blackboard.quick_teleport = true
end

function BTLeaveHooks.destroy_unit_leave_hook(unit, blackboard, t)
	Managers.state.conflict:destroy_unit(unit, blackboard, "debug")
end

function BTLeaveHooks.beastmen_standard_bearer_leave_move_and_plant_standard(unit, blackboard, t)
