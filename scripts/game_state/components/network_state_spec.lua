...
local function decode_full_profile_peers(peer_string)
	...
	for _, peer_info_array in ipairs(json_array) do
		local peer_table = {
			peer_id = peer_info_array [1],
			local_player_id = peer_info_array [2],
			profile_index = peer_info_array [3],
			career_index = peer_info_array [4],
			is_bot = peer_info_array [5] }
...
local spec = {
	server = {
		peer_ingame = { clear_when_peer_id_leaves = true, default_value = false, type = "boolean",
		...
		profile_index_reservation = { default_value = "", type = "string",


			composite_keys = { profile_index = true } },



		full_profile_peers = { type = "table",
		...
		level_key = { default_value = "inn_level", type = "string",


			composite_keys = { } },

		level_seed = { default_value = 0, type = "number",


			composite_keys = { } },

		conflict_director = { default_value = "inn_level", type = "string",


			composite_keys = { } },

		game_mode = { default_value = "inn", type = "string",


			composite_keys = { } },

		environment_variation_id = { default_value = 0, type = "number",


			composite_keys = { } },

		locked_director_functions = { type = "table",
		...
		difficulty = { type = "string", default_value = "normal",
		...
		difficulty_tweak = { default_value = 0, type = "number",


			composite_keys = { } },

		extra_packages = { type = "table",
		...
		mechanism = { type = "string", default_value = "adventure",
		...
		level_session_id = { default_value = 0, type = "number",


			composite_keys = { } },

		level_transition_type = { type = "string", default_value = "load_next_level",
	...
	peer = {
		inventory_list = { type = "table",

			composite_keys = { local_player_id = true },


			default_value = { inventory_id = 0,
		...
		loaded_inventory_id = { default_value = 0, clear_when_peer_id_leaves = true, type = "number",
		...
		actually_ingame = { clear_when_peer_id_leaves = true, default_value = false, type = "boolean",
