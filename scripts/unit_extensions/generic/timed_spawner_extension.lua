...
function TimedSpawnerExtension:init(extension_init_context, unit, extension_init_data)
...
function TimedSpawnerExtension:extensions_ready(world, unit)
	return end

function TimedSpawnerExtension:destroy()
...
function TimedSpawnerExtension:_can_spawn(network_time)
...
function TimedSpawnerExtension:update(unit, input, dt, context, t)
...
function TimedSpawnerExtension:_spawn_breed()
...
function TimedSpawnerExtension:rpc_on_timed_spawn(sender, go_id)
...
function TimedSpawnerExtension:get_spawn_rate()
	return self._spawn_rate
end

function TimedSpawnerExtension:get_spawnable_breeds()
	return self._spawnable_breeds
end

function TimedSpawnerExtension:get_max_spawn_amount()
