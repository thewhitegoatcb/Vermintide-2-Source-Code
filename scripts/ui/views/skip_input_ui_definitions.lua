...
local scenegraph_definition = {
	root = { is_root = true, position = { 0, 0, UILayer.popup }, size = screen_resolution },
	screen = { vertical_alignment = "center", parent = "root", horizontal_alignment = "right", position = { 0, 0, 0 }, size = screen_resolution },
	skip_input = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "left", position = { 20, 20, 1 } } }


local input_text_style = { vertical_alignment = "bottom", dynamic_font = true, font_size = 36, horizontal_alignment = "left", pixel_perfect = true, font_type = "hell_shark", word_wrap = false,
...
local function create_skip_widget(parent, ui_renderer, input_service)
	...
	return { scenegraph_id = "skip_input",
		element = {
			passes = { { style_id = "input_text_1", pass_type = "text", text_id = "input_text_1",
					...
					content_change_function = function (content, style)
						...
						if input ~= content.input and input then
							...
							content.progress = math.abs(content.input_time - t) <= double_click_threshold and 1 or content.progress
				...
				{ style_id = "gamepad_input_text_2", pass_type = "text", text_id = "input_text_2",
				...
				{ style_id = "kbm_input_text_2", pass_type = "text", text_id = "input_text_2",
				...
				{ style_id = "kbm_input_text", pass_type = "text", text_id = "kbm_input_text",
				...
				{ pass_type = "texture", style_id = "kbm_input_icon_left", texture_id = "kbm_input_icon_left",
				...
				{ pass_type = "tiled_texture", style_id = "kbm_input_icon_middle", texture_id = "kbm_input_icon_middle",
				...
				{ pass_type = "texture", style_id = "kbm_input_icon_right", texture_id = "kbm_input_icon_right",
				...
				{ style_id = "input_icon_bar", texture_id = "input_icon_bar", pass_type = "gradient_mask_texture",
		...
		content = { input_time = 0, progress = 0, input_icon_bar = "controller_hold_bar",
		...
		style = {
			hold_bar = {
				...
				offset = { icon_offset, -10, 1 },
				size = { 0, 8 } },

			hold_bar_bg = {
				color = { 255, 0, 0, 0 },
				offset = { icon_offset - 2, -12, 0 },
				size = { 0, 12 } },

			gamepad_input_icon = {
				color = { 255, 255, 255, 255 },
				texture_size = gamepad_texture_data.size,
				offset = { icon_offset, 5, 1 } },

			input_icon_bar = { gradient_threshold = 0,

				color = { 255, 255, 255, 255 },
				texture_size = { gamepad_texture_data.size [1] + 4, gamepad_texture_data.size [1] + 4 },
				offset = { icon_offset - 2, 3, 0 } },
			...
			gamepad_input_text_2 = {
				...
				offset = { gamepad_input_text_2_offset, 0, 0 } },
			...
			kbm_input_text = {
				...
				horizontal_alignment = input_text_style.horizontal_alignment,
				vertical_alignment = input_text_style.vertical_alignment,
				offset = { kbm_icon_middle_offset, 0, 2 } },
			...
			kbm_input_icon_middle = {
				...
				texture_size = { kbm_text_width, kbm_texture_data [2].size [2] },
				offset = { kbm_icon_middle_offset, 5, 1 } },

			kbm_input_icon_right = {
				color = { 255, 255, 255, 255 },
				texture_size = kbm_texture_data [3].size,
				offset = { kbm_icon_right_offset, 5, 1 } },
			...
			kbm_input_text_2 = {
				...
				horizontal_alignment = input_text_style.horizontal_alignment,
				vertical_alignment = input_text_style.vertical_alignment,
				offset = { kbm_input_text_2_offset, 0, 0 } } } }
