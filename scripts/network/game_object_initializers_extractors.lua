...
go_type_table = {
	...
	initializers = {
		...
		player_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { ammo_percentage = 1, overcharge_threshold_percentage = 0, has_moved_from_start_position = false, overcharge_max_value = 40, ability_percentage = 0, overcharge_percentage = 0, moving_platform = 0,
		...
		player_bot_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local rotation = Unit.local_rotation(unit, 0)
			local data_table = { ammo_percentage = 1, overcharge_threshold_percentage = 0, ability_percentage = 0, prestige_level = 0, overcharge_max_value = 40, level = 0, overcharge_percentage = 0, moving_platform = 0,
		...
		ai_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { has_teleported = 1,
		...
		ai_unit_training_dummy_bob = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { damage = 0, has_teleported = 1,
		...
		ai_unit_beastmen_minotaur = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { lean_downwards = false, has_teleported = 1,
		...
		ai_unit_grey_seer = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { show_health_bar = false, has_teleported = 1,
				go_type = NetworkLookup.go_types.ai_unit,
				husk_unit = NetworkLookup.husks [unit_name],
		...
		ai_unit_tentacle = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { reach_distance = 0, has_teleported = 1,
		...
		ai_unit_vortex = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { height_percentage = 0, fx_radius_percentage = 0, has_teleported = 1, inner_radius_percentage = 0,
		...
		ai_unit_stormfiend = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { attack_arm = 1, has_teleported = 1,
		...
		ai_unit_stormfiend_boss = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { show_health_bar = false, attack_arm = 1, has_teleported = 1,
				go_type = NetworkLookup.go_types.ai_unit_stormfiend,
				husk_unit = NetworkLookup.husks [unit_name],
		...
		damage_wave_unit = function (unit, unit_name, unit_template, gameobject_functor_context)
			...
			local data_table = { height_percentage = 0,
	...
	extractors = {
		...
		player_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				locomotion_system = { id = go_id, game = game_session, player = player, has_moved_from_start_position = has_moved_from_start_position },
				health_system = { player = player, game_object_id = go_id, profile_index = profile_id, career_index = career_id },
				hit_reaction_system = { is_husk = true, hit_reaction_template = "player" },
				death_system = { death_reaction_template = "player", is_husk = true },
				aim_system = { template = "player", is_husk = true, go_id = go_id },
				status_system = { wounds = player_wounds, profile_id = profile_id, player = player },
				inventory_system = { id = go_id, game = game_session, player = player },
				attachment_system = { profile = profile, player = player },
				cosmetic_system = { profile = profile, skin_name = skin_name, frame_name = frame_name, player = player },
				dialogue_context_system = { profile = profile },
				dialogue_system = { wwise_career_switch_group = "player_career", faction = "player", wwise_voice_switch_group = "character", profile = profile, wwise_voice_switch_value = profile.character_vo, wwise_career_switch_value = career_name },
				whereabouts_system = { player = player },
				buff_system = { is_husk = true, initial_buff_names = initial_buff_names },
				statistics_system = { template = "player", statistics_id = player:stats_id() },
				ai_slot_system = { profile_index = profile_id },
				talent_system = { is_husk = true, player = player, profile_index = profile_id },
				career_system = { player = player, profile_index = profile_id, career_index = career_id, initial_ability_percentage = initial_ability_percentage },
				overcharge_system = { overcharge_max_value = overcharge_max_value, overcharge_data = overcharge_data },
				energy_system = { energy_max_value = energy_max_value, energy_data = energy_data },
				aggro_system = { side = side },
				proximity_system = { profile = profile, side = side },
				target_override_system = { side = side },
				ai_commander_system = { player = player } }
		...
		player_bot_unit = function (game_session, go_id, owner, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				dialogue_system = { wwise_career_switch_group = "player_career", faction = "player", wwise_voice_switch_group = "character", profile = profile, wwise_voice_switch_value = profile.character_vo, wwise_career_switch_value = career_name },
				whereabouts_system = { player = player },
				attachment_system = { profile = profile },
				cosmetic_system = { profile = profile, skin_name = skin_name, frame_name = frame_name, player = player },
				buff_system = { is_husk = true },
				statistics_system = { template = "player", statistics_id = player:stats_id() },
				ai_slot_system = { profile_index = profile_id },
				talent_system = { is_husk = true, player = player, profile_index = profile_id },
				career_system = { player = player, profile_index = profile_id, career_index = career_id, initial_ability_percentage = initial_ability_percentage },
		...
		ai_unit = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_system = { go_id = game_object_id, game = game_session, side_id = side_id },
				locomotion_system = { go_id = game_object_id, breed = breed, game = game_session },
				health_system = { health = health },
				death_system = { is_husk = true, death_reaction_template = breed.death_reaction, disable_second_hit_ragdoll = breed.disable_second_hit_ragdoll },
				hit_reaction_system = { is_husk = true, hit_reaction_template = breed.hit_reaction, hit_effect_template = breed.hit_effect_template },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
		...
		ai_unit_beastmen_bestigor = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				death_system = { is_husk = true, death_reaction_template = breed.death_reaction, disable_second_hit_ragdoll = breed.disable_second_hit_ragdoll },
				hit_reaction_system = { is_husk = true, hit_reaction_template = breed.hit_reaction, hit_effect_template = breed.hit_effect_template },
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				animation_movement_system = { is_husk = true, template = breed.animation_movement_template },
				proximity_system = { breed = breed } }
		...
		ai_unit_tentacle = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_supplementary_system = { portal_unit = portal_unit, tentacle_template_name = tentacle_template_name },
				ai_system = { go_id = game_object_id, game = game_session, side_id = side_id },
				death_system = { is_husk = true, death_reaction_template = breed.death_reaction, disable_second_hit_ragdoll = breed.disable_second_hit_ragdoll },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				health_system = { health = health },
		...
		ai_unit_vortex = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_system = { go_id = game_object_id, game = game_session, side_id = side_id },
				locomotion_system = { go_id = game_object_id, breed = breed, game = game_session },
				ai_supplementary_system = { vortex_template_name = vortex_template_name, inner_decal_unit = inner_decal_unit, outer_decal_unit = outer_decal_unit, owner_unit = owner_unit } }
		...
		ai_unit_tentacle_portal = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				health_system = { health = health },
				death_system = { death_reaction_template = "chaos_tentacle_portal", is_husk = true } }
		...
		ai_unit_with_inventory = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				hit_reaction_system = { is_husk = true, hit_reaction_template = breed.hit_reaction, hit_effect_template = breed.hit_effect_template },
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				aim_system = { is_husk = true, template = breed.aim_template },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				proximity_system = { breed = breed },
				buff_system = { breed = breed },
				animation_movement_system = { is_husk = true, template = breed.animation_movement_template } }
		...
		ai_unit_with_inventory_and_shield = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				ai_shield_system = { is_blocking = is_blocking },
				aim_system = { is_husk = true, template = breed.aim_template },
				proximity_system = { breed = breed },
				buff_system = { breed = breed } }
		...
		ai_lord_with_inventory = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_system = { go_id = go_id, game = game_session, side_id = side_id },
				locomotion_system = { go_id = go_id, breed = breed, game = game_session },
				health_system = { health = health },
				death_system = { is_husk = true, death_reaction_template = breed.death_reaction, disable_second_hit_ragdoll = breed.disable_second_hit_ragdoll },
				hit_reaction_system = { is_husk = true, hit_reaction_template = breed.hit_reaction, hit_effect_template = breed.hit_effect_template },
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
		...
		ai_unit_pack_master = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				aim_system = { template = "pack_master", is_husk = true },
				proximity_system = { breed = breed },
				buff_system = { breed = breed } }
		...
		ai_unit_ratling_gunner = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				aim_system = { template = "ratling_gunner", is_husk = true },
				proximity_system = { breed = breed },
				buff_system = { breed = breed } }
		...
		ai_unit_warpfire_thrower = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				locomotion_system = { go_id = game_object_id, breed = breed, game = game_session },
				health_system = { health = health },
				death_system = { is_husk = true, death_reaction_template = breed.death_reaction },
				hit_reaction_system = { is_husk = true, hit_reaction_template = breed.hit_reaction, hit_effect_template = breed.hit_effect_template },
				ai_inventory_system = { inventory_configuration_name = inventory_configuration_name },
				dialogue_system = { faction = "enemy", breed_name = breed_name },
				aim_system = { template = "ratling_gunner", is_husk = true },
		...
		pickup_training_dummy_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				health_system = { damage = 0, health = 100 },
		...
		explosive_pickup_projectile_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			if explode_time ~= 0 then
				explosion_data = { explode_time = explode_time, fuse_time = fuse_time }
			end
		...
		projectile_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				projectile_system = { is_husk = true,
					angle = angle,
					speed = speed,
					target_vector = target_vector,
					initial_position = initial_position,
		...
		positioned_blob_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				...
				props_system = { start_size = 0.3, duration = 0.5, end_size = 1 },




				death_system = { death_reaction_template = "nurgle_liquid_blob", shrink_and_despawn_time = 3 },
				...
				area_damage_system = { catapult_strength = 3, range = 2, detonation_time = 3, arm_time = 3, explosion_template = "bubonic_catapult_explosion" } }
		...
		standard_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				health_system = { health = health },
				death_system = { death_reaction_template = "standard", is_husk = true },
				ai_supplementary_system = { standard_template_name = NetworkLookup.standard_templates [standard_template_name] },
				ping_system = { always_pingable = always_pingable } }
		...
		overpowering_blob_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
			...
			local extension_init_data = {
				health_system = { health = health },
				death_system = { death_reaction_template = "lure_unit", is_husk = true } }
...
function initializers.ai_true_flight_killable_projectile_unit(unit, unit_name, unit_template, gameobject_functor_context)
...
function extractors.ai_true_flight_killable_projectile_unit(game_session, go_id, owner_id, unit, gameobject_functor_context)
	...
	extension_init_data.health_system = { health = health }
	extension_init_data.death_system = { is_husk = true, death_reaction_template = template.death_reaction_template }
