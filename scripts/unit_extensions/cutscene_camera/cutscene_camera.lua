...
function CutsceneCamera:init(extension_init_context, unit, extension_init_data)
...
function CutsceneCamera:activate(transition_data)
...
function CutsceneCamera:setup_external_camera(transition, tree_name, node_name)
...
function CutsceneCamera:update()
	self:update_cutscene_camera()
end

function CutsceneCamera:update_cutscene_camera()
...
function CutsceneCamera:_handle_input(pose)
...
function CutsceneCamera:transition_progress(start_time, end_time, time)
	local progress = nil
...
function CutsceneCamera:near_range()
	return Camera.near_range(self.camera)
end

function CutsceneCamera:far_range()
