local ByteArray = { }
function ByteArray.write_int32(array, value, index)
...
function ByteArray.read_int32(array, index)
	index = index or 1
...
function ByteArray.read_string(array, start_index, end_index)
...
function ByteArray.write_string(array, str, start_index, str_start_index, str_end_index)
	start_index = start_index or 1
