...
local scenegraph_definition = {
	...
	item_grid = { vertical_alignment = "center", parent = "window", horizontal_alignment = "center", size = { 186, 186 }, position = { 0, 28, 6 } },
	item_grid_random_icon = { vertical_alignment = "center", parent = "item_grid", horizontal_alignment = "center", size = { 37, 62 }, position = { 0, 0, 0 } },
...
local widgets = {
	...
	craft_button = UIWidgets.create_default_button("craft_button", scenegraph_definition.craft_button.size, nil, nil, Localize("hero_view_crafting_craft"), 24, nil, "button_detail_02", nil, disable_with_gamepad),
