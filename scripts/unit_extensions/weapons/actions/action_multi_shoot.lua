...
function ActionMultiShoot:_use_ammo()
...
function ActionMultiShoot:_get_barrel_data(shots_fired)
...
function ActionMultiShoot:_get_total_shots()
	local total_shots = 0
...
function ActionMultiShoot:_combine_rotations(yaw, pitch, current_rot)
...
function ActionMultiShoot:_get_spread_rotation(num_shots_total, current_rotation, num_layers_spread, bullseye, spread_pitch)
...
function ActionMultiShoot:_shoot(num_shots_total, num_shots_this_frame)
	local current_action = self.current_action
...
function ActionMultiShoot:finish(reason)
