...
local challenge_settings = { reward = "deus_power_up_quest_test_reward_01", type = "kill_elites", category = "deus_mutator",



	amount = { 1, 7, 7, 10, 10, 15, 15, 15 } }
...
return {
	server_start_function = function (context, data, unit)
		...
		local challenge = challenge_manager:add_challenge(
		challenge_settings.type,
		is_repeatable,
		category,
		challenge_reward,
		player_unique_id,
		challenge_settings.amount [difficulty_rank],
