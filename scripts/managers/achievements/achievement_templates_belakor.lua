...
achievements.blk_complete_arena = { name = "achv_blk_complete_arena_name", display_completion_ui = true, icon = "achievement_morris_complete_arena", desc = "achv_blk_complete_arena_desc",
...
achievements.blk_three_champions = { name = "achv_blk_three_champions_name", display_completion_ui = true, icon = "achievement_morris_shadow_champions_active", desc = "achv_blk_three_champions_desc",




	events = { "register_lieutenant_spawned", "register_kill" },
...
achievements.blk_fast_arena = { name = "achv_blk_fast_arena_name", display_completion_ui = true, icon = "achievement_morris_complete_arena_fast", desc = "achv_blk_fast_arena_desc",




	events = { "register_locus_destroyed" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.blk_fast_kill_totems = { name = "achv_blk_fast_kill_totems_name", display_completion_ui = true, icon = "achievement_morris_complete_arena_totems_destroyed", desc = "achv_blk_fast_kill_totems_desc",




	events = { "register_totem_state_change", "register_completed_level" },
	completed = function (statistics_db, stats_id, template_data)
...
achievements.blk_synced_destruction = { name = "achv_blk_synced_destruction_name", display_completion_ui = true, icon = "achievement_morris_destroy_locis", desc = "achv_blk_synced_destruction_desc",
	...
	on_event = function (statistics_db, stats_id, template_data, event_name, event_data)
		...
		if #template_data.locus_destroyed >= 3 and
		template_data.locus_destroyed [#template_data.locus_destroyed] - template_data.locus_destroyed [1] <= synced_destruction_window then
...
achievements.blk_white_run = { name = "achv_blk_white_run_name", display_completion_ui = true, icon = "achievement_morris_complete_arena_no_upgrades", desc = "achv_blk_white_run_desc",
...
achievements.blk_clutch_skull = { name = "achv_blk_clutch_skull_name", display_completion_ui = true, icon = "achievement_morris_destroy_skulls_before_hit", desc = "achv_blk_clutch_skull_desc",
...
achievements.blk_no_totem = { name = "achv_blk_no_totem_name", display_completion_ui = true, icon = "achievement_morris_complete_arena_totems_alive", desc = "achv_blk_no_totem_desc",
...
achievements.blk_hitless_skull = { name = "achv_blk_hitless_skull_name", display_completion_ui = true, icon = "achievement_morris_destroy_skulls_within_time", desc = "achv_blk_hitless_skull_desc",




	events = { "register_skull_hit", "register_completed_level" },
	completed = function (statistics_db, stats_id, template_data)
...
local all_challenges = { "blk_complete_arena", "blk_three_champions", "blk_fast_arena", "blk_synced_destruction", "blk_fast_kill_totems", "blk_white_run", "blk_clutch_skull", "blk_no_totem", "blk_hitless_skull" }
