...
function PlayerCharacterStateEnterLadderTop:init(character_state_init_context)
...
function PlayerCharacterStateEnterLadderTop:on_enter_animation_event(speed)
...
function PlayerCharacterStateEnterLadderTop:on_enter(unit, input, dt, context, t, previous_state, params)
	local unit = self.unit
...
function PlayerCharacterStateEnterLadderTop:on_exit(unit, input, dt, context, t, next_state)
	local loc_ext = self.locomotion_extension
...
function PlayerCharacterStateEnterLadderTop:update(unit, input, dt, context, t)
	local csm = self.csm
	local unit = self.unit
	local input_extension = self.input_extension
