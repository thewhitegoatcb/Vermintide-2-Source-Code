...
local ai_supplementary_system_extension = { "TentacleSplineExtension", "VortexExtension", "VortexHuskExtension", "ThrownUnitHuskExtension", "BeastmenStandardExtension", "UnitSynchronizationExtension", "GrudgeMarkSirenChainExtension" }
...
function EntitySystem:init(entity_system_creation_context)
...
function EntitySystem:_init_systems(entity_system_creation_context)
	local no_pre_update = false local has_pre_update = true local has_post_update = true local dont_run_on_dedicated_server = true
	...
	self:_add_system("target_override_system", TargetOverrideSystem, entity_system_creation_context, { "TargetOverrideExtension" })
	...
	self:_add_system("input_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerInputExtension", "PlayerInputTutorialExtension", "PlayerBotInput" }, nil, has_pre_update)
	self:_add_system("position_lookup_system", PositionLookupSystem, entity_system_creation_context)


	self:_add_system("darkness_system", DarknessSystem, entity_system_creation_context, { "LightSourceExtension" })
	self:_add_system("character_state_machine_system", ExtensionSystemBase, entity_system_creation_context, { "GenericCharacterStateMachineExtension" })
	self:_add_system("ladder_system", ExtensionSystemBase, entity_system_creation_context, { "LadderExtension" })
	...
	self:_add_system("ai_shield_system", ExtensionSystemBase, entity_system_creation_context, { "AIShieldUserExtension", "AIShieldUserHuskExtension" })
	...
	self:_add_system("smart_targeting_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerUnitSmartTargetingExtension" })
	...
	self.entity_manager:add_ignore_extensions({ "VersusVolumeObjectiveExtension", "VersusInteractObjectiveExtension", "VersusPayloadObjectiveExtension", "VersusSocketObjectiveExtension", "VersusTargetObjectiveExtension", "VersusMissionObjectiveExtension" })
	...
	if DEDICATED_SERVER then
		self.entity_manager:add_ignore_extensions({ "UnitFlowOverrideExtension" })
	end



	self:_add_system("buff_system", BuffSystem, entity_system_creation_context)
	self:_add_system("buff_area_system", ExtensionSystemBase, entity_system_creation_context, { "BuffAreaExtension" })
	...
	self:_add_system("spread_system", ExtensionSystemBase, entity_system_creation_context, { "WeaponSpreadExtension" })
	...
	self:_add_system("attack_intensity_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerUnitAttackIntensityExtension" })
	self:_add_system("hit_reaction_system", HitReactionSystem, entity_system_creation_context)
	self:_add_system("overcharge_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerUnitOverchargeExtension", "PlayerHuskOverchargeExtension" })
	self:_add_system("trail_system", ExtensionSystemBase, entity_system_creation_context, { "GenericTrailExtension" })
	self:_add_system("sound_effect_system", SoundEffectSystem, entity_system_creation_context)
	self:_add_system("visual_effects_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerUnitVisualEffectsExtension", "PlayerHuskVisualEffectsExtension" }, nil, nil, nil, dont_run_on_dedicated_server)
	...
	self:_add_system("ai_navigation_system", AINavigationSystem, entity_system_creation_context, { "AINavigationExtension", "PlayerBotNavigation" }, nil, no_pre_update, has_post_update)
	self:_add_system("whereabouts_system", WhereaboutsSystem, entity_system_creation_context, { "PlayerWhereaboutsExtension", "LureWhereaboutsExtension", "JumpsWhereaboutsExtension" }, nil, no_pre_update)
	...
	self:_add_system("ai_beam_effect_system", ExtensionSystemBase, entity_system_creation_context, { "CorruptorBeamExtension", "StormfiendBeamExtension", "CurseCorruptorBeamExtension" })
	...
	self:_add_system("event_spawner_system", ExtensionSystemBase, entity_system_creation_context, { "EventLightSpawnerExtension" })
	self:_add_system("disrupt_ritual_system", DisruptRitualSystem, entity_system_creation_context, { "DisruptRitualExtension" })
	...
	if Managers.state.game_mode:settings().use_keep_decorations then
		...
		self.entity_manager:add_ignore_extensions({ "KeepDecorationPaintingExtension" })
	end


	self:_add_system("aim_system", AimSystem, entity_system_creation_context, { "GenericUnitAimExtension" })
	self:_add_system("animation_movement_system", AnimationMovementSystem, entity_system_creation_context, { "GenericUnitAnimationMovementSystem" })
	...
	if IS_WINDOWS then
		...
		self:_add_system("eyetracking_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerEyeTrackingExtension" })
	end
	...
	self:_add_system("camera_state_machine_system", ExtensionSystemBase, entity_system_creation_context, { "GenericCameraStateMachineExtension" })
	...
	self:_add_system("props_system", PropsSystem, entity_system_creation_context, { "BotNavTransitionExtension" }, { "PerlinLightExtension", "QuestChallengePropExtension" })
	...
	self:_add_system("energy_system", ExtensionSystemBase, entity_system_creation_context, { "PlayerUnitEnergyExtension", "PlayerHuskEnergyExtension" })
	self:_add_system("boon_system", ExtensionSystemBase, entity_system_creation_context, { "BoonExtension" })
...
function EntitySystem:register_system(system_object, system_name, ...)
	return end

function EntitySystem:_add_system(name, class, context, extension_list, extension_list_ignore_on_dedicated, has_pre_update, has_post_update, dont_run_on_dedicated_server)
...
function EntitySystem:pre_update(dt)
...
function EntitySystem:physics_async_update()

	self:system_update("physics_async_update", self.system_update_context.dt)

end

function EntitySystem:system_update(update_func, dt)
...
function EntitySystem:commit_and_remove_pending_units()
...
function EntitySystem:hot_join_sync(peer_id)
