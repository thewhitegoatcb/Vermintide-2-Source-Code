...
local RPCS = { "rpc_show_badge", "rpc_complete_badge" }




function BadgeManager:init(statistics_db, network_event_delegate, is_server)
	...
	elseif current_mechanism_name == "adventure" then --[[ Nothing --]]
	end
...
function BadgeManager:_initialize_server()
...
function BadgeManager:_initialize_client()
...
function BadgeManager:update(dt, t)
...
function BadgeManager:_update_server(dt, t)
...
function BadgeManager:_update_client(dt, t)
	local update_cache = self._update_cache
	local network_transmit = Managers.state.network.network_transmit
...
function BadgeManager:rpc_show_badge(channel_id, badge_id)
...
function BadgeManager:rpc_complete_badge(channel_id, badge_id, player_peer_id)
