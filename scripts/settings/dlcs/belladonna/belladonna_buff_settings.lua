...
settings.buff_templates = {
	...
	invincibility_standard = {
		buffs = { { update_func = "update_invincibility_standard", name = "invincibility_standard", max_stacks = 1, remove_buff_func = "remove_invincibility_standard", apply_buff_func = "apply_invincibility_standard" } } },
	...
	healing_standard = {
		buffs = { { update_func = "update_healing_standard", name = "healing_standard", max_stacks = 1, remove_buff_func = "remove_healing_standard", apply_buff_func = "apply_healing_standard",
				...
				heal_amounts = { hardest = 8, hard = 3, harder = 6, cataclysm_2 = 13, cataclysm = 11, cataclysm_3 = 15, normal = 2 } } } } }
...
settings.buff_function_templates = {
	...
	remove_invincibility_standard = function (unit, buff, params, world)
		if Managers.state.network.is_server then
			...
			stored_damage and standard_is_destroyed and HEALTH_ALIVE [unit] then
