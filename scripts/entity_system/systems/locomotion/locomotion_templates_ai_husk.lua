...
function LocomotionTemplates.AiHuskLocomotionExtension.update(data, t, dt)
...
function LocomotionTemplates.AiHuskLocomotionExtension.update_alive(data, t, dt)
...
function LocomotionTemplates.AiHuskLocomotionExtension.update_pure_network_update_units(data, t, dt)
...
function LocomotionTemplates.AiHuskLocomotionExtension.update_other_update_units_navmesh_check(data, t, dt)
...
function LocomotionTemplates.AiHuskLocomotionExtension.update_other_update_units(data, t, dt)
