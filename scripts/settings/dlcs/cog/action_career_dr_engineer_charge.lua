...
function ActionCareerDREngineerCharge:init(world, item_name, is_server, owner_unit, damage_unit, first_person_unit, weapon_unit, weapon_system)
...
function ActionCareerDREngineerCharge:client_owner_post_update(dt, t, world, can_damage)
...
function ActionCareerDREngineerCharge:start_audio_loop()
	local current_action = self.current_action
