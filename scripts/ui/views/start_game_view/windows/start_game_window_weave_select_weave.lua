...
function StartGameWindowWeaveSelectWeave:on_enter(params, offset)
...
function StartGameWindowWeaveSelectWeave:_create_ui_elements(params, offset)
...
function StartGameWindowWeaveSelectWeave:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowWeaveSelectWeave")
	self._ui_animator = nil
end

function StartGameWindowWeaveSelectWeave:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowWeaveSelectWeave:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowWeaveSelectWeave:_update_game_options_hover_effect()
...
function StartGameWindowWeaveSelectWeave:_on_option_button_hover_enter(widget, index, instant)
...
function StartGameWindowWeaveSelectWeave:_on_option_button_hover_exit(widget, index, instant)
...
function StartGameWindowWeaveSelectWeave:_create_style_animation_enter(widget, target_value, style_id, widget_index, instant)
...
function StartGameWindowWeaveSelectWeave:_animate_pulse(target, target_index, from, to, speed)
	local new_animation = UIAnimation.init(UIAnimation.pulse_animation, target, target_index, from, to, speed)
	return new_animation
end

function StartGameWindowWeaveSelectWeave:_animate_element_by_time(target, target_index, from, to, time)
	local new_animation = UIAnimation.init(UIAnimation.function_by_time, target, target_index, from, to, time, math.ease_out_quad)
	return new_animation
end

function StartGameWindowWeaveSelectWeave:_create_style_animation_exit(widget, target_value, style_id, widget_index, instant)
	local widget_style = widget.style
	local pass_style = widget_style [style_id]
	if not pass_style then
		return
...
function StartGameWindowWeaveSelectWeave:_play_sound(event)
	self._parent:play_sound(event)
end

function StartGameWindowWeaveSelectWeave:update(dt, t)
...
function StartGameWindowWeaveSelectWeave:_update_animations(dt)
...
function StartGameWindowWeaveSelectWeave:_update_input(dt, t)
...
function StartGameWindowWeaveSelectWeave:post_update(dt, t)
	return end

function StartGameWindowWeaveSelectWeave:_draw(dt)
