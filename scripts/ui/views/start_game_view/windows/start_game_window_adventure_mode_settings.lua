...
function StartGameWindowAdventureModeSettings:on_enter(params, offset)
...
function StartGameWindowAdventureModeSettings:create_ui_elements(params, offset)
...
function StartGameWindowAdventureModeSettings:on_exit(params)
	print("[StartGameWindow] Exit Substate StartGameWindowAdventureModeSettings")
	self.ui_animator = nil
end

function StartGameWindowAdventureModeSettings:update(dt, t)
...
function StartGameWindowAdventureModeSettings:post_update(dt, t)
	return end

function StartGameWindowAdventureModeSettings:_update_animations(dt)
...
function StartGameWindowAdventureModeSettings:_is_button_released(widget)
...
function StartGameWindowAdventureModeSettings:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameWindowAdventureModeSettings:_is_button_hover_exit(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_exit
end

function StartGameWindowAdventureModeSettings:_handle_input(dt, t)
...
function StartGameWindowAdventureModeSettings:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowAdventureModeSettings:_update_difficulty_option()
	local parent = self.parent
...
function StartGameWindowAdventureModeSettings:_update_next_level_option()
...
function StartGameWindowAdventureModeSettings:_set_selected_level(level_id)
...
function StartGameWindowAdventureModeSettings:_set_difficulty_option(difficulty_key)
...
function StartGameWindowAdventureModeSettings:draw(dt)
...
function StartGameWindowAdventureModeSettings:_update_game_options_hover_effect()
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowAdventureModeSettings:_on_option_button_hover_enter(widget, index, instant)
...
function StartGameWindowAdventureModeSettings:_on_option_button_hover_exit(widget, index, instant)
...
function StartGameWindowAdventureModeSettings:_create_style_animation_enter(widget, target_value, style_id, widget_index, instant)
...
function StartGameWindowAdventureModeSettings:_create_style_animation_exit(widget, target_value, style_id, widget_index, instant)
	local widget_style = widget.style
	local pass_style = widget_style [style_id]
	if not pass_style then
		return
...
function StartGameWindowAdventureModeSettings:_animate_pulse(target, target_index, from, to, speed)
	local new_animation = UIAnimation.init(UIAnimation.pulse_animation, target, target_index, from, to, speed)
	return new_animation
end

function StartGameWindowAdventureModeSettings:_animate_element_by_time(target, target_index, from, to, time)
