...
local grid_settings = { { wield = true, name = "heroic_deeds", display_name = "heroic_deeds", item_filter = "slot_type == deed", hero_specific_filter = false,
...
function StartGameWindowMutatorGridConsole:on_enter(params, offset)
...
function StartGameWindowMutatorGridConsole:_start_transition_animation(animation_name)
	local params = {
...
function StartGameWindowMutatorGridConsole:create_ui_elements(params, offset)
...
function StartGameWindowMutatorGridConsole:on_exit(params)
...
function StartGameWindowMutatorGridConsole:update(dt, t)
...
function StartGameWindowMutatorGridConsole:post_update(dt, t)
	return end

function StartGameWindowMutatorGridConsole:_update_animations(dt)
...
function StartGameWindowMutatorGridConsole:_handle_input(dt, t)
	...
	if ( UIUtils.is_button_pressed(delete_selection_button) or input_service:get("special_1") ) and
	not table.is_empty(self._deeds_marked_for_deletion) then
		self._popup_id = Managers.popup:queue_popup(Localize("delete_deeds_popup_warning_message"), Localize("popup_discard_changes_topic"), "yes", Localize("popup_choice_yes"), "cancel_popup", Localize("popup_choice_no"))
...
function StartGameWindowMutatorGridConsole:_play_sound(event)
	self.parent:play_sound(event)
end

function StartGameWindowMutatorGridConsole:_update_selected_item_backend_id()
...
function StartGameWindowMutatorGridConsole:draw(dt)
...
function StartGameWindowMutatorGridConsole:_update_page_info()
...
function StartGameWindowMutatorGridConsole:_setup_input_buttons()
	local input_service = self.parent:window_input_service()
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowMutatorGridConsole:_set_gamepad_input_buttons_visibility(visible)
	local widgets_by_name = self._widgets_by_name
...
function StartGameWindowMutatorGridConsole:_handle_gamepad_activity()
...
function StartGameWindowMutatorGridConsole:_delete_deeds(all_deeds_items, marked_deeds)
...
function StartGameWindowMutatorGridConsole:_handle_deeds_deletion()
...
function StartGameWindowMutatorGridConsole:_update_on_removal_state(t)
...
function StartGameWindowMutatorGridConsole:_is_deleting()
	return self._deed_removal_id
end

function StartGameWindowMutatorGridConsole:_on_removal_complete()
	local item_grid = self._item_grid
...
function StartGameWindowMutatorGridConsole:_set_delete_buttons_visible(value)
...
function StartGameWindowMutatorGridConsole:_mark_all_for_deletion()
	self._deeds_marked_for_deletion = { }
