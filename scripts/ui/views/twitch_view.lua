...
function TwitchView:init(ingame_ui_context)
...
function TwitchView:_create_ui_elements()
...
function TwitchView:update(dt, t, is_sub_menu)
...
function TwitchView:cb_on_message_received(key, message_type, user_name, message, parameter)
...
function TwitchView:_play_sound(event)
	WwiseWorld.trigger_event(self._wwise_world, event)
end

function TwitchView:_update_input(dt, t)
...
function TwitchView:_update_error(dt, t)
...
function TwitchView:cb_connection_callback(message)
...
function TwitchView:set_active(active)
	self._active = active
...
function TwitchView:is_active()
	return self._active
end

function TwitchView:suspend()
...
function TwitchView:_draw(dt, t)
...
function TwitchView:on_exit()
	ShowCursorStack.pop()
	self:set_active(false)
end

function TwitchView:destroy()
	return end

function TwitchView:_exit(return_to_game)
	local exit_transition = return_to_game and "exit_menu" or "ingame_menu"
	self._ingame_ui:handle_transition(exit_transition)
end

function TwitchView:input_service()
