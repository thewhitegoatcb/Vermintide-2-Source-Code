...
function HeroWindowGotwfPanel:on_enter(params, offset)
...
function HeroWindowGotwfPanel:_create_ui_elements(params, offset)
...
function HeroWindowGotwfPanel:on_exit(params)
	print("[HeroViewWindow] Exit Substate HeroWindowGotwfPanel")
	self._ui_animator = nil
end

function HeroWindowGotwfPanel:update(dt, t)
...
function HeroWindowGotwfPanel:post_update(dt, t)
	self:_handle_input(dt, t)
end

function HeroWindowGotwfPanel:_update_animations(dt)
...
function HeroWindowGotwfPanel:_handle_input(dt, t)
...
function HeroWindowGotwfPanel:_draw(dt)
...
function HeroWindowGotwfPanel:_handle_gamepad_activity()
...
function HeroWindowGotwfPanel:_animate_button(widget, dt)
