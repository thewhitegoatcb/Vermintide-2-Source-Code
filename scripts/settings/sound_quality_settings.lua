...
if IS_WINDOWS then
	SoundQualitySettings = {
		templates = {
			low = { max_num_voices = 28, sound_performance = 1, occlusion = false },




			medium = { max_num_voices = 64, sound_performance = 0.5, occlusion = false },




			high = { max_num_voices = 80, sound_performance = 0, occlusion = true } } }
...
function SoundQualitySettings.get_quality_template(sound_quality)
...
function SoundQualitySettings.set_sound_quality(wwise_world, sound_quality)
