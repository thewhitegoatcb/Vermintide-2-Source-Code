...
local conversion_table = { shield_rats_no_elites = "shield_rats", beastmen = "beastmen_elites", marauders_and_warriors = "marauders_elites", beastmen_light = "beastmen", standard_no_elites = "standard" }
...
return { description = "mutator_deus_more_elites_desc", display_name = "mutator_deus_more_elites_name", hide_from_player_ui = true, icon = "mutator_icon_deus_more_elites",
