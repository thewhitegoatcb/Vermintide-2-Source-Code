...
function CareerAbilityBWAdept:init(extension_init_context, unit, extension_init_data)
...
function CareerAbilityBWAdept:extensions_ready(world, unit)
...
function CareerAbilityBWAdept:destroy()
	return end

local PROFILER_NAME = "career_ability_bw_adept"

function CareerAbilityBWAdept:update(unit, input, dt, context, t)
...
function CareerAbilityBWAdept:stop(reason)
	if
...
function CareerAbilityBWAdept:_ability_available()
...
function CareerAbilityBWAdept:_start_priming()
...
function CareerAbilityBWAdept:_update_priming(dt, t)
...
function CareerAbilityBWAdept:_stop_priming()
...
function CareerAbilityBWAdept:_run_ability()
	...
	status_extension.do_leap = { move_function = "teleleap",
		...
		leap_events = { { distance_percentage = 0.1,
...
function CareerAbilityBWAdept:_play_vo()
	local owner_unit = self._owner_unit
