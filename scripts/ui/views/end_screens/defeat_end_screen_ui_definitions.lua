local scenegraph = {
	...
	end_screen_banner_defeat = { vertical_alignment = "center", parent = "screen", horizontal_alignment = "center",
	...
	defeat_effect_1 = { vertical_alignment = "center", parent = "end_screen_banner_defeat", horizontal_alignment = "center",
	...
	defeat_effect_2 = { vertical_alignment = "center", parent = "end_screen_banner_defeat", horizontal_alignment = "center",
	...
	title_text_defeat = { vertical_alignment = "top", parent = "end_screen_banner_defeat", horizontal_alignment = "center",
...
local title_text_defeat_style = { word_wrap = true, upper_case = true, localize = false, use_shadow = true, font_size = 100, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local animations = { }
animations.defeat = { { name = "entry", start_progress = 1.4, end_progress = 1.8,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "text", start_progress = 1.8, end_progress = 2.2,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "effect_1", start_progress = 1, end_progress = 1.5,
		...
		on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
			...
			return end },
	{ name = "effect_2", start_progress = 1.7, end_progress = 3,
