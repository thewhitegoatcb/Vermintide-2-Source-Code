...
settings.additional_system_extensions = {
	pickup_system = { { require = "scripts/unit_extensions/pickups/orb_pickup_unit_extension", class = "OrbPickupUnitExtension" } } }
...
settings.pickup_system_extension_update = { "OrbPickupUnitExtension" }



settings.unit_extension_templates = { "scripts/settings/dlcs/belakor/belakor_extension_templates" }



settings.statistics_definitions = { "scripts/managers/backend/statistics_definitions_belakor" }



settings.anim_lookup = { "spawn_chaos_champion_01", "spawn_chaos_champion_02", "spawn_chaos_champion_03", "spawn_chaos_champion_04", "spawn_chaos_champion_05", "insert_locus_crystal" }
...
settings.husk_lookup = { "units/props/deus_orb/deus_orb_01", "units/props/blk/blk_curse_shadow_dagger_01", "units/props/blk/blk_curse_shadow_homing_skull_01", "units/props/blk/blk_curse_shadow_dagger_spawner_01", "units/props/blk/blk_curse_shadow_homing_skulls_spawner_01", "units/weapons/player/pup_belakor_crystal/pup_belakor_crystal", "units/props/blk/blk_locus_01", "units/props/blk/blk_totem_01", "units/beings/enemies/blk_shadow_lieutenant/chr_blk_shadow_lieutenant", "units/gameplay/belakor_crystal_socket_01" }
...
settings.game_object_extractors = {
	...
	shadow_dagger_unit = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
		...
		local extension_init_data = {
			...
			projectile_locomotion_system = { is_husk = true,
				angle = angle,
				speed = speed,
				gravity_settings = NetworkLookup.projectile_gravity_settings [gravity_settings],
				target_vector = target_vector,
	...
	arena_belakor_big_statue_health = function (game_session, go_id, owner_id, unit, gameobject_functor_context)
		...
		local extension_init_data = {
			...
			death_system = { death_reaction_template = "level_object", is_husk = true },
	...
	belakor_crystal_socket = function (game_session, game_object_id, owner_id, unit, gameobject_functor_context)
		local extension_init_data = {
			objective_socket_system = { use_game_object_id = true } }
...
settings.game_object_templates = {
	orb_pickup_unit = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	shadow_dagger_unit = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	shadow_skull_unit = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	arena_belakor_big_statue_health = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = false, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	deus_belakor_locus = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	belakor_crystal = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	belakor_crystal_throw = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	belakor_totem = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	shadow_homing_skulls_spawner = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false },
	...
	belakor_crystal_socket = { game_object_created_func_name = "game_object_created_network_unit", syncs_position = true, syncs_rotation = true, game_object_destroyed_func_name = "game_object_destroyed_network_unit", is_level_unit = false } }
...
settings.entity_extensions = { "scripts/unit_extensions/ai_supplementary/shadow_dagger_spawner_extension", "scripts/unit_extensions/ai_supplementary/shadow_homing_skulls_spawner_extension", "scripts/unit_extensions/ai_supplementary/shadow_dagger_extension", "scripts/unit_extensions/deus/deus_belakor_locus_extension", "scripts/unit_extensions/deus/deus_arena_belakor_big_statue_extension", "scripts/unit_extensions/deus/deus_belakor_crystal_extension", "scripts/unit_extensions/deus/deus_belakor_totem_extension", "scripts/unit_extensions/deus/deus_belakor_statue_socket_extension", "scripts/unit_extensions/generic/kill_volume_handler_extension" }
...
settings.systems = { "scripts/entity_system/systems/orb/orb_system" }


settings.entity_system_params = {
	shadow_homing_skulls_spawner_system = { system_class_name = "ExtensionSystemBase", system_name = "shadow_homing_skulls_spawner_system",


		extension_list = { "ShadowHomingSkullsSpawnerExtension" } },

	shadow_dagger_spawner_system = { system_class_name = "ExtensionSystemBase", system_name = "shadow_dagger_spawner_system",


		extension_list = { "ShadowDaggerSpawnerExtension" } },

	shadow_dagger_system = { system_class_name = "ExtensionSystemBase", system_name = "shadow_dagger_system",


		extension_list = { "ShadowDaggerExtension" } },

	deus_belakor_locus_system = { system_class_name = "ExtensionSystemBase", system_name = "deus_belakor_locus_system",


		extension_list = { "DeusBelakorLocusExtension" } },

	deus_belakor_crystal_system = { system_class_name = "ExtensionSystemBase", system_name = "deus_belakor_crystal_system",


		extension_list = { "DeusBelakorCrystalExtension" } },

	deus_arena_belakor_big_statue_system = { system_class_name = "ExtensionSystemBase", system_name = "deus_arena_belakor_big_statue_system",


		extension_list = { "DeusArenaBelakorBigStatueExtension" } },

	deus_belakor_totem_system = { system_class_name = "ExtensionSystemBase", system_name = "deus_belakor_totem_system",


		extension_list = { "DeusBelakorTotemExtension" } },

	deus_belakor_statue_socket_system = { system_class_name = "ExtensionSystemBase", system_name = "deus_belakor_statue_socket_system",


		extension_list = { "DeusBelakorStatueSocketExtension" } },

	orb_system = { system_class_name = "OrbSystem", system_name = "orb_system",


		extension_list = { } },

	kill_volume_handler_system = { system_class_name = "ExtensionSystemBase", system_name = "kill_volume_handler_system",


		extension_list = { "KillVolumeHandlerExtension" } } }



settings.network_damage_sources = { "tiny_explosive_barrel" }



settings.network_go_types = { "orb_pickup_unit", "shadow_dagger_spawner", "shadow_dagger_unit", "arena_belakor_big_statue_health", "deus_belakor_locus", "belakor_crystal", "belakor_crystal_throw", "belakor_totem", "shadow_homing_skulls_spawner", "shadow_skull_unit", "belakor_crystal_socket" }
...
settings.mutators = { "challenge_test", "arena_belakor_script", "curse_belakors_shadows", "curse_shadow_daggers", "curse_shadow_homing_skulls", "curse_belakor_totems", "curse_grey_wings" }
...
settings.network_packages = { "resource_packages/mutators/mutator_curse_shadow_daggers", "resource_packages/mutators/mutator_curse_shadow_homing_skulls", "resource_packages/mutators/mutator_curse_belakor_totems", "resource_packages/mutators/mutator_curse_grey_wings" }
...
settings.effects = { "fx/cursed_chest_spawn_01_portal", "fx/blk_grey_wings_01", "fx/blk_grey_wings_spawn_01", "fx/blk_grey_wings_teleport_01", "fx/blk_grey_wings_teleport_direction_01", "fx/trail_locus" }
...
settings.dialogue_event_data_lookup = { "belakor_crystal" }
...
settings.death_reactions = { "scripts/settings/dlcs/belakor/belakor_death_reactions" }



settings.interactions = { "deus_belakor_locus_pre_crystal", "deus_belakor_locus_with_crystal" }




settings.interactions_filenames = { "scripts/settings/dlcs/belakor/belakor_interactions" }



settings.hit_effects = { "scripts/settings/hit_effects/hit_effects_shadow_totem", "scripts/settings/hit_effects/hit_effects_shadow_skull" }