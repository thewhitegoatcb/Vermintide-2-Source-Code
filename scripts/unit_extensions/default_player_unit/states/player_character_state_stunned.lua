...
function PlayerCharacterStateStunned:init(character_state_init_context)
	...
	self.inputs_to_buffer = { "action_career_release", "action_career", "wield_switch", "wield_1", "wield_2", "wield_3", "wield_4", "wield_4_alt", "wield_5", "action_one" }
...
function PlayerCharacterStateStunned:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateStunned:on_exit(unit, input, dt, context, t, next_state)
	local input_extension = self.input_extension
...
function PlayerCharacterStateStunned:update(unit, input, dt, context, t)
	local csm = self.csm
	local input_extension = self.input_extension
...
function PlayerCharacterStateStunned:queue_input(input, input_extension, inventory_extension)
