...
function BTFollowCommanderAction:init(...)
	BTFollowCommanderAction.super.init(self, ...)
end

BTFollowCommanderAction.name = "BTFollowCommanderAction"

function BTFollowCommanderAction:enter(unit, blackboard, t)
	...
	if
	wield_weapon and ScriptUnit.has_extension(unit, "ai_inventory_system") then
...
function BTFollowCommanderAction:leave(unit, blackboard, t, reason, destroy)
	if not destroy then
...
function BTFollowCommanderAction:run(unit, blackboard, t, dt)
	local navigation_extension = blackboard.navigation_extension
...
function BTFollowCommanderAction:start_move_animation(unit, blackboard)
...
function BTFollowCommanderAction:start_move_rotation(unit, blackboard, t, dt)
...
function BTFollowCommanderAction:toggle_start_move_animation_lock(unit, should_lock_ani, blackboard)
