...
function BTCritterNurglingRoamAction:leave(unit, blackboard, t, reason, destroy)
...
function BTCritterNurglingRoamAction:run(unit, blackboard, t)
...
function BTCritterNurglingRoamAction:find_move_pos(blackboard, action)
...
function BTCritterNurglingRoamAction:start_move_animation(unit, blackboard)
	Managers.state.network:anim_event(unit, "walk")
	blackboard.move_state = "moving"
end

function BTCritterNurglingRoamAction:start_idle_animation(unit, blackboard)
	Managers.state.network:anim_event(unit, "idle")
	blackboard.move_state = "idle"
end

function BTCritterNurglingRoamAction:try_exit_state(unit, blackboard, action, t)
...
function BTCritterNurglingRoamAction:has_overlap(unit, blackboard, action)
