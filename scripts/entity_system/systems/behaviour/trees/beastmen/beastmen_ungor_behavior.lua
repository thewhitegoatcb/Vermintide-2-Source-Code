...
local UNGOR_COMBAT = { "BTUtilityNode",
...
local UNGOR_SMART_OBJECT = { "BTSelector",
...
BreedBehaviors.ungor = { "BTSelector",
	...
	UNGOR_SMART_OBJECT,
	UNGOR_COMBAT, { "BTMoveToGoalAction", name = "move_to_goal", condition = "has_goal_destination",
	...
	{ "BTFallbackIdleAction", name = "fallback_idle" }, name = "ungor" }