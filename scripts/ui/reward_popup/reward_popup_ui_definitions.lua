...
local CLOSE_BUTTON_SIZE = { 370, 70 }
...
local scenegraph_definition = {
	screen = { scale = "fit",
		position = { 0, 0, UILayer.end_screen_banner },
		size = { SIZE_X, SIZE_Y } },
	...
	background_top = { vertical_alignment = "bottom", parent = "background", horizontal_alignment = "center",
	...
	deus_background_top = { vertical_alignment = "bottom", parent = "background", horizontal_alignment = "center",
	...
	background_top_glow = { vertical_alignment = "bottom", parent = "background_top", horizontal_alignment = "center",
	...
	deus_background_top_glow = { vertical_alignment = "bottom", parent = "deus_background_top", horizontal_alignment = "center",
	...
	background_bottom = { vertical_alignment = "top", parent = "background", horizontal_alignment = "center",
	...
	deus_background_bottom = { vertical_alignment = "top", parent = "background", horizontal_alignment = "center",
	...
	background_bottom_glow = { vertical_alignment = "top", parent = "background_bottom", horizontal_alignment = "center",
	...
	deus_background_bottom_glow = { vertical_alignment = "top", parent = "deus_background_bottom", horizontal_alignment = "center",
	...
	background_center = { vertical_alignment = "center", parent = "background", horizontal_alignment = "center",
	...
	entry_root = { vertical_alignment = "center", parent = "background_center", horizontal_alignment = "center",
	...
	deus_item_tooltip = { vertical_alignment = "bottom", parent = "deus_background_top", horizontal_alignment = "center",
	...
	deus_power_up = { vertical_alignment = "top", parent = "deus_background_top", horizontal_alignment = "center",
	...
	item_tooltip = { vertical_alignment = "bottom", parent = "background_top", horizontal_alignment = "center",
	...
	title_root = { vertical_alignment = "center", parent = "background_top", horizontal_alignment = "center",
	...
	level_root = { vertical_alignment = "center", parent = "entry_root", horizontal_alignment = "center",
	...
	reward_root = { vertical_alignment = "center", parent = "background_bottom", horizontal_alignment = "center",
	...
	deus_reward_root = { vertical_alignment = "center", parent = "deus_background_top", horizontal_alignment = "center",
	...
	texture_root = { vertical_alignment = "center", parent = "reward_root", horizontal_alignment = "center",
	...
	item_root = { vertical_alignment = "center", parent = "reward_root", horizontal_alignment = "center",
	...
	item_list_root = { vertical_alignment = "center", parent = "reward_root", horizontal_alignment = "center",

		position = { 0, 0, 10 },
		offset = { 0.5 * PADDING, 0.5 * PADDING + 80 + 15, 0 },
		size = { ( 80 + PADDING ) * ITEM_LIST_MAX_COLUMNS, 80 } },



	deus_item_root = { vertical_alignment = "center", parent = "deus_reward_root", horizontal_alignment = "center",
	...
	deus_icon = { vertical_alignment = "center", parent = "deus_reward_root", horizontal_alignment = "center",
	...
	career_root = { vertical_alignment = "center", parent = "reward_root", horizontal_alignment = "center",
	...
	claim_button = { vertical_alignment = "bottom", parent = "screen", horizontal_alignment = "center",
...
local title_text_style = { word_wrap = true, font_size = 46, localize = false, use_shadow = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
...
local level_text_style = { word_wrap = true, font_size = 46, localize = false, use_shadow = true, horizontal_alignment = "center", vertical_alignment = "center", font_type = "hell_shark_header",
	...
	return {
		element = {
			passes = { { texture_id = "texture_id", style_id = "texture_id", pass_type = "texture" },
				...
				{ texture_id = "background", style_id = "background", pass_type = "texture" },



				{ texture_id = "frame", style_id = "frame", pass_type = "texture" } } },
		...
		content = { frame = "reward_pop_up_item_frame", background = "reward_pop_up_item_bg",
			texture_id = texture },
	...
	return {
		element = {
			passes = { { texture_id = "texture_id", style_id = "texture_id", pass_type = "texture" },
				...
				{ texture_id = "rarity_texture", style_id = "rarity_texture", pass_type = "texture" } } },
		...
		content = { frame = "reward_pop_up_item_frame", rarity_texture = "icon_bg_plentiful",
			texture_id = texture },
...
local function create_item_list_widget(scenegraph_id)
	local passes = { }
	local content = { frame = "reward_pop_up_item_frame", illusion = "item_frame_illusion", no_equipped_item = true }
	...
	for i = 1, ITEM_LIST_MAX_COLUMNS * ITEM_LIST_MAX_ROWS do
		...
		passes [#passes + 1] = { pass_type = "texture", style_id = rarity_key, texture_id = rarity_key, content_check_function = content_check_function }
		passes [#passes + 1] = { pass_type = "texture", style_id = icon_key, texture_id = icon_key, content_check_function = content_check_function }
		passes [#passes + 1] = { texture_id = "illusion", pass_type = "texture", style_id = illusion_key,
			content_check_function = function (arg_content)
				return arg_content [item_key] and arg_content [illusion_key]
			end }

		passes [#passes + 1] = { texture_id = "frame", pass_type = "texture", style_id = frame_key, content_check_function = content_check_function }
		passes [#passes + 1] = { pass_type = "hover", style_id = tooltip_key, content_check_function = content_check_function }
		passes [#passes + 1] = { pass_type = "item_tooltip",

			item_id = item_key,
			style_id = tooltip_key,
			content_check_function = function (arg_content)
				if not arg_content [item_key] then return false end
				local selected_i = arg_content.selected_i
				if selected_i then
					do return selected_i == i end
				else
		...
		style [rarity_key] = { offset = { 0, 0, 0 }, size = { 80, 80 } }
		style [icon_key] = { offset = { 0, 0, 1 }, size = { 80, 80 } }
		style [illusion_key] = { offset = { 0, 0, 3 }, size = { 80, 80 } }
		style [frame_key] = { offset = { 0, 0, 4 }, size = { 80, 80 } }
		style [tooltip_key] = { font_type = "hell_shark", localize = true, font_size = 18, horizontal_alignment = "left", vertical_alignment = "top", max_width = 500,
			offset = { 0, 0, 5 },
			size = { 80, 80 },
	...
	passes [#passes + 1] = { pass_type = "texture_frame", style_id = "cursor", texture_id = "cursor",
	...
	return {
		element = {
			passes = { { texture_id = "texture_id", style_id = "texture_id", pass_type = "texture" },
				...
				{ texture_id = "illusion_overlay", style_id = "illusion_overlay", pass_type = "texture" } } },
		...
		content = { frame = "reward_pop_up_item_frame", rarity_texture = "icon_bg_plentiful", illusion_overlay = "item_frame_illusion",
			texture_id = texture },
...
local function create_description_text_widget(text, scenegraph_id)
	local text_offset = { 0, 6, 2 }
	local text_style = { vertical_alignment = "bottom", word_wrap = true, horizontal_alignment = "center", font_size = 28, font_type = "hell_shark",
	...
	text_shadow_style.text_color = { 255, 0, 0, 1 }
	text_shadow_style.offset = { text_offset [1] + 2, text_offset [2] - 2, text_offset [3] - 1 }

	local title_text_offset = { 0, 0, 2 }
	local title_text_style = { vertical_alignment = "top", word_wrap = true, horizontal_alignment = "center", font_size = 46, font_type = "hell_shark_header",
	...
	title_text_shadow_style.text_color = { 255, 0, 0, 1 }
...
local function create_power_up(scenegraph_id)
	return {
		...
		content = { title_text = "", icon_frame = "weapon_icon_glow_white", rarity_text = "", shrine_bg = "shrine_blessing_bg_hover", visible = true, description_text = "", icon_glow = "popup_icon_glow_white",
		...
		style = {
			...
			shrine_bg_frame_left = { vertical_alignment = "top", horizontal_alignment = "left",
				color = { 255, 255, 255, 255 },
				texture_size = { 242, scenegraph_definition.deus_power_up.size [2] },
			...
			icon_glow = { vertical_alignment = "top", horizontal_alignment = "center",
				color = { 255, 255, 255, 255 },
			...
			icon_frame = { vertical_alignment = "top", horizontal_alignment = "center",
				color = { 255, 255, 255, 255 },
			...
			title_text = { font_type = "hell_shark_header", upper_case = true, localize = false, word_wrap = false, font_size = 28, horizontal_alignment = "left", vertical_alignment = "top", dynamic_font_size = true,
				...
				area_size = { 240, scenegraph_definition.deus_power_up.size [2] },
...
local function create_deus_icon(scenegraph_id)
	return {
		...
		content = { icon_bg = "button_frame_01" },



		style = {
			icon = { vertical_alignment = "bottom", horizontal_alignment = "center",
				color = { 255, 255, 255, 255 },


				offset = { 0, 0, 2 },
				texture_size = { 58, 58 },
				default_texture_size = { 58, 58 } },

			icon_bg = { vertical_alignment = "bottom", horizontal_alignment = "center",
				color = { 255, 255, 255, 255 },


				offset = { 0, -6, 0 },
				texture_size = { 70, 70 },
				default_texture_size = { 70, 70 } },

			rectangular_bg = { vertical_alignment = "bottom", horizontal_alignment = "center",
				color = { 255, 0, 0, 0 },
...
local tooltip_passes = { "item_titles", "skin_applied", "fatigue", "item_power_level", "properties", "traits", "keywords" }
...
local widget_definitions = {
	...
	texture = { scenegraph_id = "item_root",
		element = {
			passes = { { texture_id = "texture_id", style_id = "texture_id", pass_type = "texture" } } },
		...
		content = { texture_id = "icons_placeholder" },
	...
	background_center = UIWidgets.create_simple_uv_texture("reward_pop_up_01_bg", { { 0, 0.5 }, { 1, 0.5 } }, "background_center"),
	background_bottom = UIWidgets.create_simple_uv_texture("reward_popup_panel", { { 1, 1 }, { 0, 0 } }, "background_bottom"),
	background_bottom_glow = UIWidgets.create_simple_uv_texture("mission_objective_bottom", { { 0, 0 }, { 1, 1 } }, "background_bottom_glow"),
	background_top_glow = UIWidgets.create_simple_uv_texture("mission_objective_top", { { 0, 0 }, { 1, 1 } }, "background_top_glow"),
	screen_background = UIWidgets.create_simple_rect("screen", { 100, 0, 0, 0 }),
	...
	deus_background_bottom = UIWidgets.create_simple_uv_texture("reward_popup_panel_morris", { { 1, 1 }, { 0, 0 } }, "deus_background_bottom"),
	deus_background_top_glow = UIWidgets.create_simple_uv_texture("mission_objective_top", { { 0, 0 }, { 1, 1 } }, "deus_background_top_glow"),
	deus_background_bottom_glow = UIWidgets.create_simple_uv_texture("mission_objective_bottom", { { 0, 0 }, { 1, 1 } }, "deus_background_bottom_glow"),
...
local animations = {
	entry_enter = { { name = "fade_in_title_text", duration = 0.2,
	...
	entry_exit = { { name = "fade_out_title_text", duration = 0.2,
	...
	open = { { name = "reset", start_progress = 0, end_progress = 0,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "fade_in_blur", start_progress = 0, end_progress = 0.3,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "background_fade_in", start_progress = 0.3, end_progress = 0.5,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "background_entry", start_progress = 0, end_progress = 0.4,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "background_expand", start_progress = 0.4, end_progress = 0.5,
	...
	close = { { name = "background_collapse", start_progress = 0, end_progress = 0.15,
		...
		{ name = "fade_out_background", start_progress = 0.15, end_progress = 0.4,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "fade_out_blur", start_progress = 0.4, end_progress = 0.5,
	...
	deus_open = { { name = "reset", start_progress = 0, end_progress = 0,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "background_fade_in", start_progress = 0, end_progress = 0.3,
		...
		{ name = "background_entry", start_progress = 0, end_progress = 0.4,
			...
			on_complete = function (ui_scenegraph, scenegraph_definition, widgets, params)
				return end },
		{ name = "background_expand", start_progress = 0.3, end_progress = 0.4,
	...
	deus_close = { { name = "background_collapse", start_progress = 0, end_progress = 0.15,
...
local generic_input_actions = {
	default = { { input_action = "confirm", priority = 2, description_text = "welcome_currency_popup_button_claim" },




		{ input_action = "d_pad", priority = 2, description_text = "input_description_navigate", ignore_keybinding = true },





		{ input_action = "right_stick_press", priority = 3, description_text = "input_description_tooltip" } } }
