...
function BuffUI:init(parent, ingame_ui_context)
...
function BuffUI:_create_ui_elements()
...
function BuffUI:on_spectator_target_changed(spectated_player_unit)
...
local COLOR_BUFF = { 255, 48, 255, 0 }
local COLOR_DEBUFF = { 255, 255, 30, 0 }
...
function BuffUI:_remove_buff(index)
...
local customizer_data = { root_scenegraph_id = "pivot", label = "Buff bar", registry_key = "buff_ui", drag_scenegraph_id = "pivot_dragger" }
...
function BuffUI:set_panel_alpha(alpha)
