...
function DeusUpgradeWeaponInteractionUI:init(parent, ingame_ui_context)
	DeusUpgradeWeaponInteractionUI.super.init(self, parent, ingame_ui_context)
end

function DeusUpgradeWeaponInteractionUI:chest_unlock_failed(chest_type)
	if chest_type == DeusUpgradeWeaponInteractionUI.TYPE then
		self:_start_animation("chest_unlock_failed")
	end
end

function DeusUpgradeWeaponInteractionUI:_populate_widget(interactable_unit, wielded_slot_name)
