PerformanceTitles = {
	...
	titles = {
		headhunter = { evaluation_template = "equal_higher", display_name = "performance_title_headhunter", amount = 1,



			stat_types = { { "headshots" } } },





		doctor = { evaluation_template = "equal_higher", display_name = "performance_title_doctor", amount = 1,



			stat_types = { { "times_friend_healed" } } },





		savior = { evaluation_template = "equal_higher", display_name = "performance_title_savior", amount = 1,
		...
		reviver = { evaluation_template = "equal_higher", display_name = "performance_title_reviver", amount = 1,
...
for title_name, settings in pairs(PerformanceTitles.titles) do
	...
	fassert(template, "Performance Titles %s failed, no evaluation_template called %s", title_name, tostring(evaluation_template)) end