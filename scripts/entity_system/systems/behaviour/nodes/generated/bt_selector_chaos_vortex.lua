...
function BTSelector_chaos_vortex:init(...)
	BTSelector_chaos_vortex.super.init(self, ...)
	self._children = { }
end

function BTSelector_chaos_vortex:leave(unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

function BTSelector_chaos_vortex:run(unit, blackboard, t, dt)
...
function BTSelector_chaos_vortex:add_child(node)
