...
base_trail_light_urn_definition.config = { allow_rotation_update = false, hud_verb = "player_interaction", block_other_interactions = true, activate_block = true, hold = true, swap_to_3p = true, animation = "interaction_torch", rotate_toward_interactable = true, show_weapons = true }
...
function base_trail_light_urn_definition.server.start(world, interactor_unit, interactable_unit, data, config, t)
...
function base_trail_light_urn_definition.client.start(world, interactor_unit, interactable_unit, data, config, t)
	...
	local interactor_animation_time_variable = Unit.get_data(interactable_unit, "interaction_data",
	"interactor_animation_time_variable")
	...
	if interactor_animation_name then
		local interactor_animation_time_variable = Unit.animation_find_variable(interactor_unit,
		interactor_animation_time_variable)
		Unit.animation_set_variable(interactor_unit, interactor_animation_time_variable, duration)
		local interactor_animation_name = Unit.get_data(interactable_unit, "interaction_data",
		"interactor_animation")
...
function base_trail_light_urn_definition.server.update(world, interactor_unit, interactable_unit, data, config, dt, t)
	...
	local trail_urn_alignment_extension = ScriptUnit.extension(interactable_unit, "trail_urn_alignment_system")
	if trail_urn_alignment_extension:is_state_aligned() and
	trail_urn_alignment_extension:is_unit_pushed_out_off_range(interactor_unit, interactable_unit) then
		return InteractionResult.FAILURE
	end
...
function base_trail_light_urn_definition.client.update(world, interactor_unit, interactable_unit, data, config, dt, t)

	local trail_urn_alignment_extension = ScriptUnit.extension(interactable_unit, "trail_urn_alignment_system")
	trail_urn_alignment_extension:on_client_move_to_node(interactor_unit, interactable_unit, data.is_husk, t)
end

function base_trail_light_urn_definition.server.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function base_trail_light_urn_definition.client.stop(world, interactor_unit, interactable_unit, data, config, t, result)
...
function base_trail_light_urn_definition.server.can_interact(interactor_unit, interactable_unit, data, config)
	...
	local custom_interaction_check_name = Unit.get_data(interactable_unit, "interaction_data",
	"custom_interaction_check_name")
	if custom_interaction_check_name then
		...
		if
		interaction_custom_check_func and not InteractionCustomChecks [custom_interaction_check_name](interactor_unit, interactable_unit) then
			return false
		end
	end
...
function base_trail_light_urn_definition.client.can_interact(interactor_unit, interactable_unit, data, config)
	local trail_urn_alignment_extension = ScriptUnit.extension(interactable_unit, "trail_urn_alignment_system")
