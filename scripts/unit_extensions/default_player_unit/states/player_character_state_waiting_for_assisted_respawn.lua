...
function PlayerCharacterStateWaitingForAssistedRespawn:init(character_state_init_context)
...
function PlayerCharacterStateWaitingForAssistedRespawn:on_enter(unit, input, dt, context, t, previous_state, params)
...
function PlayerCharacterStateWaitingForAssistedRespawn:on_exit(unit, input, dt, context, t, next_state)
	local first_person_extension = self.first_person_extension
...
function PlayerCharacterStateWaitingForAssistedRespawn:update(unit, input, dt, context, t)
	local csm = self.csm
	local status_extension = self.status_extension
