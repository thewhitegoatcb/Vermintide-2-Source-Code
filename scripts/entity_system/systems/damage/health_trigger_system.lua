...
local extensions = { "HealthTriggerExtension" }



function HealthTriggerSystem:init(entity_system_creation_context, system_name)
	HealthTriggerSystem.super.init(self, entity_system_creation_context, system_name, extensions)
	self.unit_extensions = { }
end

function HealthTriggerSystem:destroy()
...
function HealthTriggerSystem:on_add_extension(world, unit, extension_name, ...)
	local extension = { }
...
function HealthTriggerSystem:on_remove_extension(unit, extension_name)
...
function HealthTriggerSystem:extensions_ready(world, unit, extension_name)
...
function HealthTriggerSystem:update(context, t)
