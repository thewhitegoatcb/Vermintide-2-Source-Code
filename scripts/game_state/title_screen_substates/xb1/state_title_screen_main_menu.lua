...
local game_types = { INVITATION = "invitation", OFFLINE = "offline", ONLINE = "online" }
...
function StateTitleScreenMainMenu:_init_managers()
...
function StateTitleScreenMainMenu:_update_input(dt, t)
	...
	elseif
	not active_menu_selection and input_service:get("back") then
		self:_close_menu()
	end
...
function StateTitleScreenMainMenu:_check_connection_state()
...
function StateTitleScreenMainMenu:_check_privileges()
...
function StateTitleScreenMainMenu:cb_privilege_updated(privilege)
...
function StateTitleScreenMainMenu:_signin_to_xsts()
...
function StateTitleScreenMainMenu:cb_xsts_token_received(data)
