...
local function has_melee_weapon_equipped(unit)
	...
	if slot_data == nil then return false
	end
	local right_unit_1p = slot_data.right_unit_1p

	if ScriptUnit.has_extension(right_unit_1p, "ammo_system") then return false
	end
	return true
end
...
TutorialTemplates = {
	...
	core_needs_help = { priority = 50, action = "interact", needed_points = 0, text = "player_in_need_of_help", display_type = "tooltip", icon = "hud_tutorial_icon_attention", is_mission_tutorial = true,
		...
		can_show = function (t, unit, data, raycast_unit)
			...
			if has_raycast_unit and raycast_unit_dist < 400 then
				do return true, raycast_unit_pos end
	...
	core_revive = { priority = 45, action = "interact", do_not_verify = true, needed_points = 0, text = "tutorial_tooltip_core_revive", display_type = "tooltip", icon = "hud_tutorial_icon_attention", is_mission_tutorial = true,
...
TutorialTemplates.advanced_grenade = { priority = 60, needed_points = 3, allowed_in_tutorial = true, display_type = "tooltip", icon = "grenade_icon", is_mission_tutorial = true,
	...
	can_show = function (t, unit, data, raycast_unit, world)
		...
		local best_position = nil local best_distance_sq = 400
		...
		if best_position == nil then return false end
...
TutorialTemplates.play_go_tutorial_tooltip = { do_not_verify = true, needed_points = 3, allowed_in_tutorial = true, text = "none", display_type = "tooltip", icon = "hud_tutorial_icon_info",
	...
	alt_action_icons = { move_left = "left_stick", move_forward = "left_stick", action_instant_heal_other_hold = "d_up", move_back = "left_stick", move_right = "left_stick", action_instant_drink_potion = "d_right", action_instant_grenade_throw = "right_shoulder" },
...
TutorialTemplates.elite_cage_respawn = { priority = 30, needed_points = 3, text = "tutorial_tooltip_elite_cage_respawn", display_type = "tooltip", icon = "hud_tutorial_icon_rescue", is_mission_tutorial = true,
...
local enemy_texts = { skaven_loot_rat = "tutorial_infoslate_elite_enemy_loot_rat", skaven_storm_vermin = "tutorial_infoslate_elite_enemy_storm_vermin",



	skaven_ratling_gunner = { "tutorial_infoslate_elite_enemy_ratling_gunner", "tutorial_infoslate_elite_enemy_ratling_gunner_02" },

	skaven_storm_vermin_commander = { "tutorial_infoslate_elite_enemy_storm_vermin_commander", "tutorial_infoslate_elite_enemy_storm_vermin_commander_02" },
	skaven_poison_wind_globadier = { "tutorial_infoslate_elite_enemy_poison_wind_globadier", "tutorial_infoslate_elite_enemy_poison_wind_globadier_02" },
	skaven_gutter_runner = { "tutorial_infoslate_elite_enemy_gutter_runner", "tutorial_infoslate_elite_enemy_gutter_runner_smoke_bomb" },
	skaven_rat_ogre = { "tutorial_infoslate_elite_enemy_rat_ogre", "tutorial_infoslate_elite_enemy_rat_ogre_02" },
	skaven_pack_master = { "tutorial_infoslate_elite_enemy_pack_master", "tutorial_infoslate_elite_enemy_pack_master_02" } }
...
TutorialTemplates.objective_pickup = { priority = 4, action = "interact", needed_points = 4, display_type = "objective_tooltip", icon = "hud_tutorial_icon_mission", is_mission_tutorial = true,





	game_mode_icons = { weave = "hud_weaves_icon_mission" },
	...
	can_show = function (t, unit, data, raycast_unit, world)
		...
		if slot_name == "slot_level_event" and slot_data ~= nil then
			for objective_unit, _ in pairs(obj_units) do
				...
				local carrying_objective_item =
				obj_left_hand_unit and obj_left_hand_unit == slot_data.left_hand_unit_name
				carrying_objective_item =
				carrying_objective_item and obj_right_hand_unit == slot_data.right_hand_unit_name
...
TutorialTemplates.objective_socket = { priority = 5, action = "interact", needed_points = 0, display_type = "objective_tooltip", icon = "hud_tutorial_icon_mission", is_mission_tutorial = true,
		...
		if slot_name == "slot_level_event" and slot_data ~= nil then
			...
			for socket_unit, socket_extension in pairs(units) do
				...
				if sockets_enabled and tutorial_text_enabled then
					...
					if socket_extension.num_closed_sockets < socket_extension.num_sockets and
					distance_sq < socket_extension.distance then
						objective_units_n = objective_units_n + 1
			...
			if objective_units_n == 0 then return false
			end
...
TutorialTemplates.objective_unit = { priority = 1, action = "interact", needed_points = 0, display_type = "objective_tooltip", icon = "hud_tutorial_icon_mission", is_mission_tutorial = true,
