...
function LevelEndView:init(context)
	LevelEndView.super.init(self, context)
	self._weave_render_settings = { snap_pixel_positions = true }
...
function LevelEndView:setup_pages(game_won, rewards)
...
function LevelEndView:_setup_pages_untrusted()
	local index_by_state_name = { EndViewStateScore = 1 }
	return index_by_state_name
end

function LevelEndView:_setup_pages_victory(rewards)
...
function LevelEndView:_setup_pages_defeat()
	local index_by_state_name = {
...
function LevelEndView:create_ui_elements()
	self.ui_animations = { }
...
function LevelEndView:draw_weave_widgets(dt, input_service)
...
function LevelEndView:draw(dt, input_service)
	local ui_renderer = self.ui_renderer
...
function LevelEndView:update(dt, t)
...
function LevelEndView:_update_gamepad_input(dt, t)
	local input_service = self:input_service()
...
function LevelEndView:input_enabled()
	return not self._ready_button_widget.content.button_hotspot.disable_button
end

function LevelEndView:set_input_description(input_desc)
...
function LevelEndView:_update_animations(dt, t)
...
function LevelEndView:destroy()
	LevelEndView.super.destroy(self)
end

function LevelEndView:active_input_service()
	return self.input_blocked and FAKE_INPUT_SERVICE or self:input_service()
end

function LevelEndView:_start_animation(animation_name)
	local params = { wwise_world = self.wwise_world, render_settings = self.render_settings }
...
function LevelEndView:_retry_level()
...
function LevelEndView:signal_done(do_reload)
...
function LevelEndView:peer_signaled_done(peer_id, do_reload)
...
function LevelEndView:_setup_camera()
...
function LevelEndView:_push_mouse_cursor()
