...
function TimedExplosionExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
...
function TimedExplosionExtension:update(unit, input, dt, context, t)
...
function TimedExplosionExtension:_explode()
...
function TimedExplosionExtension:_invoke_on_explode_callbacks()
...
function TimedExplosionExtension:add_on_explode_callback(callback)
