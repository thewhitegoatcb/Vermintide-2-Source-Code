...
function BTLootRatAlertedAction:init(...)
	BTLootRatAlertedAction.super.init(self, ...)
end

BTLootRatAlertedAction.name = "BTLootRatAlertedAction"

function BTLootRatAlertedAction:enter(unit, blackboard, t)
...
function BTLootRatAlertedAction:init_alerted(unit, blackboard)
...
function BTLootRatAlertedAction:leave(unit, blackboard, t, reason, destroy)
	if script_data.enable_alert_icon then
		local category_name = "detect"
...
function BTLootRatAlertedAction:run(unit, blackboard, t, dt)
