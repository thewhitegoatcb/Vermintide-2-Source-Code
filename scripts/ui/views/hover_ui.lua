local scenegraph_definition = {
	root = { is_root = true,
		size = { 1920, 1080 },
		position = { 0, 0, UILayer.hover } },


	hover_root = { vertical_alignment = "bottom", parent = "root", horizontal_alignment = "left",
	...
	default_hover_widget = { vertical_alignment = "center", parent = "hover_root", horizontal_alignment = "center",
...
local widget_definitions = {
	default_hover_widget = { scenegraph_id = "default_hover_widget",
		element = {
			passes = { { texture_id = "background", style_id = "background", pass_type = "rounded_background" },
		...
		style = {
			text = { font_size = 28, word_wrap = true, pixel_perfect = true, horizontal_alignment = "center", vertical_alignment = "center", dynamic_font = true, font_type = "hell_shark",
...
function HoverUI:init(ingame_ui_context, input_service)
...
function HoverUI:draw(dt, ui_scenegraph, input_service)
...
function HoverUI:update_objects()
...
function HoverUI:display_object(name, type, content, style)
...
function HoverUI:stop_display_object()

	return end

function HoverUI:destroy(dt)

	return end

function HoverUI:register_widget(name, tooltip_type, hover_content, content, style)
...
function HoverUI:unregister_widget(name)
...
function HoverUI:get_text_size(localized_text, text_style)
...
function HoverUI:animate_default_widget()
...
function HoverUI:set_default_widget_text(text)
	local ui_scenegraph = self.ui_scenegraph
...
function HoverUI:update_widget_pivot_position(ui_scenegraph, input_service)
	local active_widget = self.active_tooltip_widget
	if active_widget then
