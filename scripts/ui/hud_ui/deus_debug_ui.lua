...
function DeusDebugUI:init(parent, ingame_ui_context)
...
function DeusDebugUI:destroy()
	World.destroy_gui(self._world, self._gui)
	self._gui = nil
end

function DeusDebugUI:update(dt, t)
	self:_draw(dt, t)
end

function DeusDebugUI:_draw(dt, t)
	self:_draw_left_side(dt, t)
	self:_draw_right_side(dt, t)
end

function DeusDebugUI:_draw_right_side(dt, t)
...
function DeusDebugUI:_draw_left_side(dt, t)
	local deus_run_controller = Managers.mechanism:game_mechanism():get_deus_run_controller()
