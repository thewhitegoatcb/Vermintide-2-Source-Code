...
local XB1_ACHIEVEMENT_ID = { karak_azgaraz_complete_dlc_dwarf_exterior_legend = 120, dwarf_jump_puzzle = 116, dwarf_towers = 117 }





local PS4_ACHIEVEMENT_ID = { dwarf_jump_puzzle = "090" }




local all_difficulties = { }
local portals = { LevelSettings.dlc_dwarf_exterior }
...
achievements.dwarf_towers = { name = "achv_dwarf_towers_name", display_completion_ui = true, icon = "achievement_dwarf_towers", desc = "achv_dwarf_towers_desc",





	events = { "progress_dwarf_towers_challenge" },
...
achievements.dwarf_chain_speed = { name = "achv_dwarf_chain_speed_name", display_completion_ui = true, icon = "achievement_dwarf_chain_speed",
	...
	events = { "progress_dwarf_chain_speed_challenge" },
...
achievements.dwarf_jump_puzzle = { name = "achv_dwarf_jump_puzzle_name", display_completion_ui = true, icon = "achievement_dwarf_jump_puzzle", desc = "achv_dwarf_jump_puzzle_desc",
	...
	events = { "complete_dwarf_jump_puzzle_challenge" },
...
achievements.dwarf_push = { name = "achv_dwarf_push_name", display_completion_ui = true, icon = "achievement_dwarf_push",
	...
	progress = function (statistics_db, stats_id, template_data)
		...
		return { completed, DWARF_PUSH_AMOUNT }
	end,
	completed = function (statistics_db, stats_id, template_data)
