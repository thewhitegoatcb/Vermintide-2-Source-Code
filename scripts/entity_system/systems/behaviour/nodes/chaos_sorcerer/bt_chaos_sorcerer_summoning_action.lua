...
function BTChaosSorcererSummoningAction:trigger_summon_sound(unit, blackboard, t)
...
function BTChaosSorcererSummoningAction:leave(unit, blackboard, t, reason, destroy)
...
function BTChaosSorcererSummoningAction:run(unit, blackboard, t, dt)
	local action = blackboard.action
...
function BTChaosSorcererSummoningAction:spawn_exalted_spell(unit, blackboard, t, dt, target_position)
...
function BTChaosSorcererSummoningAction:_start_vortex_summoning(unit, blackboard, t)
...
function BTChaosSorcererSummoningAction:_clean_up_vortex_summoning(unit, blackboard, t)
	local vortex_data = blackboard.vortex_data
...
function BTChaosSorcererSummoningAction:_update_vortex_summoning(unit, blackboard, t, dt)
	local vortex_data = blackboard.vortex_data
	local summon_position = vortex_data.vortex_spawn_pos:unbox()
...
function BTChaosSorcererSummoningAction:_launch_vortex_dummy_missile(owner_unit, action, vortex_data, spawn_position, target_position, target_dir)
	...
	local extension_init_data = {
		projectile_locomotion_system = { trajectory_template_name = "throw_trajectory", gravity_settings = "default",
			angle = angle,
		...
		projectile_system = { impact_template_name = "direct_impact", explosion_template_name = "chaos_vortex_dummy_missile",
...
function BTChaosSorcererSummoningAction:_spawn_boss_vortex(unit, blackboard, t, dt, target_position)
	local action = blackboard.action
...
function BTChaosSorcererSummoningAction:_spawn_vortex(unit, blackboard, t, dt, target_position, vortex_data)
	...
	vortex_data.queued_vortex [vortex_queue_id] = { inner_decal_unit = link_decal_units and inner_decal_unit, outer_decal_unit = link_decal_units and outer_decal_unit }
...
function BTChaosSorcererSummoningAction:spawn_portal(unit, blackboard, t, dt, target_position, portal_data)
	...
	local optional_data = {
		...
		prepare_func = function (breed, extension_init_data)
			extension_init_data.ai_supplementary_system = { tentacle_template_name = tentacle_template_name }
		end,
...
function BTChaosSorcererSummoningAction:boss_sorcerer_spawn_tentacle_in_arena(unit, blackboard, t)
	local breed = Breeds.chaos_tentacle
...
function BTChaosSorcererSummoningAction:init_boss_sorcerer_tentacle(unit, blackboard, t)
...
function BTChaosSorcererSummoningAction:init_summon_plague_wave(unit, blackboard, t)
...
function BTChaosSorcererSummoningAction:init_summon_vermintide(unit, blackboard, t)
	blackboard.summon_plague_wave_timer = t + 0.1
	blackboard.damage_wave_template_name = "vermintide"
end


function BTChaosSorcererSummoningAction:update_summon_plague_wave(unit, blackboard, t, dt)
...
function BTChaosSorcererSummoningAction:spawn_plague_wave(unit, blackboard, t, dt, target_position)
...
function BTChaosSorcererSummoningAction:spawn_plague_wave_from_spawner(unit, blackboard, t, dt, target_position)
	local plague_wave_pos = POSITION_LOOKUP [unit]
	...
	local extension_init_data = {
		area_damage_system = { damage_wave_template_name = "plague_wave",
...
function BTChaosSorcererSummoningAction:spawn_plague_waves_in_patterns(unit, blackboard, t, dt, target_position)
...
function BTChaosSorcererSummoningAction:init_summon_plague_wave_sequence(unit, blackboard, t)
	blackboard.summon_plague_wave_timer = t + 0.5
...
function BTChaosSorcererSummoningAction:update_sequenced_plague_wave_spawning(unit, blackboard, t, dt)
...
function BTChaosSorcererSummoningAction:clean_up_plague_wave(unit, blackboard, t)
	local target_unit = blackboard.target_unit
...
function BTChaosSorcererSummoningAction:init_boss_rings(unit, blackboard, t)
	blackboard.summoning_finished = true
end

function BTChaosSorcererSummoningAction:spawn_boss_rings(unit, blackboard, t)
	local action = blackboard.action
...
function BTChaosSorcererSummoningAction:update_boss_rings(unit, blackboard, t, dt)
	local world = blackboard.world
	local action = blackboard.action
	...
	for i, ring in ipairs(ring_sequence) do
		...
		if not done then
			...
			if ring.delay_time <= t and not ring.damage_effect_time then
				...
				local premonition_effect = premonition_type == "short" and ring_info [ring_position].premonition_effect_name_short or
				premonition_type == "medium" and ring_info [ring_position].premonition_effect_name_medium or
				premonition_type == "long" and ring_info [ring_position].premonition_effect_name_long
...
function BTChaosSorcererSummoningAction:clean_up_boss_rings(unit, blackboard, t)
