...
function PlayerUnitMovementSettings.get_movement_settings_table(unit)
...
function PlayerUnitMovementSettings.register_unit(unit)
	units_player_movement_setting [unit] = table.clone(PlayerUnitMovementSettings)
end

function PlayerUnitMovementSettings.unregister_unit(unit)
...
PlayerUnitMovementSettings.catapulted.directions.forward = { wall_collide_animation = "airtime_end", start_animation = "airtime_bwd", land_animation = "airtime_end" }




PlayerUnitMovementSettings.catapulted.directions.backward = { wall_collide_animation = "airtime_end", start_animation = "airtime_fwd", land_animation = "airtime_end" }




PlayerUnitMovementSettings.catapulted.directions.forward_thrown = { start_animation_1p = "airtime_bwd", start_animation = "airtime_fwd", wall_collide_animation = "airtime_end", land_animation = "airtime_end" }
...
PlayerUnitMovementSettings.dodging = {
	distance = 2,
	speed_at_times = {
		{ time_in_dodge = 0, speed = 1 },

		{ time_in_dodge = 0.05, speed = 4 },

		{ time_in_dodge = 0.1, speed = 7 },

		{ time_in_dodge = 0.25, speed = 5 },

		{ time_in_dodge = 0.4, speed = 2 },

		{ time_in_dodge = 0.5, speed = 1 } },
...
PlayerUnitMovementSettings.slowing_damage_types = { projectile = true, kinetic = true, blunt = true, slashing = true, vomit_face = true, warpfire_ground = false, plague_face = false, piercing = true, vomit_ground = false, warpfire_face = false, cutting = true, crush = true }
...
PlayerUnitMovementSettings.charged_settings.charged = { duration = 1, first_person_anim_name = "interrupt", third_person_anim_name = "idle" }
...
PlayerUnitMovementSettings.stun_settings.parry_broken = { duration = 1, first_person_anim_name = "parry_break", third_person_anim_name = "parry_break" }





PlayerUnitMovementSettings.stun_settings.pushed = { duration = 0.2, first_person_anim_name = "interrupt", third_person_anim_name = "idle" }
...
PlayerUnitMovementSettings.hit_react_settings = {
	light_push = { start_look_sense_override = 0.9, end_look_sense_override = 1, movement_speed_modifier = 1,
	...
	light = { start_look_sense_override = 0.6, end_look_sense_override = 1, movement_speed_modifier = 0.8,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
	...
	medium_push = { start_look_sense_override = 0.6, end_look_sense_override = 1, movement_speed_modifier = 0.8,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
	...
	medium = { start_look_sense_override = 0.4, end_look_sense_override = 0.8, movement_speed_modifier = 0.65,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
	...
	heavy_push = { start_look_sense_override = 0.4, end_look_sense_override = 0.8, movement_speed_modifier = 0.65,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
	...
	heavy = { start_look_sense_override = 0.35, end_look_sense_override = 0.7, movement_speed_modifier = 0.5,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
	...
	slow_bomb = { start_look_sense_override = 0.35, end_look_sense_override = 0.7, movement_speed_modifier = 0.1,
		look_override_function = function ()
			local look_override_x = 0.5 * (0.5 - math.random())
			local look_override_y = -0.5 + math.random() * 0.2
			return look_override_x, look_override_y
	...
	charged = { start_look_sense_override = 0.4, end_look_sense_override = 0.8, movement_speed_modifier = 0.65,
		look_override_function = function ()
...
PlayerUnitMovementSettings.overpowered_templates.fly_bomb = { end_sound_event = "Stop_sorcerer_boss_flies_curse_loop", start_sound_event = "Play_sorcerer_boss_flies_curse_loop" }
