...
function BTVictimGrabbedThrowAwayAction:init(...)
	BTVictimGrabbedThrowAwayAction.super.init(self, ...)
end

function BTVictimGrabbedThrowAwayAction:enter(unit, blackboard, t)
...
function BTVictimGrabbedThrowAwayAction:find_throw_direction(unit, blackboard, ray_length)
...
function BTVictimGrabbedThrowAwayAction:leave(unit, blackboard, t, reason, destroy)
...
function BTVictimGrabbedThrowAwayAction:catapult_player(unit, blackboard, throw_speed, throw_speed_z)
...
function BTVictimGrabbedThrowAwayAction:run(unit, blackboard, t, dt)
