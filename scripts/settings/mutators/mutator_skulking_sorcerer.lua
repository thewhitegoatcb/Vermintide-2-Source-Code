return { description = "description_skulking_sorcerer", display_name = "display_name_skulking_sorcerer", icon = "mutator_icon_skulking_sorcerer",
	...
	server_start_function = function (context, data)
		...
		function data.cb_mutator_sorcerer_spawned(unit, breed, optional_data)
		...
		data.respawn_times = { 8, 15 }
		data.initial_spawn_time = 45
		data.despawn_distance_sq = 3600
		data.wanted_respawn_main_path_distance = { 35, 45 }
	end,
