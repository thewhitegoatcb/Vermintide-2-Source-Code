...
function ImguiCraftItem:init()
	self._properties = { }
	self._traits = { }
	self._skins = { }
	self._types = { }
	self._rarities = { "default", "plentiful", "common", "rare", "exotic", "unique", "magic" }
...
function ImguiCraftItem:update()
...
function ImguiCraftItem:is_persistent()
	return false
end

function ImguiCraftItem:draw(is_open)
...
function ImguiCraftItem:give_item(item_key, power_level, skin_name, rarity, magic_level, properties, traits)
...
function ImguiCraftItem:_parse_master_list()
...
function ImguiCraftItem:_get_skins_for_item(item_name)
	if item_name then
