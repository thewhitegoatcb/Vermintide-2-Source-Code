...
function BTMoveToGoalAction:init(...)
	BTMoveToGoalAction.super.init(self, ...)
end

BTMoveToGoalAction.name = "BTMoveToGoalAction"

function BTMoveToGoalAction:enter(unit, blackboard, t)
...
function BTMoveToGoalAction:leave(unit, blackboard, t, reason, destroy)
	if not destroy then
...
function BTMoveToGoalAction:run(unit, blackboard, t, dt)
...
function BTMoveToGoalAction:start_move_animation(unit, blackboard)
...
function BTMoveToGoalAction:start_move_rotation(unit, blackboard, t, dt)
...
function BTMoveToGoalAction:toggle_start_move_animation_lock(unit, should_lock_ani, blackboard)
