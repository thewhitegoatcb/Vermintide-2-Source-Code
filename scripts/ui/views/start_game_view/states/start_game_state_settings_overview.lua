...
function StartGameStateSettingsOverview:on_enter(params)
...
function StartGameStateSettingsOverview:_calculate_current_weave()
...
function StartGameStateSettingsOverview:_setup_menu_layout(mechanism_name)
	local layout_settings = nil

	local use_gamepad_layout = IS_CONSOLE or
	Managers.input:is_device_active("gamepad") or
	not UISettings.use_pc_menu_layout or
	MechanismSettings [mechanism_name].use_gamepad_layout
...
function StartGameStateSettingsOverview:_create_ui_elements(params)
...
function StartGameStateSettingsOverview:_create_hdr_gui()
	local world_flags = { Application.DISABLE_SOUND, Application.DISABLE_ESRAM }
...
function StartGameStateSettingsOverview:hdr_renderer()
	return self._ui_hdr_renderer
end

function StartGameStateSettingsOverview:ui_renderer()
	if self._gamepad_style_active then
		do return self._gui_data.bottom.renderer end
	else
		return self.ui_renderer
	end
end

function StartGameStateSettingsOverview:_create_video_players()
...
function StartGameStateSettingsOverview:_destroy_video_players()
...
function StartGameStateSettingsOverview:get_video_player_by_name(name)
	return self._video_players [name]
end

function StartGameStateSettingsOverview:_setup_gamepad_gui()
	if self._is_in_inn then
		...
		gui_data.bottom = { renderer = renderer, world = world, viewport_name = viewport_name }
...
function StartGameStateSettingsOverview:_setup_gamepad_renderer(name, layer, shading_environment)
	local world_flags = { Application.DISABLE_SOUND, Application.DISABLE_ESRAM }
...
function StartGameStateSettingsOverview:_destroy_gamepad_gui()
...
function StartGameStateSettingsOverview:disable_player_world()
...
function StartGameStateSettingsOverview:enable_player_world()
...
function StartGameStateSettingsOverview:_start_layout_name()
	...
	if layout_setting and self:can_add_layout(layout_setting) then
		do return start_layout_name end
	else
...
function StartGameStateSettingsOverview:can_add_layout(layout_setting)
	local can_add_function = layout_setting.can_add_function
	return can_add_function and can_add_function(self)
end

function StartGameStateSettingsOverview:_initial_windows_setups(params)
...
function StartGameStateSettingsOverview:window_input_service()
	return self._show_difficulty_option and FAKE_INPUT_SERVICE or self:input_service()
end

function StartGameStateSettingsOverview:_close_window_at_index(window_index)
	...
	if
	current_window and current_window.on_exit then
...
function StartGameStateSettingsOverview:_change_window(window_index, window_name)
	local active_windows = self._active_windows
	...
	if not ignore_alignment then
		...
		window_offset = { window_width_offset, 0, 3 }
	end
...
function StartGameStateSettingsOverview:_set_new_save_data_table(table_name)
	if table_name then
...
function StartGameStateSettingsOverview:_validate_mission_save_data(mission_save_data)
...
function StartGameStateSettingsOverview:close_on_exit()
	return self._close_on_exit
end

function StartGameStateSettingsOverview:get_current_window_layout_settings()
...
function StartGameStateSettingsOverview:set_layout_by_name(name)
...
function StartGameStateSettingsOverview:get_mechanism_name()
	return self._mechanism_name
end



function StartGameStateSettingsOverview:is_in_mechanism(mechanism_name)
	local is_in_weave_menu = self.parent:on_enter_sub_state() == "weave_quickplay"


	if mechanism_name == "weave" then
		do return self._mechanism_name == "adventure" and is_in_weave_menu end
	else
		return self._mechanism_name == mechanism_name and not is_in_weave_menu
	end
end

function StartGameStateSettingsOverview:is_weekly_event_active()
...
function StartGameStateSettingsOverview:get_quickplay_settings(mechanism_name)
	return self._mechanism_quickplay_settings [mechanism_name or self._mechanism_name]
end

function StartGameStateSettingsOverview:get_custom_game_settings(mechanism_name)
	return self._mechanism_custom_game_settings [mechanism_name or self._mechanism_name]
end

function StartGameStateSettingsOverview:get_twitch_settings(mechanism_name)
	return self._mechanism_twitch_settings [mechanism_name or self._mechanism_name]
end

function StartGameStateSettingsOverview:get_save_data_table_map(mechanism_name)
	return self._save_data_table_maps [mechanism_name or self._mechanism_name]
end

function StartGameStateSettingsOverview:set_layout(index)
	...
	local windows = self._widgets_by_name.exit_button.content if reset_on_exit then --[[ Nothing --]] end windows.visible = close_on_exit
...
function StartGameStateSettingsOverview:set_window_input_focus(window_name)
...
function StartGameStateSettingsOverview:get_selected_game_mode_layout_name()
	return self._selected_game_mode_layout_name
end

function StartGameStateSettingsOverview:get_previous_selected_game_mode_layout_name()
	return self._previous_selected_game_mode_layout_name
end

function StartGameStateSettingsOverview:get_selected_layout_name()
	return self._selected_layout_name
end

function StartGameStateSettingsOverview:get_previous_selected_layout_name()
	return self._previous_selected_layout_name
end

function StartGameStateSettingsOverview:get_layout_setting(index)
	return self._window_layouts [index]
end

function StartGameStateSettingsOverview:get_layout_setting_by_name(name)
...
function StartGameStateSettingsOverview:_get_first_game_mode_option_layout()
	local window_layouts = self._window_layouts
	for i = 1, #window_layouts do
		local layout_setting = window_layouts [i]
...
function StartGameStateSettingsOverview:_windows_update(dt, t)
	local active_windows = self._active_windows
	for _, window in pairs(active_windows) do
		window:update(dt, t)
	end
...
function StartGameStateSettingsOverview:_windows_post_update(dt, t)
	local active_windows = self._active_windows
	for _, window in pairs(active_windows) do
...
function StartGameStateSettingsOverview:enable_widget(active_window_index, widget_name, enable)
	local active_windows = self._active_windows
...
function StartGameStateSettingsOverview:disable_input(input_name)
	local active_windows = self._active_windows
...
function StartGameStateSettingsOverview:transitioning()
...
function StartGameStateSettingsOverview:_wanted_state()
	local new_state = self.parent:wanted_state()
	return new_state
end

function StartGameStateSettingsOverview:wanted_menu_state()
	return self._wanted_menu_state
end

function StartGameStateSettingsOverview:clear_wanted_menu_state()
	self._wanted_menu_state = nil
end


function StartGameStateSettingsOverview:on_exit(params)
...
function StartGameStateSettingsOverview:_close_active_windows()
	local active_windows = self._active_windows
	local params = self._window_params
...
function StartGameStateSettingsOverview:_update_transition_timer(dt)
...
function StartGameStateSettingsOverview:input_service()
	return self.parent:input_service()
end

function StartGameStateSettingsOverview:update(dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
	...
	if not self._transition_timer and (
	wanted_state or self._new_state) then
...
function StartGameStateSettingsOverview:post_update(dt, t)
...
function StartGameStateSettingsOverview:_update_animations(dt)
...
function StartGameStateSettingsOverview:_is_button_hover_enter(widget)
	local content = widget.content
	local hotspot = content.button_hotspot
	return hotspot.on_hover_enter
end

function StartGameStateSettingsOverview:_handle_input(dt, t)
	...
	elseif input_pressed or back_pressed or self:_is_button_pressed(back_button) then
		...
		return_layout_name =
		return_layout_name or self:get_previous_selected_layout_name()
...
function StartGameStateSettingsOverview:close_menu(ignore_sound_on_close_menu)
	self.parent:close_menu(nil, ignore_sound_on_close_menu)
end

function StartGameStateSettingsOverview:cancel_matchmaking()
	self.parent:cancel_matchmaking()
end

function StartGameStateSettingsOverview:play(t, vote_type, force_close_menu)
	...
	elseif vote_type == "adventure" then
		local params = { mechanism = "adventure", quick_game = true, strict_matchmaking = false, matchmaking_type = "standard",
	...
	elseif vote_type == "weave_quick_play" then
		local params = { mechanism = "weave", quick_game = true, strict_matchmaking = false, matchmaking_type = "standard",
			difficulty = self._selected_difficulty_key,
	...
	elseif vote_type == "custom" then
		...
		local params = { mechanism = "adventure", matchmaking_type = "custom", quick_game = false,
	...
	elseif vote_type == "deed" then
		local params = { is_private = true, mechanism = "adventure", quick_game = false, strict_matchmaking = false, always_host = true, matchmaking_type = "deed",
	...
	elseif vote_type == "twitch" then
		local params = { private_game = true, strict_matchmaking = false, always_host = true, matchmaking_type = "custom", mechanism = "adventure", quick_game = false, twitch_enabled = true,
			mission_id = self:get_selected_level_id(),
			difficulty = self._selected_difficulty_key,
	...
	elseif vote_type == "event" then
		...
		local event_data = { mutators = game_mode_data.mutators }
		if next(event_data) == nil then
			event_data = nil
		end

		local params = { private_game = false, strict_matchmaking = false, always_host = false, matchmaking_type = "event", mechanism = "adventure", quick_game = false,
	...
	elseif vote_type == "weave" then
		...
		local params = { matchmaking_type = "custom", mechanism = "weave", quick_game = false,
	...
	elseif vote_type == "deus_custom" then
		...
		local params = { matchmaking_type = "custom", mechanism = "deus", quick_game = false,
	...
	elseif vote_type == "deus_twitch" then
		...
		local params = { private_game = true, mechanism = "deus", strict_matchmaking = false, always_host = true, matchmaking_type = "custom", quick_game = false, twitch_enabled = true,
			mission_id = journey_name,
			difficulty = self._selected_difficulty_key,
	...
	elseif vote_type == "deus_quickplay" then
		local params = { mechanism = "deus", quick_game = true, strict_matchmaking = false, matchmaking_type = "standard",
			difficulty = self._selected_difficulty_key,
...
function StartGameStateSettingsOverview:is_confirm_putton_pressed()
	return false
end

function StartGameStateSettingsOverview:set_input_description(input_description)
...
function StartGameStateSettingsOverview:change_generic_actions(input_description)
	if not self._menu_input_description then
		return
	end
...
function StartGameStateSettingsOverview:draw(input_service, dt)
...
function StartGameStateSettingsOverview:draw_menu_input_description(input_service, dt)
	local ui_top_renderer = self._ui_top_renderer
	self._menu_input_description:draw(ui_top_renderer, dt)
end

function StartGameStateSettingsOverview:_is_button_pressed(widget)
	local content = widget.content
...
function StartGameStateSettingsOverview:play_sound(event)
	self.parent:play_sound(event)
end

function StartGameStateSettingsOverview:_start_transition_animation(key, animation_name)
	local params = {
		wwise_world = self._wwise_world,
...
function StartGameStateSettingsOverview:get_selected_weave_id()
	return self._selected_weave_id
end

function StartGameStateSettingsOverview:get_selected_weave_objective_index()
	return self._selected_weave_objective_index
end

function StartGameStateSettingsOverview:set_next_weave()
...
function StartGameStateSettingsOverview:set_selected_weave_id(weave_name)
...
function StartGameStateSettingsOverview:set_selected_weave_objective_index(objective_index)
	self._selected_weave_objective_index = objective_index
end

function StartGameStateSettingsOverview:get_selected_heroic_deed_backend_id()
	return self._selected_heroic_deed_backend_id
end

function StartGameStateSettingsOverview:set_selected_heroic_deed_backend_id(backend_id)
	self._selected_heroic_deed_backend_id = backend_id
end

function StartGameStateSettingsOverview:get_selected_level_id()
	...
	if
	level_settings and level_settings.dlc_name then
...
function StartGameStateSettingsOverview:set_selected_level_id(level_id)
	if self._layout_save_settings then
...
function StartGameStateSettingsOverview:get_selected_area_name()
...
function StartGameStateSettingsOverview:set_selected_area_name(area_name)
	if self._layout_save_settings then
...
function StartGameStateSettingsOverview:show_difficulty_option()
	self._show_difficulty_option = true
end

function StartGameStateSettingsOverview:hide_difficulty_option()
	self._show_difficulty_option = false
end

function StartGameStateSettingsOverview:set_private_option_enabled(is_private)
...
function StartGameStateSettingsOverview:is_private_option_enabled()
	return self._is_game_private
end

function StartGameStateSettingsOverview:set_always_host_option_enabled(always_host)
...
function StartGameStateSettingsOverview:is_always_host_option_enabled()
	return self._always_host
end

function StartGameStateSettingsOverview:set_strict_matchmaking_option_enabled(use_strict_matchmaking)
...
function StartGameStateSettingsOverview:is_strict_matchmaking_option_enabled()
	return self._use_strict_matchmaking
end

function StartGameStateSettingsOverview:is_difficulty_approved(difficulty_key)
	...
	if difficulty_settings.dlc_requirement and
	not Managers.unlock:is_dlc_unlocked(difficulty_settings.dlc_requirement) then
		difficulty_approved = false
...
function StartGameStateSettingsOverview:set_difficulty_option(difficulty_key)
	if self._layout_save_settings then
...
function StartGameStateSettingsOverview:get_difficulty_option(ignore_approval)
	local selected_difficulty_key = self._selected_difficulty_key
	if
	not ignore_approval and selected_difficulty_key and not self:is_difficulty_approved(selected_difficulty_key) then
...
function StartGameStateSettingsOverview:set_dedicated_or_player_hosted_search(use_dedicated_win_servers, use_dedicated_aws_servers, use_player_hosted)
...
function StartGameStateSettingsOverview:using_player_hosted_search()
	return self._use_player_hosted
end

function StartGameStateSettingsOverview:using_dedicated_servers_search()
	return self._use_dedicated_win_servers, self._use_dedicated_aws_servers
end

function StartGameStateSettingsOverview:set_play_button_enabled(enabled)

	return end

function StartGameStateSettingsOverview:set_confirm_button_visibility(visible)


	return end

function StartGameStateSettingsOverview:set_fullscreen_effect_enable_state(enabled)
...
function StartGameStateSettingsOverview:set_mutator_option(mutator_key)
	self._selected_mutator_key = mutator_key
end

function StartGameStateSettingsOverview:get_mutator_option()
	return self._selected_mutator_key
end

function StartGameStateSettingsOverview:get_completed_level_difficulty_index(statistics_db, stats_id, level_id)
...
function StartGameStateSettingsOverview:can_use_streaming()
	if IS_WINDOWS then
		return true
	end
...
function StartGameStateSettingsOverview:setup_backend_image_material(gui, reference_name, texture_name, masked)
	...
	cdn:get_resource_urls({ texture_name }, cb)

	return material_name
end

function StartGameStateSettingsOverview:_cb_on_backend_url_loaded(gui, reference_name, texture_name, material_name, result)
...
function StartGameStateSettingsOverview:_cb_on_backend_image_loaded(gui, reference_name, material_name, texture_resource)
...
function StartGameStateSettingsOverview:_create_material_instance(gui, new_material_name, template_material_name, reference_name)
	local cloned_materials_by_reference = self._cloned_materials_by_reference
...
function StartGameStateSettingsOverview:_set_material_diffuse_by_resource(gui, material_name, texture_resource)
...
function StartGameStateSettingsOverview:_set_material_diffuse_by_path(gui, material_name, texture_path)
	local material = Gui.material(gui, material_name)
	if material then
...
function StartGameStateSettingsOverview:_is_unique_reference_to_material(reference_name)
	local cloned_materials_by_reference = self._cloned_materials_by_reference
...
function StartGameStateSettingsOverview:reset_cloned_material(reference_name)
	local gui_by_cloned_material_reference = self._gui_by_cloned_material_reference
	local cloned_materials_by_reference = self._cloned_materials_by_reference
...
function StartGameStateSettingsOverview:_reset_cloned_materials()
	local cloned_materials_by_reference = self._cloned_materials_by_reference
