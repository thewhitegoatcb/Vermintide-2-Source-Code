...
function ProjectileFixedImpactUnitExtension:init(extension_init_context, unit, extension_init_data)
...
function ProjectileFixedImpactUnitExtension:extensions_ready(world, unit)
	self.locomotion_extension = ScriptUnit.extension(unit, "projectile_locomotion_system")
end

function ProjectileFixedImpactUnitExtension:update(unit, input, dt, context, t)
